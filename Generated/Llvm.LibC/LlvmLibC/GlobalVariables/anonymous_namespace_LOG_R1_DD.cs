...
internal static partial class anonymous_namespace_LOG_R1_DD
{
	[FixedAddressValueType]
	private static InlineArray129_NumberPair __value;

	public unsafe static InlineArray129_NumberPair* Pointer => unchecked((InlineArray129_NumberPair*)Unsafe.AsPointer(ref __value));

	public static InlineArray129_NumberPair Value
	{
		get
		{
			return __value;
	...
	unsafe static anonymous_namespace_LOG_R1_DD()
	{
		Value = new InlineArrayBuilder<InlineArray129_NumberPair, NumberPair>
		{
			default(NumberPair),
			new NumberPair
			{
