...
[MangledName("_ZN19__llvm_libc_20_1_2_12_GLOBAL__N_19LOG_R1_DDE")]
[DemangledName("__llvm_libc_20_1_2_::(anonymous namespace)::LOG_R1_DD")]
internal static partial class Llvm_libc_20_1_2_anonymous_namespace_LOG_R1_DD
{
	[FixedAddressValueType]
	private static InlineArray129_Llvm_libc_20_1_2_NumberPair __value;

	public unsafe static InlineArray129_Llvm_libc_20_1_2_NumberPair* Pointer => unchecked((InlineArray129_Llvm_libc_20_1_2_NumberPair*)Unsafe.AsPointer(ref __value));

	public static InlineArray129_Llvm_libc_20_1_2_NumberPair Value
	{
		get
		{
			return __value;
	...
	unsafe static Llvm_libc_20_1_2_anonymous_namespace_LOG_R1_DD()
	{
		Value = new InlineArrayBuilder<InlineArray129_Llvm_libc_20_1_2_NumberPair, Llvm_libc_20_1_2_NumberPair>
		{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -8.269399178187412E-15,
				Hi = 0.04391923393484376
			},
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = 3.0171021061886944E-14,
				Hi = 0.05211600113898385
			},
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -1.3352588834854848E-14,
				Hi = 0.06038051098892083
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -4.713370778300984E-15,
				Hi = 0.08134563945395712
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -1.3438406228830954E-14,
				Hi = 0.10275973395778237
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = 2.3568822182038756E-14,
				Hi = 0.11583181552509814
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -1.6376276414097503E-14,
				Hi = 0.16989903679541385
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -2.5223102140407338E-14,
				Hi = 0.18388527877016259
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = 4.541021984976105E-14,
				Hi = 0.20284319251470606
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -3.979844515951702E-15,
				Hi = 0.22216746534115828
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = -2.037449094215686E-14,
				Hi = 0.25187261975509045
			},
			new Llvm_libc_20_1_2_NumberPair
			{
			...
			new Llvm_libc_20_1_2_NumberPair
			{
				Lo = 1.1782016386565151E-14,
				Hi = 0.28248725557466514
			},
			new Llvm_libc_20_1_2_NumberPair
			{
