...
internal static partial class StrToNumResult_unsigned_int_internal_strtointeger_unsigned_int_char_const_int_unsigned_long
{
	public unsafe static Struct_fiz2nb Invoke(void* src, int @base, long src_len)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				num5 = InstructionHelper.Select((b4 & 1) == 1, cpp_internal_integer_impl_unsigned_int_0u_4294967295u_max.Invoke(), -1);
				llvm_lifetime_start_p0.Invoke(4L, &num6);
				num6 = (int)((uint)num5 / (uint)num8);
				while ((ulong)num2 < (ulong)src_len && internal_isalnum_int_24.Invoke(((sbyte*)src)[num2]))
				{
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = internal_b36_char_to_int_int_26.Invoke(((sbyte*)src)[num2]);
					int num9;
					if (num7 >= num8)
					{
						num9 = 3;
				...
				if (num3 == 34)
				{
					...
					{
						cpp_internal_integer_impl_unsigned_int_0u_4294967295u_min.Invoke();
						int value;
						long parsed_len2;
						int error;
