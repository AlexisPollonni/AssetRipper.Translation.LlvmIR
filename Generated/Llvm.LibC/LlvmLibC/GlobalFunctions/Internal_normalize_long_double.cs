...
internal static partial class Internal_normalize_long_double
{
	...
	public unsafe static void Invoke([MangledName("exponent")][NativeType("int&")] void* Exponent, [MangledName("mantissa")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<long double>::StorageType&")] void* Mantissa)
	{
		int num = 0;
		Llvm_lifetime_start_p0.Invoke(4L, &num);
		Int128 @int = *unchecked((Int128*)Mantissa);
		num = unchecked(Cpp_countl_zero_unsigned_int128.Invoke(*(long*)(&@int), ((long*)(&@int))[1])) - 64;
