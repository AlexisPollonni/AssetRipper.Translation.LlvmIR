		...
		*unchecked((int*)(&fputil_FPBits_5nkvcs2)) = -1431655766;
		...
		else
		{
			...
			else
			{
				...
				b = (((fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa_const.Invoke(&fputil_FPBits_5nkvcs2) & (1 << unchecked(num2 - 1))) != 0) ? ((sbyte)1) : ((sbyte)0));
				...
				{
					fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_uintval_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, num4);
					llvm_lifetime_start_p0.Invoke(4L, &num5);
					num5 = fputil_FPBits_float_get_val_const.Invoke(&fputil_FPBits_5nkvcs2);
					result = (((b & 1) == 1) ? ((!fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg_const.Invoke(&fputil_FPBits_5nkvcs2)) ? (num5 + 1f) : (num5 - 1f)) : num5);
