	...
	public unsafe static long Invoke([NativeType("double")] double x)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			{
				lambda_Invoke_kcfwxx.Invoke(&anon_izyfb8);
				result = InstructionHelper.Select(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)), long.MinValue, long.MaxValue);
			}
			else
			{
				...
				else if (num3 == 63 && (FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_pos.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) || FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) != 0L))
				{
					lambda_Invoke_kcfwxx.Invoke(&anon_izyfb8);
					result = InstructionHelper.Select(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)), long.MinValue, long.MaxValue);
				}
