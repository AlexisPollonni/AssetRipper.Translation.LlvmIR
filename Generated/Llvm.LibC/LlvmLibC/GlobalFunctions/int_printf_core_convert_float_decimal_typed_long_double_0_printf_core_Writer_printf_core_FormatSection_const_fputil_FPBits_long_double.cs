...
internal static partial class int_printf_core_convert_float_decimal_typed_long_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_long_double
{
	public unsafe static int Invoke(void* writer, void* to_conv, [MangledName("float_bits.coerce0")] long float_bits, [MangledName("float_bits.coerce1")] long FRACTION_LEN)
	{
		...
		unchecked
		{
			while (true)
			{
				...
				num6 = FloatToString_long_double_0_get_positive_block_int.Invoke(&floatToString_8m29tk, num5);
				if ((b2 & 1) == 1)
				{
			...
			if (num2 < 63)
			{
				...
				while (true)
				{
					...
					{
						if (FloatToString_long_double_0_is_lowest_block_unsigned_long.Invoke(&floatToString_8m29tk, (uint)num10))
						{
						...
						else
						{
							...
							num14 = FloatToString_long_double_0_get_negative_block_int.Invoke(&floatToString_8m29tk, num10);
							...
							else
							{
								...
								*(long*)num23 = struct_fiz2nb2.field_0;
								byte* num24 = (byte*)(&@int) + 8u;
								Struct_fiz2nb struct_fiz2nb3 = struct_fiz2nb;
								*(long*)num24 = struct_fiz2nb3.field_1;
								int2 = @int;
								b3 = (sbyte)(byte)((cpp_enable_if_cpp_is_integral_v_unsigned_int128_is_big_int_v_unsigned_int128_bool_type_printf_core_zero_after_digits_unsigned_int128_int_int_unsigned_int128_int.Invoke(base_2_exp, digits_after_point, *(long*)(&int2), ((long*)(&int2))[1], 63) ? 1 : 0) ^ -1);
								...
								num18 = printf_core_get_round_direction_int_bool_Sign.Invoke(last_digit, truncated, anon_izyfb8.val);
								llvm_lifetime_start_p0.Invoke(4L, &num19);
								num19 = printf_core_FloatWriter_write_last_block_unsigned_int_unsigned_long_printf_core_RoundDirection_int_char.Invoke(&printf_core_FloatWriter2, num14, (uint)num16, num18, 0, 0);
								if (num19 < 0)
								{
									result = num19;
									num22 = 1;
