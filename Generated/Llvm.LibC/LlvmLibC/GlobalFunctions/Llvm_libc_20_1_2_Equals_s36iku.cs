...
internal static partial class Llvm_libc_20_1_2_Equals_s36iku
{
	...
	public unsafe static bool Invoke([MangledName("lhs")][NativeType("__llvm_libc_20_1_2_::BigInt<128ul, false, unsigned long> const&")] Anon_izyfb7* Lhs, [MangledName("rhs")][NativeType("__llvm_libc_20_1_2_::BigInt<128ul, false, unsigned long> const&")] Anon_izyfb7* Rhs)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (*(long*)Array_unsigned_long_2ul_Index_j6w6uu.Invoke(&((Llvm_libc_20_1_2_BigInt_qdkjbh*)Lhs)->Val, num) != *(long*)Array_unsigned_long_2ul_Index_j6w6uu.Invoke(&((Llvm_libc_20_1_2_BigInt_qdkjbh*)Rhs)->Val, num))
				{
					result = false;
					num2 = 1;
					break;
