		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				b = (fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg_const.Invoke(&fputil_FPBits_5nkvcs2) ? ((sbyte)1) : ((sbyte)0));
				...
				else if (num <= -1)
				{
					result = rnd switch
					{
						...
						_ => (num > -2 && fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa_const.Invoke(&fputil_FPBits_5nkvcs2) != 0) ? InstructionHelper.Select((b & 1) == 1, -1f, 1f) : InstructionHelper.Select((b & 1) == 1, -0f, 0f), 
					};
				}
				else
				{
					...
					num3 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2);
					...
					else
					{
						...
						*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
						...
						num6 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa_const.Invoke(&fputil_FPBits_5nkvcs2) & ((1 << num2) - 1);
						llvm_lifetime_start_p0.Invoke(4L, &num7);
						num7 = 1 << num2 - 1;
						llvm_lifetime_start_p0.Invoke(4L, &num8);
						num8 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa_const.Invoke(&fputil_FPBits_5nkvcs3) & (1 << num2);
						result = rnd switch
						{
