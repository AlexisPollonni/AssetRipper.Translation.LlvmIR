...
internal static partial class FMod_Float16_unsigned_int_fputil_generic_FModDivisionSimpleHelper_unsigned_int_eval_internal
{
	...
	public unsafe static short Invoke([MangledName("sx.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<_Float16>")] short sx, [MangledName("sy.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<_Float16>")] short sy)
	{
		...
		unchecked
		{
			if (details_expects_bool_condition_bool.Invoke((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)) <= (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva4)), expected: true))
			{
				if ((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)) < (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva4)))
				{
			...
			else
			{
				...
				num = (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3));
				llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva4));
				if (details_expects_bool_condition_bool.Invoke(num2 > 10 && checked(num - num2) <= 5, expected: true))
				{
					...
					num3 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3));
					llvm_lifetime_start_p0.Invoke(2L, &num4);
					num4 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva4));
				...
				else if (details_expects_bool_condition_bool.Invoke(num == 0 && num2 == 0, expected: false))
				{
					*(short*)(&fputil_FPBits_2fahva2) = -21846;
					...
					FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2), (short)((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)) % (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva4))));
				}
				else
				{
					llvm_lifetime_start_p0.Invoke(4L, &num6);
					num6 = (ushort)FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3));
					num = checked(num + -1);
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = (ushort)FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva4));
					...
					{
						num7 = (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva4));
					...
					if (details_expects_bool_condition_bool.Invoke(num6 == 0, expected: false))
					{
						...
						short field_4 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_zero.Invoke(anon_izyfb10.val);
