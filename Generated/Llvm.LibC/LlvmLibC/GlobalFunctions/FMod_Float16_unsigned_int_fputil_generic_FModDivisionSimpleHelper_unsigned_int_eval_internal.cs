...
internal static partial class FMod_Float16_unsigned_int_fputil_generic_FModDivisionSimpleHelper_unsigned_int_eval_internal
{
	...
	public unsafe static short Invoke([MangledName("sx.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<_Float16>")] short Sx, [MangledName("sy.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<_Float16>")] short Sy)
	{
		...
		fputil_FPBits_2fahva2.FPRepImpl.FPRepSem.FPStorage.field_0 = Sx;
		fputil_FPBits_2fahva3.FPRepImpl.FPRepSem.FPStorage.field_0 = Sy;
		unchecked
		{
			if (Details_expects_bool_condition_bool.Invoke((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) <= (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)), Expected: true))
			{
				if ((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) < (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)))
				{
			...
			else
			{
				...
				num = (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2));
				Llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3));
				if (Details_expects_bool_condition_bool.Invoke(num2 > 10 && checked(num - num2) <= 5, Expected: true))
				{
					...
					num3 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2));
					Llvm_lifetime_start_p0.Invoke(2L, &num4);
					num4 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3));
					...
					if ((ushort)num5 == 0)
					{
						...
						fputil_FPBits_2fahva.FPRepImpl.FPRepSem.FPStorage.field_0 = field_2;
					}
					else
					{
						short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_make_value.Invoke(num5, checked(num2 - 1));
						fputil_FPBits_2fahva.FPRepImpl.FPRepSem.FPStorage.field_0 = field_3;
					}
				...
				else if (Details_expects_bool_condition_bool.Invoke(num == 0 && num2 == 0, Expected: false))
				{
					*(short*)(&fputil_FPBits_2fahva) = -21846;
					...
					FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva), (short)((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) % (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3))));
				}
				else
				{
					Llvm_lifetime_start_p0.Invoke(4L, &num6);
					num6 = (ushort)FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2));
					num = checked(num + -1);
					Llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = (ushort)FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3));
					...
					{
						num7 = (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3));
					...
					if (Details_expects_bool_condition_bool.Invoke(num6 == 0, Expected: false))
					{
						...
						fputil_FPBits_2fahva.FPRepImpl.FPRepSem.FPStorage.field_0 = field_4;
					}
					else if (num11 == 0)
					{
						short field_5 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_make_value.Invoke((short)num6, num2);
						fputil_FPBits_2fahva.FPRepImpl.FPRepSem.FPStorage.field_0 = field_5;
					}
					else
					{
						...
						fputil_FPBits_2fahva.FPRepImpl.FPRepSem.FPStorage.field_0 = field_6;
					}
