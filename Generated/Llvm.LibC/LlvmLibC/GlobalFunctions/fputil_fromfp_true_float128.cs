		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
				...
				if (FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan.Invoke(&fputil_FPBits_ubgsi4))
				{
					fputil_raise_except_if_required.Invoke(1);
				...
				else
				{
					...
					else
					{
						...
						double num4 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi6);
						...
						else
						{
							...
							double num5 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi8) - 1.0;
							...
							if (num > num3)
							{
								...
								result = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi9);
