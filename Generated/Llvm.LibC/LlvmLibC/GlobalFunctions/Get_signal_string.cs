...
internal static partial class Get_signal_string
{
	...
	public unsafe static Struct_kqhe8i Invoke([MangledName("sig_num")][NativeType("int")] int Sig_num)
	{
		...
		Span_char_Constructor.Invoke(&cpp_string_view2, Llvm_threadlocal_address_p0.Invoke(Internal_signal_buffer.Pointer), 29L);
		unchecked
		{
			Struct_kqhe8i struct_kqhe8i = Invoke(Sig_num, *(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]);
	...
	public unsafe static Struct_kqhe8i Invoke([MangledName("sig_num")] int Sig_num, [MangledName("buffer.coerce0")][NativeType("int")] void* Buffer, [MangledName("buffer.coerce1")][NativeType("__llvm_libc_20_1_2_::cpp::span<char>")] long Opt_str)
	{
		...
		unchecked
		{
			...
			*ptr3 = -86;
			...
			ptr3[5] = -86;
			ptr3[6] = -86;
			MessageMapper_32ul_487ul_get_str.Invoke(&cpp_optional_bnt67x, (MessageMapper_f6bdqy*)Internal_signal_mapper.Pointer, Sig_num);
			...
			else
			{
				...
				Struct_kqhe8i struct_kqhe8i = Internal_build_signal_string.Invoke(Sig_num, *(void**)(&cpp_string_view3), ((long*)(&cpp_string_view3))[1]);
				Cpp_string_view* num = &cpp_string_view;
				Struct_kqhe8i struct_kqhe8i2 = struct_kqhe8i;
				*(void**)num = struct_kqhe8i2.field_0;
				byte* num2 = (byte*)(&cpp_string_view) + 8u;
