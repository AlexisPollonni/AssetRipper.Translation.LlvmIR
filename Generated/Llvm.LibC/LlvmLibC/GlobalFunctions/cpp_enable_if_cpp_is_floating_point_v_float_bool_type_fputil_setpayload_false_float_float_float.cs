...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float_bool_type_fputil_setpayload_false_float_float_float
{
			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				else
				{
					...
					int field_2 = fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan_Sign_unsigned_int.Invoke(v: num2, sign: anon_izyfb9.val);
					fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0 = field_2;
					*(float*)res = fputil_FPBits_float_get_val_const.Invoke(&fputil_FPBits_5nkvcs4);
