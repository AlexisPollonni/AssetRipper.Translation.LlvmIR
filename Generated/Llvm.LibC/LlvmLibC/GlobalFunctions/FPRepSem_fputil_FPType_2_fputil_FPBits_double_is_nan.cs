...
internal static partial class FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan
{
	...
	public unsafe static bool Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg* This)
	{
		...
		return unchecked((ulong)num > (ulong)FPStorage_fputil_FPType_2_encode.Invoke(llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg.FPStorage.Val));
	}
}
