...
internal static partial class FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan
{
	...
	public unsafe static bool Invoke(fputil_internal_FPRepSem_fq8nhg* @this)
	{
		...
		return unchecked((ulong)num > (ulong)FPStorage_fputil_FPType_2_encode.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, fputil_internal_FPRepSem_fq8nhg2.FPStorage.val));
	}
}
