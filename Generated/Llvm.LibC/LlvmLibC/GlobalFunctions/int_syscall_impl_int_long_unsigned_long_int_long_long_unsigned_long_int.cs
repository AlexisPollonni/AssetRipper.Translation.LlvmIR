...
internal static partial class int_syscall_impl_int_long_unsigned_long_int_long_long_unsigned_long_int
{
	public unsafe static int Invoke([MangledName("__number")] long number, [MangledName("ts")][CleanName("ts")] long ts_3enpke, [MangledName("ts1")][CleanName("ts")] long ts_76xnpk, [MangledName("ts3")][CleanName("ts")] int ts_w24gdx)
	{
		long num = 0L;
