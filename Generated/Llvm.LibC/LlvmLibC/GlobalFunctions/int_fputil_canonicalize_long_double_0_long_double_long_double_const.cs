...
internal static partial class int_fputil_canonicalize_long_double_0_long_double_long_double_const
{
	public unsafe static int Invoke(void* cx, void* x)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			b = (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit_const.Invoke(&fputil_FPBits_ubgsi3) ? ((sbyte)1) : ((sbyte)0));
			...
			*(long*)num3 = struct_fiz2nb3.field_1;
			...
			num = (ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi3);
			if (num == 32767)
			{
				if ((b & 1) != 1 && (b2 & 1) != 1)
				{
					if (NumericHelper.IntCmpEq(@int, 0L))
					{
						...
						int3 = int12;
						Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val, *(long*)(&int3), ((long*)(&int3))[1]);
						...
						*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi4);
					...
					else
					{
						...
						int4 = int13;
						Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val2, *(long*)(&int4), ((long*)(&int4))[1]);
						...
						*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi5);
				...
				else if ((b & 1) != 1 && (b2 & 1) == 1)
				{
					...
					int5 = int14;
					Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val3, *(long*)(&int5), ((long*)(&int5))[1]);
					...
					*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi6);
				...
				{
					if (!bool_details_expects_bool_condition_bool_bool_bool.Invoke(fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_signaling_nan_const.Invoke(&fputil_FPBits_ubgsi3), expected: false))
					{
						*(double*)cx = *(double*)x;
						goto IL_07ca;
					}
					...
					Struct_fiz2nb struct_fiz2nb13 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
					Int128* num5 = &int6;
					...
					*(long*)num6 = struct_fiz2nb15.field_1;
					...
					int7 = int15;
					Struct_fiz2nb struct_fiz2nb16 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val4, *(long*)(&int7), ((long*)(&int7))[1]);
					...
					*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi7);
			...
			else
			{
				if (num == 0 && (b & 1) == 1)
				{
					...
					int8 = @int;
					Struct_fiz2nb struct_fiz2nb19 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_make_value_unsigned_int128_int.Invoke(*(long*)(&int8), ((long*)(&int8))[1], 0);
					...
					*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi8);
				...
				if (num != 0 && (b & 1) != 1)
				{
					...
					int9 = int16;
					Struct_fiz2nb struct_fiz2nb22 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val5, *(long*)(&int9), ((long*)(&int9))[1]);
					...
					*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi9);
				...
				else
				{
					...
					anon_izyfb13.val = fputil_internal_FPStorage_fputil_FPType_4_sign_const.Invoke(&fputil_FPBits_ubgsi3);
					Struct_fiz2nb struct_fiz2nb25 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
					Int128* num7 = &int10;
					...
					*(long*)num8 = struct_fiz2nb27.field_1;
					...
					int11 = int17;
					Struct_fiz2nb struct_fiz2nb28 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val6, *(long*)(&int11), ((long*)(&int11))[1]);
					...
					*(double*)cx = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi10);
