...
internal static partial class Internal_heap_sort_internal_ArrayFixedSize_8ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0
{
	...
	public unsafe static void Invoke([MangledName("array")][NativeType("__llvm_libc_20_1_2_::internal::ArrayFixedSize<8ul> const&")] void* Array, [MangledName("is_less")][NativeType("__llvm_libc_20_1_2_::__qsort_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*))::$_0 const&")] void* Is_less)
	{
		long num = 0L;
		long num2 = 0L;
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb) = -86;
			while ((ulong)num > 1uL)
			{
				...
				i = num2;
				while ((ulong)Lambda_Invoke_augukk.Invoke(&anon_izyfb, i) < (ulong)num)
				{
					Llvm_lifetime_start_p0.Invoke(8L, &num3);
					num3 = Lambda_Invoke_augukk.Invoke(&anon_izyfb, i);
