...
internal static partial class IntegerToString_int_details_Fmt_unsigned_char_10_false_false_false_1ul_Constructor
{
	...
	public unsafe static void Invoke(IntegerToString_bz5c8a* @this, [NativeType("int")] int value)
	{
		...
		unchecked
		{
			...
			*ptr2 = -86;
			...
			ptr2[5] = -86;
			ptr2[6] = -86;
			span_char_span_char_11ul_true.Invoke(&cpp_string_view2, &@this->array);
			...
			IntegerWriter_write_gqfnqc.Invoke(value, &details_StringBufferWriterImpl2);
