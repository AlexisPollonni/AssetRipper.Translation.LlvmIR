...
{
	[MangledName("strfromd")]
	[DemangledName("strfromd")]
	public unsafe static int Invoke([MangledName("s")] void* S, [MangledName("n")] long N, [MangledName("format")] void* Format, [MangledName("fp")] double Fp)
	{
		...
		Internal_parse_format_string_double.Invoke(&llvm_libc_20_1_2_printf_core_FormatSection, Format, Fp);
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			{
				num = Internal_strfromfloat_convert_double.Invoke(&llvm_libc_20_1_2_printf_core_Writer, &llvm_libc_20_1_2_printf_core_FormatSection);
			}
			else
			{
