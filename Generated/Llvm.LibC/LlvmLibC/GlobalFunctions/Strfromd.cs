...
internal static partial class Strfromd
{
	...
	public unsafe static int Invoke([MangledName("s")] void* S, [MangledName("n")] long N, [MangledName("format")] void* Format, [MangledName("fp")] double Fp)
	{
		...
		Internal_parse_format_string_double.Invoke(&printf_core_FormatSection, Format, Fp);
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			{
				num = Internal_strfromfloat_convert_double.Invoke(&printf_core_Writer, &printf_core_FormatSection);
			}
			else
			{
