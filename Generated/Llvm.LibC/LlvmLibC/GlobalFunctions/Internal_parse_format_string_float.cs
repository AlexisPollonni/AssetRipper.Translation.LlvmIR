...
internal static partial class Internal_parse_format_string_float
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_printf_core_FormatSection* Agg_result, [MangledName("format")][NativeType("char const*")] void* Format, [MangledName("fp")][NativeType("float")] float Fp)
	{
		float num = 0f;
		long num2 = 0L;
		double num3 = 0.0;
