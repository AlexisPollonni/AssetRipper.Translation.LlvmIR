	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X, [MangledName("y")][NativeType("_Float16")] Half Y)
	{
		...
		unchecked
		{
			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			Half result = ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva))) ? ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2))) ? ((!NumericHelper.FcmpOgt(X, Y)) ? default(Half) : ((Half)((float)X - (float)Y))) : Y) : X);
