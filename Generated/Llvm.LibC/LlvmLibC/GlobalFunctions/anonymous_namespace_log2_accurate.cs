	...
	public unsafe static double Invoke([NativeType("int")] int e_x, [NativeType("int")] int index, [NativeType("double")] double m_x)
	{
		...
		unchecked
		{
			...
			*(long*)ptr4 = -6148914691236517206L;
			...
			log_range_reduction.Invoke(&fputil_DyadicFloat_kt2kd9, m_x, anonymous_namespace_LOG2_TABLE.Pointer, &fputil_DyadicFloat_kt2kd5);
			...
			*(long*)ptr6 = -6148914691236517206L;
			...
			fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd9, (fputil_DyadicFloat_kt2kd4*)anonymous_namespace_BIG_COEFFS.Pointer);
			...
			fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd11, &fputil_DyadicFloat_kt2kd9, &fputil_DyadicFloat_kt2kd12);
			...
			fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd15, &fputil_DyadicFloat_kt2kd9, &fputil_DyadicFloat_kt2kd16);
			...
			fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd19, &fputil_DyadicFloat_kt2kd9, &fputil_DyadicFloat_kt2kd20);
			...
			*(long*)ptr8 = -6148914691236517206L;
			...
			double result = DyadicFloat_128ul_double_double_void.Invoke(&fputil_DyadicFloat_kt2kd23);
