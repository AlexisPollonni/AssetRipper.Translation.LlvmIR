...
internal static partial class Cmp_neq_uint64_t
{
	...
	public unsafe static int Invoke([MangledName("a")][NativeType("unsigned long")] long A, [MangledName("b")][NativeType("unsigned long")] long B)
	{
		...
		StrictIntegralType_int_StrictIntegralType_int_false.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt, InstructionHelper.Select(unchecked((ulong)A < (ulong)B), -5, 5));
