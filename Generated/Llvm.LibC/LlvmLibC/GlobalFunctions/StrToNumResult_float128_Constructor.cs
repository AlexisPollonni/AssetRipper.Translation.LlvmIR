...
internal static partial class StrToNumResult_float128_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] StrToNumResult_c5b6ms* This, [MangledName("value")][NativeType("__float128")] double Value, [MangledName("parsed_len")][NativeType("long")] long Parsed_len, [MangledName("error")][NativeType("int")] int Error)
	{
		This->Value = Value;
		This->Error = Error;
