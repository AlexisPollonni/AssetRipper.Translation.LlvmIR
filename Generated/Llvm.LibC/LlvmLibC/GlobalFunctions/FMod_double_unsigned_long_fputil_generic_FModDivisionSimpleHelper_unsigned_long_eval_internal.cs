...
internal static partial class FMod_double_unsigned_long_fputil_generic_FModDivisionSimpleHelper_unsigned_long_eval_internal
{
	...
	public unsafe static long Invoke([MangledName("sx.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<double>")] long Sx, [MangledName("sy.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<double>")] long Sy)
	{
		...
		fputil_FPBits_wjhbrm2.FPRepImpl.FPRepSem.FPStorage.Val = Sx;
		fputil_FPBits_wjhbrm3.FPRepImpl.FPRepSem.FPStorage.Val = Sy;
		unchecked
		{
			if (Details_expects_bool_condition_bool.Invoke((ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) <= (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3)), Expected: true))
			{
				if ((ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) < (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3)))
				{
			...
			else
			{
				...
				num = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
				Llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3));
				if (Details_expects_bool_condition_bool.Invoke(num2 > 52 && checked(num - num2) <= 11, Expected: true))
				{
					Llvm_lifetime_start_p0.Invoke(8L, &num3);
					num3 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2));
					Llvm_lifetime_start_p0.Invoke(8L, &num4);
					num4 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3));
					...
					if (num5 == 0L)
					{
						...
						fputil_FPBits_wjhbrm.FPRepImpl.FPRepSem.FPStorage.Val = val2;
					}
					else
					{
						long val3 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_make_value.Invoke(num5, checked(num2 - 1));
						fputil_FPBits_wjhbrm.FPRepImpl.FPRepSem.FPStorage.Val = val3;
					}
				...
				else if (Details_expects_bool_condition_bool.Invoke(num == 0 && num2 == 0, Expected: false))
				{
					*(long*)(&fputil_FPBits_wjhbrm) = -6148914691236517206L;
					...
					FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_mantissa.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm), (long)((ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) % (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3))));
				}
				else
				{
					Llvm_lifetime_start_p0.Invoke(8L, &num6);
					num6 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2));
					num = checked(num + -1);
					Llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3));
					...
					{
						num7 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3));
					...
					if (Details_expects_bool_condition_bool.Invoke(num6 == 0L, Expected: false))
					{
						...
						fputil_FPBits_wjhbrm.FPRepImpl.FPRepSem.FPStorage.Val = val4;
					}
					else if (num11 == 0)
					{
						long val5 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_make_value.Invoke(num6, num2);
						fputil_FPBits_wjhbrm.FPRepImpl.FPRepSem.FPStorage.Val = val5;
					}
					else
					{
						...
						fputil_FPBits_wjhbrm.FPRepImpl.FPRepSem.FPStorage.Val = val6;
					}
