...
internal static partial class float128_fputil_copysign_float128_0_float128_float128
{
	public unsafe static double Invoke(double x, double y)
	{
		...
		*unchecked((Int128*)(&fputil_FPBits_ubgsi3)) = -6148914691236517206L;
		...
		fputil_internal_FPStorage_fputil_FPType_3_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi3, anon_izyfb8.val);
