	...
	public unsafe static bool Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			...
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi6, y);
			Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&fputil_FPBits_ubgsi6);
