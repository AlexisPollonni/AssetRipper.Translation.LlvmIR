...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_bool_type_fputil_totalordermag_double_double_double
{
	public unsafe static bool Invoke(double x, double y)
	{
		...
		long num = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval_const.Invoke(&fputil_FPBits_wjhbrm2);
		...
		bool result = unchecked((ulong)num <= (ulong)fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval_const.Invoke(&fputil_FPBits_wjhbrm4));
