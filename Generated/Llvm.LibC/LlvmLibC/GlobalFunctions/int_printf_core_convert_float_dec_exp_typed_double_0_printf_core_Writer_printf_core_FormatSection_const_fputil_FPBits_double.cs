...
internal static partial class int_printf_core_convert_float_dec_exp_typed_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_double
{
	public unsafe static int Invoke(void* writer, void* to_conv, [MangledName("float_bits.coerce")] long float_bits)
	{
		int result = 0;
		...
		num2 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_explicit_exponent_const.Invoke(&fputil_FPBits_wjhbrm2);
		llvm_lifetime_start_p0.Invoke(16L, &x);
		unchecked
		{
			x = (Int128)(UInt128)(ulong)fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_wjhbrm2);
			llvm_lifetime_start_p0.Invoke(1L, &init_sign_char);
			init_sign_char = 0;
			if (fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg_const.Invoke(&fputil_FPBits_wjhbrm2))
			{
				init_sign_char = 45;
			}
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (num13 == num12)
				{
					...
					num15 = FloatToString_double_0_get_block_int.Invoke(&floatToString_dhsqbm, num6);
				...
				if ((b2 & 1) != 1)
				{
					checked
					{
						if (num6 >= 0)
						{
							...
							for (j = num6 - 1; j >= 0; j += -1)
							{
								...
								num17 = FloatToString_double_0_get_block_int.Invoke(&floatToString_dhsqbm, j);
								if (num17 != 0)
								{
									b2 = 1;
									num22 = 10;
					...
					{
						b2 = (sbyte)(byte)((cpp_enable_if_cpp_is_integral_v_unsigned_long_is_big_int_v_unsigned_long_bool_type_printf_core_zero_after_digits_unsigned_long_int_int_unsigned_long_int.Invoke(checked(num2 - 52), num3 - num5, fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_wjhbrm2), 52) ? 1 : 0) ^ -1);
					}
				}
				...
				num18 = printf_core_FloatWriter_write_last_block_unsigned_int_unsigned_long_printf_core_RoundDirection_int_char.Invoke(&printf_core_FloatWriter2, num7, num13, num16, num5, InstructionHelper.Select(internal_islower_int_175.Invoke(((printf_core_FormatSection*)to_conv)->conv_name), (sbyte)101, (sbyte)69));
				if (num18 < 0)
				{
					result = num18;
					num22 = 1;
