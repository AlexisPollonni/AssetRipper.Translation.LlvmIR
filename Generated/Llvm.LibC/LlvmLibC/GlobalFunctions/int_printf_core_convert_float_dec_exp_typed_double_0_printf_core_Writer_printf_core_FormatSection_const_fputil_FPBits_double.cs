...
internal static partial class int_printf_core_convert_float_dec_exp_typed_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_double
{
	public unsafe static int Invoke(printf_core_Writer* writer, printf_core_FormatSection* to_conv, [MangledName("float_bits.coerce")] long float_bits)
	{
		...
		unchecked
		{
			...
			init_sign_char = 0;
			if (fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)))
			{
				init_sign_char = 45;
			}
		...
		unchecked
		{
			...
			while (true)
			{
				...
				num18 = printf_core_FloatWriter_write_last_block_unsigned_int_unsigned_long_printf_core_RoundDirection_int_char.Invoke(&printf_core_FloatWriter2, num7, num13, (RoundDirection_zvveyk)num16, num5, InstructionHelper.Select(internal_islower_int_175.Invoke(to_conv->conv_name), (sbyte)101, (sbyte)69));
				if (num18 < 0)
				{
					result = num18;
					num22 = 1;
