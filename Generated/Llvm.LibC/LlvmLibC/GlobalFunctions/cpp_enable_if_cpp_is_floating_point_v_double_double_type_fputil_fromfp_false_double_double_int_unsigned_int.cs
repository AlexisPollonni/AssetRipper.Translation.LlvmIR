...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_double_type_fputil_fromfp_false_double_double_int_unsigned_int
{
		...
		unchecked
		{
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
				...
				if (fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_inf_or_nan_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3)))
				{
					fputil_raise_except_if_required_int.Invoke(1);
				...
				else
				{
					...
					else
					{
						...
						long val4 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value_Sign_unsigned_long_unsigned_long.Invoke(biased_exp: num3, sign: anon_izyfb11.val, mantissa: 0L);
						fputil_FPBits_wjhbrm6.FPRepImpl.FPRepSem.FPStorage.val = val4;
						double num5 = fputil_FPBits_double_get_val_const.Invoke(&fputil_FPBits_wjhbrm6) - 1.0;
