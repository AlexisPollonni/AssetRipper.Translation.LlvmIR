...
{
	public unsafe static double Invoke(int idx_x, double dx, double y6, double lo6_hi, void* exp2_hi_mid)
	{
		int num = 0;
		double num2 = 0.0;
		...
		unchecked
		{
			...
			*(double*)(&numberPair5) = double.NaN;
			...
			long num9 = num;
			Struct_4ydhja struct_4ydhja7 = fputil_add_NumberPair_double_const_NumberPair_double_const.Invoke((byte*)anonymous_namespace_LOG2_R2_DD.Pointer + (nint)num9 * sizeof(NumberPair), &numberPair4);
			...
			*(double*)(&numberPair10) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja25 = cpp_enable_if_sizeof_NumberPair_double_8ul_NumberPair_double_type_fputil_polyeval_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const.Invoke(&numberPair9, &inlineArray10_NumberPair, Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)2 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)3 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)4 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)5 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)6 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)7 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)8 * sizeof(NumberPair))), Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray10_NumberPair, (nint)9 * sizeof(NumberPair))));
