...
internal static partial class int_printf_core_convert_float_dec_exp_typed_long_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_long_double
{
	public unsafe static int Invoke(void* writer, void* to_conv, [MangledName("float_bits.coerce0")] long float_bits, [MangledName("float_bits.coerce1")] long FRACTION_LEN)
	{
		int result = 0;
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_ubgsi3) = float_bits;
			((long*)(&fputil_FPBits_ubgsi3))[1] = FRACTION_LEN;
			llvm_lifetime_start_p0.Invoke(4L, &num);
			num = 63;
			llvm_lifetime_start_p0.Invoke(4L, &num2);
			num2 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_exponent_const.Invoke(&fputil_FPBits_ubgsi3);
			...
			*(long*)num20 = struct_fiz2nb2.field_0;
			byte* num21 = (byte*)(&@int) + 8u;
			Struct_fiz2nb struct_fiz2nb3 = struct_fiz2nb;
			*(long*)num21 = struct_fiz2nb3.field_1;
			x = @int;
			llvm_lifetime_start_p0.Invoke(1L, &init_sign_char);
			init_sign_char = 0;
			if (fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				init_sign_char = 45;
			}
			...
			num3 = ((((printf_core_FormatSection*)to_conv)->precision >= 0) ? ((printf_core_FormatSection*)to_conv)->precision : 6);
			llvm_lifetime_start_p0.Invoke(1L, &b);
			b = (sbyte)(byte)((num3 == 0) ? ((((byte)((printf_core_FormatSection*)to_conv)->flags & 8) != 0) ? 1 : 0) : (-1));
			...
			*ptr = -86;
			...
			FloatToString_long_double_0_FloatToString_long_double.Invoke(&floatToString_8m29tk, fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi3));
			...
			if (NumericHelper.IntCmpNe(x, 0L))
			{
				...
				{
					num6 = checked(num6 + -1);
					num7 = FloatToString_long_double_0_get_block_int.Invoke(&floatToString_8m29tk, num6);
				}
			}
			else
			{
			...
			long num22 = IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_size_const.Invoke(&integerToString_uuwdyc);
		...
		long num23 = IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_size_const.Invoke(&integerToString_uuwdyc2);
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (num13 == num12)
				{
					...
					num15 = FloatToString_long_double_0_get_block_int.Invoke(&floatToString_8m29tk, num6);
				...
				checked
				{
					if ((b2 & 1) != 1)
					{
						if (num6 >= 0)
						{
							...
							for (j = num6 - 1; j >= 0; j += -1)
							{
								...
								num17 = FloatToString_long_double_0_get_block_int.Invoke(&floatToString_8m29tk, j);
								if (num17 != 0)
								{
									b2 = 1;
									num24 = 10;
						...
						if ((b2 & 1) != 1 && num2 - 63 < 0)
						{
							...
							unchecked
							{
								...
								Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
								Int128* num25 = &int2;
								Struct_fiz2nb struct_fiz2nb5 = struct_fiz2nb4;
								*(long*)num25 = struct_fiz2nb5.field_0;
								byte* num26 = (byte*)(&int2) + 8u;
								Struct_fiz2nb struct_fiz2nb6 = struct_fiz2nb4;
								*(long*)num26 = struct_fiz2nb6.field_1;
								int3 = int2;
								b2 = (sbyte)(byte)((cpp_enable_if_cpp_is_integral_v_unsigned_int128_is_big_int_v_unsigned_int128_bool_type_printf_core_zero_after_digits_unsigned_int128_int_int_unsigned_int128_int.Invoke(base_2_exp, digits_after_point, *(long*)(&int3), ((long*)(&int3))[1], 63) ? 1 : 0) ^ -1);
							}
						}
					}
					...
					num16 = printf_core_get_round_direction_int_bool_Sign.Invoke(last_digit, truncated, anon_izyfb8.val);
					llvm_lifetime_start_p0.Invoke(4L, &num18);
				}
				num18 = printf_core_FloatWriter_write_last_block_unsigned_int_unsigned_long_printf_core_RoundDirection_int_char.Invoke(&printf_core_FloatWriter2, num7, num13, num16, num5, InstructionHelper.Select(internal_islower_int.Invoke(((printf_core_FormatSection*)to_conv)->conv_name), (sbyte)101, (sbyte)69));
				if (num18 < 0)
				{
					result = num18;
					num24 = 1;
