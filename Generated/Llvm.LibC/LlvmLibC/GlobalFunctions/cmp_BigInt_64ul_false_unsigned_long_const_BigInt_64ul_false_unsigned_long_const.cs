	...
	public unsafe static int Invoke(BigInt_nx6qdt* lhs, BigInt_nx6qdt* rhs)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				num2 = cmp_BigInt_64ul_false_unsigned_long_const_BigInt_64ul_false_unsigned_long_const_lambda_unsigned_long_unsigned_long_operator_unsigned_long_unsigned_long_const.Invoke(&anon_izyfb8, *(long*)BigInt_64ul_false_unsigned_long_operator_unsigned_long_const_64yjsu.Invoke(lhs, num), *(long*)BigInt_64ul_false_unsigned_long_operator_unsigned_long_const_64yjsu.Invoke(rhs, num));
				if (num2 != 0)
				{
					result = num2;
					num4 = 1;
