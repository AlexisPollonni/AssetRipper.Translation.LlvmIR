	...
	public unsafe static double Invoke([NativeType("__float128")] double x)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			bool num = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
			...
			else
			{
				...
				Struct_fiz2nb struct_fiz2nb = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_max_normal.Invoke(anon_izyfb9.val);
				...
				if (internal_Equals_svxrxh.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud10), ((long*)(&fputil_internal_FPRepImpl_jrxud10))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud11), ((long*)(&fputil_internal_FPRepImpl_jrxud11))[1]))
				{
					num2 = -1;
				}
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb4 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_inf.Invoke(anon_izyfb10.val);
					...
					num2 = (internal_Equals_svxrxh.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud12), ((long*)(&fputil_internal_FPRepImpl_jrxud12))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud13), ((long*)(&fputil_internal_FPRepImpl_jrxud13))[1]) ? 1 : 0);
				}
			}
			...
			else
			{
				if (NumericHelper.IsUnorderedOrNotEquals(x, 0.0))
				{
					...
					if (Equals_fy8fvt.Invoke(anon_izyfb11.val, anon_izyfb12.val))
					{
						...
						Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval.Invoke(&fputil_FPBits_ubgsi3);
						Int128* num3 = &x2;
						...
						*(long*)num4 = struct_fiz2nb9.field_1;
						...
						FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi6, *(long*)(&@int), ((long*)(&@int))[1]);
					...
					else
					{
						...
						*(long*)num6 = struct_fiz2nb12.field_1;
						...
						FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi7, *(long*)(&int2), ((long*)(&int2))[1]);
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb13 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_min_subnormal.Invoke(anon_izyfb13.val);
