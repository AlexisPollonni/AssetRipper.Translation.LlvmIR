	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			result = ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi))) ? ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi2))) ? Internal_max_float128.Invoke(X, Y) : X) : Y);
			goto IL_01ad;
		}
		IL_01ad:
