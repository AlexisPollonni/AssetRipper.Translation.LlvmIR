...
internal static partial class void_fputil_internal_normalize_float128_int_fputil_FPBits_float128_StorageType
{
	public unsafe static void Invoke(void* exponent, void* mantissa)
	{
		...
		num = unchecked(cpp_enable_if_cpp_is_unsigned_v_unsigned_int128_int_type_cpp_countl_zero_unsigned_int128_unsigned_int128.Invoke(*(long*)(&@int), ((long*)(&@int))[1])) - 15;
