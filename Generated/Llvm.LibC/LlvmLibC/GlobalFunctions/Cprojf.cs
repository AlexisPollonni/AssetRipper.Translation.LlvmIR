...
internal static partial class Cprojf
{
	[MangledName("cprojf")]
	[DemangledName("cprojf")]
	public unsafe static InlineArray2_Single Invoke([MangledName("x.coerce")] InlineArray2_Single X)
	{
		...
		unchecked
		{
			...
			*ptr = field_2;
			*(InlineArray2_Single*)(&struct_kh2xpj4) = Llvm_libc_20_1_2_project_float_complex.Invoke(*(InlineArray2_Single*)(&struct_kh2xpj3));
