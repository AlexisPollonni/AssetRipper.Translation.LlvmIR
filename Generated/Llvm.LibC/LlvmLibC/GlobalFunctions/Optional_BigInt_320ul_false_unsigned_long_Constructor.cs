...
internal static partial class Optional_BigInt_320ul_false_unsigned_long_Constructor
{
	...
	{
		OptionalStorage_BigInt_320ul_false_unsigned_long_false_Constructor.Invoke(&unchecked((Llvm_libc_20_1_2_cpp_optional_t82b4p*)This)->Storage);
	}
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("t")][NativeType("__llvm_libc_20_1_2_::BigInt<320ul, false, unsigned long>&&")] Llvm_libc_20_1_2_BigInt_76gxx6* T)
	{
		unchecked
		{
			OptionalStorage_BigInt_320ul_false_unsigned_long_false_OptionalStorage_BigInt_320ul_false_unsigned_long.Invoke(&((Llvm_libc_20_1_2_cpp_optional_t82b4p*)This)->Storage, Cpp_move_BigInt_320ul_false_unsigned_long.Invoke(T));
			((Llvm_libc_20_1_2_cpp_optional_t82b4p*)This)->Storage.field_1 = 1;
		}
	}
}
