...
{
	public unsafe static int Invoke(BigInt_ys7s55* value)
	{
		return int_multiword_countl_zero_unsigned_short_1ul_cpp_array_unsigned_short_1ul_const.Invoke(&value->val);
	}
}
