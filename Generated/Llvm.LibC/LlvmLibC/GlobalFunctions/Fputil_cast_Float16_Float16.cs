...
internal static partial class Fputil_cast_Float16_Float16
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<_Float16> && cpp::is_floating_point_v<_Float16>, _Float16>::type")]
	public static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X)
	{
		return X;
	}
}
