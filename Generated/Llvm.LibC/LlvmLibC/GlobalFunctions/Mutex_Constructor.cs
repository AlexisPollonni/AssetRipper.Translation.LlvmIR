...
internal static partial class Mutex_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Mutex* This, [MangledName("is_timed")][NativeType("bool")] bool Is_timed, [MangledName("is_recursive")][NativeType("bool")] bool Is_recursive, [MangledName("is_robust")][NativeType("bool")] bool Is_robust, [MangledName("is_pshared")][NativeType("bool")] bool Is_pshared)
	{
