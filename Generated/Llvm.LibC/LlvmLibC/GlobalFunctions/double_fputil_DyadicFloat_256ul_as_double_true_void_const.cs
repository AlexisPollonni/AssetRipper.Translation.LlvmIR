...
internal static partial class double_fputil_DyadicFloat_256ul_as_double_true_void_const
{
	public unsafe static double Invoke(fputil_DyadicFloat_jhcpjj* @this)
	{
		return double_fputil_DyadicFloat_256ul_fast_as_double_true_void_const.Invoke(@this);
	}
}
