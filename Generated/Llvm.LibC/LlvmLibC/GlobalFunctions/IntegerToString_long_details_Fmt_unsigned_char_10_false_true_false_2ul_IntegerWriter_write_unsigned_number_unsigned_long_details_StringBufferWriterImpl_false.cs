...
internal static partial class IntegerToString_long_details_Fmt_unsigned_char_10_false_true_false_2ul_IntegerWriter_write_unsigned_number_unsigned_long_details_StringBufferWriterImpl_false
{
	public unsafe static void Invoke(long value, details_StringBufferWriterImpl* sink)
	{
		...
		unchecked
		{
			while (details_StringBufferWriterImpl_false_ok_const.Invoke(sink) && num != 0L)
			{
				...
				details_StringBufferWriterImpl_false_push_char.Invoke(sink, IntegerToString_long_details_Fmt_unsigned_char_10_false_true_false_2ul_IntegerWriter_digit_char_unsigned_char.Invoke(digit));
