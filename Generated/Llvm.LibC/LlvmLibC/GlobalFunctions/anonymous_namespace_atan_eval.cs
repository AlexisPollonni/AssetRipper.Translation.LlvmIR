...
internal static partial class anonymous_namespace_atan_eval
{
	...
	public unsafe static Struct_4ydhja Invoke([NativeType("__llvm_libc_20_1_2_::NumberPair<double> const&")] NumberPair* x)
	{
		...
		unchecked
		{
			*(double*)(&numberPair) = double.NaN;
			...
			numberPair.lo = fputil_multiply_add_double.Invoke(x2, y2, z2);
