...
internal static partial class StringBufferWriterImpl_false_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Details_StringBufferWriterImpl* This, [MangledName("buffer.coerce0")] void* Buffer, [MangledName("buffer.coerce1")] long Buffer_coerce1)
	{
		Cpp_string_view cpp_string_view = default(Cpp_string_view);
		unchecked
		{
			*(void**)(&cpp_string_view) = Buffer;
			((long*)(&cpp_string_view))[1] = Buffer_coerce1;
			Span_char_span_char_true.Invoke(&This->Buffer, &cpp_string_view);
			This->Index = 0L;
			This->Out_of_range = 0;
		}
	}
