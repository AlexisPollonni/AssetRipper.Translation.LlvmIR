...
internal static partial class Operator_qdjidv
{
	...
	[CleanName("Operator")]
	public unsafe static int Invoke([MangledName("lhs")][NativeType("__llvm_libc_20_1_2_::BigInt<32ul, false, unsigned int>&")] BigInt_vtm4cw* Lhs, [MangledName("rhs")][NativeType("__llvm_libc_20_1_2_::BigInt<32ul, false, unsigned int> const&")] BigInt_vtm4cw* Rhs)
	{
