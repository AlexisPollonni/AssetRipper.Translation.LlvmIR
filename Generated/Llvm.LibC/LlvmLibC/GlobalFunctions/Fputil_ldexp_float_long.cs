...
internal static partial class Fputil_ldexp_float_long
{
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X, [MangledName("exp")][NativeType("long")] long Exp)
	{
		...
		llvm_libc_20_1_2_fputil_DyadicFloat_cs3nhs.Exponent += unchecked((int)Exp);
