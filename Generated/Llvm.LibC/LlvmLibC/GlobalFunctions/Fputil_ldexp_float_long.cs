...
internal static partial class Fputil_ldexp_float_long
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil5ldexpIflEENS_3cpp9enable_ifIXaasr3cppE19is_floating_point_vIT_Esr3cppE13is_integral_vIT0_EES4_E4typeES4_S5_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<float> && cpp::is_integral_v<long>, float>::type __llvm_libc_20_1_2_::fputil::ldexp<float, long>(float, long)")]
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<float> && cpp::is_integral_v<long>, float>::type")]
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X, [MangledName("exp")][NativeType("long")] long Exp)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			if (Details_expects_bool_condition_bool.Invoke(Exp == 0L || FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&fputil_FPBits_5nkvcs) || FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)), Expected: false))
			{
				result = X;
				goto IL_05ae;
			}
			...
			num = 279;
			if (Details_expects_bool_condition_bool.Invoke(Exp > 279L, Expected: false))
			{
		...
		fputil_DyadicFloat_cs3nhs.Exponent += unchecked((int)Exp);
		result = DyadicFloat_32ul_as_float_true_void.Invoke(&fputil_DyadicFloat_cs3nhs);
