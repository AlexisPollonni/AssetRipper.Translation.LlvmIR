...
internal static partial class Fixed_point_bit_not_long_Fract
{
	...
	public unsafe static int Invoke([MangledName("x")][NativeType("long _Fract")] int X)
	{
		int num = 0;
		int num2 = 0;
		int num3 = X;
		Llvm_lifetime_start_p0.Invoke(4L, &num);
		num = Cpp_bit_cast_unsigned_int_long_Fract.Invoke(&num3);
		Llvm_lifetime_start_p0.Invoke(4L, &num2);
		num2 = num ^ -1;
		int result = Cpp_bit_cast_long_Fract_unsigned_int.Invoke(&num2);
