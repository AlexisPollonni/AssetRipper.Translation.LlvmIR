...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_long_double_sizeof_double_sizeof_long_double_double_type_fputil_generic_add_double_long_double_long_double_long_double
{
	public static double Invoke(double x, double y)
	{
		return cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_long_double_sizeof_double_sizeof_long_double_double_type_fputil_generic_add_or_sub_false_double_long_double_long_double_long_double.Invoke(x, y);
	}
}
