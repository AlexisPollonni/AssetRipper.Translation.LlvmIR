...
internal static partial class double_fputil_DyadicFloat_128ul_as_double_false_void_const
{
	public unsafe static double Invoke(fputil_DyadicFloat_kt2kd4* @this)
	{
		return double_fputil_DyadicFloat_128ul_fast_as_double_false_void_const.Invoke(@this);
	}
}
