...
internal static partial class BigInt_64ul_false_unsigned_long_sub_overflow_BigInt_64ul_false_unsigned_long_const
{
	...
	{
		return unchecked(unsigned_long_multiword_sub_with_borrow_unsigned_long_1ul_1ul_cpp_array_unsigned_long_1ul_cpp_array_unsigned_long_1ul_const.Invoke(&((BigInt_nx6qdt*)@this)->val, &((BigInt_nx6qdt*)rhs)->val));
	}
}
