	...
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			float result = ((!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs))) ? Fputil_trunc_float_0.Invoke(X) : (0f - Fputil_ceil_float_0.Invoke(0f - X)));
