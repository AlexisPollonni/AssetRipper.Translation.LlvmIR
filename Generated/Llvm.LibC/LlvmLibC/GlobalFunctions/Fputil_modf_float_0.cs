	...
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X, [MangledName("iptr")][NativeType("float&")] void* Iptr)
	{
		...
		unchecked
		{
			*(int*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) = -1431655766;
			...
			float result;
			if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) || FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs))
			{
				*(float*)Iptr = X;
				result = X;
			}
