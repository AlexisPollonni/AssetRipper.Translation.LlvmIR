...
internal static partial class FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent
{
	...
	public unsafe static short Invoke([MangledName("this")] Fputil_internal_FPRepImpl_vhj4tm* This)
	{
		...
		short result = unchecked((short)TypedInt_unsigned_int_ToUInt32_tsgje4.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent));
