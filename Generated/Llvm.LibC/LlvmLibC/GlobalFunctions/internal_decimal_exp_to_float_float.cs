	...
	public unsafe static Struct_3driym Invoke([MangledName("init_num.coerce")][NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<float>")] long init_num, [NativeType("bool")] bool truncated, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round, [NativeType("char const*")] void* numStart, [NativeType("unsigned long")] long num_len)
	{
		...
		unchecked
		{
			...
			*(int*)ptr = -1431655766;
			...
			FloatConvertReturn_float_Constructor.Invoke(&internal_FloatConvertReturn_a8f9er3);
			...
			*ptr4 = -86;
			ptr4[1] = -86;
			ptr4[2] = -86;
			optional_internal_ExpandedFloat_float_Constructor_fbx47x.Invoke(&cpp_optional_6hseum2);
			...
			else
			{
				if ((b & 1) != 1)
				{
					...
					Struct_8myw6y struct_8myw6y4 = internal_clinger_fast_path_float.Invoke(*(long*)(&internal_ExpandedFloat_i7t5up5), round);
					...
					if (optional_internal_ExpandedFloat_float_has_value.Invoke(&cpp_optional_6hseum2))
					{
						llvm_memcpy_p0_p0_i64.Invoke(&internal_FloatConvertReturn_a8f9er2.num, optional_internal_ExpandedFloat_float_value.Invoke(&cpp_optional_6hseum2), 8L, isVolatile: false);
				...
				Struct_8myw6y struct_8myw6y5 = internal_eisel_lemire_float.Invoke(*(long*)(&internal_ExpandedFloat_i7t5up6), round);
				...
				if (optional_internal_ExpandedFloat_float_has_value.Invoke(&cpp_optional_6hseum2))
				{
					...
					*ptr7 = -86;
					...
					Struct_8myw6y struct_8myw6y6 = internal_eisel_lemire_float.Invoke(*(long*)(&internal_ExpandedFloat_i7t5up7), round);
					...
					int num3;
					if (optional_internal_ExpandedFloat_float_has_value.Invoke(&cpp_optional_6hseum5) && optional_internal_ExpandedFloat_float_PointerDereference.Invoke(&cpp_optional_6hseum2)->mantissa == optional_internal_ExpandedFloat_float_PointerDereference.Invoke(&cpp_optional_6hseum5)->mantissa && optional_internal_ExpandedFloat_float_PointerDereference.Invoke(&cpp_optional_6hseum2)->exponent == optional_internal_ExpandedFloat_float_PointerDereference.Invoke(&cpp_optional_6hseum5)->exponent)
					{
						llvm_memcpy_p0_p0_i64.Invoke(&internal_FloatConvertReturn_a8f9er2.num, optional_internal_ExpandedFloat_float_value.Invoke(&cpp_optional_6hseum2), 8L, isVolatile: false);
						internal_FloatConvertReturn_a8f9er2.error = 0;
						num3 = 1;
