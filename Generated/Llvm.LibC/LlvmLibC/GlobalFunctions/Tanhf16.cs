			...
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			if (Details_expects_bool_condition_bool.Invoke(((uint)(ushort)num2 > 12104u) ? ((uint)(ushort)num2 >= 17449u) : true, Expected: false))
			{
				...
				else if ((uint)(ushort)num >= 33792u && (uint)(ushort)num <= 38912u)
				{
					...
					else
					{
						...
						FPBits_Float16_FPBits_unsigned_short.Invoke(&llvm_libc_20_1_2_fputil_FPBits_2fahva3, (short)((ushort)num - 1));
				...
				else
				{
					...
					if ((num4 == 0 && (uint)(ushort)num2 >= 17538u) || (num4 == 2048 && FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva))) || (num4 == 1024 && FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva))))
					{
					...
					{
						result = ((!FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva))) ? Fputil_cast_Float16_double.Invoke(-0.99951171875) : Fputil_cast_Float16_double.Invoke(0.99951171875));
					}
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_2ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_TANHF16_EXCEPTS.Pointer);
				*(int*)(&llvm_libc_20_1_2_cpp_optional_aq7wey.Storage) = storage;
				...
				case 0:
				{
					...
					x3 = *(int*)Array_unsigned_int_32ul_Index.Invoke(Index: (uint)num9, This: Llvm_libc_20_1_2_EXP2_MID_5_BITS.Pointer) + (num8 << 23);
					Llvm_lifetime_start_p0.Invoke(4L, &num10);
					Llvm_lifetime_start_p0.Invoke(4L, &llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
					FPBits_float_FPBits_unsigned_int.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs, x3);
					float num14 = FPBits_float_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
