...
internal static partial class Cprojf16
{
	[MangledName("cprojf16")]
	[DemangledName("cprojf16")]
	public unsafe static InlineArray2_Half Invoke([MangledName("x.coerce")] InlineArray2_Half X)
	{
		...
		unchecked
		{
			...
			*ptr = field_2;
			*(InlineArray2_Half*)(&struct_zwcg4) = Llvm_libc_20_1_2_project_Float16_complex.Invoke(*(InlineArray2_Half*)(&struct_zwcg3));
