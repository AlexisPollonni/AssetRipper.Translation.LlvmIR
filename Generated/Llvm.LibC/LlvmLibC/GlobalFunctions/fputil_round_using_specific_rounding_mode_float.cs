...
internal static partial class fputil_round_using_specific_rounding_mode_float
{
	...
	public unsafe static float Invoke([NativeType("float")] float x, [NativeType("int")] int rnd)
	{
			...
			else
			{
				...
				else if (num <= -1)
				{
					result = rnd switch
					{
						...
						_ => (num > -2 && FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) != 0) ? InstructionHelper.Select((b & 1) == 1, -1f, 1f) : InstructionHelper.Select((b & 1) == 1, -0f, 0f), 
					};
				}
				else
				{
					...
					else
					{
						...
						*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
						FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs3, num4);
						llvm_lifetime_start_p0.Invoke(4L, &num5);
						num5 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs3);
						llvm_lifetime_start_p0.Invoke(4L, &num6);
						num6 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) & ((1 << num2) - 1);
						llvm_lifetime_start_p0.Invoke(4L, &num7);
						num7 = 1 << num2 - 1;
						llvm_lifetime_start_p0.Invoke(4L, &num8);
						num8 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3)) & (1 << num2);
						result = rnd switch
						{
