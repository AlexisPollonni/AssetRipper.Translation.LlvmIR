...
[MangledName("_ZN19__llvm_libc_20_1_2_7generic14MemcmpSequenceIjJhEE5blockEPKNS_3cpp4byteES6_")]
[DemangledName("__llvm_libc_20_1_2_::generic::MemcmpSequence<unsigned int, unsigned char>::block(__llvm_libc_20_1_2_::cpp::byte const*, __llvm_libc_20_1_2_::cpp::byte const*)")]
internal static partial class generic_MemcmpSequence_unsigned_int_unsigned_char_block_cpp_byte_const_cpp_byte_const
{
	public unsafe static int Invoke(void* p1, void* p2)
	{
		...
		unchecked
		{
			*(int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2) = -1431655766;
			...
			{
				fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2.field_0 = generic_MemcmpSequence_unsigned_char_block_cpp_byte_const_cpp_byte_const.Invoke((byte*)p1 + 4, (byte*)p2 + 4);
			}
