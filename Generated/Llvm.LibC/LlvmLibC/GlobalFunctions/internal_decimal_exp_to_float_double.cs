	...
	public unsafe static void Invoke([MangledName("agg.result")] internal_FloatConvertReturn_g92bm8* agg_result, [MangledName("init_num.coerce0")] long init_num, [MangledName("init_num.coerce1")] int truncated, [MangledName("truncated")] bool round, [MangledName("round")] int numStart, [MangledName("numStart")] void* num_len, [MangledName("num_len")] long mantissa)
	{
		...
		unchecked
		{
			...
			*ptr3 = -86;
			...
			ptr3[2] = -86;
			ptr3[3] = -86;
			FloatConvertReturn_double_Constructor.Invoke(&internal_FloatConvertReturn_g92bm9);
			...
			*ptr7 = -86;
			...
			ptr7[5] = -86;
			ptr7[6] = -86;
			optional_internal_ExpandedFloat_double_Constructor_6vskuc.Invoke(&cpp_optional_9m4esb2);
			...
			else
			{
				if ((b & 1) != 1)
				{
					...
					internal_clinger_fast_path_double.Invoke(&cpp_optional_9m4esb3, *(long*)(&internal_ExpandedFloat_k68bhv5), ((RoundDirection_b3pcwy*)(&internal_ExpandedFloat_k68bhv5))[2], numStart);
					...
					if (optional_internal_ExpandedFloat_double_has_value.Invoke(&cpp_optional_9m4esb2))
					{
						llvm_memcpy_p0_p0_i64.Invoke(&agg_result->num, optional_internal_ExpandedFloat_double_value.Invoke(&cpp_optional_9m4esb2), 16L, isVolatile: false);
						agg_result->error = 0;
						goto IL_0608;
					}
				}
				...
				if (optional_internal_ExpandedFloat_double_has_value.Invoke(&cpp_optional_9m4esb2))
				{
					...
					*ptr11 = -86;
					...
					internal_eisel_lemire_double.Invoke(&cpp_optional_9m4esb5, *(long*)(&internal_ExpandedFloat_k68bhv7), ((RoundDirection_b3pcwy*)(&internal_ExpandedFloat_k68bhv7))[2], numStart);
					int num3;
					if (optional_internal_ExpandedFloat_double_has_value.Invoke(&cpp_optional_9m4esb5) && optional_internal_ExpandedFloat_double_PointerDereference.Invoke(&cpp_optional_9m4esb2)->mantissa == optional_internal_ExpandedFloat_double_PointerDereference.Invoke(&cpp_optional_9m4esb5)->mantissa && optional_internal_ExpandedFloat_double_PointerDereference.Invoke(&cpp_optional_9m4esb2)->exponent == optional_internal_ExpandedFloat_double_PointerDereference.Invoke(&cpp_optional_9m4esb5)->exponent)
					{
						llvm_memcpy_p0_p0_i64.Invoke(&agg_result->num, optional_internal_ExpandedFloat_double_value.Invoke(&cpp_optional_9m4esb2), 16L, isVolatile: false);
						agg_result->error = 0;
						num3 = 1;
				...
				internal_simple_decimal_conversion_double.Invoke(&internal_FloatConvertReturn_g92bm10, num_len, mantissa, (RoundDirection_b3pcwy)numStart);
