...
internal static partial class multiword_shift_multiword_Direction_0_false_unsigned_long_5ul
{
			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un2) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 5uL; num5++)
				{
					...
					num6 = lambda0_Invoke_cbh959.Invoke(&anon_6je4un2, num5 + num3);
					llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = lambda0_Invoke_cbh959.Invoke(&anon_6je4un2, num5 + num3 + 1L);
					llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = array_unsigned_long_5ul_Index_wu6ki8.Invoke(agg_result, lambda_Invoke_xph9by.Invoke(&anon_izyfb8, num5));
					if (num4 == 0L)
					{
						*(long*)ptr = num6;
					}
