...
internal static partial class FPRepImpl_fputil_FPType_1_fputil_FPBits_float_abs
{
	...
	public unsafe static int Invoke(fputil_internal_FPRepImpl_vhj4tm* @this)
	{
		...
		FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, unchecked((fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt*)@this)->field_0 & 0x7FFFFFFF);
