...
internal static partial class fputil_round_using_specific_rounding_mode_Float16
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x, [NativeType("int")] int rnd)
	{
			...
			else
			{
				...
				else if (num <= -1)
				{
					result = rnd switch
					{
						...
						_ => (num > -2 && (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) != 0) ? InstructionHelper.Select((b & 1) == 1, default(Half), default(Half)) : InstructionHelper.Select((b & 1) == 1, default(Half), default(Half)), 
					};
				}
				else
				{
					...
					else
					{
						...
						*(short*)(&fputil_FPBits_2fahva3) = -21846;
						FPBits_Float16_FPBits_unsigned_short.Invoke(&fputil_FPBits_2fahva3, num4);
						llvm_lifetime_start_p0.Invoke(2L, &half);
						half = FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva3);
						llvm_lifetime_start_p0.Invoke(2L, &num5);
						num5 = (short)((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) & (ushort)(short)checked((1 << num2) - 1));
						llvm_lifetime_start_p0.Invoke(2L, &num6);
						num6 = (short)(1 << num2 - 1);
						llvm_lifetime_start_p0.Invoke(2L, &num7);
						num7 = (short)((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)) & (1 << num2));
						result = rnd switch
						{
