...
internal static partial class FPStorage_fputil_FPType_0_set_biased_exponent
{
	...
	public unsafe static void Invoke(void* @this, [MangledName("biased.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::BiasedExponent")] int biased)
	{
		...
		unchecked
		{
			...
			((fputil_internal_FPStorage_za9n4f*)@this)->field_0 = FPStorage_fputil_FPType_0_merge.Invoke(field_, FPStorage_fputil_FPType_0_encode.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3.field_0.field_0), 31744);
		}
	}
}
