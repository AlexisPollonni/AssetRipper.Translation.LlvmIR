...
[MangledName("_ZN19__llvm_libc_20_1_2_6fputil6fromfpILb1EgEENS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT0_EES4_E4typeES4_ij")]
[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<__float128>, __float128>::type __llvm_libc_20_1_2_::fputil::fromfp<true, __float128>(__float128, int, unsigned int)")]
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float128_float128_type_fputil_fromfp_true_float128_float128_int_unsigned_int
{
				...
				*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
				...
				else
				{
					...
					else
					{
						...
						int6 = 0L;
						Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val3, biased_exp, mantissa, *(long*)(&int6), ((long*)(&int6))[1]);
						...
						double num4 = fputil_FPBits_float128_get_val_const.Invoke(&fputil_FPBits_ubgsi6);
						...
						if (num < num2)
						{
							...
							int7 = 0L;
							Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan_Sign_unsigned_int128.Invoke(val4, *(long*)(&int7), ((long*)(&int7))[1]);
						...
						else
						{
							...
							int9 = 0L;
							Struct_fiz2nb struct_fiz2nb13 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val5, biased_exp2, mantissa2, *(long*)(&int9), ((long*)(&int9))[1]);
							...
							double num5 = fputil_FPBits_float128_get_val_const.Invoke(&fputil_FPBits_ubgsi8) - 1.0;
							...
							if (num > num3)
							{
								...
								int10 = 0L;
								Struct_fiz2nb struct_fiz2nb16 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan_Sign_unsigned_int128.Invoke(val6, *(long*)(&int10), ((long*)(&int10))[1]);
								...
								result = fputil_FPBits_float128_get_val_const.Invoke(&fputil_FPBits_ubgsi9);
