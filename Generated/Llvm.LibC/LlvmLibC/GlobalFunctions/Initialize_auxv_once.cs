...
{
	public unsafe static readonly void* __pointer = (delegate*<void>)(&Invoke);
		...
		unchecked
		{
			...
			*(int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt) = -1431655766;
			...
			while (num != 0L)
			{
				...
				num3 = ((delegate*<int, void*, long, long>)Read.__pointer)(AuxvFdGuard_get.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt), ptr2, num);
				if (num3 <= 0L)
				{
