	...
	public unsafe static void Invoke([NativeType("__llvm_libc_20_1_2_::cpp::byte*")] void* dst, [NativeType("__llvm_libc_20_1_2_::cpp::byte const*")] void* src, [NativeType("unsigned long")] long count)
	{
		...
		unchecked
		{
			...
			*(InlineArray16_SByte*)ptr = InlineArrayHelper.Create<InlineArray16_SByte, byte>(new byte[16]
			...
			generic_load_cpp_array_unsigned_char_vector_16_2ul.Invoke(&cpp_array_ueviby2, src);
			...
			*(InlineArray16_SByte*)ptr2 = InlineArrayHelper.Create<InlineArray16_SByte, byte>(new byte[16]
			...
			generic_load_cpp_array_unsigned_char_vector_16_2ul.Invoke(&cpp_array_ueviby3, (byte*)src + num);
			...
			generic_store_cpp_array_unsigned_char_vector_16_2ul.Invoke(dst2, &cpp_array_ueviby5);
