...
internal static partial class NormalFloat_float128_Float128
{
	...
	public unsafe static double Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie* This)
	{
		int num = 0;
		int num2 = 0;
		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, 0.0);
				Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb2, &This->Sign, 1L, isVolatile: false);
				FPStorage_fputil_FPType_3_set_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, anon_izyfb2.Val);
				...
				if (This->Exponent < -16382)
				{
					...
					if ((uint)num4 <= 113u)
					{
						...
						@int = 0L;
						FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&@int), ((long*)(&@int))[1]);
						int2 = NumericHelper.ShiftRightLogical(This->Mantissa, (Int128)(UInt128)(uint)num4);
						FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&int2), ((long*)(&int2))[1]);
						...
						*(long*)num6 = struct_fiz2nb6.field_1;
						...
						{
							Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
							Int128* num7 = &x2;
						...
						int5 = int3;
						FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&int5), ((long*)(&int5))[1]);
						if (NumericHelper.IntCmpEq(int3, 0L))
						{
							int6 = 1L;
							FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&int6), ((long*)(&int6))[1]);
						}
				...
				else
				{
					...
					FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&int7), ((long*)(&int7))[1]);
					int8 = This->Mantissa;
					FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&int8), ((long*)(&int8))[1]);
					result = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
				}
