...
internal static partial class fputil_ExceptValues_Float16_5ul_lookup_unsigned_short_const
{
	public unsafe static int Invoke(void* @this, short x_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num3 == (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_ist8fx*)@this)->values))[num].input, expected: false))
				{
					llvm_lifetime_start_p0.Invoke(2L, &num2);
					num2 = ((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_ist8fx*)@this)->values))[num].rnd_towardzero_result;
					switch (fputil_quick_get_round.Invoke())
					{
					case 2048:
					{
						int num7 = (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_ist8fx*)@this)->values))[num].rnd_upward_offset;
						num2 = (short)checked(unchecked((ushort)num2) + num7);
						break;
					}
					case 1024:
					{
						int num6 = (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_ist8fx*)@this)->values))[num].rnd_downward_offset;
						num2 = (short)checked(unchecked((ushort)num2) + num6);
						break;
					}
					case 0:
					{
						int num5 = (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_ist8fx*)@this)->values))[num].rnd_tonearest_offset;
