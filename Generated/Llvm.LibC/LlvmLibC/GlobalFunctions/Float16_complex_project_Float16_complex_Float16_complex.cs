...
internal static partial class Float16_complex_project_Float16_complex_Float16_complex
{
	public unsafe static InlineArray2_Half Invoke([MangledName("c.coerce")] InlineArray2_Half c)
	{
		...
		Complex_ueqjqt complex_ueqjqt2 = default(Complex_ueqjqt);
		...
		unchecked
		{
			...
			*(InlineArray2_Half*)(&complex_ueqjqt) = cpp_enable_if_sizeof_Complex_Float16_sizeof_Float16_complex_cpp_is_trivially_constructible_Complex_Float16_value_cpp_is_trivially_copyable_Complex_Float16_value_cpp_is_trivially_copyable_Float16_complex_value_Complex_Float16_type_cpp_bit_cast_Complex_Float16_Float16_complex_Float16_complex_const.Invoke(&struct_zwcg2);
			...
			if (num2 != 0)
			{
				llvm_lifetime_start_p0.Invoke(4L, &complex_ueqjqt2);
				...
				complex_ueqjqt2.real = fputil_FPBits_Float16_get_val_const.Invoke(&fputil_FPBits_2fahva4);
				complex_ueqjqt2.imag = (Half)InstructionHelper.Select(NumericHelper.FcmpOgt(complex_ueqjqt.imag, default(Half)), 0.0, -0.0);
				...
				*ptr = field_3;
				...
				llvm_lifetime_end_p0.Invoke(4L, &complex_ueqjqt2);
			}
			else
			{
