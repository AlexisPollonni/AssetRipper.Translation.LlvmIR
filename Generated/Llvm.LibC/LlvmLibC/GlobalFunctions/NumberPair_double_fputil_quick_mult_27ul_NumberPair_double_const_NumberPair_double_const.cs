	...
	public unsafe static Struct_4ydhja Invoke(void* a, void* b)
	{
		...
		unchecked
		{
			*(double*)(&numberPair) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = NumberPair_double_fputil_exact_mult_27ul_double_double.Invoke(((NumberPair*)a)->hi, ((NumberPair*)b)->hi);
			...
			*(double*)num3 = struct_4ydhja3.field_1;
			...
			z = fputil_multiply_add_double_double_double.Invoke(((NumberPair*)a)->hi, ((NumberPair*)b)->lo, numberPair.lo);
			llvm_lifetime_start_p0.Invoke(8L, &num);
			num = (numberPair.lo = fputil_multiply_add_double_double_double.Invoke(((NumberPair*)a)->lo, ((NumberPair*)b)->hi, z));
