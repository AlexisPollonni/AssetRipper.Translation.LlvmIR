...
internal static partial class cpp_enable_if_cpp_is_fixed_point_v_unsigned_Fract_unsigned_Fract_type_fixed_point_sqrt_unsigned_Fract_unsigned_Fract
{
	public unsafe static short Invoke(short x)
	{
		...
		short result;
		if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(unchecked((ushort)num) == 0, expected: false))
		{
			result = fixed_point_FXRep_unsigned_Fract_ZERO.Invoke();
		}
		else
		{
			...
			unchecked
			{
				...
				num7 = fixed_point_internal_SqrtConfig_unsigned_Fract_Type_fixed_point_sqrt_core_fixed_point_internal_SqrtConfig_unsigned_Fract_fixed_point_internal_SqrtConfig_unsigned_Fract_Type.Invoke(x_frac);
				num7 = (short)(num7 >>> (int)(short)checked(-1 - (num5 >> 1)));
				result = cpp_enable_if_sizeof_unsigned_Fract_sizeof_unsigned_Fract_cpp_is_trivially_constructible_unsigned_Fract_value_cpp_is_trivially_copyable_unsigned_Fract_value_cpp_is_trivially_copyable_unsigned_Fract_value_unsigned_Fract_type_cpp_bit_cast_unsigned_Fract_unsigned_Fract_unsigned_Fract_const.Invoke(&num7);
