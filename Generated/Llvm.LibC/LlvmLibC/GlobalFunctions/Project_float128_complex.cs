	...
	public unsafe static void Invoke([MangledName("agg.result")] Struct_unhbb7* Agg_result, [MangledName("c")][NativeType("__float128 complex")] void* C)
	{
		...
		unchecked
		{
			*(double*)(&complex_22i76p) = double.NaN;
			...
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi, complex_22i76p.Real);
			bool num = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi));
			...
			{
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi2, complex_22i76p.Imag);
				num2 = (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi2)) ? 1 : 0);
			}
			...
			if (num2 != 0)
			{
				...
				complex_22i76p2.Real = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi3);
