...
internal static partial class double_fputil_DyadicFloat_64ul_fast_as_double_true_void_const
{
	public unsafe static double Invoke(void* @this)
	{
		...
		{
			double result;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(BigInt_64ul_false_unsigned_long_is_zero_const.Invoke(&((fputil_DyadicFloat_374hpp*)@this)->mantissa), expected: false))
			{
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm2);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb8, &((fputil_DyadicFloat_374hpp*)@this)->sign, 1L, isVolatile: false);
			...
			else
			{
				...
				checked
				{
					num3 = unchecked((fputil_DyadicFloat_374hpp*)@this)->exponent + 1086;
				}
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num3 > 2046, expected: false))
				{
					llvm_lifetime_start_p0.Invoke(8L, &num4);
					llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm3);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, &((fputil_DyadicFloat_374hpp*)@this)->sign, 1L, isVolatile: false);
				...
				else
				{
					...
					*(long*)(&bigInt_nx6qdt) = -6148914691236517206L;
					...
					{
						long data = BigInt_64ul_false_unsigned_long_operator_unsigned_long_const_5vdftb.Invoke(&((fputil_DyadicFloat_374hpp*)@this)->mantissa, (uint)num7);
						*(long*)(&bigInt_nx6qdt.val.Data) = data;
					}
					llvm_lifetime_start_p0.Invoke(8L, &num9);
					llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm5);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb10, &((fputil_DyadicFloat_374hpp*)@this)->sign, 1L, isVolatile: false);
					long val3 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value_Sign_unsigned_long_unsigned_long.Invoke(biased_exp: num3, mantissa: (BigInt_64ul_false_unsigned_long_operator_unsigned_long_unsigned_long_const.Invoke(&bigInt_nx6qdt) & 0xFFFFFFFFFFFFFL) | 0L, sign: anon_izyfb10.val);
					...
					*(long*)(&bigInt_nx6qdt2) = -6148914691236517206L;
					...
					else
					{
						...
						long data2 = BigInt_64ul_false_unsigned_long_operator_unsigned_long_const_vswmz5.Invoke(&bigInt_nx6qdt3, (uint)(num7 - 1));
					...
					*(long*)(&bigInt_nx6qdt4.val.Data) = data3;
					...
					long data4 = operator_BigInt_64ul_false_unsigned_long_const_BigInt_64ul_false_unsigned_long_const_ufy43f.Invoke(&((fputil_DyadicFloat_374hpp*)@this)->mantissa, &bigInt_nx6qdt2);
					*(long*)(&bigInt_nx6qdt6.val.Data) = data4;
					int num21 = (BigInt_64ul_false_unsigned_long_is_zero_const.Invoke(&bigInt_nx6qdt6) ? 1 : 0) ^ -1;
					llvm_lifetime_end_p0.Invoke(8L, &bigInt_nx6qdt6);
					b2 = (sbyte)(byte)num21;
					llvm_lifetime_start_p0.Invoke(1L, &b3);
					llvm_lifetime_start_p0.Invoke(8L, &bigInt_nx6qdt7);
					long data5 = operator_BigInt_64ul_false_unsigned_long_const_BigInt_64ul_false_unsigned_long_const_ufy43f.Invoke(&((fputil_DyadicFloat_374hpp*)@this)->mantissa, &bigInt_nx6qdt4);
					*(long*)(&bigInt_nx6qdt7.val.Data) = data5;
					int num22 = (BigInt_64ul_false_unsigned_long_is_zero_const.Invoke(&bigInt_nx6qdt7) ? 1 : 0) ^ -1;
					...
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num8 <= 0, expected: false))
					{
						...
						checked
						{
							...
							llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb13, &unchecked((fputil_DyadicFloat_374hpp*)@this)->sign, 1L, isVolatile: false);
					...
					else
					{
						...
						llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb14, &((fputil_DyadicFloat_374hpp*)@this)->sign, 1L, isVolatile: false);
