...
internal static partial class Log2
{
	...
	public unsafe static double Invoke([MangledName("x")] double X)
	{
		...
		FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm8, num6);
		double num21 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm8);
		...
		unchecked
		{
			*(double*)(&numberPair) = double.NaN;
			...
			FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm9, x);
			double num22 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm9);
			Llvm_lifetime_end_p0.Invoke(8L, &fputil_FPBits_wjhbrm9);
			num11 = num22;
			double x2 = num5;
			double y = num7 - num11;
			long num23 = num4;
			num8 = Fputil_multiply_add_double.Invoke(x2, y, ((double*)CD.Pointer)[num23]);
			...
			*(double*)num26 = struct_4ydhja3.field_1;
			...
			double x3 = num9;
			long num27 = num4;
			num12 = Fputil_polyeval_double_double_double_double.Invoke(x3, ((NumberPair*)Anonymous_namespace_LOG_R1.Pointer)[num27].Lo, a_yc74sk, a_ijazrn, a_889uw);
			numberPair.Lo += num12;
