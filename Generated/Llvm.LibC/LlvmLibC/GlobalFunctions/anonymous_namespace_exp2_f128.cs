...
internal static partial class anonymous_namespace_exp2_f128
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, [NativeType("double")] double x, [NativeType("int")] int hi, [NativeType("int")] int idx1, [NativeType("int")] int idx2)
	{
		...
		unchecked
		{
			...
			*(long*)ptr10 = -6148914691236517206L;
			...
			anonymous_namespace_poly_approx_f128_3v5nkh.Invoke(&fputil_DyadicFloat_kt2kd17, &fputil_DyadicFloat_kt2kd5);
			*(sbyte*)agg_result = -86;
