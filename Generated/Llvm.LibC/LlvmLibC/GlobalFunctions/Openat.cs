...
{
	[MangledName("openat")]
	[DemangledName("openat")]
	public unsafe static int Invoke([MangledName("dfd")] int Dfd, [MangledName("path")] void* Path, [MangledName("flags")] int Flags, ReadOnlySpan<nint> args)
	{
		int ts_784yyq = 0;
