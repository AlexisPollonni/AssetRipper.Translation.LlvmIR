...
internal static partial class multiword_multiply_with_carry_unsigned_long_8ul_4ul_4ul
{
	...
	public unsafe static long Invoke([NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 8ul>&")] cpp_array_uibb79* dst, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 4ul> const&")] cpp_array_jgy3xh* lhs, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 4ul> const&")] cpp_array_jgy3xh* rhs)
	{
		...
		unchecked
		{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			for (num = 0L; (ulong)num < 8uL; num++)
			{
				...
				{
					long num6 = multiword_mul_add_with_carry_unsigned_long_2ul.Invoke((cpp_array_i3937k*)(&bigInt_qdkjbh), *(long*)array_unsigned_long_4ul_Index_pwcpnu.Invoke(lhs, num5), *(long*)array_unsigned_long_4ul_Index_pwcpnu.Invoke(rhs, num - num5));
					num4 += num6;
				}
