...
internal static partial class BigInt_320ul_false_unsigned_long_div_uint_half_times_pow_2
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Cpp_optional_t82b4p* Agg_result, [MangledName("this")] BigInt_76gxx6* This, [MangledName("x")] int X, [MangledName("e")] long E)
	{
		...
		unchecked
		{
			*(long*)ptr = -6148914691236517206L;
			...
			BigInt_320ul_false_unsigned_long_Constructor.Invoke(&bigInt_76gxx);
			if (X == 0)
			{
			...
			else if ((ulong)E >= 320uL)
			{
				...
				BigInt_320ul_false_unsigned_long_Constructor.Invoke(&bigInt_76gxx2);
				Llvm_memcpy_p0_p0_i64.Invoke(This, &bigInt_76gxx2, 40L, isVolatile: false);
				Llvm_lifetime_end_p0.Invoke(40L, &bigInt_76gxx2);
				Optional_BigInt_320ul_false_unsigned_long_Constructor.Invoke(Agg_result, &bigInt_76gxx);
			}
			else
			{
				...
				*(long*)ptr2 = -6148914691236517206L;
				...
				BigInt_320ul_false_unsigned_long_Constructor.Invoke(&bigInt_76gxx3);
				...
				for (num9 = 5L - num6; (ulong)num9 > 0uL; num9 += -1L)
				{
					...
					*(long*)Array_unsigned_long_5ul_Index_wu6ki8.Invoke(&bigInt_76gxx3.Val, num9 - 1L) = num17;
					num7 = (long)((ulong)num7 % (ulong)num);
				...
				if ((ulong)num11 > 0uL)
				{
					BigInt_320ul_false_unsigned_long_Operator.Invoke(&bigInt_76gxx3, num11);
					...
					long num19 = num12;
					*(long*)Array_unsigned_long_5ul_Index_wu6ki8.Invoke(&bigInt_76gxx3.Val, 0L) += num19;
					if ((ulong)(num5 - E) <= 32uL)
					{
						if ((ulong)num8 < 4uL)
						{
							long num20 = num7 >>> 32;
							*(long*)BigInt_320ul_false_unsigned_long_Index.Invoke(&bigInt_76gxx, num8 + 1L) = num20;
						}
						long num21 = (num7 << 32) + (*(long*)Array_unsigned_long_5ul_Index_wu6ki8.Invoke(&This->Val, num8) & 0xFFFFFFFFL);
						*(long*)BigInt_320ul_false_unsigned_long_Index.Invoke(&bigInt_76gxx, num8) = num21;
					}
					else
					{
						long num22 = num7;
						*(long*)BigInt_320ul_false_unsigned_long_Index.Invoke(&bigInt_76gxx, num8) = num22;
					}
				...
				{
					long num23 = num7;
					*(long*)BigInt_320ul_false_unsigned_long_Index.Invoke(&bigInt_76gxx, num8) = num23;
				}
				for (; (ulong)num8 > 0uL; num8 += -1L)
				{
					long num24 = *(long*)Array_unsigned_long_5ul_Index_wu6ki8.Invoke(&This->Val, num8 - 1L);
					*(long*)BigInt_320ul_false_unsigned_long_Index.Invoke(&bigInt_76gxx, num8 - 1L) = num24;
				}
