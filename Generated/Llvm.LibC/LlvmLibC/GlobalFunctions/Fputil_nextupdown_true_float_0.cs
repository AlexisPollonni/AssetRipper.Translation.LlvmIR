...
internal static partial class Fputil_nextupdown_true_float_0
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil10nextupdownILb1EfTnNS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT0_EEiE4typeELi0EEES4_S4_")]
	[DemangledName("float __llvm_libc_20_1_2_::fputil::nextupdown<true, float, 0>(float)")]
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X)
	{
		...
		Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm3 = default(Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm);
		Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm4 = default(Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm);
		...
		unchecked
		{
			...
			*(int*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) = -1431655766;
			...
			bool num = FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
			...
			else
			{
				...
				{
					Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm3, &llvm_libc_20_1_2_fputil_FPBits_5nkvcs, 4L, isVolatile: false);
					...
					Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm4, &llvm_libc_20_1_2_fputil_FPBits_5nkvcs3, 4L, isVolatile: false);
					num2 = (Internal_Equals_wuhucm.Invoke(llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm3.FPRepSem.field_0.field_0, llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm4.FPRepSem.field_0.field_0) ? 1 : 0);
				}
			}
			...
			else
			{
				if (NumericHelper.IsUnorderedOrNotEquals(X, 0f))
				{
					...
					else
					{
						...
						FPBits_float_FPBits_unsigned_int.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs5, FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)) - 1);
				...
				else
				{
					...
					llvm_libc_20_1_2_fputil_FPBits_5nkvcs6.FPRepImpl.FPRepSem.field_0.field_0 = field_3;
					Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs, &llvm_libc_20_1_2_fputil_FPBits_5nkvcs6, 4L, isVolatile: false);
