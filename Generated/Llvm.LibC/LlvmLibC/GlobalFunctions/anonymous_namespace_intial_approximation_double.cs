	...
	public unsafe static double Invoke(double x)
	{
		...
		unchecked
		{
			*(double*)(&inlineArray8_Double) = 3.471273287514779;
			...
			z = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x, Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, sizeof(double))), *(double*)(&inlineArray8_Double));
			llvm_lifetime_start_p0.Invoke(8L, &y);
			y = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x, Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, (nint)3 * sizeof(double))), Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, (nint)2 * sizeof(double))));
			llvm_lifetime_start_p0.Invoke(8L, &z2);
			z2 = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x, Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, (nint)5 * sizeof(double))), Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, (nint)4 * sizeof(double))));
			llvm_lifetime_start_p0.Invoke(8L, &y2);
			y2 = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x, Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, (nint)7 * sizeof(double))), Unsafe.As<InlineArray8_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray8_Double, (nint)6 * sizeof(double))));
			...
			double result = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x2, y3, z3);
