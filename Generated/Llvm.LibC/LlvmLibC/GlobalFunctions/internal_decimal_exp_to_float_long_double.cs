...
internal static partial class internal_decimal_exp_to_float_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] internal_FloatConvertReturn_hgyipa* agg_result, [NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<long double>")] void* init_num, [NativeType("bool")] bool truncated, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round, [NativeType("char const*")] void* numStart, [NativeType("unsigned long")] long num_len)
	{
		...
		unchecked
		{
			...
			FloatConvertReturn_long_double_Constructor.Invoke(&internal_FloatConvertReturn_hgyipa2);
			...
			optional_internal_ExpandedFloat_long_double_Constructor_jkh8ki.Invoke(&cpp_optional_q5jaj9);
			...
			else
			{
				if ((b & 1) != 1)
				{
					...
					internal_clinger_fast_path_long_double.Invoke(&cpp_optional_q5jaj10, &internal_ExpandedFloat_9jummq4, round);
					...
					if (optional_internal_ExpandedFloat_long_double_has_value.Invoke(&cpp_optional_q5jaj9))
					{
						llvm_memcpy_p0_p0_i64.Invoke(&agg_result->num, optional_internal_ExpandedFloat_long_double_value.Invoke(&cpp_optional_q5jaj9), 32L, isVolatile: false);
						agg_result->error = 0;
						goto IL_0492;
					}
				}
				...
				internal_eisel_lemire_long_double.Invoke(&cpp_optional_q5jaj11, &internal_ExpandedFloat_9jummq5, round);
				...
				if (optional_internal_ExpandedFloat_long_double_has_value.Invoke(&cpp_optional_q5jaj9))
				{
					...
					internal_eisel_lemire_long_double.Invoke(&cpp_optional_q5jaj12, &internal_ExpandedFloat_9jummq6, round);
					int num2;
					if (optional_internal_ExpandedFloat_long_double_has_value.Invoke(&cpp_optional_q5jaj12) && NumericHelper.IntCmpEq(optional_internal_ExpandedFloat_long_double_PointerDereference.Invoke(&cpp_optional_q5jaj9)->mantissa, optional_internal_ExpandedFloat_long_double_PointerDereference.Invoke(&cpp_optional_q5jaj12)->mantissa) && optional_internal_ExpandedFloat_long_double_PointerDereference.Invoke(&cpp_optional_q5jaj9)->exponent == optional_internal_ExpandedFloat_long_double_PointerDereference.Invoke(&cpp_optional_q5jaj12)->exponent)
					{
						llvm_memcpy_p0_p0_i64.Invoke(&agg_result->num, optional_internal_ExpandedFloat_long_double_value.Invoke(&cpp_optional_q5jaj9), 32L, isVolatile: false);
						agg_result->error = 0;
						num2 = 1;
				...
				internal_simple_decimal_conversion_long_double.Invoke(&internal_FloatConvertReturn_hgyipa3, numStart, num_len, round);
