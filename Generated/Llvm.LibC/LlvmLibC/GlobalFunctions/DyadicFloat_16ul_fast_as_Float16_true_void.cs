...
internal static partial class DyadicFloat_16ul_fast_as_Float16_true_void
{
	...
	public unsafe static Half Invoke([MangledName("this")] Fputil_DyadicFloat_jvghxm* This)
	{
			...
			unchecked
			{
				...
				else
				{
					...
					*(short*)(&bigInt_ys7s) = -21846;
					...
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&bigInt_ys7s, 0);
					}
					else
					{
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(Biased_exp: (short)num3, Mantissa: (short)(((ushort)BigInt_16ul_false_unsigned_short_Unsigned_short_unsigned_short.Invoke(&bigInt_ys7s) & 0x3FF) | 0), Sign: anon_izyfb3.Val);
					...
					*(short*)(&bigInt_ys7s2) = -21846;
					...
					if (num11)
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&bigInt_ys7s2, 0);
					}
					else
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&bigInt_ys7s3, 1);
						short data2 = BigInt_16ul_false_unsigned_short_LeftShift.Invoke(&bigInt_ys7s3, (uint)(num4 - 1));
					...
					*(short*)(&bigInt_ys7s4) = -21846;
					...
					BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&bigInt_ys7s5, 1);
					short data3 = BigInt_16ul_false_unsigned_short_Subtract.Invoke(&bigInt_ys7s2, &bigInt_ys7s5);
					*(short*)(&bigInt_ys7s4.Val.Data) = data3;
					...
					short data4 = BitwiseAnd.Invoke(&This->Mantissa, &bigInt_ys7s2);
					*(short*)(&bigInt_ys7s6.Val.Data) = data4;
					bool num12 = InstructionHelper.BooleanXor(BigInt_16ul_false_unsigned_short_is_zero.Invoke(&bigInt_ys7s6), right: true);
					Llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s6);
					b2 = (num12 ? ((sbyte)1) : ((sbyte)0));
					Llvm_lifetime_start_p0.Invoke(1L, &b3);
					Llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s7);
					short data5 = BitwiseAnd.Invoke(&This->Mantissa, &bigInt_ys7s4);
					*(short*)(&bigInt_ys7s7.Val.Data) = data5;
					bool num13 = InstructionHelper.BooleanXor(BigInt_16ul_false_unsigned_short_is_zero.Invoke(&bigInt_ys7s7), right: true);
