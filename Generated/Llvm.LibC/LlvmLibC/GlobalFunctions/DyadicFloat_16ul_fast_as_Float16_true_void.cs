			...
			unchecked
			{
				...
				else
				{
					...
					*(short*)(&bigInt_ys7s) = -21846;
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(biased_exp: (short)num3, mantissa: (short)(((ushort)BigInt_16ul_false_unsigned_short_unsigned_short_unsigned_short.Invoke(&bigInt_ys7s) & 0x3FF) | 0), sign: anon_izyfb10.val);
					...
					*(short*)(&bigInt_ys7s6.val.Data) = data4;
					int num12 = (BigInt_16ul_false_unsigned_short_is_zero.Invoke(&bigInt_ys7s6) ? 1 : 0) ^ -1;
					...
					*(short*)(&bigInt_ys7s7.val.Data) = data5;
					int num13 = (BigInt_16ul_false_unsigned_short_is_zero.Invoke(&bigInt_ys7s7) ? 1 : 0) ^ -1;
