...
internal static partial class DyadicFloat_16ul_fast_as_Float16_true_void
{
	[MangledName("_ZNK19__llvm_libc_20_1_2_6fputil11DyadicFloatILm16EE7fast_asIDF16_Lb1EvEET_v")]
	[DemangledName("_Float16 __llvm_libc_20_1_2_::fputil::DyadicFloat<16ul>::fast_as<_Float16, true, void>() const")]
	[return: NativeType("_Float16")]
	public unsafe static Half Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_DyadicFloat_jvghxm* This)
	{
		...
		Llvm_libc_20_1_2_BigInt_ys7s55 llvm_libc_20_1_2_BigInt_ys7s2 = default(Llvm_libc_20_1_2_BigInt_ys7s55);
		Llvm_libc_20_1_2_BigInt_ys7s55 llvm_libc_20_1_2_BigInt_ys7s3 = default(Llvm_libc_20_1_2_BigInt_ys7s55);
		Llvm_libc_20_1_2_BigInt_ys7s55 llvm_libc_20_1_2_BigInt_ys7s4 = default(Llvm_libc_20_1_2_BigInt_ys7s55);
		Llvm_libc_20_1_2_BigInt_ys7s55 llvm_libc_20_1_2_BigInt_ys7s5 = default(Llvm_libc_20_1_2_BigInt_ys7s55);
		sbyte b2 = 0;
		Llvm_libc_20_1_2_BigInt_ys7s55 llvm_libc_20_1_2_BigInt_ys7s6 = default(Llvm_libc_20_1_2_BigInt_ys7s55);
		sbyte b3 = 0;
		Llvm_libc_20_1_2_BigInt_ys7s55 llvm_libc_20_1_2_BigInt_ys7s7 = default(Llvm_libc_20_1_2_BigInt_ys7s55);
		int num6 = 0;
		Half x = default(Half);
		int num7 = 0;
		...
		Half result;
		if (Details_expects_bool_condition_bool.Invoke(BigInt_16ul_false_unsigned_short_is_zero.Invoke(&This->Mantissa), Expected: false))
		{
		...
		else
		{
			...
			unchecked
			{
				...
				else
				{
					...
					{
						b = 1;
						num4 = (int)(5L + (long)(uint)checked(1 - num3));
						num3 = 15;
					}
					...
					*(short*)(&llvm_libc_20_1_2_BigInt_ys7s) = -21846;
					if ((ulong)(uint)num4 >= 16uL)
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&llvm_libc_20_1_2_BigInt_ys7s, 0);
					}
					else
					{
						short data = BigInt_16ul_false_unsigned_short_RightShift.Invoke(&This->Mantissa, (uint)num4);
						*(short*)(&llvm_libc_20_1_2_BigInt_ys7s.Val.Data) = data;
					}
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(Biased_exp: (short)num3, Mantissa: (short)(((ushort)BigInt_16ul_false_unsigned_short_Unsigned_short_unsigned_short.Invoke(&llvm_libc_20_1_2_BigInt_ys7s) & 0x3FF) | 0), Sign: anon_izyfb3.Val);
					...
					half4 = half9;
					Llvm_lifetime_start_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s2);
					*(short*)(&llvm_libc_20_1_2_BigInt_ys7s2) = -21846;
					bool num11 = (ulong)(uint)num4 > 16uL;
					Llvm_lifetime_start_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s3);
					if (num11)
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&llvm_libc_20_1_2_BigInt_ys7s2, 0);
					}
					else
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&llvm_libc_20_1_2_BigInt_ys7s3, 1);
						short data2 = BigInt_16ul_false_unsigned_short_LeftShift.Invoke(&llvm_libc_20_1_2_BigInt_ys7s3, (uint)(num4 - 1));
						*(short*)(&llvm_libc_20_1_2_BigInt_ys7s2.Val.Data) = data2;
					}
					Llvm_lifetime_end_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s3);
					Llvm_lifetime_start_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s4);
					*(short*)(&llvm_libc_20_1_2_BigInt_ys7s4) = -21846;
					Llvm_lifetime_start_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s5);
					BigInt_16ul_false_unsigned_short_BigInt_int_void.Invoke(&llvm_libc_20_1_2_BigInt_ys7s5, 1);
					short data3 = BigInt_16ul_false_unsigned_short_Subtract.Invoke(&llvm_libc_20_1_2_BigInt_ys7s2, &llvm_libc_20_1_2_BigInt_ys7s5);
					*(short*)(&llvm_libc_20_1_2_BigInt_ys7s4.Val.Data) = data3;
					Llvm_lifetime_end_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s5);
					Llvm_lifetime_start_p0.Invoke(1L, &b2);
					Llvm_lifetime_start_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s6);
					short data4 = Llvm_libc_20_1_2_BitwiseAnd.Invoke(&This->Mantissa, &llvm_libc_20_1_2_BigInt_ys7s2);
					*(short*)(&llvm_libc_20_1_2_BigInt_ys7s6.Val.Data) = data4;
					bool num12 = InstructionHelper.BooleanXor(BigInt_16ul_false_unsigned_short_is_zero.Invoke(&llvm_libc_20_1_2_BigInt_ys7s6), right: true);
					Llvm_lifetime_end_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s6);
					b2 = (num12 ? ((sbyte)1) : ((sbyte)0));
					Llvm_lifetime_start_p0.Invoke(1L, &b3);
					Llvm_lifetime_start_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s7);
					short data5 = Llvm_libc_20_1_2_BitwiseAnd.Invoke(&This->Mantissa, &llvm_libc_20_1_2_BigInt_ys7s4);
					*(short*)(&llvm_libc_20_1_2_BigInt_ys7s7.Val.Data) = data5;
					bool num13 = InstructionHelper.BooleanXor(BigInt_16ul_false_unsigned_short_is_zero.Invoke(&llvm_libc_20_1_2_BigInt_ys7s7), right: true);
					Llvm_lifetime_end_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s7);
					...
					Llvm_lifetime_end_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s4);
					Llvm_lifetime_end_p0.Invoke(2L, &llvm_libc_20_1_2_BigInt_ys7s2);
