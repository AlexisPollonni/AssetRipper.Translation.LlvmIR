...
internal static partial class logf
{
	public unsafe static float Invoke(float x)
	{
				...
				if (num9 != 1065307503)
				{
					if (num9 != 1092063211)
					{
						if (num9 != 512247085)
						{
							...
							bool num11 = details_expects_bool_condition_bool.Invoke((uint)num10 < (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3)), expected: false);
							...
							if (num11)
							{
								...
								FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs5, FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2) * 8388608f);
								...
								if (num12 != 1343224579)
								{
									if (num12 != 1557569160)
									{
										...
										else
										{
											...
											int field_3 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_max_normal.Invoke(anon_izyfb10.val);
											fputil_FPBits_5nkvcs6.FPRepImpl.FPRepSem.field_0.field_0 = field_3;
											bool num14 = details_expects_bool_condition_bool.Invoke((uint)num13 > (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6)), expected: false);
											...
											if (num2 == int.MinValue)
											{
												...
												int field_4 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb11.val);
		...
		{
			result = (float)((double)(num3 + unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)))) * 0.6931471805599453);
		}
		else
		{
			llvm_lifetime_start_p0.Invoke(4L, &num4);
			num4 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke(unchecked((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)));
			...
			unchecked
			{
				...
				num6 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
				llvm_lifetime_start_p0.Invoke(8L, &num7);
				num7 = double.NaN;
				double x3 = num6;
				long num15 = num5;
				num7 = fputil_multiply_add_double.Invoke(x3, ((double*)RD.Pointer)[num15], -1.0);
				...
				*(double*)(&inlineArray4_Double) = -0.5000000000072301;
				...
				num8 = fputil_multiply_add_double.Invoke(num3, 0.6931471805599453, fputil_polyeval_double_double_double.Invoke(x2, a, a_yc74sk, a_ijazrn));
				result = (float)num8;
