...
internal static partial class logf
{
	public unsafe static float Invoke(float x)
	{
			...
			if ((uint)num2 < 1281189285u)
			{
				...
				if (num9 != 1065307503)
				{
					if (num9 != 1092063211)
					{
						...
						result = float_fputil_round_result_slightly_up_float_float.Invoke(-45.685104f);
					}
					else
					{
					...
					if (num12 != 1708691667)
					{
						if (num12 != 1865525484)
						{
							if (num12 != 2048389898)
							{
								...
								{
									result = float_fputil_round_result_slightly_up_float_float.Invoke(22.991505f);
								}
							}
							else
							{
		...
		IL_0537:
		if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((num2 & 0x7FFFFF) == 0, expected: false))
		{
			result = (float)((double)(num3 + unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent_const.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)))) * 0.6931471805599453);
		}
		else
		{
			...
			unchecked
			{
				...
				double x3 = num6;
				long num15 = num5;
				num7 = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x3, ((double*)RD.Pointer)[num15], -1.0);
				...
				*(double*)(&inlineArray4_Double) = -0.5000000000072301;
				...
				a_ijazrn = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num7, Unsafe.As<InlineArray4_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray4_Double, (nint)3 * sizeof(double))), Unsafe.As<InlineArray4_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray4_Double, (nint)2 * sizeof(double))));
				llvm_lifetime_start_p0.Invoke(8L, &a_yc74sk);
				a_yc74sk = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num7, Unsafe.As<InlineArray4_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray4_Double, sizeof(double))), *(double*)(&inlineArray4_Double));
				llvm_lifetime_start_p0.Invoke(8L, &a);
				long num16 = num5;
				a = ((double*)LOG_R.Pointer)[num16] + num7;
				llvm_lifetime_start_p0.Invoke(8L, &num8);
				num8 = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num3, 0.6931471805599453, cpp_enable_if_sizeof_double_8ul_double_type_fputil_polyeval_double_double_double_double_double_double_double.Invoke(x2, a, a_yc74sk, a_ijazrn));
				result = (float)num8;
