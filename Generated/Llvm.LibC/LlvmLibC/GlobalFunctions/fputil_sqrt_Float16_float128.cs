...
internal static partial class fputil_sqrt_Float16_float128
{
	...
	public unsafe static Half Invoke([NativeType("__float128")] double x)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			int num2 = (internal_Equals_svxrxh.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud10), ((long*)(&fputil_internal_FPRepImpl_jrxud10))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud11), ((long*)(&fputil_internal_FPRepImpl_jrxud11))[1]) ? (-1) : ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3))) ? (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)) ? 1 : 0) : (-1)));
			...
			else
			{
				...
				*(long*)num4 = struct_fiz2nb6.field_1;
				...
				{
					num = checked(num + 1);
					internal_normalize_float128.Invoke(&num, &x2);
				}
				else
				{
