...
internal static partial class Generic_add_or_sub_false_Float16_long_double
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic10add_or_subILb0EDF16_eEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT0_Esr3cppE19is_floating_point_vIT1_ElestS5_stS6_ES5_E4typeES6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<_Float16> && cpp::is_floating_point_v<long double> && sizeof (_Float16) <= sizeof (long double), _Float16>::type __llvm_libc_20_1_2_::fputil::generic::add_or_sub<false, _Float16, long double>(long double, long double)")]
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("y")][NativeType("long double")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			else
			{
				...
				x2 = Y;
				result = Fputil_cast_Float16_long_double.Invoke(x2);
		...
		unchecked
		{
			...
			double num12 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3);
			...
			double num13 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi4);
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi5, *(double*)Cpp_max_long_double.Invoke(&num4, &num5));
				Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi6);
				*(Int128*)(&fputil_FPBits_ubgsi6) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi6, *(double*)Cpp_min_long_double.Invoke(&num4, &num5));
				...
				else
				{
					...
					*(long*)num25 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num6 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi5)) - unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi6));
				...
				num7 = checked(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_exponent.Invoke(&fputil_FPBits_ubgsi5) - 66);
