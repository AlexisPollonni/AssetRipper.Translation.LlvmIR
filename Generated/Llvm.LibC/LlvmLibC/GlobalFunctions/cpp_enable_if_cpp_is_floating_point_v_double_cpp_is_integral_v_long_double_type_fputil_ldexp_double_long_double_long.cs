...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_integral_v_long_double_type_fputil_ldexp_double_long_double_long
{
	public unsafe static double Invoke(double x, long exp)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			num = 2100;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(exp > 2100L, expected: false))
			{
