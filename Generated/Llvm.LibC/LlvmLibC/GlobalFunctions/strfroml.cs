	...
	public unsafe static int Invoke(void* s, long n, void* format, double fp)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			{
				num = int_internal_strfromfloat_convert_long_double_printf_core_Writer_printf_core_FormatSection_const.Invoke(&printf_core_Writer2, &printf_core_FormatSection2);
			}
			else
			{
