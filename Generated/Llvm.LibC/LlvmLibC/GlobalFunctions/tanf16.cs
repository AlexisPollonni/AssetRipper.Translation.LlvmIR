			...
			case 0:
				if (details_expects_bool_condition_bool.Invoke((ushort)num2 <= 11076, expected: false))
				{
					if (details_expects_bool_condition_bool.Invoke((ushort)num2 <= 4326, expected: false))
					{
						...
						result = (((!FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) || num4 != 2048) && (!FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) || num4 != 1024)) ? x : fputil_cast_Float16_float.Invoke(fputil_multiply_add_float.Invoke(num3, 0.00048828125f, num3)));
					...
					else
					{
						...
						num5 = fputil_polyeval_float_float_float_float.Invoke(x2, 1f, 1f / 3f, 0.13332918f, 0.054504853f);
				...
				else if (details_expects_bool_condition_bool.Invoke((ushort)num2 >= 31744, expected: false))
				{
					...
					result = (Half)(num9 + (float)FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva3));
				...
				else
				{
					...
					x4 = float.NaN;
					sincosf16_eval.Invoke(num3, &num6, &num7, &x3, &x4);
					result = fputil_cast_Float16_float.Invoke(fputil_multiply_add_float.Invoke(x3, num7, fputil_multiply_add_float.Invoke(x4, num6, num6)) / fputil_multiply_add_float.Invoke(x3, 0f - num6, fputil_multiply_add_float.Invoke(x4, num7, num7)));
