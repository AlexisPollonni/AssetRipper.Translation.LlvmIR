				...
				*(short*)(&fputil_FPBits_2fahva3) = -21846;
				...
				if (@this->exponent < -14)
				{
					...
					if ((uint)num4 <= 11u)
					{
						...
						num7 = (short)(1 << num4 - 1);
						fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_biased_exponent_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3), 0);
						fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3), (short)((ushort)@this->mantissa >> num4));
						llvm_lifetime_start_p0.Invoke(2L, &num8);
						num8 = fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3));
						if ((ushort)num6 > (ushort)num7)
						{
							num8 = (short)checked(unchecked((ushort)num8) + 1);
						}
						else if ((ushort)num6 == (ushort)num7 && ((ushort)fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)) & 1) != 0)
						{
							num8 = (short)checked(unchecked((ushort)num8) + 1);
						}
						fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3), num8);
						if ((ushort)num8 == 1024)
						{
							fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_biased_exponent_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3), 1);
						}
				...
				{
					fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_biased_exponent_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3), (short)checked(@this->exponent + 15));
					fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3), @this->mantissa);
					result = fputil_FPBits_Float16_get_val_const.Invoke(&fputil_FPBits_2fahva3);
				}
