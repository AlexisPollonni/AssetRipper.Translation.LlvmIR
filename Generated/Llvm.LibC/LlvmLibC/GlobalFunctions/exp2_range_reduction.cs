...
internal static partial class exp2_range_reduction
{
	...
	public unsafe static InlineArray2_Single Invoke([NativeType("_Float16")] Half x)
	{
		...
		unchecked
		{
			...
			x2 = fputil_multiply_add_float.Invoke(num2, -0.125f, num);
			llvm_lifetime_start_p0.Invoke(4L, &x3);
			x3 = *(int*)array_unsigned_int_8ul_Index.Invoke(Index: (uint)num5, @this: EXP2_MID_BITS.Pointer) + (num4 << 23);
			...
			exp_lo = fputil_polyeval_float_float_float_float.Invoke(x2, 1f, 0.6931472f, 0.24025469f, 0.05550606f);
