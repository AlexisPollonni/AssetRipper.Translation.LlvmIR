...
internal static partial class FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan
{
	...
	public unsafe static short Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign, [NativeType("unsigned short")] short v)
	{
		...
		Significand_Constructor_n44wpn.Invoke(&fputil_internal_FPRepSem_i7nz4h4, v);
		short field_3 = internal_BitwiseOr_sf5vh5.Invoke(fputil_internal_FPRepSem_i7nz4h3.FPStorage.field_0, fputil_internal_FPRepSem_i7nz4h4.FPStorage.field_0);
