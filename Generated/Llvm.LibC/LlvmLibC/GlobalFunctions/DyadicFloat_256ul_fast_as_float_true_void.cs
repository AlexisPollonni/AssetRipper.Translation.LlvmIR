			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					int field_3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value.Invoke(biased_exp: num3, mantissa: (BigInt_256ul_false_unsigned_long_unsigned_int_unsigned_int.Invoke(&bigInt_x9dsed) & 0x7FFFFF) | 0, sign: anon_izyfb10.val);
					...
					*(long*)ptr3 = -6148914691236517206L;
					...
					int num21 = (BigInt_256ul_false_unsigned_long_is_zero.Invoke(&bigInt_x9dsed6) ? 1 : 0) ^ -1;
					...
					int num22 = (BigInt_256ul_false_unsigned_long_is_zero.Invoke(&bigInt_x9dsed7) ? 1 : 0) ^ -1;
