...
internal static partial class Llvm_libc_20_1_2_cmp_uint32_t
{
	...
	public unsafe static int Invoke([MangledName("a")][NativeType("unsigned int")] int A, [MangledName("b")][NativeType("unsigned int")] int B)
	{
		...
		StrictIntegralType_int_StrictIntegralType_int_false.Invoke(&llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt, unchecked((int)((num >> 1) | (num & 0xFFFFL))));
