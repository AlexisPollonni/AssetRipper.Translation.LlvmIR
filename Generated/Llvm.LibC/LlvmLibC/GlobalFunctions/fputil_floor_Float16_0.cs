	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			Half result = ((!FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2))) ? fputil_trunc_Float16_0.Invoke(x) : ((Half)(0f - (float)fputil_ceil_Float16_0.Invoke((Half)(0f - (float)x)))));
