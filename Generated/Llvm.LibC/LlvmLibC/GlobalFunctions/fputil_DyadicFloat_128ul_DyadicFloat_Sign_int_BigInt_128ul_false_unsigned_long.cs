...
{
	public unsafe static void Invoke(void* @this, [MangledName("s.coerce")] sbyte s, int e, [MangledName("m.coerce0")] long m, [MangledName("m.coerce1")] long m_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&bigInt_qdkjbh) = m;
			...
			((fputil_DyadicFloat_kt2kd4*)@this)->exponent = e;
