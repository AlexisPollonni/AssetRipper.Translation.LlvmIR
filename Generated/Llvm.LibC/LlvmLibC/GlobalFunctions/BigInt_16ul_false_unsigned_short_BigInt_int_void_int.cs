...
internal static partial class BigInt_16ul_false_unsigned_short_BigInt_int_void_int
{
	public unsafe static void Invoke(BigInt_ys7s55* @this, int v)
	{
		long num = 0L;
		sbyte b = 0;
		long num2 = 0L;
		...
		unchecked
		{
			...
			while (true)
			{
				...
				*(short*)cpp_array_unsigned_short_1ul_operator_unsigned_long.Invoke(&@this->val, num2) = (short)num3;
				num3 >>= 16;
				num2++;
			}
