...
internal static partial class fputil_internal_FPStorage_fputil_FPType_4_encode_fputil_internal_FPStorage_fputil_FPType_4_BiasedExponent_fputil_internal_FPStorage_fputil_FPType_4_Significand
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("exp.coerce")] int exp, [MangledName("sig.coerce0")] long sig, [MangledName("sig.coerce1")] long sig_coerce1)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			...
			Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPStorage_fputil_FPType_4_encode_fputil_internal_FPStorage_fputil_FPType_4_Significand.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua3), ((long*)(&fputil_internal_FPRepSem_f94eua3))[1]);
			Int128* num3 = &y;
