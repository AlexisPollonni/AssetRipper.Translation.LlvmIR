...
internal static partial class BigInt_128ul_false_unsigned_long_BigInt_unsigned_int_void_unsigned_int
{
	public unsafe static void Invoke(anon_izyfb7* @this, int v)
	{
		long num = 0L;
		sbyte b = 0;
		long num2 = 0L;
		...
		unchecked
		{
			...
			while (true)
			{
				...
				*(long*)cpp_array_unsigned_long_2ul_operator_unsigned_long.Invoke(&((BigInt_qdkjbh*)@this)->val, num2) = (uint)num3;
				num3 = 0;
				num2++;
			}
