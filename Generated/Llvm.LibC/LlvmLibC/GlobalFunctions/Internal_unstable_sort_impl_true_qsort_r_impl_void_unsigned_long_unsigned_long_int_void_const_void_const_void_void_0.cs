			...
			if (Array != null && Array_len != 0L && Elem_size != 0L)
			{
				...
				case 4L:
					...
					*(IntPtr*)(&llvm_libc_20_1_2_cpp_string_view) = unchecked((nint)(-6148914691236517206L));
					...
					Internal_quick_sort_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&llvm_libc_20_1_2_cpp_string_view, Is_less);
				...
				case 8L:
					...
					*(IntPtr*)(&llvm_libc_20_1_2_cpp_string_view2) = unchecked((nint)(-6148914691236517206L));
					...
					Internal_quick_sort_internal_ArrayFixedSize_8ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&llvm_libc_20_1_2_cpp_string_view2, Is_less);
				...
				case 16L:
					...
					*(IntPtr*)(&llvm_libc_20_1_2_cpp_string_view3) = unchecked((nint)(-6148914691236517206L));
					...
					Internal_quick_sort_internal_ArrayFixedSize_16ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&llvm_libc_20_1_2_cpp_string_view3, Is_less);
				...
				default:
					...
					*(IntPtr*)(&llvm_libc_20_1_2_scanf_core_ReadBuffer) = unchecked((nint)(-6148914691236517206L));
					...
					Internal_quick_sort_internal_ArrayGenericSize_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&llvm_libc_20_1_2_scanf_core_ReadBuffer, Is_less);
