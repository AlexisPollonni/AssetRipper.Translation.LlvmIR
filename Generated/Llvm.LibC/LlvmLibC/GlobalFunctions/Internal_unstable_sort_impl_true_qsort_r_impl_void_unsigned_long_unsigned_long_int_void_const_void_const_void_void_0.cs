			...
			if (Array != null && Array_len != 0L && Elem_size != 0L)
			{
				...
				case 4L:
					...
					*(IntPtr*)(&cpp_string_view) = unchecked((nint)(-6148914691236517206L));
					...
					ArrayFixedSize_4ul_Constructor.Invoke(&cpp_string_view, Array, Array_len);
					Internal_quick_sort_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&cpp_string_view, Is_less);
				...
				case 8L:
					...
					*(IntPtr*)(&cpp_string_view2) = unchecked((nint)(-6148914691236517206L));
					...
					ArrayFixedSize_8ul_Constructor.Invoke(&cpp_string_view2, Array, Array_len);
					Internal_quick_sort_internal_ArrayFixedSize_8ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&cpp_string_view2, Is_less);
				...
				case 16L:
					...
					*(IntPtr*)(&cpp_string_view3) = unchecked((nint)(-6148914691236517206L));
					...
					ArrayFixedSize_16ul_Constructor.Invoke(&cpp_string_view3, Array, Array_len);
					Internal_quick_sort_internal_ArrayFixedSize_16ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&cpp_string_view3, Is_less);
				...
				default:
					...
					*(IntPtr*)(&scanf_core_ReadBuffer) = unchecked((nint)(-6148914691236517206L));
					...
					ArrayGenericSize_Constructor.Invoke(&scanf_core_ReadBuffer, Array, Array_len, Elem_size);
					Internal_quick_sort_internal_ArrayGenericSize_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&scanf_core_ReadBuffer, Is_less);
