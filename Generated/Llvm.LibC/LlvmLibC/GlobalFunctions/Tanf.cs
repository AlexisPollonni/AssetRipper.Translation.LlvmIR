	...
	public unsafe static float Invoke([MangledName("x")] float X)
	{
		...
		unchecked
		{
			*(int*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) = -1431655766;
			...
			b = ((FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)) >>> 31 != 0) ? ((sbyte)1) : ((sbyte)0));
			...
			else
			{
				if (Details_expects_bool_condition_bool.Invoke((uint)num > 1297535828u, Expected: false))
				{
					...
					*ptr2 = -86;
					ptr2[1] = -86;
					ptr2[2] = -86;
					long storage = ExceptValues_float_6ul_lookup_odd.Invoke(X_abs: num, Sign: (b & 1) == 1, This: Llvm_libc_20_1_2_TANF_EXCEPTS.Pointer);
				...
				x3 = double.NaN;
				Llvm_libc_20_1_2_sincosf_eval.Invoke(xd, num, &num6, &num7, &x2, &x3);
