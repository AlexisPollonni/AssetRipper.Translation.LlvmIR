...
internal static partial class Internal_clinger_fast_path_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_cpp_optional_q5jaj8* Agg_result, [MangledName("init_num")][NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<long double>")] void* Init_num, [MangledName("round")][NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy Round)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			if (num == 0)
			{
				...
				FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, num2);
			...
			if (num > 0)
			{
				...
				else
				{
					if (num > 27)
					{
						...
						num2 = num3 * ((double*)Llvm_libc_20_1_2_internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num4];
						num = 27;
					}
					if (!(num2 > 1.8446744073709552E+19))
					{
						...
						double num5 = num2;
						long num6 = num;
						FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3, num5 * ((double*)Llvm_libc_20_1_2_internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num6]);
		...
		if (num < 0)
		{
			...
			double num7 = num2;
			long num8 = -num;
			FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4, num7 / unchecked((double*)Llvm_libc_20_1_2_internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num8]);
		...
		unchecked
		{
			if (Round != RoundDirection_b3pcwy.Nearest)
			{
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5);
				Llvm_lifetime_start_p0.Invoke(16L, &llvm_libc_20_1_2_fputil_FPBits_ubgsi6);
				double num9 = 0.0 - num2;
				long num10 = num;
				FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6, num9 * ((double*)Llvm_libc_20_1_2_internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num10]);
				Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5, &llvm_libc_20_1_2_fputil_FPBits_ubgsi6, 16L, isVolatile: false);
				Llvm_lifetime_end_p0.Invoke(16L, &llvm_libc_20_1_2_fputil_FPBits_ubgsi6);
				if (NumericHelper.IsUnorderedOrNotEquals(FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi), 0.0 - FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5)))
				{
					Llvm_lifetime_start_p0.Invoke(16L, &llvm_libc_20_1_2_fputil_FPBits_ubgsi7);
					*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi7) = -6148914691236517206L;
					FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi7);
					Llvm_lifetime_start_p0.Invoke(16L, &llvm_libc_20_1_2_fputil_FPBits_ubgsi8);
					*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi8) = -6148914691236517206L;
					FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi8);
					if (FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) < 0.0 - FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5))
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi7, &llvm_libc_20_1_2_fputil_FPBits_ubgsi, 16L, isVolatile: false);
						Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi8, &llvm_libc_20_1_2_fputil_FPBits_ubgsi5, 16L, isVolatile: false);
					}
					else
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi7, &llvm_libc_20_1_2_fputil_FPBits_ubgsi5, 16L, isVolatile: false);
						Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi8, &llvm_libc_20_1_2_fputil_FPBits_ubgsi, 16L, isVolatile: false);
					}
			...
			*(Int128*)(&llvm_libc_20_1_2_internal_ExpandedFloat_9jummq) = -6148914691236517206L;
			...
			sbyte* ptr = (sbyte*)(&llvm_libc_20_1_2_internal_ExpandedFloat_9jummq) + 20;
			*ptr = -86;
			ptr[1] = -86;
			ptr[2] = -86;
			ptr[3] = -86;
			...
			*(long*)num12 = struct_fiz2nb3.field_1;
			llvm_libc_20_1_2_internal_ExpandedFloat_9jummq.Mantissa = mantissa;
			llvm_libc_20_1_2_internal_ExpandedFloat_9jummq.Exponent = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
