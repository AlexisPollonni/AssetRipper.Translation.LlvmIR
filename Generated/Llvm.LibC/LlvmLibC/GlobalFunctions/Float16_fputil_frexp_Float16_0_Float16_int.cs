...
internal static partial class Float16_fputil_frexp_Float16_0_Float16_int
{
			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				*(int*)(&fputil_NormalFloat_epbrnk2) = -1431655766;
				...
				fputil_NormalFloat_Float16_NormalFloat_fputil_FPBits_Float16.Invoke(&fputil_NormalFloat_epbrnk2, fputil_FPBits_2fahva3.FPRepImpl.FPRepSem.FPStorage.field_0);
				*(int*)exp = checked(fputil_NormalFloat_epbrnk2.exponent + 1);
				fputil_NormalFloat_epbrnk2.exponent = -1;
				result = fputil_NormalFloat_Float16_operator_Float16_const.Invoke(&fputil_NormalFloat_epbrnk2);
