			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			else
			{
				...
				else if (num == -1)
				{
					...
					Struct_fiz2nb struct_fiz2nb = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_one.Invoke(anon_izyfb8.val);
				...
				else
				{
					...
					*(long*)num7 = struct_fiz2nb12.field_1;
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi3)) ? (num3 + 1.0) : (num3 - 1.0)) : num3);
