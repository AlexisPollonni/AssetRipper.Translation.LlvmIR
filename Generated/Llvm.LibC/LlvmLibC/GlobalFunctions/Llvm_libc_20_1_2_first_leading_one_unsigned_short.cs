...
internal static partial class Llvm_libc_20_1_2_first_leading_one_unsigned_short
{
	...
	{
		return Llvm_libc_20_1_2_first_leading_zero_unsigned_short.Invoke(unchecked((short)((ushort)Value ^ -1)));
	}
}
