...
internal static partial class BigInt_16512ul_false_unsigned_long_BigInt_unsigned_int128_void
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_q8g275* This, [MangledName("v.coerce0")] long V, [MangledName("v.coerce1")] long T_SIZE)
	{
		...
		unchecked
		{
			*(long*)(&@int) = V;
			...
			while (true)
			{
				...
				{
					BigInt_16512ul_false_unsigned_long_extend.Invoke(This, num2, (b & 1) == 1);
					num3 = 1;
					break;
				}
				long num4 = (long)int2;
				*(long*)Array_unsigned_long_258ul_Index_cpunpn.Invoke(&This->Val, num2) = num4;
