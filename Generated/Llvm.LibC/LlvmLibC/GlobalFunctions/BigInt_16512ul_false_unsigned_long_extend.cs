...
internal static partial class BigInt_16512ul_false_unsigned_long_extend
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_q8g275* This, [MangledName("index")][NativeType("unsigned long")] long Index, [MangledName("is_neg")][NativeType("bool")] bool Is_neg)
	{
		long num = 0L;
		long num2 = 0L;
