			...
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			else
			{
				...
				else
				{
					...
					b = (((fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) & (1L << (int)(uint)(num2 - 1))) != 0L) ? ((sbyte)1) : ((sbyte)0));
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2))) ? (num5 + 1.0) : (num5 - 1.0)) : num5);
