...
internal static partial class Printf_core_multiple_of_power_of_2_unsigned_int128
{
	...
	public unsafe static bool Invoke([MangledName("value.coerce0")] long Value, [MangledName("value.coerce1")][CleanName("P")][NativeType("unsigned __int128")] long P_rwsa4c, [MangledName("p")][CleanName("P")][NativeType("unsigned int")] int P_42n5rb)
	{
