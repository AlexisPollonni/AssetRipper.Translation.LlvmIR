			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 5uL; num5++)
				{
					...
					num6 = Lambda0_Invoke_cbh959.Invoke(&anon_6je4un, num5 + num3);
					Llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = Lambda0_Invoke_cbh959.Invoke(&anon_6je4un, num5 + num3 + 1L);
					Llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = Array_unsigned_long_5ul_Index_wu6ki8.Invoke(Agg_result, Lambda_Invoke_xph9by.Invoke(&anon_izyfb, num5));
					if (num4 == 0L)
					{
						*(long*)ptr = num6;
					}
