			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				*ptr = -86;
				...
				fputil_NormalFloat_float_NormalFloat_fputil_FPBits_float.Invoke(&fputil_NormalFloat_phu2qv2, fputil_FPBits_5nkvcs3.FPRepImpl.FPRepSem.field_0.field_0);
				*(int*)exp = checked(fputil_NormalFloat_phu2qv2.exponent + 1);
				fputil_NormalFloat_phu2qv2.exponent = -1;
				result = fputil_NormalFloat_float_operator_float_const.Invoke(&fputil_NormalFloat_phu2qv2);
