...
internal static partial class Fputil_fromfp_true_float128
{
		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
				...
				if (FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2))
				{
					Fputil_raise_except_if_required.Invoke(1);
				...
				else
				{
					...
					else
					{
						...
						int6 = 0L;
						Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val3, biased_exp, mantissa, *(long*)(&int6), ((long*)(&int6))[1]);
						...
						double num4 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4);
						...
						if (num < num2)
						{
							...
							int7 = 0L;
							Struct_fiz2nb struct_fiz2nb10 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan.Invoke(val4, *(long*)(&int7), ((long*)(&int7))[1]);
						...
						else
						{
							...
							int9 = 0L;
							Struct_fiz2nb struct_fiz2nb13 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val5, biased_exp2, mantissa2, *(long*)(&int9), ((long*)(&int9))[1]);
							...
							double num5 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6) - 1.0;
							...
							if (num > num3)
							{
								...
								int10 = 0L;
								Struct_fiz2nb struct_fiz2nb16 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan.Invoke(val6, *(long*)(&int10), ((long*)(&int10))[1]);
								...
								result = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi7);
