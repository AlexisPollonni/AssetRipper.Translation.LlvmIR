	...
	public unsafe static double Invoke([NativeType("double")] double x, [NativeType("double")] double y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
			...
			double result = ((!FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2))) ? ((!FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3))) ? internal_max_double.Invoke(x, y) : y) : x);
