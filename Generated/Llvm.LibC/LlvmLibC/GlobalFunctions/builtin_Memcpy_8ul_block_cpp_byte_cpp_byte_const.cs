...
internal static partial class builtin_Memcpy_8ul_block_cpp_byte_cpp_byte_const
{
	public unsafe static void Invoke(void* dst, void* src)
	{
		builtin_Memcpy_8ul_block_offset_cpp_byte_cpp_byte_const_unsigned_long.Invoke(dst, src, 0L);
	}
}
