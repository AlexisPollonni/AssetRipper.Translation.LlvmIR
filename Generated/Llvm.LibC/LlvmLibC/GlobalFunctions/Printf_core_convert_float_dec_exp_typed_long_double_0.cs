	...
	public unsafe static int Invoke([MangledName("writer")] Printf_core_Writer* Writer, [MangledName("to_conv")][NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] Printf_core_FormatSection* To_conv, [MangledName("float_bits.coerce0")][NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] long Float_bits, [MangledName("float_bits.coerce1")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<long double>")] long FRACTION_LEN)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			long num21 = IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_size.Invoke(&integerToString_uuwdyc);
		...
		long num22 = IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_size.Invoke(&integerToString_uuwdyc2);
		...
		unchecked
		{
			...
			while (true)
			{
					...
					if ((b2 & 1) != 1)
					{
						if (num6 >= 0)
						{
							...
							for (j = num6 - 1; j >= 0; j += -1)
							{
								...
								num16 = FloatToString_long_double_0_get_block.Invoke(&floatToString_8m29tk, j);
								if (num16 != 0)
								{
									b2 = 1;
									num23 = 10;
				...
				num17 = FloatWriter_write_last_block.Invoke(&printf_core_FloatWriter, num7, num13, (RoundDirection_zvveyk)round, num5, InstructionHelper.Select(Internal_islower_qy8nhx.Invoke(To_conv->Conv_name), (sbyte)101, (sbyte)69));
				if (num17 < 0)
				{
					result = num17;
					num23 = 1;
