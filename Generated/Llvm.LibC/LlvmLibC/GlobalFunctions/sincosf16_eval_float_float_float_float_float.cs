...
internal static partial class sincosf16_eval_float_float_float_float_float
{
	public unsafe static void Invoke(float xf, void* sin_k, void* cos_k, void* sin_y, void* cosm1_y)
	{
		...
		k = range_reduction_sincosf16_float_float.Invoke(xf, &y);
		sincosf16_poly_eval_int_float_float_float_float_float_3.Invoke(k, y, sin_k, cos_k, sin_y, cosm1_y);
