...
internal static partial class BigInt_128ul_false_unsigned_long_BigInt_unsigned_int_void
{
	...
	public unsafe static void Invoke([MangledName("this")] Anon_izyfb7* This, [MangledName("v")][NativeType("unsigned int")] int V)
	{
		long num = 0L;
		sbyte b = 0;
		long num2 = 0L;
		...
		unchecked
		{
			...
			while (true)
			{
				...
				*(long*)Array_unsigned_long_2ul_Index_6dk93t.Invoke(&((Llvm_libc_20_1_2_BigInt_qdkjbh*)This)->Val, num2) = (uint)num3;
				num3 = 0;
				num2++;
			}
