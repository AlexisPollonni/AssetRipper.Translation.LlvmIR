...
internal static partial class Fputil_quick_mul_256ul
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_fputil_DyadicFloat_jhcpjj* Agg_result, [MangledName("a")][NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<256ul> const&")] Llvm_libc_20_1_2_fputil_DyadicFloat_jhcpjj* A, [MangledName("b")][NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<256ul> const&")] Llvm_libc_20_1_2_fputil_DyadicFloat_jhcpjj* B)
	{
		...
		Llvm_memcpy_p0_p0_i64.Invoke(source: (!Llvm_libc_20_1_2_NotEquals_rpctvi.Invoke(anon_izyfb.Val, anon_izyfb2.Val)) ? Llvm_libc_20_1_2_Sign_POS.Pointer : Llvm_libc_20_1_2_Sign_NEG.Pointer, destination: &Agg_result->Sign, length: 1L, isVolatile: false);
		...
		if (!BigInt_256ul_false_unsigned_long_is_zero.Invoke(&A->Mantissa) && !BigInt_256ul_false_unsigned_long_is_zero.Invoke(&B->Mantissa))
		{
			...
			BigInt_256ul_false_unsigned_long_quick_mul_hi.Invoke(&llvm_libc_20_1_2_BigInt_x9dsed, &A->Mantissa, &B->Mantissa);
			Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Mantissa, &llvm_libc_20_1_2_BigInt_x9dsed, 32L, isVolatile: false);
		...
		else
		{
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Mantissa, &llvm_libc_20_1_2_BigInt_x9dsed2, 32L, isVolatile: false);
