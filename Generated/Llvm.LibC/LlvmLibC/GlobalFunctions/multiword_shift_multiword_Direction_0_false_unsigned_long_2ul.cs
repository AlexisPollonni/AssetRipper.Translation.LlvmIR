...
internal static partial class multiword_shift_multiword_Direction_0_false_unsigned_long_2ul
{
	[MangledName("_ZN19__llvm_libc_20_1_2_9multiword5shiftILNS0_9DirectionE0ELb0EmLm2EEENS_3cpp5arrayIT1_XT2_EEES6_m")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::array<unsigned long, 2ul> __llvm_libc_20_1_2_::multiword::shift<(__llvm_libc_20_1_2_::multiword::Direction)0, false, unsigned long, 2ul>(__llvm_libc_20_1_2_::cpp::array<unsigned long, 2ul>, unsigned long)")]
	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("array.coerce0")] long array, [MangledName("array.coerce1")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 2ul>")] long offset, [MangledName("offset")][NativeType("unsigned long")] long WORD_BITS)
	{
		...
		unchecked
		{
			*(long*)(&cpp_array_i3937k3) = array;
			...
			Struct_fiz2nb struct_fiz2nb = cpp_bit_cast_unsigned_int128_cpp_array_unsigned_long_2ul.Invoke(&cpp_array_i3937k3);
			Int128* num3 = &@int;
