...
internal static partial class FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent
{
	...
	public unsafe static short Invoke([MangledName("this")] Fputil_internal_FPRepImpl_ucubaq* This)
	{
		...
		short result = unchecked((short)TypedInt_unsigned_int_ToUInt32_cpbc3y.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent));
