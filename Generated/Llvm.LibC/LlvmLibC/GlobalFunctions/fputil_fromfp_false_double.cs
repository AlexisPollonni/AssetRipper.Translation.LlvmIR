				...
				*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
				...
				else
				{
					...
					else
					{
						...
						long val4 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value.Invoke(biased_exp: num3, sign: anon_izyfb11.val, mantissa: 0L);
						fputil_FPBits_wjhbrm6.FPRepImpl.FPRepSem.FPStorage.val = val4;
						double num5 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm6) - 1.0;
