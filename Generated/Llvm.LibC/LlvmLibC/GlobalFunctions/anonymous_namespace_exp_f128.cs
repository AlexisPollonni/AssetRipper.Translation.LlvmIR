...
internal static partial class anonymous_namespace_exp_f128
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, [NativeType("double")] double x, [NativeType("double")] double kd, [NativeType("int")] int idx1, [NativeType("int")] int idx2)
	{
		...
		x2 = fputil_multiply_add_double.Invoke(kd, -0.00016922538588914904, x);
		...
		unchecked
		{
			...
			*(long*)ptr10 = -6148914691236517206L;
			...
			anonymous_namespace_poly_approx_f128_cq56ks.Invoke(&fputil_DyadicFloat_kt2kd21, &fputil_DyadicFloat_kt2kd5);
			*(sbyte*)agg_result = -86;
