	...
	public unsafe static int Invoke([MangledName("writer")][NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] Llvm_libc_20_1_2_printf_core_Writer* Writer, [MangledName("to_conv")][NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] Llvm_libc_20_1_2_printf_core_FormatSection* To_conv, [MangledName("float_bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<float>")] int Float_bits)
	{
		...
		unchecked
		{
			...
			*(Int128*)((byte*)(&llvm_libc_20_1_2_FloatToString_vnf) + 16) = -6148914691236517206L;
			...
			num4 = FloatToString_float_0_get_positive_blocks.Invoke(&llvm_libc_20_1_2_FloatToString_vnf);
		...
		unchecked
		{
			while (true)
			{
				...
				num6 = FloatToString_float_0_get_positive_block.Invoke(&llvm_libc_20_1_2_FloatToString_vnf, num5);
				if ((b2 & 1) == 1)
				{
			...
			if (num2 < 23)
			{
				...
				num10 = 0;
				if ((ulong)(uint)num9 <= (ulong)FloatToString_float_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_vnf))
				{
					num10 = num9;
				...
				else if ((ulong)(uint)num10 < (ulong)FloatToString_float_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_vnf))
				{
					num10 = (int)FloatToString_float_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_vnf);
				...
				while (true)
				{
					...
					{
						if (FloatToString_float_0_is_lowest_block.Invoke(&llvm_libc_20_1_2_FloatToString_vnf, (uint)num10))
						{
						...
						else
						{
							...
							num14 = FloatToString_float_0_get_negative_block.Invoke(&llvm_libc_20_1_2_FloatToString_vnf, num10);
							...
							else
							{
								...
								b3 = (InstructionHelper.BooleanXor(Printf_core_zero_after_digits_unsigned_int.Invoke(checked(num2 - 23), num3, FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs), 23), right: true) ? ((sbyte)1) : ((sbyte)0));
