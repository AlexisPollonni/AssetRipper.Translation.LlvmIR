		...
		unchecked
		{
			...
			*(Int128*)((byte*)(&floatToString_uyiqeh) + 16) = -6148914691236517206L;
			...
			if (NumericHelper.IntCmpNe(x, 0L))
			{
				...
				*(long*)num33 = struct_kqhe8i6.field_1;
				...
				if ((b & 1) != 1)
				{
					...
					{
						b = (sbyte)(byte)((cpp_enable_if_cpp_is_integral_v_unsigned_int_is_big_int_v_unsigned_int_bool_type_printf_core_zero_after_digits_unsigned_int_int_int_unsigned_int_int.Invoke(checked(num2 - 23), num5 - num4, fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa_const.Invoke(&fputil_FPBits_5nkvcs2), 23) ? 1 : 0) ^ -1);
					}
				}
				...
				if (num3 > num4 && num4 >= -4)
				{
					...
					result = int_printf_core_convert_float_decimal_typed_float_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_float.Invoke(writer, &printf_core_FormatSection3, fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0);
				...
				else
				{
					...
					result = int_printf_core_convert_float_dec_exp_typed_float_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_float.Invoke(writer, &printf_core_FormatSection4, fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0);
			...
			else
			{
				...
				result = int_printf_core_convert_float_decimal_typed_float_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_float.Invoke(writer, &printf_core_FormatSection2, fputil_FPBits_5nkvcs3.FPRepImpl.FPRepSem.field_0.field_0);
