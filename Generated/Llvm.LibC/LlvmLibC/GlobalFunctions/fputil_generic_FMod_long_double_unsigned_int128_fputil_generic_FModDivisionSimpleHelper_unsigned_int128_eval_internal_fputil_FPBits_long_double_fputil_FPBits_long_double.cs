...
internal static partial class fputil_generic_FMod_long_double_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_eval_internal_fputil_FPBits_long_double_fputil_FPBits_long_double
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("sx.coerce0")] long sx, [MangledName("sx.coerce1")] long sy, [MangledName("sy.coerce0")] long e_x, [MangledName("sy.coerce1")] long e_y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_ubgsi5) = e_x;
			...
			Struct_fiz2nb struct_fiz2nb = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
			Int128* num10 = &@int;
			...
			*(long*)num11 = struct_fiz2nb3.field_1;
			Int128 x2 = @int;
			Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi5);
			Int128* num12 = &y;
			...
			*(long*)num13 = struct_fiz2nb6.field_1;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(NumericHelper.IntCmpUle(x2, y), expected: true))
			{
				Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
				Int128* num14 = &int2;
				...
				*(long*)num17 = struct_fiz2nb12.field_1;
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb13 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero_Sign.Invoke(anon_izyfb8.val);
			...
			else
			{
				...
				num = (ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi4);
				llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi5);
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num2 > 63 && checked(num - num2) <= 15, expected: true))
				{
					llvm_lifetime_start_p0.Invoke(16L, &x);
					Struct_fiz2nb struct_fiz2nb16 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num18 = &int3;
					...
					*(long*)num19 = struct_fiz2nb18.field_1;
					...
					Struct_fiz2nb struct_fiz2nb19 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num20 = &int4;
					...
					*(long*)num21 = struct_fiz2nb21.field_1;
					...
					if (NumericHelper.IntCmpEq(int5, 0L))
					{
						...
						Struct_fiz2nb struct_fiz2nb22 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero_Sign.Invoke(anon_izyfb9.val);
					...
					else
					{
						...
						int6 = int21;
						Struct_fiz2nb struct_fiz2nb25 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_make_value_unsigned_int128_int.Invoke(*(long*)(&int6), ((long*)(&int6))[1], result);
				...
				else if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num == 0 && num2 == 0, expected: false))
				{
					*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb28 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num22 = &int7;
					...
					*(long*)num23 = struct_fiz2nb30.field_1;
					Int128 x4 = int7;
					Struct_fiz2nb struct_fiz2nb31 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num24 = &y4;
					...
					*(long*)num25 = struct_fiz2nb33.field_1;
					...
					fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int8), ((long*)(&int8))[1]);
				}
				else
				{
					llvm_lifetime_start_p0.Invoke(16L, &int9);
					Struct_fiz2nb struct_fiz2nb34 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num26 = &int10;
					...
					*(long*)num27 = struct_fiz2nb36.field_1;
					...
					Struct_fiz2nb struct_fiz2nb37 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num28 = &int12;
					...
					*(long*)num29 = struct_fiz2nb39.field_1;
					...
					{
						Struct_fiz2nb struct_fiz2nb40 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi5);
						Int128* num30 = &int13;
						...
						*(long*)num31 = struct_fiz2nb42.field_1;
						int11 = int13;
						int14 = int11;
						num4 = cpp_enable_if_cpp_is_unsigned_v_unsigned_int128_int_type_cpp_countl_zero_unsigned_int128_unsigned_int128.Invoke(*(long*)(&int14), ((long*)(&int14))[1]);
					}
					llvm_lifetime_start_p0.Invoke(4L, &num5);
					int15 = int11;
					num5 = cpp_enable_if_cpp_is_unsigned_v_unsigned_int128_int_type_cpp_countr_zero_unsigned_int128_unsigned_int128.Invoke(*(long*)(&int15), ((long*)(&int15))[1]);
					...
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(NumericHelper.IntCmpEq(int9, 0L), expected: false))
					{
						llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb10, Sign_POS.Pointer, 1L, isVolatile: false);
						Struct_fiz2nb struct_fiz2nb43 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero_Sign.Invoke(anon_izyfb10.val);
					...
					else if (num7 == 0)
					{
						...
						int result2 = num2;
						int16 = int22;
						Struct_fiz2nb struct_fiz2nb46 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_make_value_unsigned_int128_int.Invoke(*(long*)(&int16), ((long*)(&int16))[1], result2);
					...
					else
					{
						...
						int18 = int24;
						Struct_fiz2nb struct_fiz2nb49 = fputil_generic_FModDivisionSimpleHelper_unsigned_int128_execute_int_int_unsigned_int128_unsigned_int128.Invoke(exp_diff, sides_zeroes_count, x5, y5, *(long*)(&int18), ((long*)(&int18))[1]);
						Int128* num32 = &int19;
						...
						*(long*)num33 = struct_fiz2nb51.field_1;
						...
						int result3 = num2;
						int20 = int25;
						Struct_fiz2nb struct_fiz2nb52 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_make_value_unsigned_int128_int.Invoke(*(long*)(&int20), ((long*)(&int20))[1], result3);
