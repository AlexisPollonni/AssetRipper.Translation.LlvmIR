			...
			else
			{
				...
				*(long*)ptr8 = -6148914691236517206L;
				...
				if (details_expects_bool_condition_bool.Invoke((ushort)num < 1039, expected: true))
				{
					...
					range_reduction_small_f128_nv2a7v.Invoke(&fputil_DyadicFloat_kt2kd8, x);
				...
				*(long*)ptr10 = -6148914691236517206L;
				...
				_0_Invoke_zdjgbv.Invoke(&fputil_DyadicFloat_kt2kd10, &anon_izyfb9, num2 + 128);
				...
				*(long*)ptr12 = -6148914691236517206L;
				...
				_0_Invoke_zdjgbv.Invoke(&fputil_DyadicFloat_kt2kd11, &anon_izyfb9, num2 + 64);
				...
				*(long*)ptr14 = -6148914691236517206L;
				...
				fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd13, &fputil_DyadicFloat_kt2kd11, &fputil_DyadicFloat_kt2kd7);
				fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd14, &fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd6);
