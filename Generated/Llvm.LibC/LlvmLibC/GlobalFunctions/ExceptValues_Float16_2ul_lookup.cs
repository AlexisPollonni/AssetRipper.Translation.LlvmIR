...
internal static partial class ExceptValues_Float16_2ul_lookup
{
	...
	public unsafe static int Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_ExceptValues_rhfsch* This, [MangledName("x_bits")][NativeType("unsigned short")] short X_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (Details_expects_bool_condition_bool.Invoke((ushort)num3 == (ushort)((Llvm_libc_20_1_2_fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Input, Expected: false))
				{
					...
					case 2048:
					{
						int num7 = (ushort)((Llvm_libc_20_1_2_fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Rnd_upward_offset;
						num2 = (short)checked(unchecked((ushort)num2) + num7);
						break;
					}
					case 1024:
					{
						int num6 = (ushort)((Llvm_libc_20_1_2_fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Rnd_downward_offset;
