...
internal static partial class BigInt_320ul_false_unsigned_long_extend_unsigned_long_bool
{
	public unsafe static void Invoke(BigInt_76gxx6* @this, long index, bool is_neg)
	{
		long num = 0L;
		long num2 = 0L;
		...
		unchecked
		{
			...
			{
				long num3 = num;
				*(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long.Invoke(&@this->val, num2) = num3;
			}
