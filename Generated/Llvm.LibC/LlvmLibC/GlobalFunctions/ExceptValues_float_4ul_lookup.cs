...
internal static partial class ExceptValues_float_4ul_lookup
{
	...
	public unsafe static long Invoke([MangledName("this")] void* This, [MangledName("x_bits")][NativeType("unsigned int")] int X_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (Details_expects_bool_condition_bool.Invoke(X_bits == ((Llvm_libc_20_1_2_fputil_ExceptValues_float_6_Mapping*)(&((Llvm_libc_20_1_2_fputil_ExceptValues_kbc9gk*)This)->Values))[num].Input, Expected: false))
				{
					Llvm_lifetime_start_p0.Invoke(4L, &num2);
					num2 = ((Llvm_libc_20_1_2_fputil_ExceptValues_float_6_Mapping*)(&((Llvm_libc_20_1_2_fputil_ExceptValues_kbc9gk*)This)->Values))[num].Rnd_towardzero_result;
					switch (Fputil_quick_get_round.Invoke())
					{
					case 2048:
					{
						int rnd_upward_offset = ((Llvm_libc_20_1_2_fputil_ExceptValues_float_6_Mapping*)(&((Llvm_libc_20_1_2_fputil_ExceptValues_kbc9gk*)This)->Values))[num].Rnd_upward_offset;
						num2 += rnd_upward_offset;
						break;
					}
					case 1024:
					{
						int rnd_downward_offset = ((Llvm_libc_20_1_2_fputil_ExceptValues_float_6_Mapping*)(&((Llvm_libc_20_1_2_fputil_ExceptValues_kbc9gk*)This)->Values))[num].Rnd_downward_offset;
						num2 += rnd_downward_offset;
						break;
					}
					case 0:
					{
						int rnd_tonearest_offset = ((Llvm_libc_20_1_2_fputil_ExceptValues_float_6_Mapping*)(&((Llvm_libc_20_1_2_fputil_ExceptValues_kbc9gk*)This)->Values))[num].Rnd_tonearest_offset;
