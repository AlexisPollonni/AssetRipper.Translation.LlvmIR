...
internal static partial class BigInt_256ul_false_unsigned_long_Increment
{
	...
	public unsafe static BigInt_x9dsed* Invoke([MangledName("this")] BigInt_x9dsed* This)
	{
...
internal static partial class BigInt_256ul_false_unsigned_long_increment
{
	...
	public unsafe static void Invoke([MangledName("this")] BigInt_x9dsed* This)
	{
		...
		*unchecked((long*)(&cpp_array_rpgxvv.Data)) = 1L;
		Multiword_add_with_carry_unsigned_long_4ul_1ul.Invoke(val, &cpp_array_rpgxvv);
