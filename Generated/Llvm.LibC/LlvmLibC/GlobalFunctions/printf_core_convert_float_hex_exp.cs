...
internal static partial class printf_core_convert_float_hex_exp
{
	...
	public unsafe static int Invoke([NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] printf_core_Writer* writer, [NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] printf_core_FormatSection* to_conv)
	{
		int result = 0;
		sbyte b = 0;
		int num = 0;
		...
		unchecked
		{
			if (to_conv->length_modifier == LengthModifier_mnvaa2.L)
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
				...
				num = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_exponent.Invoke(&fputil_FPBits_ubgsi3);
				...
				*(long*)num37 = struct_fiz2nb3.field_1;
				x = int3;
				b2 = (FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_inf_or_nan.Invoke(&fputil_FPBits_ubgsi3) ? ((sbyte)1) : ((sbyte)0));
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
				...
				num = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_explicit_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
				x = (Int128)(UInt128)(ulong)FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2));
				b2 = (FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_inf_or_nan.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) ? ((sbyte)1) : ((sbyte)0));
			...
			*(IntPtr*)(&cpp_string_view2) = unchecked((nint)(-6148914691236517206L));
			...
			string_view_Constructor.Invoke(&cpp_string_view2, &inlineArray2_SByte, 2L);
			...
			*(InlineArray2_SByte**)(&cpp_string_view3) = str_4_162.Pointer;
			...
			if (((byte)to_conv->flags & 1) == 1)
			{
				...
				num18 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view4), ((long*)(&cpp_string_view4))[1]);
				if (num18 < 0)
				{
					result = num18;
					num38 = 1;
				...
				if ((b7 & 1) == 1)
				{
					...
					num20 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view5), ((long*)(&cpp_string_view5))[1]);
					if (num20 < 0)
					{
						result = num20;
						num38 = 1;
				...
				if ((ulong)num10 > 1uL)
				{
					...
					string_view_Constructor.Invoke(&cpp_string_view6, Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray16_SByte, 1)), num10 - 1L);
					num21 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view6), ((long*)(&cpp_string_view6))[1]);
					if (num21 < 0)
					{
						result = num21;
						num38 = 1;
				...
				string_view_Constructor.Invoke(&cpp_string_view7, Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray6_SByte, (nint)num12)), 6L - num12);
				num24 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view7), ((long*)(&cpp_string_view7))[1]);
				if (num24 < 0)
				{
					result = num24;
					num38 = 1;
			...
			else
			{
				...
				num28 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view8), ((long*)(&cpp_string_view8))[1]);
				if (num28 < 0)
				{
					result = num28;
					num38 = 1;
				...
				if ((b7 & 1) == 1)
				{
					...
					num31 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view9), ((long*)(&cpp_string_view9))[1]);
					if (num31 < 0)
					{
						result = num31;
						num38 = 1;
				...
				if ((ulong)num10 > 1uL)
				{
					...
					string_view_Constructor.Invoke(&cpp_string_view10, Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray16_SByte, 1)), num10 - 1L);
					num32 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view10), ((long*)(&cpp_string_view10))[1]);
					if (num32 < 0)
					{
						result = num32;
						num38 = 1;
				...
				string_view_Constructor.Invoke(&cpp_string_view11, Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray6_SByte, (nint)num12)), 6L - num12);
				num35 = Writer_write.Invoke(writer, *(void**)(&cpp_string_view11), ((long*)(&cpp_string_view11))[1]);
				if (num35 < 0)
				{
					result = num35;
					num38 = 1;
