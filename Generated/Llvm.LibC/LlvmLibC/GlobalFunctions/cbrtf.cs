	...
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			num2 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) >>> 31 << 11;
			float result;
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm2, x2);
				llvm_lifetime_start_p0.Invoke(4L, &num3);
				num3 = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
				llvm_lifetime_start_p0.Invoke(4L, &num4);
				num4 = (int)((uint)num3 / 3u + 682) | num2;
				llvm_lifetime_start_p0.Invoke(4L, &num5);
				num5 = (int)((uint)num3 % 3u);
				llvm_lifetime_start_p0.Invoke(8L, &num6);
				num6 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
				llvm_lifetime_start_p0.Invoke(4L, &num7);
				num7 = (int)(num6 >>> 48);
				num6 |= 0x3FF0000000000000L;
				llvm_lifetime_start_p0.Invoke(8L, &num8);
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm3);
				FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm3, num6);
				double num12 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm3);
				...
				z = fputil_multiply_add_double.Invoke(x6, *(double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num13 * sizeof(InlineArray7_Double)), 1.0);
				...
				y = fputil_multiply_add_double.Invoke(x7, y4, ((double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num15 * sizeof(InlineArray7_Double)))[1]);
				...
				z2 = fputil_multiply_add_double.Invoke(x8, y5, ((double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num17 * sizeof(InlineArray7_Double)))[3L]);
				...
				y2 = fputil_multiply_add_double.Invoke(x9, y6, ((double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num19 * sizeof(InlineArray7_Double)))[5L]);
				...
				double num20 = fputil_multiply_add_double.Invoke(x3, y3, z3);
				long num21 = (uint)num5;
				x4 = num20 * ((double*)anonymous_namespace_CBRT2.Pointer)[num21];
				llvm_lifetime_start_p0.Invoke(8L, &num11);
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm4);
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm4, x4);
				long num22 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm4));
				...
				FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm5, x5);
				result = (float)FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm5);
