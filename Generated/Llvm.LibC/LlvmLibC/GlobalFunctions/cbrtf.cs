			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
				...
				z = fputil_multiply_add_double_double_double.Invoke(x6, *(double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num13 * sizeof(InlineArray7_Double)), 1.0);
				...
				y = fputil_multiply_add_double_double_double.Invoke(x7, y4, ((double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num15 * sizeof(InlineArray7_Double)))[1]);
				...
				z2 = fputil_multiply_add_double_double_double.Invoke(x8, y5, ((double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num17 * sizeof(InlineArray7_Double)))[3L]);
				...
				y2 = fputil_multiply_add_double_double_double.Invoke(x9, y6, ((double*)((byte*)anonymous_namespace_COEFFS.Pointer + (nint)num19 * sizeof(InlineArray7_Double)))[5L]);
				llvm_lifetime_start_p0.Invoke(8L, &x3);
				x3 = num10 * num10;
				llvm_lifetime_start_p0.Invoke(8L, &z3);
				z3 = fputil_multiply_add_double_double_double.Invoke(num10, y, z);
				llvm_lifetime_start_p0.Invoke(8L, &y3);
				y3 = fputil_multiply_add_double_double_double.Invoke(num10, y2, z2);
				llvm_lifetime_start_p0.Invoke(8L, &x4);
				double num20 = fputil_multiply_add_double_double_double.Invoke(x3, y3, z3);
