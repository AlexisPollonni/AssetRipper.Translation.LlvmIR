...
internal static partial class NormalFloat_float128_init_from_bits
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_NormalFloat_wqb3ie* This, [MangledName("bits.coerce0")] long Bits, [MangledName("bits.coerce1")] long Shift)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_ubgsi) = Bits;
			((long*)(&fputil_FPBits_ubgsi))[1] = Shift;
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)))
			{
			...
			else
			{
				...
				checked
				{
					This->Exponent = unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) - 16383;
					struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
					num6 = &int3;
