...
internal static partial class Parser_internal_ArgList_Constructor_hus89e
{
	...
	public unsafe static void Invoke([MangledName("this")] Printf_core_Parser* This, [MangledName("new_str")][NativeType("char const*")] void* New_str, [MangledName("args")][NativeType("__llvm_libc_20_1_2_::internal::ArgList&")] Internal_ArgList* Args)
	{
		This->Str = New_str;
		This->Cur_pos = 0L;
