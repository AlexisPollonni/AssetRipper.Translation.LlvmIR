...
internal static partial class BigInt_64ul_false_unsigned_long_to_unsigned_int
{
	...
	public unsafe static int Invoke(BigInt_555ggs* @this)
	{
		...
		num2 = unchecked((int)(*(long*)array_unsigned_long_1ul_Index_fk3nam.Invoke(&@this->val, 0L)));
		int result = num2;
