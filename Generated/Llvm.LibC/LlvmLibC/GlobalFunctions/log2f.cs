...
internal static partial class log2f
{
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				bool num8 = (uint)num7 < (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3));
				...
				else
				{
					...
					value = (((uint)num9 > (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs4))) ? 1 : 0);
				}
		...
		return result;
		IL_0384:
		int num11 = unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)));
		num2 += num11;
		llvm_lifetime_start_p0.Invoke(4L, &num3);
		unchecked
		{
			num3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) >>> 16;
			...
			num4 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
			llvm_lifetime_start_p0.Invoke(8L, &num5);
			num5 = double.NaN;
			double x3 = num4;
			long num12 = num3;
			num5 = fputil_multiply_add_double.Invoke(x3, ((double*)RD.Pointer)[num12], -1.0);
			...
			*(double*)(&inlineArray5_Double) = 1.4426950408888615;
			...
			num6 = fputil_polyeval_double_double_double.Invoke(x2, a, a_yc74sk, a_ijazrn);
			result = (float)num6;
