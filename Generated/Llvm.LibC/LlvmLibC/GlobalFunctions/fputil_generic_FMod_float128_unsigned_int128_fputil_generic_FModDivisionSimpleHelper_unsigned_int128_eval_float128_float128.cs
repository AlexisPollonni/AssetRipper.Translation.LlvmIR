...
[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic4FModIgoNS1_24FModDivisionSimpleHelperIoEEE4evalEgg")]
[DemangledName("__llvm_libc_20_1_2_::fputil::generic::FMod<__float128, unsigned __int128, __llvm_libc_20_1_2_::fputil::generic::FModDivisionSimpleHelper<unsigned __int128>>::eval(__float128, __float128)")]
internal static partial class fputil_generic_FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_eval_float128_float128
{
	public unsafe static double Invoke(double x, double y)
	{
		...
		num = double.NaN;
		int num2;
		if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(fputil_generic_FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_pre_check_float128_float128_float128.Invoke(x, y, &num), expected: false))
		{
			result = num;
			num2 = 1;
		}
		...
		unchecked
		{
			...
			case 0:
			{
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				fputil_internal_FPStorage_fputil_FPType_3_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi3, anon_izyfb9.val);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb10, Sign_POS.Pointer, 1L, isVolatile: false);
				fputil_internal_FPStorage_fputil_FPType_3_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi4, anon_izyfb10.val);
				...
				*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
				...
				Struct_fiz2nb struct_fiz2nb = fputil_generic_FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_eval_internal_fputil_FPBits_float128_fputil_FPBits_float128.Invoke(*(long*)(&fputil_FPBits_ubgsi6), ((long*)(&fputil_FPBits_ubgsi6))[1], *(long*)(&fputil_FPBits_ubgsi7), ((long*)(&fputil_FPBits_ubgsi7))[1]);
				...
				fputil_internal_FPStorage_fputil_FPType_3_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi5, anon_izyfb11.val);
