...
internal static partial class Internal_shift_mantissa_BigInt_64ul_false_unsigned_long
{
	...
	public unsafe static bool Invoke([MangledName("shift_length")][NativeType("int")] int Shift_length, [MangledName("mant")][NativeType("__llvm_libc_20_1_2_::BigInt<64ul, false, unsigned long>&")] BigInt_555ggs* Mant)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				*(long*)(&bigInt_555ggs2) = -6148914691236517206L;
				...
				BigInt_64ul_false_unsigned_long_BigInt_int_void.Invoke(&bigInt_555ggs4, 1);
				long data = BigInt_64ul_false_unsigned_long_LeftShift.Invoke(&bigInt_555ggs4, Shift_length);
				*(long*)(&bigInt_555ggs3.Val.Data) = data;
				...
				long data2 = BigInt_64ul_false_unsigned_long_Subtract_dhppwb.Invoke(&bigInt_555ggs3, &bigInt_555ggs5);
				*(long*)(&bigInt_555ggs2.Val.Data) = data2;
				...
				long data3 = BitwiseAnd.Invoke(Mant, &bigInt_555ggs2);
				*(long*)(&bigInt_555ggs6.Val.Data) = data3;
				Llvm_lifetime_start_p0.Invoke(8L, &bigInt_555ggs7);
				BigInt_64ul_false_unsigned_long_BigInt_int_void.Invoke(&bigInt_555ggs7, 0);
				bool num = NotEquals_b94f9b.Invoke(&bigInt_555ggs6, &bigInt_555ggs7);
