...
internal static partial class NormalFloat_double_cmp
{
	...
	public unsafe static int Invoke([MangledName("this")] Fputil_NormalFloat_vc4yvk* This, [MangledName("other")][NativeType("__llvm_libc_20_1_2_::fputil::NormalFloat<double> const&")] Fputil_NormalFloat_vc4yvk* Other)
	{
		int num = 0;
		...
		int result = ((!NotEquals_rpctvi.Invoke(anon_izyfb.Val, anon_izyfb2.Val)) ? ((This->Exponent <= Other->Exponent) ? ((This->Exponent != Other->Exponent) ? (-num) : (unchecked((ulong)This->Mantissa <= (ulong)Other->Mantissa) ? ((This->Mantissa != Other->Mantissa) ? (-num) : 0) : num)) : num) : num);
