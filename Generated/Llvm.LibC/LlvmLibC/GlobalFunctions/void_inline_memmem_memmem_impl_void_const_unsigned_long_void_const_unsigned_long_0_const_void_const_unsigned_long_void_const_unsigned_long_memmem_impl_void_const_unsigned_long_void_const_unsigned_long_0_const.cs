...
internal static partial class void_inline_memmem_memmem_impl_void_const_unsigned_long_void_const_unsigned_long_0_const_void_const_unsigned_long_void_const_unsigned_long_memmem_impl_void_const_unsigned_long_void_const_unsigned_long_0_const
{
		...
		unchecked
		{
			...
			else
			{
				...
				while (true)
				{
					...
					for (num2 = 0L; (ulong)num2 < (ulong)needle_len && (((memmem_impl_void_const_unsigned_long_void_const_unsigned_long_0_operator_unsigned_char_unsigned_char_const.Invoke(comp, ((sbyte*)ptr)[num + num2], ((sbyte*)ptr2)[num2]) != 0) ? 1u : 0u) ^ 0xFFFFFFFFu) != 0; num2++)
					{
					}
					if (num2 == needle_len)
					{
