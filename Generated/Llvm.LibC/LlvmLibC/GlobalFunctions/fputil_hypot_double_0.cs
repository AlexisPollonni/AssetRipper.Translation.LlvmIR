	...
	public unsafe static double Invoke([NativeType("double")] double x, [NativeType("double")] double y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm4) = -6148914691236517206L;
			...
			b = (((ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) >= (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm4))) ? ((sbyte)1) : ((sbyte)0));
			...
			*(long*)(&fputil_FPBits_wjhbrm7) = -6148914691236517206L;
			...
			if (details_expects_bool_condition_bool.Invoke(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_inf_or_nan.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm6)), expected: false))
			{
				if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_signaling_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_signaling_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)))
				{
					fputil_raise_except_if_required.Invoke(1);
					llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm8);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb8, Sign_POS.Pointer, 1L, isVolatile: false);
					long val3 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(anon_izyfb8.val, 0L);
				...
				else if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_inf.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_inf.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)))
				{
					llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm9);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, Sign_POS.Pointer, 1L, isVolatile: false);
					long val4 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf.Invoke(anon_izyfb9.val);
				...
				{
					result = ((!FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2))) ? y : x);
				}
				goto IL_0e23;
			}
			llvm_lifetime_start_p0.Invoke(2L, &num);
			num = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm6));
			llvm_lifetime_start_p0.Invoke(2L, &num2);
			num2 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm7));
		}
		if (unchecked((ushort)num) - unchecked((ushort)num2) >= 54 || x == 0.0 || y == 0.0)
		{
			result = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm2) + FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm4);
			goto IL_0e01;
		}
		...
		unchecked
		{
			...
			num4 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm6));
			llvm_lifetime_start_p0.Invoke(8L, &num5);
			num5 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm7));
				...
				if (num7 == 9007199254740992L)
				{
					...
					if ((ulong)num3 >= 2047uL)
					{
						...
						if (num10 == 0 || num10 == 2048)
						{
							...
							long val5 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf.Invoke(anon_izyfb10.val);
						...
						case 0:
						{
							...
							long val6 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_max_normal.Invoke(anon_izyfb11.val);
			...
			if ((ulong)num11 >= 4503599627370496uL)
			{
				...
				if ((ulong)num3 >= 2047uL)
				{
					if (num16 == 0 || num16 == 2048)
					{
						...
						long val7 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf.Invoke(anon_izyfb12.val);
					...
					else
					{
						...
						long val8 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_max_normal.Invoke(anon_izyfb13.val);
						fputil_FPBits_wjhbrm13.FPRepImpl.FPRepSem.FPStorage.val = val8;
						result = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm13);
