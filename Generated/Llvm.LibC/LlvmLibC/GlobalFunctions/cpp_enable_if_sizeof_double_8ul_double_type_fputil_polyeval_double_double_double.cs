...
internal static partial class cpp_enable_if_sizeof_double_8ul_double_type_fputil_polyeval_double_double_double
{
	public static double Invoke(double parameter_0, double a0)
	{
		return a0;
	}
}
