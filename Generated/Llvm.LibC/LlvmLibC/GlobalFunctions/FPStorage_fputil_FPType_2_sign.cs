...
internal static partial class FPStorage_fputil_FPType_2_sign
{
	...
	public unsafe static sbyte Invoke([MangledName("this")] void* This)
	{
		...
		Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb, ((unchecked((Fputil_internal_FPStorage_v3nexn*)This)->Val & long.MinValue) == 0L) ? Sign_POS.Pointer : Sign_NEG.Pointer, 1L, isVolatile: false);
