...
internal static partial class Llvm_libc_20_1_2_exp_range_reduction
{
	...
	public unsafe static InlineArray2_Single Invoke([MangledName("x")][NativeType("_Float16")] Half X)
	{
		...
		unchecked
		{
			...
			num6 = *(float*)Array_float_31ul_Index.Invoke(Index: checked(num4 + 18), This: Llvm_libc_20_1_2_EXP_HI.Pointer);
			Llvm_lifetime_start_p0.Invoke(4L, &num7);
			num7 = *(float*)Array_float_8ul_Index.Invoke(Index: num5, This: Llvm_libc_20_1_2_EXP_MID.Pointer);
			...
			llvm_libc_20_1_2_ExpRangeReduction.Exp_hi_mid = num6 * num7;
