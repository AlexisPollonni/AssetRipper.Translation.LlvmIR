...
internal static partial class openat
{
	public unsafe static int Invoke(int dfd, void* path, int flags, ReadOnlySpan<nint> args)
	{
		int ts_784yyq = 0;
		InlineArray1_va_list_tag inlineArray1_va_list_tag = default(InlineArray1_va_list_tag);
		int num = 0;
		llvm_lifetime_start_p0.Invoke(4L, &ts_784yyq);
		ts_784yyq = 0;
		unchecked
		{
			...
			num = int_syscall_impl_int_int_char_const_int_unsigned_int_long_int_char_const_int_unsigned_int.Invoke(257L, dfd, path, flags, ts_784yyq);
		}
		int result;
		if (num > 0)
		{
		...
		llvm_lifetime_end_p0.Invoke(4L, &ts_784yyq);
		return result;
	}
}
