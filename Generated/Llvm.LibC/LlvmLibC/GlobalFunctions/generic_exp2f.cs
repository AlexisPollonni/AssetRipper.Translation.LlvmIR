	...
	public unsafe static float Invoke([NativeType("float")] float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			num4 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2));
			...
			else
			{
				...
				else if (fputil_fenv_is_round_up.Invoke())
				{
					...
					int field_3 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_min_subnormal.Invoke(anon_izyfb10.val);
		...
		unchecked
		{
			*(double*)(&inlineArray5_Double) = 0.6931471805599453;
			...
			x5 = fputil_multiply_add_double.Invoke(num13, y2, z);
			result = (float)fputil_multiply_add_double.Invoke(x5, num13 * num12, num14 * num12);
		...
		unchecked
		{
			*(double*)(&inlineArray6_Double) = 0.6931471805599457;
			...
			x3 = fputil_polyeval_double_double_double.Invoke(x2, a, a_yc74sk, a_ijazrn);
			llvm_lifetime_start_p0.Invoke(8L, &num7);
			num7 = fputil_multiply_add_double.Invoke(x3, num6, 1.0);
			result = (float)num7;
