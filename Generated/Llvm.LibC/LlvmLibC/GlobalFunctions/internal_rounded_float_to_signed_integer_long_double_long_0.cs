...
internal static partial class internal_rounded_float_to_signed_integer_long_double_long_0
{
	...
	public unsafe static long Invoke([NativeType("long double")] double x)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			{
				lambda_Invoke_b7spk7.Invoke(&anon_izyfb8);
				result = InstructionHelper.Select(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi3), long.MinValue, long.MaxValue);
				goto IL_0209;
			}
			llvm_lifetime_start_p0.Invoke(4L, &num3);
			num3 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_exponent.Invoke(&fputil_FPBits_ubgsi3);
			...
			else
			{
				...
				if (!FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_pos.Invoke(&fputil_FPBits_ubgsi3))
				{
