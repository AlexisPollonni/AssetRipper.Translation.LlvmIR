...
internal static partial class StrToNumResult_double_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] StrToNumResult_k826n6* This, [MangledName("value")][NativeType("double")] double Value, [MangledName("parsed_len")][NativeType("long")] long Parsed_len, [MangledName("error")][NativeType("int")] int Error)
	{
		This->Value = Value;
		This->Error = Error;
