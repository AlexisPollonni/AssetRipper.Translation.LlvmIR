...
internal static partial class fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_FPRepImpl
{
	public unsafe static void Invoke(fputil_internal_FPRepImpl_vhj4tm* @this)
	{
		fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_FPRepSem.Invoke(@this);
	}
}
