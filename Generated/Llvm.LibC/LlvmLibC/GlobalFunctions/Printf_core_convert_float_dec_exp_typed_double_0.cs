		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (num13 == num12)
				{
					...
					num15 = FloatToString_double_0_get_block.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy, num6);
					...
					checked
					{
						if (num6 >= 0)
						{
							...
							for (j = num6 - 1; j >= 0; j += -1)
							{
								...
								num16 = FloatToString_double_0_get_block.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy, j);
								if (num16 != 0)
								{
									b2 = 1;
									num21 = 10;
