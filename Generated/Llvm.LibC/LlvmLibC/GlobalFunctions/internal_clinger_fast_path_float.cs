...
internal static partial class internal_clinger_fast_path_float
{
	...
	public unsafe static Struct_8myw6y Invoke([MangledName("init_num.coerce")][NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<float>")] long init_num, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round)
	{
		...
		unchecked
		{
			*(long*)(&internal_ExpandedFloat_i7t5up2) = init_num;
			...
			if ((uint)num >> 23 != 0)
			{
				optional_internal_ExpandedFloat_float_Constructor_h2idu8.Invoke(&cpp_optional_6hseum2);
				goto IL_04b5;
			}
			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			if (num2 == 0)
			{
				...
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs3, num3);
			...
			if (num2 > 0)
			{
				...
				else
				{
					...
					if (!(num3 > 16777215f))
					{
						...
						float num6 = num3;
						long num7 = num2;
						FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs4, num6 * ((float*)internal_ClingerConsts_float_POWERS_OF_TEN_ARRAY.Pointer)[num7]);
		...
		if (num2 < 0)
		{
			...
			float num8 = num3;
			long num9 = -num2;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs5, num8 / unchecked((float*)internal_ClingerConsts_float_POWERS_OF_TEN_ARRAY.Pointer)[num9]);
		...
		unchecked
		{
			if (round != RoundDirection_b3pcwy.Nearest)
			{
				...
				*(int*)(&fputil_FPBits_5nkvcs6) = -1431655766;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs6);
				llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs7);
				float num10 = 0f - num3;
				long num11 = num2;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs7, num10 * ((float*)internal_ClingerConsts_float_POWERS_OF_TEN_ARRAY.Pointer)[num11]);
				...
				if (NumericHelper.IsUnorderedOrNotEquals(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2), 0f - FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs6)))
				{
					...
					*(int*)(&fputil_FPBits_5nkvcs9) = -1431655766;
					FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs9);
					if (FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2) < 0f - FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs6))
					{
			...
			*(int*)(&internal_ExpandedFloat_i7t5up3) = -1431655766;
			...
			internal_ExpandedFloat_i7t5up3.mantissa = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs2);
			internal_ExpandedFloat_i7t5up3.exponent = (ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2));
			optional_internal_ExpandedFloat_float_Constructor_cm37bp.Invoke(&cpp_optional_6hseum2, &internal_ExpandedFloat_i7t5up3);
