	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X, [MangledName("exp")][NativeType("long")] long Exp)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva) = -21846;
			...
			if (Details_expects_bool_condition_bool.Invoke(Exp == 0L || FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva)) || FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_inf_or_nan.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva)), Expected: false))
			{
				result = X;
				goto IL_05c3;
			}
		...
		fputil_DyadicFloat_jvghxm.Exponent += unchecked((int)Exp);
