				...
				else
				{
					if (NumericHelper.IsUnorderedOrNotEquals(From, default(Half)))
					{
						if (Fputil_cast_long_double_Float16.Invoke(From) < To == NumericHelper.FcmpOgt(From, default(Half)))
						{
							...
							FPBits_Float16_FPBits_unsigned_short.Invoke(&fputil_FPBits_2fahva2, (short)checked(unchecked((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva))) + 1));
