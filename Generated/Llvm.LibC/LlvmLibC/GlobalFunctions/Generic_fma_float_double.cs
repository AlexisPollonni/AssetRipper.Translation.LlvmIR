...
internal static partial class Generic_fma_float_double
{
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("y")][NativeType("double")] double Y, [MangledName("z")][NativeType("double")] double Z)
	{
		int num = 0;
		long num2 = 0L;
		long num3 = 0L;
			...
			*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
			...
			if (Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3)), Expected: false) && (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2))))
			{
				...
				if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_quiet_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm)))
				{
					...
					int field_ = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(V: (int)num4, Sign: anon_izyfb.Val);
				...
				else if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_quiet_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)))
				{
					...
					int field_2 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(V: (int)num5, Sign: anon_izyfb2.Val);
				...
				else if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_quiet_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3)))
				{
					...
					int field_3 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(V: (int)num6, Sign: anon_izyfb3.Val);
			...
			{
				result = Fputil_cast_float_double.Invoke(Llvm_fmuladd_f64.Invoke(num15, num16, num17));
			}
			else
			{
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm4, num15);
				bool num18 = Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_subnormal.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)), Expected: false);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm5, num16);
				bool num19 = Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_subnormal.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm5)), Expected: false);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm6, num17);
				bool num20 = Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_subnormal.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm6)), Expected: false);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm7, num15);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm8, num16);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm9, num17);
				...
				*(sbyte*)(&anon_izyfb6) = -86;
				...
				else
				{
					...
					*(long*)ptr6 = -6148914691236517206L;
					...
					result = DyadicFloat_128ul_as_float_true_void.Invoke(&fputil_DyadicFloat_kt2kd);
