...
internal static partial class printf_core_convert_float_dec_exp_typed_double_0
{
	...
	public unsafe static int Invoke([NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] printf_core_Writer* writer, [NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] printf_core_FormatSection* to_conv, [MangledName("float_bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<double>")] long float_bits)
	{
		...
		unchecked
		{
			num2 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_explicit_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
			...
			init_sign_char = 0;
			if (FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)))
			{
				init_sign_char = 45;
			}
			...
			*(Int128*)((byte*)(&floatToString_rwjwy) + 16) = -6148914691236517206L;
			FloatToString_double_0_Constructor.Invoke(&floatToString_rwjwy, FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm2));
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if ((b2 & 1) != 1)
				{
					checked
					{
						if (num6 >= 0)
						{
							...
							for (j = num6 - 1; j >= 0; j += -1)
							{
								...
								num17 = FloatToString_double_0_get_block.Invoke(&floatToString_rwjwy, j);
								if (num17 != 0)
								{
									b2 = 1;
									num22 = 10;
					...
					{
						b2 = (sbyte)(byte)((printf_core_zero_after_digits_unsigned_long.Invoke(checked(num2 - 52), num3 - num5, FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)), 52) ? 1 : 0) ^ -1);
					}
				}
				...
				num18 = FloatWriter_write_last_block.Invoke(&printf_core_FloatWriter2, num7, num13, (RoundDirection_zvveyk)num16, num5, InstructionHelper.Select(internal_islower_p5hwic.Invoke(to_conv->conv_name), (sbyte)101, (sbyte)69));
				if (num18 < 0)
				{
					result = num18;
					num22 = 1;
