...
internal static partial class FPStorage_fputil_FPType_4_biased_exponent
{
	...
	public unsafe static int Invoke([MangledName("this")] void* This)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			BiasedExponent_Constructor_w8dba9.Invoke(&llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent, (int)NumericHelper.ShiftRightLogical(x, 64L));
