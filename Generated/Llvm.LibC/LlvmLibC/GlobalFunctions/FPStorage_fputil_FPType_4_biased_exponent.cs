	...
	public unsafe static int Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			BiasedExponent_Constructor_w8dba9.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2, (int)NumericHelper.ShiftRightLogical(x, 64L));
