...
internal static partial class Llvm_libc_20_1_2_eval_sinh_or_cosh_true
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X)
	{
		...
		float num13 = 0f;
		float x3 = 0f;
		Llvm_libc_20_1_2_cpp_array_scvvei llvm_libc_20_1_2_cpp_array_scvvei = default(Llvm_libc_20_1_2_cpp_array_scvvei);
		float num14 = 0f;
		float num15 = 0f;
		...
		unchecked
		{
			...
			x = *(int*)Array_unsigned_int_32ul_Index.Invoke(Index: (uint)num7, This: Llvm_libc_20_1_2_EXP2_MID_5_BITS_5.Pointer) + (num5 << 23);
			Llvm_lifetime_start_p0.Invoke(4L, &x2);
			x2 = *(int*)Array_unsigned_int_32ul_Index.Invoke(Index: (uint)num8, This: Llvm_libc_20_1_2_EXP2_MID_5_BITS_5.Pointer) + (num6 << 23);
			Llvm_lifetime_start_p0.Invoke(4L, &num9);
			Llvm_lifetime_start_p0.Invoke(4L, &llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
			FPBits_float_FPBits_unsigned_int.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs, x);
			float num16 = FPBits_float_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
			...
			FPBits_float_FPBits_unsigned_int.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs2, x2);
			...
			x3 = num13 * num13;
			Llvm_lifetime_start_p0.Invoke(16L, &llvm_libc_20_1_2_cpp_array_scvvei);
			sbyte* ptr = (sbyte*)(&llvm_libc_20_1_2_cpp_array_scvvei);
			*(float*)ptr = 1f;
			((float*)ptr)[1] = 1f;
			((float*)ptr)[2L] = 0.5000305f;
			((float*)ptr)[3L] = 0.16667074f;
			Llvm_lifetime_start_p0.Invoke(4L, &num14);
			num14 = Fputil_polyeval_float_float.Invoke(x3, *(float*)Array_float_4ul_Index.Invoke(&llvm_libc_20_1_2_cpp_array_scvvei, 1L) * 0.5f, *(float*)Array_float_4ul_Index.Invoke(&llvm_libc_20_1_2_cpp_array_scvvei, 3L) * 0.5f);
			Llvm_lifetime_start_p0.Invoke(4L, &num15);
			num15 = Fputil_polyeval_float_float.Invoke(x3, *(float*)Array_float_4ul_Index.Invoke(&llvm_libc_20_1_2_cpp_array_scvvei, 0L) * 0.5f, *(float*)Array_float_4ul_Index.Invoke(&llvm_libc_20_1_2_cpp_array_scvvei, 2L) * 0.5f);
			Half result = Fputil_cast_Float16_float.Invoke(Fputil_multiply_add_float.Invoke(num13, num14 * num11, num15 * num12));
			Llvm_lifetime_end_p0.Invoke(4L, &num15);
			Llvm_lifetime_end_p0.Invoke(4L, &num14);
			Llvm_lifetime_end_p0.Invoke(16L, &llvm_libc_20_1_2_cpp_array_scvvei);
