		...
		unchecked
		{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			for (num = 0L; (ulong)num < 10uL; num++)
			{
				...
				{
					long num6 = unsigned_long_multiword_mul_add_with_carry_unsigned_long_2ul_cpp_array_unsigned_long_2ul_unsigned_long_unsigned_long.Invoke((cpp_array_i3937k*)(&bigInt_qdkjbh), *(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long_const.Invoke(lhs, num5), *(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long_const.Invoke(rhs, num - num5));
					num4 += num6;
				}
