...
internal static partial class Fputil_nextupdown_false
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			bool num = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi);
			...
			else
			{
				...
				if (Internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud), ((long*)(&fputil_internal_FPRepImpl_jrxud))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud2), ((long*)(&fputil_internal_FPRepImpl_jrxud2))[1]))
				{
					num2 = 1;
				}
				else
				{
					...
					Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud4, &fputil_FPBits_ubgsi3, 16L, isVolatile: false);
					num2 = (Internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud3), ((long*)(&fputil_internal_FPRepImpl_jrxud3))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud4), ((long*)(&fputil_internal_FPRepImpl_jrxud4))[1]) ? 1 : 0);
				}
			}
			...
			{
				anon_izyfb5.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi);
				Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb6, &anon_izyfb, 1L, isVolatile: false);
				if (Equals_fy8fvt.Invoke(anon_izyfb5.Val, anon_izyfb6.Val))
				{
					...
					*(long*)num4 = struct_fiz2nb12.field_1;
					if (NumericHelper.IntCmpEq(x, long.MaxValue))
					{
						...
						checked
						{
							int2 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) + 1;
						}
					...
					else
					{
						...
						*(long*)num6 = struct_fiz2nb15.field_1;
						...
						FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi5, *(long*)(&int3), ((long*)(&int3))[1]);
				...
				{
					Struct_fiz2nb struct_fiz2nb16 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
					Int128* num7 = &x3;
					...
					*(long*)num8 = struct_fiz2nb18.field_1;
					...
					{
						int4 = long.MaxValue;
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int4), ((long*)(&int4))[1]);
						checked
						{
							int5 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) - 1;
						}
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int5), ((long*)(&int5))[1]);
					}
					else
					{
						Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi6);
						Struct_fiz2nb struct_fiz2nb19 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi);
						Int128* num9 = &x4;
						...
						*(long*)num10 = struct_fiz2nb21.field_1;
						...
						FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi6, *(long*)(&int6), ((long*)(&int6))[1]);
