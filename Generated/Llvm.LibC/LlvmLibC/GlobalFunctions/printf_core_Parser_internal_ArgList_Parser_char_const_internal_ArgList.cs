...
internal static partial class printf_core_Parser_internal_ArgList_Parser_char_const_internal_ArgList
{
	public unsafe static void Invoke(void* @this, void* new_str, void* args)
	{
		unchecked
		{
			((printf_core_Parser*)@this)->str = new_str;
			((printf_core_Parser*)@this)->cur_pos = 0L;
			internal_ArgList_ArgList_internal_ArgList.Invoke(&((printf_core_Parser*)@this)->args_cur, args);
			internal_ArgList_ArgList_internal_ArgList.Invoke(&((printf_core_Parser*)@this)->args_start, args);
			((printf_core_Parser*)@this)->args_index = 1L;
			InlineArray128_printf_core_TypeDesc* desc_arr = &((printf_core_Parser*)@this)->desc_arr;
			*(short*)desc_arr = printf_core_TypeDesc_printf_core_type_desc_from_type_void_kvifr8.Invoke();
			...
			while (true)
			{
				...
				((printf_core_TypeDesc*)ptr2)->primary_type = 0;
