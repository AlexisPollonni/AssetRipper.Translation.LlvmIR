...
internal static partial class scanf_core_scanf_main
{
	...
	public unsafe static int Invoke([NativeType("__llvm_libc_20_1_2_::scanf_core::Reader*")] scanf_core_Reader* reader, [NativeType("char const*")] void* str, [NativeType("__llvm_libc_20_1_2_::internal::ArgList&")] internal_ArgList* args)
	{
		...
		Parser_internal_ArgList_Constructor_ch3m7r.Invoke(&scanf_core_Parser2, str, args);
		...
		Parser_internal_ArgList_get_next_section.Invoke(&scanf_core_FormatSection2, &scanf_core_Parser2);
		while (!string_view_empty.Invoke(&scanf_core_FormatSection2.raw_string) && num == 0)
		{
			if ((scanf_core_FormatSection2.has_conv & 1) == 1)
			{
				num = scanf_core_convert.Invoke(reader, &scanf_core_FormatSection2);
			...
			else
			{
				...
				num = unchecked(scanf_core_raw_match.Invoke(reader, *(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]));
			}
			llvm_lifetime_start_p0.Invoke(88L, &scanf_core_FormatSection3);
			Parser_internal_ArgList_get_next_section.Invoke(&scanf_core_FormatSection3, &scanf_core_Parser2);
		...
		Parser_internal_ArgList_Destructor_crcdb5.Invoke(&scanf_core_Parser2);
