...
internal static partial class FPStorage_fputil_FPType_1_sign
{
	...
	public unsafe static sbyte Invoke([MangledName("this")] void* This)
	{
		...
		Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb, ((unchecked((Fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt*)This)->field_0 & int.MinValue) == 0) ? Sign_POS.Pointer : Sign_NEG.Pointer, 1L, isVolatile: false);
