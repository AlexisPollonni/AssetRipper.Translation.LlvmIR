...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float128_cpp_is_integral_v_int_float128_type_fputil_ldexp_float128_int_float128_int
{
	public unsafe static double Invoke(double x, int exp)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((exp == 0) ? true : ((!fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero_const.Invoke(&fputil_FPBits_ubgsi3)) ? fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan_const.Invoke(&fputil_FPBits_ubgsi3) : true), expected: false))
			{
				result = x;
				goto IL_0664;
			}
			...
			num = 32880;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(exp > 32880, expected: false))
			{
