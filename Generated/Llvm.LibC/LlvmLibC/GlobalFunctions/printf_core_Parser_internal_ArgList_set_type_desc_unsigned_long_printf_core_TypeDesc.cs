...
{
	public unsafe static void Invoke(void* @this, long index, [MangledName("value.coerce")] short value)
	{
		...
		unchecked
		{
			*(short*)(&printf_core_TypeDesc2) = value;
			...
			{
				llvm_memcpy_p0_p0_i64.Invoke((byte*)(&((printf_core_Parser*)@this)->desc_arr) + (nint)(index - 1L) * sizeof(printf_core_TypeDesc), &printf_core_TypeDesc2, 2L, isVolatile: false);
			}
		}
	}
}
