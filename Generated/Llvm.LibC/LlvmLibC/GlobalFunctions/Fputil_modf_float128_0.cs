	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("iptr")][NativeType("__float128&")] void* Iptr)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			double result;
			if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)))
			{
				*(double*)Iptr = X;
				result = X;
			}
