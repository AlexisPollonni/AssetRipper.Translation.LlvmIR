...
internal static partial class Cpp_bit_cast_short_Fract_signed_char
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (short _Fract) == sizeof (signed char) && cpp::is_trivially_constructible<short _Fract>::value && cpp::is_trivially_copyable<short _Fract>::value && cpp::is_trivially_copyable<signed char>::value, short _Fract>::type")]
	public unsafe static sbyte Invoke([MangledName("from")][NativeType("signed char const&")] void* From)
	{
