...
{
	public unsafe static void Invoke([MangledName("agg.result")] cpp_optional_w3bnnt* agg_result, void* @this, int x, long e)
	{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			else
			{
				...
				*(long*)ptr2 = -6148914691236517206L;
				...
				{
					num7 <<= 32;
					cpp_array_v97b5b* val = &((BigInt_76gxx6*)@this)->val;
					long num14 = num8 + -1L;
					num8 = num14;
					...
					num7 <<= 32;
					long num16 = *(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long.Invoke(&((BigInt_76gxx6*)@this)->val, num8) & 0xFFFFFFFFL;
					num7 += num16;
				...
				if ((ulong)num11 > 0uL)
				{
					...
					cpp_array_v97b5b* val2 = &((BigInt_76gxx6*)@this)->val;
					long num18 = num8 + -1L;
					num8 = num18;
					...
					*(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long.Invoke(&bigInt_76gxx3.val, 0L) += num19;
					if ((ulong)(num5 - e) <= 32uL)
					{
						...
						long num21 = (num7 << 32) + (*(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long.Invoke(&((BigInt_76gxx6*)@this)->val, num8) & 0xFFFFFFFFL);
				...
				{
					long num24 = *(long*)cpp_array_unsigned_long_5ul_operator_unsigned_long.Invoke(&((BigInt_76gxx6*)@this)->val, num8 - 1L);
