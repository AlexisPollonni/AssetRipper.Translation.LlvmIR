	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("iptr")][NativeType("long double&")] void* Iptr)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			double result;
			if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi) || FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi))
			{
				*(double*)Iptr = X;
				result = X;
			}
