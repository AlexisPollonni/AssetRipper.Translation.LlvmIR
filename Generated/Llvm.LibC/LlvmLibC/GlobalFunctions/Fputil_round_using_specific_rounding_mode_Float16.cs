		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			else
			{
				...
				b = (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) ? ((sbyte)1) : ((sbyte)0));
				...
				else if (num <= -1)
				{
					result = Rnd switch
					{
						...
						_ => (num > -2 && (ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) != 0) ? InstructionHelper.Select((b & 1) == 1, default(Half), default(Half)) : InstructionHelper.Select((b & 1) == 1, default(Half), default(Half)), 
					};
				}
				else
				{
					...
					else
					{
						...
						*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva2) = -21846;
						FPBits_Float16_FPBits_unsigned_short.Invoke(&llvm_libc_20_1_2_fputil_FPBits_2fahva2, num4);
						Llvm_lifetime_start_p0.Invoke(2L, &half);
						half = FPBits_Float16_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_2fahva2);
						Llvm_lifetime_start_p0.Invoke(2L, &num5);
						num5 = (short)((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) & (ushort)(short)checked((1 << num2) - 1));
						Llvm_lifetime_start_p0.Invoke(2L, &num6);
						num6 = (short)(1 << num2 - 1);
						Llvm_lifetime_start_p0.Invoke(2L, &num7);
						num7 = (short)((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva2)) & (1 << num2));
						result = Rnd switch
						{
