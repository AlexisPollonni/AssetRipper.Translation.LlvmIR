		...
		unchecked
		{
			...
			case 0:
			{
				...
				*(sbyte*)(&anon_izyfb) = -86;
				...
				FPStorage_fputil_FPType_3_set_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, anon_izyfb2.Val);
				Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb3, Llvm_libc_20_1_2_Sign_POS.Pointer, 1L, isVolatile: false);
				FPStorage_fputil_FPType_3_set_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, anon_izyfb3.Val);
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3) = -6148914691236517206L;
				...
				FPStorage_fputil_FPType_3_set_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3, anon_izyfb4.Val);
