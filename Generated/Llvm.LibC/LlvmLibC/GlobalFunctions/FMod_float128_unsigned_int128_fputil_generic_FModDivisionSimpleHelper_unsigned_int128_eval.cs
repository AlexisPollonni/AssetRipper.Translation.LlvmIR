...
internal static partial class FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_eval
{
	...
	public unsafe static double Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y)
	{
		...
		num = double.NaN;
		int num2;
		if (details_expects_bool_condition_bool.Invoke(FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_pre_check.Invoke(x, y, &num), expected: false))
		{
			result = num;
			num2 = 1;
		}
		...
		unchecked
		{
			...
			case 0:
			{
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				FPStorage_fputil_FPType_3_set_sign.Invoke(&fputil_FPBits_ubgsi3, anon_izyfb9.val);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb10, Sign_POS.Pointer, 1L, isVolatile: false);
				FPStorage_fputil_FPType_3_set_sign.Invoke(&fputil_FPBits_ubgsi4, anon_izyfb10.val);
				...
				*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
				...
				Struct_fiz2nb struct_fiz2nb = FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_eval_internal.Invoke(*(long*)(&fputil_FPBits_ubgsi6), ((long*)(&fputil_FPBits_ubgsi6))[1], *(long*)(&fputil_FPBits_ubgsi7), ((long*)(&fputil_FPBits_ubgsi7))[1]);
				...
				FPStorage_fputil_FPType_3_set_sign.Invoke(&fputil_FPBits_ubgsi5, anon_izyfb11.val);
