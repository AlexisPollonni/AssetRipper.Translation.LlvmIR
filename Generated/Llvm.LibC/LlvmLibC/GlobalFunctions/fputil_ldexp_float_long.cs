...
internal static partial class fputil_ldexp_float_long
{
	...
	public unsafe static float Invoke([NativeType("float")] float x, [NativeType("long")] long exp)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			if (details_expects_bool_condition_bool.Invoke((exp == 0L) ? true : ((!FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&fputil_FPBits_5nkvcs2)) ? FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) : true), expected: false))
			{
				result = x;
				goto IL_05ae;
			}
		...
		fputil_DyadicFloat_cs3nhs2.exponent += unchecked((int)exp);
