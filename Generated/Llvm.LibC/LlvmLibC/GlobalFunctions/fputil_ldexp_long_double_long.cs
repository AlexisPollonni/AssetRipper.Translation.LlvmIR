...
internal static partial class fputil_ldexp_long_double_long
{
	...
	public unsafe static double Invoke([NativeType("long double")] double x, [NativeType("long")] long exp)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (details_expects_bool_condition_bool.Invoke((exp == 0L) ? true : ((!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi3)) ? FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_inf_or_nan.Invoke(&fputil_FPBits_ubgsi3) : true), expected: false))
			{
				result = x;
				goto IL_0675;
			}
