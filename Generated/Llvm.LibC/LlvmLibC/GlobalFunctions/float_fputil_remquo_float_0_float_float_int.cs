			...
			*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
			...
			else
			{
				...
				*ptr = -86;
				...
				fputil_NormalFloat_float_NormalFloat_fputil_FPBits_float.Invoke(&fputil_NormalFloat_phu2qv2, fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0);
				...
				*ptr2 = -86;
				...
				fputil_NormalFloat_float_NormalFloat_fputil_FPBits_float.Invoke(&fputil_NormalFloat_phu2qv3, fputil_FPBits_5nkvcs6.FPRepImpl.FPRepSem.field_0.field_0);
				...
				*(int*)q = 0;
				while (true)
				{
					...
					*ptr3 = -86;
					...
					checked
					{
						fputil_NormalFloat_float_NormalFloat_Sign_int_unsigned_int.Invoke(e: num + fputil_NormalFloat_phu2qv3.exponent, m: num2, @this: &fputil_NormalFloat_phu2qv4, s: anon_izyfb14.val);
						llvm_lifetime_start_p0.Invoke(4L, &num6);
						num6 = fputil_NormalFloat_float_operator_float_const.Invoke(&fputil_NormalFloat_phu2qv4);
						...
						struct_8myw6y = fputil_NormalFloat_float_mul2_int_const.Invoke(&fputil_NormalFloat_phu2qv4, 1);
						llvm_memcpy_p0_p0_i64.Invoke(&fputil_NormalFloat_phu2qv5, &struct_8myw6y, 9L, isVolatile: false);
						int num11 = fputil_NormalFloat_float_cmp_fputil_NormalFloat_float_const_const.Invoke(&fputil_NormalFloat_phu2qv5, &fputil_NormalFloat_phu2qv3);
