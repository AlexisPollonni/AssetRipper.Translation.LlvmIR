...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_signaling_nan_Sign_unsigned_int128
{
		...
		unchecked
		{
			*(long*)(&@int) = v;
			...
			else
			{
				...
				Struct_fiz2nb struct_fiz2nb4 = fputil_internal_operator_fputil_internal_FPStorage_fputil_FPType_3_Significand_int.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua3), ((long*)(&fputil_internal_FPRepSem_f94eua3))[1], 1);
			...
			*(long*)num2 = struct_fiz2nb9.field_1;
			int4 = int3;
			fputil_FPBits_float128_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int4), ((long*)(&int4))[1]);
