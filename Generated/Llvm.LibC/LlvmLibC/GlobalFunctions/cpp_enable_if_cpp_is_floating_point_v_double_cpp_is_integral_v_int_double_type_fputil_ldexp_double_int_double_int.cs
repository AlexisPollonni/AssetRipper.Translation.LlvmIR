...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_integral_v_int_double_type_fputil_ldexp_double_int_double_int
{
	public unsafe static double Invoke(double x, int exp)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((exp == 0) ? true : ((!fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_zero_const.Invoke(&fputil_FPBits_wjhbrm2)) ? fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_inf_or_nan_const.Invoke(&fputil_FPBits_wjhbrm2) : true), expected: false))
			{
				result = x;
				goto IL_05a9;
			}
			...
			num = 2100;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(exp > 2100, expected: false))
			{
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				if (!operator_Sign_Sign_fy8fvt.Invoke(anon_izyfb9.val, anon_izyfb10.val) || num2 != 1024)
				{
					...
					if ((!operator_Sign_Sign_fy8fvt.Invoke(anon_izyfb11.val, anon_izyfb12.val) || num2 != 2048) && num2 != 3072)
					{
						...
						long val = fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf_Sign.Invoke(anon_izyfb14.val);
				...
				long val2 = fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_max_normal_Sign.Invoke(anon_izyfb13.val);
				...
				*(sbyte*)(&anon_izyfb15) = -86;
				...
				if (!operator_Sign_Sign_fy8fvt.Invoke(anon_izyfb16.val, anon_izyfb17.val) || num3 != 2048)
				{
					...
					if (!operator_Sign_Sign_fy8fvt.Invoke(anon_izyfb18.val, anon_izyfb19.val) || num3 != 1024)
					{
						...
						long val3 = fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_zero_Sign.Invoke(anon_izyfb21.val);
				...
				long val4 = fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_min_subnormal_Sign.Invoke(anon_izyfb20.val);
		...
		fputil_DyadicFloat_374hpp2.exponent += exp;
