...
internal static partial class int_syscall_impl_int_long_int_long_long_int
{
	public unsafe static int Invoke([MangledName("__number")] long number, [MangledName("ts")][CleanName("ts")] long ts_3enpke, [MangledName("ts1")][CleanName("ts")] int ts_76xnpk)
	{
		long num = 0L;
