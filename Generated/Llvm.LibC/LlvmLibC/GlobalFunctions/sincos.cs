	...
	public unsafe static void Invoke(double x, void* sin_x, void* cos_x)
	{
		...
		unchecked
		{
			...
			*(double*)ptr2 = double.NaN;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num < 1039, expected: true))
			{
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num < 1016, expected: false))
				{
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num < 996, expected: false))
					{
						...
						{
							*(double*)sin_x = fputil_multiply_add_double_double_double.Invoke(x, -5.551115123125783E-17, x);
							*(double*)cos_x = fputil_multiply_add_double_double_double.Invoke(x, 0.0 - x, 1.0);
							num12 = 1;
						}
						goto IL_0f45;
					}
			...
			else
			{
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num > 2046, expected: false))
				{
					...
					*(double*)sin_x = (*(double*)cos_x = x + fputil_FPBits_double_get_val_const.Invoke(&fputil_FPBits_wjhbrm3));
			...
			*(double*)(&numberPair4) = double.NaN;
			...
			long num13 = (uint)(num2 & 0xFF);
			llvm_memcpy_p0_p0_i64.Invoke(&numberPair4, (byte*)SIN_K_PI_OVER_128.Pointer + (nint)num13 * sizeof(NumberPair), 16L, isVolatile: false);
			llvm_lifetime_start_p0.Invoke(16L, &numberPair5);
			*(double*)(&numberPair5) = double.NaN;
			((double*)(&numberPair5))[1] = double.NaN;
			long num14 = (uint)((num2 + 64) & 0xFF);
			llvm_memcpy_p0_p0_i64.Invoke(&numberPair5, (byte*)SIN_K_PI_OVER_128.Pointer + (nint)num14 * sizeof(NumberPair), 16L, isVolatile: false);
			...
			*(double*)num15 = struct_4ydhja2.field_0;
			byte* num16 = (byte*)(&numberPair7) + 8u;
			Struct_4ydhja struct_4ydhja3 = struct_4ydhja;
			*(double*)num16 = struct_4ydhja3.field_1;
			...
			*(double*)num17 = struct_4ydhja5.field_0;
			byte* num18 = (byte*)(&numberPair8) + 8u;
			Struct_4ydhja struct_4ydhja6 = struct_4ydhja4;
			*(double*)num18 = struct_4ydhja6.field_1;
			...
			*(double*)(&numberPair9) = double.NaN;
			...
			NumberPair* num19 = &numberPair9;
			Struct_4ydhja struct_4ydhja8 = struct_4ydhja7;
			*(double*)num19 = struct_4ydhja8.field_0;
			byte* num20 = (byte*)(&numberPair9) + 8u;
			Struct_4ydhja struct_4ydhja9 = struct_4ydhja7;
			*(double*)num20 = struct_4ydhja9.field_1;
			...
			*(double*)(&numberPair10) = double.NaN;
			...
			NumberPair* num21 = &numberPair10;
			Struct_4ydhja struct_4ydhja11 = struct_4ydhja10;
			*(double*)num21 = struct_4ydhja11.field_0;
			byte* num22 = (byte*)(&numberPair10) + 8u;
			Struct_4ydhja struct_4ydhja12 = struct_4ydhja10;
			*(double*)num22 = struct_4ydhja12.field_1;
			...
			*(double*)(&numberPair12) = double.NaN;
			...
			NumberPair* num25 = &numberPair12;
			Struct_4ydhja struct_4ydhja17 = struct_4ydhja16;
			*(double*)num25 = struct_4ydhja17.field_0;
			byte* num26 = (byte*)(&numberPair12) + 8u;
			Struct_4ydhja struct_4ydhja18 = struct_4ydhja16;
			*(double*)num26 = struct_4ydhja18.field_1;
			double num27 = numberPair7.lo + numberPair8.lo;
			numberPair11.lo += num27;
			double num28 = numberPair10.lo + numberPair9.lo;
			numberPair12.lo += num28;
			llvm_lifetime_start_p0.Invoke(8L, &num4);
			num4 = numberPair11.lo + num3;
			llvm_lifetime_start_p0.Invoke(8L, &num5);
			num5 = numberPair11.lo - num3;
			llvm_lifetime_start_p0.Invoke(8L, &num6);
			num6 = numberPair12.lo + num3;
			llvm_lifetime_start_p0.Invoke(8L, &num7);
			num7 = numberPair12.lo - num3;
			llvm_lifetime_start_p0.Invoke(8L, &num8);
			num8 = numberPair11.hi + num4;
			llvm_lifetime_start_p0.Invoke(8L, &num9);
			num9 = numberPair11.hi + num5;
			llvm_lifetime_start_p0.Invoke(8L, &num10);
			num10 = numberPair12.hi + num6;
			llvm_lifetime_start_p0.Invoke(8L, &num11);
			num11 = numberPair12.hi + num7;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num8 == num9 && num10 == num11, expected: true))
			{
				*(double*)sin_x = num8;
				*(double*)cos_x = num10;
				num12 = 1;
			...
			else
			{
				...
				*(long*)ptr10 = -6148914691236517206L;
				...
				sincos_impl_double_double_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd10, &anon_izyfb9, num2);
				...
				*(long*)ptr12 = -6148914691236517206L;
				...
				sincos_impl_double_double_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd11, &anon_izyfb9, num2 + 64);
				...
				*(long*)ptr14 = -6148914691236517206L;
				...
				sincos_impl_double_double_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd12, &anon_izyfb9, num2 + 128);
				if (num8 == num9)
				{
					*(double*)sin_x = num8;
				}
