...
internal static partial class NumberPair_double_fputil_quick_mult_28ul_NumberPair_double_const_NumberPair_double_const
{
	public unsafe static Struct_4ydhja Invoke(NumberPair* a, NumberPair* b)
	{
		...
		unchecked
		{
			*(double*)(&numberPair) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = NumberPair_double_fputil_exact_mult_28ul_double_double.Invoke(a->hi, b->hi);
