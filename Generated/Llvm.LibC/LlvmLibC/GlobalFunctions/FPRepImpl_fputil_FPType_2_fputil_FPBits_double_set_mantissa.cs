...
internal static partial class FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_mantissa
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq* This, [MangledName("mantVal")][NativeType("unsigned long")] long MantVal)
	{
		unchecked
		{
			((Llvm_libc_20_1_2_fputil_internal_FPStorage_v3nexn*)This)->Val = FPStorage_fputil_FPType_2_merge.Invoke(((Llvm_libc_20_1_2_fputil_internal_FPStorage_v3nexn*)This)->Val, MantVal, 4503599627370495L);
		}
	}
}
