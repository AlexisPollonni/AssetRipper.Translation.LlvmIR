		...
		*unchecked((int*)(&fputil_FPBits_5nkvcs2)) = -1431655766;
		...
		else
		{
			...
			else
			{
				...
				mantVal = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa_const.Invoke(&fputil_FPBits_5nkvcs2) >>> num2 << num2;
				fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_mantissa_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, mantVal);
