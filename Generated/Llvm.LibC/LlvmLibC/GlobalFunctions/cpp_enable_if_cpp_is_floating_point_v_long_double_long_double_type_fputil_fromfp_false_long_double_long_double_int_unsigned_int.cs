...
[MangledName("_ZN19__llvm_libc_20_1_2_6fputil6fromfpILb0EeEENS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT0_EES4_E4typeES4_ij")]
[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<long double>, long double>::type __llvm_libc_20_1_2_::fputil::fromfp<false, long double>(long double, int, unsigned int)")]
internal static partial class cpp_enable_if_cpp_is_floating_point_v_long_double_long_double_type_fputil_fromfp_false_long_double_long_double_int_unsigned_int
{
	public unsafe static double Invoke(double x, int rnd, int width)
	{
		...
		unchecked
		{
			...
			if (width == 0)
			{
				...
				int2 = 0L;
				Struct_fiz2nb struct_fiz2nb = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val, *(long*)(&int2), ((long*)(&int2))[1]);
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
				...
				if (fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_inf_or_nan_const.Invoke(&fputil_FPBits_ubgsi4))
				{
					fputil_raise_except_if_required_int.Invoke(1);
					...
					int3 = 0L;
					Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val2, *(long*)(&int3), ((long*)(&int3))[1]);
				...
				else
				{
					...
					num = cpp_enable_if_cpp_is_floating_point_v_long_double_long_double_type_fputil_round_using_specific_rounding_mode_long_double_long_double_int.Invoke(x, rnd);
					if (num < 0.0)
					{
						fputil_raise_except_if_required_int.Invoke(1);
						...
						int4 = 0L;
						Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val3, *(long*)(&int4), ((long*)(&int4))[1]);
					...
					else
					{
						...
						int7 = long.MinValue;
						Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val4, biased_exp, mantissa, *(long*)(&int7), ((long*)(&int7))[1]);
						...
						double num3 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi7) - 1.0;
						...
						if (num > num2)
						{
							...
							int8 = 0L;
							Struct_fiz2nb struct_fiz2nb13 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val5, *(long*)(&int8), ((long*)(&int8))[1]);
							...
							result = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi8);
