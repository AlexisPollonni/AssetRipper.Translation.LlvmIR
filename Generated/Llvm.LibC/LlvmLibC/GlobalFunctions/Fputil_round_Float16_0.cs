			...
			*(short*)(&fputil_FPBits_2fahva) = -21846;
			...
			else
			{
				...
				else
				{
					...
					b = ((((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva)) & (1 << num2 - 1)) != 0) ? ((sbyte)1) : ((sbyte)0));
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva))) ? ((Half)((float)half + 1f)) : ((Half)((float)half - 1f))) : half);
