...
internal static partial class logf16
{
			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = fputil_ExceptValues_Float16_11ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: LOGF16_EXCEPTS.Pointer);
				*(int*)(&cpp_optional_aq7wey2.storage) = storage;
				...
				case 0:
					...
					num4 = fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2));
					...
					fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_biased_exponent_unsigned_short.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2), 15);
					llvm_lifetime_start_p0.Invoke(4L, &x2);
					x2 = (float)fputil_FPBits_Float16_get_val_const.Invoke(&fputil_FPBits_2fahva2);
					llvm_lifetime_start_p0.Invoke(4L, &num6);
					num6 = cpp_enable_if_sizeof_float_8ul_float_type_fputil_multiply_add_float_float_float_float.Invoke(x2, *(float*)cpp_array_float_32ul_operator_unsigned_long_const.Invoke(Index: num5, @this: ONE_OVER_F_F.Pointer), -1f);
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = num6 * cpp_enable_if_sizeof_float_8ul_float_type_fputil_polyeval_float_float_float_float_float_float_float.Invoke(num6, 1f, -0.5001832f, 0.33349213f);
					llvm_lifetime_start_p0.Invoke(4L, &z);
					z = *(float*)cpp_array_float_32ul_operator_unsigned_long_const.Invoke(Index: num5, @this: LOGF_F.Pointer) + num7;
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float_Float16_type_fputil_cast_Float16_float_float.Invoke(cpp_enable_if_sizeof_float_8ul_float_type_fputil_multiply_add_float_float_float_float.Invoke(num2, 0.6931472f, z));
