			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = fputil_ExceptValues_Float16_5ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: LOGF16_EXCEPTS.Pointer);
				*(int*)(&cpp_optional_aq7wey2.storage) = storage;
				...
				case 0:
					...
					num6 = fputil_multiply_add_float_float_float.Invoke(x2, *(float*)cpp_array_float_32ul_operator_unsigned_long_const.Invoke(Index: num5, @this: ONE_OVER_F_F.Pointer), -1f);
					...
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float_Float16_type_fputil_cast_Float16_float_float.Invoke(fputil_multiply_add_float_float_float.Invoke(num2, 0.6931472f, z));
