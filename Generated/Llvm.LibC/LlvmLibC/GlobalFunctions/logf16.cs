			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			if (details_expects_bool_condition_bool.Invoke(((ushort)num == 0) ? true : (((ushort)num != 15360) ? ((uint)(ushort)num >= 31744u) : true), expected: false))
			{
				...
				else
				{
					...
					short field_5 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_inf.Invoke(anon_izyfb12.val);
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_11ul_lookup.Invoke(x_bits: num, @this: LOGF16_EXCEPTS.Pointer);
				*(int*)(&cpp_optional_aq7wey2.storage) = storage;
				...
				case 0:
					...
					if (((ushort)num & 0x7C00) == 0)
					{
						...
						FPBits_Float16_Constructor.Invoke(&fputil_FPBits_2fahva8, (Half)((float)FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva2) * (float)fputil_cast_Float16_float.Invoke(1024f)));
					...
					num4 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2));
					...
					FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_biased_exponent.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2), 15);
					llvm_lifetime_start_p0.Invoke(4L, &x2);
					x2 = (float)FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva2);
					llvm_lifetime_start_p0.Invoke(4L, &num6);
					num6 = fputil_multiply_add_float.Invoke(x2, *(float*)array_float_32ul_Index.Invoke(Index: num5, @this: ONE_OVER_F_F.Pointer), -1f);
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = num6 * fputil_polyeval_float_float_float.Invoke(num6, 1f, -0.5001832f, 0.33349213f);
					llvm_lifetime_start_p0.Invoke(4L, &z);
					z = *(float*)array_float_32ul_Index.Invoke(Index: num5, @this: LOGF_F.Pointer) + num7;
					result = fputil_cast_Float16_float.Invoke(fputil_multiply_add_float.Invoke(num2, 0.6931472f, z));
