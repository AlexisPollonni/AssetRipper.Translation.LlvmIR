...
internal static partial class scanf_core_Parser_internal_ArgList_parse_index_unsigned_long
{
	public unsafe static long Invoke(void* @this, void* local_pos)
	{
		...
		{
			long result;
			if (internal_isdigit_int_137.Invoke(((sbyte*)((scanf_core_Parser*)@this)->str)[*(long*)local_pos]))
			{
				...
				*(int*)(&strToNumResult_yrtfty) = -1431655766;
				...
				Struct_fiz2nb struct_fiz2nb = StrToNumResult_int_internal_strtointeger_int_char_const_int_unsigned_long.Invoke((byte*)((scanf_core_Parser*)@this)->str + *(long*)local_pos, 10, cpp_internal_integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
				...
				*(long*)num3 = struct_fiz2nb3.field_1;
				...
				if (((sbyte*)((scanf_core_Parser*)@this)->str)[*(long*)local_pos + strToNumResult_yrtfty.parsed_len] != 36)
				{
					result = 0L;
				}
				else
