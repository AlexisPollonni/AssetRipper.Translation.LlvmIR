...
internal static partial class Fixed_point_sqrt_core_fixed_point_internal_SqrtConfig_unsigned_short_Accum
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::fixed_point::internal::SqrtConfig<unsigned short _Accum>::Type")]
	public unsafe static short Invoke([MangledName("x_frac")][NativeType("__llvm_libc_20_1_2_::fixed_point::internal::SqrtConfig<unsigned short _Accum>::Type")] short X_frac)
	{
		short num = 0;
		short num2 = 0;
		int num3 = 0;
