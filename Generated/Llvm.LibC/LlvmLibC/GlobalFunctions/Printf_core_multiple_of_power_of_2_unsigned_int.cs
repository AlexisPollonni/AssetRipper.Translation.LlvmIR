...
internal static partial class Printf_core_multiple_of_power_of_2_unsigned_int
{
	...
	public static bool Invoke([MangledName("value")][NativeType("unsigned int")] int Value, [MangledName("p")][NativeType("unsigned int")] int P)
	{
