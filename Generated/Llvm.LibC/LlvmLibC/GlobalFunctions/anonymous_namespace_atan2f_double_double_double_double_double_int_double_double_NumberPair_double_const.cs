	...
	public unsafe static float Invoke(double num_d, double den_d, double q_d, int idx, double k_d, double final_sign, NumberPair* const_term)
	{
		...
		unchecked
		{
			*(double*)(&numberPair) = double.NaN;
			...
			{
				num5 *= 0.0625;
				num = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num5, 0.0 - den_d, num_d);
				num2 = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num5, num_d, den_d);
			...
			*(double*)(&numberPair2) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = anonymous_namespace_split_d_double.Invoke(numberPair.hi);
			...
			*(double*)num7 = struct_4ydhja3.field_1;
			...
			z = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(numberPair2.hi, 0.0 - num2, num);
			llvm_lifetime_start_p0.Invoke(8L, &num3);
			num3 = cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(numberPair2.lo, 0.0 - num2, z);
			...
			*(double*)(&numberPair3) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja4 = NumberPair_double_fputil_quick_mult_27ul_NumberPair_double_const_NumberPair_double_const.Invoke(&numberPair, &numberPair);
			...
			*(double*)(&numberPair4) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja7 = cpp_enable_if_sizeof_NumberPair_double_8ul_NumberPair_double_type_fputil_polyeval_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const.Invoke(&numberPair3, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 1, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 2L, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 3L, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 4L, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 5L, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 6L, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 7L, (NumberPair*)anonymous_namespace_COEFFS_61.Pointer + 8L);
			...
			*(double*)(&numberPair5) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja10 = cpp_enable_if_sizeof_NumberPair_double_8ul_NumberPair_double_type_fputil_multiply_add_NumberPair_double_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const.Invoke(&numberPair, &numberPair4, (NumberPair*)anonymous_namespace_ATAN_I.Pointer + idx);
			...
			*(double*)num13 = struct_4ydhja12.field_1;
			Struct_4ydhja struct_4ydhja13 = fputil_add_NumberPair_double_const_NumberPair_double_const.Invoke(const_term, &numberPair6);
			...
			*(double*)(&numberPair7) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja16 = NumberPair_double_fputil_exact_add_true_double_double.Invoke(numberPair5.hi, numberPair5.lo);
			...
			*(double*)num17 = struct_4ydhja18.field_1;
			...
			num4 = cpp_enable_if_sizeof_unsigned_long_sizeof_double_cpp_is_trivially_constructible_unsigned_long_value_cpp_is_trivially_copyable_unsigned_long_value_cpp_is_trivially_copyable_double_value_unsigned_long_type_cpp_bit_cast_unsigned_long_double_double_const.Invoke(&numberPair7.hi);
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((num4 & 0xFFFFFFFL) == 0L && NumericHelper.IsUnorderedOrNotEquals(numberPair7.lo, 0.0), expected: false))
			{
				llvm_lifetime_start_p0.Invoke(1L, &anon_izyfb8);
				*(sbyte*)(&anon_izyfb8) = -86;
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm2);
				fputil_FPBits_double_FPBits_double_double.Invoke(&fputil_FPBits_wjhbrm2, numberPair7.hi);
				...
				*(sbyte*)(&anon_izyfb9) = -86;
				...
				fputil_FPBits_double_FPBits_double_double.Invoke(&fputil_FPBits_wjhbrm3, numberPair7.lo);
			...
			float result = (float)cpp_enable_if_sizeof_double_sizeof_unsigned_long_cpp_is_trivially_constructible_double_value_cpp_is_trivially_copyable_double_value_cpp_is_trivially_copyable_unsigned_long_value_double_type_cpp_bit_cast_double_unsigned_long_unsigned_long_const.Invoke(&num4);
