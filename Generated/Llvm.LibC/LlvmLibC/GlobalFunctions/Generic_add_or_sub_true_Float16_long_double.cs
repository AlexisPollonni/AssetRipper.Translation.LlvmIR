...
internal static partial class Generic_add_or_sub_true_Float16_long_double
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi))
			{
				...
				else
				{
					...
					num4 = Y;
					num4 = 0.0 - num4;
					result = Fputil_cast_Float16_long_double.Invoke(num4);
			...
			else
			{
				...
				num5 = Y;
				num5 = 0.0 - num5;
				result = Fputil_cast_Float16_long_double.Invoke(num5);
