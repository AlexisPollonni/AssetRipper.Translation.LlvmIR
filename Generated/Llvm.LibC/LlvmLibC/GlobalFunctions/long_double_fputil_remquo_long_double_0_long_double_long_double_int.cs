...
internal static partial class long_double_fputil_remquo_long_double_0_long_double_long_double_int
{
	public unsafe static double Invoke(double x, double y, void* q)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan_const.Invoke(&fputil_FPBits_ubgsi4))
			{
				result = y;
			}
			else if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf_const.Invoke(&fputil_FPBits_ubgsi3) || fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero_const.Invoke(&fputil_FPBits_ubgsi4))
			{
			...
			{
				*(int*)q = 0;
				result = long_double_fputil_copysign_long_double_0_long_double_long_double.Invoke(0.0, x);
			}
			...
			else
			{
				...
				*(sbyte*)(&anon_izyfb9) = -86;
				...
				fputil_internal_FPStorage_fputil_FPType_4_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi3, anon_izyfb12.val);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb13, Sign_POS.Pointer, 1L, isVolatile: false);
				fputil_internal_FPStorage_fputil_FPType_4_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi4, anon_izyfb13.val);
				...
				fputil_NormalFloat_long_double_NormalFloat_fputil_FPBits_long_double.Invoke(&fputil_NormalFloat_wqb3ie2, *(long*)(&fputil_FPBits_ubgsi6), ((long*)(&fputil_FPBits_ubgsi6))[1]);
				...
				fputil_NormalFloat_long_double_NormalFloat_fputil_FPBits_long_double.Invoke(&fputil_NormalFloat_wqb3ie3, *(long*)(&fputil_FPBits_ubgsi7), ((long*)(&fputil_FPBits_ubgsi7))[1]);
				...
				*(int*)q = 0;
				while (true)
				{
					...
					int3 = int4;
					fputil_NormalFloat_long_double_NormalFloat_Sign_int_unsigned_int128.Invoke(&fputil_NormalFloat_wqb3ie4, val2, e, *(long*)(&int3), ((long*)(&int3))[1]);
					llvm_lifetime_start_p0.Invoke(16L, &num3);
					num3 = fputil_NormalFloat_long_double_operator_long_double_const.Invoke(&fputil_NormalFloat_wqb3ie4);
					llvm_lifetime_start_p0.Invoke(16L, &num4);
					num4 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi4);
					llvm_lifetime_start_p0.Invoke(4L, &num5);
					llvm_lifetime_start_p0.Invoke(48L, &fputil_NormalFloat_wqb3ie5);
					fputil_NormalFloat_long_double_mul2_int_const.Invoke(&fputil_NormalFloat_wqb3ie5, &fputil_NormalFloat_wqb3ie4, 1);
					int num8 = fputil_NormalFloat_long_double_cmp_fputil_NormalFloat_long_double_const_const.Invoke(&fputil_NormalFloat_wqb3ie5, &fputil_NormalFloat_wqb3ie3);
					...
					checked
					{
						...
						*unchecked((int*)q) = ((!Sign_is_neg_const.Invoke(&anon_izyfb9)) ? (*unchecked((int*)q)) : (-(*unchecked((int*)q))));
						result = ((num3 != 0.0) ? num3 : long_double_fputil_copysign_long_double_0_long_double_long_double.Invoke(0.0, x));
