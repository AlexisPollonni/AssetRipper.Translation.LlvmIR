...
internal static partial class multiword_shift_multiword_Direction_0_false_unsigned_long_258ul
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] cpp_array_anzbtp* agg_result, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 258ul>")] void* array, [NativeType("unsigned long")] long offset)
	{
		long num = 0L;
		long num2 = 0L;
		sbyte b = 0;
			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un2) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 258uL; num5++)
				{
					...
					num6 = lambda0_Invoke_92gyaa.Invoke(&anon_6je4un2, num5 + num3);
					llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = lambda0_Invoke_92gyaa.Invoke(&anon_6je4un2, num5 + num3 + 1L);
					llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = array_unsigned_long_258ul_Index_cpunpn.Invoke(agg_result, lambda_Invoke_4wih76.Invoke(&anon_izyfb8, num5));
					if (num4 == 0L)
					{
						*(long*)ptr = num6;
					}
