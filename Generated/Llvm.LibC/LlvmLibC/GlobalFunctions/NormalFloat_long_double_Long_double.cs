		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi2, 0.0);
				Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb2, &((Fputil_NormalFloat_wqb3ie*)This)->Sign, 1L, isVolatile: false);
				FPStorage_fputil_FPType_4_set_sign.Invoke(&fputil_FPBits_ubgsi2, anon_izyfb2.Val);
				...
				if (((Fputil_NormalFloat_wqb3ie*)This)->Exponent < -16382)
				{
					...
					if ((uint)num4 <= 64u)
					{
						...
						@int = 0L;
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi2, *(long*)(&@int), ((long*)(&@int))[1]);
						int2 = NumericHelper.ShiftRightLogical(((Fputil_NormalFloat_wqb3ie*)This)->Mantissa, (Int128)(UInt128)(uint)num4);
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi2, *(long*)(&int2), ((long*)(&int2))[1]);
						...
						*(long*)num6 = struct_fiz2nb6.field_1;
						...
						{
							Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi2);
							Int128* num7 = &x2;
						...
						int5 = int3;
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi2, *(long*)(&int5), ((long*)(&int5))[1]);
						if (NumericHelper.IntCmpEq(int3, long.MinValue))
						{
							int6 = 1L;
							FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi2, *(long*)(&int6), ((long*)(&int6))[1]);
							FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_set_implicit_bit.Invoke(&fputil_FPBits_ubgsi2, ImplicitVal: true);
						}
						else
						{
							FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_set_implicit_bit.Invoke(&fputil_FPBits_ubgsi2, ImplicitVal: false);
						}
				...
				{
					int7 = num;
					FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi2, *(long*)(&int7), ((long*)(&int7))[1]);
					int8 = ((Fputil_NormalFloat_wqb3ie*)This)->Mantissa;
					FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi2, *(long*)(&int8), ((long*)(&int8))[1]);
					FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_set_implicit_bit.Invoke(&fputil_FPBits_ubgsi2, ImplicitVal: true);
					result = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi2);
				}
