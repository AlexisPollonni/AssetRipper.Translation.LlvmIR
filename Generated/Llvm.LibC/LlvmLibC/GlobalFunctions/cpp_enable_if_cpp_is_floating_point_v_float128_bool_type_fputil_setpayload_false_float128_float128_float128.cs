...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float128_bool_type_fputil_setpayload_false_float128_float128_float128
{
			...
			if (!fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_neg_const.Invoke(&fputil_FPBits_ubgsi3) && num >= 0 && num < 111)
			{
				...
				*(long*)num3 = struct_fiz2nb6.field_1;
				if (!NumericHelper.IntCmpNe(NumericHelper.BitwiseAnd(NumericHelper.ShiftLeft(x, (Int128)(UInt128)(uint)num), -1L), 0L))
				{
					...
					Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa_const.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
					Int128* num4 = &x2;
					...
					*(long*)num5 = struct_fiz2nb9.field_1;
					...
					int3 = int4;
					Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan_Sign_unsigned_int128.Invoke(val2, *(long*)(&int3), ((long*)(&int3))[1]);
					...
					*(double*)res = fputil_FPBits_float128_get_val_const.Invoke(&fputil_FPBits_ubgsi5);
