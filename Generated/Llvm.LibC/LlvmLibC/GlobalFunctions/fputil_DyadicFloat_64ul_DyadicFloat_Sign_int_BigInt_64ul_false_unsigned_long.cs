...
{
	public unsafe static void Invoke(fputil_DyadicFloat_374hpp* @this, [MangledName("s.coerce")] sbyte s, int e, [MangledName("m.coerce")] long m)
	{
		anon_izyfb7 anon_izyfb8 = default(anon_izyfb7);
		BigInt_nx6qdt bigInt_nx6qdt = default(BigInt_nx6qdt);
		anon_izyfb8.val = s;
		*unchecked((long*)(&bigInt_nx6qdt.val.Data)) = m;
