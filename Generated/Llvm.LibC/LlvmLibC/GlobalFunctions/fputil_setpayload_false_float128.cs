...
internal static partial class fputil_setpayload_false_float128
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil10setpayloadILb0EgEENS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT0_EEbE4typeERS4_S4_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<__float128>, bool>::type __llvm_libc_20_1_2_::fputil::setpayload<false, __float128>(__float128&, __float128)")]
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<__float128>, bool>::type")]
	public unsafe static bool Invoke([NativeType("__float128&")] void* res, [NativeType("__float128")] double pl)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi3, pl);
			if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
			{
				...
				*(double*)res = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi4);
			...
			if (!FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_neg.Invoke(&fputil_FPBits_ubgsi3) && num >= 0 && num < 111)
			{
				...
				*(long*)num3 = struct_fiz2nb6.field_1;
				if (!NumericHelper.IntCmpNe(NumericHelper.BitwiseAnd(NumericHelper.ShiftLeft(x, (Int128)(UInt128)(uint)num), -1L), 0L))
				{
					...
					Struct_fiz2nb struct_fiz2nb7 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
					Int128* num4 = &x2;
					...
					*(long*)num5 = struct_fiz2nb9.field_1;
					int2 = NumericHelper.ShiftRightLogical(x2, (Int128)(UInt128)(uint)checked(112 - num));
					llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi5);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, Sign_POS.Pointer, 1L, isVolatile: false);
					Int128 int4 = int2;
					sbyte val2 = anon_izyfb9.val;
					int3 = int4;
					Struct_fiz2nb struct_fiz2nb10 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan.Invoke(val2, *(long*)(&int3), ((long*)(&int3))[1]);
					...
					*(double*)res = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi5);
