	...
	public unsafe static float Invoke(float x, float y)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs2, num41);
			llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs3);
			*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs3, num42);
			...
			int num43 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs4));
			llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs4);
			num2 = num43;
			llvm_lifetime_start_p0.Invoke(4L, &num3);
			num3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3));
			llvm_lifetime_start_p0.Invoke(4L, &num4);
			llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs5);
			int field_2 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_abs.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3));
			fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0 = field_2;
			int num44 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs5));
			...
			else if (num4 == 2139095040)
			{
				...
				else if (num41 == 0f && num3 == -8388608)
				{
					...
					int field_3 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb8.val);
				...
				else
				{
					...
					result = InstructionHelper.Select(condition, FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs7), 0f);
			...
			else
			{
				...
				else
				{
					...
					FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs8, num47);
					result = ((FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs8)) == int.MinValue) ? 0f : num47);
		...
		FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs14, num41);
		unchecked
		{
			num = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs14));
			...
			double x4 = num17;
			long num49 = num16;
			num19 = fputil_multiply_add_double.Invoke(x4, ((double*)RD.Pointer)[num49], -1.0);
			...
			*(double*)(&inlineArray6_Double) = 1.4426950408889634;
			...
			num20 = fputil_polyeval_double_double_double.Invoke(x2, a, a_yc74sk, a_ijazrn);
			llvm_lifetime_start_p0.Invoke(8L, &num21);
			double x5 = num19;
			double y2 = num20;
			long num50 = num16;
			num21 = fputil_multiply_add_double.Invoke(x5, y2, ((double*)LOG2_R.Pointer)[num50] + num14);
			...
			double num51 = num14;
			long num52 = num16;
			num24 = fputil_multiply_add_double.Invoke(x6, num51 + ((fputil_TripleDouble*)anonymous_namespace_LOG2_R_TD.Pointer)[num52].hi, 0.0 - num23);
			llvm_lifetime_start_p0.Invoke(8L, &num25);
			double x7 = num22;
			double x8 = num19;
			double y3 = num20;
			long num53 = num16;
			num25 = fputil_multiply_add_double.Invoke(x7, fputil_multiply_add_double.Invoke(x8, y3, ((fputil_TripleDouble*)anonymous_namespace_LOG2_R_TD.Pointer)[num53].mid), num24);
			...
			long num54 = num27;
			num29 = cpp_bit_cast_unsigned_long_double.Invoke(&((fputil_TripleDouble*)EXP2_MID1.Pointer)[num54].hi);
			...
			*(double*)(&inlineArray6_Double2) = 1.0;
			...
			num32 = fputil_polyeval_double_double_double.Invoke(x3, a2, a_yc74sk2, a_ijazrn2);
			...
			if (details_expects_bool_condition_bool.Invoke(num35 == num37, expected: true))
			{
				...
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs15, num35);
				bool num57 = details_expects_bool_condition_bool.Invoke(FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs15)) == 0, expected: false);
				llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs15);
				if (num57)
				{
					llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs16);
					FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs16, num35);
					bool num58 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_inf.Invoke(&fputil_FPBits_5nkvcs16);
				...
				*(double*)(&numberPair) = double.NaN;
				...
				checked
				{
					...
					if (num59)
					{
						long num60 = num28;
						long num61 = num27;
						num39 = num60 + cpp_bit_cast_long_double.Invoke(&unchecked((fputil_TripleDouble*)EXP2_MID1.Pointer)[num61].mid);
					...
					num40 = anonymous_namespace_powf_double_double.Invoke(num16, num19, num22, num24, &numberPair);
					result = (float)num40;
				...
				if (num62 != 1073741824)
				{
					if (num62 != 1092616192)
					{
						...
						if (num41 == 0f)
						{
							...
							{
								FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs9, num3);
								num64 = (anonymous_namespace_is_odd_integer.Invoke(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs9)) ? 1 : 0);
							}
							...
							if ((uint)num3 > 2147483648u)
							{
								...
								int field_5 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb10.val);
						...
						else if (num2 == 2139095040)
						{
							...
							{
								FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs11, num3);
								num66 = (anonymous_namespace_is_odd_integer.Invoke(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs11)) ? 1 : 0);
							}
							...
							else
							{
								...
								int field_6 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb11.val);
						...
						else
						{
							...
							if ((b & 1) == 1)
							{
								if (!anonymous_namespace_is_integer.Invoke(num42))
								{
									...
									int field_7 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(anon_izyfb12.val, 0);
									fputil_FPBits_5nkvcs13.FPRepImpl.FPRepSem.field_0.field_0 = field_7;
									result = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs13);
