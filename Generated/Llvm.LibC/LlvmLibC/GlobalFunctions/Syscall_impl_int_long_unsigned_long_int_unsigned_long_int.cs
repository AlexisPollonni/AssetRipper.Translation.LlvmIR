...
internal static partial class Syscall_impl_int_long_unsigned_long_int_unsigned_long_int
{
	...
	public unsafe static int Invoke([MangledName("__number")][NativeType("long")] long Number, [MangledName("ts")][CleanName("Ts")][NativeType("long")] long Ts_3enpke, [MangledName("ts1")][CleanName("Ts")][NativeType("unsigned long")] long Ts_76xnpk, [MangledName("ts3")][CleanName("Ts")][NativeType("int")] int Ts_w24gdx, [MangledName("ts5")][CleanName("Ts")][NativeType("unsigned long")] long Ts_784yyq, [MangledName("ts7")][CleanName("Ts")][NativeType("int")] int Ts_4jbuhx)
	{
		...
		num = Syscall_impl.Invoke(Number, Ts_3enpke, Ts_76xnpk, Ts_w24gdx, Ts_784yyq, Ts_4jbuhx);
