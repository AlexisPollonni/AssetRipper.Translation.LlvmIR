...
internal static partial class BigInt_64ul_false_unsigned_long_is_zero_const
{
	public unsafe static bool Invoke(BigInt_555ggs* @this)
	{
		bool result = false;
		void* ptr = null;
		void* ptr2 = null;
		...
		unchecked
		{
			...
			ptr2 = cpp_array_unsigned_long_1ul_begin_const.Invoke((cpp_array_rpgxvv*)ptr);
			llvm_lifetime_start_p0.Invoke(8L, &ptr3);
			ptr3 = cpp_array_unsigned_long_1ul_end_const.Invoke((cpp_array_rpgxvv*)ptr);
			int num2;
			while (true)
			{
				if (ptr2 == ptr3)
