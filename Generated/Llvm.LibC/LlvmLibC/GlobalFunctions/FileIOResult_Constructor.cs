...
internal static partial class FileIOResult_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] FileIOResult* This, [MangledName("val")][NativeType("unsigned long")] long Val)
	{
		This->Value = Val;
		This->Error = 0;
	}
	...
	public unsafe static void Invoke([MangledName("this")] FileIOResult* This, [MangledName("val")][NativeType("unsigned long")] long Val, [MangledName("error")][NativeType("int")] int Error)
	{
		This->Value = Val;
		This->Error = Error;
	}
