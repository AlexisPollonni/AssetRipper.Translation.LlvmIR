				...
				else
				{
					if (NumericHelper.IsUnorderedOrNotEquals(From, 0f))
					{
						if (Fputil_cast_long_double_float.Invoke(From) < To == From > 0f)
						{
							...
							FPBits_float_FPBits_unsigned_int.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs2, FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)) + 1);
					...
					else
					{
						...
						llvm_libc_20_1_2_fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0 = field_;
