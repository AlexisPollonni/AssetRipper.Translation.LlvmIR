...
internal static partial class generic_add_or_sub_false_Float16_float
{
	...
	public unsafe static Half Invoke([NativeType("float")] float x, [NativeType("float")] float y)
	{
			...
			*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
			...
			else if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&fputil_FPBits_5nkvcs2))
			{
				...
				else
				{
					...
					x2 = y;
					result = fputil_cast_Float16_float.Invoke(x2);
			...
			else
			{
				...
				x3 = y;
				result = fputil_cast_Float16_float.Invoke(x3);
		...
		unchecked
		{
			...
			float num15 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs4);
			...
			float num16 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5);
			...
			else
			{
				...
				*(int*)(&fputil_FPBits_5nkvcs6) = -1431655766;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs6, *(float*)cpp_max_float.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs7);
				*(int*)(&fputil_FPBits_5nkvcs7) = -1431655766;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs7, *(float*)cpp_min_float.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(4L, &num8);
				num8 = -1431655766;
				if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_subnormal.Invoke(&fputil_FPBits_5nkvcs6))
				{
					num8 = (((b & 1) != 1) ? (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6)) - FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs7))) : (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6)) + FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs7))));
					num8 <<= 3;
				}
				else
				{
					llvm_lifetime_start_p0.Invoke(4L, &num9);
					num9 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs6) << 3;
					llvm_lifetime_start_p0.Invoke(4L, &num10);
					num10 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs7) << 3;
					llvm_lifetime_start_p0.Invoke(4L, &num11);
					checked
					{
						num11 = unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6))) - unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs7)));
						llvm_lifetime_start_p0.Invoke(4L, &num12);
						num12 = num10 >>> *unchecked((int*)cpp_min_int.Invoke(&num11, &num3));
				...
				checked
				{
					num14 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_exponent.Invoke(unchecked((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6))) - 26;
				...
				*ptr = -86;
				...
				int e = num14;
				BigInt_32ul_false_unsigned_int_BigInt_unsigned_int_void.Invoke(&bigInt_vtm4cw, num8);
