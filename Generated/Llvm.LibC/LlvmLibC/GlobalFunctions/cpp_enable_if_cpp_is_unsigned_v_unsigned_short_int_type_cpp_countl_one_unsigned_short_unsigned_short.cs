...
internal static partial class cpp_enable_if_cpp_is_unsigned_v_unsigned_short_int_type_cpp_countl_one_unsigned_short_unsigned_short
{
	public static int Invoke(short value)
	{
		return cpp_enable_if_cpp_is_unsigned_v_unsigned_short_int_type_cpp_countl_zero_unsigned_short_unsigned_short.Invoke(unchecked((short)((ushort)value ^ -1)));
	}
}
