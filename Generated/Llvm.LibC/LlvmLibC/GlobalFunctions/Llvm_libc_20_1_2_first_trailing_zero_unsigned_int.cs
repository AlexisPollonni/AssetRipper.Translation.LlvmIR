...
internal static partial class Llvm_libc_20_1_2_first_trailing_zero_unsigned_int
{
	...
	{
		return (Value != Integer_impl_unsigned_int_0u_4294967295u_max.Invoke()) ? (Cpp_countr_zero_unsigned_int.Invoke(Value ^ -1) + 1) : 0;
	}
}
