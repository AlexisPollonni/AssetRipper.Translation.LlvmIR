...
internal static partial class anonymous_namespace_exp10_f128_double_double_int_int
{
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, double x, double kd, int idx1, int idx2)
	{
		...
		unchecked
		{
			...
			*(long*)ptr10 = -6148914691236517206L;
			...
			anonymous_namespace_poly_approx_f128_fputil_DyadicFloat_128ul_const_46.Invoke(&fputil_DyadicFloat_kt2kd21, &fputil_DyadicFloat_kt2kd5);
			*(sbyte*)agg_result = -86;
