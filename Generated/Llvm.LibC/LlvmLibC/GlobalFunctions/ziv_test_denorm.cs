...
internal static partial class ziv_test_denorm
{
	...
	public unsafe static Struct_8myw6y Invoke([NativeType("int")] int hi, [NativeType("double")] double mid, [NativeType("double")] double lo, [NativeType("double")] double err)
	{
		...
		unchecked
		{
			if (details_expects_bool_condition_bool.Invoke(num13 == num14, expected: true))
			{
				...
				optional_double_Constructor_3qcik5.Invoke(&cpp_optional_vhbvq8, &num15);
				llvm_lifetime_end_p0.Invoke(8L, &num16);
				llvm_lifetime_end_p0.Invoke(8L, &num15);
			}
			else
			{
				optional_double_Constructor_tpurt2.Invoke(&cpp_optional_vhbvq8);
			}
