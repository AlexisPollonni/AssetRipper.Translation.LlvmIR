...
internal static partial class Statfs_utils_linux_fstatfs
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Cpp_optional_qbe95b* Agg_result, [MangledName("fd")][NativeType("int")] int Fd)
	{
		...
		num = Syscall_impl_int_int_statfs.Invoke(138L, Fd, &statfs);
		if (num < 0)
		{
