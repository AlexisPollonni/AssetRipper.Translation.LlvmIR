...
internal static partial class IntegerWriter_write_unsigned_number_cxrqng
{
	...
	public unsafe static void Invoke([MangledName("value")][NativeType("unsigned int")] int Value, [MangledName("sink")][NativeType("__llvm_libc_20_1_2_::details::StringBufferWriterImpl<false>&")] Llvm_libc_20_1_2_details_StringBufferWriterImpl* Sink)
	{
		sbyte digit = 0;
		int num = Value;
		unchecked
