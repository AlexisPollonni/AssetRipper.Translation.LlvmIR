					...
					*(long*)num7 = struct_fiz2nb6.field_1;
					...
					else
					{
						...
						*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
						int4 = int3;
						FPBits_long_double_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, *(long*)(&int4), ((long*)(&int4))[1]);
						Llvm_lifetime_start_p0.Invoke(16L, &num3);
						num3 = FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
						...
						*(long*)num9 = struct_fiz2nb9.field_1;
						...
						Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
						Int128* num10 = &x5;
