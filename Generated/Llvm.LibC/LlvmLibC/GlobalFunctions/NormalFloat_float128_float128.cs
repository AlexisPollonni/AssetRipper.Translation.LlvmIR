		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi4, 0.0);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, &@this->sign, 1L, isVolatile: false);
				FPStorage_fputil_FPType_3_set_sign.Invoke(&fputil_FPBits_ubgsi4, anon_izyfb9.val);
				...
				if (@this->exponent < -16382)
				{
					...
					if ((uint)num4 <= 113u)
					{
						...
						@int = 0L;
						FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&@int), ((long*)(&@int))[1]);
						int2 = NumericHelper.ShiftRightLogical(@this->mantissa, (Int128)(UInt128)(uint)num4);
						FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int2), ((long*)(&int2))[1]);
						...
						*(long*)num6 = struct_fiz2nb6.field_1;
						...
						{
							Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi4);
							Int128* num7 = &x2;
						...
						int5 = int3;
						FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int5), ((long*)(&int5))[1]);
						if (NumericHelper.IntCmpEq(int3, 0L))
						{
							int6 = 1L;
							FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int6), ((long*)(&int6))[1]);
						}
				...
				else
				{
					...
					FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int7), ((long*)(&int7))[1]);
					int8 = @this->mantissa;
					FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int8), ((long*)(&int8))[1]);
					result = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi4);
				}
