...
internal static partial class void_internal_quick_sort_impl_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_void_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const
{
	public unsafe static void Invoke(void* array, void* ancestor_pivot, long limit, void* is_less)
	{
		...
		unchecked
		{
			while (true)
			{
				...
				{
					void_internal_heap_sort_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_const_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const.Invoke(array, is_less);
					num7 = 1;
				}
				else
				{
					...
					num2 = unsigned_long_internal_choose_pivot_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_const_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const.Invoke(array, is_less);
					if (ptr2 != null && !qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_operator_void_const_void_const_const.Invoke(is_less, ptr2, internal_ArrayGenericSize_get_unsigned_long_const.Invoke(array, num2)))
					{
					...
					else
					{
						...
						num4 = unsigned_long_internal_partition_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const.Invoke(array, num2, is_less);
						if (num == 2L)
						{
							num7 = 1;
						}
...
internal static partial class void_internal_quick_sort_impl_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_void_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const_lambda_void_const_void_const_operator_void_const_void_const_const
{
