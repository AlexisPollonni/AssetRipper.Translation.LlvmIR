...
internal static partial class double_fputil_fmaximum_mag_double_0_double_double
{
	public unsafe static double Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
			...
			double result = ((!(double_fputil_abs_double_0_double.Invoke(x) > double_fputil_abs_double_0_double.Invoke(y))) ? ((!(double_fputil_abs_double_0_double.Invoke(y) > double_fputil_abs_double_0_double.Invoke(x))) ? double_fputil_fmaximum_double_0_double_double.Invoke(x, y) : y) : x);
