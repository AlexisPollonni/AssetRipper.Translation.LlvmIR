...
internal static partial class ExceptValues_float_11ul_lookup
{
	...
	public unsafe static long Invoke(fputil_ExceptValues_zsuwev* @this, [NativeType("unsigned int")] int x_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (details_expects_bool_condition_bool.Invoke(x_bits == ((fputil_ExceptValues_float_6_Mapping*)(&@this->values))[num].input, expected: false))
				{
