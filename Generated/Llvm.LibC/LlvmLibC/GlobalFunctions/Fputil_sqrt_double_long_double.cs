...
internal static partial class Fputil_sqrt_double_long_double
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil4sqrtIdeEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT_Esr3cppE19is_floating_point_vIT0_ElestS4_stS5_ES4_E4typeES5_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<double> && cpp::is_floating_point_v<long double> && sizeof (double) <= sizeof (long double), double>::type __llvm_libc_20_1_2_::fputil::sqrt<double, long double>(long double)")]
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			else if (FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi))
			{
				result = double.NaN;
			}
			else
			{
				...
				num2 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_exponent.Invoke(&fputil_FPBits_ubgsi);
				Llvm_lifetime_start_p0.Invoke(16L, &x);
				Struct_fiz2nb struct_fiz2nb4 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
				Int128* num4 = &int2;
				...
				*(long*)num5 = struct_fiz2nb6.field_1;
				...
				checked
				{
					if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_subnormal.Invoke(&fputil_FPBits_ubgsi))
					{
						num2++;
