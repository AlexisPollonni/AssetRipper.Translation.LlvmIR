...
internal static partial class long_fputil_round_to_signed_integer_long_double_long_0_long_double
{
	public static long Invoke(double x)
	{
		return long_fputil_internal_rounded_float_to_signed_integer_long_double_long_0_long_double.Invoke(long_double_fputil_round_long_double_0_long_double.Invoke(x));
	}
}
