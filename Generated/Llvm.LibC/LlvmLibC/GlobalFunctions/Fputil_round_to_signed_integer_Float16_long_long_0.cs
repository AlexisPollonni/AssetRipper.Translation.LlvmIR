...
internal static partial class Fputil_round_to_signed_integer_Float16_long_long_0
{
	...
	{
		return Internal_rounded_float_to_signed_integer_Float16_long_long_0.Invoke(Fputil_round_Float16_0.Invoke(X));
	}
}
