...
internal static partial class fputil_DyadicFloat_256ul_DyadicFloat_float128_0_float128
{
	public unsafe static void Invoke(void* @this, double x)
	{
		...
		unchecked
		{
			llvm_memcpy_p0_p0_i64.Invoke(&((fputil_DyadicFloat_jhcpjj*)@this)->sign, Sign_POS.Pointer, 1L, isVolatile: false);
			((fputil_DyadicFloat_jhcpjj*)@this)->exponent = 0;
			BigInt_256ul_false_unsigned_long_BigInt_int_void_int.Invoke(&((fputil_DyadicFloat_jhcpjj*)@this)->mantissa, 0);
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			((fputil_DyadicFloat_jhcpjj*)@this)->exponent = checked(fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_explicit_exponent_const.Invoke(&fputil_FPBits_ubgsi3) - 112);
