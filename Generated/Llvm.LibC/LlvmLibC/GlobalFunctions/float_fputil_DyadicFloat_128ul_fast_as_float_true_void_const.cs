	...
	public unsafe static float Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				checked
				{
					num3 = unchecked((fputil_DyadicFloat_kt2kd4*)@this)->exponent + 254;
				}
				...
				else
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					int field_3 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value_Sign_unsigned_int_unsigned_int.Invoke(biased_exp: num3, mantissa: (BigInt_128ul_false_unsigned_long_operator_unsigned_int_unsigned_int_const.Invoke(&bigInt_qdkjbh) & 0x7FFFFF) | 0, sign: anon_izyfb10.val);
