		...
		unchecked
		{
			...
			case 0:
			{
				...
				*(sbyte*)(&anon_izyfb) = -86;
				...
				FPStorage_fputil_FPType_1_set_sign.Invoke(&fputil_FPBits_5nkvcs2, anon_izyfb3.Val);
				...
				*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
				...
				int field_ = FMod_float_unsigned_long_fputil_generic_FModDivisionSimpleHelper_unsigned_long_eval_internal.Invoke(fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0, fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0);
				...
				FPStorage_fputil_FPType_1_set_sign.Invoke(&fputil_FPBits_5nkvcs3, anon_izyfb4.Val);
