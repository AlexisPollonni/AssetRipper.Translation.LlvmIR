...
internal static partial class expf
{
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				if ((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) <= 101)
				{
					result = 1f + x;
				}
				else if ((uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) >= 3268407733u)
				{
				...
				{
					if (!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_pos.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) || (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) < 1118961664u)
					{
						goto IL_03ab;
					}
					...
					result = x + FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5);
		...
		x2 = fputil_multiply_add_float.Invoke(num4, -1f / 128f, x);
		...
		unchecked
		{
			...
			num8 = fputil_polyeval_double_double_double_double_double.Invoke(x2, 1.0, 0.9999999999997574, 0.5000000000002021, 0.16666679382778612, 0.041666666671038154);
