	...
	public unsafe static Half Invoke([MangledName("x")] Half X)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva) = -21846;
			...
			else if (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva)) && (uint)(ushort)num2 >= 18944u)
			{
			...
			{
				if ((uint)(ushort)num2 > 10240u || FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva)))
				{
					goto IL_05f1;
				}
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_2ul_lookup.Invoke(X_bits: num, This: EXPF16_EXCEPTS_LO.Pointer);
		...
		unchecked
		{
			...
			*(Half*)ptr2 = default(Half);
			ptr2[2] = -86;
			ptr2[3] = -86;
			int storage2 = ExceptValues_Float16_3ul_lookup.Invoke(X_bits: num, This: EXPF16_EXCEPTS_HI.Pointer);
