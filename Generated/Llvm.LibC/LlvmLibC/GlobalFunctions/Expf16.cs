	...
	public unsafe static Half Invoke([MangledName("x")] Half X)
	{
		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			if (!Details_expects_bool_condition_bool.Invoke(((uint)(ushort)num2 > 10240u) ? ((uint)(ushort)num2 >= 18944u) : true, Expected: false))
			{
				goto IL_05f1;
			}
			...
			else if (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) && (uint)(ushort)num2 >= 18944u)
			{
			...
			{
				if ((uint)(ushort)num2 > 10240u || FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_i7nz4h*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)))
				{
					goto IL_05f1;
				}
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_2ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_EXPF16_EXCEPTS_LO.Pointer);
				*(int*)(&llvm_libc_20_1_2_cpp_optional_aq7wey.Storage) = storage;
				...
				case 0:
					...
					x = (float)X;
					result = Fputil_cast_Float16_float.Invoke(Fputil_polyeval_float_float_float_float.Invoke(x, 1f, 1f, 0.5000305f, 0.16667074f));
		...
		unchecked
		{
			...
			*(Half*)ptr2 = default(Half);
			ptr2[2] = -86;
			ptr2[3] = -86;
			int storage2 = ExceptValues_Float16_3ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_EXPF16_EXCEPTS_HI.Pointer);
