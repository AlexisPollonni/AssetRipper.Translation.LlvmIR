...
internal static partial class Generic_add_or_sub_false_Float16_float
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("float")] float X, [MangledName("y")][NativeType("float")] float Y)
	{
		...
		unchecked
		{
			...
			float num15 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs3);
			...
			float num16 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs4);
			...
			else
			{
				...
				*(int*)(&fputil_FPBits_5nkvcs5) = -1431655766;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs5, *(float*)Cpp_max_float.Invoke(&num6, &num7));
				Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs6);
				*(int*)(&fputil_FPBits_5nkvcs6) = -1431655766;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs6, *(float*)Cpp_min_float.Invoke(&num6, &num7));
				Llvm_lifetime_start_p0.Invoke(4L, &num8);
				num8 = -1431655766;
				if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_subnormal.Invoke(&fputil_FPBits_5nkvcs5))
				{
					num8 = (((b & 1) != 1) ? (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs5)) - FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6))) : (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs5)) + FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6))));
					num8 <<= 3;
				}
				else
				{
					Llvm_lifetime_start_p0.Invoke(4L, &num9);
					num9 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs5) << 3;
					Llvm_lifetime_start_p0.Invoke(4L, &num10);
					num10 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs6) << 3;
					Llvm_lifetime_start_p0.Invoke(4L, &num11);
					checked
					{
						num11 = unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs5))) - unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6)));
				...
				checked
				{
					num14 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_exponent.Invoke(unchecked((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs5))) - 26;
