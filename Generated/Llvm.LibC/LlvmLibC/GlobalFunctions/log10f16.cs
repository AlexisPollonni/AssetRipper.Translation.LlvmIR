			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_17ul_lookup.Invoke(x_bits: num, @this: LOG10F16_EXCEPTS.Pointer);
				*(int*)(&cpp_optional_aq7wey2.storage) = storage;
				...
				case 0:
					...
					num6 = fputil_multiply_add_float.Invoke(x2, *(float*)array_float_32ul_Index.Invoke(Index: num5, @this: ONE_OVER_F_F_10.Pointer), -1f);
					...
					z = *(float*)array_float_32ul_Index.Invoke(Index: num5, @this: LOG10F_F.Pointer) + num7;
