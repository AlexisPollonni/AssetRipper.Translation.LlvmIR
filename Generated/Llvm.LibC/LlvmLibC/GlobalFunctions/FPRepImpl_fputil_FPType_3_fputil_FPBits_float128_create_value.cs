	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte Sign, [MangledName("biased_exp.coerce0")] long Biased_exp, [MangledName("biased_exp.coerce1")] long Mantissa, [MangledName("mantissa.coerce0")] long Mantissa_coerce0, [MangledName("mantissa.coerce1")] long Mantissa_coerce1)
	{
		...
		unchecked
		{
			...
			*(long*)(&int2) = Mantissa_coerce0;
			...
			BiasedExponent_Constructor_ugybtz.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent, (int)int4);
			Int128 int6 = int5;
			Significand_Constructor_rhfmvq.Invoke(&fputil_internal_FPRepSem_f94eua, *(long*)(&int6), ((long*)(&int6))[1]);
			Struct_fiz2nb struct_fiz2nb = FPStorage_fputil_FPType_3_encode.Invoke(anon_izyfb2.Val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua), ((long*)(&fputil_internal_FPRepSem_f94eua))[1]);
			Int128* num = &int3;
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			Int128 int7 = int3;
			FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int7), ((long*)(&int7))[1]);
