...
internal static partial class BigInt_128ul_false_unsigned_long_ful_mul_128ul
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] BigInt_x9dsed* Agg_result, [MangledName("this")] Anon_izyfb7* This, [MangledName("other")] Anon_izyfb7* Other)
	{
		...
		unchecked
		{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			BigInt_256ul_false_unsigned_long_Constructor.Invoke(&bigInt_x9dsed);
			Multiword_multiply_with_carry_unsigned_long_4ul_2ul_2ul.Invoke(&bigInt_x9dsed.Val, &((BigInt_qdkjbh*)This)->Val, &((BigInt_qdkjbh*)Other)->Val);
