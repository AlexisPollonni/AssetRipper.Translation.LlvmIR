...
internal static partial class StrToNumResult_internal_ExpandedFloat_float_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("value.coerce")][NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<float>")] long Value)
	{
		...
		unchecked
		{
			*(long*)(&llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up) = Value;
			Llvm_memcpy_p0_p0_i64.Invoke(&((Llvm_libc_20_1_2_StrToNumResult_kkgahp*)This)->Value, &llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up, 8L, isVolatile: false);
			((Llvm_libc_20_1_2_StrToNumResult_kkgahp*)This)->Error = 0;
			((Llvm_libc_20_1_2_StrToNumResult_kkgahp*)This)->Parsed_len = 0L;
		}
	}
}
