...
internal static partial class generic_add_or_sub_false_double_long_double
{
	...
	public unsafe static double Invoke([NativeType("long double")] double x, [NativeType("long double")] double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else
			{
				...
				x3 = y;
				result = fputil_cast_double_long_double.Invoke(x3);
		...
		unchecked
		{
			...
			double num12 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi5);
			...
			double num13 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi6);
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi7) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi7, *(double*)cpp_max_long_double.Invoke(&num4, &num5));
				llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi8);
				*(Int128*)(&fputil_FPBits_ubgsi8) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi8, *(double*)cpp_min_long_double.Invoke(&num4, &num5));
				...
				else
				{
					...
					*(long*)num25 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num6 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi7)) - unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi8));
				...
				num7 = checked(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_exponent.Invoke(&fputil_FPBits_ubgsi7) - 66);
