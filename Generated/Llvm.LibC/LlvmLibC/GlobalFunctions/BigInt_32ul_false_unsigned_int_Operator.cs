...
internal static partial class BigInt_32ul_false_unsigned_int_Operator
{
	...
	public unsafe static BigInt_vtm4cw* Invoke(BigInt_vtm4cw* @this, [NativeType("unsigned long")] long s)
	{
		...
		unchecked
		{
			int data = multiword_shift_multiword_Direction_0_false_unsigned_int_1ul.Invoke(*(int*)(&cpp_array_2v7m9i3.Data), s);
