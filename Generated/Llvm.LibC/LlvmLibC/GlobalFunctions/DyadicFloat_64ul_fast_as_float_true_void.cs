...
internal static partial class DyadicFloat_64ul_fast_as_float_true_void
{
	...
	public unsafe static float Invoke([MangledName("this")] Fputil_DyadicFloat_syracv* This)
	{
			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)(&bigInt_555ggs) = -6148914691236517206L;
					...
					int field_3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value.Invoke(Biased_exp: num3, Mantissa: (BigInt_64ul_false_unsigned_long_Unsigned_int_unsigned_int.Invoke(&bigInt_555ggs) & 0x7FFFFF) | 0, Sign: anon_izyfb3.Val);
					...
					*(long*)(&bigInt_555ggs6.Val.Data) = data4;
					bool num21 = InstructionHelper.BooleanXor(BigInt_64ul_false_unsigned_long_is_zero.Invoke(&bigInt_555ggs6), right: true);
					...
					*(long*)(&bigInt_555ggs7.Val.Data) = data5;
					bool num22 = InstructionHelper.BooleanXor(BigInt_64ul_false_unsigned_long_is_zero.Invoke(&bigInt_555ggs7), right: true);
