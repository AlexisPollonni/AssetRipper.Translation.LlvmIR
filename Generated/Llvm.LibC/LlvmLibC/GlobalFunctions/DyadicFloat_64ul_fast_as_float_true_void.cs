			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)(&bigInt_555ggs) = -6148914691236517206L;
					...
					int field_3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value.Invoke(biased_exp: num3, mantissa: (BigInt_64ul_false_unsigned_long_unsigned_int_unsigned_int.Invoke(&bigInt_555ggs) & 0x7FFFFF) | 0, sign: anon_izyfb10.val);
