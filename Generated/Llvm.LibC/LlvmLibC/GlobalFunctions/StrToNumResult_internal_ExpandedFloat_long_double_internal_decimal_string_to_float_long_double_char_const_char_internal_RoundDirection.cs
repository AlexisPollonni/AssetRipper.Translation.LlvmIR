...
internal static partial class StrToNumResult_internal_ExpandedFloat_long_double_internal_decimal_string_to_float_long_double_char_const_char_internal_RoundDirection
{
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_ggsbhp* agg_result, void* src, sbyte DECIMAL_POINT, RoundDirection_b3pcwy round)
	{
		int num = 0;
		sbyte b = 0;
		sbyte b2 = 0;
		...
		StrToNumResult_internal_ExpandedFloat_long_double_StrToNumResult_internal_ExpandedFloat_long_double.Invoke(agg_result, &internal_ExpandedFloat_9jummq2);
		...
		unchecked
		{
			while (true)
			{
				if (internal_isdigit_int_121.Invoke(((sbyte*)src)[num3]))
				{
					llvm_lifetime_start_p0.Invoke(4L, &num4);
					num4 = internal_b36_char_to_int_int_120.Invoke(((sbyte*)src)[num3]);
					b3 = 1;
			...
			if ((b3 & 1) == 1)
			{
				if (internal_tolower_int_118.Invoke(((sbyte*)src)[num3]) == 101)
				{
					...
					if (internal_isdigit_int_121.Invoke(((sbyte*)src)[num3 + 1L + (((b5 & 1) == 1) ? 1L : 0L)]))
					{
						num3++;
						...
						*(int*)(&strToNumResult_yrtfty) = -1431655766;
						...
						Struct_fiz2nb struct_fiz2nb = StrToNumResult_int_internal_strtointeger_int_char_const_int_unsigned_long.Invoke((byte*)src + num3, 10, cpp_internal_integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
						StrToNumResult_yrtfty* num7 = &strToNumResult_yrtfty;
						Struct_fiz2nb struct_fiz2nb2 = struct_fiz2nb;
						*(long*)num7 = struct_fiz2nb2.field_0;
						byte* num8 = (byte*)(&strToNumResult_yrtfty) + 8u;
						...
						*(long*)num8 = struct_fiz2nb3.field_1;
						...
						num5 = strToNumResult_yrtfty.value;
				...
				else
				{
					...
					internal_FloatConvertReturn_long_double_internal_decimal_exp_to_float_long_double_internal_ExpandedFloat_long_double_bool_internal_RoundDirection_char_const_unsigned_long.Invoke(&internal_FloatConvertReturn_hgyipa2, &internal_ExpandedFloat_9jummq4, (b2 & 1) == 1, round, src, cpp_internal_integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
