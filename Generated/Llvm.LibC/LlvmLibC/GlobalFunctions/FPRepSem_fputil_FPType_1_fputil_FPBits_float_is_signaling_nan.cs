...
internal static partial class FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_signaling_nan
{
	...
	{
		return FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan.Invoke(This) ? (unchecked((byte)((FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_quiet_nan.Invoke(This) ? 1u : 0u) ^ 0xFFFFFFFFu)) != 0) : false;
	}
}
