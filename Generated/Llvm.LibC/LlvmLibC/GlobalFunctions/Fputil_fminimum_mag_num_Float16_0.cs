...
internal static partial class Fputil_fminimum_mag_num_Float16_0
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X, [MangledName("y")][NativeType("_Float16")] Half Y)
	{
		...
		unchecked
		{
			...
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva2) = -21846;
			...
			Half result = ((!NumericHelper.FcmpOlt(Fputil_abs_Float16_0.Invoke(X), Fputil_abs_Float16_0.Invoke(Y))) ? ((!NumericHelper.FcmpOlt(Fputil_abs_Float16_0.Invoke(Y), Fputil_abs_Float16_0.Invoke(X))) ? Fputil_fminimum_num_Float16_0.Invoke(X, Y) : Y) : X);
