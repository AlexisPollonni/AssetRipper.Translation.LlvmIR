	...
	public unsafe static long Invoke(void* @this, int x_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(x_bits == ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_evg4xu*)@this)->values))[num].input, expected: false))
				{
