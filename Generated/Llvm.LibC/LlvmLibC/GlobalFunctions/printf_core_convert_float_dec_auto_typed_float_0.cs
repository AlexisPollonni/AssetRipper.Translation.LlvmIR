...
internal static partial class printf_core_convert_float_dec_auto_typed_float_0
{
	[MangledName("_ZN19__llvm_libc_20_1_2_11printf_core28convert_float_dec_auto_typedIfTnNS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT_EEiE4typeELi0EEEiPNS0_6WriterERKNS0_13FormatSectionENS_6fputil6FPBitsIS4_EE")]
	...
	public unsafe static int Invoke([NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] printf_core_Writer* writer, [NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] printf_core_FormatSection* to_conv, [MangledName("float_bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<float>")] int float_bits)
	{
		...
		unchecked
		{
			num2 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_explicit_exponent.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2));
			llvm_lifetime_start_p0.Invoke(16L, &x);
			x = (Int128)(UInt128)(uint)FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs2);
			...
			*(Int128*)((byte*)(&floatToString_vnf) + 16) = -6148914691236517206L;
			FloatToString_float_0_Constructor.Invoke(&floatToString_vnf, FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2));
			...
			if (NumericHelper.IntCmpNe(x, 0L))
			{
				...
				{
					num6 = checked(num6 + -1);
					num7 = FloatToString_float_0_get_block.Invoke(&floatToString_vnf, num6);
				}
				...
				long num29 = IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_size.Invoke(&integerToString_uuwdyc);
				...
				if ((ulong)num8 <= (ulong)(uint)(num5 + 1))
				{
					...
					*(long*)num31 = struct_kqhe8i3.field_1;
					...
					{
						if (*(sbyte*)string_view_Index.Invoke(&cpp_string_view2, num12) == 57)
						{
							num11++;
							num10 = 0L;
						}
						else if (*(sbyte*)string_view_Index.Invoke(&cpp_string_view2, num12) == 48)
						{
							num10++;
							num11 = 0L;
						}
				...
				*(long*)num33 = struct_kqhe8i6.field_1;
				...
				num16 = 9L - string_view_size.Invoke(&cpp_string_view3);
				if (num9 == 0L)
				{
					num15 = string_view_size.Invoke(&cpp_string_view3);
					num16 = 0L;
				}
				...
				{
					if (*(sbyte*)string_view_Index.Invoke(&cpp_string_view3, i) == 57)
					{
						num11++;
						num10 = 0L;
					}
					else if (*(sbyte*)string_view_Index.Invoke(&cpp_string_view3, i) == 48)
					{
						num10++;
						num11 = 0L;
					}
				...
				if ((uint)num19 == num15)
				{
					...
					num21 = FloatToString_float_0_get_block.Invoke(&floatToString_vnf, num6);
				...
				if ((b & 1) != 1)
				{
					checked
					{
						if (num6 >= 0)
						{
							...
							for (k = num6 - 1; k >= 0; k += -1)
							{
								...
								num23 = FloatToString_float_0_get_block.Invoke(&floatToString_vnf, k);
								int num34;
								if (num23 != 0)
								{
									b = 1;
					...
					if ((b & 1) != 1 && checked(num2 - 23) < 0)
					{
						b = (sbyte)(byte)((printf_core_zero_after_digits_unsigned_int.Invoke(checked(num2 - 23), num5 - num4, FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs2), 23) ? 1 : 0) ^ -1);
					}
				}
				int last_digit = num20;
				bool truncated = (b & 1) == 1;
				anon_izyfb8.val = FPStorage_fputil_FPType_1_sign.Invoke(&fputil_FPBits_5nkvcs2);
				num22 = (int)printf_core_get_round_direction.Invoke(last_digit, truncated, anon_izyfb8.val);
				...
				if (num3 > num4 && num4 >= -4)
				{
					...
					result = printf_core_convert_float_decimal_typed_float_0.Invoke(writer, &printf_core_FormatSection3, fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0);
				...
				else
				{
					...
					result = printf_core_convert_float_dec_exp_typed_float_0.Invoke(writer, &printf_core_FormatSection4, fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0);
			...
			else
			{
				...
				result = printf_core_convert_float_decimal_typed_float_0.Invoke(writer, &printf_core_FormatSection2, fputil_FPBits_5nkvcs3.FPRepImpl.FPRepSem.field_0.field_0);
