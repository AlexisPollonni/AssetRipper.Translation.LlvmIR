...
internal static partial class FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_normal
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE4ENS0_6FPBitsIeEEE10max_normalENS_4SignE")]
	[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)4, __llvm_libc_20_1_2_::fputil::FPBits<long double>>::max_normal(__llvm_libc_20_1_2_::Sign)")]
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte Sign)
	{
		...
		int field_ = Exponent_max_p5wtjy.Invoke();
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb4 = FPStorage_fputil_FPType_4_encode.Invoke(anon_izyfb2.Val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua), ((long*)(&fputil_internal_FPRepSem_f94eua))[1]);
			Int128* num = &@int;
