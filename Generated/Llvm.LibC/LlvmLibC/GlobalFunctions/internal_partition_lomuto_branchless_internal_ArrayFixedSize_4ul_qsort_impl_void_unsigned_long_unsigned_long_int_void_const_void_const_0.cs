...
internal static partial class internal_partition_lomuto_branchless_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0
{
	...
	public unsafe static long Invoke([NativeType("__llvm_libc_20_1_2_::internal::ArrayFixedSize<4ul> const&")] void* array, [NativeType("void const*")] void* pivot, [NativeType("__llvm_libc_20_1_2_::__qsort_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*))::$_0 const&")] void* is_less)
	{
		...
		unchecked
		{
			while ((ulong)num3 < (ulong)num)
			{
				...
				b = (_0_Invoke_4rap2e.Invoke(is_less, ArrayFixedSize_4ul_get.Invoke(array, num3), pivot) ? ((sbyte)1) : ((sbyte)0));
