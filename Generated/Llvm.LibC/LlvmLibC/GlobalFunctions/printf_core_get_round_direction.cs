...
internal static partial class printf_core_get_round_direction
{
	...
	public unsafe static RoundDirection_zvveyk Invoke([NativeType("int")] int last_digit, [NativeType("bool")] bool truncated, [MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign)
	{
		...
		unchecked
		{
			...
			case 1024:
				if (Sign_is_neg.Invoke(&anon_izyfb8) && ((b & 1) == 1 || last_digit > 0))
				{
					return RoundDirection_zvveyk.Up;
				}
				return RoundDirection_zvveyk.Down;
			case 2048:
				if (Sign_is_pos.Invoke(&anon_izyfb8) && ((b & 1) == 1 || last_digit > 0))
				{
					return RoundDirection_zvveyk.Up;
				}
				return RoundDirection_zvveyk.Down;
