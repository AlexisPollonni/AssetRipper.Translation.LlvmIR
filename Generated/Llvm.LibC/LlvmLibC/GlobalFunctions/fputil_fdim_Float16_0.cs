	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x, [NativeType("_Float16")] Half y)
	{
		...
		unchecked
		{
			...
			*(short*)(&fputil_FPBits_2fahva3) = -21846;
			...
			Half result = ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2))) ? ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3))) ? ((!NumericHelper.FcmpOgt(x, y)) ? default(Half) : ((Half)((float)x - (float)y))) : y) : x);
