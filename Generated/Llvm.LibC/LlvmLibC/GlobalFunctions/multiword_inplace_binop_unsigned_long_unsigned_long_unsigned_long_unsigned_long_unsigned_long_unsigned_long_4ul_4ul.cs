...
internal static partial class multiword_inplace_binop_unsigned_long_unsigned_long_unsigned_long_unsigned_long_unsigned_long_unsigned_long_4ul_4ul
{
	...
	public unsafe static long Invoke([NativeType("unsigned long (*)(unsigned long, unsigned long, unsigned long, unsigned long&)")] void* op_with_carry, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 4ul>&")] cpp_array_jgy3xh* dst, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 4ul> const&")] cpp_array_jgy3xh* rhs)
	{
		long num = 0L;
		long num2 = 0L;
		sbyte b = 0;
		...
		unchecked
		{
			for (num2 = 0L; (ulong)num2 < 4uL; num2++)
			{
				...
				num3 = (((b & 1) != 1) ? 0L : (*(long*)array_unsigned_long_4ul_Index_pwcpnu.Invoke(rhs, num2)));
