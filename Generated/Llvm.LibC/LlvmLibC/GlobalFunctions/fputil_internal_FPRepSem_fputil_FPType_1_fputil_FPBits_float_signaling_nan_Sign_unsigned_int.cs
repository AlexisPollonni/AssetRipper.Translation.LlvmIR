...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_signaling_nan_Sign_unsigned_int
{
	public unsafe static int Invoke([MangledName("sign.coerce")] sbyte sign, int v)
	{
		...
		if (v != 0)
		{
			fputil_internal_FPStorage_fputil_FPType_1_Significand_Significand_unsigned_int.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent4, v);
		}
		else
		{
			...
			int field_3 = fputil_internal_operator_fputil_internal_FPStorage_fputil_FPType_1_Significand_int.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent5.field_0.field_0, 1);
