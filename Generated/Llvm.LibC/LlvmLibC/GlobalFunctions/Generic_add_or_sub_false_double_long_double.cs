...
internal static partial class Generic_add_or_sub_false_double_long_double
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi))
			{
				...
				else
				{
					...
					x = Y;
					result = Fputil_cast_double_long_double.Invoke(x);
			...
			else
			{
				...
				x2 = Y;
				result = Fputil_cast_double_long_double.Invoke(x2);
