	...
	public unsafe static double Invoke([MangledName("e_x")][NativeType("int")] int E_x, [MangledName("index")][NativeType("int")] int Index, [MangledName("m_x")][NativeType("double")] double M_x)
	{
		...
		unchecked
		{
			...
			*(long*)ptr4 = -6148914691236517206L;
			...
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd2, Anonymous_namespace_LOG10_2.Pointer, &fputil_DyadicFloat_kt2kd);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd5, (byte*)Anonymous_namespace_LOG10_TABLE.Pointer + (nint)Index * (nint)sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			...
			*(long*)ptr6 = -6148914691236517206L;
			...
			Log_range_reduction.Invoke(&fputil_DyadicFloat_kt2kd6, M_x, Anonymous_namespace_LOG10_TABLE.Pointer, &fputil_DyadicFloat_kt2kd2);
			...
			*(long*)ptr8 = -6148914691236517206L;
			...
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd7, &fputil_DyadicFloat_kt2kd6, (Fputil_DyadicFloat_kt2kd4*)Anonymous_namespace_BIG_COEFFS_33.Pointer);
			Llvm_lifetime_start_p0.Invoke(24L, &fputil_DyadicFloat_kt2kd8);
			Llvm_lifetime_start_p0.Invoke(24L, &fputil_DyadicFloat_kt2kd9);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd7, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd11, (byte*)Anonymous_namespace_BIG_COEFFS_33.Pointer + sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd9, &fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd11);
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd8, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd9);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd7, &fputil_DyadicFloat_kt2kd8, 24L, isVolatile: false);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd14, &fputil_DyadicFloat_kt2kd7, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd15, (byte*)Anonymous_namespace_BIG_COEFFS_33.Pointer + (nint)2 * sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd13, &fputil_DyadicFloat_kt2kd14, &fputil_DyadicFloat_kt2kd15);
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd12, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd13);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd7, &fputil_DyadicFloat_kt2kd12, 24L, isVolatile: false);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd18, &fputil_DyadicFloat_kt2kd7, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd19, (byte*)Anonymous_namespace_BIG_COEFFS_33.Pointer + (nint)3 * sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd17, &fputil_DyadicFloat_kt2kd18, &fputil_DyadicFloat_kt2kd19);
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd16, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd17);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd7, &fputil_DyadicFloat_kt2kd16, 24L, isVolatile: false);
			...
			*(sbyte*)(&fputil_DyadicFloat_kt2kd20) = -86;
			sbyte* ptr9 = (sbyte*)(&fputil_DyadicFloat_kt2kd20) + 1;
			*ptr9 = -86;
			ptr9[1] = -86;
			ptr9[2] = -86;
			((int*)(&fputil_DyadicFloat_kt2kd20))[1] = -1431655766;
			sbyte* ptr10 = (sbyte*)(&fputil_DyadicFloat_kt2kd20) + 8;
			*(long*)ptr10 = -6148914691236517206L;
			((long*)ptr10)[1] = -6148914691236517206L;
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd21, &fputil_DyadicFloat_kt2kd2, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd22, &fputil_DyadicFloat_kt2kd7, 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd20, &fputil_DyadicFloat_kt2kd21, &fputil_DyadicFloat_kt2kd22);
			double result = DyadicFloat_128ul_Double_double_void.Invoke(&fputil_DyadicFloat_kt2kd20);
