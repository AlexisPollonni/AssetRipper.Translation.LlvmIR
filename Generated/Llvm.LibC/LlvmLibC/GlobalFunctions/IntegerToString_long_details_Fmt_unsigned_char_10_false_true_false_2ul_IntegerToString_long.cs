...
internal static partial class IntegerToString_long_details_Fmt_unsigned_char_10_false_true_false_2ul_IntegerToString_long
{
	public unsafe static void Invoke(void* @this, long value)
	{
		...
		unchecked
		{
			...
			*ptr2 = -86;
			...
			ptr2[5] = -86;
			ptr2[6] = -86;
			cpp_span_char_span_char_21ul_true_cpp_array_char_21ul.Invoke(&cpp_string_view2, &((IntegerToString_uuwdyc*)@this)->array);
			...
			IntegerToString_long_details_Fmt_unsigned_char_10_false_true_false_2ul_IntegerWriter_write_long_details_StringBufferWriterImpl_false.Invoke(value, &details_StringBufferWriterImpl2);
			((IntegerToString_uuwdyc*)@this)->written = details_StringBufferWriterImpl_false_size_const.Invoke(&details_StringBufferWriterImpl2);
