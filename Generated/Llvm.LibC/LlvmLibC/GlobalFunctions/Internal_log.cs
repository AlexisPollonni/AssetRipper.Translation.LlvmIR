	...
	public unsafe static float Invoke([MangledName("x")][NativeType("double")] double X)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm) = -6148914691236517206L;
			...
			num2 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm));
			long num7 = num2;
			...
			bool num8 = Details_expects_bool_condition_bool.Invoke((ulong)num7 > (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)), Expected: false);
			Llvm_lifetime_end_p0.Invoke(8L, &fputil_FPBits_wjhbrm2);
			float result;
			if (num8)
			{
				if (FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm)) && !FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm)))
				{
			...
			else
			{
				...
				num4 = (int)(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm)) >>> 45);
				FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_biased_exponent.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm), 1023L);
				...
				*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
				...
				FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3), FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3)) & -35184372088832L);
				Llvm_lifetime_start_p0.Invoke(8L, &num5);
				num5 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm) - FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm3);
				long num9 = num4;
				...
				double x = num3;
				long num11 = num4;
				a = Fputil_multiply_add_double.Invoke(x, 0.6931471805599453, ((double*)LOG_F.Pointer)[num11]);
