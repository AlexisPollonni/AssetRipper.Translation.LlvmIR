...
internal static partial class BigInt_128ul_false_unsigned_long_sub_overflow
{
	...
	{
		return unchecked(Multiword_sub_with_borrow_unsigned_long_2ul_2ul.Invoke(&((Llvm_libc_20_1_2_BigInt_qdkjbh*)This)->Val, &((Llvm_libc_20_1_2_BigInt_qdkjbh*)Rhs)->Val));
	}
}
