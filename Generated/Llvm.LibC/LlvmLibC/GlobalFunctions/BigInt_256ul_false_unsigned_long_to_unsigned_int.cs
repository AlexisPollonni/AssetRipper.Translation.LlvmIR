...
internal static partial class BigInt_256ul_false_unsigned_long_to_unsigned_int
{
	...
	public unsafe static int Invoke([MangledName("this")] BigInt_x9dsed* This)
	{
		long num = 0L;
		int num2 = 0;
		...
		num2 = unchecked((int)(*(long*)Array_unsigned_long_4ul_Index_pwcpnu.Invoke(&This->Val, 0L)));
		int result = num2;
