	...
	public unsafe static int Invoke([MangledName("buffer")] void* Buffer, [MangledName("format")] void* Format, [MangledName("vlist")] Va_list_tag* Vlist)
	{
		...
		unchecked
		{
			...
			*(IntPtr*)((byte*)ptr + 16) = unchecked((nint)(-6148914691236517206L));
			...
			WriteBuffer_Constructor.Invoke(&llvm_libc_20_1_2_printf_core_WriteBuffer, Buffer, Integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
			...
			*(IntPtr*)(&llvm_libc_20_1_2_printf_core_Writer) = unchecked((nint)(-6148914691236517206L));
			...
			sbyte* ptr2 = (sbyte*)(&llvm_libc_20_1_2_printf_core_Writer) + 12;
			*ptr2 = -86;
			ptr2[1] = -86;
			ptr2[2] = -86;
			ptr2[3] = -86;
