	...
	public unsafe static float Invoke([MangledName("x")] float X)
	{
		...
		unchecked
		{
			*(int*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) = -1431655766;
			...
			num2 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs));
				...
				if (num9 != 1065307503)
				{
					if (num9 != 1092063211)
					{
						if (num9 != 512247085)
						{
							...
							bool num11 = Details_expects_bool_condition_bool.Invoke((uint)num10 < (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs2)), Expected: false);
							...
							if (num11)
							{
								...
								FPBits_float_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs4, FPBits_float_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) * 8388608f);
								...
								if (num12 != 1343224579)
								{
									if (num12 != 1557569160)
									{
										...
										else
										{
											...
											bool num14 = Details_expects_bool_condition_bool.Invoke((uint)num13 > (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs5)), Expected: false);
											...
											else if (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)) && !FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs))
											{
												...
												llvm_libc_20_1_2_fputil_FPBits_5nkvcs7.FPRepImpl.FPRepSem.field_0.field_0 = field_5;
		...
		{
			result = (float)((double)(num3 + unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)))) * 0.6931471805599453);
		}
		else
		{
			Llvm_lifetime_start_p0.Invoke(4L, &num4);
			num4 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke(unchecked((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)));
			Llvm_lifetime_start_p0.Invoke(4L, &num5);
			num5 = num4 >>> 16;
			num3 += unchecked(num2 + 65536) >>> 23;
			unchecked
			{
				FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_biased_exponent.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs), 127);
				Llvm_lifetime_start_p0.Invoke(4L, &num6);
				num6 = FPBits_float_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
				Llvm_lifetime_start_p0.Invoke(8L, &num7);
				num7 = double.NaN;
				double x2 = num6;
				long num15 = num5;
				num7 = Fputil_multiply_add_double.Invoke(x2, ((double*)Llvm_libc_20_1_2_RD.Pointer)[num15], -1.0);
				...
				*(double*)(&inlineArray4_Double) = -0.5000000000072301;
				...
				long num16 = num5;
				a = ((double*)Llvm_libc_20_1_2_LOG_R.Pointer)[num16] + num7;
