...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_long_double_bool_type_fputil_totalorder_long_double_long_double_long_double
{
	public unsafe static bool Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			...
			Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
			Int128* num3 = &int2;
