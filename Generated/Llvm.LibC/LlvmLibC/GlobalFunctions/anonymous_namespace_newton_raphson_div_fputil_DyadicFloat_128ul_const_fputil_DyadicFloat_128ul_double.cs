	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, fputil_DyadicFloat_kt2kd4* a, void* b, double q)
	{
		...
		unchecked
		{
			...
			*(long*)ptr2 = -6148914691236517206L;
			...
			fputil_DyadicFloat_128ul_DyadicFloat_double_0_double.Invoke(&fputil_DyadicFloat_kt2kd5, q);
			...
			*(long*)ptr3 = 0L;
			...
			llvm_memcpy_p0_p0_i64.Invoke(source: (!operator_Sign_Sign_fy8fvt.Invoke(anon_izyfb8.val, anon_izyfb9.val)) ? Sign_POS.Pointer : Sign_NEG.Pointer, destination: &((fputil_DyadicFloat_kt2kd4*)b)->sign, length: 1L, isVolatile: false);
			...
			*(long*)ptr7 = -6148914691236517206L;
			...
			fputil_DyadicFloat_128ul_fputil_quick_mul_128ul_fputil_DyadicFloat_128ul_const_fputil_DyadicFloat_128ul_const.Invoke(agg_result, a, &fputil_DyadicFloat_kt2kd11);
