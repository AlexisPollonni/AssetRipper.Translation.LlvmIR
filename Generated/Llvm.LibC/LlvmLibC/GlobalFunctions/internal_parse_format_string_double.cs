...
internal static partial class internal_parse_format_string_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] printf_core_FormatSection* agg_result, [NativeType("char const*")] void* format, [NativeType("double")] double fp)
	{
		double num = 0.0;
		long num2 = 0L;
		double num3 = 0.0;
