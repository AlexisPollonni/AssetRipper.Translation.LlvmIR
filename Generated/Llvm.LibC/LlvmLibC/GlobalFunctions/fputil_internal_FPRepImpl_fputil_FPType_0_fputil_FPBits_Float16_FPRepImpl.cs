...
internal static partial class fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_FPRepImpl
{
	public unsafe static void Invoke(fputil_internal_FPRepImpl_7z3gh9* @this)
	{
		fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_FPRepSem.Invoke(unchecked((fputil_internal_FPRepSem_i7nz4h*)@this));
	}
}
