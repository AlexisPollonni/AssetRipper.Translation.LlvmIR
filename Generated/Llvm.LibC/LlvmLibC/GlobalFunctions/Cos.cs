	...
	public unsafe static double Invoke([MangledName("x")] double X)
	{
		...
		unchecked
		{
			...
			*(double*)ptr2 = double.NaN;
			...
			else
			{
				if (Details_expects_bool_condition_bool.Invoke((ushort)num > 2046, Expected: false))
				{
					...
					result = X + FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm2);
			...
			*(double*)(&llvm_libc_20_1_2_NumberPair3) = double.NaN;
			...
			num3 = Generic_sincos_eval.Invoke(&llvm_libc_20_1_2_NumberPair, &llvm_libc_20_1_2_NumberPair2, &llvm_libc_20_1_2_NumberPair3);
			...
			*(double*)(&llvm_libc_20_1_2_NumberPair4) = double.NaN;
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_NumberPair4, (byte*)Llvm_libc_20_1_2_SIN_K_PI_OVER_128.Pointer + (nint)num8 * sizeof(Llvm_libc_20_1_2_NumberPair), 16L, isVolatile: false);
			...
			*(double*)(&llvm_libc_20_1_2_NumberPair5) = double.NaN;
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_NumberPair5, (byte*)Llvm_libc_20_1_2_SIN_K_PI_OVER_128.Pointer + (nint)num9 * sizeof(Llvm_libc_20_1_2_NumberPair), 16L, isVolatile: false);
			...
			*(double*)(&llvm_libc_20_1_2_NumberPair6) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = Fputil_quick_mult_27ul.Invoke(&llvm_libc_20_1_2_NumberPair3, &llvm_libc_20_1_2_NumberPair5);
			Llvm_libc_20_1_2_NumberPair* num10 = &llvm_libc_20_1_2_NumberPair6;
			Struct_4ydhja struct_4ydhja2 = struct_4ydhja;
			*(double*)num10 = struct_4ydhja2.field_0;
			byte* num11 = (byte*)(&llvm_libc_20_1_2_NumberPair6) + 8u;
			...
			*(double*)(&llvm_libc_20_1_2_NumberPair7) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja4 = Fputil_quick_mult_27ul.Invoke(&llvm_libc_20_1_2_NumberPair2, &llvm_libc_20_1_2_NumberPair4);
			Llvm_libc_20_1_2_NumberPair* num12 = &llvm_libc_20_1_2_NumberPair7;
			Struct_4ydhja struct_4ydhja5 = struct_4ydhja4;
			*(double*)num12 = struct_4ydhja5.field_0;
			byte* num13 = (byte*)(&llvm_libc_20_1_2_NumberPair7) + 8u;
			...
			*(double*)(&llvm_libc_20_1_2_NumberPair8) = double.NaN;
			...
			Llvm_libc_20_1_2_NumberPair* num14 = &llvm_libc_20_1_2_NumberPair8;
			Struct_4ydhja struct_4ydhja8 = struct_4ydhja7;
			*(double*)num14 = struct_4ydhja8.field_0;
			byte* num15 = (byte*)(&llvm_libc_20_1_2_NumberPair8) + 8u;
			Struct_4ydhja struct_4ydhja9 = struct_4ydhja7;
			*(double*)num15 = struct_4ydhja9.field_1;
			double num16 = llvm_libc_20_1_2_NumberPair7.Lo + llvm_libc_20_1_2_NumberPair6.Lo;
			llvm_libc_20_1_2_NumberPair8.Lo += num16;
			Llvm_lifetime_start_p0.Invoke(8L, &num4);
			num4 = llvm_libc_20_1_2_NumberPair8.Lo + num3;
			Llvm_lifetime_start_p0.Invoke(8L, &num5);
			num5 = llvm_libc_20_1_2_NumberPair8.Lo - num3;
			Llvm_lifetime_start_p0.Invoke(8L, &num6);
			num6 = llvm_libc_20_1_2_NumberPair8.Hi + num4;
			...
			else
			{
				...
				*(long*)ptr8 = -6148914691236517206L;
				...
				if (Details_expects_bool_condition_bool.Invoke((ushort)num < 1039, Expected: true))
				{
					...
					Llvm_libc_20_1_2_range_reduction_small_f128_nv2a7v.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4, X);
				...
				*(long*)ptr10 = -6148914691236517206L;
				...
				_0_Invoke_zdjgbv.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6, &anon_izyfb2, num2 + 128);
				...
				*(long*)ptr12 = -6148914691236517206L;
				...
				_0_Invoke_zdjgbv.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd7, &anon_izyfb2, num2 + 64);
				...
				*(long*)ptr14 = -6148914691236517206L;
				...
				Fputil_quick_mul_128ul.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd7, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd3);
				Fputil_quick_mul_128ul.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd10, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2);
