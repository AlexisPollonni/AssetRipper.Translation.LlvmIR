			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi))
			{
				if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi2))
				{
					...
					else
					{
						...
						fputil_FPBits_5nkvcs9.FPRepImpl.FPRepSem.field_0.field_0 = field_9;
		...
		unchecked
		{
			...
			if (num6 == num7 && (b & 1) != 1)
			{
				if (Fputil_quick_get_round.Invoke() == 1024)
				{
					...
					fputil_FPBits_5nkvcs10.FPRepImpl.FPRepSem.field_0.field_0 = field_10;
				...
				else
				{
					...
					fputil_FPBits_5nkvcs11.FPRepImpl.FPRepSem.field_0.field_0 = field_11;
