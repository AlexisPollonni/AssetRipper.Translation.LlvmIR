	...
	public unsafe static void Invoke(void* @this, double x)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			((fputil_DyadicFloat_kt2kd4*)@this)->exponent = checked(fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_exponent_const.Invoke(&fputil_FPBits_ubgsi3) - 63);
