	...
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else if ((ushort)num >= 19456 && fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos_const.Invoke(&fputil_FPBits_2fahva2))
			{
		...
		unchecked
		{
			...
			*(Half*)ptr2 = default(Half);
			ptr2[2] = -86;
			ptr2[3] = -86;
			int storage2 = fputil_ExceptValues_Float16_6ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: EXP2M1F16_EXCEPTS_HI.Pointer);
