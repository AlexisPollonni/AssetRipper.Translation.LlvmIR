	...
	public unsafe static double Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
			...
			double result = ((!operator_Sign_Sign_rpctvi.Invoke(anon_izyfb8.val, anon_izyfb9.val)) ? ((!(x < y)) ? y : x) : ((!fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg_const.Invoke(&fputil_FPBits_wjhbrm2)) ? y : x));
