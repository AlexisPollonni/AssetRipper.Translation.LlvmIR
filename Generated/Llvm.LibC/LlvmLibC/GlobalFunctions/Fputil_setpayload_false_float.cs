	...
	public unsafe static bool Invoke([MangledName("res")][NativeType("float&")] void* Res, [MangledName("pl")][NativeType("float")] float Pl)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs, Pl);
			bool result;
			if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&fputil_FPBits_5nkvcs))
			{
				...
				*(float*)Res = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
			...
			else
			{
				...
				if (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) || num < 0 || num >= 22 || ((FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) << num) & 0x7FFFFF) != 0)
				{
					*(float*)Res = 0f;
					result = true;
				}
				else
				{
					...
					num2 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs) >>> checked(23 - num);
					Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs3);
					Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb2, Sign_POS.Pointer, 1L, isVolatile: false);
					int field_2 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(V: num2, Sign: anon_izyfb2.Val);
