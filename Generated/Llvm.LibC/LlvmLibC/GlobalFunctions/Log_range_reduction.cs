...
internal static partial class Log_range_reduction
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Fputil_DyadicFloat_kt2kd4* Agg_result, [MangledName("m_x")][NativeType("double")] double M_x, [MangledName("log_table")][NativeType("__llvm_libc_20_1_2_::LogRR const&")] LogRR* Log_table, [MangledName("sum")][NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<128ul>&")] Fputil_DyadicFloat_kt2kd4* Sum)
	{
		long num = 0L;
		long num2 = 0L;
		...
		Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd2, Sum, 24L, isVolatile: false);
		unchecked
		{
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd3, (byte*)(&Log_table->Step_2) + (nint)num2 * sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd, &fputil_DyadicFloat_kt2kd2, &fputil_DyadicFloat_kt2kd3);
			Llvm_memcpy_p0_p0_i64.Invoke(Sum, &fputil_DyadicFloat_kt2kd, 24L, isVolatile: false);
		...
		Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd5, Sum, 24L, isVolatile: false);
		unchecked
		{
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd6, (byte*)(&Log_table->Step_3) + (nint)num7 * sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd4, &fputil_DyadicFloat_kt2kd5, &fputil_DyadicFloat_kt2kd6);
			Llvm_memcpy_p0_p0_i64.Invoke(Sum, &fputil_DyadicFloat_kt2kd4, 24L, isVolatile: false);
		...
		Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd8, Sum, 24L, isVolatile: false);
		unchecked
		{
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd9, (byte*)(&Log_table->Step_4) + (nint)num10 * sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd7, &fputil_DyadicFloat_kt2kd8, &fputil_DyadicFloat_kt2kd9);
			Llvm_memcpy_p0_p0_i64.Invoke(Sum, &fputil_DyadicFloat_kt2kd7, 24L, isVolatile: false);
			...
			if (num14)
			{
				...
				*(long*)(&inlineArray2_Int) = (long)NumericHelper.SubtractSigned(y: int2, x: 0L);
				...
				BigInt_128ul_false_unsigned_long_BigInt_2ul.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh), &inlineArray2_Int);
				DyadicFloat_128ul_Constructor.Invoke(Agg_result, anon_izyfb.Val, -125, *(long*)(&bigInt_qdkjbh), ((long*)(&bigInt_qdkjbh))[1]);
			}
			else
			{
				...
				*(long*)(&inlineArray2_Int2) = (long)int2;
				...
				BigInt_128ul_false_unsigned_long_BigInt_2ul.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh2), &inlineArray2_Int2);
				DyadicFloat_128ul_Constructor.Invoke(Agg_result, anon_izyfb2.Val, -125, *(long*)(&bigInt_qdkjbh2), ((long*)(&bigInt_qdkjbh2))[1]);
			}
