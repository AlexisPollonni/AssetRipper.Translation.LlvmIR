	...
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			if (!bool_details_expects_bool_condition_bool_bool_bool.Invoke((uint)(ushort)num2 >= 19456u, expected: false))
			{
				goto IL_04a4;
			}
			...
			else if (fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)))
			{
		...
		unchecked
		{
			...
			*(Half*)ptr = default(Half);
			ptr[2] = -86;
			ptr[3] = -86;
			int storage = fputil_ExceptValues_Float16_3ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: EXP2F16_EXCEPTS.Pointer);
