...
internal static partial class multiword_inplace_binop_unsigned_long_unsigned_long_unsigned_long_unsigned_long_unsigned_long_unsigned_long_1ul_1ul
{
	...
	public unsafe static long Invoke([NativeType("unsigned long (*)(unsigned long, unsigned long, unsigned long, unsigned long&)")] void* op_with_carry, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 1ul>&")] cpp_array_rpgxvv* dst, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 1ul> const&")] cpp_array_rpgxvv* rhs)
	{
		long num = 0L;
		long num2 = 0L;
		sbyte b = 0;
