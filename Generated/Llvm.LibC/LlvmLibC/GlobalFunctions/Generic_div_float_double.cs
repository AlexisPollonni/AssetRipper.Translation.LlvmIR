	...
	public unsafe static float Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("y")][NativeType("double")] double Y)
	{
		...
		unchecked
		{
			...
			*ptr2 = -86;
			...
			num4 = checked(fputil_DyadicFloat_syracv.Exponent - fputil_DyadicFloat_syracv2.Exponent - 25);
			...
			*(long*)(&bigInt_555ggs5.Val.Data) = data3;
			...
			result = DyadicFloat_64ul_as_float_true_void.Invoke(&fputil_DyadicFloat_syracv3);
