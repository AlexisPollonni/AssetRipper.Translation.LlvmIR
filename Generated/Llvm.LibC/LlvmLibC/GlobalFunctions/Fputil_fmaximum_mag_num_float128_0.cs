...
internal static partial class Fputil_fmaximum_mag_num_float128_0
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			double result = ((!(Fputil_abs_float128_0.Invoke(X) > Fputil_abs_float128_0.Invoke(Y))) ? ((!(Fputil_abs_float128_0.Invoke(Y) > Fputil_abs_float128_0.Invoke(X))) ? Fputil_fmaximum_num_float128_0.Invoke(X, Y) : Y) : X);
