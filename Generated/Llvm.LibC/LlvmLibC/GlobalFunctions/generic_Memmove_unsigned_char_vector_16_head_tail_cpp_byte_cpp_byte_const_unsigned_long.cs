...
internal static partial class generic_Memmove_unsigned_char_vector_16_head_tail_cpp_byte_cpp_byte_const_unsigned_long
{
	public unsafe static void Invoke(void* dst, void* src, long count)
	{
		...
		unchecked
		{
			...
			value = unsigned_char_vector_16_generic_load_unsigned_char_vector_16_cpp_byte_const.Invoke(src);
			...
			value2 = unsigned_char_vector_16_generic_load_unsigned_char_vector_16_cpp_byte_const.Invoke((byte*)src + num);
			void_generic_store_unsigned_char_vector_16_cpp_byte_unsigned_char_vector_16.Invoke(dst, value);
			void_generic_store_unsigned_char_vector_16_cpp_byte_unsigned_char_vector_16.Invoke((byte*)dst + num, value2);
