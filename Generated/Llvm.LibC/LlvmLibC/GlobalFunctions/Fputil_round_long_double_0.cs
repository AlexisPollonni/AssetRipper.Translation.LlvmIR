			...
			else
			{
				...
				else
				{
					...
					*(long*)num5 = struct_fiz2nb9.field_1;
					...
					Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi);
					Int128* num6 = &int2;
					...
					*(long*)num7 = struct_fiz2nb12.field_1;
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi)) ? (num3 + 1.0) : (num3 - 1.0)) : num3);
