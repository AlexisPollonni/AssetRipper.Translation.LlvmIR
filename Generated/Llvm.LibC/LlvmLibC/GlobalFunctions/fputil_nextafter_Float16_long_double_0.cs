...
internal static partial class fputil_nextafter_Float16_long_double_0
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half from, [NativeType("long double")] double to)
	{
				...
				else
				{
					if (NumericHelper.IsUnorderedOrNotEquals(from, default(Half)))
					{
						if (fputil_cast_long_double_Float16.Invoke(from) < to == NumericHelper.FcmpOgt(from, default(Half)))
						{
							...
							FPBits_Float16_FPBits_unsigned_short.Invoke(&fputil_FPBits_2fahva3, (short)checked(unchecked((ushort)FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2))) + 1));
