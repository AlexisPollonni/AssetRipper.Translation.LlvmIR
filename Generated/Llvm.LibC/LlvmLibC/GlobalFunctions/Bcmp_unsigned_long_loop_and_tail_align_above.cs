			...
			*(long*)(&fputil_internal_FPStorage_v3nexn) = -6148914691236517206L;
			...
			if (Details_expects_bool_condition_bool.Invoke((ulong)num >= (ulong)Threshold, Expected: false) && AlignHelper_8ul_not_aligned.Invoke(&fputil_internal_FPStorage_v3nexn))
			{
				*(int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt) = -1431655766;
				fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0 = Bcmp_unsigned_long_block.Invoke(ptr, p);
				if (StrictIntegralType_unsigned_int_ToBoolean.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt))
				{
					goto IL_00bd;
				}
				Adjust_cpp_byte_const_cpp_byte_const.Invoke(fputil_internal_FPStorage_v3nexn.Val, &ptr, &p, &num);
			}
			fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0 = Bcmp_unsigned_long_loop_and_tail.Invoke(ptr, p, num);
			goto IL_00bd;
		}
		IL_00bd:
