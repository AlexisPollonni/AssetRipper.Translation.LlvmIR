...
internal static partial class fputil_ExceptValues_Float16_9ul_lookup_unsigned_short_const
{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num3 == (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_fkx7qf*)@this)->values))[num].input, expected: false))
				{
					...
					case 2048:
					{
						int num7 = (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_fkx7qf*)@this)->values))[num].rnd_upward_offset;
						num2 = (short)checked(unchecked((ushort)num2) + num7);
						break;
					}
					case 1024:
					{
						int num6 = (ushort)((fputil_ExceptValues_Float16_21_Mapping*)(&((fputil_ExceptValues_fkx7qf*)@this)->values))[num].rnd_downward_offset;
