	...
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X, [MangledName("y")][NativeType("float")] float Y)
	{
		...
		unchecked
		{
			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			result = ((!FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan.Invoke(&fputil_FPBits_5nkvcs)) ? ((!FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan.Invoke(&fputil_FPBits_5nkvcs2)) ? Internal_max_float.Invoke(X, Y) : X) : Y);
			goto IL_0143;
		}
		IL_0143:
