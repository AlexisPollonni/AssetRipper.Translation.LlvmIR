	...
	public unsafe static Struct_8myw6y Invoke([MangledName("this")] Llvm_libc_20_1_2_printf_core_Parser* This, [MangledName("index")][NativeType("unsigned long")] long Index)
	{
		...
		if (Index != 0L && Index != This->Args_index)
		{
			...
			if ((b & 1) != 1)
			{
				...
				Optional_long_Constructor.Invoke(&llvm_libc_20_1_2_cpp_optional_d6hvji);
				num2 = 1;
			}
			else
			{
		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_printf_core_TypeDesc) = Printf_core_type_desc_from_type_long.Invoke();
			...
			Optional_long_Constructor.Invoke(&llvm_libc_20_1_2_cpp_optional_d6hvji, &num);
