...
internal static partial class DyadicFloat_256ul_fast_as_Float16_true_void
{
	...
	public unsafe static Half Invoke([MangledName("this")] Fputil_DyadicFloat_jhcpjj* This)
	{
			...
			unchecked
			{
				...
				else
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(Biased_exp: (short)num3, Mantissa: (short)(((ushort)BigInt_256ul_false_unsigned_long_Unsigned_short_unsigned_short.Invoke(&bigInt_x9dsed) & 0x3FF) | 0), Sign: anon_izyfb3.Val);
					...
					*(long*)ptr3 = -6148914691236517206L;
					...
					bool num12 = InstructionHelper.BooleanXor(BigInt_256ul_false_unsigned_long_is_zero.Invoke(&bigInt_x9dsed6), right: true);
					...
					bool num13 = InstructionHelper.BooleanXor(BigInt_256ul_false_unsigned_long_is_zero.Invoke(&bigInt_x9dsed7), right: true);
