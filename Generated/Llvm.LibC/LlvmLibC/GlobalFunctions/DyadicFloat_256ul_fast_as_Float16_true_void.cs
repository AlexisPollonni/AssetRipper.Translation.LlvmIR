			...
			unchecked
			{
				...
				else
				{
					...
					*(long*)ptr3 = -6148914691236517206L;
					...
					int num12 = (BigInt_256ul_false_unsigned_long_is_zero.Invoke(&llvm_libc_20_1_2_BigInt_x9dsed6) ? 1 : 0) ^ -1;
					...
					int num13 = (BigInt_256ul_false_unsigned_long_is_zero.Invoke(&llvm_libc_20_1_2_BigInt_x9dsed7) ? 1 : 0) ^ -1;
