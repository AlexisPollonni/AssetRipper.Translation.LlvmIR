...
internal static partial class long_fputil_internal_rounded_float_to_signed_integer_float128_long_0_float128
{
	public unsafe static long Invoke(double x)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			{
				long_fputil_internal_rounded_float_to_signed_integer_float128_long_0_float128_lambda_operator_const.Invoke(&anon_izyfb8);
