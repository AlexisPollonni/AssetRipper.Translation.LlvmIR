...
internal static partial class DyadicFloat_64ul_fast_as_Float16_true_void
{
	...
	public unsafe static Half Invoke([MangledName("this")] Fputil_DyadicFloat_syracv* This)
	{
			...
			unchecked
			{
				...
				else
				{
					...
					*(long*)(&bigInt_555ggs) = -6148914691236517206L;
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(Biased_exp: (short)num3, Mantissa: (short)(((ushort)BigInt_64ul_false_unsigned_long_Unsigned_short_unsigned_short.Invoke(&bigInt_555ggs) & 0x3FF) | 0), Sign: anon_izyfb3.Val);
					...
					*(long*)(&bigInt_555ggs6.Val.Data) = data4;
					bool num12 = InstructionHelper.BooleanXor(BigInt_64ul_false_unsigned_long_is_zero.Invoke(&bigInt_555ggs6), right: true);
					...
					*(long*)(&bigInt_555ggs7.Val.Data) = data5;
					bool num13 = InstructionHelper.BooleanXor(BigInt_64ul_false_unsigned_long_is_zero.Invoke(&bigInt_555ggs7), right: true);
