...
internal static partial class builtin_Memcpy_64ul_head_tail_cpp_byte_cpp_byte_const_unsigned_long
{
	public unsafe static void Invoke(void* dst, void* src, long count)
	{
		builtin_Memcpy_64ul_block_cpp_byte_cpp_byte_const.Invoke(dst, src);
		builtin_Memcpy_64ul_tail_cpp_byte_cpp_byte_const_unsigned_long.Invoke(dst, src, count);
	}
}
