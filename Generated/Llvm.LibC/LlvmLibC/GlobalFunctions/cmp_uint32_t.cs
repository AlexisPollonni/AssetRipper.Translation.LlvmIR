...
internal static partial class cmp_uint32_t
{
	...
	public unsafe static int Invoke([NativeType("unsigned int")] int a, [NativeType("unsigned int")] int b)
	{
		...
		StrictIntegralType_int_StrictIntegralType_int_false.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2, unchecked((int)((num >> 1) | (num & 0xFFFFL))));
