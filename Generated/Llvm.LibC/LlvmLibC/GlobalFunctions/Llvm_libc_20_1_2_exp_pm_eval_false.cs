...
internal static partial class Llvm_libc_20_1_2_exp_pm_eval_false
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("float")] float X)
	{
		...
		x2 = unchecked((long*)Llvm_libc_20_1_2_ExpBase_EXP_2_MID.Pointer)[num13] + num4;
		Llvm_lifetime_start_p0.Invoke(8L, &x3);
		long num14 = num3 & 0x1F;
		x3 = unchecked((long*)Llvm_libc_20_1_2_ExpBase_EXP_2_MID.Pointer)[num14] + num5;
		Llvm_lifetime_start_p0.Invoke(8L, &num6);
		Llvm_lifetime_start_p0.Invoke(8L, &llvm_libc_20_1_2_fputil_FPBits_wjhbrm);
		FPBits_double_FPBits_unsigned_long.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm, x2);
		double num15 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm);
		Llvm_lifetime_end_p0.Invoke(8L, &llvm_libc_20_1_2_fputil_FPBits_wjhbrm);
		num6 = num15;
		Llvm_lifetime_start_p0.Invoke(8L, &num7);
		Llvm_lifetime_start_p0.Invoke(8L, &llvm_libc_20_1_2_fputil_FPBits_wjhbrm2);
		FPBits_double_FPBits_unsigned_long.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm2, x3);
		double num16 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm2);
		...
		unchecked
		{
			num11 = Fputil_polyeval_double_double_double.Invoke(x4, 0.5, *(double*)Llvm_libc_20_1_2_ExpBase_COEFFS.Pointer * 0.5, ((double*)Llvm_libc_20_1_2_ExpBase_COEFFS.Pointer)[2L] * 0.5);
			Llvm_lifetime_start_p0.Invoke(8L, &y);
			y = Fputil_polyeval_double_double_double.Invoke(x4, 0.5, ((double*)Llvm_libc_20_1_2_ExpBase_COEFFS.Pointer)[1] * 0.5, ((double*)Llvm_libc_20_1_2_ExpBase_COEFFS.Pointer)[3L] * 0.5);
			Llvm_lifetime_start_p0.Invoke(8L, &num12);
			num12 = double.NaN;
			num12 = Fputil_multiply_add_double.Invoke(num10 * num9, y, num11 * num8);
			double result = num12;
