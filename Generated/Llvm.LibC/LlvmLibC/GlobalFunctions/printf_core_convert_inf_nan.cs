		...
		unchecked
		{
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
				...
				x = (Int128)(UInt128)(ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
			...
			if (NumericHelper.IntCmpEq(x, 0L))
			{
				...
				void* ptr = writer;
				string_view_Constructor.Invoke(&cpp_string_view2, (!internal_islower_qy8nhx.Invoke(to_conv->conv_name)) ? str_1_166.Pointer : str_165.Pointer);
				num4 = Writer_write.Invoke((printf_core_Writer*)ptr, *(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]);
				int num9;
				if (num4 < 0)
				{
					result = num4;
			...
			else
			{
				...
				void* ptr2 = writer;
				string_view_Constructor.Invoke(&cpp_string_view3, (!internal_islower_qy8nhx.Invoke(to_conv->conv_name)) ? str_3_168.Pointer : str_2_167.Pointer);
				num5 = Writer_write.Invoke((printf_core_Writer*)ptr2, *(void**)(&cpp_string_view3), ((long*)(&cpp_string_view3))[1]);
				int num9;
				if (num5 < 0)
				{
					result = num5;
