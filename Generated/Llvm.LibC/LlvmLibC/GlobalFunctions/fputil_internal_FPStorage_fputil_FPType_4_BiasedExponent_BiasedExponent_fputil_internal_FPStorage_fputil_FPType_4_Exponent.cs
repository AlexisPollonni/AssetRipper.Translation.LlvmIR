...
internal static partial class fputil_internal_FPStorage_fputil_FPType_4_BiasedExponent_BiasedExponent_fputil_internal_FPStorage_fputil_FPType_4_Exponent
{
	public unsafe static void Invoke(void* @this, [MangledName("exp.coerce")] int exp)
	{
		...
		fputil_internal_FPStorage_fputil_FPType_4_TypedInt_unsigned_int_TypedInt_unsigned_int.Invoke(@this, fputil_internal_FPStorage_fputil_FPType_4_TypedInt_int_operator_int_const.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2) + 16383);
	}
}
