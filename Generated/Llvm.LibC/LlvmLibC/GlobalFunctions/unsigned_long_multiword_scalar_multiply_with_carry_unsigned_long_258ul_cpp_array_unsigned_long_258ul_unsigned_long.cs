		...
		unchecked
		{
			...
			*(long*)ptr5 = -6148914691236517206L;
			...
			for (ptr3 = cpp_array_unsigned_long_258ul_end.Invoke((cpp_array_vnnqx8*)ptr); ptr2 != ptr3; ptr2 = (byte*)ptr2 + 8)
			{
				...
				carry_in = unsigned_long_multiword_mul_add_with_carry_unsigned_long_2ul_cpp_array_unsigned_long_2ul_unsigned_long_unsigned_long.Invoke((cpp_array_i3937k*)(&bigInt_qdkjbh), *(long*)ptr4, x);
