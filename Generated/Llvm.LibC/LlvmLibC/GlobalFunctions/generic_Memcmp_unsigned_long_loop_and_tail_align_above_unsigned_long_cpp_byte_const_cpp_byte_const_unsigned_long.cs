...
internal static partial class generic_Memcmp_unsigned_long_loop_and_tail_align_above_unsigned_long_cpp_byte_const_cpp_byte_const_unsigned_long
{
			...
			*(long*)(&fputil_internal_FPStorage_v3nexn2) = -6148914691236517206L;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ulong)num >= (ulong)threshold, expected: false) && AlignHelper_8ul_not_aligned_const.Invoke(&fputil_internal_FPStorage_v3nexn2))
			{
				*(int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2) = -1431655766;
				fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2.field_0 = generic_Memcmp_unsigned_long_block_cpp_byte_const_cpp_byte_const.Invoke(ptr, p3);
			...
			fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2.field_0 = generic_Memcmp_unsigned_long_loop_and_tail_cpp_byte_const_cpp_byte_const_unsigned_long.Invoke(ptr, p3, num);
			goto IL_00bd;
		}
		IL_00bd:
