...
internal static partial class cpp_enable_if_sizeof_float_8ul_float_type_fputil_polyeval_float_float_float
{
	public static float Invoke(float parameter_0, float a0)
	{
		return a0;
	}
}
