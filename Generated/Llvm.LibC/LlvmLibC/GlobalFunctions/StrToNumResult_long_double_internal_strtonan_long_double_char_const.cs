	...
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_6sg7zz* agg_result, void* arg)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			for (num = 0L; (!internal_isalnum_int_22.Invoke(((sbyte*)arg)[num])) ? (((sbyte*)arg)[num] == 95) : true; num = checked(num + 1L))
			{
			}
			if (((sbyte*)arg)[num] == 0)
			{
			...
			StrToNumResult_long_double_StrToNumResult_long_double_long_int.Invoke(agg_result, fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi3), 0L, error);
