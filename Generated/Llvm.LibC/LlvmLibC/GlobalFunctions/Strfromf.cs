...
internal static partial class Strfromf
{
	...
	public unsafe static int Invoke([MangledName("s")] void* S, [MangledName("n")] long N, [MangledName("format")] void* Format, [MangledName("fp")] float Fp)
	{
		...
		Internal_parse_format_string_float.Invoke(&printf_core_FormatSection, Format, Fp);
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			{
				num = Internal_strfromfloat_convert_float.Invoke(&printf_core_Writer, &printf_core_FormatSection);
			}
			else
			{
