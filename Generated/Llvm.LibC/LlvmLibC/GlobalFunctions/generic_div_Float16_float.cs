	...
	public unsafe static Half Invoke([NativeType("float")] float x, [NativeType("float")] float y)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			else if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&fputil_FPBits_5nkvcs3))
			{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			DyadicFloat_32ul_DyadicFloat_float_0.Invoke(&fputil_DyadicFloat_cs3nhs2, x);
			...
			*ptr2 = -86;
			...
			DyadicFloat_32ul_DyadicFloat_float_0.Invoke(&fputil_DyadicFloat_cs3nhs3, y);
			...
			int data = BigInt_32ul_false_unsigned_int_RightShift.Invoke(&fputil_DyadicFloat_cs3nhs2.mantissa, 2L);
			*(int*)(&bigInt_vtm4cw.val.Data) = data;
			...
			int data2 = BigInt_32ul_false_unsigned_int_RightShift.Invoke(&fputil_DyadicFloat_cs3nhs3.mantissa, 1L);
			...
			*ptr3 = -86;
			...
			DyadicFloat_32ul_Constructor.Invoke(&fputil_DyadicFloat_cs3nhs4, anon_izyfb20.val, e, *(int*)(&bigInt_vtm4cw3.val.Data));
			...
			int data3 = Operator_qdjidv.Invoke(&fputil_DyadicFloat_cs3nhs4.mantissa, &bigInt_vtm4cw4);
			*(int*)(&bigInt_vtm4cw5.val.Data) = data3;
			llvm_lifetime_end_p0.Invoke(4L, &bigInt_vtm4cw4);
			result = DyadicFloat_32ul_as_Float16_true_void.Invoke(&fputil_DyadicFloat_cs3nhs4);
