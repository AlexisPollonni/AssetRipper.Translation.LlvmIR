...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_double_sizeof_Float16_sizeof_double_Float16_type_fputil_generic_div_Float16_double_double_double
{
	public unsafe static Half Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_zero_const.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3)))
			{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			fputil_DyadicFloat_64ul_DyadicFloat_double_0_double.Invoke(&fputil_DyadicFloat_syracv2, x);
			...
			*ptr2 = -86;
			...
			fputil_DyadicFloat_64ul_DyadicFloat_double_0_double.Invoke(&fputil_DyadicFloat_syracv3, y);
			...
			long data = BigInt_64ul_false_unsigned_long_operator_unsigned_long_const_5vdftb.Invoke(&fputil_DyadicFloat_syracv2.mantissa, 2L);
			*(long*)(&bigInt_555ggs.val.Data) = data;
			long num8 = BigInt_64ul_false_unsigned_long_operator_unsigned_long_unsigned_long_const.Invoke(&bigInt_555ggs);
			llvm_lifetime_end_p0.Invoke(8L, &bigInt_555ggs);
			num6 = num8;
			llvm_lifetime_start_p0.Invoke(8L, &num7);
			llvm_lifetime_start_p0.Invoke(8L, &bigInt_555ggs2);
			long data2 = BigInt_64ul_false_unsigned_long_operator_unsigned_long_const_5vdftb.Invoke(&fputil_DyadicFloat_syracv3.mantissa, 1L);
			*(long*)(&bigInt_555ggs2.val.Data) = data2;
			long num9 = BigInt_64ul_false_unsigned_long_operator_unsigned_long_unsigned_long_const.Invoke(&bigInt_555ggs2);
			...
			*ptr3 = -86;
			...
			int e = num4;
			BigInt_64ul_false_unsigned_long_BigInt_unsigned_long_void_unsigned_long.Invoke(&bigInt_555ggs3, num5);
			fputil_DyadicFloat_64ul_DyadicFloat_Sign_int_BigInt_64ul_false_unsigned_long.Invoke(&fputil_DyadicFloat_syracv4, anon_izyfb20.val, e, *(long*)(&bigInt_555ggs3.val.Data));
			llvm_lifetime_start_p0.Invoke(8L, &bigInt_555ggs4);
			BigInt_64ul_false_unsigned_long_BigInt_unsigned_int_void_unsigned_int.Invoke(&bigInt_555ggs4, (num6 != 0L) ? 1 : 0);
			long data3 = operator_BigInt_64ul_false_unsigned_long_BigInt_64ul_false_unsigned_long_const.Invoke(&fputil_DyadicFloat_syracv4.mantissa, &bigInt_555ggs4);
			*(long*)(&bigInt_555ggs5.val.Data) = data3;
			llvm_lifetime_end_p0.Invoke(8L, &bigInt_555ggs4);
			result = Float16_fputil_DyadicFloat_64ul_as_Float16_true_void_const.Invoke(&fputil_DyadicFloat_syracv4);
