	...
	public unsafe static double Invoke([MangledName("from")][NativeType("__float128")] double From, [MangledName("to")][NativeType("__float128")] double To)
	{
		...
		unchecked
		{
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, From);
			double result;
			...
			else
			{
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, To);
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
				{
				...
				else
				{
					if (NumericHelper.IsUnorderedOrNotEquals(From, 0.0))
					{
						if (Fputil_cast_float128_float128.Invoke(From) < To == From > 0.0)
						{
							...
							Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
							Int128* num = &x;
							...
							*(long*)num2 = struct_fiz2nb3.field_1;
							...
							FPBits_float128_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3, *(long*)(&@int), ((long*)(&@int))[1]);
						...
						else
						{
							...
							*(long*)num4 = struct_fiz2nb6.field_1;
							...
							FPBits_float128_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4, *(long*)(&int2), ((long*)(&int2))[1]);
					...
					else
					{
						...
						Int128* ptr = &llvm_libc_20_1_2_fputil_FPBits_ubgsi5.Val.Data.FPStorage.field_0;
