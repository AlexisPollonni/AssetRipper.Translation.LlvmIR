...
internal static partial class cpp_optional_unsigned_int_printf_core_Parser_internal_ArgList_get_arg_value_unsigned_int_unsigned_long
{
	public unsafe static long Invoke(printf_core_Parser* @this, long index)
	{
		...
		if (index != 0L && index != @this->args_index)
		{
			...
			if ((b & 1) != 1)
			{
				...
				cpp_optional_unsigned_int_optional.Invoke(&cpp_optional_g66fk5);
				num2 = 1;
			}
			else
			{
		...
		unchecked
		{
			*(short*)(&printf_core_TypeDesc2) = printf_core_TypeDesc_printf_core_type_desc_from_type_unsigned_int.Invoke();
			...
			num = unsigned_int_printf_core_Parser_internal_ArgList_get_next_arg_value_unsigned_int.Invoke(@this);
			cpp_optional_unsigned_int_optional_unsigned_int.Invoke(&cpp_optional_g66fk5, &num);
