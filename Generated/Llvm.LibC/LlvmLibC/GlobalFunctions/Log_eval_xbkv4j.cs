...
internal static partial class Log_eval_xbkv4j
{
	[MangledName("_ZN19__llvm_libc_20_1_2_L8log_evalEd.63")]
	[DemangledName("__llvm_libc_20_1_2_::log_eval(double) (.63)")]
	[CleanName("Log_eval")]
	public unsafe static double Invoke([MangledName("x")][NativeType("double")] double X)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm) = -6148914691236517206L;
			...
			num2 = (int)(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm)) >>> 45);
			FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm), FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm)) & 0x1FFFFFFFFFFFL);
			...
			double num6 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm) - 1.0;
			long num7 = num2;
			...
			*(double*)(&inlineArray6_Double) = -0.4999999999999998;
			...
			double x2 = num;
			long num8 = num2;
			num5 = Fputil_multiply_add_double.Invoke(x2, 0.6931471805599453, ((double*)LOG_F.Pointer)[num8] + num4);
			double result = num5;
