	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, [NativeType("double")] double x, [NativeType("double")] double kd, [NativeType("int")] int idx1, [NativeType("int")] int idx2)
	{
		...
		unchecked
		{
			...
			*(long*)ptr10 = -6148914691236517206L;
			...
			Struct_fiz2nb struct_fiz2nb = u128.Invoke(str.Pointer);
			Int128* num2 = &@int;
			...
			*(long*)num3 = struct_fiz2nb3.field_1;
			...
			DyadicFloat_128ul_Constructor.Invoke(&fputil_DyadicFloat_kt2kd21, anon_izyfb8.val, e, *(long*)(&bigInt_qdkjbh), ((long*)(&bigInt_qdkjbh))[1]);
			...
			*(long*)ptr14 = -6148914691236517206L;
			...
			anonymous_namespace_poly_approx_f128_8qzdhw.Invoke(&fputil_DyadicFloat_kt2kd25, &fputil_DyadicFloat_kt2kd5);
			*(sbyte*)agg_result = -86;
			...
			*(long*)ptr16 = -6148914691236517206L;
			...
			fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd26, &fputil_DyadicFloat_kt2kd20, &fputil_DyadicFloat_kt2kd5);
			fputil_multiply_add_128ul.Invoke(agg_result, &fputil_DyadicFloat_kt2kd26, &fputil_DyadicFloat_kt2kd25, &fputil_DyadicFloat_kt2kd22);
