		...
		unchecked
		{
			...
			*(Int128*)((byte*)(&floatToString_rwjwy) + 16) = -6148914691236517206L;
			...
			if (NumericHelper.IntCmpNe(x, 0L))
			{
				...
				*(long*)num33 = struct_kqhe8i6.field_1;
				...
				if ((uint)num19 == num15)
				{
					...
					num21 = FloatToString_double_0_get_block.Invoke(&floatToString_rwjwy, num6);
				...
				if ((b & 1) != 1)
				{
					checked
					{
						if (num6 >= 0)
						{
							...
							for (k = num6 - 1; k >= 0; k += -1)
							{
								...
								num23 = FloatToString_double_0_get_block.Invoke(&floatToString_rwjwy, k);
								int num34;
								if (num23 != 0)
								{
									b = 1;
					...
					{
						b = (sbyte)(byte)((printf_core_zero_after_digits_unsigned_long.Invoke(checked(num2 - 52), num5 - num4, FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)), 52) ? 1 : 0) ^ -1);
					}
				}
				...
				if (num3 > num4 && num4 >= -4)
				{
					...
					result = printf_core_convert_float_decimal_typed_double_0.Invoke(writer, &printf_core_FormatSection3, fputil_FPBits_wjhbrm4.FPRepImpl.FPRepSem.FPStorage.val);
				...
				else
				{
					...
					result = printf_core_convert_float_dec_exp_typed_double_0.Invoke(writer, &printf_core_FormatSection4, fputil_FPBits_wjhbrm5.FPRepImpl.FPRepSem.FPStorage.val);
			...
			else
			{
				...
				result = printf_core_convert_float_decimal_typed_double_0.Invoke(writer, &printf_core_FormatSection2, fputil_FPBits_wjhbrm3.FPRepImpl.FPRepSem.FPStorage.val);
