			...
			unchecked
			{
				...
				else
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					long val3 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value.Invoke(biased_exp: num3, mantissa: (BigInt_256ul_false_unsigned_long_unsigned_long_unsigned_long.Invoke(&bigInt_x9dsed) & 0xFFFFFFFFFFFFFL) | 0L, sign: anon_izyfb10.val);
