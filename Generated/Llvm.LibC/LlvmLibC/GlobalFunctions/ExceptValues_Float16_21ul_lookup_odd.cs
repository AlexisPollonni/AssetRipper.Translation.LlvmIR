...
internal static partial class ExceptValues_Float16_21ul_lookup_odd
{
	...
	public unsafe static int Invoke([MangledName("this")] Fputil_ExceptValues_qu7rez* This, [MangledName("x_abs")][NativeType("unsigned short")] short X_abs, [MangledName("sign")][NativeType("bool")] bool Sign)
	{
			...
			while (true)
			{
				...
				if (Details_expects_bool_condition_bool.Invoke((ushort)num3 == (ushort)((Fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Input, Expected: false))
				{
					...
					case 2048:
						if ((b & 1) == 1)
						{
							int num8 = (ushort)((Fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Rnd_downward_offset;
							num2 = (short)checked(unchecked((ushort)num2) + num8);
						}
						else
						{
							int num9 = (ushort)((Fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Rnd_upward_offset;
					...
					case 1024:
						if ((b & 1) == 1)
						{
							int num6 = (ushort)((Fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Rnd_upward_offset;
							num2 = (short)checked(unchecked((ushort)num2) + num6);
						}
						else
						{
							int num7 = (ushort)((Fputil_ExceptValues_Float16_21_Mapping*)(&This->Values))[num].Rnd_downward_offset;
