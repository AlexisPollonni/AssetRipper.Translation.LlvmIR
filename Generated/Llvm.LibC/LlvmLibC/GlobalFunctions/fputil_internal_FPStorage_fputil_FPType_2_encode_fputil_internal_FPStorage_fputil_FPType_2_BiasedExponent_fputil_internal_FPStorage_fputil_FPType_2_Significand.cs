...
internal static partial class fputil_internal_FPStorage_fputil_FPType_2_encode_fputil_internal_FPStorage_fputil_FPType_2_BiasedExponent_fputil_internal_FPStorage_fputil_FPType_2_Significand
{
	public unsafe static long Invoke([MangledName("exp.coerce")] int exp, [MangledName("sig.coerce")] long sig)
	{
		...
		long num = fputil_internal_FPStorage_fputil_FPType_2_encode_fputil_internal_FPStorage_fputil_FPType_2_BiasedExponent.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3.field_0.field_0);
		llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepSem_fq8nhg3, &fputil_internal_FPRepSem_fq8nhg2, 8L, isVolatile: false);
		return num | fputil_internal_FPStorage_fputil_FPType_2_encode_fputil_internal_FPStorage_fputil_FPType_2_Significand.Invoke(fputil_internal_FPRepSem_fq8nhg3.FPStorage.val);
	}
}
