		...
		unchecked
		{
			...
			*(long*)num30 = struct_fiz2nb3.field_1;
			...
			if (NumericHelper.IntCmpNe(x, 0L))
			{
				...
				*(long*)num35 = struct_kqhe8i6.field_1;
				...
				if (num3 > num4 && num4 >= -4)
				{
					...
					result = printf_core_convert_float_decimal_typed_long_double_0.Invoke(writer, &printf_core_FormatSection3, *(long*)(&fputil_FPBits_ubgsi5), ((long*)(&fputil_FPBits_ubgsi5))[1]);
				...
				else
				{
					...
					result = printf_core_convert_float_dec_exp_typed_long_double_0.Invoke(writer, &printf_core_FormatSection4, *(long*)(&fputil_FPBits_ubgsi6), ((long*)(&fputil_FPBits_ubgsi6))[1]);
			...
			else
			{
				...
				result = printf_core_convert_float_decimal_typed_long_double_0.Invoke(writer, &printf_core_FormatSection2, *(long*)(&fputil_FPBits_ubgsi4), ((long*)(&fputil_FPBits_ubgsi4))[1]);
