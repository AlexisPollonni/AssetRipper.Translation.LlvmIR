...
internal static partial class Cpp_bit_cast_int_int
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (int) == sizeof (int) && cpp::is_trivially_constructible<int>::value && cpp::is_trivially_copyable<int>::value && cpp::is_trivially_copyable<int>::value, int>::type")]
