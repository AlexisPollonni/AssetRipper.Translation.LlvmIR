	...
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else if (fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos_const.Invoke(&fputil_FPBits_2fahva2) && (uint)(ushort)num2 >= 18828u)
			{
			...
			{
				if ((uint)(ushort)num2 > 12288u || fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero_const.Invoke(&fputil_FPBits_2fahva2))
				{
					goto IL_05a1;
				}
