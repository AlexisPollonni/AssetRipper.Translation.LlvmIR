	...
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			if (!bool_details_expects_bool_condition_bool_bool_bool.Invoke(((uint)(ushort)num2 > 12288u) ? ((uint)(ushort)num2 >= 18336u) : true, expected: false))
			{
				goto IL_05a1;
			}
			...
			else if (fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) && (uint)(ushort)num2 >= 18828u)
			{
			...
			else if ((uint)(ushort)num >= 51104u)
			{
				...
				else if ((uint)(ushort)num > 51240u)
				{
					...
					result = Float16_fputil_round_result_slightly_up_Float16_Float16.Invoke(fputil_FPBits_Float16_get_val_const.Invoke(&fputil_FPBits_2fahva8));
			...
			{
				if ((uint)(ushort)num2 > 12288u || fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero_const.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2)))
				{
					goto IL_05a1;
				}
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = fputil_ExceptValues_Float16_1ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: EXPM1F16_EXCEPTS_LO.Pointer);
