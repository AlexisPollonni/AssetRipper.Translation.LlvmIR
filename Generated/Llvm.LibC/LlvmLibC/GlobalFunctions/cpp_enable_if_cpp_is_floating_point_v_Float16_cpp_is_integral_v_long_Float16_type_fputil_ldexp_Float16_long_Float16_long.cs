...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_integral_v_long_Float16_type_fputil_ldexp_Float16_long_Float16_long
{
	public unsafe static Half Invoke(Half x, long exp)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			num = 42;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(exp > 42L, expected: false))
			{
