...
internal static partial class unsigned_long_internal_partition_hoare_branchy_internal_ArrayGenericSize_void_internal_quick_sort_impl_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_void_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const_lambda_void_const_void_const_internal_ArrayGenericSize_const_void_const_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const
{
	public unsafe static long Invoke(void* array, void* pivot, void* is_less)
	{
		...
		unchecked
		{
			while (true)
			{
				if ((ulong)num2 < (ulong)num3 && void_internal_quick_sort_impl_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_void_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const_lambda_void_const_void_const_operator_void_const_void_const_const.Invoke(is_less, internal_ArrayGenericSize_get_unsigned_long_const.Invoke(array, num2), pivot))
				{
					num2++;
					continue;
				}
				...
				while ((ulong)num2 < (ulong)num3 && !void_internal_quick_sort_impl_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayGenericSize_void_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const_lambda_void_const_void_const_operator_void_const_void_const_const.Invoke(is_less, internal_ArrayGenericSize_get_unsigned_long_const.Invoke(array, num3), pivot));
