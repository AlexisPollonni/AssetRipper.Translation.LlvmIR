...
internal static partial class long_long_fputil_round_to_signed_integer_float_long_long_0_float
{
	public static long Invoke(float x)
	{
		return long_long_fputil_internal_rounded_float_to_signed_integer_float_long_long_0_float.Invoke(float_fputil_round_float_0_float.Invoke(x));
	}
}
