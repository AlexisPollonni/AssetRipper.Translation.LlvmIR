...
{
	public unsafe static Struct_fiz2nb Invoke(anon_izyfb7* lhs, anon_izyfb7* rhs)
	{
		...
		unchecked
		{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			for (num = 0L; (ulong)num < 2uL; num++)
			{
				...
				*(long*)BigInt_128ul_false_unsigned_long_operator_unsigned_long_3b99zc.Invoke((anon_izyfb7*)(&bigInt_qdkjbh), num) = num2;
			}
