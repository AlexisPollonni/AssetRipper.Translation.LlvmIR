...
internal static partial class FPRepImpl_fputil_FPType_2_fputil_FPBits_double_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq* This, [MangledName("x")][NativeType("unsigned long")] long X)
	{
		FPRepSem_fputil_FPType_2_fputil_FPBits_double_Constructor.Invoke(unchecked((Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg*)This), X);
	}
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq* This)
	{
		FPRepSem_fputil_FPType_2_fputil_FPBits_double_Constructor.Invoke(unchecked((Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg*)This));
	}
}
