...
internal static partial class BigInt_64ul_false_unsigned_long_BigInt_int_void
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_555ggs* This, [MangledName("v")][NativeType("int")] int V)
	{
		long num = 0L;
		sbyte b = 0;
		long num2 = 0L;
