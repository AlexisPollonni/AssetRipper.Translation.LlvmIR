			...
			unchecked
			{
				...
				else
				{
					...
					*(long*)(&bigInt_555ggs) = -6148914691236517206L;
					...
					long val3 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value.Invoke(Biased_exp: num3, Mantissa: (BigInt_64ul_false_unsigned_long_Unsigned_long_unsigned_long.Invoke(&bigInt_555ggs) & 0xFFFFFFFFFFFFFL) | 0L, Sign: anon_izyfb3.Val);
