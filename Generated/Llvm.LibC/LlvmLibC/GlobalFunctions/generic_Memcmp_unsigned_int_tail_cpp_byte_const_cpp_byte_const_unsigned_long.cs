...
internal static partial class generic_Memcmp_unsigned_int_tail_cpp_byte_const_cpp_byte_const_unsigned_long
{
	public unsafe static int Invoke(void* p1, void* p2, long count)
	{
		...
		{
			field_0 = generic_Memcmp_unsigned_int_block_offset_cpp_byte_const_cpp_byte_const_unsigned_long.Invoke(p1, p2, unchecked(count - 4L))
		};
