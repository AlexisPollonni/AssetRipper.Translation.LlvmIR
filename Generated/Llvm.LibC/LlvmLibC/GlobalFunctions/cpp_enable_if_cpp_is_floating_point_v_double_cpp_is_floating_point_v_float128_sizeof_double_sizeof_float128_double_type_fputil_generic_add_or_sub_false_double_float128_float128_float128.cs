...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_sizeof_double_sizeof_float128_double_type_fputil_generic_add_or_sub_false_double_float128_float128_float128
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				...
				else
				{
					...
					x2 = y;
					result = cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_double_type_fputil_cast_double_float128_float128.Invoke(x2);
			...
			else
			{
				...
				x3 = y;
				result = cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_double_type_fputil_cast_double_float128_float128.Invoke(x3);
