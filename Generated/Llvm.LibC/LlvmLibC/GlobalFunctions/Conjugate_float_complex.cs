...
internal static partial class Conjugate_float_complex
{
	...
	public unsafe static InlineArray2_Single Invoke([MangledName("c.coerce")][NativeType("float complex")] InlineArray2_Single C)
	{
		...
		unchecked
		{
			...
			*(InlineArray2_Single*)(&struct_kh2xpj3) = Cpp_bit_cast_float_complex_Complex_float.Invoke(&expRangeReduction);
