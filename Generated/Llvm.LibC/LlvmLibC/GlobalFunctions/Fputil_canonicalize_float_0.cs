	...
	public unsafe static int Invoke([MangledName("cx")][NativeType("float&")] void* Cx, [MangledName("x")][NativeType("float const&")] void* X)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			int result;
			if (Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_signaling_nan.Invoke(&fputil_FPBits_5nkvcs), Expected: false))
			{
				Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs2);
				anon_izyfb.Val = FPStorage_fputil_FPType_1_sign.Invoke(&fputil_FPBits_5nkvcs);
				int field_ = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(V: FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs), Sign: anon_izyfb.Val);
				fputil_FPBits_5nkvcs2.FPRepImpl.FPRepSem.field_0.field_0 = field_;
				*(float*)Cx = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
