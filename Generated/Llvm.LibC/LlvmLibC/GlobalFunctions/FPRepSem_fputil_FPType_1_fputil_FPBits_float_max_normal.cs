...
internal static partial class FPRepSem_fputil_FPType_1_fputil_FPBits_float_max_normal
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE1ENS0_6FPBitsIfEEE10max_normalENS_4SignE")]
	[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)1, __llvm_libc_20_1_2_::fputil::FPBits<float>>::max_normal(__llvm_libc_20_1_2_::Sign)")]
	public unsafe static int Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte Sign)
	{
		...
		int field_ = Exponent_max_jf5sk2.Invoke();
		...
		int field_2 = Significand_bits_all_ones_nwhr5u.Invoke();
