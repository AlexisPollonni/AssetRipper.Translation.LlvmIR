	...
	public unsafe static Struct_fiz2nb Invoke(void* src)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			{
				if (internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 1L)]) == ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_nan_string.Value)[1] && internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 2L)]) == ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_nan_string.Value)[2])
				{
					b = 1;
					num = checked(num + 3L);
			...
			else if (internal_tolower_int_120.Invoke(((sbyte*)src)[num]) == 105 && internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 1L)]) == ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[1] && internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 2L)]) == ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[2])
			{
				b = 1;
				...
				num = ((internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 3L)]) != ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[3] || internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 4L)]) != ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[4] || internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 5L)]) != ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[5] || internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 6L)]) != ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[6] || internal_tolower_int_120.Invoke(((sbyte*)src)[checked(num + 7L)]) != ((sbyte*)StrToNumResult_float_internal_strtofloatingpoint_float_char_const_inf_string.Value)[7]) ? checked(num + 3L) : checked(num + 8L));
			}
			if ((b & 1) != 1)
			{
				StrToNumResult_float_StrToNumResult_float_long_int.Invoke(&strToNumResult_cqc3yy, 0f, 0L, error);
			}
			else
			{
				void_internal_set_implicit_bit_float_fputil_FPBits_float.Invoke(&fputil_FPBits_5nkvcs2);
				StrToNumResult_float_StrToNumResult_float_long_int.Invoke(&strToNumResult_cqc3yy, fputil_FPBits_float_get_val_const.Invoke(&fputil_FPBits_5nkvcs2), num, error);
			}
