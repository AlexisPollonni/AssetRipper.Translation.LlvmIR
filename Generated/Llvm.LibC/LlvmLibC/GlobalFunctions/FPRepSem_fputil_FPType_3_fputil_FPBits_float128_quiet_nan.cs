...
internal static partial class FPRepSem_fputil_FPType_3_fputil_FPBits_float128_quiet_nan
{
	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte Sign, [MangledName("v.coerce0")][NativeType("__llvm_libc_20_1_2_::Sign")] long V, [MangledName("v.coerce1")][NativeType("unsigned __int128")] long V_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = V;
			...
			Int128 int4 = int3;
			Significand_Constructor_rhfmvq.Invoke(&fputil_internal_FPRepSem_f94eua3, *(long*)(&int4), ((long*)(&int4))[1]);
			Struct_fiz2nb struct_fiz2nb4 = Internal_BitwiseOr_s6pzhg.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1], *(long*)(&fputil_internal_FPRepSem_f94eua3), ((long*)(&fputil_internal_FPRepSem_f94eua3))[1]);
			Int128* ptr2 = &fputil_internal_FPRepSem_f94eua.FPStorage.field_0;
			Struct_fiz2nb struct_fiz2nb5 = struct_fiz2nb4;
			((Struct_fiz2nb*)ptr2)->field_0 = struct_fiz2nb5.field_0;
			Struct_fiz2nb struct_fiz2nb6 = struct_fiz2nb4;
			((Struct_fiz2nb*)ptr2)->field_1 = struct_fiz2nb6.field_1;
			Struct_fiz2nb struct_fiz2nb7 = FPStorage_fputil_FPType_3_encode.Invoke(anon_izyfb2.Val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua), ((long*)(&fputil_internal_FPRepSem_f94eua))[1]);
			Int128* num = &int2;
			...
			*(long*)num2 = struct_fiz2nb9.field_1;
			Int128 int5 = int2;
			FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int5), ((long*)(&int5))[1]);
