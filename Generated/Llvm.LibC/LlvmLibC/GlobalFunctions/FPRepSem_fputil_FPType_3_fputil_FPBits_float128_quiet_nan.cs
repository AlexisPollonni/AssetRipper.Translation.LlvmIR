	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte sign, [MangledName("v.coerce0")][NativeType("__llvm_libc_20_1_2_::Sign")] long v, [MangledName("v.coerce1")][NativeType("unsigned __int128")] long v_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = v;
			...
			Int128 int4 = int3;
			Significand_Constructor_rhfmvq.Invoke(&fputil_internal_FPRepSem_f94eua4, *(long*)(&int4), ((long*)(&int4))[1]);
			Struct_fiz2nb struct_fiz2nb4 = internal_BitwiseOr_s6pzhg.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua3), ((long*)(&fputil_internal_FPRepSem_f94eua3))[1], *(long*)(&fputil_internal_FPRepSem_f94eua4), ((long*)(&fputil_internal_FPRepSem_f94eua4))[1]);
			...
			Struct_fiz2nb struct_fiz2nb7 = FPStorage_fputil_FPType_3_encode.Invoke(anon_izyfb9.val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1]);
			Int128* num = &int2;
			...
			*(long*)num2 = struct_fiz2nb9.field_1;
			Int128 int5 = int2;
			FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int5), ((long*)(&int5))[1]);
