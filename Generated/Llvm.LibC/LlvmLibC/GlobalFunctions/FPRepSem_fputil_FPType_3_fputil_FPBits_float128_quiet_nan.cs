	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte Sign, [MangledName("v.coerce0")][NativeType("__llvm_libc_20_1_2_::Sign")] long V, [MangledName("v.coerce1")][NativeType("unsigned __int128")] long V_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = V;
			...
			Int128 int4 = int3;
			Significand_Constructor_rhfmvq.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua3, *(long*)(&int4), ((long*)(&int4))[1]);
			Struct_fiz2nb struct_fiz2nb4 = Internal_BitwiseOr_s6pzhg.Invoke(*(long*)(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua2), ((long*)(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua2))[1], *(long*)(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua3), ((long*)(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua3))[1]);
			...
			*(long*)num2 = struct_fiz2nb9.field_1;
			Int128 int5 = int2;
			FPBits_float128_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, *(long*)(&int5), ((long*)(&int5))[1]);
