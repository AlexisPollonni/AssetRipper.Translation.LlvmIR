	...
	public unsafe static Struct_yx4nca Invoke(printf_core_Parser* @this, [NativeType("unsigned long")] long index)
	{
		...
		if (index != 0L && index != @this->args_index)
		{
			...
			if ((b & 1) != 1)
			{
				...
				optional_char_Constructor_e46sab.Invoke(&cpp_optional_77yu8f2);
				num = 1;
			}
			else
			{
		...
		unchecked
		{
			*(short*)(&printf_core_TypeDesc2) = printf_core_type_desc_from_type_char.Invoke();
			...
			optional_char_Constructor_rumc48.Invoke(&cpp_optional_77yu8f2, &ptr);
