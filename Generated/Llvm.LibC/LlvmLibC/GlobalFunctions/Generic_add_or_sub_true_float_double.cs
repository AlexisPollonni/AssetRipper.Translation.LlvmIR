...
internal static partial class Generic_add_or_sub_true_float_double
{
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("y")][NativeType("double")] double Y)
	{
		...
		unchecked
		{
			...
			double num18 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm4);
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm5) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm5, *(double*)Cpp_max_double.Invoke(&num8, &num9));
				Llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm6);
				*(long*)(&fputil_FPBits_wjhbrm6) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm6, *(double*)Cpp_min_double.Invoke(&num8, &num9));
				...
				else
				{
					...
					num11 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm5)) << 3;
					Llvm_lifetime_start_p0.Invoke(8L, &num12);
					num12 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm6)) << 3;
					Llvm_lifetime_start_p0.Invoke(4L, &num13);
					checked
					{
						num13 = unchecked((ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm5))) - unchecked((ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm6)));
				...
				checked
				{
					num16 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_exponent.Invoke(unchecked((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm5))) - 55;
				...
				*ptr = -86;
				...
				result = DyadicFloat_64ul_as_float_true_void.Invoke(&fputil_DyadicFloat_syracv);
