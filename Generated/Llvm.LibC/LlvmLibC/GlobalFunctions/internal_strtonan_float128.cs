...
internal static partial class internal_strtonan_float128
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_c5b6ms* agg_result, [NativeType("char const*")] void* arg)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			for (num = 0L; (!internal_isalnum_r2dwwj.Invoke(((sbyte*)arg)[num])) ? (((sbyte*)arg)[num] == 95) : true; num = checked(num + 1L))
			{
			}
			if (((sbyte*)arg)[num] == 0)
			{
				string_view_Constructor.Invoke(&cpp_string_view2, arg, num);
				Struct_fiz2nb struct_fiz2nb = internal_nan_mantissa_from_ncharseq_float128.Invoke(*(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]);
				Int128* num2 = &int2;
			...
			StrToNumResult_float128_Constructor.Invoke(agg_result, FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi3), 0L, error);
