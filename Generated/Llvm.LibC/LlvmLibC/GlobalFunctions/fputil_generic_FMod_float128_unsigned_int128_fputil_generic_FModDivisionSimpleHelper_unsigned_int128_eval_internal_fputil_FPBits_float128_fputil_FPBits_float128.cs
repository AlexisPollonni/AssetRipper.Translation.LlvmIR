...
internal static partial class fputil_generic_FMod_float128_unsigned_int128_fputil_generic_FModDivisionSimpleHelper_unsigned_int128_eval_internal_fputil_FPBits_float128_fputil_FPBits_float128
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("sx.coerce0")] long sx, [MangledName("sx.coerce1")] long sy, [MangledName("sy.coerce0")] long e_x, [MangledName("sy.coerce1")] long e_y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_ubgsi5) = e_x;
			...
			Struct_fiz2nb struct_fiz2nb = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
			Int128* num10 = &@int;
			...
			*(long*)num11 = struct_fiz2nb3.field_1;
			Int128 x2 = @int;
			Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval_const.Invoke(&fputil_FPBits_ubgsi5);
			Int128* num12 = &y;
			...
			*(long*)num13 = struct_fiz2nb6.field_1;
			...
			{
				Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
				Int128* num14 = &int2;
				...
				*(long*)num15 = struct_fiz2nb9.field_1;
				Int128 x3 = int2;
				Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval_const.Invoke(&fputil_FPBits_ubgsi5);
				Int128* num16 = &y2;
				...
				*(long*)num17 = struct_fiz2nb12.field_1;
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb13 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_zero_Sign.Invoke(anon_izyfb8.val);
			...
			else
			{
				...
				num = (ushort)fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi4);
				llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi5);
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num2 > 112 && checked(num - num2) <= 15, expected: true))
				{
					...
					*(long*)num21 = struct_fiz2nb21.field_1;
					...
					if (NumericHelper.IntCmpEq(int5, 0L))
					{
						...
						Struct_fiz2nb struct_fiz2nb22 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_zero_Sign.Invoke(anon_izyfb9.val);
					...
					else
					{
						...
						int6 = int21;
						Struct_fiz2nb struct_fiz2nb25 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_make_value_unsigned_int128_int.Invoke(*(long*)(&int6), ((long*)(&int6))[1], result);
				...
				else if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num == 0 && num2 == 0, expected: false))
				{
					*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb28 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval_const.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num22 = &int7;
					...
					*(long*)num23 = struct_fiz2nb30.field_1;
					Int128 x4 = int7;
					Struct_fiz2nb struct_fiz2nb31 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval_const.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num24 = &y4;
					...
					*(long*)num25 = struct_fiz2nb33.field_1;
					...
					fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int8), ((long*)(&int8))[1]);
				}
				else
				{
					...
					*(long*)num29 = struct_fiz2nb39.field_1;
					...
					{
						Struct_fiz2nb struct_fiz2nb40 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi5);
						Int128* num30 = &int13;
					...
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(NumericHelper.IntCmpEq(int9, 0L), expected: false))
					{
						...
						Struct_fiz2nb struct_fiz2nb43 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_zero_Sign.Invoke(anon_izyfb10.val);
					...
					else if (num7 == 0)
					{
						...
						int result2 = num2;
						int16 = int22;
						Struct_fiz2nb struct_fiz2nb46 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_make_value_unsigned_int128_int.Invoke(*(long*)(&int16), ((long*)(&int16))[1], result2);
					...
					else
					{
						...
						*(long*)num33 = struct_fiz2nb51.field_1;
						...
						int result3 = num2;
						int20 = int25;
						Struct_fiz2nb struct_fiz2nb52 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_make_value_unsigned_int128_int.Invoke(*(long*)(&int20), ((long*)(&int20))[1], result3);
