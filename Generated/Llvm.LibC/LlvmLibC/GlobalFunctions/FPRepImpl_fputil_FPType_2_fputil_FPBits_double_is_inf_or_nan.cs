...
internal static partial class FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_inf_or_nan
{
	...
	public unsafe static bool Invoke([MangledName("this")] Fputil_internal_FPRepImpl_ucubaq* This)
	{
		return InstructionHelper.BooleanXor(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_finite.Invoke(unchecked((Fputil_internal_FPRepSem_fq8nhg*)This)), right: true);
	}
}
