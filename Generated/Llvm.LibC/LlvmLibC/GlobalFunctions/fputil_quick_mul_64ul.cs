...
internal static partial class fputil_quick_mul_64ul
{
	...
	public unsafe static Struct_fiz2nb Invoke([NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<64ul> const&")] fputil_DyadicFloat_syracv* a, [NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<64ul> const&")] fputil_DyadicFloat_syracv* b)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			DyadicFloat_64ul_Constructor.Invoke(&fputil_DyadicFloat_syracv2);
			...
			llvm_memcpy_p0_p0_i64.Invoke(source: (!NotEquals_rpctvi.Invoke(anon_izyfb8.val, anon_izyfb9.val)) ? Sign_POS.Pointer : Sign_NEG.Pointer, destination: &fputil_DyadicFloat_syracv2.sign, length: 1L, isVolatile: false);
			...
			if (!BigInt_64ul_false_unsigned_long_is_zero.Invoke(&a->mantissa) && !BigInt_64ul_false_unsigned_long_is_zero.Invoke(&b->mantissa))
			{
				...
				*(long*)(&bigInt_555ggs.val.Data) = data;
				...
				if (*(long*)array_unsigned_long_1ul_Index_3erz3i.Invoke(&fputil_DyadicFloat_syracv2.mantissa.val, 0L) >>> 63 == 0L)
				{
					DyadicFloat_64ul_shift_left.Invoke(&fputil_DyadicFloat_syracv2, 1);
				}
			}
			else
			{
