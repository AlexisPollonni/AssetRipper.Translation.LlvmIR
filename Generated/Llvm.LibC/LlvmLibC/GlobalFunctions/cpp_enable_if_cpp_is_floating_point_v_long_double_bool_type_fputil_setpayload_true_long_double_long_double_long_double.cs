...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_long_double_bool_type_fputil_setpayload_true_long_double_long_double_long_double
{
				...
				*(long*)num3 = struct_fiz2nb3.field_1;
				if (!NumericHelper.IntCmpNe(NumericHelper.BitwiseAnd(NumericHelper.ShiftLeft(x, (Int128)(UInt128)(uint)num), long.MaxValue), 0L))
				{
					...
					*(long*)num5 = struct_fiz2nb6.field_1;
					...
					int2 = int3;
					Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_signaling_nan_Sign_unsigned_int128.Invoke(val, *(long*)(&int2), ((long*)(&int2))[1]);
