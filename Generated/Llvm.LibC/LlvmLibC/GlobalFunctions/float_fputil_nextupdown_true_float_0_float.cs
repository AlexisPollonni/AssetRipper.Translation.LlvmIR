...
internal static partial class float_fputil_nextupdown_true_float_0_float
{
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			bool num = fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_nan_const.Invoke(&fputil_FPBits_5nkvcs2);
			...
			else
			{
				...
				int field_ = fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_max_normal_Sign.Invoke(anon_izyfb9.val);
				...
				if (fputil_internal_operator_fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float.Invoke(fputil_internal_FPRepImpl_vhj4tm2.FPRepSem.field_0.field_0, fputil_internal_FPRepImpl_vhj4tm3.FPRepSem.field_0.field_0))
				{
					num2 = -1;
				}
				else
				{
					...
					num2 = (fputil_internal_operator_fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float.Invoke(fputil_internal_FPRepImpl_vhj4tm4.FPRepSem.field_0.field_0, fputil_internal_FPRepImpl_vhj4tm5.FPRepSem.field_0.field_0) ? 1 : 0);
				}
			}
			...
			else
			{
				if (NumericHelper.IsUnorderedOrNotEquals(x, 0f))
				{
					...
					if (operator_Sign_Sign_fy8fvt.Invoke(anon_izyfb11.val, anon_izyfb12.val))
					{
						...
						fputil_FPBits_float_FPBits_unsigned_int_unsigned_int.Invoke(&fputil_FPBits_5nkvcs5, fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2) + 1);
					...
					else
					{
						...
						fputil_FPBits_float_FPBits_unsigned_int_unsigned_int.Invoke(&fputil_FPBits_5nkvcs6, fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2) - 1);
				...
				else
				{
					...
					int field_3 = fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_min_subnormal_Sign.Invoke(anon_izyfb13.val);
