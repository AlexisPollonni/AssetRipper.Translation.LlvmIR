...
internal static partial class FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_significand
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_internal_FPRepImpl_ucubaq* This, [MangledName("sigVal")][NativeType("unsigned long")] long SigVal)
	{
		unchecked
		{
			((Fputil_internal_FPStorage_v3nexn*)This)->Val = FPStorage_fputil_FPType_2_merge.Invoke(((Fputil_internal_FPStorage_v3nexn*)This)->Val, SigVal, 4503599627370495L);
		}
	}
}
