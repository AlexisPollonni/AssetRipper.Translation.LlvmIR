...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_sizeof_double_sizeof_float128_double_type_fputil_sqrt_double_float128_float128
{
	public unsafe static double Invoke(double x)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (num3 != 0)
			{
				result = cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_double_type_fputil_cast_double_float128_float128.Invoke(x);
			}
