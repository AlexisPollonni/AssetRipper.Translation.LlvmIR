...
internal static partial class Float16_eval_sinh_or_cosh_false_Float16
{
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			...
			x2 = *(int*)cpp_array_unsigned_int_32ul_operator_unsigned_long_const.Invoke(Index: (uint)num7, @this: EXP2_MID_5_BITS_12.Pointer) + (num5 << 23);
			llvm_lifetime_start_p0.Invoke(4L, &x3);
			x3 = *(int*)cpp_array_unsigned_int_32ul_operator_unsigned_long_const.Invoke(Index: (uint)num8, @this: EXP2_MID_5_BITS_12.Pointer) + (num6 << 23);
			...
			*(float*)ptr = 1f;
			...
			Half result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float_Float16_type_fputil_cast_Float16_float_float.Invoke(cpp_enable_if_sizeof_float_8ul_float_type_fputil_multiply_add_float_float_float_float.Invoke(num13, num14 * num12, num15 * num11));
