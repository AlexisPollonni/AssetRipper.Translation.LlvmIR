		...
		unchecked
		{
			...
			if ((b3 & 1) == 1)
			{
				...
				if (Internal_tolower_b2645y.Invoke(((sbyte*)Src)[num3]) == 112)
				{
					...
					if (Internal_isdigit_u2vjuj.Invoke(((sbyte*)Src)[num3 + 1L + (((b5 & 1) == 1) ? 1L : 0L)]))
					{
						...
						*(int*)(&llvm_libc_20_1_2_StrToNumResult_imtnam) = -1431655766;
						...
						Llvm_libc_20_1_2_StrToNumResult_imtnam* num8 = &llvm_libc_20_1_2_StrToNumResult_imtnam;
						Struct_fiz2nb struct_fiz2nb2 = struct_fiz2nb;
						*(long*)num8 = struct_fiz2nb2.field_0;
						byte* num9 = (byte*)(&llvm_libc_20_1_2_StrToNumResult_imtnam) + 8u;
				...
				else
				{
					...
					llvm_libc_20_1_2_internal_ExpandedFloat_9jummq2.Mantissa = @int;
					llvm_libc_20_1_2_internal_ExpandedFloat_9jummq2.Exponent = num2;
					Internal_binary_exp_to_float_long_double.Invoke(&llvm_libc_20_1_2_internal_FloatConvertReturn_hgyipa, &llvm_libc_20_1_2_internal_ExpandedFloat_9jummq2, (b2 & 1) == 1, Round);
