...
internal static partial class fputil_DyadicFloat_64ul_shift_left_unsigned_int
{
	public unsafe static void* Invoke(void* @this, int shift_length)
	{
		...
		unchecked
		{
			if ((ulong)(uint)shift_length < 64uL)
			{
				checked
				{
					unchecked((fputil_DyadicFloat_374hpp*)@this)->exponent -= shift_length;
				}
				BigInt_64ul_false_unsigned_long_operator_unsigned_long_pq2pm2.Invoke(&((fputil_DyadicFloat_374hpp*)@this)->mantissa, (uint)shift_length);
			}
			else
			{
