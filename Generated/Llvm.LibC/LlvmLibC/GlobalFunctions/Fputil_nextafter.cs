...
internal static partial class Fputil_nextafter
{
	...
	public unsafe static double Invoke([MangledName("from")][NativeType("long double")] double From, [MangledName("to")][NativeType("long double")] double To)
	{
		...
		Fputil_internal_FPRepImpl_jrxud9 fputil_internal_FPRepImpl_jrxud3 = default(Fputil_internal_FPRepImpl_jrxud9);
		Fputil_internal_FPRepImpl_jrxud9 fputil_internal_FPRepImpl_jrxud4 = default(Fputil_internal_FPRepImpl_jrxud9);
		...
		Fputil_internal_FPRepImpl_jrxud9 fputil_internal_FPRepImpl_jrxud5 = default(Fputil_internal_FPRepImpl_jrxud9);
		Fputil_internal_FPRepImpl_jrxud9 fputil_internal_FPRepImpl_jrxud6 = default(Fputil_internal_FPRepImpl_jrxud9);
		...
		Fputil_internal_FPRepImpl_jrxud9 fputil_internal_FPRepImpl_jrxud7 = default(Fputil_internal_FPRepImpl_jrxud9);
		Fputil_internal_FPRepImpl_jrxud9 fputil_internal_FPRepImpl_jrxud8 = default(Fputil_internal_FPRepImpl_jrxud9);
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi, From);
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi2, To);
			if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi2))
			{
				result = To;
			}
			else
			{
				if (From != To)
				{
					if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit.Invoke(&fputil_FPBits_ubgsi) && FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_subnormal.Invoke(&fputil_FPBits_ubgsi))
					{
						@int = 1L;
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi, *(long*)(&@int), ((long*)(&@int))[1]);
					}
					...
					if (From == 0.0)
					{
						...
						Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb, (!(From > To)) ? Sign_POS.Pointer : Sign_NEG.Pointer, 1L, isVolatile: false);
					...
					else if (From < 0.0)
					{
						if (To < From)
						{
							...
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud2, &fputil_FPBits_ubgsi4, 16L, isVolatile: false);
							bool num = Internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud), ((long*)(&fputil_internal_FPRepImpl_jrxud))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud2), ((long*)(&fputil_internal_FPRepImpl_jrxud2))[1]);
							...
							{
								Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
								Int128* num2 = &x;
								...
								*(long*)num3 = struct_fiz2nb12.field_1;
								...
								{
									int3 = 0L;
									FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int3), ((long*)(&int3))[1]);
									checked
									{
										int4 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) + 1;
									}
									FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int4), ((long*)(&int4))[1]);
									if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf.Invoke(&fputil_FPBits_ubgsi))
									{
								...
								Struct_fiz2nb struct_fiz2nb13 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi);
								Int128* num4 = &x2;
								...
								*(long*)num5 = struct_fiz2nb15.field_1;
								...
								FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi6, *(long*)(&int5), ((long*)(&int5))[1]);
								Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_ubgsi, &fputil_FPBits_ubgsi6, 16L, isVolatile: false);
								Llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi6);
							}
						}
						else
						{
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud3, &fputil_FPBits_ubgsi, 16L, isVolatile: false);
							...
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud4, &fputil_FPBits_ubgsi7, 16L, isVolatile: false);
							bool num6 = Internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud3), ((long*)(&fputil_internal_FPRepImpl_jrxud3))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud4), ((long*)(&fputil_internal_FPRepImpl_jrxud4))[1]);
							...
							{
								Struct_fiz2nb struct_fiz2nb22 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
								Int128* num7 = &x3;
								...
								*(long*)num8 = struct_fiz2nb24.field_1;
								...
								{
									int6 = long.MaxValue;
									FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int6), ((long*)(&int6))[1]);
									checked
									{
										int7 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) - 1;
									}
									FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int7), ((long*)(&int7))[1]);
									result = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi);
									goto IL_0e75;
								}
								Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi9);
								Struct_fiz2nb struct_fiz2nb25 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi);
								Int128* num9 = &x4;
								...
								*(long*)num10 = struct_fiz2nb27.field_1;
								...
								FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi9, *(long*)(&int8), ((long*)(&int8))[1]);
								Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_ubgsi, &fputil_FPBits_ubgsi9, 16L, isVolatile: false);
					...
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud5, &fputil_FPBits_ubgsi, 16L, isVolatile: false);
						...
						Int128* ptr6 = &fputil_FPBits_ubgsi10.Val.Data.FPStorage.field_0;
						...
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud6, &fputil_FPBits_ubgsi10, 16L, isVolatile: false);
						bool num11 = Internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud5), ((long*)(&fputil_internal_FPRepImpl_jrxud5))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud6), ((long*)(&fputil_internal_FPRepImpl_jrxud6))[1]);
						...
						if (num11)
						{
							...
							Int128* ptr7 = &fputil_FPBits_ubgsi11.Val.Data.FPStorage.field_0;
							...
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_ubgsi, &fputil_FPBits_ubgsi11, 16L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi11);
						}
						else
						{
							Struct_fiz2nb struct_fiz2nb34 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
							Int128* num12 = &x5;
							...
							*(long*)num13 = struct_fiz2nb36.field_1;
							...
							{
								int9 = long.MaxValue;
								FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int9), ((long*)(&int9))[1]);
								checked
								{
									int10 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) - 1;
								}
								FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int10), ((long*)(&int10))[1]);
								result = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi);
								goto IL_0e75;
							}
							Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi12);
							Struct_fiz2nb struct_fiz2nb37 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi);
							Int128* num14 = &x6;
							...
							*(long*)num15 = struct_fiz2nb39.field_1;
							...
							FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi12, *(long*)(&int11), ((long*)(&int11))[1]);
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_ubgsi, &fputil_FPBits_ubgsi12, 16L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi12);
						}
					}
					else
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud7, &fputil_FPBits_ubgsi, 16L, isVolatile: false);
						...
						Int128* ptr8 = &fputil_FPBits_ubgsi13.Val.Data.FPStorage.field_0;
						...
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepImpl_jrxud8, &fputil_FPBits_ubgsi13, 16L, isVolatile: false);
						bool num16 = Internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud7), ((long*)(&fputil_internal_FPRepImpl_jrxud7))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud8), ((long*)(&fputil_internal_FPRepImpl_jrxud8))[1]);
						...
						if (num16)
						{
							...
							Int128* ptr9 = &fputil_FPBits_ubgsi14.Val.Data.FPStorage.field_0;
							...
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_ubgsi, &fputil_FPBits_ubgsi14, 16L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi14);
						}
						else
						{
							Struct_fiz2nb struct_fiz2nb46 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi);
							Int128* num17 = &x7;
							...
							*(long*)num18 = struct_fiz2nb48.field_1;
							...
							{
								int12 = 0L;
								FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int12), ((long*)(&int12))[1]);
								checked
								{
									int13 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) + 1;
								}
								FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int13), ((long*)(&int13))[1]);
								if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf.Invoke(&fputil_FPBits_ubgsi))
								{
									Fputil_raise_except_if_required.Invoke(40);
								}
							...
							Struct_fiz2nb struct_fiz2nb49 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi);
							Int128* num19 = &x8;
							...
							*(long*)num20 = struct_fiz2nb51.field_1;
							...
							FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi15, *(long*)(&int14), ((long*)(&int14))[1]);
							Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_ubgsi, &fputil_FPBits_ubgsi15, 16L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi15);
						}
					}
					if (!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit.Invoke(&fputil_FPBits_ubgsi))
					{
