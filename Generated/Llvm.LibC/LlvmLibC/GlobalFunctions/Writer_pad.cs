	...
	public unsafe static int Invoke([MangledName("this")] Printf_core_Writer* This, [MangledName("new_char")][NativeType("char")] sbyte New_char, [MangledName("length")][NativeType("unsigned long")] long Length)
	{
		...
		unchecked
		{
			...
			*(IntPtr*)(&cpp_string_view) = unchecked((nint)(-6148914691236517206L));
			...
			String_view_Constructor.Invoke(&cpp_string_view, &inlineArray64_SByte, 64L);
			while (true)
			{
				if ((ulong)(num + 64L) < (ulong)Length)
				{
					...
					num4 = WriteBuffer_overflow_write.Invoke(wb, *(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]);
					int num6;
					if (num4 != 0)
					{
						result = num4;
				...
				else
				{
					...
					*(IntPtr*)(&cpp_string_view3) = unchecked((nint)(-6148914691236517206L));
					...
					Struct_kqhe8i struct_kqhe8i = String_view_substr.Invoke(&cpp_string_view, 0L, Length - num);
					Cpp_string_view* num7 = &cpp_string_view3;
					Struct_kqhe8i struct_kqhe8i2 = struct_kqhe8i;
					*(void**)num7 = struct_kqhe8i2.field_0;
					byte* num8 = (byte*)(&cpp_string_view3) + 8u;
					...
					*(long*)num8 = struct_kqhe8i3.field_1;
					...
					result = WriteBuffer_overflow_write.Invoke(wb2, *(void**)(&cpp_string_view4), ((long*)(&cpp_string_view4))[1]);
