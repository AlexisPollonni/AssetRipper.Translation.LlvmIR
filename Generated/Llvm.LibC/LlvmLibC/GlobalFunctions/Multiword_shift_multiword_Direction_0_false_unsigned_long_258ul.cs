...
internal static partial class Multiword_shift_multiword_Direction_0_false_unsigned_long_258ul
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_cpp_array_anzbtp* Agg_result, [MangledName("array")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 258ul>")] void* Array, [MangledName("offset")][NativeType("unsigned long")] long Offset)
	{
		long num = 0L;
		long num2 = 0L;
		sbyte b = 0;
			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 258uL; num5++)
				{
					...
					num6 = Lambda0_Invoke_92gyaa.Invoke(&anon_6je4un, num5 + num3);
					Llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = Lambda0_Invoke_92gyaa.Invoke(&anon_6je4un, num5 + num3 + 1L);
					Llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = Array_unsigned_long_258ul_Index_cpunpn.Invoke(Agg_result, Lambda_Invoke_4wih76.Invoke(&anon_izyfb, num5));
					if (num4 == 0L)
					{
						*(long*)ptr = num6;
					}
