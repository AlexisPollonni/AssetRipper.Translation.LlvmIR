		...
		unchecked
		{
			...
			while (true)
			{
				if ((ulong)num2 < (ulong)num)
				{
					...
					{
						fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0 = Generic_cmp_neq_unsigned_long.Invoke(P1, P2, num2);
						break;
					}
					num2 += 8L;
					continue;
				}
				fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0 = Memcmp_unsigned_long_block_offset.Invoke(P1, P2, num);
				break;
			}
