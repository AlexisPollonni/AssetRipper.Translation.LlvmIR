...
internal static partial class Fputil_floor_float128_0
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X)
	{
		...
		*unchecked((Int128*)(&fputil_FPBits_ubgsi)) = -6148914691236517206L;
		...
		double result = ((!FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_neg.Invoke(&fputil_FPBits_ubgsi)) ? Fputil_trunc_float128_0.Invoke(X) : (0.0 - Fputil_ceil_float128_0.Invoke(0.0 - X)));
