...
internal static partial class BigInt_128ul_false_unsigned_long_BigInt_16512ul_false_unsigned_long
{
	...
	public unsafe static void Invoke([MangledName("this")] Anon_izyfb7* This, [MangledName("other")][NativeType("__llvm_libc_20_1_2_::BigInt<16512ul, false, unsigned long> const&")] BigInt_q8g275* Other)
	{
		sbyte b = 0;
		long num = 0L;
		unchecked
