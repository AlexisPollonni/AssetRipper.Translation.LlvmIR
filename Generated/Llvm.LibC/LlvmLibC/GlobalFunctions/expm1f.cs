	...
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			else
			{
				...
				{
					if ((uint)fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2) < 1118961664u)
					{
						goto IL_03ac;
					}
					if ((uint)fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2) < 2139095040u)
					{
		...
		unchecked
		{
			if ((uint)num2 < 1031798784u)
			{
				...
				{
					result = ((!bool_details_expects_bool_condition_bool_bool_bool.Invoke(fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2) == int.MinValue, expected: false)) ? float_fputil_fma_float_float_float_float_float.Invoke(x, x, x) : x);
				}
				else
				{
