	...
	public unsafe static double Invoke([NativeType("long double")] double x)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			bool num = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi3);
			...
			else
			{
				...
				Struct_fiz2nb struct_fiz2nb = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_normal.Invoke(anon_izyfb9.val);
				...
				if (internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud10), ((long*)(&fputil_internal_FPRepImpl_jrxud10))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud11), ((long*)(&fputil_internal_FPRepImpl_jrxud11))[1]))
				{
					num2 = -1;
				}
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb4 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_inf.Invoke(anon_izyfb10.val);
					...
					num2 = (internal_Equals_jif2sf.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud12), ((long*)(&fputil_internal_FPRepImpl_jrxud12))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud13), ((long*)(&fputil_internal_FPRepImpl_jrxud13))[1]) ? 1 : 0);
				}
			}
			...
			else if (x == 0.0)
			{
				...
				Struct_fiz2nb struct_fiz2nb7 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_subnormal.Invoke(anon_izyfb11.val);
				...
				result = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi6);
			...
			else
			{
				...
				if (Equals_fy8fvt.Invoke(anon_izyfb12.val, anon_izyfb13.val))
				{
					...
					*(long*)num4 = struct_fiz2nb12.field_1;
					...
					{
						@int = 0L;
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&@int), ((long*)(&@int))[1]);
						checked
						{
							int2 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi3)) + 1;
						}
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int2), ((long*)(&int2))[1]);
					}
					else
					{
						...
						*(long*)num6 = struct_fiz2nb15.field_1;
						...
						FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi7, *(long*)(&int3), ((long*)(&int3))[1]);
				...
				{
					Struct_fiz2nb struct_fiz2nb16 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi3);
					Int128* num7 = &x4;
					...
					*(long*)num8 = struct_fiz2nb18.field_1;
					...
					{
						int4 = long.MaxValue;
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int4), ((long*)(&int4))[1]);
						checked
						{
							int5 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi3)) - 1;
						}
						FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int5), ((long*)(&int5))[1]);
					}
					else
					{
						llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi8);
						Struct_fiz2nb struct_fiz2nb19 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi3);
						Int128* num9 = &x5;
						...
						*(long*)num10 = struct_fiz2nb21.field_1;
						...
						FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi8, *(long*)(&int6), ((long*)(&int6))[1]);
