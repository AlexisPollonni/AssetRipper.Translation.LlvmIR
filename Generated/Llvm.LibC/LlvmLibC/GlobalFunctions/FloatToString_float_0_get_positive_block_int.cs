		...
		unchecked
		{
			...
			if (@this->exponent >= -23)
			{
				...
				*(long*)ptr = -6148914691236517206L;
				...
				BigInt_192ul_false_unsigned_long_BigInt_3ul_unsigned_long_const_3ul.Invoke(&bigInt_khh67p2, (byte*)POW10_SPLIT.Pointer + (nint)num7 * sizeof(InlineArray3_Int64));
