...
internal static partial class fputil_remquo_Float16_0
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x, [NativeType("_Float16")] Half y, [NativeType("int&")] void* q)
	{
		...
		unchecked
		{
			...
			*(short*)(&fputil_FPBits_2fahva3) = -21846;
			...
			else if (FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3)))
			{
				result = y;
			}
			...
			else if (FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_inf.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva3)))
			{
				*(int*)q = 0;
				result = x;
			}
			else
			{
				...
				*(sbyte*)(&anon_izyfb9) = -86;
				...
				anon_izyfb11.val = FPStorage_fputil_FPType_0_sign.Invoke(&fputil_FPBits_2fahva3);
				...
				FPStorage_fputil_FPType_0_set_sign.Invoke(&fputil_FPBits_2fahva2, anon_izyfb12.val);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb13, Sign_POS.Pointer, 1L, isVolatile: false);
				FPStorage_fputil_FPType_0_set_sign.Invoke(&fputil_FPBits_2fahva3, anon_izyfb13.val);
				...
				*(int*)(&fputil_NormalFloat_epbrnk3) = -1431655766;
				...
				NormalFloat_Float16_Constructor.Invoke(&fputil_NormalFloat_epbrnk3, fputil_FPBits_2fahva6.FPRepImpl.FPRepSem.FPStorage.field_0);
				...
				*(int*)q = 0;
				while (true)
				{
					...
					*(int*)(&fputil_NormalFloat_epbrnk4) = -1431655766;
					...
					NormalFloat_Float16_Constructor.Invoke(e: checked(num + fputil_NormalFloat_epbrnk3.exponent), m: num2, @this: &fputil_NormalFloat_epbrnk4, s: anon_izyfb14.val);
					llvm_lifetime_start_p0.Invoke(2L, &half);
					half = NormalFloat_Float16_Float16.Invoke(&fputil_NormalFloat_epbrnk4);
					llvm_lifetime_start_p0.Invoke(2L, &half2);
					half2 = FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva3);
					llvm_lifetime_start_p0.Invoke(4L, &num6);
					llvm_lifetime_start_p0.Invoke(8L, &fputil_NormalFloat_epbrnk5);
					*(InlineArray7_Byte*)(&fputil_NormalFloat_epbrnk5) = NumericHelper.TruncOrZextToBytes<long, InlineArray7_Byte>(NormalFloat_Float16_mul2.Invoke(&fputil_NormalFloat_epbrnk4, 1));
					int num9 = NormalFloat_Float16_cmp.Invoke(&fputil_NormalFloat_epbrnk5, &fputil_NormalFloat_epbrnk3);
