...
internal static partial class Parser_unsigned_int128_parse_10
{
	...
	public unsafe static Struct_fiz2nb Invoke([NativeType("char const*")] void* str)
	{
		...
		DigitBuffer_unsigned_int128_10_Constructor.Invoke(&internal_DigitBuffer_wha8ym2, str);
		Struct_fiz2nb struct_fiz2nb = internal_accumulate_unsigned_int128.Invoke(10, &internal_DigitBuffer_wha8ym2.digits, internal_DigitBuffer_wha8ym2.size);
		Int128* num = &@int;
