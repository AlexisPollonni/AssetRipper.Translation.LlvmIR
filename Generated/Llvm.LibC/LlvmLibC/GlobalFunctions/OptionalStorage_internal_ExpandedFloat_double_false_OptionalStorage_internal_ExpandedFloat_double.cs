...
internal static partial class OptionalStorage_internal_ExpandedFloat_double_false_OptionalStorage_internal_ExpandedFloat_double
{
	...
	public unsafe static void Invoke([MangledName("this")][NativeType("__llvm_libc_20_1_2_::cpp::in_place_t")] Llvm_libc_20_1_2_cpp_optional_internal_ExpandedFloat_double_OptionalStorage* This, [MangledName("args")][NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<double>&&")] void* Args)
	{
		Llvm_memcpy_p0_p0_i64.Invoke(&This->field, Cpp_forward_internal_ExpandedFloat_double.Invoke(unchecked((Llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv*)Args)), 16L, isVolatile: false);
		This->In_use = 0;
	}
}
