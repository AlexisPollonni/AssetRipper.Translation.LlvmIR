...
internal static partial class char_internal_string_token_true_char_char_const_char
{
		...
		unchecked
		{
			...
			else
			{
				...
				*(long*)ptr5 = -6148914691236517206L;
				...
				for (; *(sbyte*)ptr2 != 0 && cpp_bitset_256ul_test_unsigned_long_const.Invoke(&cpp_array_jgy3xh2, *(sbyte*)ptr2); ptr2 = (byte*)ptr2 + 1)
				{
				}
				if (*(sbyte*)ptr2 == 0)
				{
