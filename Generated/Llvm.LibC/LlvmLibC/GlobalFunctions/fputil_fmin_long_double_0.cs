	...
	public unsafe static double Invoke([NativeType("long double")] double x, [NativeType("long double")] double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			double result = ((!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi3)) ? ((!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi4)) ? internal_min_long_double.Invoke(x, y) : x) : y);
