...
internal static partial class long_long_fputil_internal_rounded_float_to_signed_integer_long_double_long_long_0_long_double
{
	public unsafe static long Invoke(double x)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			{
				long_long_fputil_internal_rounded_float_to_signed_integer_long_double_long_long_0_long_double_lambda_operator_const.Invoke(&anon_izyfb8);
