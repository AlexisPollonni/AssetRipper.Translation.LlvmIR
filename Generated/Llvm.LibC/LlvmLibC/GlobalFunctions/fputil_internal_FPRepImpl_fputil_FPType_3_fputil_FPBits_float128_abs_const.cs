...
internal static partial class fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs_const
{
	public unsafe static Struct_fiz2nb Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			fputil_FPBits_float128_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&@int), ((long*)(&@int))[1]);
