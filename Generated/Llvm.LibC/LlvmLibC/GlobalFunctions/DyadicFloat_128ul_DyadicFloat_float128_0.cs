...
internal static partial class DyadicFloat_128ul_DyadicFloat_float128_0
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* This, [MangledName("x")][NativeType("__float128")] double X)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			This->Exponent = checked(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_explicit_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) - 112);
