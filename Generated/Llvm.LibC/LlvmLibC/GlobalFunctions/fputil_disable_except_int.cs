...
internal static partial class fputil_disable_except_int
{
	public unsafe static int Invoke(int excepts)
	{
		...
		num2 = fputil_internal_get_x87_control_word.Invoke();
		llvm_lifetime_start_p0.Invoke(2L, &status);
		unchecked
		{
			status = (short)(((ushort)num2 ^ -1) & 0x3F);
			num2 = (short)((ushort)num2 | (ushort)num);
			fputil_internal_write_x87_control_word_unsigned_short.Invoke(num2);
			llvm_lifetime_start_p0.Invoke(4L, &num3);
			num3 = fputil_internal_get_mxcsr.Invoke();
			num3 |= (ushort)num << 7;
			fputil_internal_write_mxcsr_unsigned_int.Invoke(num3);
