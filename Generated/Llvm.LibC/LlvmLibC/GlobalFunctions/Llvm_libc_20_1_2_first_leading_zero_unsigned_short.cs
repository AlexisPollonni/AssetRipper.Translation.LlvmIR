...
internal static partial class Llvm_libc_20_1_2_first_leading_zero_unsigned_short
{
	...
	{
		short num = Value;
		return unchecked((ushort)num != (ushort)Integer_impl_unsigned_short_unsigned_short_0_unsigned_short_65535_max.Invoke()) ? (Cpp_countl_one_unsigned_short.Invoke(num) + 1) : 0;
	}
}
