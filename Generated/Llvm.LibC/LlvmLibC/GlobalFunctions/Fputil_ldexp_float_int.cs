	...
	public unsafe static float Invoke([MangledName("x")][NativeType("float")] float X, [MangledName("exp")][NativeType("int")] int Exp)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			if (Details_expects_bool_condition_bool.Invoke(Exp == 0 || FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero.Invoke(&fputil_FPBits_5nkvcs) || FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)), Expected: false))
			{
				result = X;
				goto IL_059d;
			}
		...
		fputil_DyadicFloat_cs3nhs.Exponent += Exp;
