...
internal static partial class cpp_enable_if_is_unsigned_integral_or_big_int_v_BigInt_256ul_false_unsigned_long_bool_type_fputil_generic_internal_shift_mantissa_BigInt_256ul_false_unsigned_long_int_BigInt_256ul_false_unsigned_long
{
	public unsafe static bool Invoke(int shift_length, BigInt_x9dsed* mant)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				*(long*)ptr = -6148914691236517206L;
				...
				BigInt_256ul_false_unsigned_long_BigInt_int_void_int.Invoke(&bigInt_x9dsed4, 1);
				BigInt_256ul_false_unsigned_long_operator_unsigned_long_const_kxxaxj.Invoke(&bigInt_x9dsed3, &bigInt_x9dsed4, shift_length);
				...
				BigInt_256ul_false_unsigned_long_operator_BigInt_256ul_false_unsigned_long_const_nar9qw.Invoke(&bigInt_x9dsed2, &bigInt_x9dsed3, &bigInt_x9dsed5);
				...
				operator_BigInt_256ul_false_unsigned_long_const_BigInt_256ul_false_unsigned_long_const_abg3um.Invoke(&bigInt_x9dsed6, mant, &bigInt_x9dsed2);
				llvm_lifetime_start_p0.Invoke(32L, &bigInt_x9dsed7);
				BigInt_256ul_false_unsigned_long_BigInt_int_void_int.Invoke(&bigInt_x9dsed7, 0);
				bool num = operator_BigInt_256ul_false_unsigned_long_const_BigInt_256ul_false_unsigned_long_const_627jbj.Invoke(&bigInt_x9dsed6, &bigInt_x9dsed7);
				llvm_lifetime_end_p0.Invoke(32L, &bigInt_x9dsed7);
				llvm_lifetime_end_p0.Invoke(32L, &bigInt_x9dsed6);
				b = (num ? ((sbyte)1) : ((sbyte)0));
				BigInt_256ul_false_unsigned_long_operator_unsigned_long_bk6nzq.Invoke(mant, shift_length);
				result = (b & 1) == 1;
