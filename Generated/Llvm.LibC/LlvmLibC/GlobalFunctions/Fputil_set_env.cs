	...
	public unsafe static int Invoke([MangledName("envp")][NativeType("fenv_t const*")] void* Envp)
	{
		...
		unchecked
		{
			*(short*)(&fputil_internal_X87StateDescriptor) = -21846;
			...
			sbyte* ptr2 = (sbyte*)(&fputil_internal_X87StateDescriptor) + 8;
			*(int*)ptr2 = -1431655766;
			...
			if (Envp == (void*)(-1L))
			{
				short* ptr3 = &fputil_internal_X87StateDescriptor.Status_word;
				*ptr3 = (short)((ushort)(*ptr3) & -64);
				Llvm_lifetime_start_p0.Invoke(4L, &i);
				for (i = 0; i < 5; i = checked(i + 1))
				{
					Unsafe.As<InlineArray5_Int32, int>(ref Unsafe.AddByteOffset(ref fputil_internal_X87StateDescriptor.field, (nint)i * (nint)4)) = 0;
				}
				Llvm_lifetime_end_p0.Invoke(4L, &i);
				short* ptr4 = &fputil_internal_X87StateDescriptor.Control_word;
				*ptr4 = (short)((ushort)(*ptr4) | 0x3F);
				short* ptr5 = &fputil_internal_X87StateDescriptor.Control_word;
				*ptr5 = (short)((ushort)(*ptr5) & -3073);
				short* ptr6 = &fputil_internal_X87StateDescriptor.Control_word;
			...
			else
			{
				...
				ptr = Envp;
				short* ptr7 = &fputil_internal_X87StateDescriptor.Status_word;
				*ptr7 = (short)((ushort)(*ptr7) & -64);
				int num2 = (ushort)((Fputil_internal_FPState*)ptr)->X87_status.Status_word & 0x3F;
				short* ptr8 = &fputil_internal_X87StateDescriptor.Status_word;
				*ptr8 = (short)((ushort)(*ptr8) | num2);
				...
				for (j = 0; j < 5; j = checked(j + 1))
				{
					...
					Unsafe.As<InlineArray5_Int32, int>(ref Unsafe.AddByteOffset(ref fputil_internal_X87StateDescriptor.field, (nint)j * (nint)4)) = num3;
				}
				Llvm_lifetime_end_p0.Invoke(4L, &j);
				fputil_internal_X87StateDescriptor.Control_word = ((Fputil_internal_FPState*)ptr)->X87_status.Control_word;
				Internal_write_x87_state_descriptor.Invoke(&fputil_internal_X87StateDescriptor);
				Internal_write_mxcsr.Invoke(((Fputil_internal_FPState*)ptr)->Mxcsr);
				result = 0;
