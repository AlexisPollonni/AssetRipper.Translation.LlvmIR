			...
			if ((b3 & 1) == 1)
			{
				...
				else
				{
					...
					*ptr5 = -86;
					...
					internal_decimal_exp_to_float_double.Invoke(round: (b2 & 1) == 1, numStart: (int)round, num_len: src, mantissa: integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke(), agg_result: &internal_FloatConvertReturn_g92bm9, init_num: *(long*)(&internal_ExpandedFloat_k68bhv4), truncated: ((int*)(&internal_ExpandedFloat_k68bhv4))[2]);
