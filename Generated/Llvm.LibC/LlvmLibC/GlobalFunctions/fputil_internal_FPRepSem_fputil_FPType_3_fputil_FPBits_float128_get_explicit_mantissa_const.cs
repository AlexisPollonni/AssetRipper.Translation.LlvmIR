...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa_const
{
	public unsafe static Struct_fiz2nb Invoke(fputil_internal_FPRepSem_f94eua* @this)
	{
		...
		{
			Int128 int3;
			if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal_const.Invoke(@this))
			{
				Struct_fiz2nb struct_fiz2nb = fputil_internal_FPStorage_fputil_FPType_3_sig_bits_const.Invoke(@this);
				Int128* num = &@int;
			...
			{
				Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPStorage_fputil_FPType_3_sig_bits_const.Invoke(@this);
				Int128* num3 = &int2;
