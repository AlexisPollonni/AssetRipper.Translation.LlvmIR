...
internal static partial class BigInt_16ul_false_unsigned_short_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] BigInt_ys7s55* This, [MangledName("words")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned short, 1ul> const&")] Cpp_array_knh6hw* Words)
	{
	...
	public unsafe static void Invoke([MangledName("this")] BigInt_ys7s55* This)
	{
		Llvm_memset_p0_i64.Invoke(&This->Val.Data, 0, 2L, isVolatile: false);
	}
}
