...
internal static partial class long_double_fputil_DyadicFloat_128ul_fast_as_long_double_true_void_const
{
	public unsafe static double Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				checked
				{
					num2 = unchecked((fputil_DyadicFloat_kt2kd4*)@this)->exponent + 16510;
				}
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num2 > 32766, expected: false))
				{
					...
					int3 = long.MinValue;
					Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val, biased_exp, mantissa, *(long*)(&int3), ((long*)(&int3))[1]);
					...
					double num18 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi4);
					...
					fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi5, num5);
					bool num19 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf_const.Invoke(&fputil_FPBits_ubgsi5);
				...
				else
				{
					...
					*(long*)ptr3 = -6148914691236517206L;
					...
					{
						Struct_fiz2nb struct_fiz2nb7 = BigInt_128ul_false_unsigned_long_operator_unsigned_long_const_99u38u.Invoke(&((fputil_DyadicFloat_kt2kd4*)@this)->mantissa, (uint)num6);
					...
					*(long*)num21 = struct_fiz2nb12.field_1;
					...
					int5 = int17;
					Struct_fiz2nb struct_fiz2nb13 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val2, biased_exp2, mantissa2, *(long*)(&int5), ((long*)(&int5))[1]);
					...
					double num22 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi6);
					...
					*(long*)ptr6 = -6148914691236517206L;
					...
					else
					{
						...
						Struct_fiz2nb struct_fiz2nb16 = BigInt_128ul_false_unsigned_long_operator_unsigned_long_const_dnm495.Invoke(&bigInt_qdkjbh3, (uint)(num6 - 1));
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb19 = BigInt_128ul_false_unsigned_long_operator_BigInt_128ul_false_unsigned_long_const_gydwfz.Invoke(&bigInt_qdkjbh2, &bigInt_qdkjbh5);
					...
					Struct_fiz2nb struct_fiz2nb22 = operator_BigInt_128ul_false_unsigned_long_const_BigInt_128ul_false_unsigned_long_const_bs7s6m.Invoke(&((fputil_DyadicFloat_kt2kd4*)@this)->mantissa, &bigInt_qdkjbh2);
					...
					int num24 = (BigInt_128ul_false_unsigned_long_is_zero_const.Invoke(&bigInt_qdkjbh6) ? 1 : 0) ^ -1;
					llvm_lifetime_end_p0.Invoke(16L, &bigInt_qdkjbh6);
					b2 = (sbyte)(byte)num24;
					llvm_lifetime_start_p0.Invoke(1L, &b3);
					llvm_lifetime_start_p0.Invoke(16L, &bigInt_qdkjbh7);
					Struct_fiz2nb struct_fiz2nb25 = operator_BigInt_128ul_false_unsigned_long_const_BigInt_128ul_false_unsigned_long_const_bs7s6m.Invoke(&((fputil_DyadicFloat_kt2kd4*)@this)->mantissa, &bigInt_qdkjbh4);
					...
					int num25 = (BigInt_128ul_false_unsigned_long_is_zero_const.Invoke(&bigInt_qdkjbh7) ? 1 : 0) ^ -1;
					...
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num7 <= 0, expected: false))
					{
						...
						int7 = long.MinValue;
						Struct_fiz2nb struct_fiz2nb28 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val3, biased_exp3, mantissa3, *(long*)(&int7), ((long*)(&int7))[1]);
						...
						double num26 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi7);
						...
						int9 = long.MinValue;
						Struct_fiz2nb struct_fiz2nb31 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val4, biased_exp4, mantissa4, *(long*)(&int9), ((long*)(&int9))[1]);
						...
						double num27 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi8);
						llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi8);
						num13 = num27;
						llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi9);
						llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb13, &((fputil_DyadicFloat_kt2kd4*)@this)->sign, 1L, isVolatile: false);
						...
						int11 = long.MinValue;
						Struct_fiz2nb struct_fiz2nb34 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val5, biased_exp5, mantissa5, *(long*)(&int11), ((long*)(&int11))[1]);
						...
						num10 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi9);
						...
						num15 = num8 * num12;
						result = cpp_enable_if_sizeof_long_double_8ul_long_double_type_fputil_multiply_add_long_double_long_double_const_long_double_const_long_double_const.Invoke(&num10, &num14, &num15) * num13;
					...
					else
					{
						...
						int13 = long.MinValue;
						Struct_fiz2nb struct_fiz2nb37 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value_Sign_unsigned_int128_unsigned_int128.Invoke(val6, biased_exp6, mantissa6, *(long*)(&int13), ((long*)(&int13))[1]);
						...
						num10 = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi10);
						...
						num17 = num9;
						double num28 = cpp_enable_if_sizeof_long_double_8ul_long_double_type_fputil_multiply_add_long_double_long_double_const_long_double_const_long_double_const.Invoke(&num10, &num17, &num8);
						...
						if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((b & 1) == 1, expected: false))
						{
							...
							fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi11, num16);
							Struct_fiz2nb struct_fiz2nb40 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi11);
							Int128* num29 = &x2;
							...
							*(long*)num30 = struct_fiz2nb42.field_1;
							...
							int15 = int14;
							fputil_FPBits_long_double_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi12, *(long*)(&int15), ((long*)(&int15))[1]);
							result = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi12);
