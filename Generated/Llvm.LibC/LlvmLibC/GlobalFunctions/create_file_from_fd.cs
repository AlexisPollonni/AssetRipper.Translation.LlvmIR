...
internal static partial class create_file_from_fd
{
	...
	public unsafe static Struct_yx4nca Invoke([NativeType("int")] int fd, [NativeType("char const*")] void* mode)
	{
		...
		if (num == 0)
		{
			...
			expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2.field_0);
			goto IL_042a;
		}
		...
		unchecked
		{
			if (num2 == -1)
			{
				unexpected_int_Constructor.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt3, 9);
				expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt3.field_0);
			}
			else
			{
				if (((num2 & 3) != 0 || (num & 1) != 0) && ((num2 & 3) != 1 || (num & 2) != 0))
				{
					...
					if ((num & 4) != 0 && (num2 & 0x400) == 0)
					{
						...
						{
							unexpected_int_Constructor.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt5, 9);
							expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt5.field_0);
							goto IL_0406;
						}
					}
					...
					*(sbyte*)(&anon_izyfb8) = -86;
					...
					if (!AllocChecker_ToBoolean.Invoke(&anon_izyfb8))
					{
						...
						expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt6.field_0);
						num3 = 1;
					}
					else
					{
					...
					case 0:
						{
							...
							*(sbyte*)(&anon_izyfb9) = -86;
							...
							{
								unexpected_int_Constructor.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt7, 12);
								expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt7.field_0);
							}
							else
							{
								if ((b & 1) == 1)
								{
									...
									*ptr3 = -86;
									ptr3[1] = -86;
									ptr3[2] = -86;
									*(InlineArray5_Byte*)(&cpp_optional_int_OptionalStorage2) = NumericHelper.TruncOrZextToBytes<long, InlineArray5_Byte>(File_seek.Invoke(ptr, 0L, 2));
									if (!expected_int_int_has_value.Invoke(&cpp_optional_int_OptionalStorage2))
									{
										free.Invoke(ptr);
										unexpected_int_Constructor.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt8, *(int*)expected_int_int_error.Invoke(&cpp_optional_int_OptionalStorage2));
										expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt8.field_0);
										num3 = 1;
									}
									else
									{
								...
								expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, (LinuxFile*)ptr);
							}
							goto IL_03d2;
						}
						IL_03d2:
				...
				unexpected_int_Constructor.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt4, 22);
				expected_LinuxFile_int_Constructor.Invoke(&cpp_optional_char_OptionalStorage2, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt4.field_0);
			}
			goto IL_0418;
		}
		IL_0418:
