...
internal static partial class generic_Memmove_cpp_array_unsigned_char_vector_16_4ul_loop_and_tail_backward_cpp_byte_cpp_byte_const_unsigned_long
{
	public unsafe static void Invoke(void* dst, void* src, long count)
	{
		...
		unchecked
		{
			...
			do
			{
				generic_Memmove_cpp_array_unsigned_char_vector_16_4ul_block_cpp_byte_cpp_byte_const.Invoke((byte*)dst + num, (byte*)src + num);
				num -= 64L;
			}
			while (num >= 0L);
			llvm_memcpy_p0_p0_i64.Invoke(&cpp_array_2b9gdz3, &cpp_array_2b9gdz2, 64L, isVolatile: false);
			void_generic_store_cpp_array_unsigned_char_vector_16_4ul_cpp_byte_cpp_array_unsigned_char_vector_16_4ul.Invoke(dst, &cpp_array_2b9gdz3);
