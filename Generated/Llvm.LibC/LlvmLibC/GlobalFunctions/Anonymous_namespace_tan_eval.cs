...
internal static partial class Anonymous_namespace_tan_eval
{
	...
	public unsafe static double Invoke([MangledName("u")][NativeType("__llvm_libc_20_1_2_::NumberPair<double> const&")] Llvm_libc_20_1_2_NumberPair* U, [MangledName("result")][NativeType("__llvm_libc_20_1_2_::NumberPair<double>&")] Llvm_libc_20_1_2_NumberPair* Result)
	{
		double num = 0.0;
		double y = 0.0;
		double z = 0.0;
		...
		unchecked
		{
			...
			*(double*)num4 = struct_4ydhja3.field_1;
			Llvm_memcpy_p0_p0_i64.Invoke(Result, &llvm_libc_20_1_2_NumberPair, 16L, isVolatile: false);
			...
			double result = Fputil_multiply_add_double.Invoke(FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm), 4.440892098500626E-16, 1.9721522630525295E-31);
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* Agg_result, [MangledName("u")][NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<128ul> const&")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* U)
	{
		...
		InlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4 inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd = default(InlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4);
		...
		unchecked
		{
			...
			*(long*)ptr2 = -6148914691236517206L;
			...
			Llvm_lifetime_start_p0.Invoke(216L, &inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd);
			Llvm_memcpy_p0_p0_i64.Invoke(&inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, TAN_COEFFS.Pointer, 216L, isVolatile: false);
			Llvm_lifetime_start_p0.Invoke(24L, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2);
			Fputil_polyeval_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)(&inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)2 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)3 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)4 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)5 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)6 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)7 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))), (Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4*)Unsafe.AsPointer(ref Unsafe.AddByteOffset(ref inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, (nint)8 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))));
			Fputil_quick_mul_128ul.Invoke(Agg_result, U, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2);
			Llvm_lifetime_end_p0.Invoke(24L, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2);
			Llvm_lifetime_end_p0.Invoke(216L, &inlineArray9_Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd);
