...
internal static partial class fputil_floor_long_double_0
{
	...
	public unsafe static double Invoke([NativeType("long double")] double x)
	{
		...
		*unchecked((Int128*)(&fputil_FPBits_ubgsi3)) = -6148914691236517206L;
		...
		double result = ((!FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi3)) ? fputil_trunc_long_double_0.Invoke(x) : (0.0 - fputil_ceil_long_double_0.Invoke(0.0 - x)));
