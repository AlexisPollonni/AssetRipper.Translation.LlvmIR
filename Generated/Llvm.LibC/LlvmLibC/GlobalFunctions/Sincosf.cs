		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			if (Details_expects_bool_condition_bool.Invoke((uint)num < 964689920u, Expected: false))
			{
				...
				else
				{
					*(float*)Sinp = (float)Fputil_multiply_add_double.Invoke(num2, -2.980232238769531E-08, num2);
					...
					FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, num);
					*(float*)Cosp = (float)Fputil_multiply_add_double.Invoke(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2), -2.980232238769531E-08, 1.0);
			...
			else if (Details_expects_bool_condition_bool.Invoke((uint)num >= 2139095040u, Expected: false))
			{
				...
				*(float*)Sinp = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs3);
			...
			else
			{
				...
				while (true)
				{
					...
					if (Details_expects_bool_condition_bool.Invoke(num9 == ((int*)EXCEPT_INPUTS.Pointer)[num10], Expected: false))
					{
						...
						if (num27)
						{
							FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs4, num4);
							num28 = 0f - FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs4);
						}
						else
						{
							FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs5, num4);
							num28 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5);
						}
						*(float*)Sinp = num28;
						Llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs5);
						Llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs4);
						Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs6);
						FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs6, num5);
						*(float*)Cosp = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs6);
				...
				if (num8 == 2)
				{
					...
					x2 = double.NaN;
					Sincosf_eval.Invoke(num2, num, &num6, &num7, &x, &x2);
