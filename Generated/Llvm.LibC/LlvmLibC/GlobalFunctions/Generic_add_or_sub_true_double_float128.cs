...
internal static partial class Generic_add_or_sub_true_double_float128
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic10add_or_subILb1EdgEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT0_Esr3cppE19is_floating_point_vIT1_ElestS5_stS6_ES5_E4typeES6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<double> && cpp::is_floating_point_v<__float128> && sizeof (double) <= sizeof (__float128), double>::type __llvm_libc_20_1_2_::fputil::generic::add_or_sub<true, double, __float128>(__float128, __float128)")]
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)))
			{
				...
				else
				{
					...
					num4 = Y;
					num4 = 0.0 - num4;
					result = Fputil_cast_double_float128.Invoke(num4);
			...
			else
			{
				...
				num5 = Y;
				num5 = 0.0 - num5;
				result = Fputil_cast_double_float128.Invoke(num5);
		...
		unchecked
		{
			...
			if (num6 == num7 && (b & 1) != 1)
			{
				if (Fputil_quick_get_round.Invoke() == 1024)
				{
					...
					llvm_libc_20_1_2_fputil_FPBits_wjhbrm10.FPRepImpl.FPRepSem.FPStorage.Val = val10;
				...
				else
				{
					...
					llvm_libc_20_1_2_fputil_FPBits_wjhbrm11.FPRepImpl.FPRepSem.FPStorage.Val = val11;
			...
			else
			{
				...
				*(long*)ptr4 = -6148914691236517206L;
				...
				result = DyadicFloat_128ul_as_double_true_void.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd);
