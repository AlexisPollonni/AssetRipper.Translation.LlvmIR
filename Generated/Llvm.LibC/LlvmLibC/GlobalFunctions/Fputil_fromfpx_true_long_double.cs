...
internal static partial class Fputil_fromfpx_true_long_double
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("rnd")][NativeType("int")] int Rnd, [MangledName("width")][NativeType("unsigned int")] int Width)
	{
		...
		num = Fputil_fromfp_true_long_double.Invoke(X, Rnd, Width);
		...
		*unchecked((Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)) = -6148914691236517206L;
		FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, num);
		if (!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) && NumericHelper.IsUnorderedOrNotEquals(num, X))
		{
