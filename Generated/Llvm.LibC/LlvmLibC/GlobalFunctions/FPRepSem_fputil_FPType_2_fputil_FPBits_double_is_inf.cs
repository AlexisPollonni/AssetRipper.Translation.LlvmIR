...
internal static partial class FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_inf
{
	...
	public unsafe static bool Invoke([MangledName("this")] Fputil_internal_FPRepSem_fq8nhg* This)
	{
		...
		return num == FPStorage_fputil_FPType_2_encode.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, fputil_internal_FPRepSem_fq8nhg.FPStorage.Val);
	}
}
