...
internal static partial class cpp_enable_if_cpp_is_unsigned_v_unsigned_short_unsigned_short_type_cpp_bit_ceil_unsigned_short_unsigned_short
{
	public static short Invoke(short value)
	{
		...
		unchecked
		{
			...
			return (short)(1 << cpp_enable_if_cpp_is_unsigned_v_unsigned_int_int_type_cpp_bit_width_unsigned_int_unsigned_int.Invoke((ushort)num - 1));
		}
	}
}
