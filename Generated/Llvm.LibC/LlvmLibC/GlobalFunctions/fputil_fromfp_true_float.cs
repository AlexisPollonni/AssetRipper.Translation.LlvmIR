				...
				*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
				...
				else
				{
					...
					else
					{
						...
						int field_3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value.Invoke(biased_exp: num3, sign: anon_izyfb10.val, mantissa: 0);
						fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0 = field_3;
						float num6 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5);
						...
						else
						{
							...
							int field_5 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value.Invoke(biased_exp: num3, sign: anon_izyfb12.val, mantissa: 0);
							fputil_FPBits_5nkvcs7.FPRepImpl.FPRepSem.field_0.field_0 = field_5;
							float num7 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs7) - 1f;
							...
							if (num2 > num5)
							{
								...
								int field_6 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan.Invoke(anon_izyfb13.val, 0);
