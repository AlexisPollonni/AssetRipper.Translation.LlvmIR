...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float_sizeof_Float16_sizeof_float_Float16_type_fputil_generic_div_Float16_float_float_float
{
	public unsafe static Half Invoke(float x, float y)
	{
		...
		int i = 0;
		fputil_DyadicFloat_cs3nhs fputil_DyadicFloat_cs3nhs4 = default(fputil_DyadicFloat_cs3nhs);
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			fputil_DyadicFloat_32ul_DyadicFloat_float_0_float.Invoke(&fputil_DyadicFloat_cs3nhs2, x);
			llvm_lifetime_start_p0.Invoke(12L, &fputil_DyadicFloat_cs3nhs3);
			*(sbyte*)(&fputil_DyadicFloat_cs3nhs3) = -86;
			sbyte* ptr2 = (sbyte*)(&fputil_DyadicFloat_cs3nhs3) + 1;
			*ptr2 = -86;
			ptr2[1] = -86;
			ptr2[2] = -86;
			((int*)(&fputil_DyadicFloat_cs3nhs3))[1] = -1431655766;
			((int*)(&fputil_DyadicFloat_cs3nhs3))[2] = -1431655766;
			fputil_DyadicFloat_32ul_DyadicFloat_float_0_float.Invoke(&fputil_DyadicFloat_cs3nhs3, y);
			llvm_lifetime_start_p0.Invoke(4L, &num3);
			num3 = 13;
			llvm_lifetime_start_p0.Invoke(4L, &num4);
			num4 = checked(fputil_DyadicFloat_cs3nhs2.exponent - fputil_DyadicFloat_cs3nhs3.exponent - 12);
			llvm_lifetime_start_p0.Invoke(4L, &num5);
			num5 = 0;
			llvm_lifetime_start_p0.Invoke(4L, &num6);
			llvm_lifetime_start_p0.Invoke(4L, &bigInt_vtm4cw);
			int data = BigInt_32ul_false_unsigned_int_operator_unsigned_long_const_mny5rw.Invoke(&fputil_DyadicFloat_cs3nhs2.mantissa, 2L);
			*(int*)(&bigInt_vtm4cw.val.Data) = data;
			int num8 = BigInt_32ul_false_unsigned_int_operator_unsigned_int_unsigned_int_const.Invoke(&bigInt_vtm4cw);
			llvm_lifetime_end_p0.Invoke(4L, &bigInt_vtm4cw);
			num6 = num8;
			llvm_lifetime_start_p0.Invoke(4L, &num7);
			llvm_lifetime_start_p0.Invoke(4L, &bigInt_vtm4cw2);
			int data2 = BigInt_32ul_false_unsigned_int_operator_unsigned_long_const_mny5rw.Invoke(&fputil_DyadicFloat_cs3nhs3.mantissa, 1L);
			*(int*)(&bigInt_vtm4cw2.val.Data) = data2;
			int num9 = BigInt_32ul_false_unsigned_int_operator_unsigned_int_unsigned_int_const.Invoke(&bigInt_vtm4cw2);
			...
			llvm_lifetime_start_p0.Invoke(12L, &fputil_DyadicFloat_cs3nhs4);
			*(sbyte*)(&fputil_DyadicFloat_cs3nhs4) = -86;
			sbyte* ptr3 = (sbyte*)(&fputil_DyadicFloat_cs3nhs4) + 1;
			*ptr3 = -86;
			ptr3[1] = -86;
			ptr3[2] = -86;
			((int*)(&fputil_DyadicFloat_cs3nhs4))[1] = -1431655766;
			((int*)(&fputil_DyadicFloat_cs3nhs4))[2] = -1431655766;
			llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb20, &anon_izyfb8, 1L, isVolatile: false);
			int e = num4;
			BigInt_32ul_false_unsigned_int_BigInt_unsigned_int_void_unsigned_int.Invoke(&bigInt_vtm4cw3, num5);
			fputil_DyadicFloat_32ul_DyadicFloat_Sign_int_BigInt_32ul_false_unsigned_int.Invoke(&fputil_DyadicFloat_cs3nhs4, anon_izyfb20.val, e, *(int*)(&bigInt_vtm4cw3.val.Data));
			llvm_lifetime_start_p0.Invoke(4L, &bigInt_vtm4cw4);
			BigInt_32ul_false_unsigned_int_BigInt_unsigned_int_void_unsigned_int.Invoke(&bigInt_vtm4cw4, (num6 != 0) ? 1 : 0);
			int data3 = operator_BigInt_32ul_false_unsigned_int_BigInt_32ul_false_unsigned_int_const.Invoke(&fputil_DyadicFloat_cs3nhs4.mantissa, &bigInt_vtm4cw4);
			*(int*)(&bigInt_vtm4cw5.val.Data) = data3;
			llvm_lifetime_end_p0.Invoke(4L, &bigInt_vtm4cw4);
			result = Float16_fputil_DyadicFloat_32ul_as_Float16_true_void_const.Invoke(&fputil_DyadicFloat_cs3nhs4);
			llvm_lifetime_end_p0.Invoke(12L, &fputil_DyadicFloat_cs3nhs4);
