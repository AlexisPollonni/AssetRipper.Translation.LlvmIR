...
internal static partial class cpp_enable_if_cpp_is_integral_v_unsigned_short_cpp_is_same_v_unsigned_short_bool_unsigned_short_type_BigInt_256ul_false_unsigned_long_to_unsigned_short_const
{
	public unsafe static short Invoke(void* @this)
	{
		...
		num2 = unchecked((short)(*(long*)cpp_array_unsigned_long_4ul_operator_unsigned_long_const.Invoke(&((BigInt_x9dsed*)@this)->val, 0L)));
		short result = num2;
