...
internal static partial class Generic_add_or_sub_true_Float16_double
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("y")][NativeType("double")] double Y)
	{
			...
			*(long*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			else if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)))
			{
				...
				else
				{
					...
					num6 = Y;
					num6 = 0.0 - num6;
					result = Fputil_cast_Float16_double.Invoke(num6);
			...
			else
			{
				...
				num7 = Y;
				num7 = 0.0 - num7;
				result = Fputil_cast_Float16_double.Invoke(num7);
		...
		unchecked
		{
			...
			double num17 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm3);
			...
			double num18 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm4);
			...
			else
			{
				...
				*(long*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm5) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm5, *(double*)Cpp_max_double.Invoke(&num8, &num9));
				...
				*(long*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm6) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm6, *(double*)Cpp_min_double.Invoke(&num8, &num9));
				...
				else
				{
					...
					num11 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm5)) << 3;
					Llvm_lifetime_start_p0.Invoke(8L, &num12);
					num12 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm6)) << 3;
				...
				checked
				{
					num16 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_exponent.Invoke(unchecked((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm5))) - 55;
				...
				*ptr = -86;
				...
				int e = num16;
				BigInt_64ul_false_unsigned_long_BigInt_unsigned_long_void.Invoke(&llvm_libc_20_1_2_BigInt_555ggs, num10);
