...
internal static partial class fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_exponent_const
{
	public unsafe static int Invoke(void* @this)
	{
		...
		*unchecked((int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2)) = -1431655766;
		...
		if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero_const.Invoke(@this))
		{
			llvm_lifetime_start_p0.Invoke(4L, &fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent4);
			int field_3 = fputil_internal_FPStorage_fputil_FPType_4_Exponent_zero.Invoke();
		...
		int field_4 = fputil_internal_FPStorage_fputil_FPType_4_Exponent_subnormal.Invoke();
		...
		if (num)
		{
			...
			int field_5 = fputil_internal_FPStorage_fputil_FPType_4_Exponent_min.Invoke();
