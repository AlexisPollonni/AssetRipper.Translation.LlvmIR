...
internal static partial class scanf_core_write_int_with_length
{
	...
	public unsafe static void Invoke([NativeType("unsigned long")] long output_val, [NativeType("__llvm_libc_20_1_2_::scanf_core::FormatSection const&")] scanf_core_FormatSection* to_conv)
	{
		void* ptr = null;
		int num = 0;
		unchecked
