...
internal static partial class vscanf
{
	public unsafe static int Invoke(void* format, va_list_tag* vlist)
	{
		...
		unchecked
		{
			...
			*(IntPtr*)((byte*)ptr + 16) = unchecked((nint)(-6148914691236517206L));
			...
			num = scanf_core_vfscanf_internal_IO_FILE_char_const_internal_ArgList.Invoke(stdin.Value, format, &internal_ArgList2);
