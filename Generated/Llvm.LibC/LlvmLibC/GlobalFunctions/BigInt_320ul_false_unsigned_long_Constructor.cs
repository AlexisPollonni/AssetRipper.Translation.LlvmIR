...
internal static partial class BigInt_320ul_false_unsigned_long_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_76gxx6* This, [MangledName("words")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 5ul> const&")] Llvm_libc_20_1_2_cpp_array_msasyg* Words)
	{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_76gxx6* This)
	{
		Llvm_memset_p0_i64.Invoke(&This->Val.Data, 0, 40L, isVolatile: false);
	}
}
