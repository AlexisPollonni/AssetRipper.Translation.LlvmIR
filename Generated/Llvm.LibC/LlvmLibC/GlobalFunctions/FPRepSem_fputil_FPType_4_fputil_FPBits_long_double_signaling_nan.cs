	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte sign, [MangledName("v.coerce0")][NativeType("__llvm_libc_20_1_2_::Sign")] long v, [MangledName("v.coerce1")][NativeType("unsigned __int128")] long v_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = v;
			...
			{
				int2 = int5;
				Significand_Constructor_j3ersh.Invoke(&fputil_internal_FPRepSem_f94eua4, *(long*)(&int2), ((long*)(&int2))[1]);
			}
			else
			{
				...
				Struct_fiz2nb struct_fiz2nb7 = internal_RightShift_7akpcn.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua5), ((long*)(&fputil_internal_FPRepSem_f94eua5))[1], 2);
			...
			Struct_fiz2nb struct_fiz2nb13 = FPStorage_fputil_FPType_4_encode.Invoke(anon_izyfb9.val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1]);
			Int128* num = &int3;
			...
			*(long*)num2 = struct_fiz2nb15.field_1;
			int4 = int3;
			FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int4), ((long*)(&int4))[1]);
