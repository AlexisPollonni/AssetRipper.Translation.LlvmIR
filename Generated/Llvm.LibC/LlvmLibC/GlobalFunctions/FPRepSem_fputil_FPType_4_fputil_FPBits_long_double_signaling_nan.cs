	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte Sign, [MangledName("v.coerce0")][NativeType("__llvm_libc_20_1_2_::Sign")] long V, [MangledName("v.coerce1")][NativeType("unsigned __int128")] long V_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = V;
			...
			{
				int2 = int5;
				Significand_Constructor_j3ersh.Invoke(&fputil_internal_FPRepSem_f94eua3, *(long*)(&int2), ((long*)(&int2))[1]);
			}
			else
			{
				...
				Struct_fiz2nb struct_fiz2nb7 = Internal_RightShift_7akpcn.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua4), ((long*)(&fputil_internal_FPRepSem_f94eua4))[1], 2);
				Int128* ptr3 = &fputil_internal_FPRepSem_f94eua3.FPStorage.field_0;
				Struct_fiz2nb struct_fiz2nb8 = struct_fiz2nb7;
				((Struct_fiz2nb*)ptr3)->field_0 = struct_fiz2nb8.field_0;
				Struct_fiz2nb struct_fiz2nb9 = struct_fiz2nb7;
				((Struct_fiz2nb*)ptr3)->field_1 = struct_fiz2nb9.field_1;
			}
			Struct_fiz2nb struct_fiz2nb10 = Internal_BitwiseOr_qsntgr.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1], *(long*)(&fputil_internal_FPRepSem_f94eua3), ((long*)(&fputil_internal_FPRepSem_f94eua3))[1]);
			Int128* ptr4 = &fputil_internal_FPRepSem_f94eua.FPStorage.field_0;
			Struct_fiz2nb struct_fiz2nb11 = struct_fiz2nb10;
			((Struct_fiz2nb*)ptr4)->field_0 = struct_fiz2nb11.field_0;
			Struct_fiz2nb struct_fiz2nb12 = struct_fiz2nb10;
			((Struct_fiz2nb*)ptr4)->field_1 = struct_fiz2nb12.field_1;
			Struct_fiz2nb struct_fiz2nb13 = FPStorage_fputil_FPType_4_encode.Invoke(anon_izyfb2.Val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua), ((long*)(&fputil_internal_FPRepSem_f94eua))[1]);
			Int128* num = &int3;
			...
			*(long*)num2 = struct_fiz2nb15.field_1;
			int4 = int3;
			FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi, *(long*)(&int4), ((long*)(&int4))[1]);
