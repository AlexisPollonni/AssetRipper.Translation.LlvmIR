...
internal static partial class FPStorage_fputil_FPType_0_encode
{
	...
	public unsafe static short Invoke([MangledName("value.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::Significand")] short value)
	{
		...
		return unchecked((short)((ushort)TypedInt_unsigned_short_to_storage_type.Invoke(&fputil_internal_FPRepSem_i7nz4h2) & 0x3FF));
	}
	...
	public unsafe static short Invoke([MangledName("exp.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::BiasedExponent")] int exp)
	{
		...
		return unchecked((short)(((ushort)TypedInt_unsigned_int_to_storage_type_wwhq92.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2) << 10) & 0x7C00));
	}
	...
	public unsafe static short Invoke([MangledName("exp.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::BiasedExponent")] int exp, [MangledName("sig.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::Significand")] short sig)
	{
		...
		unchecked
		{
			ushort num = (ushort)Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3.field_0.field_0);
			llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepSem_i7nz4h3, &fputil_internal_FPRepSem_i7nz4h2, 2L, isVolatile: false);
			return (short)(num | (ushort)Invoke(fputil_internal_FPRepSem_i7nz4h3.FPStorage.field_0));
		}
	}
	...
	public unsafe static short Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign, [MangledName("exp.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::BiasedExponent")] int exp, [MangledName("sig.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::Significand")] short sig)
	{
		...
		if (Sign_is_neg.Invoke(&anon_izyfb8))
		{
			llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3, &fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2, 4L, isVolatile: false);
			llvm_memcpy_p0_p0_i64.Invoke(&fputil_internal_FPRepSem_i7nz4h3, &fputil_internal_FPRepSem_i7nz4h2, 2L, isVolatile: false);
			return unchecked((short)(0x8000 | (ushort)Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3.field_0.field_0, fputil_internal_FPRepSem_i7nz4h3.FPStorage.field_0)));
		}
		...
		return Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent4.field_0.field_0, fputil_internal_FPRepSem_i7nz4h4.FPStorage.field_0);
	}
}
