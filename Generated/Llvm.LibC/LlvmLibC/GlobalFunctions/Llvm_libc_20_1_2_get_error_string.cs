...
internal static partial class Llvm_libc_20_1_2_get_error_string
{
	...
	public unsafe static Struct_kqhe8i Invoke([MangledName("err_num")][NativeType("int")] int Err_num)
	{
		...
		Span_char_Constructor.Invoke(&llvm_libc_20_1_2_cpp_string_view2, Llvm_threadlocal_address_p0.Invoke(Llvm_libc_20_1_2_internal_error_buffer.Pointer), 26L);
		unchecked
		{
			Struct_kqhe8i struct_kqhe8i = Invoke(Err_num, *(void**)(&llvm_libc_20_1_2_cpp_string_view2), ((long*)(&llvm_libc_20_1_2_cpp_string_view2))[1]);
	...
	public unsafe static Struct_kqhe8i Invoke([MangledName("err_num")] int Err_num, [MangledName("buffer.coerce0")][NativeType("int")] void* Buffer, [MangledName("buffer.coerce1")][NativeType("__llvm_libc_20_1_2_::cpp::span<char>")] long Opt_str)
	{
		...
		unchecked
		{
			...
			*ptr3 = -86;
			...
			ptr3[5] = -86;
			ptr3[6] = -86;
			MessageMapper_134ul_3113ul_get_str.Invoke(&llvm_libc_20_1_2_cpp_optional_bnt67x, (Llvm_libc_20_1_2_MessageMapper_8a2hs7*)Llvm_libc_20_1_2_internal_ERROR_MAPPER.Pointer, Err_num);
			...
			else
			{
				...
				Struct_kqhe8i struct_kqhe8i = Internal_build_error_string.Invoke(Err_num, *(void**)(&llvm_libc_20_1_2_cpp_string_view3), ((long*)(&llvm_libc_20_1_2_cpp_string_view3))[1]);
				Llvm_libc_20_1_2_cpp_string_view* num = &llvm_libc_20_1_2_cpp_string_view;
				Struct_kqhe8i struct_kqhe8i2 = struct_kqhe8i;
				*(void**)num = struct_kqhe8i2.field_0;
				byte* num2 = (byte*)(&llvm_libc_20_1_2_cpp_string_view) + 8u;
