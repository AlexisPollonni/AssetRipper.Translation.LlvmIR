...
internal static partial class Fputil_ldexp_double_long
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("exp")][NativeType("long")] long Exp)
	{
		...
		fputil_DyadicFloat_syracv.Exponent += unchecked((int)Exp);
