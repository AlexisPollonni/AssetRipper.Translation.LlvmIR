			...
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			else
			{
				...
				*ptr2 = -86;
				...
				fputil_NormalFloat_double_NormalFloat_fputil_FPBits_double.Invoke(&fputil_NormalFloat_vc4yvk2, fputil_FPBits_wjhbrm3.FPRepImpl.FPRepSem.FPStorage.val);
				*(int*)exp = checked(fputil_NormalFloat_vc4yvk2.exponent + 1);
				fputil_NormalFloat_vc4yvk2.exponent = -1;
				result = fputil_NormalFloat_double_operator_double_const.Invoke(&fputil_NormalFloat_vc4yvk2);
