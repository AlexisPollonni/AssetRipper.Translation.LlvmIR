			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				else
				{
					...
					b = ((((ushort)fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) & (1 << num2 - 1)) != 0) ? ((sbyte)1) : ((sbyte)0));
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2))) ? ((Half)((float)half + 1f)) : ((Half)((float)half - 1f))) : half);
