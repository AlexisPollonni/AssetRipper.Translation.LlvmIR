...
internal static partial class Float16_fputil_round_Float16_0_Float16
{
			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				else if (num == -1)
				{
					...
					short field_ = fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_one_Sign.Invoke(anon_izyfb8.val);
				...
				else
				{
					...
					b = ((((ushort)fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa_const.Invoke(&fputil_FPBits_2fahva2) & (1 << num2 - 1)) != 0) ? ((sbyte)1) : ((sbyte)0));
					...
					{
						fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_uintval_unsigned_short.Invoke(&fputil_FPBits_2fahva2, num4);
						llvm_lifetime_start_p0.Invoke(2L, &half);
						half = fputil_FPBits_Float16_get_val_const.Invoke(&fputil_FPBits_2fahva2);
						result = (((b & 1) == 1) ? ((!fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg_const.Invoke(&fputil_FPBits_2fahva2)) ? ((Half)((float)half + 1f)) : ((Half)((float)half - 1f))) : half);
