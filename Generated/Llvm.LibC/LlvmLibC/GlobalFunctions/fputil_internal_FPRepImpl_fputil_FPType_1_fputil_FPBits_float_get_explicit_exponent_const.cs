...
internal static partial class fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_explicit_exponent_const
{
	public unsafe static int Invoke(void* @this)
	{
		...
		*unchecked((int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2)) = -1431655766;
		...
		int field_2 = fputil_internal_FPStorage_fputil_FPType_1_BiasedExponent_operator_fputil_internal_FPStorage_fputil_FPType_1_Exponent_const.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3);
		...
		if (fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero_const.Invoke(@this))
		{
			llvm_lifetime_start_p0.Invoke(4L, &fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent4);
			int field_3 = fputil_internal_FPStorage_fputil_FPType_1_Exponent_zero.Invoke();
		...
		int field_4 = fputil_internal_FPStorage_fputil_FPType_1_Exponent_subnormal.Invoke();
		...
		if (num)
		{
			...
			int field_5 = fputil_internal_FPStorage_fputil_FPType_1_Exponent_min.Invoke();
		...
		int result = fputil_internal_FPStorage_fputil_FPType_1_TypedInt_int_operator_int_const.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2);
