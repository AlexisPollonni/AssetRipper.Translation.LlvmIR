...
internal static partial class FloatWriter_write_middle_block
{
	...
	public unsafe static int Invoke(printf_core_FloatWriter* @this, [NativeType("unsigned int")] int block)
	{
		int result = 0;
		int num = 0;
		...
		unchecked
		{
			...
			else
			{
				...
				*(long*)num5 = struct_kqhe8i3.field_1;
				...
				{
					sbyte b = *(sbyte*)string_view_Index.Invoke(&cpp_string_view2, num2 + 1L);
