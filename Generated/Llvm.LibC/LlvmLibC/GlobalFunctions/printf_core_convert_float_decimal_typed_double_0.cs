					...
					if ((uint)num10 < (uint)num9)
					{
						...
						else
						{
							...
							else
							{
								...
								b3 = (sbyte)(byte)((printf_core_zero_after_digits_unsigned_long.Invoke(checked(num2 - 52), num3, FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)), 52) ? 1 : 0) ^ -1);
