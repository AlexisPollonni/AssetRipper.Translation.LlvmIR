...
{
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_jhcpjj* agg_result, void* a, void* b)
	{
		...
		unchecked
		{
			llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb8, &((fputil_DyadicFloat_jhcpjj*)a)->sign, 1L, isVolatile: false);
			llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, &((fputil_DyadicFloat_jhcpjj*)b)->sign, 1L, isVolatile: false);
		...
		agg_result->exponent = unchecked((fputil_DyadicFloat_jhcpjj*)a)->exponent + unchecked((fputil_DyadicFloat_jhcpjj*)b)->exponent + 256;
		unchecked
		{
			if (!BigInt_256ul_false_unsigned_long_is_zero_const.Invoke(&((fputil_DyadicFloat_jhcpjj*)a)->mantissa) && !BigInt_256ul_false_unsigned_long_is_zero_const.Invoke(&((fputil_DyadicFloat_jhcpjj*)b)->mantissa))
			{
				llvm_lifetime_start_p0.Invoke(32L, &bigInt_x9dsed);
				BigInt_256ul_false_unsigned_long_quick_mul_hi_BigInt_256ul_false_unsigned_long_const_const.Invoke(&bigInt_x9dsed, &((fputil_DyadicFloat_jhcpjj*)a)->mantissa, &((fputil_DyadicFloat_jhcpjj*)b)->mantissa);
				...
				if (*(long*)cpp_array_unsigned_long_4ul_operator_unsigned_long.Invoke(&agg_result->mantissa.val, 3L) >>> 63 == 0L)
				{
