...
internal static partial class Float16_fputil_DyadicFloat_16ul_fast_as_Float16_true_void_const
{
	public unsafe static Half Invoke(void* @this)
	{
		...
		BigInt_ys7s55 bigInt_ys7s2 = default(BigInt_ys7s55);
		BigInt_ys7s55 bigInt_ys7s3 = default(BigInt_ys7s55);
		BigInt_ys7s55 bigInt_ys7s4 = default(BigInt_ys7s55);
		BigInt_ys7s55 bigInt_ys7s5 = default(BigInt_ys7s55);
		sbyte b2 = 0;
		BigInt_ys7s55 bigInt_ys7s6 = default(BigInt_ys7s55);
		sbyte b3 = 0;
		BigInt_ys7s55 bigInt_ys7s7 = default(BigInt_ys7s55);
		int num6 = 0;
		Half x = default(Half);
		int num7 = 0;
		...
		{
			Half result;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(BigInt_16ul_false_unsigned_short_is_zero_const.Invoke(&((fputil_DyadicFloat_jvghxm*)@this)->mantissa), expected: false))
			{
				llvm_lifetime_start_p0.Invoke(2L, &fputil_FPBits_2fahva2);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb8, &((fputil_DyadicFloat_jvghxm*)@this)->sign, 1L, isVolatile: false);
			...
			else
			{
				...
				checked
				{
					num3 = unchecked((fputil_DyadicFloat_jvghxm*)@this)->exponent + 30;
				}
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num3 > 30, expected: false))
				{
					...
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, &((fputil_DyadicFloat_jvghxm*)@this)->sign, 1L, isVolatile: false);
				...
				else
				{
					...
					*(short*)(&bigInt_ys7s) = -21846;
					...
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void_int.Invoke(&bigInt_ys7s, 0);
					}
					else
					{
						short data = BigInt_16ul_false_unsigned_short_operator_unsigned_long_const_4jf2a2.Invoke(&((fputil_DyadicFloat_jvghxm*)@this)->mantissa, (uint)num4);
						*(short*)(&bigInt_ys7s.val.Data) = data;
					}
					llvm_lifetime_start_p0.Invoke(2L, &half4);
					llvm_lifetime_start_p0.Invoke(2L, &fputil_FPBits_2fahva5);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb10, &((fputil_DyadicFloat_jvghxm*)@this)->sign, 1L, isVolatile: false);
					short field_3 = fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value_Sign_unsigned_short_unsigned_short.Invoke(biased_exp: (short)num3, mantissa: (short)(((ushort)BigInt_16ul_false_unsigned_short_operator_unsigned_short_unsigned_short_const.Invoke(&bigInt_ys7s) & 0x3FF) | 0), sign: anon_izyfb10.val);
					...
					half4 = half9;
					llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s2);
					*(short*)(&bigInt_ys7s2) = -21846;
					bool num11 = (ulong)(uint)num4 > 16uL;
					llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s3);
					if (num11)
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void_int.Invoke(&bigInt_ys7s2, 0);
					}
					else
					{
						BigInt_16ul_false_unsigned_short_BigInt_int_void_int.Invoke(&bigInt_ys7s3, 1);
						short data2 = BigInt_16ul_false_unsigned_short_operator_unsigned_long_const_vwn7qt.Invoke(&bigInt_ys7s3, (uint)(num4 - 1));
						*(short*)(&bigInt_ys7s2.val.Data) = data2;
					}
					llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s3);
					llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s4);
					*(short*)(&bigInt_ys7s4) = -21846;
					llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s5);
					BigInt_16ul_false_unsigned_short_BigInt_int_void_int.Invoke(&bigInt_ys7s5, 1);
					short data3 = BigInt_16ul_false_unsigned_short_operator_BigInt_16ul_false_unsigned_short_const.Invoke(&bigInt_ys7s2, &bigInt_ys7s5);
					*(short*)(&bigInt_ys7s4.val.Data) = data3;
					llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s5);
					llvm_lifetime_start_p0.Invoke(1L, &b2);
					llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s6);
					short data4 = operator_BigInt_16ul_false_unsigned_short_const_BigInt_16ul_false_unsigned_short_const.Invoke(&((fputil_DyadicFloat_jvghxm*)@this)->mantissa, &bigInt_ys7s2);
					*(short*)(&bigInt_ys7s6.val.Data) = data4;
					int num12 = (BigInt_16ul_false_unsigned_short_is_zero_const.Invoke(&bigInt_ys7s6) ? 1 : 0) ^ -1;
					llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s6);
					b2 = (sbyte)(byte)num12;
					llvm_lifetime_start_p0.Invoke(1L, &b3);
					llvm_lifetime_start_p0.Invoke(2L, &bigInt_ys7s7);
					short data5 = operator_BigInt_16ul_false_unsigned_short_const_BigInt_16ul_false_unsigned_short_const.Invoke(&((fputil_DyadicFloat_jvghxm*)@this)->mantissa, &bigInt_ys7s4);
					*(short*)(&bigInt_ys7s7.val.Data) = data5;
					int num13 = (BigInt_16ul_false_unsigned_short_is_zero_const.Invoke(&bigInt_ys7s7) ? 1 : 0) ^ -1;
					llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s7);
					b3 = (sbyte)(byte)num13;
					...
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num5 <= 0, expected: false))
					{
						...
						llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb13, &((fputil_DyadicFloat_jvghxm*)@this)->sign, 1L, isVolatile: false);
					...
					else
					{
						...
						llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb14, &((fputil_DyadicFloat_jvghxm*)@this)->sign, 1L, isVolatile: false);
					...
					llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s4);
					llvm_lifetime_end_p0.Invoke(2L, &bigInt_ys7s2);
