...
internal static partial class Float16_fputil_DyadicFloat_16ul_fast_as_Float16_true_void_const
{
	public unsafe static Half Invoke(fputil_DyadicFloat_jvghxm* @this)
	{
		...
		Half result;
		if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(BigInt_16ul_false_unsigned_short_is_zero_const.Invoke(&@this->mantissa), expected: false))
		{
			...
			unchecked
			{
				...
				else
				{
					...
					*(short*)(&bigInt_ys7s) = -21846;
					...
					{
						short data = BigInt_16ul_false_unsigned_short_operator_unsigned_long_const_4jf2a2.Invoke(&@this->mantissa, (uint)num4);
					...
					*(short*)(&bigInt_ys7s4.val.Data) = data3;
					...
					short data4 = operator_BigInt_16ul_false_unsigned_short_const_BigInt_16ul_false_unsigned_short_const.Invoke(&@this->mantissa, &bigInt_ys7s2);
					*(short*)(&bigInt_ys7s6.val.Data) = data4;
					...
					short data5 = operator_BigInt_16ul_false_unsigned_short_const_BigInt_16ul_false_unsigned_short_const.Invoke(&@this->mantissa, &bigInt_ys7s4);
