...
internal static partial class BigInt_16512ul_false_unsigned_long_to_unsigned_int
{
	...
	public unsafe static int Invoke([MangledName("this")] BigInt_q8g275* This)
	{
		long num = 0L;
		int num2 = 0;
		...
		num2 = unchecked((int)(*(long*)Array_unsigned_long_258ul_Index_7gdq4k.Invoke(&This->Val, 0L)));
		int result = num2;
