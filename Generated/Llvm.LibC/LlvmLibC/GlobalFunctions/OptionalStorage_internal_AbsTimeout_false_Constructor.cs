...
internal static partial class OptionalStorage_internal_AbsTimeout_false_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_cpp_optional_long_double_OptionalStorage* This)
	{
		unchecked
		{
			*(sbyte*)(&((Llvm_libc_20_1_2_cpp_optional_internal_AbsTimeout_OptionalStorage*)This)->field) = 0;
			((Llvm_libc_20_1_2_cpp_optional_internal_AbsTimeout_OptionalStorage*)This)->In_use = 0;
		}
	}
}
