...
internal static partial class StrToNumResult_unsigned_long_long_internal_strtointeger_unsigned_long_long_char_const_int_unsigned_long
{
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_gbeb3a* agg_result, void* src, int @base, long src_len)
	{
		...
		unchecked
		{
			if (src_len == 0L)
			{
				StrToNumResult_unsigned_long_long_StrToNumResult_unsigned_long_long_long_int.Invoke(agg_result, 0L, 0L, 0);
			}
			else if (num8 < 0 || num8 == 1 || num8 > 36)
			{
				StrToNumResult_unsigned_long_long_StrToNumResult_unsigned_long_long_long_int.Invoke(agg_result, 0L, 0L, 22);
			}
			else
			{
				...
				if (num3 == 34)
				{
					...
					{
						StrToNumResult_unsigned_long_long_StrToNumResult_unsigned_long_long_long_int.Invoke(agg_result, cpp_internal_integer_impl_unsigned_long_long_0ull_18446744073709551615ull_max.Invoke(), parsed_len, num3);
					}
					else
					{
						cpp_internal_integer_impl_unsigned_long_long_0ull_18446744073709551615ull_min.Invoke();
						long value;
						long parsed_len2;
						int error;
						StrToNumResult_unsigned_long_long_StrToNumResult_unsigned_long_long_long_int.Invoke(agg_result, value, parsed_len2, error);
					}
				}
				else
				{
					StrToNumResult_unsigned_long_long_StrToNumResult_unsigned_long_long_long_int.Invoke(agg_result, ((b4 & 1) != 1) ? (-num) : num, parsed_len, num3);
				}
