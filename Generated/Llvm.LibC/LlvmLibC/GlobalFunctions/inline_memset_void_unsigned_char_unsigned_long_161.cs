...
internal static partial class inline_memset_void_unsigned_char_unsigned_long_161
{
	public unsafe static void Invoke(void* dst, sbyte value, long count)
	{
		inline_memset_x86_cpp_byte_unsigned_char_unsigned_long_162.Invoke(dst, value, count);
	}
}
