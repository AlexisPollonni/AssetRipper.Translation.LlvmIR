...
internal static partial class ArrayFixedSize_8ul_swap
{
	...
	public unsafe static void Invoke(void* @this, [NativeType("unsigned long")] long i, [NativeType("unsigned long")] long j)
	{
		...
		unchecked
		{
			*(sbyte*)(&inlineArray8_SByte) = -86;
			...
			ptr = ArrayFixedSize_8ul_get_internal.Invoke(@this, i);
			llvm_lifetime_start_p0.Invoke(8L, &ptr2);
			ptr2 = ArrayFixedSize_8ul_get_internal.Invoke(@this, j);
