		...
		unchecked
		{
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			else
			{
				...
				NormalFloat_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie, *(long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2), ((long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2))[1]);
				*(int*)Exp = checked(llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie.Exponent + 1);
				...
				result = NormalFloat_long_double_Long_double.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie);
