...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_signaling_nan_Sign_unsigned_short
{
	public unsafe static short Invoke([MangledName("sign.coerce")] sbyte sign, short v)
	{
		...
		if (num != 0)
		{
			fputil_internal_FPStorage_fputil_FPType_0_Significand_Significand_unsigned_short.Invoke(&fputil_internal_FPRepSem_i7nz4h2, num);
		}
		else
		{
			...
			short field_3 = fputil_internal_operator_fputil_internal_FPStorage_fputil_FPType_0_Significand_int.Invoke(fputil_internal_FPRepSem_i7nz4h3.FPStorage.field_0, 1);
