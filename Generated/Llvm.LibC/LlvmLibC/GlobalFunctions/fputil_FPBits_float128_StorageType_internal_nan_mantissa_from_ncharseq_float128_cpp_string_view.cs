...
internal static partial class fputil_FPBits_float128_StorageType_internal_nan_mantissa_from_ncharseq_float128_cpp_string_view
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("ncharseq.coerce0")] void* ncharseq, [MangledName("ncharseq.coerce1")] long nan_mantissa)
	{
		...
		unchecked
		{
			*(void**)(&cpp_string_view2) = ncharseq;
			...
			@int = 0L;
			if (cpp_string_view_data_const.Invoke(&cpp_string_view2) != null && internal_isdigit_int.Invoke(*(sbyte*)cpp_string_view_operator_unsigned_long_const.Invoke(&cpp_string_view2, 0L)))
			{
