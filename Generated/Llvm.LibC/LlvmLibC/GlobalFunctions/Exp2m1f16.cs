	...
	public unsafe static Half Invoke([MangledName("x")] Half X)
	{
		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			if (!Details_expects_bool_condition_bool.Invoke(((uint)(ushort)num2 > 12288u) ? ((uint)(ushort)num2 >= 18816u) : true, Expected: false))
			{
				goto IL_05a4;
			}
			...
			else if ((ushort)num >= 19456 && FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)))
			{
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_6ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_EXP2M1F16_EXCEPTS_LO.Pointer);
		...
		unchecked
		{
			...
			*(Half*)ptr2 = default(Half);
			ptr2[2] = -86;
			ptr2[3] = -86;
			int storage2 = ExceptValues_Float16_7ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_EXP2M1F16_EXCEPTS_HI.Pointer);
			*(int*)(&llvm_libc_20_1_2_cpp_optional_aq7wey2.Storage) = storage2;
			...
			case 0:
				...
				*(InlineArray2_Single*)(&llvm_libc_20_1_2_ExpRangeReduction) = Llvm_libc_20_1_2_exp2_range_reduction.Invoke(X);
