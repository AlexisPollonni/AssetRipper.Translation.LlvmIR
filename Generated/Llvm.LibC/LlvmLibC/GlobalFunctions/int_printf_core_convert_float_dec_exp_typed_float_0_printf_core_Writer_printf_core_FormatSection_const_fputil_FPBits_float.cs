	...
	public unsafe static int Invoke(void* writer, void* to_conv, [MangledName("float_bits.coerce")] int float_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				num18 = printf_core_FloatWriter_write_last_block_unsigned_int_unsigned_long_printf_core_RoundDirection_int_char.Invoke(&printf_core_FloatWriter2, num7, num13, num16, num5, InstructionHelper.Select(internal_islower_int_168.Invoke(((printf_core_FormatSection*)to_conv)->conv_name), (sbyte)101, (sbyte)69));
				if (num18 < 0)
				{
					result = num18;
					num22 = 1;
