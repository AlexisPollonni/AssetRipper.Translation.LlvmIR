...
internal static partial class DyadicFloat_128ul_DyadicFloat_float_0
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_DyadicFloat_kt2kd4* This, [MangledName("x")][NativeType("float")] float X)
	{
		...
		BigInt_128ul_false_unsigned_long_BigInt_unsigned_int_void.Invoke(unchecked((Anon_izyfb7*)(&bigInt_qdkjbh)), FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs));
