...
internal static partial class fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value_Sign_unsigned_long_unsigned_long
{
	public unsafe static long Invoke([MangledName("sign.coerce")] sbyte sign, long biased_exp, long mantissa)
	{
		...
		fputil_internal_FPStorage_fputil_FPType_2_BiasedExponent_BiasedExponent_unsigned_int.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2, unchecked((int)biased_exp));
		fputil_internal_FPStorage_fputil_FPType_2_Significand_Significand_unsigned_long.Invoke(&fputil_internal_FPRepSem_fq8nhg2, mantissa);
