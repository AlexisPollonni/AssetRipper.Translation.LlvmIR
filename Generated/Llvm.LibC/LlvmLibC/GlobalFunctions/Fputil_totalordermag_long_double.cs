...
internal static partial class Fputil_totalordermag_long_double
{
	...
	public unsafe static bool Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("y")][NativeType("long double")] double Y)
	{
		...
		Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&fputil_FPBits_ubgsi2);
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			...
			Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&fputil_FPBits_ubgsi4);
