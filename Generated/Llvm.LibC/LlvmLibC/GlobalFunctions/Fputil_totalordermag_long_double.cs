...
internal static partial class Fputil_totalordermag_long_double
{
	...
	public unsafe static bool Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("y")][NativeType("long double")] double Y)
	{
		...
		Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb4 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
			Int128* num = &@int;
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			...
			FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4, Y);
			Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4);
