...
internal static partial class fputil_nextafter_long_double_long_double
{
	public unsafe static double Invoke(double from, double to)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi3, from);
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi4, to);
			if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan_const.Invoke(&fputil_FPBits_ubgsi4))
			{
				result = to;
			}
			else
			{
				if (from != to)
				{
					if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit_const.Invoke(&fputil_FPBits_ubgsi3) && fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_subnormal_const.Invoke(&fputil_FPBits_ubgsi3))
					{
						@int = 1L;
						fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&@int), ((long*)(&@int))[1]);
					}
					...
					if (from == 0.0)
					{
						...
						Struct_fiz2nb struct_fiz2nb = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_subnormal_Sign.Invoke(anon_izyfb8.val);
					...
					else if (from < 0.0)
					{
						if (to < from)
						{
							...
							Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_subnormal_Sign.Invoke(anon_izyfb9.val);
							...
							bool num = fputil_internal_operator_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud10), ((long*)(&fputil_internal_FPRepImpl_jrxud10))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud11), ((long*)(&fputil_internal_FPRepImpl_jrxud11))[1]);
							...
							if (num)
							{
								...
								Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_normal_Sign.Invoke(anon_izyfb10.val);
							...
							else
							{
								...
								*(long*)num3 = struct_fiz2nb12.field_1;
								...
								{
									int3 = 0L;
									fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int3), ((long*)(&int3))[1]);
									checked
									{
										int4 = unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi3)) + 1;
									}
									fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int4), ((long*)(&int4))[1]);
									if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf_const.Invoke(&fputil_FPBits_ubgsi3))
									{
								...
								*(long*)num5 = struct_fiz2nb15.field_1;
								...
								fputil_FPBits_long_double_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi8, *(long*)(&int5), ((long*)(&int5))[1]);
						...
						else
						{
							...
							Struct_fiz2nb struct_fiz2nb16 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_normal_Sign.Invoke(anon_izyfb11.val);
							...
							bool num6 = fputil_internal_operator_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud12), ((long*)(&fputil_internal_FPRepImpl_jrxud12))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud13), ((long*)(&fputil_internal_FPRepImpl_jrxud13))[1]);
							...
							if (num6)
							{
								...
								Struct_fiz2nb struct_fiz2nb19 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_subnormal_Sign.Invoke(anon_izyfb12.val);
							...
							{
								Struct_fiz2nb struct_fiz2nb22 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
								Int128* num7 = &x3;
								...
								*(long*)num8 = struct_fiz2nb24.field_1;
								...
								{
									int6 = long.MaxValue;
									fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int6), ((long*)(&int6))[1]);
									checked
									{
										int7 = unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi3)) - 1;
									}
									fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int7), ((long*)(&int7))[1]);
									result = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi3);
									goto IL_0e75;
								}
								llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi11);
								Struct_fiz2nb struct_fiz2nb25 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi3);
								Int128* num9 = &x4;
								...
								*(long*)num10 = struct_fiz2nb27.field_1;
								...
								fputil_FPBits_long_double_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi11, *(long*)(&int8), ((long*)(&int8))[1]);
					...
					else if (to < from)
					{
						...
						Struct_fiz2nb struct_fiz2nb28 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_normal_Sign.Invoke(anon_izyfb13.val);
						...
						bool num11 = fputil_internal_operator_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud14), ((long*)(&fputil_internal_FPRepImpl_jrxud14))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud15), ((long*)(&fputil_internal_FPRepImpl_jrxud15))[1]);
						...
						if (num11)
						{
							...
							Struct_fiz2nb struct_fiz2nb31 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_subnormal_Sign.Invoke(anon_izyfb14.val);
						...
						{
							Struct_fiz2nb struct_fiz2nb34 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
							Int128* num12 = &x5;
							...
							*(long*)num13 = struct_fiz2nb36.field_1;
							...
							{
								int9 = long.MaxValue;
								fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int9), ((long*)(&int9))[1]);
								checked
								{
									int10 = unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi3)) - 1;
								}
								fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int10), ((long*)(&int10))[1]);
								result = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi3);
								goto IL_0e75;
							}
							llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi14);
							Struct_fiz2nb struct_fiz2nb37 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi3);
							Int128* num14 = &x6;
							...
							*(long*)num15 = struct_fiz2nb39.field_1;
							...
							fputil_FPBits_long_double_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi14, *(long*)(&int11), ((long*)(&int11))[1]);
					...
					else
					{
						...
						Struct_fiz2nb struct_fiz2nb40 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_subnormal_Sign.Invoke(anon_izyfb15.val);
						...
						bool num16 = fputil_internal_operator_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud16), ((long*)(&fputil_internal_FPRepImpl_jrxud16))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud17), ((long*)(&fputil_internal_FPRepImpl_jrxud17))[1]);
						...
						if (num16)
						{
							...
							Struct_fiz2nb struct_fiz2nb43 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_normal_Sign.Invoke(anon_izyfb16.val);
						...
						{
							Struct_fiz2nb struct_fiz2nb46 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
							Int128* num17 = &x7;
							...
							*(long*)num18 = struct_fiz2nb48.field_1;
							...
							{
								int12 = 0L;
								fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int12), ((long*)(&int12))[1]);
								checked
								{
									int13 = unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi3)) + 1;
								}
								fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int13), ((long*)(&int13))[1]);
								if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf_const.Invoke(&fputil_FPBits_ubgsi3))
								{
									fputil_raise_except_if_required_int.Invoke(40);
								}
							...
							Struct_fiz2nb struct_fiz2nb49 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi3);
							Int128* num19 = &x8;
							...
							*(long*)num20 = struct_fiz2nb51.field_1;
							...
							fputil_FPBits_long_double_FPBits_unsigned_int128_unsigned_int128.Invoke(&fputil_FPBits_ubgsi17, *(long*)(&int14), ((long*)(&int14))[1]);
