...
internal static partial class Fputil_nextupdown_true_float128_0
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil10nextupdownILb1EgTnNS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT0_EEiE4typeELi0EEES4_S4_")]
	[DemangledName("__float128 __llvm_libc_20_1_2_::fputil::nextupdown<true, __float128, 0>(__float128)")]
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			bool num = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi));
			...
			else
			{
				...
				if (Internal_Equals_svxrxh.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud), ((long*)(&fputil_internal_FPRepImpl_jrxud))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud2), ((long*)(&fputil_internal_FPRepImpl_jrxud2))[1]))
				{
					num2 = 1;
				}
				else
				{
					...
					num2 = (Internal_Equals_svxrxh.Invoke(*(long*)(&fputil_internal_FPRepImpl_jrxud3), ((long*)(&fputil_internal_FPRepImpl_jrxud3))[1], *(long*)(&fputil_internal_FPRepImpl_jrxud4), ((long*)(&fputil_internal_FPRepImpl_jrxud4))[1]) ? 1 : 0);
				}
			}
			...
			else
			{
				if (NumericHelper.IsUnorderedOrNotEquals(X, 0.0))
				{
					...
					if (Equals_fy8fvt.Invoke(anon_izyfb4.Val, anon_izyfb5.Val))
					{
						...
						Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval.Invoke(&fputil_FPBits_ubgsi);
						Int128* num3 = &x;
						...
						*(long*)num4 = struct_fiz2nb9.field_1;
						...
						FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&@int), ((long*)(&@int))[1]);
					...
					else
					{
						...
						*(long*)num6 = struct_fiz2nb12.field_1;
						...
						FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi5, *(long*)(&int2), ((long*)(&int2))[1]);
