...
internal static partial class BigInt_320ul_false_unsigned_long_operator_unsigned_long_9v34k9
{
	public unsafe static void* Invoke(void* @this, long s)
	{
		...
		unchecked
		{
			llvm_memcpy_p0_p0_i64.Invoke(&cpp_array_v97b5b3, &((BigInt_76gxx6*)@this)->val, 40L, isVolatile: false);
			...
			llvm_memcpy_p0_p0_i64.Invoke(&((BigInt_76gxx6*)@this)->val, &cpp_array_v97b5b2, 40L, isVolatile: false);
