...
internal static partial class fputil_modf_Float16_0
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x, [NativeType("_Float16&")] void* iptr)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			Half result;
			if (FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2)) || FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2)))
			{
				*(Half*)iptr = x;
				result = x;
			}
