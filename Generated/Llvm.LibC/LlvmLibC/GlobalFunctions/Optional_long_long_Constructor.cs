...
internal static partial class Optional_long_long_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("t")][NativeType("long long&&")] void* T)
	{
		unchecked
		{
			OptionalStorage_long_long_false_OptionalStorage_long_long.Invoke(&((Llvm_libc_20_1_2_cpp_optional_d6hvji*)This)->Storage, Cpp_move_long_long.Invoke(T));
	...
	{
		OptionalStorage_long_long_false_OptionalStorage.Invoke(&unchecked((Llvm_libc_20_1_2_cpp_optional_d6hvji*)This)->Storage);
	}
}
