	...
	public unsafe static double Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("y")][NativeType("double")] double Y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			double result = ((!NotEquals_rpctvi.Invoke(anon_izyfb.Val, anon_izyfb2.Val)) ? ((!(X > Y)) ? Y : X) : ((!FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_pos.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm))) ? Y : X));
