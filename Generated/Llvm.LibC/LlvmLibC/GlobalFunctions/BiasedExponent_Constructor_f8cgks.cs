...
internal static partial class BiasedExponent_Constructor_f8cgks
{
	...
	public unsafe static void Invoke(void* @this, [MangledName("exp.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)1>::Exponent")] int exp)
	{
		...
		TypedInt_unsigned_int_Constructor_znza9e.Invoke(@this, TypedInt_int_ToInt32_626vzq.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2) + 127);
	}
}
