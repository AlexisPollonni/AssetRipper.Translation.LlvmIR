...
{
	public unsafe static int Invoke(void* buffer, long buffsz, void* format, va_list_tag* vlist)
	{
		...
		unchecked
		{
			...
			*(IntPtr*)((byte*)ptr + 16) = unchecked((nint)(-6148914691236517206L));
			...
			WriteBuffer_Constructor.Invoke(&printf_core_WriteBuffer2, buffer, ((ulong)buffsz <= 0uL) ? 0L : (buffsz - 1L));
			...
			*ptr2 = -86;
			...
			num = printf_core_printf_main.Invoke(&printf_core_Writer2, format, &internal_ArgList2);
			if ((ulong)buffsz > 0uL)
			{
