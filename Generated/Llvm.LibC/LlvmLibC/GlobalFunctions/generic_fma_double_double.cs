...
internal static partial class generic_fma_double_double
{
	...
	public unsafe static double Invoke([NativeType("double")] double x, [NativeType("double")] double y, [NativeType("double")] double z)
	{
		int num = 0;
		long num2 = 0L;
		long num3 = 0L;
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm2, num15);
			llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm3);
			*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
			FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm3, num16);
			llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm4);
			*(long*)(&fputil_FPBits_wjhbrm4) = -6148914691236517206L;
			FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm4, num17);
			double result;
			if (details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)) ? true : ((!FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3))) ? FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)) : true), expected: false) && (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3))))
			{
				if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_signaling_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_signaling_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3)) || FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_signaling_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)))
				{
				...
				if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_quiet_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)))
				{
					...
					long val = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(v: num4, sign: anon_izyfb8.val);
				...
				else if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_quiet_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3)))
				{
					...
					long val2 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(v: num5, sign: anon_izyfb9.val);
				...
				else if (FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_quiet_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)))
				{
					llvm_lifetime_start_p0.Invoke(8L, &num6);
					num6 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm4));
					num6 >>>= 0;
					llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm7);
					anon_izyfb10.val = FPStorage_fputil_FPType_2_sign.Invoke(&fputil_FPBits_wjhbrm4);
					long val3 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(v: num6, sign: anon_izyfb10.val);
			...
			{
				result = fputil_cast_double_double.Invoke(llvm_fmuladd_f64.Invoke(num15, num16, num17));
			}
			else
			{
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm9, num15);
				bool num18 = details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_subnormal.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm9)), expected: false);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm10, num16);
				bool num19 = details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_subnormal.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm10)), expected: false);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm11, num17);
				bool num20 = details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_subnormal.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm11)), expected: false);
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm12, num15);
				llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_wjhbrm2, &fputil_FPBits_wjhbrm12, 8L, isVolatile: false);
				llvm_lifetime_end_p0.Invoke(8L, &fputil_FPBits_wjhbrm12);
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm13);
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm13, num16);
				llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_wjhbrm3, &fputil_FPBits_wjhbrm13, 8L, isVolatile: false);
				llvm_lifetime_end_p0.Invoke(8L, &fputil_FPBits_wjhbrm13);
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm14);
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm14, num17);
				llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_wjhbrm4, &fputil_FPBits_wjhbrm14, 8L, isVolatile: false);
				llvm_lifetime_end_p0.Invoke(8L, &fputil_FPBits_wjhbrm14);
				llvm_lifetime_start_p0.Invoke(1L, &anon_izyfb12);
				*(sbyte*)(&anon_izyfb12) = -86;
				anon_izyfb12.val = FPStorage_fputil_FPType_2_sign.Invoke(&fputil_FPBits_wjhbrm4);
				...
				*(sbyte*)(&anon_izyfb13) = -86;
				...
				anon_izyfb15.val = FPStorage_fputil_FPType_2_sign.Invoke(&fputil_FPBits_wjhbrm3);
				...
				int num21 = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
				num7 = checked(num7 + num21);
				int num22 = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3));
				num8 = checked(num8 + num22);
				int num23 = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm4));
				...
				else
				{
					...
					v = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2));
					llvm_lifetime_start_p0.Invoke(8L, &v2);
					v2 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm3));
					llvm_lifetime_start_p0.Invoke(16L, &bigInt_qdkjbh);
					sbyte* ptr = (sbyte*)(&bigInt_qdkjbh);
					*(long*)ptr = -6148914691236517206L;
					((long*)ptr)[1] = -6148914691236517206L;
					BigInt_128ul_false_unsigned_long_BigInt_unsigned_long_void.Invoke((anon_izyfb7*)(&bigInt_qdkjbh), FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm4)));
					...
					*(long*)ptr2 = -6148914691236517206L;
					...
					BigInt_128ul_false_unsigned_long_BigInt_unsigned_long_void.Invoke((anon_izyfb7*)(&bigInt_qdkjbh3), v);
					llvm_lifetime_start_p0.Invoke(16L, &bigInt_qdkjbh4);
					BigInt_128ul_false_unsigned_long_BigInt_unsigned_long_void.Invoke((anon_izyfb7*)(&bigInt_qdkjbh4), v2);
					Struct_fiz2nb struct_fiz2nb = BigInt_128ul_false_unsigned_long_Multiply.Invoke((anon_izyfb7*)(&bigInt_qdkjbh3), (anon_izyfb7*)(&bigInt_qdkjbh4));
					...
					num13 = 54;
					BigInt_128ul_false_unsigned_long_Operator_89tuvz.Invoke((anon_izyfb7*)(&bigInt_qdkjbh), 54L);
					...
					if (num12 < num14)
					{
						b = (internal_shift_mantissa_BigInt_128ul_false_unsigned_long.Invoke(checked(num14 - num12), (anon_izyfb7*)(&bigInt_qdkjbh2)) ? ((sbyte)1) : ((sbyte)0));
						num12 = num14;
					}
					else if (num14 < num12)
					{
						b2 = 1;
						b = (internal_shift_mantissa_BigInt_128ul_false_unsigned_long.Invoke(checked(num12 - num14), (anon_izyfb7*)(&bigInt_qdkjbh)) ? ((sbyte)1) : ((sbyte)0));
					}
					...
					{
						BigInt_128ul_false_unsigned_long_Operator_hkgjni.Invoke((anon_izyfb7*)(&bigInt_qdkjbh2), (anon_izyfb7*)(&bigInt_qdkjbh));
					}
					else if (GreaterThanOrEquals_crwxpm.Invoke((anon_izyfb7*)(&bigInt_qdkjbh2), (anon_izyfb7*)(&bigInt_qdkjbh)))
					{
						if ((b2 & 1) == 1 && (b & 1) == 1)
						{
							BigInt_128ul_false_unsigned_long_Increment.Invoke((anon_izyfb7*)(&bigInt_qdkjbh));
						}
						BigInt_128ul_false_unsigned_long_Operator_qwctfr.Invoke((anon_izyfb7*)(&bigInt_qdkjbh2), (anon_izyfb7*)(&bigInt_qdkjbh));
					}
					else
					{
						if ((b2 & 1) != 1 && (b & 1) == 1)
						{
							BigInt_128ul_false_unsigned_long_Increment.Invoke((anon_izyfb7*)(&bigInt_qdkjbh2));
						}
						llvm_lifetime_start_p0.Invoke(16L, &bigInt_qdkjbh5);
						Struct_fiz2nb struct_fiz2nb4 = BigInt_128ul_false_unsigned_long_Subtract_wqmyif.Invoke((anon_izyfb7*)(&bigInt_qdkjbh), (anon_izyfb7*)(&bigInt_qdkjbh2));
					...
					BigInt_128ul_false_unsigned_long_BigInt_int_void.Invoke((anon_izyfb7*)(&bigInt_qdkjbh6), 0);
					bool num24 = Equals_s36iku.Invoke((anon_izyfb7*)(&bigInt_qdkjbh2), (anon_izyfb7*)(&bigInt_qdkjbh6));
					...
					*(long*)ptr6 = -6148914691236517206L;
					...
					DyadicFloat_128ul_Constructor.Invoke(&fputil_DyadicFloat_kt2kd5, anon_izyfb18.val, e, *(long*)(&bigInt_qdkjbh7), ((long*)(&bigInt_qdkjbh7))[1]);
					llvm_lifetime_start_p0.Invoke(16L, &bigInt_qdkjbh8);
					BigInt_128ul_false_unsigned_long_BigInt_unsigned_int_void.Invoke((anon_izyfb7*)(&bigInt_qdkjbh8), ((b & 1) == 1) ? 1 : 0);
					Struct_fiz2nb struct_fiz2nb7 = Operator_66fhg9.Invoke((anon_izyfb7*)(&fputil_DyadicFloat_kt2kd5.mantissa), (anon_izyfb7*)(&bigInt_qdkjbh8));
					...
					result = DyadicFloat_128ul_as_double_true_void.Invoke(&fputil_DyadicFloat_kt2kd5);
