...
{
	public unsafe static int Invoke(void* @this, int negative_block_index)
	{
		int num = 0;
		...
		unchecked
		{
			...
			else
			{
				...
				num = checked(-1 - negative_block_index);
				while (num < ((FloatToString_8m29tk*)@this)->int_block_index)
				{
					...
					BigInt_16512ul_false_unsigned_long_mul_unsigned_long.Invoke(&((FloatToString_8m29tk*)@this)->float_as_fixed, 1000000000L);
					checked
					{
						unchecked((FloatToString_8m29tk*)@this)->int_block_index += -1;
					}
				}
				llvm_lifetime_start_p0.Invoke(2064L, &bigInt_k36xhe);
				BigInt_16512ul_false_unsigned_long_operator_unsigned_long_const_zwn8yf.Invoke(&bigInt_k36xhe, &((FloatToString_8m29tk*)@this)->float_as_fixed, 16384L);
