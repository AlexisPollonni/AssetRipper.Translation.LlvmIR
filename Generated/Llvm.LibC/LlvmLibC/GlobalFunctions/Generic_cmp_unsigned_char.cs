...
internal static partial class Generic_cmp_unsigned_char
{
	...
	public unsafe static int Invoke([MangledName("p1")][NativeType("__llvm_libc_20_1_2_::cpp::byte const*")] void* P1, [MangledName("p2")][NativeType("__llvm_libc_20_1_2_::cpp::byte const*")] void* P2, [MangledName("offset")][NativeType("unsigned long")] long Offset)
	{
		...
		StrictIntegralType_int_StrictIntegralType_int_false.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt, unchecked((byte)Generic_load_unsigned_char.Invoke(P1, Offset)) - unchecked((byte)Generic_load_unsigned_char.Invoke(P2, Offset)));
