...
internal static partial class DyadicFloat_64ul_DyadicFloat_double_0
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_DyadicFloat_syracv* This, [MangledName("x")][NativeType("double")] double X)
	{
		...
		*unchecked((long*)(&fputil_FPBits_wjhbrm)) = -6148914691236517206L;
		...
		BigInt_64ul_false_unsigned_long_BigInt_unsigned_long_void.Invoke(&bigInt_555ggs, FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke(unchecked((Fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm))));
