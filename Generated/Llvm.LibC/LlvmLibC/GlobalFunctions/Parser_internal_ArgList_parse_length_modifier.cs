...
internal static partial class Parser_internal_ArgList_parse_length_modifier
{
	...
	public unsafe static LengthModifier_3739tr Invoke(scanf_core_Parser* @this, [NativeType("unsigned long*")] void* local_pos)
	{
		unchecked
		{
	...
	public unsafe static Struct_nfiam5 Invoke(printf_core_Parser* @this, [NativeType("unsigned long*")] void* local_pos)
	{
			...
			case 119:
				...
				if (internal_isdigit_prmaet.Invoke(((sbyte*)@this->str)[*(long*)local_pos]))
				{
					...
					*(long*)local_pos += strToNumResult_imtnam.parsed_len;
					...
					num = 0;
					printf_core_LengthSpec2.bit_width = *(int*)cpp_max_int.Invoke(&num, &strToNumResult_imtnam.value);
