...
internal static partial class Fixed_point_bit_not_Fract
{
	...
	public unsafe static short Invoke([MangledName("x")][NativeType("_Fract")] short X)
	{
		short num = 0;
		short num2 = 0;
		short num3 = X;
		Llvm_lifetime_start_p0.Invoke(2L, &num);
		num = Cpp_bit_cast_unsigned_short_Fract.Invoke(&num3);
		Llvm_lifetime_start_p0.Invoke(2L, &num2);
		num2 = unchecked((short)((ushort)num ^ -1));
		short result = Cpp_bit_cast_Fract_unsigned_short.Invoke(&num2);
