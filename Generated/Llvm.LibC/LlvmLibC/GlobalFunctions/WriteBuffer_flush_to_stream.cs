...
internal static partial class WriteBuffer_flush_to_stream
{
	...
	public unsafe static int Invoke([MangledName("this")] Printf_core_WriteBuffer* This, [MangledName("new_str.coerce0")] void* New_str, [MangledName("new_str.coerce1")] long Retval)
	{
		int result = 0;
		...
		unchecked
		{
			*(void**)(&cpp_string_view) = New_str;
			((long*)(&cpp_string_view))[1] = Retval;
			if ((ulong)This->Buff_cur > 0uL)
			{
				Llvm_lifetime_start_p0.Invoke(4L, &num);
				void* stream_writer = This->Stream_writer;
				String_view_Constructor.Invoke(&cpp_string_view2, This->Buff, This->Buff_cur);
				void* output_target = This->Output_target;
				num = ((delegate*<void*, long, void*, int>)stream_writer)(*(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1], output_target);
				int num3;
				if (num < 0)
				{
					result = num;
			...
			if ((ulong)String_view_size.Invoke(&cpp_string_view) > 0uL)
			{
				...
				num2 = ((delegate*<void*, long, void*, int>)stream_writer2)(*(void**)(&cpp_string_view3), ((long*)(&cpp_string_view3))[1], output_target2);
				int num3;
				if (num2 < 0)
				{
					result = num2;
