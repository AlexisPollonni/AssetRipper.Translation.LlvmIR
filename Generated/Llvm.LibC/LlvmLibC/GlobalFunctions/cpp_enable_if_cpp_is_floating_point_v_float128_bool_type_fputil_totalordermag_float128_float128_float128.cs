...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float128_bool_type_fputil_totalordermag_float128_float128_float128
{
	public unsafe static bool Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			...
			fputil_FPBits_float128_FPBits_float128_float128.Invoke(&fputil_FPBits_ubgsi6, y);
			Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs_const.Invoke(&fputil_FPBits_ubgsi6);
