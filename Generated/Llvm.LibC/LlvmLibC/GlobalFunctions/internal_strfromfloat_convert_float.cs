		...
		unchecked
		{
			...
			else
			{
				...
				*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
				FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, x);
				...
				else
				{
					...
					case 102:
						...
						result = printf_core_convert_float_decimal_typed_float_0.Invoke(writer, section, fputil_FPBits_5nkvcs3.FPRepImpl.FPRepSem.field_0.field_0);
						break;
					case 69:
					case 101:
						llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs4, &fputil_FPBits_5nkvcs2, 4L, isVolatile: false);
						result = printf_core_convert_float_dec_exp_typed_float_0.Invoke(writer, section, fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0);
						break;
					case 65:
					case 97:
					...
					case 103:
						...
						result = printf_core_convert_float_dec_auto_typed_float_0.Invoke(writer, section, fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0);
						break;
					default:
