...
internal static partial class fputil_abs_Float16_0
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x)
	{
		...
		short field_ = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_abs.Invoke(unchecked((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva3)));
		fputil_FPBits_2fahva2.FPRepImpl.FPRepSem.FPStorage.field_0 = field_;
		Half result = FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva2);
