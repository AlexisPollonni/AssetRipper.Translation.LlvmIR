...
internal static partial class internal_simple_decimal_conversion_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] internal_FloatConvertReturn_hgyipa* agg_result, [NativeType("char const*")] void* numStart, [NativeType("unsigned long")] long num_len, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round)
	{
		int i = 0;
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) > 0 && internal_exp10_to_exp2.Invoke(HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) - 1) > 16383)
		{
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) < 0 && internal_exp10_to_exp2.Invoke(-HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2)) > 16446)
		{
		...
		else
		{
			while (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) > 0)
			{
				...
				{
					long num3 = HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2);
			...
			while (true)
			{
				...
				else
				{
					...
					num4 = ((unchecked((byte)(*(sbyte*)HighPrecisionDecimal_get_digits.Invoke(&internal_HighPrecisionDecimal2))) < 5) ? 1 : 0);
				}
				if (num4 == 0)
				{
					break;
				...
				{
					long num5 = -HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2);
			...
			{
				HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal2, 63);
				llvm_lifetime_start_p0.Invoke(16L, &@int);
				Struct_fiz2nb struct_fiz2nb = HighPrecisionDecimal_round_to_integer_type_unsigned_int128.Invoke(&internal_HighPrecisionDecimal2, RoundDirection_b3pcwy.Nearest);
				Int128* num6 = &int2;
				...
				if (i <= 0)
				{
					...
					HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal2, -1);
					Struct_fiz2nb struct_fiz2nb4 = HighPrecisionDecimal_round_to_integer_type_unsigned_int128.Invoke(&internal_HighPrecisionDecimal2, round);
					Int128* num8 = &int3;
