				...
				*(long*)(&cpp_optional_xmxtsi2.storage) = storage;
				...
				case 0:
					...
					else
					{
						...
						x3 = double.NaN;
						sincosf_eval_double_unsigned_int_double_double_double_double.Invoke(num2, num, &num3, &num4, &x2, &x3);
						result = (float)cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x2, 0.0 - num3, cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x3, num4, num4));
