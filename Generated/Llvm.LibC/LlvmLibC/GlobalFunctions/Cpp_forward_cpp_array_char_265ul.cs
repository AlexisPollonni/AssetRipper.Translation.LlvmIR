...
internal static partial class Cpp_forward_cpp_array_char_265ul
{
	...
	public unsafe static Llvm_libc_20_1_2_cpp_array_knc3mr* Invoke([MangledName("value")][NativeType("__llvm_libc_20_1_2_::cpp::remove_reference<__llvm_libc_20_1_2_::cpp::array<char, 265ul>>::type&")] Llvm_libc_20_1_2_cpp_array_knc3mr* Value)
	{
		return Value;
	}
}
