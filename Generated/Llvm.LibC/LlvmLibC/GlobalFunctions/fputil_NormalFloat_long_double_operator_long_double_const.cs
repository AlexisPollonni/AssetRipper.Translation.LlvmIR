...
internal static partial class fputil_NormalFloat_long_double_operator_long_double_const
{
		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
				fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi4, 0.0);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, &((fputil_NormalFloat_wqb3ie*)@this)->sign, 1L, isVolatile: false);
				fputil_internal_FPStorage_fputil_FPType_4_set_sign_Sign.Invoke(&fputil_FPBits_ubgsi4, anon_izyfb9.val);
				...
				if (((fputil_NormalFloat_wqb3ie*)@this)->exponent < -16382)
				{
					...
					if ((uint)num4 <= 64u)
					{
						...
						@int = 0L;
						fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&@int), ((long*)(&@int))[1]);
						int2 = NumericHelper.ShiftRightLogical(((fputil_NormalFloat_wqb3ie*)@this)->mantissa, (Int128)(UInt128)(uint)num4);
						fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int2), ((long*)(&int2))[1]);
						...
						*(long*)num6 = struct_fiz2nb6.field_1;
						...
						{
							Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi4);
							Int128* num7 = &x2;
						...
						int5 = int3;
						fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int5), ((long*)(&int5))[1]);
						if (NumericHelper.IntCmpEq(int3, long.MinValue))
						{
							int6 = 1L;
							fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int6), ((long*)(&int6))[1]);
							fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_set_implicit_bit_bool.Invoke(&fputil_FPBits_ubgsi4, implicitVal: true);
						}
						else
						{
							fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_set_implicit_bit_bool.Invoke(&fputil_FPBits_ubgsi4, implicitVal: false);
						}
				...
				{
					int7 = num;
					fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int7), ((long*)(&int7))[1]);
					int8 = ((fputil_NormalFloat_wqb3ie*)@this)->mantissa;
					fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int8), ((long*)(&int8))[1]);
					fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_set_implicit_bit_bool.Invoke(&fputil_FPBits_ubgsi4, implicitVal: true);
					result = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi4);
				}
