...
internal static partial class exp10_range_reduction
{
	...
	public unsafe static InlineArray2_Single Invoke([NativeType("_Float16")] Half x)
	{
		...
		unchecked
		{
			...
			x2 = fputil_multiply_add_float.Invoke(num2, -0.03762875f, num);
			llvm_lifetime_start_p0.Invoke(4L, &x3);
			x3 = *(int*)array_unsigned_int_8ul_Index.Invoke(Index: (uint)num5, @this: EXP2_MID_BITS_11.Pointer) + (num4 << 23);
			llvm_lifetime_start_p0.Invoke(4L, &exp_hi_mid);
			llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs2);
			FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, x3);
			float num6 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
			llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs2);
			exp_hi_mid = num6;
			llvm_lifetime_start_p0.Invoke(4L, &exp_lo);
			exp_lo = fputil_polyeval_float_float_float_float_float.Invoke(x2, 1f, 2.3025842f, 2.6509514f, 2.0367494f, 1.1711367f);
