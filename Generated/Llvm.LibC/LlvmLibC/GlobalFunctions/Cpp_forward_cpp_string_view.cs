...
internal static partial class Cpp_forward_cpp_string_view
{
	...
	public unsafe static void* Invoke([MangledName("value")][NativeType("__llvm_libc_20_1_2_::cpp::remove_reference<__llvm_libc_20_1_2_::cpp::string_view>::type&")] void* Value)
	{
		return Value;
	}
}
