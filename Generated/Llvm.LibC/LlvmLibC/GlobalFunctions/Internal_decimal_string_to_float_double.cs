			...
			*ptr2 = -86;
			...
			if ((b3 & 1) == 1)
			{
				...
				if (num2 == 0L)
				{
					...
					Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Value, &internal_ExpandedFloat_k68bhv2, 16L, isVolatile: false);
				...
				else
				{
					...
					*ptr5 = -86;
					...
					Internal_decimal_exp_to_float_double.Invoke(Round: (b2 & 1) == 1, NumStart: (int)Round, Num_len: Src, Mantissa: Integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke(), Agg_result: &internal_FloatConvertReturn_g92bm, Init_num: *(long*)(&internal_ExpandedFloat_k68bhv3), Truncated: ((int*)(&internal_ExpandedFloat_k68bhv3))[2]);
