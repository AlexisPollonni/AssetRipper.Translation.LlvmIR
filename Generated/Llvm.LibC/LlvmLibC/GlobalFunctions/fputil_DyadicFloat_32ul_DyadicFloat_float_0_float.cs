...
internal static partial class fputil_DyadicFloat_32ul_DyadicFloat_float_0_float
{
	public unsafe static void Invoke(void* @this, float x)
	{
		...
		unchecked
		{
			...
			BigInt_32ul_false_unsigned_int_BigInt_int_void_int.Invoke(&((fputil_DyadicFloat_cs3nhs*)@this)->mantissa, 0);
			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			((fputil_DyadicFloat_cs3nhs*)@this)->exponent = checked(fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_explicit_exponent_const.Invoke(unchecked((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2))) - 23);
			llvm_lifetime_start_p0.Invoke(4L, &bigInt_vtm4cw);
			BigInt_32ul_false_unsigned_int_BigInt_unsigned_int_void_unsigned_int.Invoke(&bigInt_vtm4cw, fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa_const.Invoke(&fputil_FPBits_5nkvcs2));
