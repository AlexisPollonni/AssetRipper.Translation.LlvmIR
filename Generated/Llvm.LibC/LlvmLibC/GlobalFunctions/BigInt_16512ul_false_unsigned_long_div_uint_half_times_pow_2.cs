...
internal static partial class BigInt_16512ul_false_unsigned_long_div_uint_half_times_pow_2
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_cpp_optional_he65ea* Agg_result, [MangledName("this")] Llvm_libc_20_1_2_BigInt_q8g275* This, [MangledName("x")] int X, [MangledName("e")] long E)
	{
		...
		BigInt_16512ul_false_unsigned_long_Constructor.Invoke(&llvm_libc_20_1_2_BigInt_q8g);
		unchecked
		{
			if (X == 0)
			{
			...
			{
				Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_BigInt_q8g, This, 2064L, isVolatile: false);
				Llvm_lifetime_start_p0.Invoke(2064L, &llvm_libc_20_1_2_BigInt_q8g2);
				Llvm_memset_p0_i64.Invoke(&llvm_libc_20_1_2_BigInt_q8g2, 0, 2064L, isVolatile: false);
				BigInt_16512ul_false_unsigned_long_Constructor.Invoke(&llvm_libc_20_1_2_BigInt_q8g2);
				Llvm_memcpy_p0_p0_i64.Invoke(This, &llvm_libc_20_1_2_BigInt_q8g2, 2064L, isVolatile: false);
				Llvm_lifetime_end_p0.Invoke(2064L, &llvm_libc_20_1_2_BigInt_q8g2);
				Optional_BigInt_16512ul_false_unsigned_long_Constructor.Invoke(Agg_result, &llvm_libc_20_1_2_BigInt_q8g);
			}
			else
			{
				Llvm_lifetime_start_p0.Invoke(2064L, &llvm_libc_20_1_2_BigInt_q8g3);
				Llvm_memset_p0_i64.Invoke(&llvm_libc_20_1_2_BigInt_q8g3, -86, 2064L, isVolatile: false);
				BigInt_16512ul_false_unsigned_long_Constructor.Invoke(&llvm_libc_20_1_2_BigInt_q8g3);
				...
				{
					num7 <<= 32;
					Llvm_libc_20_1_2_cpp_array_anzbtp* val = &This->Val;
					long num14 = num8 + -1L;
					num8 = num14;
					...
					*(long*)Array_unsigned_long_258ul_Index_cpunpn.Invoke(&llvm_libc_20_1_2_BigInt_q8g3.Val, num9 - 1L) = num17;
					num7 = (long)((ulong)num7 % (ulong)num);
				...
				if ((ulong)num11 > 0uL)
				{
					BigInt_16512ul_false_unsigned_long_Operator.Invoke(&llvm_libc_20_1_2_BigInt_q8g3, num11);
					Llvm_lifetime_start_p0.Invoke(8L, &num12);
					num12 = 0L;
					Llvm_lifetime_start_p0.Invoke(8L, &num13);
					Llvm_libc_20_1_2_cpp_array_anzbtp* val2 = &This->Val;
					long num18 = num8 + -1L;
					num8 = num18;
					...
					long num19 = num12;
					*(long*)Array_unsigned_long_258ul_Index_cpunpn.Invoke(&llvm_libc_20_1_2_BigInt_q8g3.Val, 0L) += num19;
					if ((ulong)(num5 - E) <= 32uL)
					{
						if ((ulong)num8 < 257uL)
						{
							long num20 = num7 >>> 32;
							*(long*)BigInt_16512ul_false_unsigned_long_Index_jsva56.Invoke(&llvm_libc_20_1_2_BigInt_q8g, num8 + 1L) = num20;
						}
						long num21 = (num7 << 32) + (*(long*)Array_unsigned_long_258ul_Index_cpunpn.Invoke(&This->Val, num8) & 0xFFFFFFFFL);
						*(long*)BigInt_16512ul_false_unsigned_long_Index_jsva56.Invoke(&llvm_libc_20_1_2_BigInt_q8g, num8) = num21;
					}
					else
					{
						long num22 = num7;
						*(long*)BigInt_16512ul_false_unsigned_long_Index_jsva56.Invoke(&llvm_libc_20_1_2_BigInt_q8g, num8) = num22;
					}
				...
				{
					long num23 = num7;
					*(long*)BigInt_16512ul_false_unsigned_long_Index_jsva56.Invoke(&llvm_libc_20_1_2_BigInt_q8g, num8) = num23;
				}
				for (; (ulong)num8 > 0uL; num8 += -1L)
				{
					long num24 = *(long*)Array_unsigned_long_258ul_Index_cpunpn.Invoke(&This->Val, num8 - 1L);
					*(long*)BigInt_16512ul_false_unsigned_long_Index_jsva56.Invoke(&llvm_libc_20_1_2_BigInt_q8g, num8 - 1L) = num24;
				}
				Llvm_memcpy_p0_p0_i64.Invoke(This, &llvm_libc_20_1_2_BigInt_q8g3, 2064L, isVolatile: false);
				Optional_BigInt_16512ul_false_unsigned_long_Constructor.Invoke(Agg_result, &llvm_libc_20_1_2_BigInt_q8g);
