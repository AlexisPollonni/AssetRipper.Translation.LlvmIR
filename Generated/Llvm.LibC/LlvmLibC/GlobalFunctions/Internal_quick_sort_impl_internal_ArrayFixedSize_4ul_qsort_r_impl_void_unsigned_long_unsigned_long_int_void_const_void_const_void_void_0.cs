...
internal static partial class Internal_quick_sort_impl_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0
{
	...
	public unsafe static void Invoke([MangledName("array")][NativeType("__llvm_libc_20_1_2_::internal::ArrayFixedSize<4ul>&")] void* Array, [MangledName("ancestor_pivot")][NativeType("void const*")] void* Ancestor_pivot, [MangledName("limit")][NativeType("unsigned long")] long Limit, [MangledName("is_less")][NativeType("__llvm_libc_20_1_2_::__qsort_r_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*, void*), void*)::$_0 const&")] void* Is_less)
	{
		...
		unchecked
		{
			while (true)
			{
				...
				{
					Internal_heap_sort_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(Array, Is_less);
					num7 = 1;
				}
				else
				{
					...
					num2 = Internal_choose_pivot_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(Array, Is_less);
					if (ptr2 != null && !_0_Invoke_kq6gnz.Invoke(Is_less, ptr2, ArrayFixedSize_4ul_get.Invoke(Array, num2)))
					{
						...
						long num8 = Internal_partition_internal_ArrayFixedSize_4ul_void_internal_quick_sort_impl_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0_internal_ArrayFixedSize_4ul_void_const_unsigned_long_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0_const_lambda_void_const_void_const.Invoke(Array, pivot_index, &anon_e6q);
					...
					else
					{
						...
						num4 = Internal_partition_internal_ArrayFixedSize_4ul_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(Array, num2, Is_less);
						if (num == 2L)
						{
							num7 = 1;
						}
