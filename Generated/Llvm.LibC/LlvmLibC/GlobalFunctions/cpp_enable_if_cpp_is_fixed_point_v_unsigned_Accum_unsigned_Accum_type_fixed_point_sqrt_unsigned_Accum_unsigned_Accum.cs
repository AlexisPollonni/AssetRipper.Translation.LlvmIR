...
internal static partial class cpp_enable_if_cpp_is_fixed_point_v_unsigned_Accum_unsigned_Accum_type_fixed_point_sqrt_unsigned_Accum_unsigned_Accum
{
	public unsafe static int Invoke(int x)
	{
		...
		num = cpp_enable_if_sizeof_unsigned_int_sizeof_unsigned_Accum_cpp_is_trivially_constructible_unsigned_int_value_cpp_is_trivially_copyable_unsigned_int_value_cpp_is_trivially_copyable_unsigned_Accum_value_unsigned_int_type_cpp_bit_cast_unsigned_int_unsigned_Accum_unsigned_Accum_const.Invoke(&num8);
		int result;
		...
		else
		{
			...
			num7 = fixed_point_internal_SqrtConfig_unsigned_Accum_Type_fixed_point_sqrt_core_fixed_point_internal_SqrtConfig_unsigned_Accum_fixed_point_internal_SqrtConfig_unsigned_Accum_Type.Invoke(x_frac);
			num7 >>>= 15 - (num5 >> 1);
