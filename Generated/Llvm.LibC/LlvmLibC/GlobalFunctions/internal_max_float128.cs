	...
	public unsafe static double Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			double result = ((!NotEquals_rpctvi.Invoke(anon_izyfb8.val, anon_izyfb9.val)) ? ((!(x > y)) ? y : x) : ((!FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_pos.Invoke(&fputil_FPBits_ubgsi3)) ? y : x));
