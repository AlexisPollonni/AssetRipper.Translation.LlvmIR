...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_long_double_cpp_is_integral_v_int_long_double_type_fputil_ldexp_long_double_int_long_double_int
{
	public unsafe static double Invoke(double x, int exp)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			num = 32831;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(exp > 32831, expected: false))
			{
