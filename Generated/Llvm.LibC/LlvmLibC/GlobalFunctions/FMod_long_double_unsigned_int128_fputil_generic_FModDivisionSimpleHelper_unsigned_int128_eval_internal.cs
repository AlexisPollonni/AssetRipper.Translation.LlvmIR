	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sx.coerce0")] long Sx, [MangledName("sx.coerce1")] long Sy, [MangledName("sy.coerce0")] long E_x, [MangledName("sy.coerce1")] long E_y)
	{
		...
		unchecked
		{
			...
			*(long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3) = E_x;
			...
			Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
			Int128* num10 = &@int;
			...
			*(long*)num11 = struct_fiz2nb3.field_1;
			Int128 x2 = @int;
			Struct_fiz2nb struct_fiz2nb4 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
			Int128* num12 = &y;
			...
			*(long*)num13 = struct_fiz2nb6.field_1;
			...
			{
				Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
				Int128* num14 = &int2;
				...
				*(long*)num15 = struct_fiz2nb9.field_1;
				Int128 x3 = int2;
				Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
				Int128* num16 = &y2;
			...
			else
			{
				...
				num = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
				Llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
				if (Details_expects_bool_condition_bool.Invoke(num2 > 63 && checked(num - num2) <= 15, Expected: true))
				{
					...
					Struct_fiz2nb struct_fiz2nb16 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
					Int128* num18 = &int3;
					...
					*(long*)num19 = struct_fiz2nb18.field_1;
					...
					Struct_fiz2nb struct_fiz2nb19 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
					Int128* num20 = &int4;
				...
				else if (Details_expects_bool_condition_bool.Invoke(num == 0 && num2 == 0, Expected: false))
				{
					*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb28 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
					Int128* num22 = &int7;
					...
					*(long*)num23 = struct_fiz2nb30.field_1;
					Int128 x4 = int7;
					Struct_fiz2nb struct_fiz2nb31 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
					Int128* num24 = &y4;
					...
					*(long*)num25 = struct_fiz2nb33.field_1;
					...
					FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, *(long*)(&int8), ((long*)(&int8))[1]);
				}
				else
				{
					Llvm_lifetime_start_p0.Invoke(16L, &int9);
					Struct_fiz2nb struct_fiz2nb34 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
					Int128* num26 = &int10;
					...
					*(long*)num27 = struct_fiz2nb36.field_1;
					...
					Struct_fiz2nb struct_fiz2nb37 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
					Int128* num28 = &int12;
					...
					*(long*)num29 = struct_fiz2nb39.field_1;
					...
					{
						Struct_fiz2nb struct_fiz2nb40 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
						Int128* num30 = &int13;
