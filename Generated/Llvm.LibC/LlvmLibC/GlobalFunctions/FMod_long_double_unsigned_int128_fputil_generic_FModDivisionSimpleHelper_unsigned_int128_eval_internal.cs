	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sx.coerce0")] long sx, [MangledName("sx.coerce1")] long sy, [MangledName("sy.coerce0")] long e_x, [MangledName("sy.coerce1")] long e_y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_ubgsi5) = e_x;
			...
			Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi4);
			Int128* num10 = &@int;
			...
			*(long*)num11 = struct_fiz2nb3.field_1;
			Int128 x2 = @int;
			Struct_fiz2nb struct_fiz2nb4 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi5);
			Int128* num12 = &y;
			...
			*(long*)num13 = struct_fiz2nb6.field_1;
			...
			{
				Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi4);
				Int128* num14 = &int2;
				...
				*(long*)num15 = struct_fiz2nb9.field_1;
				Int128 x3 = int2;
				Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi5);
				Int128* num16 = &y2;
				...
				*(long*)num17 = struct_fiz2nb12.field_1;
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb13 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero.Invoke(anon_izyfb8.val);
			...
			else
			{
				...
				num = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi4);
				llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi5);
				if (details_expects_bool_condition_bool.Invoke(num2 > 63 && checked(num - num2) <= 15, expected: true))
				{
					...
					Struct_fiz2nb struct_fiz2nb16 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num18 = &int3;
					...
					*(long*)num19 = struct_fiz2nb18.field_1;
					...
					Struct_fiz2nb struct_fiz2nb19 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num20 = &int4;
					...
					*(long*)num21 = struct_fiz2nb21.field_1;
					...
					if (NumericHelper.IntCmpEq(int5, 0L))
					{
						...
						Struct_fiz2nb struct_fiz2nb22 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero.Invoke(anon_izyfb9.val);
				...
				else if (details_expects_bool_condition_bool.Invoke(num == 0 && num2 == 0, expected: false))
				{
					*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
					FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi3);
					Struct_fiz2nb struct_fiz2nb28 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num22 = &int7;
					...
					*(long*)num23 = struct_fiz2nb30.field_1;
					Int128 x4 = int7;
					Struct_fiz2nb struct_fiz2nb31 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num24 = &y4;
					...
					*(long*)num25 = struct_fiz2nb33.field_1;
					...
					FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_mantissa.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int8), ((long*)(&int8))[1]);
				}
				else
				{
					llvm_lifetime_start_p0.Invoke(16L, &int9);
					Struct_fiz2nb struct_fiz2nb34 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi4);
					Int128* num26 = &int10;
					...
					*(long*)num27 = struct_fiz2nb36.field_1;
					...
					Struct_fiz2nb struct_fiz2nb37 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num28 = &int12;
					...
					*(long*)num29 = struct_fiz2nb39.field_1;
					...
					{
						Struct_fiz2nb struct_fiz2nb40 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi5);
						Int128* num30 = &int13;
					...
					if (details_expects_bool_condition_bool.Invoke(NumericHelper.IntCmpEq(int9, 0L), expected: false))
					{
						...
						Struct_fiz2nb struct_fiz2nb43 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero.Invoke(anon_izyfb10.val);
