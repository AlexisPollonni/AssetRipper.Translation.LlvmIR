...
internal static partial class anonymous_namespace_powf_double_double
{
	...
	public unsafe static double Invoke([NativeType("int")] int idx_x, [NativeType("double")] double dx, [NativeType("double")] double y6, [NativeType("double")] double lo6_hi, [NativeType("__llvm_libc_20_1_2_::NumberPair<double> const&")] NumberPair* exp2_hi_mid)
	{
		int num = 0;
		double num2 = 0.0;
			...
			*(double*)num27 = struct_4ydhja33.field_1;
			...
			if (details_expects_bool_condition_bool.Invoke((num3 & 0xFFFFFFFL) == 0L && NumericHelper.IsUnorderedOrNotEquals(numberPair12.lo, 0.0), expected: false))
			{
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm2, numberPair12.hi);
				...
				*(sbyte*)(&anon_izyfb9) = -86;
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm3, numberPair12.lo);
