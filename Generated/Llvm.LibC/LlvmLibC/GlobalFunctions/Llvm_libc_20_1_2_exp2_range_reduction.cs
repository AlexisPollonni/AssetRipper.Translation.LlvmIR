...
internal static partial class Llvm_libc_20_1_2_exp2_range_reduction
{
	...
	public unsafe static InlineArray2_Single Invoke([MangledName("x")][NativeType("_Float16")] Half X)
	{
		...
		unchecked
		{
			...
			x2 = *(int*)Array_unsigned_int_8ul_Index.Invoke(Index: (uint)num5, This: Llvm_libc_20_1_2_EXP2_MID_BITS.Pointer) + (num4 << 23);
