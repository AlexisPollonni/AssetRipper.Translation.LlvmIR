...
internal static partial class Internal_strtonan_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_StrToNumResult_uytq62* Agg_result, [MangledName("arg")][NativeType("char const*")] void* Arg)
	{
		...
		unchecked
		{
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			StrToNumResult_long_double_Constructor.Invoke(Agg_result, FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi), 0L, error);
