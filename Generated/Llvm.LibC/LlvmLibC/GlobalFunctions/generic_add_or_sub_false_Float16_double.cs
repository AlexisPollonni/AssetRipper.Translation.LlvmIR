...
internal static partial class generic_add_or_sub_false_Float16_double
{
	...
	public unsafe static Half Invoke([NativeType("double")] double x, [NativeType("double")] double y)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
			...
			else
			{
				...
				x3 = y;
				result = fputil_cast_Float16_double.Invoke(x3);
		...
		unchecked
		{
			...
			double num15 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm4);
			...
			double num16 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm5);
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm6) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm6, *(double*)cpp_max_double.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm7);
				*(long*)(&fputil_FPBits_wjhbrm7) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm7, *(double*)cpp_min_double.Invoke(&num6, &num7));
				...
				else
				{
					...
					num9 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm6)) << 3;
					llvm_lifetime_start_p0.Invoke(8L, &num10);
					num10 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm7)) << 3;
					llvm_lifetime_start_p0.Invoke(4L, &num11);
					checked
					{
						num11 = unchecked((ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm6))) - unchecked((ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm7)));
				...
				checked
				{
					num14 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_exponent.Invoke(unchecked((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm6))) - 55;
