...
internal static partial class BigInt_16512ul_false_unsigned_long_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_q8g275* This, [MangledName("words")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 258ul> const&")] Llvm_libc_20_1_2_cpp_array_anzbtp* Words)
	{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_q8g275* This)
	{
		Llvm_memset_p0_i64.Invoke(&This->Val.Data, 0, 2064L, isVolatile: false);
	}
}
