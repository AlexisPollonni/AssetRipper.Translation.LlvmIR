			...
			if ((b3 & 1) == 1)
			{
				...
				else
				{
					...
					*ptr5 = -86;
					...
					ptr5[2] = -86;
					ptr5[3] = -86;
					llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv2.Mantissa = num2;
					llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv2.Exponent = num3;
					Internal_binary_exp_to_float_double.Invoke(Round: (b2 & 1) == 1, Agg_result: &llvm_libc_20_1_2_internal_FloatConvertReturn_g92bm, Init_num: *(long*)(&llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv2), Truncated: ((int*)(&llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv2))[2], Mantissa: (int)Round);
