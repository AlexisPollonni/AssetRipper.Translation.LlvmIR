...
internal static partial class int_inline_strncmp_strncmp_impl_char_const_char_const_unsigned_long_0_char_const_char_const_unsigned_long_strncmp_impl_char_const_char_const_unsigned_long_0
{
	public unsafe static int Invoke(void* left, void* right, long n, void* comp)
	{
		...
		unchecked
		{
			for (; (ulong)num > 1uL; num += -1L, ptr = (byte*)ptr + 1, ptr2 = (byte*)ptr2 + 1)
			{
				...
				l = *(sbyte*)ptr;
				int num2 = ((strncmp_impl_char_const_char_const_unsigned_long_0_operator_char_char_const.Invoke(comp, l, 0) == 0 || strncmp_impl_char_const_char_const_unsigned_long_0_operator_char_char_const.Invoke(comp, l, *(sbyte*)ptr2) != 0) ? 2 : 0);
			...
			return strncmp_impl_char_const_char_const_unsigned_long_0_operator_char_char_const.Invoke(comp, *(sbyte*)ptr, *(sbyte*)ptr2);
		}
	}
}
