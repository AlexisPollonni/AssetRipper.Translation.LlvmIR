...
internal static partial class Log10f
{
	...
	public unsafe static float Invoke([MangledName("x")] float X)
	{
		...
		unchecked
		{
			bool num11 = (uint)num10 < (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs2));
			...
			else
			{
				...
				value = (((uint)num12 > (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs3))) ? 1 : 0);
			}
		...
		unchecked
		{
			...
			double x2 = num5;
			long num14 = num4;
			num6 = Fputil_multiply_add_double.Invoke(x2, ((float*)Llvm_libc_20_1_2_R.Pointer)[num14], -1.0);
			...
			*(double*)(&inlineArray5_Double) = 0.4342944819032211;
			...
			long num15 = num4;
			a = Fputil_multiply_add_double.Invoke(x3, y, ((double*)Llvm_libc_20_1_2_LOG10_R.Pointer)[num15]);
