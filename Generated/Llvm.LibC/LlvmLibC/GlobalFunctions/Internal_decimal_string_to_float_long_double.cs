		...
		unchecked
		{
			...
			if ((b3 & 1) == 1)
			{
				...
				if (NumericHelper.IntCmpEq(@int, 0L))
				{
					...
					Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Value, &internal_ExpandedFloat_9jummq2, 32L, isVolatile: false);
				...
				else
				{
					...
					Internal_decimal_exp_to_float_long_double.Invoke(&internal_FloatConvertReturn_hgyipa, &internal_ExpandedFloat_9jummq3, (b2 & 1) == 1, Round, Src, Integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
