	...
	public unsafe static long Invoke(void* str, void* str_end, int @base)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			StrToNumResult_long_long_internal_strtointeger_long_long_char_const_int_unsigned_long.Invoke(&strToNumResult_aztiru, str, @base, cpp_internal_integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
			if (StrToNumResult_long_long_has_error.Invoke(&strToNumResult_aztiru))
			{
			...
			long result = StrToNumResult_long_long_operator_long_long.Invoke(&strToNumResult_aztiru);
