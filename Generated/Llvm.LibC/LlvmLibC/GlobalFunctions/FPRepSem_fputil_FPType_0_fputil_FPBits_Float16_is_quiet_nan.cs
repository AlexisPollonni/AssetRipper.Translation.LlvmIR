...
internal static partial class FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_quiet_nan
{
	...
	public unsafe static bool Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepSem_i7nz4h* This)
	{
		...
		unchecked
		{
			ushort num = (ushort)FPStorage_fputil_FPType_0_exp_sig_bits.Invoke(This);
			...
			return num >= (ushort)FPStorage_fputil_FPType_0_encode.Invoke(llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, llvm_libc_20_1_2_fputil_internal_FPRepSem_i7nz4h.FPStorage.field_0);
		}
	}
}
