...
internal static partial class FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_quiet_nan
{
	...
	public unsafe static bool Invoke(fputil_internal_FPRepSem_i7nz4h* @this)
	{
		...
		unchecked
		{
			...
			return num >= (ushort)FPStorage_fputil_FPType_0_encode.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, fputil_internal_FPRepSem_i7nz4h2.FPStorage.field_0);
		}
	}
}
