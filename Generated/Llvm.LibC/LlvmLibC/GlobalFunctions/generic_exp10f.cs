	...
	public unsafe static float Invoke([NativeType("float")] float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			{
				if (!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_pos.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) || (uint)num < 1109008539u)
				{
					goto IL_0337;
				}
		...
		unchecked
		{
			...
			*(double*)num8 = struct_4ydhja3.field_1;
			...
			x2 = fputil_multiply_add_double.Invoke(num4, y, z);
			result = (float)fputil_multiply_add_double.Invoke(x2, num4 * numberPair.lo, num5 * numberPair.lo);
