...
internal static partial class generic_add_or_sub_true_double_float128
{
	...
	public unsafe static double Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)))
			{
				...
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
				{
					...
					*(long*)num11 = struct_fiz2nb3.field_1;
					...
					anon_izyfb10.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi3);
					long val = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(v: (long)@int, sign: anon_izyfb10.val);
				...
				else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)))
				{
					...
					*(long*)num13 = struct_fiz2nb6.field_1;
					...
					anon_izyfb11.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi4);
					long val2 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(v: (long)int3, sign: anon_izyfb11.val);
				...
				else
				{
					...
					long val3 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(anon_izyfb12.val, 0L);
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
			{
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)))
				{
					if ((b & 1) != 1)
					{
						...
						long val4 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_quiet_nan.Invoke(anon_izyfb13.val, 0L);
					...
					else
					{
						...
						long val5 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf.Invoke(anon_izyfb14.val);
				...
				else
				{
					...
					long val6 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf.Invoke(anon_izyfb15.val);
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)))
			{
				...
				anon_izyfb16.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi4);
				long val7 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_inf.Invoke(anon_izyfb16.val);
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
			{
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)))
				{
					if (fputil_quick_get_round.Invoke() == 1024)
					{
						...
						long val8 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_zero.Invoke(anon_izyfb17.val);
					...
					else
					{
						...
						long val9 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_zero.Invoke(anon_izyfb18.val);
		...
		Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&fputil_FPBits_ubgsi3);
		...
		unchecked
		{
			...
			double num14 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi5);
			...
			Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&fputil_FPBits_ubgsi4);
			...
			double num15 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi6);
			...
			if (num6 == num7 && (b & 1) != 1)
			{
				if (fputil_quick_get_round.Invoke() == 1024)
				{
					...
					long val10 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_zero.Invoke(anon_izyfb19.val);
				...
				else
				{
					...
					long val11 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_zero.Invoke(anon_izyfb20.val);
					fputil_FPBits_wjhbrm12.FPRepImpl.FPRepSem.FPStorage.val = val11;
					result = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm12);
			...
			else
			{
				...
				*(sbyte*)(&anon_izyfb21) = -86;
				...
				if (num6 > num7)
				{
					...
					anon_izyfb22.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi3);
				...
				else if (num6 < num7)
				{
					if ((b & 1) == 1)
					{
						...
						anon_izyfb23.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi4);
						llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb21, &anon_izyfb23, 1L, isVolatile: false);
						llvm_lifetime_end_p0.Invoke(1L, &anon_izyfb23);
					}
					else if (FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_pos.Invoke(&fputil_FPBits_ubgsi4))
					{
				...
				else if ((b & 1) == 1)
				{
					...
					anon_izyfb24.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi3);
				...
				*(Int128*)(&fputil_FPBits_ubgsi7) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi7, *(double*)cpp_max_float128.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi8);
				*(Int128*)(&fputil_FPBits_ubgsi8) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi8, *(double*)cpp_min_float128.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(16L, &int5);
				int5 = -6148914691236517206L;
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi7)))
				{
					if ((b & 1) == 1)
					{
						Struct_fiz2nb struct_fiz2nb13 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi7);
						Int128* num16 = &int6;
						...
						*(long*)num17 = struct_fiz2nb15.field_1;
						Int128 x7 = int6;
						Struct_fiz2nb struct_fiz2nb16 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi8);
						Int128* num18 = &y2;
					...
					{
						Struct_fiz2nb struct_fiz2nb19 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi7);
						Int128* num20 = &int7;
						...
						*(long*)num21 = struct_fiz2nb21.field_1;
						Int128 x8 = int7;
						Struct_fiz2nb struct_fiz2nb22 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi8);
						Int128* num22 = &y3;
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb25 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi7));
					Int128* num24 = &x3;
					...
					*(long*)num25 = struct_fiz2nb27.field_1;
					...
					Struct_fiz2nb struct_fiz2nb28 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi8));
					Int128* num26 = &x5;
					...
					*(long*)num27 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num8 = unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi7)) - unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi8));
					...
					b2 = -86;
					b2 = ((num8 > 3 && (num8 > 115 || NumericHelper.IntCmpNe(NumericHelper.ShiftLeft(x4, (Int128)(UInt128)(uint)checked(128 - num8)), 0L))) ? ((sbyte)1) : ((sbyte)0));
				...
				num9 = checked(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_exponent.Invoke(&fputil_FPBits_ubgsi7) - 115);
