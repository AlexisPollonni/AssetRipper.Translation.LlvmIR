...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_sizeof_double_sizeof_float128_double_type_fputil_generic_fma_double_float128_float128_float128_float128
{
	public unsafe static double Invoke(double x, double y, double z)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
			...
			{
				result = cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_float128_double_type_fputil_cast_double_float128_float128.Invoke(llvm_fmuladd_f128.Invoke(num11, num12, num13));
			}
			else
			{
