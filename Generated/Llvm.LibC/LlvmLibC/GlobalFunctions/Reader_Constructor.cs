...
internal static partial class Reader_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Scanf_core_Reader* This, [MangledName("string_buffer")][NativeType("__llvm_libc_20_1_2_::scanf_core::ReadBuffer*")] Scanf_core_ReadBuffer* String_buffer)
	{
	...
	public unsafe static void Invoke([MangledName("this")] Scanf_core_Reader* This, [MangledName("stream")][NativeType("void*")] void* Stream, [MangledName("stream_getc_in")][NativeType("int (*)(void*)")] void* Stream_getc_in, [MangledName("stream_ungetc_in")][NativeType("void (*)(int, void*)")] void* Stream_ungetc_in, [MangledName("stream_buffer")][NativeType("__llvm_libc_20_1_2_::scanf_core::ReadBuffer*")] Scanf_core_ReadBuffer* Stream_buffer)
	{
