...
internal static partial class Generic_add_or_sub_true_Float16_float128
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
		...
		unchecked
		{
			...
			double num14 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi3);
			...
			double num15 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi4);
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi5, *(double*)Cpp_max_float128.Invoke(&num6, &num7));
				Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi6);
				*(Int128*)(&fputil_FPBits_ubgsi6) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi6, *(double*)Cpp_min_float128.Invoke(&num6, &num7));
				...
				else
				{
					...
					*(long*)num27 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num8 = unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi5)) - unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi6));
				...
				num9 = checked(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_exponent.Invoke(&fputil_FPBits_ubgsi5) - 115);
