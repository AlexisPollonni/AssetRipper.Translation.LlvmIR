...
internal static partial class Generic_add_or_sub_true_Float16_float128
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic10add_or_subILb1EDF16_gEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT0_Esr3cppE19is_floating_point_vIT1_ElestS5_stS6_ES5_E4typeES6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<_Float16> && cpp::is_floating_point_v<__float128> && sizeof (_Float16) <= sizeof (__float128), _Float16>::type __llvm_libc_20_1_2_::fputil::generic::add_or_sub<true, _Float16, __float128>(__float128, __float128)")]
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			if (!Details_expects_bool_condition_bool.Invoke(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) || FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)), Expected: false))
			{
				goto IL_08ce;
			}
			if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
			{
				...
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)))
				{
					...
					*(long*)num11 = struct_fiz2nb3.field_1;
					...
					anon_izyfb3.Val = FPStorage_fputil_FPType_3_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
					short field_ = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(V: (short)@int, Sign: anon_izyfb3.Val);
				...
				else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
				{
					...
					*(long*)num13 = struct_fiz2nb6.field_1;
					...
					anon_izyfb4.Val = FPStorage_fputil_FPType_3_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
					short field_2 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(V: (short)int3, Sign: anon_izyfb4.Val);
			...
			{
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
				{
					if ((b & 1) != 1)
					{
						Fputil_raise_except_if_required.Invoke(1);
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
			{
				...
				anon_izyfb9.Val = FPStorage_fputil_FPType_3_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)))
			{
				...
				else
				{
					...
					num4 = Y;
					num4 = 0.0 - num4;
					result = Fputil_cast_Float16_float128.Invoke(num4);
			...
			else
			{
				...
				num5 = Y;
				num5 = 0.0 - num5;
				result = Fputil_cast_Float16_float128.Invoke(num5);
		...
		Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
		...
		unchecked
		{
			...
			double num14 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
			...
			Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
			...
			double num15 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4);
			...
			if (num6 == num7 && (b & 1) != 1)
			{
				if (Fputil_quick_get_round.Invoke() == 1024)
				{
					...
					llvm_libc_20_1_2_fputil_FPBits_2fahva10.FPRepImpl.FPRepSem.FPStorage.field_0 = field_10;
				...
				else
				{
					...
					llvm_libc_20_1_2_fputil_FPBits_2fahva11.FPRepImpl.FPRepSem.FPStorage.field_0 = field_11;
			...
			else
			{
				...
				*(sbyte*)(&anon_izyfb14) = -86;
				...
				if (num6 > num7)
				{
					...
					anon_izyfb15.Val = FPStorage_fputil_FPType_3_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
				...
				else if (num6 < num7)
				{
					if ((b & 1) == 1)
					{
						...
						anon_izyfb16.Val = FPStorage_fputil_FPType_3_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
						Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb14, &anon_izyfb16, 1L, isVolatile: false);
						Llvm_lifetime_end_p0.Invoke(1L, &anon_izyfb16);
					}
					else if (FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_pos.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2))
					{
				...
				else if ((b & 1) == 1)
				{
					...
					anon_izyfb17.Val = FPStorage_fputil_FPType_3_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi);
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5, *(double*)Cpp_max_float128.Invoke(&num6, &num7));
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6, *(double*)Cpp_min_float128.Invoke(&num6, &num7));
				Llvm_lifetime_start_p0.Invoke(16L, &int5);
				int5 = -6148914691236517206L;
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5)))
				{
					if ((b & 1) == 1)
					{
						Struct_fiz2nb struct_fiz2nb13 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5);
						Int128* num16 = &int6;
						...
						*(long*)num17 = struct_fiz2nb15.field_1;
						Int128 x6 = int6;
						Struct_fiz2nb struct_fiz2nb16 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6);
						Int128* num18 = &y;
						Struct_fiz2nb struct_fiz2nb17 = struct_fiz2nb16;
						*(long*)num18 = struct_fiz2nb17.field_0;
						byte* num19 = (byte*)(&y) + 8u;
						Struct_fiz2nb struct_fiz2nb18 = struct_fiz2nb16;
						*(long*)num19 = struct_fiz2nb18.field_1;
						int5 = NumericHelper.Add(x6, y);
					}
					else
					{
						Struct_fiz2nb struct_fiz2nb19 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5);
						Int128* num20 = &int7;
						...
						*(long*)num21 = struct_fiz2nb21.field_1;
						Int128 x7 = int7;
						Struct_fiz2nb struct_fiz2nb22 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6);
						Int128* num22 = &y2;
						Struct_fiz2nb struct_fiz2nb23 = struct_fiz2nb22;
						*(long*)num22 = struct_fiz2nb23.field_0;
						byte* num23 = (byte*)(&y2) + 8u;
						Struct_fiz2nb struct_fiz2nb24 = struct_fiz2nb22;
						*(long*)num23 = struct_fiz2nb24.field_1;
						int5 = NumericHelper.Subtract(x7, y2);
					}
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb25 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5));
					Int128* num24 = &x2;
					Struct_fiz2nb struct_fiz2nb26 = struct_fiz2nb25;
					*(long*)num24 = struct_fiz2nb26.field_0;
					byte* num25 = (byte*)(&x2) + 8u;
					Struct_fiz2nb struct_fiz2nb27 = struct_fiz2nb25;
					*(long*)num25 = struct_fiz2nb27.field_1;
					x = NumericHelper.ShiftLeft(x2, 3L);
					Llvm_lifetime_start_p0.Invoke(16L, &x3);
					Struct_fiz2nb struct_fiz2nb28 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6));
					Int128* num26 = &x4;
					Struct_fiz2nb struct_fiz2nb29 = struct_fiz2nb28;
					*(long*)num26 = struct_fiz2nb29.field_0;
					byte* num27 = (byte*)(&x4) + 8u;
					...
					*(long*)num27 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num8 = unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5)) - unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6));
						Llvm_lifetime_start_p0.Invoke(16L, &x5);
					}
					x5 = NumericHelper.ShiftRightLogical(x3, (Int128)(UInt128)(*(uint*)Cpp_min_int.Invoke(&num8, &num3)));
					Llvm_lifetime_start_p0.Invoke(1L, &b2);
					b2 = -86;
					b2 = ((num8 > 3 && (num8 > 115 || NumericHelper.IntCmpNe(NumericHelper.ShiftLeft(x3, (Int128)(UInt128)(uint)checked(128 - num8)), 0L))) ? ((sbyte)1) : ((sbyte)0));
					Llvm_lifetime_start_p0.Invoke(16L, &y3);
					y3 = (((b2 & 1) == 1) ? 1 : 0);
					int5 = (((b & 1) != 1) ? NumericHelper.Subtract(x, NumericHelper.BitwiseOr(x5, y3)) : NumericHelper.Add(x, NumericHelper.BitwiseOr(x5, y3)));
				...
				num9 = checked(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5) - 115);
