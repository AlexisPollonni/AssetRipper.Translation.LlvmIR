...
internal static partial class BigInt_128ul_false_unsigned_long_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Anon_izyfb7* This, [MangledName("words")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 2ul> const&")] Llvm_libc_20_1_2_cpp_array_i3937k* Words)
	{
		unchecked
		{
			Llvm_memset_p0_i64.Invoke(&((Llvm_libc_20_1_2_BigInt_qdkjbh*)This)->Val.Data, 0, 16L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&((Llvm_libc_20_1_2_BigInt_qdkjbh*)This)->Val, Words, 16L, isVolatile: false);
		}
	}
	...
	{
		Llvm_memset_p0_i64.Invoke(&unchecked((Llvm_libc_20_1_2_BigInt_qdkjbh*)This)->Val.Data, 0, 16L, isVolatile: false);
	}
}
