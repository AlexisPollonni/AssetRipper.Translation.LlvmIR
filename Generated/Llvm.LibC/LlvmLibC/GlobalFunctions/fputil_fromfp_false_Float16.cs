				...
				*(short*)(&fputil_FPBits_2fahva3) = -21846;
				...
				else
				{
					...
					if (NumericHelper.FcmpOlt(half, default(Half)))
					{
						...
						short field_3 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(anon_izyfb10.val, 0);
					...
					else
					{
						...
						short field_4 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(biased_exp: num2, sign: anon_izyfb11.val, mantissa: 0);
						fputil_FPBits_2fahva6.FPRepImpl.FPRepSem.FPStorage.field_0 = field_4;
						Half half2 = (Half)((float)FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva6) - 1f);
						...
						if (NumericHelper.FcmpOgt(half, y))
						{
							...
							short field_5 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(anon_izyfb12.val, 0);
