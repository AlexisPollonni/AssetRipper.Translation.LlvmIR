...
internal static partial class BigInt_320ul_false_unsigned_long_BigInt_unsigned_int128_void
{
		...
		unchecked
		{
			*(long*)(&@int) = v;
			...
			while (true)
			{
				...
				{
					BigInt_320ul_false_unsigned_long_extend.Invoke(@this, num2, (b & 1) == 1);
					num3 = 1;
					break;
				}
				long num4 = (long)int2;
				*(long*)array_unsigned_long_5ul_Index_wu6ki8.Invoke(&@this->val, num2) = num4;
