...
internal static partial class Memmove_cpp_array_unsigned_char_vector_16_4ul_head_tail
{
	...
	public unsafe static void Invoke([NativeType("__llvm_libc_20_1_2_::cpp::byte*")] void* dst, [NativeType("__llvm_libc_20_1_2_::cpp::byte const*")] void* src, [NativeType("unsigned long")] long count)
	{
		...
		unchecked
		{
			...
			generic_load_cpp_array_unsigned_char_vector_16_4ul.Invoke(&cpp_array_2b9gdz3, (byte*)src + num);
			...
			generic_store_cpp_array_unsigned_char_vector_16_4ul.Invoke(dst2, &cpp_array_2b9gdz5);
