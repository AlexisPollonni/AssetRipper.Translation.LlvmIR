			...
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_11ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_LOGF16_EXCEPTS.Pointer);
				*(int*)(&llvm_libc_20_1_2_cpp_optional_aq7wey.Storage) = storage;
				...
				case 0:
					...
					num6 = Fputil_multiply_add_float.Invoke(x, *(float*)Array_float_32ul_Index.Invoke(Index: num5, This: Llvm_libc_20_1_2_ONE_OVER_F_F.Pointer), -1f);
					...
					z = *(float*)Array_float_32ul_Index.Invoke(Index: num5, This: Llvm_libc_20_1_2_LOGF_F.Pointer) + num7;
