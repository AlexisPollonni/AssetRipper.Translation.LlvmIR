			...
			*ptr = -86;
			...
			if ((b3 & 1) == 1)
			{
				...
				if (num2 == 0)
				{
					...
					llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up2.Exponent = 0;
					Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Value, &llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up2, 8L, isVolatile: false);
				...
				else
				{
					...
					*(int*)ptr2 = -1431655766;
					...
					llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up3.Mantissa = num2;
					llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up3.Exponent = num3;
					struct_3driym = Internal_decimal_exp_to_float_float.Invoke(Truncated: (b2 & 1) == 1, Round: Round, NumStart: Src, Num_len: Integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke(), Init_num: *(long*)(&llvm_libc_20_1_2_internal_ExpandedFloat_i7t5up3));
