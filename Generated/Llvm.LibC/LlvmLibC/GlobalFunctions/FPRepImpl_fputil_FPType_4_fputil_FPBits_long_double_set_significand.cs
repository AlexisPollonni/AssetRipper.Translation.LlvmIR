...
internal static partial class FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_significand
{
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("sigVal.coerce0")] long SigVal, [MangledName("sigVal.coerce1")] long SigVal_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = SigVal;
			...
			Int128 int4 = -1L;
			Struct_fiz2nb struct_fiz2nb = FPStorage_fputil_FPType_4_merge.Invoke(a, b, mask, b_coerce, *(long*)(&int4), ((long*)(&int4))[1]);
			Int128* num = &field_;
