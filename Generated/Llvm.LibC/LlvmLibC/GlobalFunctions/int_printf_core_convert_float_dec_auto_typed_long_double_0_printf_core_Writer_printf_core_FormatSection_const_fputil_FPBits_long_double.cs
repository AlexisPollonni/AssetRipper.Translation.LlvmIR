...
internal static partial class int_printf_core_convert_float_dec_auto_typed_long_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_long_double
{
	public unsafe static int Invoke(printf_core_Writer* writer, printf_core_FormatSection* to_conv, [MangledName("float_bits.coerce0")] long float_bits, [MangledName("float_bits.coerce1")] long FRACTION_LEN)
	{
		...
		unchecked
		{
			...
			*(long*)num30 = struct_fiz2nb3.field_1;
			...
			if (NumericHelper.IntCmpNe(x, 0L))
			{
				...
				long num31 = IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_size_const.Invoke(&integerToString_uuwdyc);
				...
				*(long*)num35 = struct_kqhe8i6.field_1;
				...
				if ((uint)num19 == num15)
				{
					...
					num21 = FloatToString_long_double_0_get_block_int.Invoke(&floatToString_8m29tk, num6);
					...
					if ((b & 1) != 1)
					{
						if (num6 >= 0)
						{
							...
							for (k = num6 - 1; k >= 0; k += -1)
							{
								...
								num23 = FloatToString_long_double_0_get_block_int.Invoke(&floatToString_8m29tk, k);
								int num36;
								if (num23 != 0)
								{
									b = 1;
						...
						if ((b & 1) != 1 && num2 - 63 < 0)
						{
							...
							unchecked
							{
								...
								*(long*)num38 = struct_fiz2nb6.field_1;
								int3 = int2;
								b = (sbyte)(byte)((cpp_enable_if_cpp_is_integral_v_unsigned_int128_is_big_int_v_unsigned_int128_bool_type_printf_core_zero_after_digits_unsigned_int128_int_int_unsigned_int128_int.Invoke(base_2_exp, digits_after_point, *(long*)(&int3), ((long*)(&int3))[1], 63) ? 1 : 0) ^ -1);
							}
						}
					}
					last_digit = num20;
				...
				if (num3 > num4 && num4 >= -4)
				{
					...
					result = int_printf_core_convert_float_decimal_typed_long_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_long_double.Invoke(writer, &printf_core_FormatSection3, *(long*)(&fputil_FPBits_ubgsi5), ((long*)(&fputil_FPBits_ubgsi5))[1]);
				...
				else
				{
					...
					result = int_printf_core_convert_float_dec_exp_typed_long_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_long_double.Invoke(writer, &printf_core_FormatSection4, *(long*)(&fputil_FPBits_ubgsi6), ((long*)(&fputil_FPBits_ubgsi6))[1]);
			...
			else
			{
				...
				result = int_printf_core_convert_float_decimal_typed_long_double_0_printf_core_Writer_printf_core_FormatSection_const_fputil_FPBits_long_double.Invoke(writer, &printf_core_FormatSection2, *(long*)(&fputil_FPBits_ubgsi4), ((long*)(&fputil_FPBits_ubgsi4))[1]);
