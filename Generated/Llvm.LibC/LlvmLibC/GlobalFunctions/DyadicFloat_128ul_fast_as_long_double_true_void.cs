		...
		unchecked
		{
			...
			else
			{
				...
				if (details_expects_bool_condition_bool.Invoke(num2 > 32766, expected: false))
				{
					...
					double num18 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi4);
					...
					FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi5, num5);
					bool num19 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf.Invoke(&fputil_FPBits_ubgsi5);
				...
				else
				{
					...
					*(long*)num21 = struct_fiz2nb12.field_1;
					...
					double num22 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi6);
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					if (details_expects_bool_condition_bool.Invoke(num7 <= 0, expected: false))
					{
						...
						double num26 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi7);
						...
						double num27 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi8);
						...
						num10 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi9);
					...
					else
					{
						...
						num10 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi10);
						...
						if (details_expects_bool_condition_bool.Invoke((b & 1) == 1, expected: false))
						{
							...
							FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi11, num16);
							Struct_fiz2nb struct_fiz2nb40 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&fputil_FPBits_ubgsi11);
							Int128* num29 = &x2;
							...
							*(long*)num30 = struct_fiz2nb42.field_1;
							...
							int15 = int14;
							FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi12, *(long*)(&int15), ((long*)(&int15))[1]);
							result = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi12);
