...
internal static partial class FPRepSem_fputil_FPType_2_fputil_FPBits_double_signaling_nan
{
	...
	public unsafe static long Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign, [NativeType("unsigned long")] long v)
	{
		...
		if (v != 0L)
		{
			Significand_Constructor_zv26wp.Invoke(&fputil_internal_FPRepSem_fq8nhg2, v);
		}
		else
		{
			long val = Significand_msb_b4svue.Invoke();
			fputil_internal_FPRepSem_fq8nhg3.FPStorage.val = val;
			long val2 = internal_RightShift_qxbw53.Invoke(fputil_internal_FPRepSem_fq8nhg3.FPStorage.val, 1);
