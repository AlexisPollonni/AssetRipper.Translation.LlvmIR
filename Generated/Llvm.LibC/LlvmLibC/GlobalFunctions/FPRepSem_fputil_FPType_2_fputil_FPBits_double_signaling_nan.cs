...
internal static partial class FPRepSem_fputil_FPType_2_fputil_FPBits_double_signaling_nan
{
	...
	public unsafe static long Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte Sign, [MangledName("v")][NativeType("unsigned long")] long V)
	{
		...
		if (V != 0L)
		{
			Significand_Constructor_zv26wp.Invoke(&fputil_internal_FPRepSem_fq8nhg, V);
		}
		else
		{
			long val = Significand_msb_b4svue.Invoke();
			fputil_internal_FPRepSem_fq8nhg2.FPStorage.Val = val;
			long val2 = Internal_RightShift_qxbw53.Invoke(fputil_internal_FPRepSem_fq8nhg2.FPStorage.Val, 1);
			fputil_internal_FPRepSem_fq8nhg.FPStorage.Val = val2;
		}
