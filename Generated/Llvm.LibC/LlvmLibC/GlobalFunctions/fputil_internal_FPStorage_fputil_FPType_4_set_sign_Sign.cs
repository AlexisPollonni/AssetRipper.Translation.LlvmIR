...
internal static partial class fputil_internal_FPStorage_fputil_FPType_4_set_sign_Sign
{
	public unsafe static void Invoke(void* @this, [MangledName("signVal.coerce")] sbyte signVal)
	{
		...
		anon_izyfb9.val = fputil_internal_FPStorage_fputil_FPType_4_sign_const.Invoke(@this);
