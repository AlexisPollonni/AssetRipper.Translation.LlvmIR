...
internal static partial class anonymous_namespace_exp_double_double
{
	...
	public unsafe static Struct_4ydhja Invoke([NativeType("double")] double x, [NativeType("double")] double kd, [NativeType("__llvm_libc_20_1_2_::NumberPair<double> const&")] NumberPair* exp_mid)
	{
	...
	public unsafe static Struct_4ydhja Invoke([NativeType("double")] double x, [NativeType("double")] double kd, [NativeType("__llvm_libc_20_1_2_::NumberPair<double> const&")] NumberPair* exp_mid, [NativeType("__llvm_libc_20_1_2_::NumberPair<double> const&")] NumberPair* hi_part)
	{
		NumberPair numberPair = default(NumberPair);
		double a = 0.0;
		double b = 0.0;
