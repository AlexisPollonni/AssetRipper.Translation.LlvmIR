		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			else if (Details_expects_bool_condition_bool.Invoke(num2 == 1176082840, Expected: false))
			{
				...
				if ((num6 == 1024 && FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_pos.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs))) || (num6 == 2048 && FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs))))
				{
					num5 = -0.34761328f;
				}
				result = ((!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs))) ? num5 : (0f - num5));
			...
			else
			{
				...
				x3 = double.NaN;
				Sincosf_eval.Invoke(num3, num2, &num7, &y, &x2, &x3);
