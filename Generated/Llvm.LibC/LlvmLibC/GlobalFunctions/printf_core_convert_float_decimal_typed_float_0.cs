...
internal static partial class printf_core_convert_float_decimal_typed_float_0
{
	...
	public unsafe static int Invoke([NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] printf_core_Writer* writer, [NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] printf_core_FormatSection* to_conv, [MangledName("float_bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<float>")] int float_bits)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			PaddingWriter_Constructor.Invoke(&printf_core_PaddingWriter2, to_conv, init_sign_char);
			...
			FloatWriter_Constructor.Invoke(&printf_core_FloatWriter2, writer, (b & 1) == 1, &printf_core_PaddingWriter2);
		...
		unchecked
		{
			while (true)
			{
				...
				num6 = FloatToString_float_0_get_positive_block.Invoke(&floatToString_vnf, num5);
				if ((b2 & 1) == 1)
				{
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = FloatWriter_write_middle_block.Invoke(&printf_core_FloatWriter2, num6);
					if (num7 < 0)
					{
						result = num7;
						num22 = 1;
				...
				else if (num6 != 0)
				{
					...
					num8 = num5;
					FloatWriter_init.Invoke(&printf_core_FloatWriter2, num8 * 9L + InstructionHelper.Select((b & 1) == 1, 1, 0) + (uint)num3, num8 * 9L);
					FloatWriter_write_first_block.Invoke(&printf_core_FloatWriter2, num6, exp_format: false);
					b2 = 1;
			...
			if ((b2 & 1) != 1)
			{
				FloatWriter_init.Invoke(&printf_core_FloatWriter2, (uint)(InstructionHelper.Select((b & 1) == 1, 1, 0) + num3), 0L);
				FloatWriter_write_first_block.Invoke(&printf_core_FloatWriter2, 0, exp_format: false);
			}
			if (num2 < 23)
			{
				...
				if ((ulong)(uint)num9 <= (ulong)FloatToString_float_0_zero_blocks_after_point.Invoke(&floatToString_vnf))
				{
					...
					num11 = FloatWriter_write_zeroes.Invoke(&printf_core_FloatWriter2, num3);
					if (num11 < 0)
					{
						result = num11;
						num22 = 1;
				...
				else if ((ulong)(uint)num10 < (ulong)FloatToString_float_0_zero_blocks_after_point.Invoke(&floatToString_vnf))
				{
					...
					num12 = FloatWriter_write_zeroes.Invoke(&printf_core_FloatWriter2, 9 * num10);
					if (num12 < 0)
					{
						result = num12;
						num22 = 1;
				...
				while (true)
				{
					...
					{
						if (FloatToString_float_0_is_lowest_block.Invoke(&floatToString_vnf, (uint)num10))
						{
							llvm_lifetime_start_p0.Invoke(4L, &num_zeroes);
							num_zeroes = num3 - 9 * num10;
							llvm_lifetime_start_p0.Invoke(4L, &num13);
							num13 = FloatWriter_write_zeroes.Invoke(&printf_core_FloatWriter2, num_zeroes);
							if (num13 < 0)
							{
								result = num13;
								num22 = 1;
						...
						else
						{
							...
							num14 = FloatToString_float_0_get_negative_block.Invoke(&floatToString_vnf, num10);
							if ((uint)num10 < (uint)(num9 - 1))
							{
								llvm_lifetime_start_p0.Invoke(4L, &num15);
								num15 = FloatWriter_write_middle_block.Invoke(&printf_core_FloatWriter2, num14);
								if (num15 < 0)
								{
									result = num15;
									num22 = 1;
							...
							else
							{
								...
								b3 = (sbyte)(byte)((printf_core_zero_after_digits_unsigned_int.Invoke(checked(num2 - 23), num3, FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs2), 23) ? 1 : 0) ^ -1);
								int last_digit = num17;
								bool truncated = (b3 & 1) == 1;
								anon_izyfb8.val = FPStorage_fputil_FPType_1_sign.Invoke(&fputil_FPBits_5nkvcs2);
								num18 = (int)printf_core_get_round_direction.Invoke(last_digit, truncated, anon_izyfb8.val);
								llvm_lifetime_start_p0.Invoke(4L, &num19);
								num19 = FloatWriter_write_last_block.Invoke(&printf_core_FloatWriter2, num14, (uint)num16, (RoundDirection_zvveyk)num18, 0, 0);
								if (num19 < 0)
								{
									result = num19;
									num22 = 1;
			...
			num20 = FloatWriter_write_zeroes.Invoke(&printf_core_FloatWriter2, num3);
			if (num20 < 0)
			{
				result = num20;
				num22 = 1;
		...
		num21 = FloatWriter_right_pad.Invoke(&printf_core_FloatWriter2);
		if (num21 < 0)
		{
			result = num21;
			num22 = 1;
