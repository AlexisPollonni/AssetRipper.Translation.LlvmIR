	...
	public unsafe static long Invoke(void* @this, int x_abs, bool sign)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(x_abs == ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_7xi2jk*)@this)->values))[num].input, expected: false))
				{
