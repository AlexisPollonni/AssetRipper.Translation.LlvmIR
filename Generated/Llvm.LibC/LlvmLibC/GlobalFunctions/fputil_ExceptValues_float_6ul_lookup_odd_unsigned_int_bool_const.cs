...
internal static partial class fputil_ExceptValues_float_6ul_lookup_odd_unsigned_int_bool_const
{
	public unsafe static long Invoke(void* @this, int x_abs, bool sign)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(x_abs == ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_x9e5i2*)@this)->values))[num].input, expected: false))
				{
					...
					case 2048:
						if ((b & 1) == 1)
						{
							int rnd_downward_offset2 = ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_x9e5i2*)@this)->values))[num].rnd_downward_offset;
							num2 += rnd_downward_offset2;
						}
						else
						{
							int rnd_upward_offset2 = ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_x9e5i2*)@this)->values))[num].rnd_upward_offset;
					...
					float num5 = fputil_FPBits_float_get_val_const.Invoke(&fputil_FPBits_5nkvcs2);
