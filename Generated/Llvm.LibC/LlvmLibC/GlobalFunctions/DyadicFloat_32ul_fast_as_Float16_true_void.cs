	...
	public unsafe static Half Invoke([MangledName("this")] void* This)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				checked
				{
					num3 = unchecked((Llvm_libc_20_1_2_fputil_DyadicFloat_cs3nhs*)This)->Exponent + 46;
				}
				...
				else
				{
					...
					*(int*)(&llvm_libc_20_1_2_BigInt_vtm4cw) = -1431655766;
					...
					{
						int data = BigInt_32ul_false_unsigned_int_RightShift.Invoke(&((Llvm_libc_20_1_2_fputil_DyadicFloat_cs3nhs*)This)->Mantissa, (uint)num4);
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(Biased_exp: (short)num3, Mantissa: (short)(((ushort)BigInt_32ul_false_unsigned_int_Unsigned_short_unsigned_short.Invoke(&llvm_libc_20_1_2_BigInt_vtm4cw) & 0x3FF) | 0), Sign: anon_izyfb3.Val);
					...
					*(int*)(&llvm_libc_20_1_2_BigInt_vtm4cw2) = -1431655766;
					...
					else
					{
						...
						int data2 = BigInt_32ul_false_unsigned_int_LeftShift.Invoke(&llvm_libc_20_1_2_BigInt_vtm4cw3, (uint)(num4 - 1));
					...
					*(int*)(&llvm_libc_20_1_2_BigInt_vtm4cw7.Val.Data) = data5;
					...
					if (Details_expects_bool_condition_bool.Invoke(num5 <= 0, Expected: false))
					{
						...
						Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb6, &((Llvm_libc_20_1_2_fputil_DyadicFloat_cs3nhs*)This)->Sign, 1L, isVolatile: false);
