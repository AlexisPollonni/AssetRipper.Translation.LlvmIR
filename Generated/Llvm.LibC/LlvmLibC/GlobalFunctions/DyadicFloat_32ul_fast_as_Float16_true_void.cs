			...
			else
			{
				...
				else
				{
					...
					*(int*)(&bigInt_vtm4cw) = -1431655766;
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(biased_exp: (short)num3, mantissa: (short)(((ushort)BigInt_32ul_false_unsigned_int_unsigned_short_unsigned_short.Invoke(&bigInt_vtm4cw) & 0x3FF) | 0), sign: anon_izyfb10.val);
					...
					*(int*)(&bigInt_vtm4cw6.val.Data) = data4;
					int num12 = (BigInt_32ul_false_unsigned_int_is_zero.Invoke(&bigInt_vtm4cw6) ? 1 : 0) ^ -1;
					...
					*(int*)(&bigInt_vtm4cw7.val.Data) = data5;
					int num13 = (BigInt_32ul_false_unsigned_int_is_zero.Invoke(&bigInt_vtm4cw7) ? 1 : 0) ^ -1;
