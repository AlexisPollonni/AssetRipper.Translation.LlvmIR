...
internal static partial class Fputil_fmaximum_mag_long_double_0
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("y")][NativeType("long double")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			double result = ((!(Fputil_abs_long_double_0.Invoke(X) > Fputil_abs_long_double_0.Invoke(Y))) ? ((!(Fputil_abs_long_double_0.Invoke(Y) > Fputil_abs_long_double_0.Invoke(X))) ? Fputil_fmaximum_long_double_0.Invoke(X, Y) : Y) : X);
