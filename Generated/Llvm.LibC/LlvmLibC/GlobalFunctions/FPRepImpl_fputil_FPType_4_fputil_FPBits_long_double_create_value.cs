	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte sign, [MangledName("biased_exp.coerce0")] long biased_exp, [MangledName("biased_exp.coerce1")] long mantissa, [MangledName("mantissa.coerce0")] long mantissa_coerce0, [MangledName("mantissa.coerce1")] long mantissa_coerce1)
	{
		...
		unchecked
		{
			...
			*(long*)(&int2) = mantissa_coerce0;
			...
			BiasedExponent_Constructor_w8dba9.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2, (int)int4);
			Int128 int6 = int5;
			Significand_Constructor_j3ersh.Invoke(&fputil_internal_FPRepSem_f94eua2, *(long*)(&int6), ((long*)(&int6))[1]);
			Struct_fiz2nb struct_fiz2nb = FPStorage_fputil_FPType_4_encode.Invoke(anon_izyfb9.val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1]);
			Int128* num = &int3;
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			Int128 int7 = int3;
			FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int7), ((long*)(&int7))[1]);
