...
internal static partial class Fputil_fminimum_mag_num_long_double_0
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil16fminimum_mag_numIeTnNS_3cpp9enable_ifIXsr3cppE19is_floating_point_vIT_EEiE4typeELi0EEES4_S4_S4_")]
	[DemangledName("long double __llvm_libc_20_1_2_::fputil::fminimum_mag_num<long double, 0>(long double, long double)")]
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("y")][NativeType("long double")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			double result = ((!(Fputil_abs_long_double_0.Invoke(X) < Fputil_abs_long_double_0.Invoke(Y))) ? ((!(Fputil_abs_long_double_0.Invoke(Y) < Fputil_abs_long_double_0.Invoke(X))) ? Fputil_fminimum_num_long_double_0.Invoke(X, Y) : Y) : X);
