		...
		unchecked
		{
			...
			*(double*)ptr2 = double.NaN;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num < 1039, expected: true))
			{
				...
				{
					if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num < 997, expected: false))
					{
			...
			*(double*)num15 = struct_4ydhja9.field_1;
			double num16 = numberPair6.lo + numberPair7.lo;
			...
			else
			{
				...
				*(long*)ptr8 = -6148914691236517206L;
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((ushort)num < 1039, expected: true))
				{
					...
					range_reduction_small_f128_double_19.Invoke(&fputil_DyadicFloat_kt2kd8, x);
				...
				*(long*)ptr10 = -6148914691236517206L;
				...
				sin_impl_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd10, &anon_izyfb9, num2);
				...
				*(long*)ptr12 = -6148914691236517206L;
				...
				sin_impl_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd11, &anon_izyfb9, num2 + 64);
				...
				*(long*)ptr14 = -6148914691236517206L;
				...
				fputil_DyadicFloat_128ul_fputil_quick_mul_128ul_fputil_DyadicFloat_128ul_const_fputil_DyadicFloat_128ul_const.Invoke(&fputil_DyadicFloat_kt2kd13, &fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd7);
				fputil_DyadicFloat_128ul_fputil_quick_mul_128ul_fputil_DyadicFloat_128ul_const_fputil_DyadicFloat_128ul_const.Invoke(&fputil_DyadicFloat_kt2kd14, &fputil_DyadicFloat_kt2kd11, &fputil_DyadicFloat_kt2kd6);
