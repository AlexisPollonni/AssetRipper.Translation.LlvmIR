			...
			*(double*)num17 = struct_4ydhja9.field_1;
			...
			else
			{
				...
				*(long*)ptr10 = -6148914691236517206L;
				...
				sin_impl_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd10, &anon_izyfb13, num2);
				...
				*(long*)ptr12 = -6148914691236517206L;
				...
				sin_impl_double_0_operator_unsigned_int_const.Invoke(&fputil_DyadicFloat_kt2kd11, &anon_izyfb13, num2 + 64);
