...
internal static partial class cpp_enable_if_cpp_is_unsigned_v_unsigned_long_long_unsigned_long_long_type_cpp_bit_ceil_unsigned_long_long_unsigned_long_long
{
	public static long Invoke(long value)
	{
		unchecked
		{
			...
			return 1L << (int)(uint)cpp_enable_if_cpp_is_unsigned_v_unsigned_long_long_int_type_cpp_bit_width_unsigned_long_long_unsigned_long_long.Invoke(value - 1L);
		}
	}
}
