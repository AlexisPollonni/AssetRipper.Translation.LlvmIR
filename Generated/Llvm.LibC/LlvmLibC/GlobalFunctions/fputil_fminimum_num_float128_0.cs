	...
	public unsafe static double Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			result = ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3))) ? ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4))) ? internal_min_float128.Invoke(x, y) : x) : y);
			goto IL_01ad;
		}
		IL_01ad:
