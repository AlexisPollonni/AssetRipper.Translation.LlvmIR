...
internal static partial class FloatToString_long_double_0_grab_digits_128ul
{
	...
	{
		Cpp_optional_neprgb cpp_optional_neprgb = default(Cpp_optional_neprgb);
		Llvm_lifetime_start_p0.Invoke(24L, &cpp_optional_neprgb);
		unchecked
		{
			sbyte* ptr = (sbyte*)(&cpp_optional_neprgb);
			sbyte* ptr2 = ptr;
			...
			*ptr3 = -86;
			...
			ptr3[5] = -86;
			ptr3[6] = -86;
			BigInt_128ul_false_unsigned_long_div_uint_half_times_pow_2.Invoke(&cpp_optional_neprgb, Int_num, 1953125, 9L);
			int result = BigInt_128ul_false_unsigned_long_Unsigned_int_unsigned_int.Invoke(Optional_BigInt_128ul_false_unsigned_long_value.Invoke(&cpp_optional_neprgb));
			Llvm_lifetime_end_p0.Invoke(24L, &cpp_optional_neprgb);
			return result;
		}
	}
}
