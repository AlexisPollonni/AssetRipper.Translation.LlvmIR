...
internal static partial class FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_quiet_nan
{
	...
	public unsafe static bool Invoke([MangledName("this")] void* This)
	{
		...
		return unchecked((uint)num >= (uint)FPStorage_fputil_FPType_1_encode_ihn944.Invoke(llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3.field_0.field_0));
	}
}
