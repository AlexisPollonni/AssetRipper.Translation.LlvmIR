...
internal static partial class anonymous_namespace_exp_double_double_double_double_NumberPair_double_const_NumberPair_double_const
{
	public unsafe static Struct_4ydhja Invoke(double x, double kd, NumberPair* exp_mid, NumberPair* hi_part)
	{
		...
		unchecked
		{
			...
			*(double*)(&numberPair3) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja4 = anonymous_namespace_poly_approx_dd_NumberPair_double_const.Invoke(&numberPair2);
			...
			*(double*)(&numberPair) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja7 = NumberPair_double_fputil_quick_mult_27ul_NumberPair_double_const_NumberPair_double_const.Invoke(exp_mid, &numberPair2);
			...
			*(double*)num7 = struct_4ydhja9.field_1;
			Struct_4ydhja struct_4ydhja10 = cpp_enable_if_sizeof_NumberPair_double_8ul_NumberPair_double_type_fputil_multiply_add_NumberPair_double_NumberPair_double_const_NumberPair_double_const_NumberPair_double_const.Invoke(&numberPair4, &numberPair3, hi_part);
