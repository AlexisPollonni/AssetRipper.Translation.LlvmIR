			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un2) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 1uL; num5++)
				{
					...
					num6 = lambda0_Invoke_ntek6y.Invoke(&anon_6je4un2, num5 + num3);
					llvm_lifetime_start_p0.Invoke(2L, &num7);
					num7 = lambda0_Invoke_ntek6y.Invoke(&anon_6je4un2, num5 + num3 + 1L);
					llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = array_unsigned_short_1ul_Index_yq9pn3.Invoke(&cpp_array_knh6hw2, lambda_Invoke_hakpqu.Invoke(&anon_izyfb8, num5));
					if (num4 == 0L)
					{
						*(short*)ptr = num6;
					}
