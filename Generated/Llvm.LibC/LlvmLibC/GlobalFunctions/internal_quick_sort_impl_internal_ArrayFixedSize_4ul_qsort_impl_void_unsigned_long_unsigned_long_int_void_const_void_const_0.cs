...
internal static partial class internal_quick_sort_impl_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0
{
	...
	public unsafe static void Invoke([NativeType("__llvm_libc_20_1_2_::internal::ArrayFixedSize<4ul>&")] void* array, [NativeType("void const*")] void* ancestor_pivot, [NativeType("unsigned long")] long limit, [NativeType("__llvm_libc_20_1_2_::__qsort_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*))::$_0 const&")] void* is_less)
	{
		long num = 0L;
		long num2 = 0L;
		long num3 = 0L;
		...
		unchecked
		{
			while (true)
			{
				...
				{
					internal_heap_sort_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(array, is_less);
					num7 = 1;
				}
				else
				{
					...
					num2 = internal_choose_pivot_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(array, is_less);
					if (ptr2 != null && !_0_Invoke_4rap2e.Invoke(is_less, ptr2, ArrayFixedSize_4ul_get.Invoke(array, num2)))
					{
						...
						long num8 = internal_partition_internal_ArrayFixedSize_4ul_void_internal_quick_sort_impl_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_internal_ArrayFixedSize_4ul_void_const_unsigned_long_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0_const_lambda_void_const_void_const.Invoke(array, pivot_index, &anon_7y5tgm2);
						llvm_lifetime_end_p0.Invoke(8L, &anon_7y5tgm2);
						num3 = num8;
						ArrayFixedSize_4ul_reset_bounds.Invoke(array, num3 + 1L, ArrayFixedSize_4ul_len.Invoke(array) - (num3 + 1L));
						ptr2 = null;
						num7 = 2;
					...
					else
					{
						...
						num4 = internal_partition_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(array, num2, is_less);
						if (num == 2L)
						{
							num7 = 1;
						}
