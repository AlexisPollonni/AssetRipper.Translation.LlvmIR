...
internal static partial class Internal_simple_decimal_conversion_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_internal_FloatConvertReturn_g92bm8* Agg_result, [MangledName("numStart")][NativeType("char const*")] void* NumStart, [MangledName("num_len")][NativeType("unsigned long")] long Num_len, [MangledName("round")][NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy Round)
	{
		int i = 0;
		...
		{
			Llvm_lifetime_start_p0.Invoke(16L, &llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv);
			llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv.Mantissa = 0L;
			llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv.Exponent = 0;
			Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Num, &llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv, 16L, isVolatile: false);
			Llvm_lifetime_end_p0.Invoke(16L, &llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv);
		}
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal) > 0 && Internal_exp10_to_exp2.Invoke(HighPrecisionDecimal_get_decimal_point.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal) - 1) > 1023)
		{
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal) < 0 && Internal_exp10_to_exp2.Invoke(-HighPrecisionDecimal_get_decimal_point.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal)) > 1075)
		{
		...
		else
		{
			...
			if (i >= 2047)
			{
				...
				llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv4.Mantissa = 0L;
				llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv4.Exponent = 2047;
			...
			{
				HighPrecisionDecimal_shift.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal, 52);
				Llvm_lifetime_start_p0.Invoke(8L, &num3);
				num3 = HighPrecisionDecimal_round_to_integer_type_unsigned_long.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal, RoundDirection_b3pcwy.Nearest);
				if (i <= 0)
				{
					for (; i < 0; i++)
					{
					...
					HighPrecisionDecimal_shift.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal, -1);
					num3 = HighPrecisionDecimal_round_to_integer_type_unsigned_long.Invoke(&llvm_libc_20_1_2_internal_HighPrecisionDecimal, Round);
					if (num3 >>> 52 != 0L)
					{
						i++;
					}
				...
				Llvm_lifetime_start_p0.Invoke(16L, &llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv5);
				llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv5.Mantissa = num3;
				llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv5.Exponent = i;
				Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Num, &llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv5, 16L, isVolatile: false);
				Llvm_lifetime_end_p0.Invoke(16L, &llvm_libc_20_1_2_internal_ExpandedFloat_k68bhv5);
