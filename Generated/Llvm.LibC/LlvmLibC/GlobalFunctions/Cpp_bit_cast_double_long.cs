...
internal static partial class Cpp_bit_cast_double_long
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (double) == sizeof (long) && cpp::is_trivially_constructible<double>::value && cpp::is_trivially_copyable<double>::value && cpp::is_trivially_copyable<long>::value, double>::type")]
	public unsafe static double Invoke([MangledName("from")][NativeType("long const&")] void* From)
	{
