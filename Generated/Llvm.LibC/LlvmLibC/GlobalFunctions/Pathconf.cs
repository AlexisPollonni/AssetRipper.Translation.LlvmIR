...
internal static partial class Pathconf
{
	[MangledName("pathconf")]
	[DemangledName("pathconf")]
	public unsafe static long Invoke([MangledName("path")] void* Path, [MangledName("name")] int Name)
	{
		long result = 0L;
		...
		Statfs_utils_linux_statfs.Invoke(&cpp_optional_qbe95b, Path);
		int num;
