...
internal static partial class Parser_internal_ArgList_get_type_desc
{
	...
	public unsafe static short Invoke([MangledName("this")] Printf_core_Parser* This, [MangledName("index")][NativeType("unsigned long")] long Index)
	{
		...
		unchecked
		{
				...
				if (((bool*)This->Str)[num])
				{
					...
					if (((sbyte*)This->Str)[num] == 46)
					{
						...
						if (((sbyte*)This->Str)[num] == 42)
						{
							...
							long index2 = num4;
							*(short*)(&printf_core_TypeDesc3) = Printf_core_type_desc_from_type_int.Invoke();
							Parser_internal_ArgList_set_type_desc.Invoke(This, index2, *(short*)(&printf_core_TypeDesc3));
							if (num4 == Index)
							{
								*(short*)(&printf_core_TypeDesc) = Printf_core_type_desc_from_type_int.Invoke();
								num5 = 1;
					...
					*(int*)(&printf_core_LengthSpec) = -1431655766;
					sbyte* ptr = (sbyte*)(&printf_core_LengthSpec) + 4;
					*ptr = -86;
					ptr[1] = -86;
					ptr[2] = -86;
					ptr[3] = -86;
					...
					else
					{
						...
						case 37:
							...
							*(short*)(&printf_core_TypeDesc4) = Printf_core_type_desc_from_type_void_kvifr8.Invoke();
							Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc4, 2L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc4);
							break;
						case 99:
							Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc5);
							*(short*)(&printf_core_TypeDesc5) = Printf_core_type_desc_from_type_int.Invoke();
							Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc5, 2L, isVolatile: false);
						...
						case 120:
							...
							case LengthModifier_mnvaa2.none:
								...
								*(short*)(&printf_core_TypeDesc6) = Printf_core_type_desc_from_type_int.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc6, 2L, isVolatile: false);
							...
							case LengthModifier_mnvaa2.l:
								...
								*(short*)(&printf_core_TypeDesc7) = Printf_core_type_desc_from_type_long.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc7, 2L, isVolatile: false);
							...
							case LengthModifier_mnvaa2.L:
								...
								*(short*)(&printf_core_TypeDesc8) = Printf_core_type_desc_from_type_long_long.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc8, 2L, isVolatile: false);
							...
							case LengthModifier_mnvaa2.j:
								...
								*(short*)(&printf_core_TypeDesc9) = Printf_core_type_desc_from_type_long.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc9, 2L, isVolatile: false);
							...
							case LengthModifier_mnvaa2.z:
								...
								*(short*)(&printf_core_TypeDesc10) = Printf_core_type_desc_from_type_unsigned_long.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc10, 2L, isVolatile: false);
							...
							case LengthModifier_mnvaa2.t:
								...
								*(short*)(&printf_core_TypeDesc11) = Printf_core_type_desc_from_type_long.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc11, 2L, isVolatile: false);
								Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc11);
								break;
							case LengthModifier_mnvaa2.w:
							case LengthModifier_mnvaa2.wf:
								if ((ulong)printf_core_LengthSpec.Bit_width <= 32uL)
								{
									Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc12);
									*(short*)(&printf_core_TypeDesc12) = Printf_core_type_desc_from_type_int.Invoke();
									Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc12, 2L, isVolatile: false);
								...
								else if ((ulong)printf_core_LengthSpec.Bit_width <= 64uL)
								{
									...
									*(short*)(&printf_core_TypeDesc13) = Printf_core_type_desc_from_type_long.Invoke();
									Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc13, 2L, isVolatile: false);
									Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc13);
								}
								else if ((ulong)printf_core_LengthSpec.Bit_width <= 64uL)
								{
									Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc14);
									*(short*)(&printf_core_TypeDesc14) = Printf_core_type_desc_from_type_long_long.Invoke();
									Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc14, 2L, isVolatile: false);
									Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc14);
								}
								else
								{
									Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc15);
									*(short*)(&printf_core_TypeDesc15) = Printf_core_type_desc_from_type_long.Invoke();
									Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc15, 2L, isVolatile: false);
						...
						case 103:
							if (printf_core_LengthSpec.Lm != LengthModifier_mnvaa2.L)
							{
								...
								*(short*)(&printf_core_TypeDesc16) = Printf_core_type_desc_from_type_double.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc16, 2L, isVolatile: false);
								Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc16);
							}
							else
							{
								Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc17);
								*(short*)(&printf_core_TypeDesc17) = Printf_core_type_desc_from_type_long_double.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc17, 2L, isVolatile: false);
						...
						case 114:
							...
							*(short*)(&printf_core_TypeDesc18) = Printf_core_type_desc_from_type_unsigned_int.Invoke();
							Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc18, 2L, isVolatile: false);
						...
						case 107:
							if (printf_core_LengthSpec.Lm == LengthModifier_mnvaa2.l)
							{
								...
								*(short*)(&printf_core_TypeDesc19) = Printf_core_type_desc_from_type_unsigned_long.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc19, 2L, isVolatile: false);
								Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc19);
							}
							else
							{
								Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc20);
								*(short*)(&printf_core_TypeDesc20) = Printf_core_type_desc_from_type_unsigned_int.Invoke();
								Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc20, 2L, isVolatile: false);
						...
						case 115:
							...
							*(short*)(&printf_core_TypeDesc21) = Printf_core_type_desc_from_type_void_f5fqec.Invoke();
							Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc21, 2L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc21);
							break;
						default:
							Llvm_lifetime_start_p0.Invoke(2L, &printf_core_TypeDesc22);
							*(short*)(&printf_core_TypeDesc22) = Printf_core_type_desc_from_type_int.Invoke();
							Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc, &printf_core_TypeDesc22, 2L, isVolatile: false);
							Llvm_lifetime_end_p0.Invoke(2L, &printf_core_TypeDesc22);
							break;
						}
						long index3 = num2;
						Llvm_memcpy_p0_p0_i64.Invoke(&printf_core_TypeDesc23, &printf_core_TypeDesc, 2L, isVolatile: false);
						Parser_internal_ArgList_set_type_desc.Invoke(This, index3, *(short*)(&printf_core_TypeDesc23));
						num5 = ((num2 == Index) ? 1 : 0);
					}
					Llvm_lifetime_end_p0.Invoke(16L, &printf_core_LengthSpec);
					goto IL_0b01;
				}
				*(short*)(&printf_core_TypeDesc) = Printf_core_type_desc_from_type_void_kvifr8.Invoke();
				break;
				IL_0b01:
			...
			return *(short*)(&printf_core_TypeDesc);
		}
	}
}
