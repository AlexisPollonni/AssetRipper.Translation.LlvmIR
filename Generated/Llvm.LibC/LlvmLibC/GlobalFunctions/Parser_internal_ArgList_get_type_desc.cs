...
internal static partial class Parser_internal_ArgList_get_type_desc
{
	...
	public unsafe static short Invoke(printf_core_Parser* @this, [NativeType("unsigned long")] long index)
	{
				...
				if (((bool*)@this->str)[num])
				{
					...
					if (((sbyte*)@this->str)[num] == 42)
					{
						...
						*(short*)(&printf_core_TypeDesc3) = printf_core_type_desc_from_type_int.Invoke();
						Parser_internal_ArgList_set_type_desc.Invoke(@this, num5, *(short*)(&printf_core_TypeDesc3));
						if (num3 == index)
						{
					...
					if (((sbyte*)@this->str)[num] == 46)
					{
						...
						if (((sbyte*)@this->str)[num] == 42)
						{
							...
							long num7 = num4;
							*(short*)(&printf_core_TypeDesc4) = printf_core_type_desc_from_type_int.Invoke();
							Parser_internal_ArgList_set_type_desc.Invoke(@this, num7, *(short*)(&printf_core_TypeDesc4));
							if (num4 == index)
							{
								*(short*)(&printf_core_TypeDesc2) = printf_core_type_desc_from_type_int.Invoke();
								num6 = 1;
					...
					else
					{
						...
						case 120:
							...
							case LengthModifier_mnvaa2.none:
								...
								*(short*)(&printf_core_TypeDesc7) = printf_core_type_desc_from_type_int.Invoke();
							...
							case LengthModifier_mnvaa2.l:
								...
								*(short*)(&printf_core_TypeDesc8) = printf_core_type_desc_from_type_long.Invoke();
							...
							case LengthModifier_mnvaa2.L:
								...
								*(short*)(&printf_core_TypeDesc9) = printf_core_type_desc_from_type_long_long.Invoke();
							...
							case LengthModifier_mnvaa2.j:
								...
								*(short*)(&printf_core_TypeDesc10) = printf_core_type_desc_from_type_long.Invoke();
							...
							case LengthModifier_mnvaa2.z:
								...
								*(short*)(&printf_core_TypeDesc11) = printf_core_type_desc_from_type_unsigned_long.Invoke();
							...
							case LengthModifier_mnvaa2.t:
								...
								*(short*)(&printf_core_TypeDesc12) = printf_core_type_desc_from_type_long.Invoke();
							...
							case LengthModifier_mnvaa2.wf:
								if ((ulong)printf_core_LengthSpec2.bit_width <= 32uL)
								{
									...
									*(short*)(&printf_core_TypeDesc13) = printf_core_type_desc_from_type_int.Invoke();
								...
								else if ((ulong)printf_core_LengthSpec2.bit_width <= 64uL)
								{
									...
									*(short*)(&printf_core_TypeDesc14) = printf_core_type_desc_from_type_long.Invoke();
								...
								else if ((ulong)printf_core_LengthSpec2.bit_width <= 64uL)
								{
									...
									*(short*)(&printf_core_TypeDesc15) = printf_core_type_desc_from_type_long_long.Invoke();
								...
								else
								{
									...
									*(short*)(&printf_core_TypeDesc16) = printf_core_type_desc_from_type_long.Invoke();
						...
						case 103:
							if (printf_core_LengthSpec2.lm != LengthModifier_mnvaa2.L)
							{
								...
								*(short*)(&printf_core_TypeDesc17) = printf_core_type_desc_from_type_double.Invoke();
							...
							else
							{
								...
								*(short*)(&printf_core_TypeDesc18) = printf_core_type_desc_from_type_long_double.Invoke();
						...
						case 114:
							...
							*(short*)(&printf_core_TypeDesc19) = printf_core_type_desc_from_type_unsigned_int.Invoke();
						...
						case 107:
							if (printf_core_LengthSpec2.lm == LengthModifier_mnvaa2.l)
							{
								...
								*(short*)(&printf_core_TypeDesc20) = printf_core_type_desc_from_type_unsigned_long.Invoke();
							...
							else
							{
								...
								*(short*)(&printf_core_TypeDesc21) = printf_core_type_desc_from_type_unsigned_int.Invoke();
						...
						case 115:
							...
							*(short*)(&printf_core_TypeDesc22) = printf_core_type_desc_from_type_void_f5fqec.Invoke();
						...
						default:
							...
							*(short*)(&printf_core_TypeDesc23) = printf_core_type_desc_from_type_int.Invoke();
						...
						Parser_internal_ArgList_set_type_desc.Invoke(@this, num10, *(short*)(&printf_core_TypeDesc24));
						num6 = ((num2 == index) ? 1 : 0);
					}
