...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_floating_point_v_float128_sizeof_float_sizeof_float128_float_type_fputil_generic_mul_float_float128_float128_float128
{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			else
			{
				...
				result = float_fputil_DyadicFloat_256ul_as_float_true_void_const.Invoke(&fputil_DyadicFloat_jhcpjj4);
