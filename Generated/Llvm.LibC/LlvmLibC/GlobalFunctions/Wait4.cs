	...
	public unsafe static int Invoke([MangledName("pid")] int Pid, [MangledName("wait_status")] void* Wait_status, [MangledName("options")] int Options, [MangledName("usage")] void* Usage)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			ptr[1] = -86;
			ptr[2] = -86;
			*(InlineArray5_Byte*)(&cpp_optional_int_OptionalStorage) = NumericHelper.TruncOrZextToBytes<long, InlineArray5_Byte>(Internal_wait4impl.Invoke(Pid, Wait_status, Options, Usage));
			int result;
