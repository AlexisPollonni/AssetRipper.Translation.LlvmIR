...
internal static partial class remap_file_pages
{
	public unsafe static int Invoke(void* addr, long size, int prot, long pgoff, int flags)
	{
		...
		num = int_syscall_impl_int_long_unsigned_long_int_unsigned_long_int_long_long_unsigned_long_int_unsigned_long_int.Invoke(216L, unchecked((long)addr), size, prot, pgoff, flags);
		int result;
		if (num < 0)
		{
