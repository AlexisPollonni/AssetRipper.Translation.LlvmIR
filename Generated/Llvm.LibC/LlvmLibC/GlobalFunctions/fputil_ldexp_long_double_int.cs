...
internal static partial class fputil_ldexp_long_double_int
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil5ldexpIeiEENS_3cpp9enable_ifIXaasr3cppE19is_floating_point_vIT_Esr3cppE13is_integral_vIT0_EES4_E4typeES4_S5_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<long double> && cpp::is_integral_v<int>, long double>::type __llvm_libc_20_1_2_::fputil::ldexp<long double, int>(long double, int)")]
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<long double> && cpp::is_integral_v<int>, long double>::type")]
	public unsafe static double Invoke([NativeType("long double")] double x, [NativeType("int")] int exp)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (details_expects_bool_condition_bool.Invoke((exp == 0) ? true : ((!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi3)) ? FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_inf_or_nan.Invoke(&fputil_FPBits_ubgsi3) : true), expected: false))
			{
				result = x;
				goto IL_0664;
			}
			...
			num = 32831;
			if (details_expects_bool_condition_bool.Invoke(exp > 32831, expected: false))
			{
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				if (!Equals_fy8fvt.Invoke(anon_izyfb9.val, anon_izyfb10.val) || num2 != 1024)
				{
					...
					if ((!Equals_fy8fvt.Invoke(anon_izyfb11.val, anon_izyfb12.val) || num2 != 2048) && num2 != 3072)
					{
						...
						Struct_fiz2nb struct_fiz2nb = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_inf.Invoke(anon_izyfb14.val);
				...
				Struct_fiz2nb struct_fiz2nb4 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_normal.Invoke(anon_izyfb13.val);
				...
				*(sbyte*)(&anon_izyfb15) = -86;
				...
				if (!Equals_fy8fvt.Invoke(anon_izyfb16.val, anon_izyfb17.val) || num3 != 2048)
				{
					...
					if (!Equals_fy8fvt.Invoke(anon_izyfb18.val, anon_izyfb19.val) || num3 != 1024)
					{
						...
						Struct_fiz2nb struct_fiz2nb7 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero.Invoke(anon_izyfb21.val);
				...
				Struct_fiz2nb struct_fiz2nb10 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_min_subnormal.Invoke(anon_izyfb20.val);
		...
		result = DyadicFloat_128ul_as_long_double_true_void.Invoke(&fputil_DyadicFloat_kt2kd5);
