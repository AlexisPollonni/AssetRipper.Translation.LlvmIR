...
internal static partial class float128_fputil_round_float128_0_float128
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			else
			{
				...
				else if (num == -1)
				{
					...
					Struct_fiz2nb struct_fiz2nb = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_one_Sign.Invoke(anon_izyfb8.val);
				...
				else
				{
					...
					*(long*)num7 = struct_fiz2nb12.field_1;
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_neg_const.Invoke(&fputil_FPBits_ubgsi3)) ? (num3 + 1.0) : (num3 - 1.0)) : num3);
