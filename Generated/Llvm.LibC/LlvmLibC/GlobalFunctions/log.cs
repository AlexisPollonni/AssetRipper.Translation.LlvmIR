	...
	public unsafe static double Invoke(double x)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			bool num16 = details_expects_bool_condition_bool.Invoke(internal_Equals_r4buia.Invoke(fputil_internal_FPRepImpl_ucubaq2.FPRepSem.FPStorage.val, fputil_internal_FPRepImpl_ucubaq3.FPRepSem.FPStorage.val), expected: false);
			...
			{
				long num17 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
				...
				bool num18 = (ulong)num17 < (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm4));
				...
				{
					long num19 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
					...
					value = (((ulong)num19 > (ulong)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm5))) ? 1 : 0);
				}
		...
		unchecked
		{
			a = fputil_multiply_add_double.Invoke(x4, 0.6931471805598903, ((NumberPair*)LOG_R_DD.Pointer)[num22].hi);
			llvm_lifetime_start_p0.Invoke(8L, &num7);
			double x5 = num6;
			long num23 = num4;
			num7 = fputil_multiply_add_double.Invoke(x5, 5.497923018708371E-14, ((NumberPair*)LOG_R_DD.Pointer)[num23].lo);
			llvm_lifetime_start_p0.Invoke(8L, &num8);
			num8 = (num & 0xFFFFFFFFFFFFFL) | 0x3FF0000000000000L;
			llvm_lifetime_start_p0.Invoke(8L, &num9);
			llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm9);
			FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm9, num8);
			...
			*(double*)(&numberPair) = double.NaN;
			...
			double num25 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm10);
			llvm_lifetime_end_p0.Invoke(8L, &fputil_FPBits_wjhbrm10);
			num12 = num25;
			double x6 = num5;
			double y = num9 - num12;
			long num26 = num4;
			num10 = fputil_multiply_add_double.Invoke(x6, y, ((double*)CD.Pointer)[num26]);
			...
			*(double*)num28 = struct_4ydhja3.field_1;
			...
			num13 = fputil_polyeval_double_double_double_double.Invoke(x2, num7 + numberPair.lo, a_yc74sk, a_ijazrn, a_889uw);
			num11 = fputil_multiply_add_double.Invoke(x2, 8.881784197001252E-16, 2.5849394142282115E-26);
