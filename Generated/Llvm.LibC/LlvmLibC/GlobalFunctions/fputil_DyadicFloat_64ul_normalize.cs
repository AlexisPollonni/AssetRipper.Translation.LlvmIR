...
internal static partial class fputil_DyadicFloat_64ul_normalize
{
	public unsafe static fputil_DyadicFloat_syracv* Invoke(fputil_DyadicFloat_syracv* @this)
	{
		...
		if (!BigInt_64ul_false_unsigned_long_is_zero_const.Invoke(&@this->mantissa))
		{
			...
			num = cpp_enable_if_is_big_int_v_BigInt_64ul_false_unsigned_long_int_type_cpp_countl_zero_BigInt_64ul_false_unsigned_long_BigInt_64ul_false_unsigned_long_const.Invoke(&@this->mantissa);
			@this->exponent -= num;
			BigInt_64ul_false_unsigned_long_operator_unsigned_long_pq2pm2.Invoke(&@this->mantissa, num);
