...
internal static partial class inline_strncmp_strncasecmp_impl_char_const_char_const_unsigned_long_0
{
	...
	public unsafe static int Invoke([NativeType("char const*")] void* left, [NativeType("char const*")] void* right, [NativeType("unsigned long")] long n, [NativeType("__llvm_libc_20_1_2_::__strncasecmp_impl__(char const*, char const*, unsigned long)::$_0&")] void* comp)
	{
		sbyte a = 0;
		void* ptr = left;
		void* ptr2 = right;
