...
internal static partial class internal_partition_internal_ArrayGenericSize_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0
{
	...
	public unsafe static long Invoke([NativeType("__llvm_libc_20_1_2_::internal::ArrayGenericSize const&")] void* array, [NativeType("unsigned long")] long pivot_index, [NativeType("__llvm_libc_20_1_2_::__qsort_r_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*, void*), void*)::$_0 const&")] void* is_less)
	{
		...
		unchecked
		{
			*(IntPtr*)(&scanf_core_ReadBuffer2) = unchecked((nint)(-6148914691236517206L));
			...
			num = internal_partition_hoare_branchy_internal_ArrayGenericSize_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0.Invoke(&scanf_core_ReadBuffer2, pivot, is_less);
