...
internal static partial class internal_simple_decimal_conversion_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] internal_FloatConvertReturn_g92bm8* agg_result, [NativeType("char const*")] void* numStart, [NativeType("unsigned long")] long num_len, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round)
	{
		int i = 0;
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) > 0 && internal_exp10_to_exp2.Invoke(HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) - 1) > 1023)
		{
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2) < 0 && internal_exp10_to_exp2.Invoke(-HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal2)) > 1075)
		{
		...
		else
		{
			...
			{
				HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal2, 52);
				llvm_lifetime_start_p0.Invoke(8L, &num3);
				num3 = HighPrecisionDecimal_round_to_integer_type_unsigned_long.Invoke(&internal_HighPrecisionDecimal2, RoundDirection_b3pcwy.Nearest);
				if (i <= 0)
				{
					for (; i < 0; i++)
					{
					...
					HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal2, -1);
					num3 = HighPrecisionDecimal_round_to_integer_type_unsigned_long.Invoke(&internal_HighPrecisionDecimal2, round);
					if (num3 >>> 52 != 0L)
					{
						i++;
					}
