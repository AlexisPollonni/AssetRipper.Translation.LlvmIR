		...
		unchecked
		{
			*(void**)(&llvm_libc_20_1_2_cpp_string_view) = New_str;
			...
			case WriteMode.FILL_BUFF_AND_DROP_OVERFLOW:
				...
				return WriteBuffer_fill_remaining_to_buff.Invoke(This, *(void**)(&llvm_libc_20_1_2_cpp_string_view2), ((long*)(&llvm_libc_20_1_2_cpp_string_view2))[1]);
			case WriteMode.FLUSH_TO_STREAM:
				...
				return WriteBuffer_flush_to_stream.Invoke(This, *(void**)(&llvm_libc_20_1_2_cpp_string_view3), ((long*)(&llvm_libc_20_1_2_cpp_string_view3))[1]);
			case WriteMode.RESIZE_AND_FILL_BUFF:
				Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_cpp_string_view4, &llvm_libc_20_1_2_cpp_string_view, 16L, isVolatile: false);
				return WriteBuffer_resize_and_write.Invoke(This, *(void**)(&llvm_libc_20_1_2_cpp_string_view4), ((long*)(&llvm_libc_20_1_2_cpp_string_view4))[1]);
			default:
