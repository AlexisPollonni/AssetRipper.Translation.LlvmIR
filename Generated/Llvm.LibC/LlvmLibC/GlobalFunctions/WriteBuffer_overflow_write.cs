		...
		unchecked
		{
			*(void**)(&cpp_string_view2) = new_str;
			...
			case WriteMode.FILL_BUFF_AND_DROP_OVERFLOW:
				...
				return WriteBuffer_fill_remaining_to_buff.Invoke(@this, *(void**)(&cpp_string_view3), ((long*)(&cpp_string_view3))[1]);
			case WriteMode.FLUSH_TO_STREAM:
				llvm_memcpy_p0_p0_i64.Invoke(&cpp_string_view4, &cpp_string_view2, 16L, isVolatile: false);
				return WriteBuffer_flush_to_stream.Invoke(@this, *(void**)(&cpp_string_view4), ((long*)(&cpp_string_view4))[1]);
			case WriteMode.RESIZE_AND_FILL_BUFF:
				llvm_memcpy_p0_p0_i64.Invoke(&cpp_string_view5, &cpp_string_view2, 16L, isVolatile: false);
				return WriteBuffer_resize_and_write.Invoke(@this, *(void**)(&cpp_string_view5), ((long*)(&cpp_string_view5))[1]);
			default:
