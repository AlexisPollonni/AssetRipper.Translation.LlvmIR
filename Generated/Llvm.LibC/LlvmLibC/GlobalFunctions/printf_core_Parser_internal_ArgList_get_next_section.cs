			...
			if (((sbyte*)@this->str)[@this->cur_pos] == 37)
			{
				...
				if (((sbyte*)@this->str)[@this->cur_pos] == 42)
				{
					...
					*(long*)(&cpp_optional_g66fk5.storage) = storage;
					if (!cpp_optional_int_has_value_const.Invoke(&cpp_optional_g66fk5))
					{
						agg_result->has_conv = 0;
					}
					else
					{
						agg_result->min_width = cpp_enable_if_sizeof_int_sizeof_int_cpp_is_trivially_constructible_int_value_cpp_is_trivially_copyable_int_value_cpp_is_trivially_copyable_int_value_int_type_cpp_bit_cast_int_int_int_const.Invoke(cpp_optional_int_value.Invoke(&cpp_optional_g66fk5));
					}
					llvm_lifetime_end_p0.Invoke(8L, &cpp_optional_g66fk5);
				}
				else if (internal_isdigit_int_151.Invoke(((sbyte*)@this->str)[@this->cur_pos]))
				{
				...
				if (((sbyte*)@this->str)[@this->cur_pos] == 46)
				{
					...
					if (((sbyte*)@this->str)[@this->cur_pos] == 42)
					{
						...
						*(long*)(&cpp_optional_g66fk6.storage) = storage2;
						if (!cpp_optional_int_has_value_const.Invoke(&cpp_optional_g66fk6))
						{
							agg_result->has_conv = 0;
						}
						else
						{
							agg_result->precision = cpp_enable_if_sizeof_int_sizeof_int_cpp_is_trivially_constructible_int_value_cpp_is_trivially_copyable_int_value_cpp_is_trivially_copyable_int_value_int_type_cpp_bit_cast_int_int_int_const.Invoke(cpp_optional_int_value.Invoke(&cpp_optional_g66fk6));
						}
				...
				*(long*)num8 = struct_nfiam3.field_1;
				...
				case 99:
				{
					...
					*(long*)(&cpp_optional_g66fk7.storage) = storage3;
					if (!cpp_optional_int_has_value_const.Invoke(&cpp_optional_g66fk7))
					{
						agg_result->has_conv = 0;
					}
					else
					{
						agg_result->conv_val_raw = cpp_enable_if_sizeof_int_sizeof_int_cpp_is_trivially_constructible_int_value_cpp_is_trivially_copyable_int_value_cpp_is_trivially_copyable_int_value_int_type_cpp_bit_cast_int_int_int_const.Invoke(cpp_optional_int_value.Invoke(&cpp_optional_g66fk7));
					}
				...
				case 120:
					...
					case LengthModifier_mnvaa2.none:
					{
						...
						*(long*)(&cpp_optional_g66fk8.storage) = storage7;
						if (!cpp_optional_int_has_value_const.Invoke(&cpp_optional_g66fk8))
						{
							agg_result->has_conv = 0;
						}
						else
						{
							agg_result->conv_val_raw = cpp_enable_if_sizeof_int_sizeof_int_cpp_is_trivially_constructible_int_value_cpp_is_trivially_copyable_int_value_cpp_is_trivially_copyable_int_value_int_type_cpp_bit_cast_int_int_int_const.Invoke(cpp_optional_int_value.Invoke(&cpp_optional_g66fk8));
						}
					...
					case LengthModifier_mnvaa2.wf:
						...
						else if ((ulong)printf_core_LengthSpec2.bit_width <= 32uL)
						{
							...
							*(long*)(&cpp_optional_g66fk9.storage) = storage6;
							if (!cpp_optional_int_has_value_const.Invoke(&cpp_optional_g66fk9))
							{
								agg_result->has_conv = 0;
							}
							else
							{
								agg_result->conv_val_raw = cpp_enable_if_sizeof_int_sizeof_int_cpp_is_trivially_constructible_int_value_cpp_is_trivially_copyable_int_value_cpp_is_trivially_copyable_int_value_int_type_cpp_bit_cast_int_int_int_const.Invoke(cpp_optional_int_value.Invoke(&cpp_optional_g66fk9));
							}
				...
				case 107:
					...
					else
					{
						...
						*(long*)(&cpp_optional_g66fk11.storage) = storage5;
						if (!cpp_optional_unsigned_int_has_value_const.Invoke(&cpp_optional_g66fk11))
						{
							agg_result->has_conv = 0;
						}
						else
						{
							agg_result->conv_val_raw = (Int128)(UInt128)(uint)cpp_enable_if_sizeof_unsigned_int_sizeof_unsigned_int_cpp_is_trivially_constructible_unsigned_int_value_cpp_is_trivially_copyable_unsigned_int_value_cpp_is_trivially_copyable_unsigned_int_value_unsigned_int_type_cpp_bit_cast_unsigned_int_unsigned_int_unsigned_int_const.Invoke(cpp_optional_unsigned_int_value.Invoke(&cpp_optional_g66fk11));
						}
				...
				case 112:
				{
					...
					*ptr19 = -86;
					...
					if (!cpp_optional_void_has_value_const.Invoke(&cpp_optional_77yu8f2))
					{
						agg_result->has_conv = 0;
					}
					else
					{
						agg_result->conv_val_ptr = cpp_enable_if_sizeof_void_sizeof_void_cpp_is_trivially_constructible_void_value_cpp_is_trivially_copyable_void_value_cpp_is_trivially_copyable_void_value_void_type_cpp_bit_cast_void_void_void_const.Invoke(cpp_optional_void_value.Invoke(&cpp_optional_77yu8f2));
					}
				...
				case 115:
				{
					...
					*ptr7 = -86;
					...
					if (!cpp_optional_char_has_value_const.Invoke(&cpp_optional_77yu8f3))
					{
						agg_result->has_conv = 0;
					}
					else
					{
						agg_result->conv_val_ptr = cpp_enable_if_sizeof_char_sizeof_char_cpp_is_trivially_constructible_char_value_cpp_is_trivially_copyable_char_value_cpp_is_trivially_copyable_char_value_char_type_cpp_bit_cast_char_char_char_const.Invoke(cpp_optional_char_value.Invoke(&cpp_optional_77yu8f3));
					}
