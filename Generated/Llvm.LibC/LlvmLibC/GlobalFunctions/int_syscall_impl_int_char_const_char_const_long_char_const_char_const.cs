...
internal static partial class int_syscall_impl_int_char_const_char_const_long_char_const_char_const
{
	public unsafe static int Invoke([MangledName("__number")] long number, [MangledName("ts")][CleanName("ts")] void* ts_3enpke, [MangledName("ts1")][CleanName("ts")] void* ts_76xnpk)
	{
		long num = 0L;
