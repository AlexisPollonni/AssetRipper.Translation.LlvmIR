...
{
	public unsafe static void Invoke([MangledName("agg.result")] BigInt_fjg8pd* agg_result, void* @this, void* other)
	{
		...
		unchecked
		{
			unsigned_long_multiword_multiply_with_carry_unsigned_long_8ul_4ul_4ul_cpp_array_unsigned_long_8ul_cpp_array_unsigned_long_4ul_const_cpp_array_unsigned_long_4ul_const.Invoke(&bigInt_fjg8pd.val, &((BigInt_x9dsed*)@this)->val, &((BigInt_x9dsed*)other)->val);
