...
internal static partial class cpp_optional_long_double_printf_core_Parser_internal_ArgList_get_arg_value_long_double_unsigned_long
{
	public unsafe static void Invoke([MangledName("agg.result")] cpp_optional_59q3zq* agg_result, void* @this, long index)
	{
		sbyte b = 0;
		...
		unchecked
		{
			if (index != 0L && index != ((printf_core_Parser*)@this)->args_index)
			{
				...
				if ((b & 1) != 1)
				{
					...
					cpp_optional_long_double_optional.Invoke(agg_result);
					num2 = 1;
				}
				else
				{
			...
			*(short*)(&printf_core_TypeDesc2) = printf_core_TypeDesc_printf_core_type_desc_from_type_long_double.Invoke();
			...
			num = long_double_printf_core_Parser_internal_ArgList_get_next_arg_value_long_double.Invoke(@this);
			cpp_optional_long_double_optional_long_double.Invoke(agg_result, &num);
