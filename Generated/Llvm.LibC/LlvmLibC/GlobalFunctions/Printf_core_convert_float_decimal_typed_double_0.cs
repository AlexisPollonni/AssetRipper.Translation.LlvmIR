...
internal static partial class Printf_core_convert_float_decimal_typed_double_0
{
	...
	public unsafe static int Invoke([MangledName("writer")][NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] Llvm_libc_20_1_2_printf_core_Writer* Writer, [MangledName("to_conv")][NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] Llvm_libc_20_1_2_printf_core_FormatSection* To_conv, [MangledName("float_bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<double>")] long Float_bits)
	{
		...
		unchecked
		{
			...
			init_sign_char = 0;
			if (FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)))
			{
				init_sign_char = 45;
			}
			...
			*(long*)(&llvm_libc_20_1_2_FloatToString_rwjwy) = -6148914691236517206L;
			...
			sbyte* ptr2 = (sbyte*)(&llvm_libc_20_1_2_FloatToString_rwjwy) + 12;
			*ptr2 = -86;
			ptr2[1] = -86;
			ptr2[2] = -86;
			ptr2[3] = -86;
			*(Int128*)((byte*)(&llvm_libc_20_1_2_FloatToString_rwjwy) + 16) = -6148914691236517206L;
			...
			num4 = FloatToString_double_0_get_positive_blocks.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy);
		...
		unchecked
		{
			while (true)
			{
				...
				num6 = FloatToString_double_0_get_positive_block.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy, num5);
				if ((b2 & 1) == 1)
				{
					Llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = FloatWriter_write_middle_block.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num6);
					if (num7 < 0)
					{
						result = num7;
						num21 = 1;
				...
				else if (num6 != 0)
				{
					...
					num8 = num5;
					FloatWriter_init.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num8 * 9L + InstructionHelper.Select((b & 1) == 1, 1, 0) + (uint)num3, num8 * 9L);
					FloatWriter_write_first_block.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num6, Exp_format: false);
					b2 = 1;
			...
			if ((b2 & 1) != 1)
			{
				FloatWriter_init.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, (uint)(InstructionHelper.Select((b & 1) == 1, 1, 0) + num3), 0L);
				FloatWriter_write_first_block.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, 0, Exp_format: false);
			}
			if (num2 < 52)
			{
				...
				num10 = 0;
				if ((ulong)(uint)num9 <= (ulong)FloatToString_double_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy))
				{
					num10 = num9;
					Llvm_lifetime_start_p0.Invoke(4L, &num11);
					num11 = FloatWriter_write_zeroes.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num3);
					if (num11 < 0)
					{
						result = num11;
						num21 = 1;
				...
				else if ((ulong)(uint)num10 < (ulong)FloatToString_double_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy))
				{
					num10 = (int)FloatToString_double_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy);
					Llvm_lifetime_start_p0.Invoke(4L, &num12);
					num12 = FloatWriter_write_zeroes.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, 9 * num10);
					if (num12 < 0)
					{
						result = num12;
						num21 = 1;
				...
				while (true)
				{
					...
					{
						if (FloatToString_double_0_is_lowest_block.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy, (uint)num10))
						{
							Llvm_lifetime_start_p0.Invoke(4L, &num_zeroes);
							num_zeroes = num3 - 9 * num10;
							Llvm_lifetime_start_p0.Invoke(4L, &num13);
							num13 = FloatWriter_write_zeroes.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num_zeroes);
							if (num13 < 0)
							{
								result = num13;
								num21 = 1;
						...
						else
						{
							...
							num14 = FloatToString_double_0_get_negative_block.Invoke(&llvm_libc_20_1_2_FloatToString_rwjwy, num10);
							if ((uint)num10 < (uint)(num9 - 1))
							{
								Llvm_lifetime_start_p0.Invoke(4L, &num15);
								num15 = FloatWriter_write_middle_block.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num14);
								if (num15 < 0)
								{
									result = num15;
									num21 = 1;
							...
							else
							{
								...
								b3 = (InstructionHelper.BooleanXor(Printf_core_zero_after_digits_unsigned_long.Invoke(checked(num2 - 52), num3, FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)), 52), right: true) ? ((sbyte)1) : ((sbyte)0));
								...
								num18 = FloatWriter_write_last_block.Invoke(&llvm_libc_20_1_2_printf_core_FloatWriter, num14, (uint)num16, (RoundDirection_zvveyk)round, 0, 0);
								if (num18 < 0)
								{
									result = num18;
									num21 = 1;
