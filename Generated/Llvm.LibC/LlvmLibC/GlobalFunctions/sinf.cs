			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			if (details_expects_bool_condition_bool.Invoke((uint)num2 <= 1044975579u, expected: false))
			{
				...
				else
				{
					...
					num4 = fputil_polyeval_double_double_double_double_double.Invoke(x2, 1.0, -0.1666666666666627, 0.008333333332344492, -0.00019841262154916348, 2.7533705626961157E-06);
			...
			else if (details_expects_bool_condition_bool.Invoke(num2 == 1176082840, expected: false))
			{
				...
				if ((num6 == 1024 && FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_pos.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2))) || (num6 == 2048 && FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2))))
				{
					num5 = -0.34761328f;
				}
				result = ((!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2))) ? num5 : (0f - num5));
			...
			else
			{
				...
				x4 = double.NaN;
				sincosf_eval.Invoke(num3, num2, &num7, &y, &x3, &x4);
				result = (float)fputil_multiply_add_double.Invoke(x3, y, fputil_multiply_add_double.Invoke(x4, num7, num7));
