...
internal static partial class Fputil_fromfp_false_long_double
{
		...
		unchecked
		{
			...
			else
			{
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
				...
				if (FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_inf_or_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2))
				{
					Fputil_raise_except_if_required.Invoke(1);
				...
				else
				{
					...
					if (num < 0.0)
					{
						...
						int4 = 0L;
						Struct_fiz2nb struct_fiz2nb7 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan.Invoke(val3, *(long*)(&int4), ((long*)(&int4))[1]);
					...
					else
					{
						...
						int7 = long.MinValue;
						Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_create_value.Invoke(val4, biased_exp, mantissa, *(long*)(&int7), ((long*)(&int7))[1]);
						...
						double num3 = FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5) - 1.0;
						...
						if (num > num2)
						{
							...
							int8 = 0L;
							Struct_fiz2nb struct_fiz2nb13 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan.Invoke(val5, *(long*)(&int8), ((long*)(&int8))[1]);
							...
							result = FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6);
