...
internal static partial class Internal_BitwiseOr_sf5vh5
{
	...
	public unsafe static short Invoke([MangledName("a.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::Significand")] short A, [MangledName("b.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)0>::Significand")] short B)
	{
		...
		fputil_internal_FPRepSem_i7nz4h2.FPStorage.field_0 = A;
		fputil_internal_FPRepSem_i7nz4h3.FPStorage.field_0 = B;
		Significand_Constructor_n44wpn.Invoke(&fputil_internal_FPRepSem_i7nz4h, unchecked((short)((ushort)TypedInt_unsigned_short_to_storage_type.Invoke(&fputil_internal_FPRepSem_i7nz4h2) | (ushort)TypedInt_unsigned_short_to_storage_type.Invoke(&fputil_internal_FPRepSem_i7nz4h3))));
