	...
	public unsafe static double Invoke([MangledName("x")] double X)
	{
		...
		unchecked
		{
			*(long*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm) = -6148914691236517206L;
			...
			double result;
			if (Details_expects_bool_condition_bool.Invoke(((ulong)num >= 13853836650999914722uL) ? true : (((ulong)num > 13591863675404156928uL || (ulong)num < 4649454530587146736uL) ? ((ulong)num <= 4368491638549381120uL) : true), Expected: false))
			{
			...
			else
			{
				...
				*(double*)(&llvm_libc_20_1_2_NumberPair) = double.NaN;
				...
				llvm_libc_20_1_2_NumberPair.Lo = ((Llvm_libc_20_1_2_fputil_TripleDouble*)Llvm_libc_20_1_2_EXP2_MID1.Pointer)[num26].Mid;
				long num27 = (uint)num5;
				llvm_libc_20_1_2_NumberPair.Hi = ((Llvm_libc_20_1_2_fputil_TripleDouble*)Llvm_libc_20_1_2_EXP2_MID1.Pointer)[num27].Hi;
				...
				*(double*)(&llvm_libc_20_1_2_NumberPair2) = double.NaN;
				...
				llvm_libc_20_1_2_NumberPair2.Lo = ((Llvm_libc_20_1_2_fputil_TripleDouble*)Llvm_libc_20_1_2_EXP2_MID2.Pointer)[num28].Mid;
				long num29 = (uint)num6;
				llvm_libc_20_1_2_NumberPair2.Hi = ((Llvm_libc_20_1_2_fputil_TripleDouble*)Llvm_libc_20_1_2_EXP2_MID2.Pointer)[num29].Hi;
				...
				*(double*)(&llvm_libc_20_1_2_NumberPair3) = double.NaN;
				...
				Llvm_libc_20_1_2_NumberPair* num30 = &llvm_libc_20_1_2_NumberPair3;
				Struct_4ydhja struct_4ydhja2 = struct_4ydhja;
				*(double*)num30 = struct_4ydhja2.field_0;
				byte* num31 = (byte*)(&llvm_libc_20_1_2_NumberPair3) + 8u;
				...
				*(double*)num31 = struct_4ydhja3.field_1;
				...
				double num32 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm2);
				...
				*(double*)(&llvm_libc_20_1_2_NumberPair4) = double.NaN;
				...
				if ((b & 1) == 1)
				{
					Struct_4ydhja struct_4ydhja4 = Fputil_exact_add_true.Invoke(num8, llvm_libc_20_1_2_NumberPair3.Hi);
					Llvm_libc_20_1_2_NumberPair* num33 = &llvm_libc_20_1_2_NumberPair4;
					Struct_4ydhja struct_4ydhja5 = struct_4ydhja4;
					*(double*)num33 = struct_4ydhja5.field_0;
					byte* num34 = (byte*)(&llvm_libc_20_1_2_NumberPair4) + 8u;
					Struct_4ydhja struct_4ydhja6 = struct_4ydhja4;
					*(double*)num34 = struct_4ydhja6.field_1;
				}
				else
				{
					Struct_4ydhja struct_4ydhja7 = Fputil_exact_add_true.Invoke(llvm_libc_20_1_2_NumberPair3.Hi, num8);
					Llvm_libc_20_1_2_NumberPair* num35 = &llvm_libc_20_1_2_NumberPair4;
					Struct_4ydhja struct_4ydhja8 = struct_4ydhja7;
					*(double*)num35 = struct_4ydhja8.field_0;
					byte* num36 = (byte*)(&llvm_libc_20_1_2_NumberPair4) + 8u;
				...
				y = num9 * llvm_libc_20_1_2_NumberPair3.Hi;
				Llvm_lifetime_start_p0.Invoke(8L, &x);
				x = Anonymous_namespace_poly_approx_d_ymtez3.Invoke(num9);
				Llvm_lifetime_start_p0.Invoke(8L, &num10);
				num10 = Fputil_multiply_add_double.Invoke(x, y, llvm_libc_20_1_2_NumberPair4.Lo);
				...
				num14 = llvm_libc_20_1_2_NumberPair4.Hi + (num10 + num12);
				Llvm_lifetime_start_p0.Invoke(8L, &num15);
				num15 = llvm_libc_20_1_2_NumberPair4.Hi + (num10 - num12);
				...
				else
				{
					...
					*(double*)(&llvm_libc_20_1_2_NumberPair5) = double.NaN;
					...
					Struct_4ydhja struct_4ydhja10 = Anonymous_namespace_exp_double_double.Invoke(X, num4, &llvm_libc_20_1_2_NumberPair3, &llvm_libc_20_1_2_NumberPair4);
					Llvm_libc_20_1_2_NumberPair* num39 = &llvm_libc_20_1_2_NumberPair5;
					Struct_4ydhja struct_4ydhja11 = struct_4ydhja10;
					*(double*)num39 = struct_4ydhja11.field_0;
					byte* num40 = (byte*)(&llvm_libc_20_1_2_NumberPair5) + 8u;
					...
					*(double*)num40 = struct_4ydhja12.field_1;
					...
					num21 = llvm_libc_20_1_2_NumberPair5.Hi + (llvm_libc_20_1_2_NumberPair5.Lo + num19);
					Llvm_lifetime_start_p0.Invoke(8L, &num22);
					num22 = llvm_libc_20_1_2_NumberPair5.Hi + (llvm_libc_20_1_2_NumberPair5.Lo - num19);
					...
					else
					{
						...
						*(long*)ptr2 = -6148914691236517206L;
						...
						Anonymous_namespace_expm1_f128.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, X, num4, num5, num6);
