	...
	public unsafe static void Invoke([MangledName("agg.result")] BigInt_x9dsed* agg_result, BigInt_x9dsed* @this, BigInt_x9dsed* other)
	{
		unchecked
		{
			*(long*)agg_result = -6148914691236517206L;
			...
			void_multiword_quick_mul_hi_unsigned_long_4ul_cpp_array_unsigned_long_4ul_cpp_array_unsigned_long_4ul_const_cpp_array_unsigned_long_4ul_const.Invoke(&agg_result->val, &@this->val, &other->val);
		}
	}
}
