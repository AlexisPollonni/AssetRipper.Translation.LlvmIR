...
internal static partial class anonymous_namespace_poly_approx_d_double_39
{
	public unsafe static double Invoke(double dx)
	{
		...
		z = fputil_multiply_add_double_double_double.Invoke(dx, 0.2402265069591007, 0.6931471805599453);
		llvm_lifetime_start_p0.Invoke(8L, &y);
		y = fputil_multiply_add_double_double_double.Invoke(dx, 0.009618130735515667, 0.05550411075639526);
