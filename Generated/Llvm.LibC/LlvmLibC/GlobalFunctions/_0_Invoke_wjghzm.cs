	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* Agg_result, [MangledName("this")] void* This, [MangledName("kk")] int Kk)
	{
		...
		unchecked
		{
			...
			*(long*)ptr2 = -6148914691236517206L;
			...
			long num2 = (uint)num;
			Llvm_memcpy_p0_p0_i64.Invoke(Agg_result, (byte*)Llvm_libc_20_1_2_SIN_K_PI_OVER_128_F128.Pointer + (nint)num2 * sizeof(Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			if ((Kk & 0x80) != 0)
			{
