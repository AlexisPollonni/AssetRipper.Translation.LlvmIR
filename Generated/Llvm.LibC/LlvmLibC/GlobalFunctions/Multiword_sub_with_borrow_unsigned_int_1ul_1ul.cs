...
internal static partial class Multiword_sub_with_borrow_unsigned_int_1ul_1ul
{
	...
	public unsafe static int Invoke([MangledName("dst")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned int, 1ul>&")] Cpp_array_2v7m9i* Dst, [MangledName("rhs")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned int, 1ul> const&")] Cpp_array_2v7m9i* Rhs)
	{
