...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_floating_point_v_float128_sizeof_float_sizeof_float128_float_type_fputil_sqrt_float_float128_float128
{
	public unsafe static float Invoke(double x)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (num3 != 0)
			{
				result = cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_floating_point_v_float128_float_type_fputil_cast_float_float128_float128.Invoke(x);
			}
