...
internal static partial class WriteBuffer_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_printf_core_WriteBuffer* This, [NativeType("char*")] void* Buff, [NativeType("unsigned long")] long Buff_len)
	{
		This->Buff = Buff;
		This->Init_buff = Buff;
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_printf_core_WriteBuffer* This, [NativeType("char*")] void* Buff, [NativeType("unsigned long")] long Buff_len, [MangledName("hook")][NativeType("int (*)(__llvm_libc_20_1_2_::cpp::string_view, void*)")] void* Hook)
	{
		This->Buff = Buff;
		This->Init_buff = Buff;
		This->Buff_len = Buff_len;
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_printf_core_WriteBuffer* This, [NativeType("char*")] void* Buff, [NativeType("unsigned long")] long Buff_len, [MangledName("hook")][NativeType("int (*)(__llvm_libc_20_1_2_::cpp::string_view, void*)")] void* Hook, [MangledName("target")][NativeType("void*")] void* Target)
	{
		This->Buff = Buff;
		This->Init_buff = Buff;
		This->Buff_len = Buff_len;
