...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_long_double_sizeof_double_sizeof_long_double_double_type_fputil_generic_add_or_sub_true_double_long_double_long_double_long_double
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				...
				else
				{
					...
					num4 = y;
					num4 = 0.0 - num4;
					result = cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_long_double_double_type_fputil_cast_double_long_double_long_double.Invoke(num4);
			...
			else
			{
				...
				num5 = y;
				num5 = 0.0 - num5;
				result = cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_long_double_double_type_fputil_cast_double_long_double_long_double.Invoke(num5);
