...
internal static partial class BigInt_128ul_false_unsigned_long_operator_BigInt_128ul_false_unsigned_long_const_kgy9bi
{
	public unsafe static anon_izyfb7* Invoke(anon_izyfb7* @this, anon_izyfb7* other)
	{
		BigInt_128ul_false_unsigned_long_sub_overflow_BigInt_128ul_false_unsigned_long_const.Invoke(@this, other);
		return @this;
	}
}
