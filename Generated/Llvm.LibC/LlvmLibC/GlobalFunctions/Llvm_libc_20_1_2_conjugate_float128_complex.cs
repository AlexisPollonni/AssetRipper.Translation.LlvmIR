...
internal static partial class Llvm_libc_20_1_2_conjugate_float128_complex
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Struct_unhbb7* Agg_result, [MangledName("c")][NativeType("__float128 complex")] void* C)
	{
		...
		unchecked
		{
			*(double*)(&llvm_libc_20_1_2_Complex_22i76p) = double.NaN;
			...
			llvm_libc_20_1_2_Complex_22i76p.Imag = 0.0 - llvm_libc_20_1_2_Complex_22i76p.Imag;
			Cpp_bit_cast_float128_complex_Complex_float128.Invoke(&struct_unhbb, &llvm_libc_20_1_2_Complex_22i76p);
