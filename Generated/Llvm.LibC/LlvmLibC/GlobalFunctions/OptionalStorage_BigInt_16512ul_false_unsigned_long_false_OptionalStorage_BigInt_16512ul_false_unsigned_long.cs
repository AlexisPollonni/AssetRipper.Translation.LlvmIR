...
internal static partial class OptionalStorage_BigInt_16512ul_false_unsigned_long_false_OptionalStorage_BigInt_16512ul_false_unsigned_long
{
	...
	public unsafe static void Invoke([MangledName("this")][NativeType("__llvm_libc_20_1_2_::cpp::in_place_t")] Cpp_optional_BigInt_16512_false_OptionalStorage* This, [MangledName("args")][NativeType("__llvm_libc_20_1_2_::BigInt<16512ul, false, unsigned long>&&")] void* Args)
	{
		Llvm_memcpy_p0_p0_i64.Invoke(&This->field, Cpp_forward_BigInt_16512ul_false_unsigned_long.Invoke(unchecked((BigInt_q8g275*)Args)), 2064L, isVolatile: false);
		This->In_use = 0;
	}
}
