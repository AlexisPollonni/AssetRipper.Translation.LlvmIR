	...
	public unsafe static float Invoke(float x, int exp)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((exp == 0) ? true : ((!fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero_const.Invoke(&fputil_FPBits_5nkvcs2)) ? fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan_const.Invoke(&fputil_FPBits_5nkvcs2) : true), expected: false))
			{
				result = x;
				goto IL_059d;
			}
		...
		fputil_DyadicFloat_c8qpxg2.exponent += exp;
