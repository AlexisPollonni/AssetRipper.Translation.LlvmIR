	...
	public unsafe static double Invoke([NativeType("double")] double x)
	{
		...
		unchecked
		{
			...
			*(double*)num12 = struct_4ydhja3.field_1;
			...
			x2 = anonymous_namespace_poly_approx_d_twxp8v.Invoke(num6);
			...
			*ptr2 = -86;
			...
			case 0:
			{
				...
				*(double*)(&numberPair4) = double.NaN;
				...
				Struct_4ydhja struct_4ydhja4 = anonymous_namespace_exp10_double_double.Invoke(x, num3, &numberPair3);
				...
				*ptr5 = -86;
				...
				ptr5[5] = -86;
				ptr5[6] = -86;
				Struct_8myw6y struct_8myw6y4 = ziv_test_denorm.Invoke(hi, numberPair4.hi, numberPair4.lo, 2.3665827156630354E-30);
				...
				case 0:
				{
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					anonymous_namespace_exp10_f128.Invoke(&fputil_DyadicFloat_kt2kd5, x, num3, num4, num5);
