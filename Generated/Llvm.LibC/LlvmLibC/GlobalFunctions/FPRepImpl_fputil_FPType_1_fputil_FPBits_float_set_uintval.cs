...
internal static partial class FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_uintval
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm* This, [MangledName("value")][NativeType("unsigned int")] int Value)
	{
		unchecked((Llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt*)This)->field_0 = Value & -1;
	}
}
