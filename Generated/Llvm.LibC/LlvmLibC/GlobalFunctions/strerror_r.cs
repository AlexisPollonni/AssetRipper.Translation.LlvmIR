...
internal static partial class strerror_r
{
	public unsafe static void* Invoke(int err_num, void* buf, long buflen)
	{
		...
		span_char_Constructor.Invoke(&cpp_string_view3, buf, buflen);
		unchecked
		{
			Struct_kqhe8i struct_kqhe8i = Get_error_string.Invoke(err_num, *(void**)(&cpp_string_view3), ((long*)(&cpp_string_view3))[1]);
			...
			*(long*)num2 = struct_kqhe8i3.field_1;
			void* result = string_view_data.Invoke(&cpp_string_view2);
