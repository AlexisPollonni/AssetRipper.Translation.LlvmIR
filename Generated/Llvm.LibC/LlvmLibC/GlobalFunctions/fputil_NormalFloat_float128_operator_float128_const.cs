				...
				if (@this->exponent < -16382)
				{
					...
					if ((uint)num4 <= 113u)
					{
						...
						*(long*)num6 = struct_fiz2nb6.field_1;
						...
						{
							Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa_const.Invoke(&fputil_FPBits_ubgsi4);
							Int128* num7 = &x2;
						...
						int5 = int3;
						fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_mantissa_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int5), ((long*)(&int5))[1]);
						if (NumericHelper.IntCmpEq(int3, 0L))
						{
							int6 = 1L;
							fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_set_biased_exponent_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int6), ((long*)(&int6))[1]);
						}
