...
internal static partial class Llvm_libc_20_1_2_inline_bcmp
{
	...
	public unsafe static int Invoke([MangledName("p1")][NativeType("void const*")] void* P1, [MangledName("p2")][NativeType("void const*")] void* P2, [MangledName("count")][NativeType("unsigned long")] long Count)
	{
		...
		llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0 = Llvm_libc_20_1_2_inline_bcmp_x86.Invoke(P1, P2, Count);
		int result = StrictIntegralType_unsigned_int_ToInt32.Invoke(&llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt);
