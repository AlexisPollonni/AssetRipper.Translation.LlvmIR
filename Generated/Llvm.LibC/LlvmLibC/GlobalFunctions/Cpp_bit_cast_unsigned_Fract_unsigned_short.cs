...
internal static partial class Cpp_bit_cast_unsigned_Fract_unsigned_short
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (unsigned _Fract) == sizeof (unsigned short) && cpp::is_trivially_constructible<unsigned _Fract>::value && cpp::is_trivially_copyable<unsigned _Fract>::value && cpp::is_trivially_copyable<unsigned short>::value, unsigned _Fract>::type")]
