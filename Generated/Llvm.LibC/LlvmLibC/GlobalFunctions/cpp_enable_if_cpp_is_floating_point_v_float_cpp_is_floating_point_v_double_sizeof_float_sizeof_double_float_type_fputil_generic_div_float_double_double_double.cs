	...
	public unsafe static float Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*ptr2 = -86;
			...
			num4 = checked(fputil_DyadicFloat_syracv2.exponent - fputil_DyadicFloat_syracv3.exponent - 25);
			...
			*(long*)(&bigInt_555ggs5.val.Data) = data3;
			...
			result = float_fputil_DyadicFloat_64ul_as_float_true_void_const.Invoke(&fputil_DyadicFloat_syracv4);
