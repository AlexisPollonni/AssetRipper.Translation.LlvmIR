...
{
	public unsafe static void Invoke(cpp_string_view* @this, cpp_array_qkm4kn* arr)
	{
		@this->span_data = cpp_array_char_21ul_data.Invoke(arr);
		@this->span_size = cpp_array_char_21ul_size_const.Invoke(arr);
	}
}
