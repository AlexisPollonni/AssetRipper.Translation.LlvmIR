...
internal static partial class DyadicFloat_128ul_fast_as_float_true_void
{
	...
	public unsafe static float Invoke([MangledName("this")] Fputil_DyadicFloat_kt2kd4* This)
	{
			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					int field_3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value.Invoke(Biased_exp: num3, Mantissa: (BigInt_128ul_false_unsigned_long_Unsigned_int_unsigned_int.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh)) & 0x7FFFFF) | 0, Sign: anon_izyfb3.Val);
