...
internal static partial class generic_add_or_sub_false_double_float128
{
	...
	public unsafe static double Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else
			{
				...
				x3 = y;
				result = fputil_cast_double_float128.Invoke(x3);
		...
		unchecked
		{
			...
			double num12 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi5);
			...
			double num13 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi6);
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi7) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi7, *(double*)cpp_max_float128.Invoke(&num4, &num5));
				llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi8);
				*(Int128*)(&fputil_FPBits_ubgsi8) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi8, *(double*)cpp_min_float128.Invoke(&num4, &num5));
				...
				else
				{
					...
					*(long*)num25 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num6 = unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi7)) - unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi8));
						llvm_lifetime_start_p0.Invoke(16L, &x8);
					}
					x8 = NumericHelper.ShiftRightLogical(x6, (Int128)(UInt128)(*(uint*)cpp_min_int.Invoke(&num6, &num3)));
				...
				num7 = checked(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_exponent.Invoke(&fputil_FPBits_ubgsi7) - 115);
