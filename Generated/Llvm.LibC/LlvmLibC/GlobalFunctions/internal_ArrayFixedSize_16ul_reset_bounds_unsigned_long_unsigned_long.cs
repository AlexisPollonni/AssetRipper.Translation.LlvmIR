...
internal static partial class internal_ArrayFixedSize_16ul_reset_bounds_unsigned_long_unsigned_long
{
	public unsafe static void Invoke(void* @this, long i, long s)
	{
		unchecked
		{
			((cpp_string_view*)@this)->span_data = internal_ArrayFixedSize_16ul_get_internal_unsigned_long_const.Invoke(@this, i);
