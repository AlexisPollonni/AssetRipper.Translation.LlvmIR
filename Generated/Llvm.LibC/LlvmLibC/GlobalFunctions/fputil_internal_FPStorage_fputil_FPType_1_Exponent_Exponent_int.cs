...
internal static partial class fputil_internal_FPStorage_fputil_FPType_1_Exponent_Exponent_int
{
	public unsafe static void Invoke(void* @this, int parameter_1)
	{
		fputil_internal_FPStorage_fputil_FPType_1_TypedInt_int_TypedInt_int.Invoke(@this, parameter_1);
	}
}
