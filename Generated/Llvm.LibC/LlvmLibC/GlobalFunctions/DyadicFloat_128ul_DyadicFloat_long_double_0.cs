...
internal static partial class DyadicFloat_128ul_DyadicFloat_long_double_0
{
	...
	public unsafe static void Invoke(fputil_DyadicFloat_kt2kd4* @this, [NativeType("long double")] double x)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			@this->exponent = checked(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_exponent.Invoke(&fputil_FPBits_ubgsi3) - 63);
