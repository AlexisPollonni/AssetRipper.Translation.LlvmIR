...
internal static partial class DyadicFloat_128ul_DyadicFloat_long_double_0
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_DyadicFloat_kt2kd4* This, [MangledName("x")][NativeType("long double")] double X)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			This->Exponent = checked(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_exponent.Invoke(&fputil_FPBits_ubgsi) - 63);
