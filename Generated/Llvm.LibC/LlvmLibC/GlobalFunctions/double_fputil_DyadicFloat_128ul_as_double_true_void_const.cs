...
internal static partial class double_fputil_DyadicFloat_128ul_as_double_true_void_const
{
	public unsafe static double Invoke(void* @this)
	{
		return double_fputil_DyadicFloat_128ul_fast_as_double_true_void_const.Invoke(@this);
	}
}
