...
internal static partial class fputil_internal_FPStorage_fputil_FPType_4_encode_fputil_internal_FPStorage_fputil_FPType_4_BiasedExponent
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("exp.coerce")] int exp)
	{
		...
		Struct_fiz2nb struct_fiz2nb = fputil_internal_FPStorage_fputil_FPType_4_TypedInt_unsigned_int_to_storage_type_const.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2);
		Int128* num = &x;
