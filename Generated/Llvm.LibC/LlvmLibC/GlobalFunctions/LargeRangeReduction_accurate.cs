...
internal static partial class LargeRangeReduction_accurate
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, LargeRangeReduction* @this)
	{
		...
		unchecked
		{
			...
			*(long*)ptr3 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&fputil_DyadicFloat_kt2kd6, x_reduced * ((double*)((byte*)ONE_TWENTY_EIGHT_OVER_PI.Pointer + (nint)num * sizeof(InlineArray4_Double)))[3L]);
			...
			*(long*)ptr5 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&fputil_DyadicFloat_kt2kd8, @this->y_lo);
			...
			*(long*)ptr7 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&fputil_DyadicFloat_kt2kd11, @this->y_mid.lo);
			...
			*(long*)ptr9 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&fputil_DyadicFloat_kt2kd14, @this->y_hi);
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&fputil_DyadicFloat_kt2kd15, @this->y_mid.hi);
			...
			*(long*)ptr11 = -6148914691236517206L;
			...
			fputil_quick_mul_128ul.Invoke(agg_result, &fputil_DyadicFloat_kt2kd16, &fputil_DyadicFloat_kt2kd5);
