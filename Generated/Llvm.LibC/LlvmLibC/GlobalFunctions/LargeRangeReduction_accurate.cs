...
internal static partial class LargeRangeReduction_accurate
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* Agg_result, [MangledName("this")] Llvm_libc_20_1_2_LargeRangeReduction* This)
	{
		...
		Llvm_memset_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, 0, 1L, isVolatile: false);
		unchecked
		{
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd))[1] = -133;
			sbyte* ptr = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd) + 8;
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2) = -86;
			sbyte* ptr2 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2) + 1;
			*ptr2 = -86;
			ptr2[1] = -86;
			ptr2[2] = -86;
			...
			*(long*)ptr3 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2, x_reduced * ((double*)((byte*)Llvm_libc_20_1_2_ONE_TWENTY_EIGHT_OVER_PI.Pointer + (nint)num * sizeof(InlineArray4_Double)))[3L]);
			...
			*(long*)ptr5 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4, This->Y_lo);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6) = -86;
			sbyte* ptr6 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6) + 1;
			*ptr6 = -86;
			ptr6[1] = -86;
			ptr6[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6))[1] = -1431655766;
			sbyte* ptr7 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6) + 8;
			*(long*)ptr7 = -6148914691236517206L;
			((long*)ptr7)[1] = -6148914691236517206L;
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd7, This->Y_mid.Lo);
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd3, 24L, isVolatile: false);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9) = -86;
			sbyte* ptr8 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9) + 1;
			*ptr8 = -86;
			ptr8[1] = -86;
			ptr8[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9))[1] = -1431655766;
			sbyte* ptr9 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9) + 8;
			*(long*)ptr9 = -6148914691236517206L;
			((long*)ptr9)[1] = -6148914691236517206L;
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd10, This->Y_hi);
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd11, This->Y_mid.Hi);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd12) = -86;
			sbyte* ptr10 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd12) + 1;
			*ptr10 = -86;
			ptr10[1] = -86;
			ptr10[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd12))[1] = -1431655766;
			sbyte* ptr11 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd12) + 8;
			*(long*)ptr11 = -6148914691236517206L;
			((long*)ptr11)[1] = -6148914691236517206L;
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd13, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd14, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6, 24L, isVolatile: false);
			...
			Fputil_quick_mul_128ul.Invoke(Agg_result, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd12, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd);
