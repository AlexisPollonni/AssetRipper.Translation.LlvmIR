...
internal static partial class DyadicFloat_128ul_DyadicFloat_double_0
{
	...
	public unsafe static void Invoke(fputil_DyadicFloat_kt2kd4* @this, [NativeType("double")] double x)
	{
		...
		unchecked
		{
			BigInt_128ul_false_unsigned_long_BigInt_unsigned_long_void.Invoke((anon_izyfb7*)(&bigInt_qdkjbh), FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2)));
