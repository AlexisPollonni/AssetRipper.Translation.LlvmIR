	...
	public unsafe static float Invoke([NativeType("float")] float x, [NativeType("float")] float y)
	{
		...
		unchecked
		{
			...
			*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
			...
			float result = ((!NotEquals_rpctvi.Invoke(anon_izyfb8.val, anon_izyfb9.val)) ? ((!(x < y)) ? y : x) : ((!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2))) ? y : x));
