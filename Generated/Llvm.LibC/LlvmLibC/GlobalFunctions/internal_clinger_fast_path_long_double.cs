...
internal static partial class internal_clinger_fast_path_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] cpp_optional_q5jaj8* agg_result, [NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<long double>")] void* init_num, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (num == 0)
			{
				...
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi4, num2);
			...
			if (num > 0)
			{
				...
				else
				{
					...
					if (!(num2 > 1.8446744073709552E+19))
					{
						...
						double num5 = num2;
						long num6 = num;
						FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi5, num5 * ((double*)internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num6]);
		...
		if (num < 0)
		{
			...
			double num7 = num2;
			long num8 = -num;
			FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi6, num7 / unchecked((double*)internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num8]);
		...
		unchecked
		{
			if (round != RoundDirection_b3pcwy.Nearest)
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi7) = -6148914691236517206L;
				...
				long num10 = num;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi8, num9 * ((double*)internal_ClingerConsts_long_double_POWERS_OF_TEN_ARRAY.Pointer)[num10]);
				...
				if (NumericHelper.IsUnorderedOrNotEquals(FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3), 0.0 - FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi7)))
				{
					llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi9);
					*(Int128*)(&fputil_FPBits_ubgsi9) = -6148914691236517206L;
					FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi9);
					llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi10);
					*(Int128*)(&fputil_FPBits_ubgsi10) = -6148914691236517206L;
					FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi10);
					if (FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3) < 0.0 - FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi7))
					{
			...
			*(long*)num12 = struct_fiz2nb3.field_1;
			...
			internal_ExpandedFloat_9jummq2.exponent = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi3);
			optional_internal_ExpandedFloat_long_double_Constructor_crcz7y.Invoke(agg_result, &internal_ExpandedFloat_9jummq2);
