...
internal static partial class BigInt_64ul_false_unsigned_long_Operator_4fggky
{
	...
	public unsafe static Llvm_libc_20_1_2_BigInt_555ggs* Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_555ggs* This, [MangledName("s")][NativeType("unsigned long")] long S)
	{
		...
		unchecked
		{
			...
			*(long*)(&llvm_libc_20_1_2_cpp_array_rpgxvv.Data) = data;
			Llvm_memcpy_p0_p0_i64.Invoke(&This->Val, &llvm_libc_20_1_2_cpp_array_rpgxvv, 8L, isVolatile: false);
