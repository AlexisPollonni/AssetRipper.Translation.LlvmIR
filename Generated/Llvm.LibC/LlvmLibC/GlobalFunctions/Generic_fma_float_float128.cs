...
internal static partial class Generic_fma_float_float128
{
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y, [MangledName("z")][NativeType("__float128")] double Z)
	{
		int num = 0;
		long num2 = 0L;
		long num3 = 0L;
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			{
				result = Fputil_cast_float_float128.Invoke(Llvm_fmuladd_f128.Invoke(num11, num12, num13));
			}
			else
			{
				...
				else
				{
					...
					*(long*)ptr2 = -6148914691236517206L;
					...
					checked
					{
						...
						result = DyadicFloat_256ul_as_float_true_void.Invoke(&fputil_DyadicFloat_jhcpjj);
