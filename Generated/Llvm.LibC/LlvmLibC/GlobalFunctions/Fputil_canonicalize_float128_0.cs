	...
	public unsafe static int Invoke([MangledName("cx")][NativeType("__float128&")] void* Cx, [MangledName("x")][NativeType("__float128 const&")] void* X)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi, *(double*)X);
			int result;
			if (Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)), Expected: false))
			{
				...
				*(double*)Cx = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi2);
