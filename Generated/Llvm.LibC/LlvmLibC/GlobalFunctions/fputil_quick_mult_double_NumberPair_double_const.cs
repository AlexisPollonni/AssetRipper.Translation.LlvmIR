...
{
	public unsafe static Struct_4ydhja Invoke(double a, void* b)
	{
		...
		unchecked
		{
			*(double*)(&numberPair) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = NumberPair_double_fputil_exact_mult_27ul_double_double.Invoke(a, ((NumberPair*)b)->hi);
			...
			*(double*)num2 = struct_4ydhja3.field_1;
			numberPair.lo = fputil_multiply_add_double_double_double.Invoke(a, ((NumberPair*)b)->lo, numberPair.lo);
