...
internal static partial class anonymous_namespace_set_exceptional_gmsn85
{
	[MangledName("_ZN19__llvm_libc_20_1_2_12_GLOBAL__N_115set_exceptionalEd.50")]
	[DemangledName("__llvm_libc_20_1_2_::(anonymous namespace)::set_exceptional(double) (.50)")]
	...
	public unsafe static double Invoke([NativeType("double")] double x)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			long num4 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3));
			...
			else if ((ulong)num >= 13873137513782915154uL)
			{
				...
				else if (fputil_quick_get_round.Invoke() == 2048)
				{
					...
					long val2 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_min_subnormal.Invoke(anon_izyfb8.val);
			...
			else
			{
				if ((ulong)num < 9218868437227405312uL)
				{
					...
					if (num3 == 1024 || num3 == 3072)
					{
						...
						long val3 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_max_normal.Invoke(anon_izyfb9.val);
				...
				result = x + FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm6);
