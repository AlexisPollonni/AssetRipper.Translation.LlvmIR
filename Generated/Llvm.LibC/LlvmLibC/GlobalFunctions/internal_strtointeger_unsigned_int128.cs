...
internal static partial class internal_strtointeger_unsigned_int128
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_i4jxtt* agg_result, [NativeType("char const*")] void* src, [NativeType("int")] int @base, [NativeType("unsigned long")] long src_len)
	{
		...
		unchecked
		{
			...
			{
				int2 = 0L;
				StrToNumResult_unsigned_int128_Constructor.Invoke(agg_result, *(long*)(&int2), ((long*)(&int2))[1], 0L, 0);
			}
			else if (num5 < 0 || num5 == 1 || num5 > 36)
			{
				int3 = 0L;
				StrToNumResult_unsigned_int128_Constructor.Invoke(agg_result, *(long*)(&int3), ((long*)(&int3))[1], 0L, 22);
			}
			else
			{
				num = (long)internal_first_non_whitespace.Invoke(src, src_len) - (long)src;
				...
				if (num5 == 0)
				{
					num5 = internal_infer_base.Invoke((byte*)src + num, src_len - num);
				}
				if (num5 == 16 && internal_is_hex_start.Invoke((byte*)src + num, src_len - num))
				{
					num += 2L;
				}
				...
				Struct_fiz2nb struct_fiz2nb = integer_impl_unsigned_int128_unsigned_int128_0_unsigned_int128_340282366920938463463374607431768211455_max.Invoke();
				...
				*(long*)num7 = struct_fiz2nb3.field_1;
				...
				while ((ulong)num < (ulong)src_len && internal_isalnum_r2dwwj.Invoke(((sbyte*)src)[num]))
				{
					llvm_lifetime_start_p0.Invoke(4L, &num3);
					num3 = internal_b36_char_to_int_cwm4z4.Invoke(((sbyte*)src)[num]);
					int num8;
					if (num3 >= num5)
					{
						num8 = 3;
				...
				if (num2 == 34)
				{
					if ((b4 & 1) == 1 || uint.MaxValue != 0)
					{
						...
						*(long*)num10 = struct_fiz2nb6.field_1;
						...
						int7 = int11;
						StrToNumResult_unsigned_int128_Constructor.Invoke(agg_result, *(long*)(&int7), ((long*)(&int7))[1], error_hm8b8a, error_xz3rmz);
					}
					else
					{
						integer_impl_unsigned_int128_unsigned_int128_0_unsigned_int128_340282366920938463463374607431768211455_min.Invoke();
						...
						*(long*)(&int8) = struct_fiz2nb7.field_0;
						...
						long error_hm8b8a2;
						int error_xz3rmz2;
						StrToNumResult_unsigned_int128_Constructor.Invoke(agg_result, value, parsed_len, error_hm8b8a2, error_xz3rmz2);
					}
				}
				else
				{
					...
					int10 = obj;
					StrToNumResult_unsigned_int128_Constructor.Invoke(agg_result, *(long*)(&int10), ((long*)(&int10))[1], error_hm8b8a3, error_xz3rmz3);
				}
