	...
	public unsafe static Struct_29m54m Invoke(void* c)
	{
		...
		unchecked
		{
			*(double*)(&complex_p54sq) = double.NaN;
			...
			fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi3, complex_p54sq.real);
			...
			{
				fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi4, complex_p54sq.imag);
