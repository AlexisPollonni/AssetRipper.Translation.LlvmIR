...
internal static partial class cpp_enable_if_cpp_is_unsigned_v_unsigned_long_int_type_first_leading_one_unsigned_long_unsigned_long
{
	public static int Invoke(long value)
	{
		return cpp_enable_if_cpp_is_unsigned_v_unsigned_long_int_type_first_leading_zero_unsigned_long_unsigned_long.Invoke(value ^ -1L);
	}
}
