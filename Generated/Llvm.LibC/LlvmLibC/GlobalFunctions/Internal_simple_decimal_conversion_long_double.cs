...
internal static partial class Internal_simple_decimal_conversion_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Internal_FloatConvertReturn_hgyipa* Agg_result, [MangledName("numStart")][NativeType("char const*")] void* NumStart, [MangledName("num_len")][NativeType("unsigned long")] long Num_len, [MangledName("round")][NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy Round)
	{
		int i = 0;
		...
		if (HighPrecisionDecimal_get_num_digits.Invoke(&internal_HighPrecisionDecimal) == 0)
		{
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Num, &internal_ExpandedFloat_9jummq, 32L, isVolatile: false);
			Llvm_lifetime_end_p0.Invoke(32L, &internal_ExpandedFloat_9jummq);
		}
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) > 0 && Internal_exp10_to_exp2.Invoke(HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) - 1) > 16383)
		{
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) < 0 && Internal_exp10_to_exp2.Invoke(-HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal)) > 16446)
		{
		...
		else
		{
			while (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) > 0)
			{
				...
				{
					long num3 = HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal);
			...
			while (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) < 0 || (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) == 0 && unchecked((byte)(*(sbyte*)HighPrecisionDecimal_get_digits.Invoke(&internal_HighPrecisionDecimal))) < 5))
			{
				...
				else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) != 0)
				{
					...
					num2 = unchecked((byte)((sbyte*)Internal_POWERS_OF_TWO.Pointer)[num4]);
				}
				else
				{
					num2 = 1;
			...
			if (i >= 32767)
			{
				...
				internal_ExpandedFloat_9jummq4.Exponent = 32767;
			...
			{
				HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal, 63);
				Llvm_lifetime_start_p0.Invoke(16L, &@int);
				Struct_fiz2nb struct_fiz2nb = HighPrecisionDecimal_round_to_integer_type_unsigned_int128.Invoke(&internal_HighPrecisionDecimal, RoundDirection_b3pcwy.Nearest);
				Int128* num5 = &int2;
				...
				if (i <= 0)
				{
					...
					HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal, -1);
					Struct_fiz2nb struct_fiz2nb4 = HighPrecisionDecimal_round_to_integer_type_unsigned_int128.Invoke(&internal_HighPrecisionDecimal, Round);
					Int128* num7 = &int3;
				...
				internal_ExpandedFloat_9jummq5.Mantissa = @int;
				internal_ExpandedFloat_9jummq5.Exponent = i;
