...
internal static partial class Scanf_core_vfscanf_internal
{
	...
	public unsafe static int Invoke([MangledName("stream")][NativeType("_IO_FILE*")] void* Stream, [MangledName("format")][NativeType("char const*")] void* Format, [MangledName("args")][NativeType("__llvm_libc_20_1_2_::internal::ArgList&")] Internal_ArgList* Args)
	{
		...
		unchecked
		{
			...
			Reader_Constructor.Invoke(&scanf_core_Reader, Stream, Internal_getc.__pointer, Internal_ungetc.__pointer, null);
			Llvm_lifetime_start_p0.Invoke(4L, &num);
			num = Scanf_core_scanf_main.Invoke(&scanf_core_Reader, Format, Args);
