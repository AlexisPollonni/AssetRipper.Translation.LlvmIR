...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_max_normal_Sign
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte sign)
	{
		...
		int field_ = fputil_internal_FPStorage_fputil_FPType_3_Exponent_max.Invoke();
		...
		Struct_fiz2nb struct_fiz2nb = fputil_internal_FPStorage_fputil_FPType_3_Significand_bits_all_ones.Invoke();
