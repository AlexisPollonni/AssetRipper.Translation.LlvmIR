...
internal static partial class BigInt_32ul_false_unsigned_int_to_unsigned_int
{
	...
	public unsafe static int Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_vtm4cw* This)
	{
		long num = 0L;
		int num2 = 0;
		...
		num2 = *unchecked((int*)Array_unsigned_int_1ul_Index_9mw8rm.Invoke(&This->Val, 0L));
		int result = num2;
