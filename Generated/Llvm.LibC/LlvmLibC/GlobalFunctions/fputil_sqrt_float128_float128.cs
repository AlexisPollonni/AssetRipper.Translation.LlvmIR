...
internal static partial class fputil_sqrt_float128_float128
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<__float128> && cpp::is_floating_point_v<__float128> && sizeof (__float128) <= sizeof (__float128), __float128>::type")]
	public unsafe static double Invoke([NativeType("__float128")] double x)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (num3 != 0)
			{
				result = fputil_cast_float128_float128.Invoke(x);
			}
