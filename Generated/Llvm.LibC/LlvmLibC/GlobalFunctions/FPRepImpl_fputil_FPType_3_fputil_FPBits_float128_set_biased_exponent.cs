	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("biased.coerce0")] long Biased, [MangledName("biased.coerce1")] long Biased_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = Biased;
			...
			BiasedExponent_Constructor_ugybtz.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent, (int)@int);
			FPStorage_fputil_FPType_3_set_biased_exponent.Invoke(This, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0);
		}
	}
}
