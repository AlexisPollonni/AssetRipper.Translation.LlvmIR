...
internal static partial class linux_file_read_File_void_unsigned_long
{
	...
	public unsafe static Struct_3driym Invoke(void* f, void* buf, long size)
	{
		...
		num = int_syscall_impl_int_int_void_unsigned_long_long_int_void_unsigned_long.Invoke(0L, LinuxFile_get_fd_const.Invoke(ptr), buf, size);
		if (num < 0)
		{
