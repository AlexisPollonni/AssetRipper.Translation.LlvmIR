	...
	public unsafe static long Invoke(void* @this, int x_bits)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(x_bits == ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_58kucm*)@this)->values))[num].input, expected: false))
				{
					llvm_lifetime_start_p0.Invoke(4L, &num2);
					num2 = ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_58kucm*)@this)->values))[num].rnd_towardzero_result;
					switch (fputil_quick_get_round.Invoke())
					{
					case 2048:
					{
						int rnd_upward_offset = ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_58kucm*)@this)->values))[num].rnd_upward_offset;
						num2 += rnd_upward_offset;
						break;
					}
					case 1024:
					{
						int rnd_downward_offset = ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_58kucm*)@this)->values))[num].rnd_downward_offset;
						num2 += rnd_downward_offset;
						break;
					}
					case 0:
					{
						int rnd_tonearest_offset = ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_58kucm*)@this)->values))[num].rnd_tonearest_offset;
