...
internal static partial class DyadicFloat_128ul_fast_as_Float16_true_void
{
	...
	public unsafe static Half Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* This)
	{
			...
			else
			{
				...
				else
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					short field_3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value.Invoke(Biased_exp: (short)num3, Mantissa: (short)(((ushort)BigInt_128ul_false_unsigned_long_Unsigned_short_unsigned_short.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh)) & 0x3FF) | 0), Sign: anon_izyfb3.Val);
					...
					*(long*)ptr3 = -6148914691236517206L;
					...
					else
					{
						...
						Struct_fiz2nb struct_fiz2nb4 = BigInt_128ul_false_unsigned_long_LeftShift.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh3), (uint)(num4 - 1));
