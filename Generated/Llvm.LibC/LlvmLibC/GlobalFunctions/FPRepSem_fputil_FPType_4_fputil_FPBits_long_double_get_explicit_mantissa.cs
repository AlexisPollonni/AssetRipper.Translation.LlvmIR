...
internal static partial class FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa
{
	...
	public unsafe static Struct_fiz2nb Invoke(void* @this)
	{
		...
		Struct_fiz2nb struct_fiz2nb = FPStorage_fputil_FPType_4_sig_bits.Invoke(@this);
		Int128* num = &@int;
