...
internal static partial class FMod_float_unsigned_long_fputil_generic_FModDivisionSimpleHelper_unsigned_long_eval_internal
{
	...
	public unsafe static int Invoke([MangledName("sx.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<float>")] int Sx, [MangledName("sy.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<float>")] int Sy)
	{
		...
		fputil_FPBits_5nkvcs2.FPRepImpl.FPRepSem.field_0.field_0 = Sx;
		fputil_FPBits_5nkvcs3.FPRepImpl.FPRepSem.field_0.field_0 = Sy;
		unchecked
		{
			if (Details_expects_bool_condition_bool.Invoke((uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) <= (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3)), Expected: true))
			{
				if ((uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) < (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3)))
				{
			...
			else
			{
				...
				num = (ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2));
				Llvm_lifetime_start_p0.Invoke(4L, &num2);
				num2 = (ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3));
				if (Details_expects_bool_condition_bool.Invoke(num2 > 23 && checked(num - num2) <= 8, Expected: true))
				{
					Llvm_lifetime_start_p0.Invoke(4L, &num3);
					num3 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs2);
					Llvm_lifetime_start_p0.Invoke(4L, &num4);
					num4 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs3);
					...
					if (num5 == 0)
					{
						...
						fputil_FPBits_5nkvcs.FPRepImpl.FPRepSem.field_0.field_0 = field_2;
					}
					else
					{
						int field_3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_make_value.Invoke(num5, checked(num2 - 1));
						fputil_FPBits_5nkvcs.FPRepImpl.FPRepSem.field_0.field_0 = field_3;
					}
				...
				else if (Details_expects_bool_condition_bool.Invoke(num == 0 && num2 == 0, Expected: false))
				{
					*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
					...
					FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs), (int)((uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) % (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3))));
				}
				else
				{
					Llvm_lifetime_start_p0.Invoke(8L, &num6);
					num6 = (uint)FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs2);
					num = checked(num + -1);
					Llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = (uint)FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs3);
					...
					{
						num7 = (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3));
					...
					if (Details_expects_bool_condition_bool.Invoke(num6 == 0L, Expected: false))
					{
						...
						fputil_FPBits_5nkvcs.FPRepImpl.FPRepSem.field_0.field_0 = field_4;
					}
					else if (num11 == 0)
					{
						int field_5 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_make_value.Invoke((int)num6, num2);
						fputil_FPBits_5nkvcs.FPRepImpl.FPRepSem.field_0.field_0 = field_5;
					}
					else
					{
						...
						fputil_FPBits_5nkvcs.FPRepImpl.FPRepSem.field_0.field_0 = field_6;
					}
