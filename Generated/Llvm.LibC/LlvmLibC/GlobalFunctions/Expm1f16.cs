	...
	public unsafe static Half Invoke([MangledName("x")] Half X)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva) = -21846;
			...
			if (!Details_expects_bool_condition_bool.Invoke((uint)(ushort)num2 <= 12288u || (uint)(ushort)num2 >= 18336u, Expected: false))
			{
				goto IL_05a1;
			}
			...
			else if (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva)) && (uint)(ushort)num2 >= 18828u)
			{
			...
			else if ((uint)(ushort)num >= 51104u)
			{
				...
				else if ((uint)(ushort)num > 51240u)
				{
					...
					result = Fputil_round_result_slightly_up_Float16.Invoke(FPBits_Float16_get_val.Invoke(&fputil_FPBits_2fahva7));
			...
			{
				if ((uint)(ushort)num2 > 12288u || FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((Fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva)))
				{
					goto IL_05a1;
				}
