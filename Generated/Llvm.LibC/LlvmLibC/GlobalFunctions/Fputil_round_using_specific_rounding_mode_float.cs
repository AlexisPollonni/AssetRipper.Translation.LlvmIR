		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			else
			{
				...
				b = (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) ? ((sbyte)1) : ((sbyte)0));
				Llvm_lifetime_start_p0.Invoke(4L, &num);
				num = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_exponent.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs));
				if (num >= 23)
				{
					result = X;
				}
				else if (num <= -1)
				{
					result = Rnd switch
					{
						...
						_ => (num > -2 && FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) != 0) ? InstructionHelper.Select((b & 1) == 1, -1f, 1f) : InstructionHelper.Select((b & 1) == 1, -0f, 0f), 
					};
				}
				else
				{
					...
					num3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs));
					...
					else
					{
						...
						*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
						FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs2, num4);
						Llvm_lifetime_start_p0.Invoke(4L, &num5);
						num5 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
						Llvm_lifetime_start_p0.Invoke(4L, &num6);
						num6 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) & ((1 << num2) - 1);
						Llvm_lifetime_start_p0.Invoke(4L, &num7);
						num7 = 1 << num2 - 1;
						Llvm_lifetime_start_p0.Invoke(4L, &num8);
						num8 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) & (1 << num2);
						result = Rnd switch
						{
