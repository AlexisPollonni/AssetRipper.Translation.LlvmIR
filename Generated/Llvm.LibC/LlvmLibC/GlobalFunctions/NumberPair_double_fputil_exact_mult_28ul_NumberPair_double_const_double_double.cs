...
internal static partial class NumberPair_double_fputil_exact_mult_28ul_NumberPair_double_const_double_double
{
	public unsafe static Struct_4ydhja Invoke(NumberPair* @as, double a, double b)
	{
		...
		unchecked
		{
			*(double*)(&numberPair2) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = NumberPair_double_fputil_split_28ul_double.Invoke(b);
