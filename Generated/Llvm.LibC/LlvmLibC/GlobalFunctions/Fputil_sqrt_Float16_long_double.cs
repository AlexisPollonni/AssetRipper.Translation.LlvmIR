...
internal static partial class Fputil_sqrt_Float16_long_double
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("long double")] double X)
	{
			...
			else
			{
				...
				*(long*)num4 = struct_fiz2nb6.field_1;
				...
				checked
				{
					...
					{
						num++;
						Internal_normalize_long_double.Invoke(&num, &x);
					}
					else
					{
