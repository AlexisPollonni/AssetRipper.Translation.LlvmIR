...
internal static partial class Llvm_libc_20_1_2_distance_to_next_aligned_32ul
{
	...
	{
		return unchecked(32L - Llvm_libc_20_1_2_distance_to_align_down_32ul.Invoke(Ptr));
	}
}
