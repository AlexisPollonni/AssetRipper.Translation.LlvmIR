			...
			else
			{
				...
				else
				{
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					int num21 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((anon_izyfb7*)(&bigInt_qdkjbh6)) ? 1 : 0) ^ -1;
					...
					int num22 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((anon_izyfb7*)(&bigInt_qdkjbh7)) ? 1 : 0) ^ -1;
