			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un2) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 1uL; num5++)
				{
					...
					num6 = lambda0_Invoke_6ucy5i.Invoke(&anon_6je4un2, num5 + num3);
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = lambda0_Invoke_6ucy5i.Invoke(&anon_6je4un2, num5 + num3 + 1L);
					llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = array_unsigned_int_1ul_Index_ejbtjs.Invoke(&cpp_array_2v7m9i2, lambda_Invoke_f9yjxv.Invoke(&anon_izyfb8, num5));
					if (num4 == 0L)
					{
						*(int*)ptr = num6;
					}
