	...
	public unsafe static float Invoke([MangledName("x")] float X)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			num2 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) >>> 31 << 11;
			float result;
			...
			else
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm) = -6148914691236517206L;
				...
				num3 = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm));
				Llvm_lifetime_start_p0.Invoke(4L, &num4);
				num4 = (int)((uint)num3 / 3u + 682) | num2;
				Llvm_lifetime_start_p0.Invoke(4L, &num5);
				num5 = (int)((uint)num3 % 3u);
				Llvm_lifetime_start_p0.Invoke(8L, &num6);
				num6 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm));
				Llvm_lifetime_start_p0.Invoke(4L, &num7);
				num7 = (int)(num6 >>> 48);
				num6 |= 0x3FF0000000000000L;
				Llvm_lifetime_start_p0.Invoke(8L, &num8);
				Llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm2);
				FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm2, num6);
				...
				z = Fputil_multiply_add_double.Invoke(x5, *(double*)((byte*)Anonymous_namespace_COEFFS.Pointer + (nint)num13 * sizeof(InlineArray7_Double)), 1.0);
				...
				y = Fputil_multiply_add_double.Invoke(x6, y4, ((double*)((byte*)Anonymous_namespace_COEFFS.Pointer + (nint)num15 * sizeof(InlineArray7_Double)))[1]);
				...
				z2 = Fputil_multiply_add_double.Invoke(x7, y5, ((double*)((byte*)Anonymous_namespace_COEFFS.Pointer + (nint)num17 * sizeof(InlineArray7_Double)))[3L]);
				...
				y2 = Fputil_multiply_add_double.Invoke(x8, y6, ((double*)((byte*)Anonymous_namespace_COEFFS.Pointer + (nint)num19 * sizeof(InlineArray7_Double)))[5L]);
				...
				x3 = num20 * ((double*)Anonymous_namespace_CBRT2.Pointer)[num21];
				Llvm_lifetime_start_p0.Invoke(8L, &num11);
				Llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm3);
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm3, x3);
				long num22 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3));
				...
				FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm4, x4);
				result = (float)FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm4);
