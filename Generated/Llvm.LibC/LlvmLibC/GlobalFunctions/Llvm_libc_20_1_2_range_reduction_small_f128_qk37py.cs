...
internal static partial class Llvm_libc_20_1_2_range_reduction_small_f128_qk37py
{
	[MangledName("_ZN19__llvm_libc_20_1_2_L26range_reduction_small_f128Ed.19")]
	[DemangledName("__llvm_libc_20_1_2_::range_reduction_small_f128(double) (.19)")]
	[CleanName("Llvm_libc_20_1_2_range_reduction_small_f128")]
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4* Agg_result, [MangledName("x")][NativeType("double")] double X)
	{
		...
		unchecked
		{
			...
			*(long*)ptr3 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2, 0.0 - num2);
			...
			*(long*)ptr5 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd3, X);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4) = -86;
			sbyte* ptr6 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4) + 1;
			*ptr6 = -86;
			ptr6[1] = -86;
			ptr6[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4))[1] = -1431655766;
			sbyte* ptr7 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4) + 8;
			*(long*)ptr7 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd5, *(double*)((byte*)Llvm_libc_20_1_2_ONE_TWENTY_EIGHT_OVER_PI_21.Pointer + (nint)3 * sizeof(InlineArray4_Double)));
			Fputil_quick_mul_128ul.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd3, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd5);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6) = -86;
			sbyte* ptr8 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6) + 1;
			*ptr8 = -86;
			ptr8[1] = -86;
			ptr8[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6))[1] = -1431655766;
			sbyte* ptr9 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6) + 8;
			*(long*)ptr9 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd7, ((double*)((byte*)Llvm_libc_20_1_2_ONE_TWENTY_EIGHT_OVER_PI_21.Pointer + (nint)3 * sizeof(InlineArray4_Double)))[1]);
			Fputil_quick_mul_128ul.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd6, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd3, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd7);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8) = -86;
			sbyte* ptr10 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8) + 1;
			*ptr10 = -86;
			ptr10[1] = -86;
			ptr10[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8))[1] = -1431655766;
			sbyte* ptr11 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8) + 8;
			*(long*)ptr11 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_double_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9, ((double*)((byte*)Llvm_libc_20_1_2_ONE_TWENTY_EIGHT_OVER_PI_21.Pointer + (nint)3 * sizeof(InlineArray4_Double)))[2L]);
			Fputil_quick_mul_128ul.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd3, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd9);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd10) = -86;
			sbyte* ptr12 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd10) + 1;
			*ptr12 = -86;
			ptr12[1] = -86;
			ptr12[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd10))[1] = -1431655766;
			sbyte* ptr13 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd10) + 8;
			*(long*)ptr13 = -6148914691236517206L;
			((long*)ptr13)[1] = -6148914691236517206L;
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd11, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd4, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd12, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2, 24L, isVolatile: false);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd13) = -86;
			sbyte* ptr14 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd13) + 1;
			*ptr14 = -86;
			ptr14[1] = -86;
			ptr14[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd13))[1] = -1431655766;
			sbyte* ptr15 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd13) + 8;
			*(long*)ptr15 = -6148914691236517206L;
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd15, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd8, 24L, isVolatile: false);
			...
			*(sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd16) = -86;
			sbyte* ptr16 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd16) + 1;
			*ptr16 = -86;
			ptr16[1] = -86;
			ptr16[2] = -86;
			((int*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd16))[1] = -1431655766;
			sbyte* ptr17 = (sbyte*)(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd16) + 8;
			*(long*)ptr17 = -6148914691236517206L;
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd18, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd13, 24L, isVolatile: false);
			...
			Fputil_quick_mul_128ul.Invoke(Agg_result, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd16, &llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd);
