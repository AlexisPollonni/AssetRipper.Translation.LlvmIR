	...
	public unsafe static void Invoke(void* dst, [MangledName("value.coerce")] InlineArray3_Byte value)
	{
		...
		unchecked
		{
			*(InlineArray3_Byte*)(&cpp_array_txpwtz2.Data) = value;
			...
			{
				void_generic_store_unsigned_char_cpp_byte_unsigned_char.Invoke((byte*)dst + num * 1L, *(sbyte*)cpp_array_unsigned_char_3ul_operator_unsigned_long.Invoke(&cpp_array_txpwtz2, num));
			}
