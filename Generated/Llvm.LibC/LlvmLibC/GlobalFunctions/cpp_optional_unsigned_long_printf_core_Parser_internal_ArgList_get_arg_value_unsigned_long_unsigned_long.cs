...
internal static partial class cpp_optional_unsigned_long_printf_core_Parser_internal_ArgList_get_arg_value_unsigned_long_unsigned_long
{
	public unsafe static Struct_8myw6y Invoke(printf_core_Parser* @this, long index)
	{
		...
		if (index != 0L && index != @this->args_index)
		{
			...
			if ((b & 1) != 1)
			{
				...
				cpp_optional_unsigned_long_optional.Invoke(&cpp_optional_d6hvji2);
				num2 = 1;
			}
			else
			{
		...
		unchecked
		{
			*(short*)(&printf_core_TypeDesc2) = printf_core_TypeDesc_printf_core_type_desc_from_type_unsigned_long.Invoke();
			...
			num = unsigned_long_printf_core_Parser_internal_ArgList_get_next_arg_value_unsigned_long.Invoke(@this);
			cpp_optional_unsigned_long_optional_unsigned_long.Invoke(&cpp_optional_d6hvji2, &num);
