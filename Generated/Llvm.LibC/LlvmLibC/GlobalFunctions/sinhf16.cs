			...
			if (details_expects_bool_condition_bool.Invoke(((ushort)num2 == 0) ? true : (((uint)(ushort)num < 33792u || (uint)(ushort)num > 41984u) ? ((uint)(ushort)num2 >= 18917u) : true), expected: false))
			{
				...
				else if ((uint)(ushort)num2 >= 18917u)
				{
					...
					else
					{
						...
						if (num3 == 0 || (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) && num3 == 2048) || (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) && num3 == 1024))
						{
							...
							short field_4 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_inf.Invoke(anon_izyfb11.val);
						...
						else
						{
							...
							anon_izyfb12.val = FPStorage_fputil_FPType_0_sign.Invoke(&fputil_FPBits_2fahva2);
							short field_5 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_max_normal.Invoke(anon_izyfb12.val);
				...
				else if (fputil_fenv_is_round_down.Invoke())
				{
					...
					FPBits_Float16_FPBits_unsigned_short.Invoke(&fputil_FPBits_2fahva8, (short)checked(unchecked((ushort)num) + 1));
				...
				else
				{
					...
					FPBits_Float16_FPBits_unsigned_short.Invoke(&fputil_FPBits_2fahva9, num);
