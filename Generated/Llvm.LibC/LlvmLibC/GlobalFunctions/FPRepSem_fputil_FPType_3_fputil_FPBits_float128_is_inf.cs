...
internal static partial class FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf
{
	[MangledName("_ZNK19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE3ENS0_6FPBitsIgEEE6is_infEv")]
	[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)3, __llvm_libc_20_1_2_::fputil::FPBits<__float128>>::is_inf() const")]
	public unsafe static bool Invoke([MangledName("this")] Fputil_internal_FPRepSem_f94eua* This)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			...
			Struct_fiz2nb struct_fiz2nb7 = FPStorage_fputil_FPType_3_encode.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua), ((long*)(&fputil_internal_FPRepSem_f94eua))[1]);
			Int128* num3 = &y;
