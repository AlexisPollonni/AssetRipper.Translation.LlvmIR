...
internal static partial class float_fputil_fminimum_mag_float_0_float_float
{
	public unsafe static float Invoke(float x, float y)
	{
		...
		unchecked
		{
			...
			*(int*)(&fputil_FPBits_5nkvcs3) = -1431655766;
			...
			float result = ((!(float_fputil_abs_float_0_float.Invoke(x) < float_fputil_abs_float_0_float.Invoke(y))) ? ((!(float_fputil_abs_float_0_float.Invoke(y) < float_fputil_abs_float_0_float.Invoke(x))) ? float_fputil_fminimum_float_0_float_float.Invoke(x, y) : y) : x);
