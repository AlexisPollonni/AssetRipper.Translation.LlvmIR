	...
	public unsafe static double Invoke([MangledName("e_x")][NativeType("int")] int E_x, [MangledName("index")][NativeType("int")] int Index, [MangledName("m_x")][NativeType("double")] double M_x)
	{
		...
		unchecked
		{
			...
			*(long*)ptr4 = -6148914691236517206L;
			...
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd2, Anonymous_namespace_LOG_2_35.Pointer, &fputil_DyadicFloat_kt2kd);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd5, (byte*)Anonymous_namespace_LOG_TABLE.Pointer + (nint)Index * (nint)sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			...
			*(long*)ptr6 = -6148914691236517206L;
			...
			Log_range_reduction.Invoke(&fputil_DyadicFloat_kt2kd6, M_x, Anonymous_namespace_LOG_TABLE.Pointer, &fputil_DyadicFloat_kt2kd2);
			Llvm_lifetime_start_p0.Invoke(24L, &fputil_DyadicFloat_kt2kd7);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd8, &fputil_DyadicFloat_kt2kd2, 24L, isVolatile: false);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd2, &fputil_DyadicFloat_kt2kd7, 24L, isVolatile: false);
			...
			*(sbyte*)(&fputil_DyadicFloat_kt2kd10) = -86;
			sbyte* ptr7 = (sbyte*)(&fputil_DyadicFloat_kt2kd10) + 1;
			*ptr7 = -86;
			ptr7[1] = -86;
			ptr7[2] = -86;
			((int*)(&fputil_DyadicFloat_kt2kd10))[1] = -1431655766;
			sbyte* ptr8 = (sbyte*)(&fputil_DyadicFloat_kt2kd10) + 8;
			*(long*)ptr8 = -6148914691236517206L;
			((long*)ptr8)[1] = -6148914691236517206L;
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd6, (Fputil_DyadicFloat_kt2kd4*)Anonymous_namespace_BIG_COEFFS_36.Pointer);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd14, (byte*)Anonymous_namespace_BIG_COEFFS_36.Pointer + sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd12, &fputil_DyadicFloat_kt2kd13, &fputil_DyadicFloat_kt2kd14);
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd11, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd12);
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd18, (byte*)Anonymous_namespace_BIG_COEFFS_36.Pointer + (nint)2 * sizeof(Fputil_DyadicFloat_kt2kd4), 24L, isVolatile: false);
			Fputil_quick_add_128ul.Invoke(&fputil_DyadicFloat_kt2kd16, &fputil_DyadicFloat_kt2kd17, &fputil_DyadicFloat_kt2kd18);
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd15, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd16);
			...
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd19, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd10);
			...
			*(long*)ptr10 = -6148914691236517206L;
			...
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd22, &fputil_DyadicFloat_kt2kd10, 24L, isVolatile: false);
