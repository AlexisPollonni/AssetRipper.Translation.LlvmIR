...
internal static partial class FloatWriter_write_first_block
{
	...
	public unsafe static void Invoke([MangledName("this")] Printf_core_FloatWriter* This, [MangledName("block")][NativeType("unsigned int")] int Block, [MangledName("exp_format")][NativeType("bool")] bool Exp_format)
	{
		...
		unchecked
		{
			...
			*ptr2 = -86;
			...
			IntegerToString_long_details_Fmt_unsigned_char_10_false_false_false_1ul_Constructor.Invoke(&integerToString_uuwdyc, (uint)Block);
			...
			*(long*)num4 = struct_kqhe8i3.field_1;
			...
			{
				sbyte b2 = *(sbyte*)String_view_Index.Invoke(&cpp_string_view, num2);
