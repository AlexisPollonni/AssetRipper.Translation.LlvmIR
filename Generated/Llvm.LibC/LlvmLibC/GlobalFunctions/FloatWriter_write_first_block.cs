...
internal static partial class FloatWriter_write_first_block
{
	...
	public unsafe static void Invoke(printf_core_FloatWriter* @this, [NativeType("unsigned int")] int block, [NativeType("bool")] bool exp_format)
	{
		...
		unchecked
		{
			...
			*(long*)num4 = struct_kqhe8i3.field_1;
			...
			{
				sbyte b2 = *(sbyte*)string_view_Index.Invoke(&cpp_string_view2, num2);
