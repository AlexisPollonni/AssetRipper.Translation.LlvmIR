...
internal static partial class strfromf
{
	public unsafe static int Invoke(void* s, long n, void* format, float fp)
	{
		...
		printf_core_FormatSection_internal_parse_format_string_float_char_const_float.Invoke(&printf_core_FormatSection2, format, fp);
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			{
				num = int_internal_strfromfloat_convert_float_printf_core_Writer_printf_core_FormatSection_const.Invoke(&printf_core_Writer2, &printf_core_FormatSection2);
			}
			else
			{
