...
internal static partial class inline_memmem_strstr_impl_char_const_char_const_0
{
	...
	public unsafe static void* Invoke([NativeType("void const*")] void* haystack, [NativeType("unsigned long")] long haystack_len, [NativeType("void const*")] void* needle, [NativeType("unsigned long")] long needle_len, [NativeType("__llvm_libc_20_1_2_::__strstr_impl__(char const*, char const*)::$_0&")] void* comp)
	{
		void* result = null;
		void* ptr = null;
		void* ptr2 = null;
		...
		unchecked
		{
			...
			else
			{
				...
				while (true)
				{
					...
					for (num2 = 0L; (ulong)num2 < (ulong)needle_len && (((_0_Invoke_7ktfmv.Invoke(comp, ((sbyte*)ptr)[num + num2], ((sbyte*)ptr2)[num2]) != 0) ? 1u : 0u) ^ 0xFFFFFFFFu) != 0; num2++)
					{
					}
					if (num2 == needle_len)
					{
