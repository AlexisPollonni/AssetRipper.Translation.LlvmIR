...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_floating_point_v_float128_sizeof_float_sizeof_float128_float_type_fputil_generic_add_or_sub_true_float_float128_float128_float128
{
	public unsafe static float Invoke(double x, double y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan_const.Invoke(&fputil_FPBits_ubgsi3) || fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan_const.Invoke(&fputil_FPBits_ubgsi4))
			{
				...
				if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan_const.Invoke(&fputil_FPBits_ubgsi3))
				{
					...
					*(long*)num11 = struct_fiz2nb3.field_1;
					...
					int field_ = fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan_Sign_unsigned_int.Invoke(v: (int)@int, sign: anon_izyfb10.val);
				...
				else if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan_const.Invoke(&fputil_FPBits_ubgsi4))
				{
					...
					*(long*)num13 = struct_fiz2nb6.field_1;
					...
					int field_2 = fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_quiet_nan_Sign_unsigned_int.Invoke(v: (int)int3, sign: anon_izyfb11.val);
			...
			{
				if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf_const.Invoke(&fputil_FPBits_ubgsi4))
				{
					if ((b & 1) != 1)
					{
						fputil_raise_except_if_required_int.Invoke(1);
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				...
				else
				{
					...
					num4 = y;
					num4 = 0.0 - num4;
					result = cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_floating_point_v_float128_float_type_fputil_cast_float_float128_float128.Invoke(num4);
			...
			else
			{
				...
				num5 = y;
				num5 = 0.0 - num5;
				result = cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_floating_point_v_float128_float_type_fputil_cast_float_float128_float128.Invoke(num5);
		...
		unchecked
		{
			...
			double num14 = fputil_FPBits_float128_get_val_const.Invoke(&fputil_FPBits_ubgsi5);
			...
			double num15 = fputil_FPBits_float128_get_val_const.Invoke(&fputil_FPBits_ubgsi6);
			...
			else
			{
				...
				*(Int128*)(&fputil_FPBits_ubgsi7) = -6148914691236517206L;
				fputil_FPBits_float128_FPBits_float128_float128.Invoke(&fputil_FPBits_ubgsi7, *(double*)float128_const_cpp_max_float128_float128_const_float128_const.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi8);
				*(Int128*)(&fputil_FPBits_ubgsi8) = -6148914691236517206L;
				fputil_FPBits_float128_FPBits_float128_float128.Invoke(&fputil_FPBits_ubgsi8, *(double*)float128_const_cpp_min_float128_float128_const_float128_const.Invoke(&num6, &num7));
				llvm_lifetime_start_p0.Invoke(16L, &int5);
				int5 = -6148914691236517206L;
				if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal_const.Invoke(&fputil_FPBits_ubgsi7))
				{
					if ((b & 1) == 1)
					{
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb25 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi7);
					Int128* num24 = &x3;
					...
					*(long*)num25 = struct_fiz2nb27.field_1;
					...
					Struct_fiz2nb struct_fiz2nb28 = fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi8);
					Int128* num26 = &x5;
					...
					*(long*)num27 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num8 = unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi7)) - unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent_const.Invoke(&fputil_FPBits_ubgsi8));
				...
				num9 = checked(fputil_internal_FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_exponent_const.Invoke(&fputil_FPBits_ubgsi7) - 115);
