	...
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			num2 = fputil_FPBits_float_get_val_const.Invoke(&fputil_FPBits_5nkvcs2);
			float result;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((uint)num < 950204804u, expected: false))
			{
				result = (float)cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num2, -2.980232238769531E-08, 1.0);
			}
			...
			else
			{
				...
				x2 = double.NaN;
				sincospif_eval_double_double_double_double_double.Invoke(num2, &num3, &num4, &num5, &x2);
				result = ((!bool_details_expects_bool_condition_bool_bool_bool.Invoke(num5 == 0.0 && num4 == 0.0, expected: false)) ? ((float)cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(num5, 0.0 - num3, cpp_enable_if_sizeof_double_8ul_double_type_fputil_multiply_add_double_double_double_double.Invoke(x2, num4, num4))) : 0f);
