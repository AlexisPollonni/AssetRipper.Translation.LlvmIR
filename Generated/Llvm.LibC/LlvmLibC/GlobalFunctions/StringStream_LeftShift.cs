...
internal static partial class StringStream_LeftShift
{
	...
	public unsafe static void* Invoke(void* @this, [MangledName("str.coerce0")] void* str, [MangledName("str.coerce1")] long str_coerce1)
	{
		...
		unchecked
		{
			*(void**)(&cpp_string_view2) = str;
			...
			StringStream_write.Invoke(@this, string_view_data.Invoke(&cpp_string_view2), string_view_size.Invoke(&cpp_string_view2));
			return @this;
		}
	}
	...
	{
		cpp_string_view cpp_string_view2 = default(cpp_string_view);
		string_view_Constructor.Invoke(&cpp_string_view2, str);
		return unchecked(Invoke(@this, *(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]));
	}
	...
	public unsafe static void* Invoke(void* @this, [NativeType("char")] sbyte a)
	{
		sbyte b = a;
	...
	public unsafe static void* Invoke(void* @this, [NativeType("int")] int val)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_kqhe8i3.field_1;
			void* result = Invoke(@this, *(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]);
