...
internal static partial class log_range_reduction
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, [NativeType("double")] double m_x, [NativeType("__llvm_libc_20_1_2_::LogRR const&")] LogRR* log_table, [NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<128ul>&")] fputil_DyadicFloat_kt2kd4* sum)
	{
		long num = 0L;
		long num2 = 0L;
		...
		unchecked
		{
			...
			if (num14)
			{
				...
				*(long*)(&inlineArray2_Int) = (long)NumericHelper.SubtractSigned(y: int2, x: 0L);
				...
				DyadicFloat_128ul_Constructor.Invoke(agg_result, anon_izyfb8.val, -125, *(long*)(&bigInt_qdkjbh), ((long*)(&bigInt_qdkjbh))[1]);
			}
			else
			{
				...
				*(long*)(&inlineArray2_Int2) = (long)int2;
				...
				DyadicFloat_128ul_Constructor.Invoke(agg_result, anon_izyfb9.val, -125, *(long*)(&bigInt_qdkjbh2), ((long*)(&bigInt_qdkjbh2))[1]);
			}
