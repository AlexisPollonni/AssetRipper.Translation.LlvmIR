...
internal static partial class Generic_div_float_float128
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic3divIfgEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT_Esr3cppE19is_floating_point_vIT0_ElestS5_stS6_ES5_E4typeES6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<float> && cpp::is_floating_point_v<__float128> && sizeof (float) <= sizeof (__float128), float>::type __llvm_libc_20_1_2_::fputil::generic::div<float, __float128>(__float128, __float128)")]
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb) = -86;
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
			{
		...
		unchecked
		{
			...
			*(long*)ptr2 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_float128_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd, X);
			...
			*(long*)ptr4 = -6148914691236517206L;
			...
			DyadicFloat_128ul_DyadicFloat_float128_0.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2, Y);
			Llvm_lifetime_start_p0.Invoke(4L, &num);
			num = 26;
			Llvm_lifetime_start_p0.Invoke(4L, &num2);
			num2 = checked(llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd.Exponent - llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd2.Exponent - 25);
