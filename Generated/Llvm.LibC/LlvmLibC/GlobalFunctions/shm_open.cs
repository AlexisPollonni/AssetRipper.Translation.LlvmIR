...
internal static partial class shm_open
{
	public unsafe static int Invoke(void* name, int oflags, int mode)
	{
		...
		unchecked
		{
			...
			{
				result = ((delegate*<void*, int, int>)open.__pointer)(cpp_array_char_265ul_data.Invoke(cpp_optional_cpp_array_char_265ul_operator.Invoke(&cpp_optional_hnriuf2)), oflags | 0xA0800);
				num = 1;
			}
			else
			{
