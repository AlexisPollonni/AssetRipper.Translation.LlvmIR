...
internal static partial class Generic_add_or_sub_true_double_long_double
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic10add_or_subILb1EdeEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT0_Esr3cppE19is_floating_point_vIT1_ElestS5_stS6_ES5_E4typeES6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<double> && cpp::is_floating_point_v<long double> && sizeof (double) <= sizeof (long double), double>::type __llvm_libc_20_1_2_::fputil::generic::add_or_sub<true, double, long double>(long double, long double)")]
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("y")][NativeType("long double")] double Y)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi) || FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi2))
			{
				...
				else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_quiet_nan.Invoke(&fputil_FPBits_ubgsi2))
				{
					...
					*(long*)num13 = struct_fiz2nb6.field_1;
					...
					anon_izyfb4.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi2);
			...
			{
				if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf.Invoke(&fputil_FPBits_ubgsi2))
				{
					if ((b & 1) != 1)
					{
						Fputil_raise_except_if_required.Invoke(1);
			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_inf.Invoke(&fputil_FPBits_ubgsi2))
			{
				...
				anon_izyfb9.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi2);
			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi))
			{
				...
				else
				{
					...
					num4 = Y;
					num4 = 0.0 - num4;
					result = Fputil_cast_double_long_double.Invoke(num4);
			...
			else
			{
				...
				num5 = Y;
				num5 = 0.0 - num5;
				result = Fputil_cast_double_long_double.Invoke(num5);
		...
		Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&fputil_FPBits_ubgsi);
		...
		unchecked
		{
			...
			double num14 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3);
			Llvm_lifetime_end_p0.Invoke(16L, &fputil_FPBits_ubgsi3);
			num6 = num14;
			Llvm_lifetime_start_p0.Invoke(16L, &num7);
			Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi4);
			Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&fputil_FPBits_ubgsi2);
			...
			double num15 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi4);
			...
			else
			{
				...
				*(sbyte*)(&anon_izyfb14) = -86;
				...
				if (num6 > num7)
				{
					...
					anon_izyfb15.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi);
				...
				else if (num6 < num7)
				{
					if ((b & 1) == 1)
					{
						...
						anon_izyfb16.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi2);
						Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb14, &anon_izyfb16, 1L, isVolatile: false);
						Llvm_lifetime_end_p0.Invoke(1L, &anon_izyfb16);
					}
					else if (FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_pos.Invoke(&fputil_FPBits_ubgsi2))
					{
				...
				else if ((b & 1) == 1)
				{
					...
					anon_izyfb17.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi);
				...
				*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi5, *(double*)Cpp_max_long_double.Invoke(&num6, &num7));
				Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi6);
				*(Int128*)(&fputil_FPBits_ubgsi6) = -6148914691236517206L;
				FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi6, *(double*)Cpp_min_long_double.Invoke(&num6, &num7));
				Llvm_lifetime_start_p0.Invoke(16L, &int5);
				int5 = -6148914691236517206L;
				if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_subnormal.Invoke(&fputil_FPBits_ubgsi5))
				{
					if ((b & 1) == 1)
					{
						Struct_fiz2nb struct_fiz2nb13 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi5);
						Int128* num16 = &int6;
						...
						*(long*)num17 = struct_fiz2nb15.field_1;
						Int128 x6 = int6;
						Struct_fiz2nb struct_fiz2nb16 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi6);
						Int128* num18 = &y;
					...
					{
						Struct_fiz2nb struct_fiz2nb19 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi5);
						Int128* num20 = &int7;
						...
						*(long*)num21 = struct_fiz2nb21.field_1;
						Int128 x7 = int7;
						Struct_fiz2nb struct_fiz2nb22 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi6);
						Int128* num22 = &y2;
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb25 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num24 = &x2;
					...
					*(long*)num25 = struct_fiz2nb27.field_1;
					...
					Struct_fiz2nb struct_fiz2nb28 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi6);
					Int128* num26 = &x4;
					...
					*(long*)num27 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num8 = unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi5)) - unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi6));
					...
					b2 = -86;
					b2 = ((num8 > 3 && (num8 > 66 || NumericHelper.IntCmpNe(NumericHelper.ShiftLeft(x3, (Int128)(UInt128)(uint)checked(128 - num8)), 0L))) ? ((sbyte)1) : ((sbyte)0));
				...
				num9 = checked(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_exponent.Invoke(&fputil_FPBits_ubgsi5) - 66);
