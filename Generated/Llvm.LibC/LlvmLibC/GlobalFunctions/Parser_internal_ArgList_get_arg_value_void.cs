	...
	public unsafe static Struct_yx4nca Invoke([MangledName("this")] Llvm_libc_20_1_2_printf_core_Parser* This, [MangledName("index")][NativeType("unsigned long")] long Index)
	{
		...
		if (Index != 0L && Index != This->Args_index)
		{
			...
			if ((b & 1) != 1)
			{
				...
				Optional_void_Constructor.Invoke(&llvm_libc_20_1_2_cpp_optional_77yu8f);
				num = 1;
			}
			else
			{
		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_printf_core_TypeDesc) = Printf_core_type_desc_from_type_void_f5fqec.Invoke();
			...
			Optional_void_Constructor.Invoke(&llvm_libc_20_1_2_cpp_optional_77yu8f, &ptr);
