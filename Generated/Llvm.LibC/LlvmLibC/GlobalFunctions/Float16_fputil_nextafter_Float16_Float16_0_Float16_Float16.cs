...
internal static partial class Float16_fputil_nextafter_Float16_Float16_0_Float16_Float16
{
	public unsafe static Half Invoke(Half from, Half to)
	{
			...
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else
			{
				...
				*(short*)(&fputil_FPBits_2fahva3) = -21846;
				fputil_FPBits_Float16_FPBits_Float16_Float16.Invoke(&fputil_FPBits_2fahva3, to);
				if (fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan_const.Invoke(&fputil_FPBits_2fahva3))
				{
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_Float16_Float16_type_fputil_cast_Float16_Float16_Float16.Invoke(to);
				}
				else if (NumericHelper.FcmpOeq(cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_Float16_Float16_type_fputil_cast_Float16_Float16_Float16.Invoke(from), to))
				{
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_Float16_Float16_type_fputil_cast_Float16_Float16_Float16.Invoke(to);
				}
				else
				{
					...
					{
						if (NumericHelper.FcmpOlt(cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_Float16_Float16_type_fputil_cast_Float16_Float16_Float16.Invoke(from), to) == NumericHelper.FcmpOgt(from, default(Half)))
						{
							llvm_lifetime_start_p0.Invoke(2L, &fputil_FPBits_2fahva4);
							fputil_FPBits_Float16_FPBits_unsigned_short_unsigned_short.Invoke(&fputil_FPBits_2fahva4, (short)checked(unchecked((ushort)fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval_const.Invoke(&fputil_FPBits_2fahva2)) + 1));
					...
					if (fputil_internal_FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_subnormal_const.Invoke(&fputil_FPBits_2fahva2))
					{
