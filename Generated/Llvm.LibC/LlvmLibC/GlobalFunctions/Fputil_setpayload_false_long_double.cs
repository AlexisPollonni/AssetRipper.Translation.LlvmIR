	...
	public unsafe static bool Invoke([MangledName("res")][NativeType("long double&")] void* Res, [MangledName("pl")][NativeType("long double")] double Pl)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi, Pl);
			if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi))
			{
				...
				*(double*)Res = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi2);
			...
			if (!FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi) && num >= 0 && num < 62)
			{
				...
				*(long*)num3 = struct_fiz2nb6.field_1;
				if (!NumericHelper.IntCmpNe(NumericHelper.BitwiseAnd(NumericHelper.ShiftLeft(x, (Int128)(UInt128)(uint)num), long.MaxValue), 0L))
				{
					...
					Struct_fiz2nb struct_fiz2nb7 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi);
					Int128* num4 = &x2;
					...
					*(double*)Res = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3);
