	...
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			if (!bool_details_expects_bool_condition_bool_bool_bool.Invoke(((uint)(ushort)num2 > 12288u) ? ((uint)(ushort)num2 >= 17055u) : true, expected: false))
			{
				goto IL_05c2;
			}
			...
			else if ((uint)(ushort)num >= 17617u && fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos_const.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)))
			{
			...
			else
			{
				...
				else
				{
					...
					*(Half*)ptr = default(Half);
					ptr[2] = -86;
					ptr[3] = -86;
					int storage = fputil_ExceptValues_Float16_3ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: EXP10M1F16_EXCEPTS_LO.Pointer);
		...
		unchecked
		{
			...
			*(Half*)ptr2 = default(Half);
			ptr2[2] = -86;
			ptr2[3] = -86;
			int storage2 = fputil_ExceptValues_Float16_6ul_lookup_unsigned_short_const.Invoke(x_bits: num, @this: EXP10M1F16_EXCEPTS_HI.Pointer);
		...
		unchecked
		{
			...
			if (num7 != 15360)
			{
				if (num7 != 16384)
				{
					...
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_double_Float16_type_fputil_cast_Float16_double_double.Invoke(999.0);
				}
				else
				{
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_double_Float16_type_fputil_cast_Float16_double_double.Invoke(99.0);
				}
			}
			else
			{
				result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_double_Float16_type_fputil_cast_Float16_double_double.Invoke(9.0);
			}
			goto IL_0741;
		}
	}
