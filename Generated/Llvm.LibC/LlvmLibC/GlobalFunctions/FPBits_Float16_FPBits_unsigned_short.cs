...
internal static partial class FPBits_Float16_FPBits_unsigned_short
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_FPBits_2fahva* This, [MangledName("x")][NativeType("unsigned short")] short X)
	{
		short field_ = X;
		unchecked
		{
			...
			((Llvm_libc_20_1_2_fputil_internal_FPStorage_za9n4f*)This)->field_0 = field_;
		}
	}
}
