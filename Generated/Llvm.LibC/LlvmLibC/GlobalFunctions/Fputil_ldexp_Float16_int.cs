...
internal static partial class Fputil_ldexp_Float16_int
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<_Float16> && cpp::is_integral_v<int>, _Float16>::type")]
	public unsafe static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X, [MangledName("exp")][NativeType("int")] int Exp)
	{
		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			if (Details_expects_bool_condition_bool.Invoke((Exp == 0) ? true : ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_i7nz4h*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva))) ? FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_inf_or_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) : true), Expected: false))
			{
				result = X;
				goto IL_05ac;
			}
			...
			num = 42;
			if (Details_expects_bool_condition_bool.Invoke(Exp > 42, Expected: false))
			{
		...
		llvm_libc_20_1_2_fputil_DyadicFloat_jvghxm.Exponent += Exp;
