	...
	public unsafe static Half Invoke(double x)
	{
		...
		*unchecked((long*)(&fputil_FPBits_wjhbrm2)) = -6148914691236517206L;
		...
		else
		{
			...
			num2 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_exponent_const.Invoke(&fputil_FPBits_wjhbrm2);
			llvm_lifetime_start_p0.Invoke(8L, &num3);
			num3 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa_const.Invoke(&fputil_FPBits_wjhbrm2);
			...
			unchecked
			{
				...
				*ptr = -86;
				...
				BigInt_64ul_false_unsigned_long_BigInt_unsigned_long_void_unsigned_long.Invoke(&bigInt_nx6qdt, num4);
