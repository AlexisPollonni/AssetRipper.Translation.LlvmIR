...
internal static partial class Get_signal_string_int_cpp_span_char
{
	public unsafe static Struct_kqhe8i Invoke(int sig_num, [MangledName("buffer.coerce0")] void* buffer, [MangledName("buffer.coerce1")] long opt_str)
	{
		...
		unchecked
		{
			...
			*ptr3 = -86;
			...
			else
			{
				...
				Struct_kqhe8i struct_kqhe8i = internal_build_signal_string_int_cpp_span_char.Invoke(sig_num, *(void**)(&cpp_string_view4), ((long*)(&cpp_string_view4))[1]);
