...
internal static partial class printf_core_zero_after_digits_unsigned_long
{
	...
	public unsafe static bool Invoke([NativeType("int")] int base_2_exp, [NativeType("int")] int digits_after_point, [NativeType("unsigned long")] long mantissa, [NativeType("int")] int mant_width)
	{
		int num = 0;
		sbyte b = 0;
		...
		unchecked
		{
			b = (sbyte)(byte)((num <= 0) ? (-1) : ((num < checked(mant_width + 8) && printf_core_multiple_of_power_of_2_unsigned_long.Invoke(mantissa, num)) ? 1 : 0));
			bool result = (b & 1) == 1;
