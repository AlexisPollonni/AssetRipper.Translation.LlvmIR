...
internal static partial class Parser_internal_ArgList_get_next_section
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Scanf_core_FormatSection* Agg_result, [MangledName("this")] Scanf_core_Parser* This)
	{
		long num = 0L;
		long index = 0L;
		...
		unchecked
		{
			if (((sbyte*)This->Str)[This->Cur_pos] == 37)
			{
				...
				if (Agg_result->Conv_name == 91)
				{
					...
					sbyte* ptr = (sbyte*)(&cpp_array_jgy3xh);
					*(long*)ptr = -6148914691236517206L;
					...
					{
						Bitset_256ul_set.Invoke(&cpp_array_jgy3xh, 93L);
						This->Cur_pos++;
					}
					while (((sbyte*)This->Str)[This->Cur_pos] != 0 && ((sbyte*)This->Str)[This->Cur_pos] != 93)
					{
						if (((sbyte*)This->Str)[This->Cur_pos] == 45 && This->Cur_pos != num3 && ((sbyte*)This->Str)[This->Cur_pos + 1L] != 93 && ((sbyte*)This->Str)[This->Cur_pos + 1L] != 0)
						{
							...
							b8 = ((b5 >= b6) ? b5 : b6);
							Bitset_256ul_set_range.Invoke(&cpp_array_jgy3xh, b7, b8);
							This->Cur_pos += 2L;
						...
						{
							Bitset_256ul_set.Invoke(&cpp_array_jgy3xh, ((sbyte*)This->Str)[This->Cur_pos]);
							This->Cur_pos++;
						}
					}
					if ((b4 & 1) == 1)
					{
						Bitset_256ul_flip.Invoke(&cpp_array_jgy3xh);
					}
					if (((sbyte*)This->Str)[This->Cur_pos] == 93)
					{
						This->Cur_pos++;
						Llvm_memcpy_p0_p0_i64.Invoke(&Agg_result->Scan_set, &cpp_array_jgy3xh, 32L, isVolatile: false);
					}
					else
					{
						Agg_result->Has_conv = 0;
			...
			String_view_Constructor.Invoke(&cpp_string_view, (byte*)This->Str + num, This->Cur_pos - num);
	...
	public unsafe static void Invoke([MangledName("agg.result")] Printf_core_FormatSection* Agg_result, [MangledName("this")] Printf_core_Parser* This)
	{
		long num = 0L;
		long index = 0L;
		Cpp_optional_g66fk4 cpp_optional_g66fk = default(Cpp_optional_g66fk4);
		StrToNumResult_imtnam strToNumResult_imtnam = default(StrToNumResult_imtnam);
		Cpp_optional_g66fk4 cpp_optional_g66fk2 = default(Cpp_optional_g66fk4);
		...
		Cpp_optional_g66fk4 cpp_optional_g66fk3 = default(Cpp_optional_g66fk4);
		Cpp_optional_g66fk4 cpp_optional_g66fk4 = default(Cpp_optional_g66fk4);
		...
		Cpp_optional_59q3zq cpp_optional_59q3zq = default(Cpp_optional_59q3zq);
			...
			if (((sbyte*)This->Str)[This->Cur_pos] == 37)
			{
				...
				if (((sbyte*)This->Str)[This->Cur_pos] == 42)
				{
					...
					*(long*)(&cpp_optional_g66fk.Storage) = storage;
					if (!Optional_int_has_value.Invoke(&cpp_optional_g66fk))
					{
						Agg_result->Has_conv = 0;
					}
					else
					{
						Agg_result->Min_width = Cpp_bit_cast_int_int.Invoke(Optional_int_value.Invoke(&cpp_optional_g66fk));
					}
				...
				if (((sbyte*)This->Str)[This->Cur_pos] == 46)
				{
					...
					{
						This->Cur_pos++;
						Llvm_lifetime_start_p0.Invoke(8L, &cpp_optional_g66fk2);
						sbyte* ptr3 = (sbyte*)(&cpp_optional_g66fk2);
						*(int*)ptr3 = -1431655766;
						ptr3[4] = -86;
						sbyte* ptr4 = ptr3 + 5;
						*ptr4 = -86;
						...
						*(long*)(&cpp_optional_g66fk2.Storage) = storage2;
						if (!Optional_int_has_value.Invoke(&cpp_optional_g66fk2))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Precision = Cpp_bit_cast_int_int.Invoke(Optional_int_value.Invoke(&cpp_optional_g66fk2));
						}
						Llvm_lifetime_end_p0.Invoke(8L, &cpp_optional_g66fk2);
					}
					else if (Internal_isdigit_prmaet.Invoke(((sbyte*)This->Str)[This->Cur_pos]))
					{
						...
						*(int*)(&strToNumResult_imtnam2) = -1431655766;
						...
						StrToNumResult_imtnam* num4 = &strToNumResult_imtnam2;
						Struct_fiz2nb struct_fiz2nb5 = struct_fiz2nb4;
						*(long*)num4 = struct_fiz2nb5.field_0;
						byte* num5 = (byte*)(&strToNumResult_imtnam2) + 8u;
				...
				Llvm_lifetime_start_p0.Invoke(16L, &printf_core_LengthSpec);
				*(int*)(&printf_core_LengthSpec) = -1431655766;
				sbyte* ptr5 = (sbyte*)(&printf_core_LengthSpec) + 4;
				*ptr5 = -86;
				ptr5[1] = -86;
				ptr5[2] = -86;
				ptr5[3] = -86;
				((long*)(&printf_core_LengthSpec))[1] = -6148914691236517206L;
				Struct_nfiam5 struct_nfiam = Parser_internal_ArgList_parse_length_modifier.Invoke(This, &This->Cur_pos);
				Printf_core_LengthSpec* num6 = &printf_core_LengthSpec;
				Struct_nfiam5 struct_nfiam2 = struct_nfiam;
				*(int*)num6 = struct_nfiam2.field_0;
				byte* num7 = (byte*)(&printf_core_LengthSpec) + 8u;
				Struct_nfiam5 struct_nfiam3 = struct_nfiam;
				*(long*)num7 = struct_nfiam3.field_1;
				Agg_result->Length_modifier = printf_core_LengthSpec.Lm;
				Agg_result->Conv_name = ((sbyte*)This->Str)[This->Cur_pos];
				Agg_result->Bit_width = printf_core_LengthSpec.Bit_width;
				...
				case 99:
				{
					Llvm_lifetime_start_p0.Invoke(8L, &cpp_optional_g66fk3);
					sbyte* ptr9 = (sbyte*)(&cpp_optional_g66fk3);
					*(int*)ptr9 = -1431655766;
					ptr9[4] = -86;
					sbyte* ptr10 = ptr9 + 5;
					*ptr10 = -86;
					...
					*(long*)(&cpp_optional_g66fk3.Storage) = storage3;
					if (!Optional_int_has_value.Invoke(&cpp_optional_g66fk3))
					{
						Agg_result->Has_conv = 0;
					}
					else
					{
						Agg_result->Conv_val_raw = Cpp_bit_cast_int_int.Invoke(Optional_int_value.Invoke(&cpp_optional_g66fk3));
					}
					Llvm_lifetime_end_p0.Invoke(8L, &cpp_optional_g66fk3);
					break;
				}
				case 66:
				case 88:
				...
				case 117:
				case 120:
					switch (printf_core_LengthSpec.Lm)
					{
					case LengthModifier_mnvaa2.hh:
					case LengthModifier_mnvaa2.h:
					case LengthModifier_mnvaa2.none:
					{
						Llvm_lifetime_start_p0.Invoke(8L, &cpp_optional_g66fk4);
						sbyte* ptr38 = (sbyte*)(&cpp_optional_g66fk4);
						...
						*(long*)(&cpp_optional_g66fk4.Storage) = storage7;
						if (!Optional_int_has_value.Invoke(&cpp_optional_g66fk4))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = Cpp_bit_cast_int_int.Invoke(Optional_int_value.Invoke(&cpp_optional_g66fk4));
						}
						Llvm_lifetime_end_p0.Invoke(8L, &cpp_optional_g66fk4);
						break;
					}
					case LengthModifier_mnvaa2.l:
					{
						Llvm_lifetime_start_p0.Invoke(16L, &cpp_optional_d6hvji);
						sbyte* ptr40 = (sbyte*)(&cpp_optional_d6hvji);
						...
						*ptr41 = -86;
						...
						Cpp_expected* ptr42 = &cpp_optional_d6hvji.Storage;
						...
						if (!Optional_long_has_value.Invoke(&cpp_optional_d6hvji))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = Cpp_bit_cast_long_long.Invoke(Optional_long_value.Invoke(&cpp_optional_d6hvji));
						}
						Llvm_lifetime_end_p0.Invoke(16L, &cpp_optional_d6hvji);
						break;
					}
					...
					case LengthModifier_mnvaa2.L:
					{
						...
						sbyte* ptr35 = (sbyte*)(&cpp_optional_d6hvji2);
						...
						*ptr36 = -86;
						...
						Cpp_expected* ptr37 = &cpp_optional_d6hvji2.Storage;
						...
						if (!Optional_long_long_has_value.Invoke(&cpp_optional_d6hvji2))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = Cpp_bit_cast_long_long_long_long.Invoke(Optional_long_long_value.Invoke(&cpp_optional_d6hvji2));
						}
					...
					case LengthModifier_mnvaa2.j:
					{
						...
						sbyte* ptr43 = (sbyte*)(&cpp_optional_d6hvji3);
						...
						*ptr44 = -86;
						...
						Cpp_expected* ptr45 = &cpp_optional_d6hvji3.Storage;
						...
						if (!Optional_long_has_value.Invoke(&cpp_optional_d6hvji3))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = Cpp_bit_cast_long_long.Invoke(Optional_long_value.Invoke(&cpp_optional_d6hvji3));
						}
					...
					case LengthModifier_mnvaa2.z:
					{
						...
						sbyte* ptr46 = (sbyte*)(&cpp_optional_d6hvji4);
						...
						*ptr47 = -86;
						...
						Cpp_expected* ptr48 = &cpp_optional_d6hvji4.Storage;
						...
						if (!Optional_unsigned_long_has_value.Invoke(&cpp_optional_d6hvji4))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = (Int128)(UInt128)(ulong)Cpp_bit_cast_unsigned_long_unsigned_long.Invoke(Optional_unsigned_long_value.Invoke(&cpp_optional_d6hvji4));
						}
					...
					case LengthModifier_mnvaa2.t:
					{
						...
						sbyte* ptr32 = (sbyte*)(&cpp_optional_d6hvji5);
						...
						*ptr33 = -86;
						...
						Cpp_expected* ptr34 = &cpp_optional_d6hvji5.Storage;
						...
						if (!Optional_long_has_value.Invoke(&cpp_optional_d6hvji5))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = Cpp_bit_cast_long_long.Invoke(Optional_long_value.Invoke(&cpp_optional_d6hvji5));
						}
					...
					case LengthModifier_mnvaa2.wf:
						if (printf_core_LengthSpec.Bit_width == 0L)
						{
							Agg_result->Has_conv = 0;
						}
						else if ((ulong)printf_core_LengthSpec.Bit_width <= 32uL)
						{
							Llvm_lifetime_start_p0.Invoke(8L, &cpp_optional_g66fk5);
							sbyte* ptr21 = (sbyte*)(&cpp_optional_g66fk5);
							...
							*(long*)(&cpp_optional_g66fk5.Storage) = storage6;
							...
							{
								Agg_result->Conv_val_raw = Cpp_bit_cast_int_int.Invoke(Optional_int_value.Invoke(&cpp_optional_g66fk5));
							}
							Llvm_lifetime_end_p0.Invoke(8L, &cpp_optional_g66fk5);
						}
						else if ((ulong)printf_core_LengthSpec.Bit_width <= 64uL)
						{
							Llvm_lifetime_start_p0.Invoke(16L, &cpp_optional_d6hvji6);
							sbyte* ptr23 = (sbyte*)(&cpp_optional_d6hvji6);
							...
							*ptr24 = -86;
							...
							Cpp_expected* ptr25 = &cpp_optional_d6hvji6.Storage;
						...
						else if ((ulong)printf_core_LengthSpec.Bit_width <= 64uL)
						{
							...
							sbyte* ptr26 = (sbyte*)(&cpp_optional_d6hvji7);
							...
							*ptr27 = -86;
							...
							Cpp_expected* ptr28 = &cpp_optional_d6hvji7.Storage;
							...
							if (!Optional_long_long_has_value.Invoke(&cpp_optional_d6hvji7))
							{
								Agg_result->Has_conv = 0;
							}
							else
							{
								Agg_result->Conv_val_raw = Cpp_bit_cast_long_long_long_long.Invoke(Optional_long_long_value.Invoke(&cpp_optional_d6hvji7));
							}
						...
						else
						{
							...
							sbyte* ptr29 = (sbyte*)(&cpp_optional_d6hvji8);
							...
							*ptr30 = -86;
							...
							Cpp_expected* ptr31 = &cpp_optional_d6hvji8.Storage;
							...
							if (!Optional_long_has_value.Invoke(&cpp_optional_d6hvji8))
							{
								Agg_result->Has_conv = 0;
							}
							else
							{
								Agg_result->Conv_val_raw = Cpp_bit_cast_long_long.Invoke(Optional_long_value.Invoke(&cpp_optional_d6hvji8));
							}
				...
				case 103:
				{
					if (printf_core_LengthSpec.Lm != LengthModifier_mnvaa2.L)
					{
						Llvm_lifetime_start_p0.Invoke(16L, &cpp_optional_vhbvq);
						sbyte* ptr49 = (sbyte*)(&cpp_optional_vhbvq);
						...
						*ptr50 = -86;
						...
						Cpp_optional_double_OptionalStorage* ptr51 = &cpp_optional_vhbvq.Storage;
						...
						if (!Optional_double_has_value.Invoke(&cpp_optional_vhbvq))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = (Int128)(UInt128)(ulong)Cpp_bit_cast_unsigned_long_double.Invoke(Optional_double_value.Invoke(&cpp_optional_vhbvq));
						}
						Llvm_lifetime_end_p0.Invoke(16L, &cpp_optional_vhbvq);
						break;
					}
					Llvm_lifetime_start_p0.Invoke(32L, &cpp_optional_59q3zq);
					sbyte* ptr52 = (sbyte*)(&cpp_optional_59q3zq);
					...
					*ptr53 = -86;
					...
					ptr53[13] = -86;
					ptr53[14] = -86;
					Parser_internal_ArgList_get_arg_value_long_double.Invoke(&cpp_optional_59q3zq, This, index);
					if (!Optional_long_double_has_value.Invoke(&cpp_optional_59q3zq))
					{
						Agg_result->Has_conv = 0;
					}
					else
					{
						Struct_fiz2nb struct_fiz2nb7 = Cpp_bit_cast_unsigned_int128_long_double.Invoke(Optional_long_double_value.Invoke(&cpp_optional_59q3zq));
					...
					Llvm_lifetime_end_p0.Invoke(32L, &cpp_optional_59q3zq);
					break;
				}
				case 82:
				case 114:
				{
					...
					sbyte* ptr11 = (sbyte*)(&cpp_optional_g66fk6);
					...
					*(long*)(&cpp_optional_g66fk6.Storage) = storage4;
					if (!Optional_unsigned_int_has_value.Invoke(&cpp_optional_g66fk6))
					{
						Agg_result->Has_conv = 0;
					}
					else
					{
						Agg_result->Conv_val_raw = (Int128)(UInt128)(uint)Cpp_bit_cast_unsigned_int_unsigned_int.Invoke(Optional_unsigned_int_value.Invoke(&cpp_optional_g66fk6));
					}
				...
				case 107:
					if (printf_core_LengthSpec.Lm == LengthModifier_mnvaa2.l)
					{
						...
						sbyte* ptr13 = (sbyte*)(&cpp_optional_d6hvji9);
						...
						*ptr14 = -86;
						...
						Cpp_expected* ptr15 = &cpp_optional_d6hvji9.Storage;
						...
						if (!Optional_unsigned_long_has_value.Invoke(&cpp_optional_d6hvji9))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = (Int128)(UInt128)(ulong)Cpp_bit_cast_unsigned_long_unsigned_long.Invoke(Optional_unsigned_long_value.Invoke(&cpp_optional_d6hvji9));
						}
					...
					else
					{
						...
						sbyte* ptr16 = (sbyte*)(&cpp_optional_g66fk7);
						...
						*(long*)(&cpp_optional_g66fk7.Storage) = storage5;
						if (!Optional_unsigned_int_has_value.Invoke(&cpp_optional_g66fk7))
						{
							Agg_result->Has_conv = 0;
						}
						else
						{
							Agg_result->Conv_val_raw = (Int128)(UInt128)(uint)Cpp_bit_cast_unsigned_int_unsigned_int.Invoke(Optional_unsigned_int_value.Invoke(&cpp_optional_g66fk7));
						}
				...
				case 112:
				{
					...
					sbyte* ptr18 = (sbyte*)(&cpp_optional_77yu8f);
					...
					*ptr19 = -86;
					...
					Cpp_optional_char_OptionalStorage* ptr20 = &cpp_optional_77yu8f.Storage;
					...
					if (!Optional_void_has_value.Invoke(&cpp_optional_77yu8f))
					{
						Agg_result->Has_conv = 0;
					}
					else
					{
						Agg_result->Conv_val_ptr = Cpp_bit_cast_void_void.Invoke(Optional_void_value.Invoke(&cpp_optional_77yu8f));
					}
				...
				case 115:
				{
					...
					sbyte* ptr6 = (sbyte*)(&cpp_optional_77yu8f2);
					...
					*ptr7 = -86;
					...
					Cpp_optional_char_OptionalStorage* ptr8 = &cpp_optional_77yu8f2.Storage;
					...
					if (!Optional_char_has_value.Invoke(&cpp_optional_77yu8f2))
					{
						Agg_result->Has_conv = 0;
					}
					else
					{
						Agg_result->Conv_val_ptr = Cpp_bit_cast_char_char.Invoke(Optional_char_value.Invoke(&cpp_optional_77yu8f2));
					}
				...
				Llvm_lifetime_end_p0.Invoke(16L, &printf_core_LengthSpec);
				Llvm_lifetime_end_p0.Invoke(8L, &index);
			}
			else
			{
