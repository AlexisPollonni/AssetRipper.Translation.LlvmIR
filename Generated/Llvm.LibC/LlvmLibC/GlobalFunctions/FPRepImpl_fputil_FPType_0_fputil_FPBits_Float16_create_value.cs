...
internal static partial class FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_create_value
{
	...
	public unsafe static short Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign, [NativeType("unsigned short")] short biased_exp, [NativeType("unsigned short")] short mantissa)
	{
		...
		BiasedExponent_Constructor_wry333.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2, unchecked((ushort)biased_exp));
		Significand_Constructor_n44wpn.Invoke(&fputil_internal_FPRepSem_i7nz4h2, parameter_);
