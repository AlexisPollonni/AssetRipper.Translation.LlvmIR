		...
		*unchecked((short*)(&fputil_FPBits_2fahva2)) = -21846;
		...
		else
		{
			...
			else
			{
				...
				mantVal = unchecked((short)((ushort)fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa_const.Invoke(&fputil_FPBits_2fahva2) >> num2 << num2));
				fputil_internal_FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa_unsigned_short.Invoke(&fputil_FPBits_2fahva2, mantVal);
