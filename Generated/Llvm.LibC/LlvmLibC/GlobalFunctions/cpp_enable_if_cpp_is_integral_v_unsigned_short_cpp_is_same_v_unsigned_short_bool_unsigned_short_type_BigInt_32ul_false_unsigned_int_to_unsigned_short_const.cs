...
internal static partial class cpp_enable_if_cpp_is_integral_v_unsigned_short_cpp_is_same_v_unsigned_short_bool_unsigned_short_type_BigInt_32ul_false_unsigned_int_to_unsigned_short_const
{
	public unsafe static short Invoke(BigInt_fzjdu3* @this)
	{
		long num = 0L;
		short num2 = 0;
		...
		num2 = unchecked((short)(*(int*)cpp_array_unsigned_int_1ul_operator_unsigned_long_const.Invoke(&@this->val, 0L)));
		short result = num2;
