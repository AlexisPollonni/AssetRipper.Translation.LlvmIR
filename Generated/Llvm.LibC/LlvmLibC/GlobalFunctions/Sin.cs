			...
			else
			{
				...
				*(long*)ptr8 = -6148914691236517206L;
				...
				if (Details_expects_bool_condition_bool.Invoke((ushort)num < 1039, Expected: true))
				{
					...
					Range_reduction_small_f128_qk37py.Invoke(&fputil_DyadicFloat_kt2kd4, X);
				...
				*(long*)ptr10 = -6148914691236517206L;
				...
				_0_Invoke_9jj3hx.Invoke(&fputil_DyadicFloat_kt2kd6, &anon_izyfb6, num2);
				...
				*(long*)ptr12 = -6148914691236517206L;
				...
				_0_Invoke_9jj3hx.Invoke(&fputil_DyadicFloat_kt2kd7, &anon_izyfb6, num2 + 64);
				...
				*(long*)ptr14 = -6148914691236517206L;
				...
				Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd9, &fputil_DyadicFloat_kt2kd6, &fputil_DyadicFloat_kt2kd3);
				Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd10, &fputil_DyadicFloat_kt2kd7, &fputil_DyadicFloat_kt2kd2);
