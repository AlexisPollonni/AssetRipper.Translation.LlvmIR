...
internal static partial class BigInt_32ul_false_unsigned_int_BigInt_unsigned_int_void
{
	...
	public unsafe static void Invoke([MangledName("this")] BigInt_vtm4cw* This, [MangledName("v")][NativeType("unsigned int")] int V)
	{
		long num = 0L;
		sbyte b = 0;
		long num2 = 0L;
