...
internal static partial class cpp_optional_void_printf_core_Parser_internal_ArgList_get_arg_value_void_unsigned_long
{
	public unsafe static Struct_yx4nca Invoke(void* @this, long index)
	{
		...
		unchecked
		{
			if (index != 0L && index != ((printf_core_Parser*)@this)->args_index)
			{
				...
				if ((b & 1) != 1)
				{
					...
					cpp_optional_void_optional.Invoke(&cpp_optional_e5s7qx2);
					num = 1;
				}
				else
				{
			...
			*(short*)(&printf_core_TypeDesc2) = printf_core_TypeDesc_printf_core_type_desc_from_type_void_i6v7xh.Invoke();
			...
			ptr = void_printf_core_Parser_internal_ArgList_get_next_arg_value_void.Invoke(@this);
			cpp_optional_void_optional_void.Invoke(&cpp_optional_e5s7qx2, &ptr);
