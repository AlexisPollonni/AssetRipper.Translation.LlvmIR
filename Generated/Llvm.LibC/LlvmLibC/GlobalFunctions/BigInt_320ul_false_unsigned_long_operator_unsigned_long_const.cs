...
{
	public unsafe static void Invoke([MangledName("agg.result")] BigInt_76gxx6* agg_result, void* @this, long s)
	{
		...
		llvm_memcpy_p0_p0_i64.Invoke(&cpp_array_v97b5b3, &unchecked((BigInt_76gxx6*)@this)->val, 40L, isVolatile: false);
