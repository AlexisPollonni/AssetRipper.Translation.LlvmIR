...
internal static partial class erff
{
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			...
			long num12 = num8;
			z = fputil_multiply_add_double_double_double.Invoke(x3, y4, *(double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num12 * sizeof(InlineArray8_Double)));
			llvm_lifetime_start_p0.Invoke(8L, &y);
			double x4 = num6;
			long num13 = num8;
			double y5 = ((double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num13 * sizeof(InlineArray8_Double)))[3L];
			long num14 = num8;
			y = fputil_multiply_add_double_double_double.Invoke(x4, y5, ((double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num14 * sizeof(InlineArray8_Double)))[2L]);
			llvm_lifetime_start_p0.Invoke(8L, &z2);
			double x5 = num6;
			long num15 = num8;
			double y6 = ((double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num15 * sizeof(InlineArray8_Double)))[5L];
			long num16 = num8;
			z2 = fputil_multiply_add_double_double_double.Invoke(x5, y6, ((double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num16 * sizeof(InlineArray8_Double)))[4L]);
			llvm_lifetime_start_p0.Invoke(8L, &y2);
			double x6 = num6;
			long num17 = num8;
			double y7 = ((double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num17 * sizeof(InlineArray8_Double)))[7L];
			long num18 = num8;
			y2 = fputil_multiply_add_double_double_double.Invoke(x6, y7, ((double*)((byte*)COEFFS_jd9ei8.Pointer + (nint)num18 * sizeof(InlineArray8_Double)))[6L]);
			llvm_lifetime_start_p0.Invoke(8L, &x2);
			x2 = num9 * num9;
			llvm_lifetime_start_p0.Invoke(8L, &z3);
			z3 = fputil_multiply_add_double_double_double.Invoke(num9, y, z);
			llvm_lifetime_start_p0.Invoke(8L, &y3);
			y3 = fputil_multiply_add_double_double_double.Invoke(num9, y2, z2);
			result = (float)(num5 * fputil_multiply_add_double_double_double.Invoke(x2, y3, z3));
