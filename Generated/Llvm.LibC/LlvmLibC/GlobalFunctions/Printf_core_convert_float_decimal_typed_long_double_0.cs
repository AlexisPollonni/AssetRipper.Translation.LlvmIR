	...
	public unsafe static int Invoke([MangledName("writer")] Llvm_libc_20_1_2_printf_core_Writer* Writer, [MangledName("to_conv")][NativeType("__llvm_libc_20_1_2_::printf_core::Writer*")] Llvm_libc_20_1_2_printf_core_FormatSection* To_conv, [MangledName("float_bits.coerce0")][NativeType("__llvm_libc_20_1_2_::printf_core::FormatSection const&")] long Float_bits, [MangledName("float_bits.coerce1")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<long double>")] long FRACTION_LEN)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			num4 = FloatToString_long_double_0_get_positive_blocks.Invoke(&llvm_libc_20_1_2_FloatToString_8m29tk);
		...
		unchecked
		{
			while (true)
			{
				...
				num6 = FloatToString_long_double_0_get_positive_block.Invoke(&llvm_libc_20_1_2_FloatToString_8m29tk, num5);
				if ((b2 & 1) == 1)
				{
			...
			if (num2 < 63)
			{
				...
				num10 = 0;
				if ((ulong)(uint)num9 <= (ulong)FloatToString_long_double_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_8m29tk))
				{
					num10 = num9;
				...
				{
					num10 = (int)FloatToString_long_double_0_zero_blocks_after_point.Invoke(&llvm_libc_20_1_2_FloatToString_8m29tk);
				...
				while (true)
				{
					...
					{
						if (FloatToString_long_double_0_is_lowest_block.Invoke(&llvm_libc_20_1_2_FloatToString_8m29tk, (uint)num10))
						{
						...
						else
						{
							...
							num14 = FloatToString_long_double_0_get_negative_block.Invoke(&llvm_libc_20_1_2_FloatToString_8m29tk, num10);
