	...
	public unsafe static int Invoke([MangledName("cx")][NativeType("long double&")] void* Cx, [MangledName("x")][NativeType("long double const&")] void* X)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			b = (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit.Invoke(&fputil_FPBits_ubgsi) ? ((sbyte)1) : ((sbyte)0));
			...
			*(long*)num3 = struct_fiz2nb3.field_1;
			...
			num = (ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi);
			if (num == 32767)
			{
				if ((b & 1) != 1 && (b2 & 1) != 1)
				{
					if (NumericHelper.IntCmpEq(@int, 0L))
					{
						...
						*(double*)Cx = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi2);
					...
					else
					{
						...
						*(double*)Cx = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3);
				...
				{
					if (!Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_signaling_nan.Invoke(&fputil_FPBits_ubgsi), Expected: false))
					{
						*(double*)Cx = *(double*)X;
						goto IL_07ca;
					}
					...
					Struct_fiz2nb struct_fiz2nb13 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi);
					Int128* num5 = &int6;
			...
			else
			{
				...
				else
				{
					...
					anon_izyfb6.Val = FPStorage_fputil_FPType_4_sign.Invoke(&fputil_FPBits_ubgsi);
					Struct_fiz2nb struct_fiz2nb25 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa.Invoke(&fputil_FPBits_ubgsi);
					Int128* num7 = &int10;
					...
					*(long*)num8 = struct_fiz2nb27.field_1;
					...
					Int128* ptr7 = &fputil_FPBits_ubgsi8.Val.Data.FPStorage.field_0;
