	...
	public unsafe static long Invoke(void* @this, [NativeType("unsigned int")] int x_abs, [NativeType("bool")] bool sign)
	{
		...
		unchecked
		{
			...
			while (true)
			{
				...
				if (details_expects_bool_condition_bool.Invoke(x_abs == ((fputil_ExceptValues_float_6_Mapping*)(&((fputil_ExceptValues_v8stj6*)@this)->values))[num].input, expected: false))
				{
