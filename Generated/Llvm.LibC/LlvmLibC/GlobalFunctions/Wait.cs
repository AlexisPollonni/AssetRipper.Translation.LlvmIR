	...
	public unsafe static int Invoke([MangledName("wait_status")] void* Wait_status)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			ptr[1] = -86;
			ptr[2] = -86;
			*(InlineArray5_Byte*)(&llvm_libc_20_1_2_cpp_optional_int_OptionalStorage) = NumericHelper.TruncOrZextToBytes<long, InlineArray5_Byte>(Internal_wait4impl.Invoke(-1, Wait_status, 0, null));
			int result;
