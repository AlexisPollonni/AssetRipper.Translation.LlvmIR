...
internal static partial class BigInt_64ul_false_unsigned_long_is_zero
{
	...
	public unsafe static bool Invoke([MangledName("this")] Llvm_libc_20_1_2_BigInt_555ggs* This)
	{
		bool result = false;
		void* ptr = null;
		void* ptr2 = null;
		...
		unchecked
		{
			...
			ptr2 = Array_unsigned_long_1ul_begin.Invoke((Llvm_libc_20_1_2_cpp_array_rpgxvv*)ptr);
			Llvm_lifetime_start_p0.Invoke(8L, &ptr3);
			ptr3 = Array_unsigned_long_1ul_end.Invoke((Llvm_libc_20_1_2_cpp_array_rpgxvv*)ptr);
			int num2;
			while (true)
			{
				if (ptr2 == ptr3)
