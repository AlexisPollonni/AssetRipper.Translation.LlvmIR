...
{
	public unsafe static void Invoke(cpp_optional_pjf72b* @this)
	{
		cpp_optional_cpp_array_char_265ul_OptionalStorage_cpp_array_char_265ul_false_OptionalStorage.Invoke(&@this->storage);
	}
}
