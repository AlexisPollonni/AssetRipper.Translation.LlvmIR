	...
	public unsafe static Struct_4ydhja Invoke(NumberPair* a, NumberPair* b)
	{
		...
		unchecked
		{
			...
			*(double*)(&numberPair2) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = NumberPair_double_fputil_exact_mult_27ul_double_double.Invoke(b->hi, 0.0 - numberPair.hi);
			...
			*(double*)(&numberPair3) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja4 = NumberPair_double_fputil_exact_mult_27ul_double_double.Invoke(b->lo, 0.0 - numberPair.hi);
