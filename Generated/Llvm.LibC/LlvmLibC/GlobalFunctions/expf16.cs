	...
	public unsafe static Half Invoke(Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			else if (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) && (uint)(ushort)num2 >= 18944u)
			{
			...
			{
				if ((uint)(ushort)num2 > 10240u || FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2)))
				{
					goto IL_05f1;
				}
				...
				*(int*)(&cpp_optional_aq7wey2.storage) = storage;
				...
				case 0:
					...
					x2 = (float)x;
					result = fputil_cast_Float16_float.Invoke(fputil_polyeval_float_float_float_float.Invoke(x2, 1f, 1f, 0.5000305f, 0.16667074f));
