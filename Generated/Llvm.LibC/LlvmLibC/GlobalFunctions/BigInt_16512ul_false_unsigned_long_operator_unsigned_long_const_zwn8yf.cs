...
{
	public unsafe static void Invoke([MangledName("agg.result")] BigInt_k36xhe* agg_result, void* @this, long s)
	{
		...
		llvm_memcpy_p0_p0_i64.Invoke(&cpp_array_vnnqx10, &unchecked((BigInt_k36xhe*)@this)->val, 2064L, isVolatile: false);
