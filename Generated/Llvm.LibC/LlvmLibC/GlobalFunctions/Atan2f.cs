	...
	public unsafe static float Invoke([MangledName("y")] float Y, [MangledName("x")] float X)
	{
		...
		unchecked
		{
			...
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			FPStorage_fputil_FPType_1_set_sign.Invoke(&fputil_FPBits_5nkvcs, anon_izyfb3.Val);
			Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb4, Sign_POS.Pointer, 1L, isVolatile: false);
			FPStorage_fputil_FPType_1_set_sign.Invoke(&fputil_FPBits_5nkvcs2, anon_izyfb4.Val);
			Llvm_lifetime_start_p0.Invoke(4L, &num6);
			num6 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs));
			Llvm_lifetime_start_p0.Invoke(4L, &num7);
			num7 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2));
			...
			FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs3, x);
			float num30 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs3);
			Llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs3);
			num9 = num30;
			Llvm_lifetime_start_p0.Invoke(4L, &num10);
			Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs4);
			FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs4, num8);
			float num31 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs4);
			...
			else
			{
				...
				*(double*)(&numberPair) = double.NaN;
				...
				long num33 = num21;
				num22 = num32 * Fputil_multiply_add_double.Invoke(x2, y, hi + *(double*)((byte*)ATAN_COEFFS.Pointer + (nint)num33 * sizeof(InlineArray9_Double)));
