...
internal static partial class DyadicFloat_128ul_fast_as_float128_true_void
{
		...
		unchecked
		{
			...
			else
			{
				...
				if (Details_expects_bool_condition_bool.Invoke(num2 > 32766, Expected: false))
				{
					...
					int3 = 0L;
					Struct_fiz2nb struct_fiz2nb4 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val, biased_exp, mantissa, *(long*)(&int3), ((long*)(&int3))[1]);
					...
					double num18 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi2);
					...
					FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi3, num5);
					bool num19 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
				...
				else
				{
					...
					*(long*)num21 = struct_fiz2nb12.field_1;
					...
					int5 = int17;
					Struct_fiz2nb struct_fiz2nb13 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val2, biased_exp2, mantissa2, *(long*)(&int5), ((long*)(&int5))[1]);
					Int128* ptr5 = &fputil_FPBits_ubgsi4.Val.Data.FPStorage.field_0;
					...
					double num22 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi4);
					...
					*(long*)ptr6 = -6148914691236517206L;
					...
					else
					{
						...
						Struct_fiz2nb struct_fiz2nb16 = BigInt_128ul_false_unsigned_long_LeftShift.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh3), (uint)(num6 - 1));
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb19 = BigInt_128ul_false_unsigned_long_Subtract_gydwfz.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh2), (Anon_izyfb7*)(&bigInt_qdkjbh5));
					...
					Struct_fiz2nb struct_fiz2nb22 = BitwiseAnd.Invoke((Anon_izyfb7*)(&This->Mantissa), (Anon_izyfb7*)(&bigInt_qdkjbh2));
					...
					bool num24 = InstructionHelper.BooleanXor(BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh6)), right: true);
					...
					Struct_fiz2nb struct_fiz2nb25 = BitwiseAnd.Invoke((Anon_izyfb7*)(&This->Mantissa), (Anon_izyfb7*)(&bigInt_qdkjbh4));
					...
					bool num25 = InstructionHelper.BooleanXor(BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh7)), right: true);
					...
					if (Details_expects_bool_condition_bool.Invoke(num7 <= 0, Expected: false))
					{
						...
						int7 = 0L;
						Struct_fiz2nb struct_fiz2nb28 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val3, biased_exp3, mantissa3, *(long*)(&int7), ((long*)(&int7))[1]);
						Int128* ptr12 = &fputil_FPBits_ubgsi5.Val.Data.FPStorage.field_0;
						...
						double num26 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi5);
						...
						int9 = 0L;
						Struct_fiz2nb struct_fiz2nb31 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val4, biased_exp4, mantissa4, *(long*)(&int9), ((long*)(&int9))[1]);
						Int128* ptr13 = &fputil_FPBits_ubgsi6.Val.Data.FPStorage.field_0;
						...
						double num27 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi6);
						...
						int11 = 0L;
						Struct_fiz2nb struct_fiz2nb34 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val5, biased_exp5, mantissa5, *(long*)(&int11), ((long*)(&int11))[1]);
						Int128* ptr14 = &fputil_FPBits_ubgsi7.Val.Data.FPStorage.field_0;
						...
						num10 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi7);
						...
						num15 = num8 * num12;
						result = Fputil_multiply_add_float128.Invoke(&num10, &num14, &num15) * num13;
					...
					else
					{
						...
						int13 = 0L;
						Struct_fiz2nb struct_fiz2nb37 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_create_value.Invoke(val6, biased_exp6, mantissa6, *(long*)(&int13), ((long*)(&int13))[1]);
						Int128* ptr15 = &fputil_FPBits_ubgsi8.Val.Data.FPStorage.field_0;
						...
						num10 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi8);
						...
						num17 = num9;
						double num28 = Fputil_multiply_add_float128.Invoke(&num10, &num17, &num8);
						...
						if (Details_expects_bool_condition_bool.Invoke((b & 1) == 1, Expected: false))
						{
							...
							FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi9, num16);
							Struct_fiz2nb struct_fiz2nb40 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval.Invoke(&fputil_FPBits_ubgsi9);
							Int128* num29 = &x2;
							...
							*(long*)num30 = struct_fiz2nb42.field_1;
							...
							int15 = int14;
							FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi10, *(long*)(&int15), ((long*)(&int15))[1]);
							result = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi10);
