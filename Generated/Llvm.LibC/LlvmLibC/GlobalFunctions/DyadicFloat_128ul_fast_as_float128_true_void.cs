		...
		unchecked
		{
			...
			else
			{
				...
				if (details_expects_bool_condition_bool.Invoke(num2 > 32766, expected: false))
				{
					...
					double num18 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi4);
					...
					FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi5, num5);
					bool num19 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi5));
				...
				else
				{
					...
					*(long*)num21 = struct_fiz2nb12.field_1;
					...
					double num22 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi6);
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					int num24 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((anon_izyfb7*)(&bigInt_qdkjbh6)) ? 1 : 0) ^ -1;
					...
					int num25 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((anon_izyfb7*)(&bigInt_qdkjbh7)) ? 1 : 0) ^ -1;
					...
					if (details_expects_bool_condition_bool.Invoke(num7 <= 0, expected: false))
					{
						...
						double num26 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi7);
						...
						double num27 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi8);
						...
						num10 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi9);
					...
					else
					{
						...
						num10 = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi10);
						...
						if (details_expects_bool_condition_bool.Invoke((b & 1) == 1, expected: false))
						{
							...
							FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi11, num16);
							Struct_fiz2nb struct_fiz2nb40 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval.Invoke(&fputil_FPBits_ubgsi11);
							Int128* num29 = &x2;
							...
							*(long*)num30 = struct_fiz2nb42.field_1;
							...
							int15 = int14;
							FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi12, *(long*)(&int15), ((long*)(&int15))[1]);
							result = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi12);
