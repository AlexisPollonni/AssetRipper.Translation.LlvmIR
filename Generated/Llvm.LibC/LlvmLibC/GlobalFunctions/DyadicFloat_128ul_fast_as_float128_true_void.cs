		...
		unchecked
		{
			...
			else
			{
				...
				if (Details_expects_bool_condition_bool.Invoke(num2 > 32766, Expected: false))
				{
					...
					double num18 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
					...
					FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3, num5);
					bool num19 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3));
				...
				else
				{
					...
					*(long*)num21 = struct_fiz2nb12.field_1;
					...
					double num22 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4);
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					if (Details_expects_bool_condition_bool.Invoke(num7 <= 0, Expected: false))
					{
						...
						double num26 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5);
						...
						double num27 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6);
						...
						num10 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi7);
					...
					else
					{
						...
						num10 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi8);
						...
						if (Details_expects_bool_condition_bool.Invoke((b & 1) == 1, Expected: false))
						{
							...
							FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi9, num16);
							Struct_fiz2nb struct_fiz2nb40 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_uintval.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi9);
							Int128* num29 = &x2;
							...
							*(long*)num30 = struct_fiz2nb42.field_1;
							...
							int15 = int14;
							FPBits_float128_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi10, *(long*)(&int15), ((long*)(&int15))[1]);
							result = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi10);
