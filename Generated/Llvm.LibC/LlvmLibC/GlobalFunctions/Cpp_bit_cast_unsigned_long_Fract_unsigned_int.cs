...
internal static partial class Cpp_bit_cast_unsigned_long_Fract_unsigned_int
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (unsigned long _Fract) == sizeof (unsigned int) && cpp::is_trivially_constructible<unsigned long _Fract>::value && cpp::is_trivially_copyable<unsigned long _Fract>::value && cpp::is_trivially_copyable<unsigned int>::value, unsigned long _Fract>::type")]
