...
{
	public unsafe static int Invoke(BigInt_fzjdu3* value)
	{
		return int_multiword_countl_zero_unsigned_int_1ul_cpp_array_unsigned_int_1ul_const.Invoke(&value->val);
	}
}
