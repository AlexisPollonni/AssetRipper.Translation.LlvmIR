	...
	public unsafe static bool Invoke([MangledName("x")][NativeType("_Float16")] Half X, [MangledName("y")][NativeType("_Float16")] Half Y)
	{
		...
		unchecked
		{
			...
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva2) = -21846;
			...
			num2 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva2));
