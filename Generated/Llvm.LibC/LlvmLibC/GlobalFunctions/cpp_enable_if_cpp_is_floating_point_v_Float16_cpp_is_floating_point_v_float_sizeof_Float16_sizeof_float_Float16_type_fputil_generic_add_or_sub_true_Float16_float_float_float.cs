		...
		unchecked
		{
			...
			else
			{
				...
				*(int*)(&fputil_FPBits_5nkvcs7) = -1431655766;
				...
				checked
				{
					num16 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_exponent_const.Invoke(unchecked((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs6))) - 26;
				...
				*ptr = -86;
				...
				int e = num16;
				BigInt_32ul_false_unsigned_int_BigInt_unsigned_int_void_unsigned_int.Invoke(&bigInt_vtm4cw, num10);
