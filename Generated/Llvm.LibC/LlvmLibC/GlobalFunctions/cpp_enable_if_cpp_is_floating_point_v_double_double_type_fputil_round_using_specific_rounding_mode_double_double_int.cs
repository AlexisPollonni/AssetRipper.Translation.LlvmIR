			...
			else
			{
				...
				else if (num <= -1)
				{
					result = rnd switch
					{
						...
						_ => (num > -2 && fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) != 0L) ? InstructionHelper.Select((b & 1) == 1, -1.0, 1.0) : InstructionHelper.Select((b & 1) == 1, -0.0, 0.0), 
					};
				}
				else
				{
					...
					else
					{
						...
						*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
						...
						num6 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) & ((1L << (int)(uint)num2) - 1L);
						llvm_lifetime_start_p0.Invoke(8L, &num7);
						num7 = 1L << (int)(uint)(num2 - 1);
						llvm_lifetime_start_p0.Invoke(8L, &num8);
						num8 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3)) & (1L << (int)(uint)num2);
						result = rnd switch
						{
