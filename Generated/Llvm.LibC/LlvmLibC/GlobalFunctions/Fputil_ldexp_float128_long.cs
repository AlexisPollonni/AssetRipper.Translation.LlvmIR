...
internal static partial class Fputil_ldexp_float128_long
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<__float128> && cpp::is_integral_v<long>, __float128>::type")]
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("exp")][NativeType("long")] long Exp)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			if (Details_expects_bool_condition_bool.Invoke(Exp == 0L || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)) || FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan.Invoke(&fputil_FPBits_ubgsi), Expected: false))
			{
				result = X;
				goto IL_0675;
			}
			...
			num = 32880;
			if (Details_expects_bool_condition_bool.Invoke(Exp > 32880L, Expected: false))
			{
		...
		result = DyadicFloat_128ul_as_float128_true_void.Invoke(&fputil_DyadicFloat_kt2kd);
