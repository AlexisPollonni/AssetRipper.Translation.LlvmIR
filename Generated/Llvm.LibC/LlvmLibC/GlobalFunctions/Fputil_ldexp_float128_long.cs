	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("exp")][NativeType("long")] long Exp)
	{
		...
		unchecked
		{
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			if (Details_expects_bool_condition_bool.Invoke((Exp == 0L) ? true : ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi))) ? FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_is_inf_or_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) : true), Expected: false))
			{
				result = X;
				goto IL_0675;
			}
		...
		llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd.Exponent += unchecked((int)Exp);
