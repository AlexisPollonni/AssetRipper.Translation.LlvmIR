...
internal static partial class FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_uintval
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq* This, [MangledName("value")][NativeType("unsigned long")] long Value)
	{
		unchecked((Llvm_libc_20_1_2_fputil_internal_FPStorage_v3nexn*)This)->Val = Value & -1L;
	}
}
