	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			int num9 = (internal_Equals_9g7dhj.Invoke(fputil_internal_FPRepImpl_7z3gh10.FPRepSem.FPStorage.field_0, fputil_internal_FPRepImpl_7z3gh11.FPRepSem.FPStorage.field_0) ? (-1) : ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2))) ? (FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_nan.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2)) ? 1 : 0) : (-1)));
			...
			else if (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)))
			{
				result = default(Half);
			}
			else
			{
				...
				num2 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_exponent.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2));
				llvm_lifetime_start_p0.Invoke(2L, &num3);
				num3 = FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_get_mantissa.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2));
				...
				*ptr2 = -86;
				...
				DyadicFloat_16ul_Constructor.Invoke(&fputil_DyadicFloat_jvghxm2, anon_izyfb9.val, e, *(short*)(&bigInt_ys7s.val.Data));
