			...
			if ((b3 & 1) == 1)
			{
				...
				else
				{
					...
					*(int*)ptr2 = -1431655766;
					...
					struct_3driym = internal_FloatConvertReturn_float_internal_binary_exp_to_float_float_internal_ExpandedFloat_float_bool_internal_RoundDirection.Invoke(truncated: (b2 & 1) == 1, init_num: *(long*)(&internal_ExpandedFloat_i7t5up3), round: round);
