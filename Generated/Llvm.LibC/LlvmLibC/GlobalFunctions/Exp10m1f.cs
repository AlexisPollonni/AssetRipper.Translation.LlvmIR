	...
	public unsafe static float Invoke([MangledName("x")] float X)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			num2 = num & 0x7FFFFFFF;
			if (Details_expects_bool_condition_bool.Invoke(FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_pos.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) && (uint)num >= 1109008539u, Expected: false))
			{
				if (FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_finite.Invoke(&fputil_FPBits_5nkvcs))
				{
		...
		unchecked
		{
			sbyte* ptr3 = (sbyte*)(&cpp_optional_xmxtsi2);
			...
			*(long*)(&cpp_optional_xmxtsi2.Storage) = storage2;
			int num9;
			...
			case 0:
			{
				...
				*(double*)num12 = struct_4ydhja3.field_1;
				...
				x2 = numberPair.Hi * numberPair.Hi;
				...
				result = (float)Fputil_multiply_add_double.Invoke(x3, numberPair.Lo, -1.0);
