...
internal static partial class FPStorage_fputil_FPType_3_set_biased_exponent
{
	...
	public unsafe static void Invoke(void* @this, [MangledName("biased.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)3>::BiasedExponent")] int biased)
	{
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb = FPStorage_fputil_FPType_3_encode.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent3.field_0.field_0);
			Int128* num = &@int;
