...
internal static partial class FPStorage_fputil_FPType_3_set_biased_exponent
{
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("biased.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)3>::BiasedExponent")] int Biased)
	{
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb = FPStorage_fputil_FPType_3_encode.Invoke(llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0);
			Int128* num = &@int;
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			...
			Int128 int5 = 0L;
			Struct_fiz2nb struct_fiz2nb4 = FPStorage_fputil_FPType_3_merge.Invoke(a, b, mask, b_coerce, *(long*)(&int5), ((long*)(&int5))[1]);
			Int128* num3 = &field_;
