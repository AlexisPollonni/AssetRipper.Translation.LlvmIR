...
internal static partial class Printf
{
	...
	public unsafe static int Invoke([MangledName("format")] void* Format, ReadOnlySpan<nint> args)
	{
		...
		unchecked
		{
			...
			*(IntPtr*)((byte*)ptr2 + 16) = unchecked((nint)(-6148914691236517206L));
			...
			num = Printf_core_vfprintf_internal.Invoke(Stdout.Value, Format, &llvm_libc_20_1_2_internal_ArgList);
			int result = num;
