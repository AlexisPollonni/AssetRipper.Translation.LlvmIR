...
[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE2ENS0_6FPBitsIdEEE4zeroENS_4SignE")]
[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)2, __llvm_libc_20_1_2_::fputil::FPBits<double>>::zero(__llvm_libc_20_1_2_::Sign)")]
internal static partial class fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_zero_Sign
{
	public unsafe static long Invoke([MangledName("sign.coerce")] sbyte sign)
	{
		...
		int field_ = fputil_internal_FPStorage_fputil_FPType_2_Exponent_subnormal.Invoke();
