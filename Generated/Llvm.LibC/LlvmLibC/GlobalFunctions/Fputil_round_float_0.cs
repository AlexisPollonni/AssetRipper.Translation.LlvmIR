			...
			*(int*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) = -1431655766;
			...
			else
			{
				...
				else
				{
					...
					b = (((FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)) & (1 << num2 - 1)) != 0) ? ((sbyte)1) : ((sbyte)0));
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs))) ? (num5 + 1f) : (num5 - 1f)) : num5);
