			...
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			else
			{
				...
				else if (num == -1)
				{
					...
					int field_ = FPRepSem_fputil_FPType_1_fputil_FPBits_float_one.Invoke(anon_izyfb.Val);
				...
				else
				{
					...
					b = (((FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) & (1 << num2 - 1)) != 0) ? ((sbyte)1) : ((sbyte)0));
					...
					{
						FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs), num4);
						Llvm_lifetime_start_p0.Invoke(4L, &num5);
						num5 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs);
						result = (((b & 1) == 1) ? ((!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_neg.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs))) ? (num5 + 1f) : (num5 - 1f)) : num5);
