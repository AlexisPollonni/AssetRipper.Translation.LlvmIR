	...
	public unsafe static double Invoke([NativeType("double")] double x)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			{
				result = ((!FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_inf.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2))) ? ((!FPRepSem_fputil_FPType_2_fputil_FPBits_double_is_nan.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2))) ? fputil_round_result_slightly_up_double.Invoke(-1.0) : x) : (-1.0));
			}
			else
			{
				if ((ulong)num < 9218868437227405312uL)
				{
					...
					if (num3 == 1024 || num3 == 3072)
					{
						...
						long val2 = FPRepSem_fputil_FPType_2_fputil_FPBits_double_max_normal.Invoke(anon_izyfb8.val);
