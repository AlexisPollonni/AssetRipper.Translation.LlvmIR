	...
	public unsafe static void Invoke(void* @this, [MangledName("bits.coerce0")] long bits, [MangledName("bits.coerce1")] long normalization_shift)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_ubgsi3) = bits;
			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_subnormal.Invoke(&fputil_FPBits_ubgsi3))
			{
			...
			else if (!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit.Invoke(&fputil_FPBits_ubgsi3))
			{
				((fputil_NormalFloat_wqb3ie*)@this)->exponent = 0;
				((fputil_NormalFloat_wqb3ie*)@this)->mantissa = 0L;
			}
			...
			{
				((fputil_NormalFloat_wqb3ie*)@this)->exponent = checked(unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi3)) - 16383);
