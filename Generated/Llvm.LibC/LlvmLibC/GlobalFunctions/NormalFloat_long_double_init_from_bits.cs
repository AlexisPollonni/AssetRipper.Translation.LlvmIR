	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("bits.coerce0")] long Bits, [MangledName("bits.coerce1")] long Normalization_shift)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_ubgsi) = Bits;
			((long*)(&fputil_FPBits_ubgsi))[1] = Normalization_shift;
			...
			else if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_subnormal.Invoke(&fputil_FPBits_ubgsi))
			{
			...
			else if (!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_implicit_bit.Invoke(&fputil_FPBits_ubgsi))
			{
				((Fputil_NormalFloat_wqb3ie*)This)->Exponent = 0;
				((Fputil_NormalFloat_wqb3ie*)This)->Mantissa = 0L;
			}
			...
			{
				((Fputil_NormalFloat_wqb3ie*)This)->Exponent = checked(unchecked((ushort)FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi)) - 16383);
