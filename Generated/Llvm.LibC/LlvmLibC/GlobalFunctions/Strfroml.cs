...
internal static partial class Strfroml
{
	...
	public unsafe static int Invoke([MangledName("s")] void* S, [MangledName("n")] long N, [MangledName("format")] void* Format, [MangledName("fp")] double Fp)
	{
		...
		Internal_parse_format_string_long_double.Invoke(&llvm_libc_20_1_2_printf_core_FormatSection, Format, Fp);
		llvm_libc_20_1_2_printf_core_FormatSection.Length_modifier = LengthModifier_mnvaa2.L;
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			{
				num = Internal_strfromfloat_convert_long_double.Invoke(&llvm_libc_20_1_2_printf_core_Writer, &llvm_libc_20_1_2_printf_core_FormatSection);
			}
			else
			{
