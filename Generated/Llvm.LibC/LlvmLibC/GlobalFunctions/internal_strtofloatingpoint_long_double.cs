...
internal static partial class internal_strtofloatingpoint_long_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_uytq62* agg_result, [NativeType("char const*")] void* src)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			if (b2 == 45)
			{
				...
				FPStorage_fputil_FPType_4_set_sign.Invoke(&fputil_FPBits_ubgsi3, anon_izyfb8.val);
			}
			if (internal_isdigit_u2vjuj.Invoke(((sbyte*)src)[num]) || ((sbyte*)src)[num] == 46)
			{
				...
				StrToNumResult_internal_ExpandedFloat_long_double_Constructor.Invoke(&strToNumResult_ggsbhp, &internal_ExpandedFloat_9jummq2);
				if (num2 == 16)
				{
					llvm_lifetime_start_p0.Invoke(48L, &strToNumResult_ggsbhp2);
					internal_hexadecimal_string_to_float_long_double.Invoke(&strToNumResult_ggsbhp2, (byte*)src + num, 46, (RoundDirection_b3pcwy)num3);
				...
				else
				{
					...
					internal_decimal_string_to_float_long_double.Invoke(&strToNumResult_ggsbhp3, (byte*)src + num, 46, (RoundDirection_b3pcwy)num3);
			...
			else if (internal_tolower_b2645y.Invoke(((sbyte*)src)[num]) == 110)
			{
				if (internal_tolower_b2645y.Invoke(((sbyte*)src)[checked(num + 1L)]) == ((sbyte*)StrToNumResult_long_double_internal_strtofloatingpoint_long_double_char_const_nan_string.Value)[1] && internal_tolower_b2645y.Invoke(((sbyte*)src)[checked(num + 2L)]) == ((sbyte*)StrToNumResult_long_double_internal_strtofloatingpoint_long_double_char_const_nan_string.Value)[2])
				{
					...
					if (((sbyte*)src)[num] == 40)
					{
						...
						{
							num = checked(num + 1L);
							string_view_Constructor.Invoke(&cpp_string_view2, (byte*)src + (num4 + 1L), num - num4 - 2L);
							Struct_fiz2nb struct_fiz2nb = internal_nan_mantissa_from_ncharseq_long_double.Invoke(*(void**)(&cpp_string_view2), ((long*)(&cpp_string_view2))[1]);
							Int128* num5 = &int4;
			...
			else if (internal_tolower_b2645y.Invoke(((sbyte*)src)[num]) == 105 && internal_tolower_b2645y.Invoke(((sbyte*)src)[checked(num + 1L)]) == ((sbyte*)StrToNumResult_long_double_internal_strtofloatingpoint_long_double_char_const_inf_string.Value)[1] && internal_tolower_b2645y.Invoke(((sbyte*)src)[checked(num + 2L)]) == ((sbyte*)StrToNumResult_long_double_internal_strtofloatingpoint_long_double_char_const_inf_string.Value)[2])
			{
				...
				Struct_fiz2nb struct_fiz2nb7 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_inf.Invoke(anon_izyfb10.val);
			...
			{
				internal_set_implicit_bit_long_double.Invoke(&fputil_FPBits_ubgsi3);
				StrToNumResult_long_double_Constructor.Invoke(agg_result, FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi3), num, error);
			}
