...
internal static partial class Statfs_utils_linux_statfs
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Llvm_libc_20_1_2_cpp_optional_qbe95b* Agg_result, [MangledName("path")][NativeType("char const*")] void* Path)
	{
		...
		num = Llvm_libc_20_1_2_syscall_impl_int_char_const_statfs.Invoke(137L, Path, &statfs);
		if (num < 0)
		{
