...
internal static partial class NormalFloat_float_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_NormalFloat_phu2qv* This, [MangledName("bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<float>")] int Bits)
	{
		...
		NormalFloat_float_init_from_bits.Invoke(This, fputil_FPBits_5nkvcs2.FPRepImpl.FPRepSem.field_0.field_0);
	}
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_NormalFloat_phu2qv* This, [MangledName("s.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte S, [MangledName("e")][NativeType("int")] int E, [MangledName("m")][NativeType("unsigned int")] int M)
	{
