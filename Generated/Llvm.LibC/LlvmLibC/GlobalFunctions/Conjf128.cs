...
internal static partial class Conjf128
{
	[MangledName("conjf128")]
	[DemangledName("conjf128")]
	public unsafe static void Invoke([MangledName("agg.result")] Struct_unhbb7* Agg_result, [MangledName("x")] void* X)
	{
		...
		unchecked
		{
			...
			*ptr = field_2;
			Llvm_libc_20_1_2_conjugate_float128_complex.Invoke(&struct_unhbb, &struct_unhbb2);
