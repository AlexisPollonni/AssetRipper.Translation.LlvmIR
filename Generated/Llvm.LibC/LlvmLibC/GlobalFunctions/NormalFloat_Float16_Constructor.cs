...
internal static partial class NormalFloat_Float16_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_NormalFloat_epbrnk* This, [MangledName("bits.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::FPBits<_Float16>")] short Bits)
	{
		...
		NormalFloat_Float16_init_from_bits.Invoke(This, fputil_FPBits_2fahva2.FPRepImpl.FPRepSem.FPStorage.field_0);
	}
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_NormalFloat_epbrnk* This, [MangledName("s.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte S, [MangledName("e")][NativeType("int")] int E, [MangledName("m")][NativeType("unsigned short")] short M)
	{
