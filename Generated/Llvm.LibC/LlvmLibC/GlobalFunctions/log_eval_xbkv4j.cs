	...
	public unsafe static double Invoke([NativeType("double")] double x)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			num2 = (int)(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) >>> 45);
			FPRepImpl_fputil_FPType_2_fputil_FPBits_double_set_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2), FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) & 0x1FFFFFFFFFFFL);
			...
			double num6 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm2) - 1.0;
			long num7 = num2;
			...
			*(double*)(&inlineArray6_Double) = -0.4999999999999998;
			...
			num4 = fputil_polyeval_double_double_double_double.Invoke(x2, num3, a_yc74sk, a_ijazrn, a_889uw);
			llvm_lifetime_start_p0.Invoke(8L, &num5);
			double x3 = num;
			long num8 = num2;
			num5 = fputil_multiply_add_double.Invoke(x3, 0.6931471805599453, ((double*)LOG_F.Pointer)[num8] + num4);
			double result = num5;
