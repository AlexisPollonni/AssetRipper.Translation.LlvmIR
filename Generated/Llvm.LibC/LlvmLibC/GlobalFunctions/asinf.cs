			...
			*(double*)(&inlineArray2_Double) = 1.0;
			...
			if ((uint)num2 < 1057244957u)
			{
				...
				else
				{
					...
					*ptr2 = -86;
					ptr2[1] = -86;
					ptr2[2] = -86;
					long storage = ExceptValues_float_2ul_lookup_odd.Invoke(x_abs: num2, sign: num3 != 0, @this: ASINF_EXCEPTS_LO.Pointer);
					*(long*)(&cpp_optional_xmxtsi2.storage) = storage;
					...
					case 0:
						...
						y = asin_eval_bsihag.Invoke(num6);
						result = (float)fputil_multiply_add_double.Invoke(x2, y, num5);
			...
			else
			{
				...
				*ptr4 = -86;
				ptr4[1] = -86;
				ptr4[2] = -86;
				long storage2 = ExceptValues_float_2ul_lookup_odd.Invoke(x_abs: num2, sign: num3 != 0, @this: ASINF_EXCEPTS_HI.Pointer);
				*(long*)(&cpp_optional_xmxtsi3.storage) = storage2;
				...
				case 0:
					...
					y3 = asin_eval_bsihag.Invoke(num8);
					result = (float)fputil_multiply_add_double.Invoke(x3, y3, z);
