	...
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			num2 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval_const.Invoke(&fputil_FPBits_5nkvcs2) & 0x7FFFFFFF;
				...
				else
				{
					...
					*(long*)(&cpp_optional_89h55j2.storage) = storage;
					...
					case 0:
						...
						y = asin_eval_double.Invoke(num5);
						result = (float)fputil_multiply_add_double_double_double.Invoke(x2, y, num4);
			...
			else
			{
				...
				*(long*)(&cpp_optional_89h55j3.storage) = storage2;
				...
				case 0:
					...
					num6 = Unsafe.As<InlineArray2_Double, double>(ref Unsafe.AddByteOffset(ref inlineArray2_Double, (nint)(uint)num3 * (nint)sizeof(double)));
					llvm_lifetime_start_p0.Invoke(8L, &y2);
					y2 = fputil_FPBits_float_get_val_const.Invoke(&fputil_FPBits_5nkvcs2);
					llvm_lifetime_start_p0.Invoke(8L, &num7);
					num7 = fputil_multiply_add_double_double_double.Invoke(-0.5, y2, 0.5);
					llvm_lifetime_start_p0.Invoke(8L, &num8);
					num8 = num6 * (-2.0 * cpp_enable_if_cpp_is_floating_point_v_double_cpp_is_floating_point_v_double_sizeof_double_sizeof_double_double_type_fputil_sqrt_double_double_double.Invoke(num7));
					llvm_lifetime_start_p0.Invoke(8L, &z);
					z = fputil_multiply_add_double_double_double.Invoke(num6, Math.PI / 2.0, num8);
					llvm_lifetime_start_p0.Invoke(8L, &x3);
					x3 = num8 * num7;
					llvm_lifetime_start_p0.Invoke(8L, &y3);
					y3 = asin_eval_double.Invoke(num7);
					result = (float)fputil_multiply_add_double_double_double.Invoke(x3, y3, z);
