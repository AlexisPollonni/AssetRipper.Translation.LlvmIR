...
internal static partial class fputil_round_using_specific_rounding_mode_double
{
	...
	public unsafe static double Invoke([NativeType("double")] double x, [NativeType("int")] int rnd)
	{
			...
			else
			{
				...
				else if (num <= -1)
				{
					result = rnd switch
					{
						...
						_ => (num > -2 && FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) != 0L) ? InstructionHelper.Select((b & 1) == 1, -1.0, 1.0) : InstructionHelper.Select((b & 1) == 1, -0.0, 0.0), 
					};
				}
				else
				{
					...
					else
					{
						...
						*(long*)(&fputil_FPBits_wjhbrm3) = -6148914691236517206L;
						FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm3, num4);
						llvm_lifetime_start_p0.Invoke(8L, &num5);
						num5 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm3);
						llvm_lifetime_start_p0.Invoke(8L, &num6);
						num6 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2)) & ((1L << (int)(uint)num2) - 1L);
						llvm_lifetime_start_p0.Invoke(8L, &num7);
						num7 = 1L << (int)(uint)(num2 - 1);
						llvm_lifetime_start_p0.Invoke(8L, &num8);
						num8 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm3)) & (1L << (int)(uint)num2);
						result = rnd switch
						{
