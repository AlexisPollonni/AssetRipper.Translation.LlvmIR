...
internal static partial class BigInt_32ul_false_unsigned_int_operator_unsigned_long_const_mny5rw
{
	public unsafe static int Invoke(void* @this, long s)
	{
		...
		unchecked
		{
			llvm_memcpy_p0_p0_i64.Invoke(&cpp_array_aj48id3, &((BigInt_fzjdu3*)@this)->val, 4L, isVolatile: false);
			int data = cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_1_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long.Invoke(*(int*)(&cpp_array_aj48id3.Data), s);
