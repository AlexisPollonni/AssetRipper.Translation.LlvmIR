...
internal static partial class BigInt_32ul_false_unsigned_int_operator_unsigned_long_const_mny5rw
{
	public unsafe static int Invoke(BigInt_vtm4cw* @this, long s)
	{
		...
		unchecked
		{
			int data = cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_1_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long.Invoke(*(int*)(&cpp_array_2v7m9i3.Data), s);
