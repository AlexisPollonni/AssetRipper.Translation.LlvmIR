...
internal static partial class anonymous_namespace_poly_approx_f128_fputil_DyadicFloat_128ul_const
{
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, void* dx)
	{
		...
		llvm_memcpy_p0_p0_i64.Invoke(&inlineArray7_fputil_DyadicFloat_kt2kd, COEFFS_128.Pointer, 168L, isVolatile: false);
		unchecked
		{
			*(sbyte*)agg_result = -86;
