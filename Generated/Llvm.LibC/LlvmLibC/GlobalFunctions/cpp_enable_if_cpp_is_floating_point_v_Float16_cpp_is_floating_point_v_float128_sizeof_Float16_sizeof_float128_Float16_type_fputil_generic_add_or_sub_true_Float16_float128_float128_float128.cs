...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float128_sizeof_Float16_sizeof_float128_Float16_type_fputil_generic_add_or_sub_true_Float16_float128_float128_float128
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				...
				else
				{
					...
					num4 = y;
					num4 = 0.0 - num4;
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float128_Float16_type_fputil_cast_Float16_float128_float128.Invoke(num4);
			...
			else
			{
				...
				num5 = y;
				num5 = 0.0 - num5;
				result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float128_Float16_type_fputil_cast_Float16_float128_float128.Invoke(num5);
