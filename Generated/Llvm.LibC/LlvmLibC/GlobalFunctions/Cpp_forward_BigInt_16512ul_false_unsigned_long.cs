...
internal static partial class Cpp_forward_BigInt_16512ul_false_unsigned_long
{
	...
	public unsafe static BigInt_q8g275* Invoke([MangledName("value")][NativeType("__llvm_libc_20_1_2_::cpp::remove_reference<__llvm_libc_20_1_2_::BigInt<16512ul, false, unsigned long>>::type&")] BigInt_q8g275* Value)
	{
		return Value;
	}
}
