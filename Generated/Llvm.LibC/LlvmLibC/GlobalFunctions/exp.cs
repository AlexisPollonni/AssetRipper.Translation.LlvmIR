	...
	public unsafe static double Invoke(double x)
	{
		...
		unchecked
		{
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			if (details_expects_bool_condition_bool.Invoke(((ulong)num >= 13873137513782915154uL) ? true : (((ulong)num >= 13591863675404156928uL || (ulong)num < 4649454530587146736uL) ? ((ulong)num < 4368491638549381120uL) : true), expected: false))
			{
			...
			*(double*)num25 = struct_4ydhja3.field_1;
			...
			x2 = anonymous_namespace_poly_approx_d_2fncbp.Invoke(num8);
			llvm_lifetime_start_p0.Invoke(8L, &num9);
			num9 = fputil_multiply_add_double.Invoke(x2, y, numberPair3.lo);
			if (details_expects_bool_condition_bool.Invoke((b & 1) == 1, expected: false))
			{
				...
				*ptr2 = -86;
				...
				ptr2[5] = -86;
				ptr2[6] = -86;
				Struct_8myw6y struct_8myw6y = ziv_test_denorm.Invoke(num7, numberPair3.hi, num9, 1.6263032587282567E-19);
				...
				int num26;
				if (details_expects_bool_condition_bool.Invoke(optional_double_has_value.Invoke(&cpp_optional_vhbvq8), expected: true))
				{
					result = *(double*)optional_double_value.Invoke(&cpp_optional_vhbvq8);
					num26 = 1;
				}
				else
				{
			...
			*(double*)(&numberPair4) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja4 = anonymous_namespace_exp_double_double.Invoke(x, num4, &numberPair3);
			...
			*(double*)num29 = struct_4ydhja6.field_1;
			if (details_expects_bool_condition_bool.Invoke((b & 1) == 1, expected: false))
			{
				...
				*ptr5 = -86;
				...
				ptr5[5] = -86;
				ptr5[6] = -86;
				Struct_8myw6y struct_8myw6y4 = ziv_test_denorm.Invoke(num7, numberPair4.hi, numberPair4.lo, 1.5777218104420236E-30);
				...
				int num26;
				if (details_expects_bool_condition_bool.Invoke(optional_double_has_value.Invoke(&cpp_optional_vhbvq9), expected: true))
				{
					result = *(double*)optional_double_value.Invoke(&cpp_optional_vhbvq9);
					num26 = 1;
				}
				else
				{
			...
			*(long*)ptr8 = -6148914691236517206L;
			...
			anonymous_namespace_exp_f128.Invoke(&fputil_DyadicFloat_kt2kd5, x, num4, num5, num6);
