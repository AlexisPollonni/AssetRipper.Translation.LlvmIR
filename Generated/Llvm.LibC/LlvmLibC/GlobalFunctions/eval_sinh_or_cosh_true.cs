...
internal static partial class eval_sinh_or_cosh_true
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x)
	{
		...
		unchecked
		{
			...
			x2 = *(int*)array_unsigned_int_32ul_Index.Invoke(Index: (uint)num7, @this: EXP2_MID_5_BITS_5.Pointer) + (num5 << 23);
			llvm_lifetime_start_p0.Invoke(4L, &x3);
			x3 = *(int*)array_unsigned_int_32ul_Index.Invoke(Index: (uint)num8, @this: EXP2_MID_5_BITS_5.Pointer) + (num6 << 23);
