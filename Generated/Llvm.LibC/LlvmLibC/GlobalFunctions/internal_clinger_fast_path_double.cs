...
internal static partial class internal_clinger_fast_path_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] cpp_optional_9m4esb* agg_result, [MangledName("init_num.coerce0")] long init_num, [MangledName("init_num.coerce1")] RoundDirection_b3pcwy round, [MangledName("round")] int mantissa)
	{
		...
		unchecked
		{
			...
			*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
			...
			if (num2 == 0)
			{
				...
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm3, num3);
			...
			if (num2 > 0)
			{
				...
				else
				{
					...
					if (!(num3 > 9007199254740991.0))
					{
						...
						double num6 = num3;
						long num7 = num2;
						FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm4, num6 * ((double*)internal_ClingerConsts_double_POWERS_OF_TEN_ARRAY.Pointer)[num7]);
		...
		if (num2 < 0)
		{
			...
			double num8 = num3;
			long num9 = -num2;
			FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm5, num8 / unchecked((double*)internal_ClingerConsts_double_POWERS_OF_TEN_ARRAY.Pointer)[num9]);
		...
		unchecked
		{
			if (mantissa != 2)
			{
				...
				*(long*)(&fputil_FPBits_wjhbrm6) = -6148914691236517206L;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm6);
				llvm_lifetime_start_p0.Invoke(8L, &fputil_FPBits_wjhbrm7);
				double num10 = 0.0 - num3;
				long num11 = num2;
				FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm7, num10 * ((double*)internal_ClingerConsts_double_POWERS_OF_TEN_ARRAY.Pointer)[num11]);
				...
				if (NumericHelper.IsUnorderedOrNotEquals(FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm2), 0.0 - FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm6)))
				{
					...
					*(long*)(&fputil_FPBits_wjhbrm9) = -6148914691236517206L;
					FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm9);
					if (FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm2) < 0.0 - FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm6))
					{
			...
			*ptr = -86;
			...
			ptr[2] = -86;
			ptr[3] = -86;
			internal_ExpandedFloat_k68bhv3.mantissa = FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2));
			internal_ExpandedFloat_k68bhv3.exponent = (ushort)FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_biased_exponent.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm2));
			optional_internal_ExpandedFloat_double_Constructor_w43rtw.Invoke(agg_result, &internal_ExpandedFloat_k68bhv3);
