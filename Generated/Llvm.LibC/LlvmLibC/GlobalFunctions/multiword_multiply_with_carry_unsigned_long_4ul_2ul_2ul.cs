...
internal static partial class multiword_multiply_with_carry_unsigned_long_4ul_2ul_2ul
{
	...
	public unsafe static long Invoke([NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 4ul>&")] cpp_array_jgy3xh* dst, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 2ul> const&")] cpp_array_i3937k* lhs, [NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 2ul> const&")] cpp_array_i3937k* rhs)
	{
		...
		unchecked
		{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			for (num = 0L; (ulong)num < 4uL; num++)
			{
				...
				{
					long num6 = multiword_mul_add_with_carry_unsigned_long_2ul.Invoke((cpp_array_i3937k*)(&bigInt_qdkjbh), *(long*)array_unsigned_long_2ul_Index_j6w6uu.Invoke(lhs, num5), *(long*)array_unsigned_long_2ul_Index_j6w6uu.Invoke(rhs, num - num5));
					num4 += num6;
				}
