...
internal static partial class Fputil_round_to_signed_integer_float_long_0
{
	...
	{
		return Internal_rounded_float_to_signed_integer_float_long_0.Invoke(Fputil_round_float_0.Invoke(X));
	}
}
