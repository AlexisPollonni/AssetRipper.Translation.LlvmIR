...
internal static partial class fputil_polyeval_fputil_DyadicFloat_128ul_fputil_DyadicFloat_128ul
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] fputil_DyadicFloat_kt2kd4* agg_result, [NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<128ul> const&")] fputil_DyadicFloat_kt2kd4* x, [NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<128ul> const&")] fputil_DyadicFloat_kt2kd4* a0, [NativeType("__llvm_libc_20_1_2_::fputil::DyadicFloat<128ul> const&")] fputil_DyadicFloat_kt2kd4* a)
	{
		...
		fputil_polyeval_fputil_DyadicFloat_128ul.Invoke(&fputil_DyadicFloat_kt2kd5, x, a);
