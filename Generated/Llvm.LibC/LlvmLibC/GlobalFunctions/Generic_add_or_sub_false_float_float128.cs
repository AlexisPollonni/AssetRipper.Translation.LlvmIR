...
internal static partial class Generic_add_or_sub_false_float_float128
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic10add_or_subILb0EfgEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT0_Esr3cppE19is_floating_point_vIT1_ElestS5_stS6_ES5_E4typeES6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<float> && cpp::is_floating_point_v<__float128> && sizeof (float) <= sizeof (__float128), float>::type __llvm_libc_20_1_2_::fputil::generic::add_or_sub<false, float, __float128>(__float128, __float128)")]
	...
	public unsafe static float Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)))
			{
				...
				else
				{
					...
					x = Y;
					result = Fputil_cast_float_float128.Invoke(x);
			...
			else
			{
				...
				x2 = Y;
				result = Fputil_cast_float_float128.Invoke(x2);
		...
		unchecked
		{
			...
			double num12 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi3);
			...
			double num13 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4);
			...
			else
			{
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5, *(double*)Cpp_max_float128.Invoke(&num4, &num5));
				...
				*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6) = -6148914691236517206L;
				FPBits_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6, *(double*)Cpp_min_float128.Invoke(&num4, &num5));
				...
				else
				{
					...
					*(long*)num25 = struct_fiz2nb30.field_1;
					...
					checked
					{
						num6 = unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5)) - unchecked((ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi6));
				...
				num7 = checked(FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_exponent.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5) - 115);
