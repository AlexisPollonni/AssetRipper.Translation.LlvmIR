...
internal static partial class anonymous_namespace_exp2_double_double_double_NumberPair_double_const
{
	public unsafe static Struct_4ydhja Invoke(double x, NumberPair* exp_mid)
	{
		...
		unchecked
		{
			...
			*(double*)(&numberPair3) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja = anonymous_namespace_poly_approx_dd_NumberPair_double_const_42.Invoke(&numberPair2);
			...
			*(double*)(&numberPair) = double.NaN;
			...
			Struct_4ydhja struct_4ydhja4 = NumberPair_double_fputil_quick_mult_27ul_NumberPair_double_const_NumberPair_double_const.Invoke(exp_mid, &numberPair3);
