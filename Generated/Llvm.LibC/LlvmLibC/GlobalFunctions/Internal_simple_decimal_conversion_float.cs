...
internal static partial class Internal_simple_decimal_conversion_float
{
	...
	public unsafe static Struct_3driym Invoke([MangledName("numStart")][NativeType("char const*")] void* NumStart, [MangledName("num_len")][NativeType("unsigned long")] long Num_len, [MangledName("round")][NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy Round)
	{
		...
		{
			Llvm_lifetime_start_p0.Invoke(8L, &internal_ExpandedFloat_i7t5up);
			internal_ExpandedFloat_i7t5up.Mantissa = 0;
			internal_ExpandedFloat_i7t5up.Exponent = 0;
			Llvm_memcpy_p0_p0_i64.Invoke(&internal_FloatConvertReturn_a8f9er.Num, &internal_ExpandedFloat_i7t5up, 8L, isVolatile: false);
			Llvm_lifetime_end_p0.Invoke(8L, &internal_ExpandedFloat_i7t5up);
		}
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) > 0 && Internal_exp10_to_exp2.Invoke(HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) - 1) > 127)
		{
		...
		else if (HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal) < 0 && Internal_exp10_to_exp2.Invoke(-HighPrecisionDecimal_get_decimal_point.Invoke(&internal_HighPrecisionDecimal)) > 150)
		{
		...
		else
		{
			...
			if (i >= 255)
			{
				...
				internal_ExpandedFloat_i7t5up4.Exponent = 255;
			...
			{
				HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal, 23);
				Llvm_lifetime_start_p0.Invoke(4L, &num3);
				num3 = HighPrecisionDecimal_round_to_integer_type_unsigned_int.Invoke(&internal_HighPrecisionDecimal, RoundDirection_b3pcwy.Nearest);
				if (i <= 0)
				{
					for (; i < 0; i++)
					{
					...
					HighPrecisionDecimal_shift.Invoke(&internal_HighPrecisionDecimal, -1);
					num3 = HighPrecisionDecimal_round_to_integer_type_unsigned_int.Invoke(&internal_HighPrecisionDecimal, Round);
				...
				internal_ExpandedFloat_i7t5up5.Mantissa = num3;
				internal_ExpandedFloat_i7t5up5.Exponent = i;
				Llvm_memcpy_p0_p0_i64.Invoke(&internal_FloatConvertReturn_a8f9er.Num, &internal_ExpandedFloat_i7t5up5, 8L, isVolatile: false);
