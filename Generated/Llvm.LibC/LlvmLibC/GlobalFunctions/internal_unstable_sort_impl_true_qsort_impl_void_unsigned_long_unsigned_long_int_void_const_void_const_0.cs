...
internal static partial class internal_unstable_sort_impl_true_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0
{
	...
	public unsafe static void Invoke([NativeType("void*")] void* array, [NativeType("unsigned long")] long array_len, [NativeType("unsigned long")] long elem_size, [NativeType("__llvm_libc_20_1_2_::__qsort_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*))::$_0 const&")] void* is_less)
	{
			...
			if (array != null && array_len != 0L && elem_size != 0L)
			{
				...
				case 4L:
					...
					*(IntPtr*)(&cpp_string_view2) = unchecked((nint)(-6148914691236517206L));
					...
					internal_quick_sort_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(&cpp_string_view2, is_less);
				...
				case 8L:
					...
					*(IntPtr*)(&cpp_string_view3) = unchecked((nint)(-6148914691236517206L));
					...
					internal_quick_sort_internal_ArrayFixedSize_8ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(&cpp_string_view3, is_less);
				...
				case 16L:
					...
					*(IntPtr*)(&cpp_string_view4) = unchecked((nint)(-6148914691236517206L));
					...
					internal_quick_sort_internal_ArrayFixedSize_16ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(&cpp_string_view4, is_less);
				...
				default:
					...
					*(IntPtr*)(&scanf_core_ReadBuffer2) = unchecked((nint)(-6148914691236517206L));
					...
					internal_quick_sort_internal_ArrayGenericSize_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0.Invoke(&scanf_core_ReadBuffer2, is_less);
