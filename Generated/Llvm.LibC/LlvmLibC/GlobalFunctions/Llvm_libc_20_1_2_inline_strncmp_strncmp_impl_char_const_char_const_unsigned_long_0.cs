...
internal static partial class Llvm_libc_20_1_2_inline_strncmp_strncmp_impl_char_const_char_const_unsigned_long_0
{
	...
	public unsafe static int Invoke([MangledName("left")][NativeType("char const*")] void* Left, [MangledName("right")][NativeType("char const*")] void* Right, [MangledName("n")][NativeType("unsigned long")] long N, [MangledName("comp")][NativeType("__llvm_libc_20_1_2_::__strncmp_impl__(char const*, char const*, unsigned long)::$_0&")] void* Comp)
	{
		sbyte l = 0;
		void* ptr = Left;
		void* ptr2 = Right;
