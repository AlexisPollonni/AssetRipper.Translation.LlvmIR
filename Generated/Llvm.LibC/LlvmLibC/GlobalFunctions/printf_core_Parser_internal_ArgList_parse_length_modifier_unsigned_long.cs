	...
	public unsafe static Struct_nfiam5 Invoke(printf_core_Parser* @this, void* local_pos)
	{
		...
		unchecked
		{
			...
			case 119:
				...
				if (internal_isdigit_int_151.Invoke(((sbyte*)@this->str)[*(long*)local_pos]))
				{
					...
					*(long*)local_pos += strToNumResult_imtnam.parsed_len;
					...
					num = 0;
					printf_core_LengthSpec2.bit_width = *(int*)int_const_cpp_max_int_int_const_int_const.Invoke(&num, &strToNumResult_imtnam.value);
