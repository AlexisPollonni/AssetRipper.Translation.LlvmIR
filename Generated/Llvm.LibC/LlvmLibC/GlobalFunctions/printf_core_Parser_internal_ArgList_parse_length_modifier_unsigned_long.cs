...
{
	public unsafe static Struct_nfiam5 Invoke(void* @this, void* local_pos)
	{
		...
		unchecked
		{
			...
			{
			case 108:
				if (((sbyte*)((printf_core_Parser*)@this)->str)[*(long*)local_pos + 1L] == 108)
				{
					*(long*)local_pos += 2L;
					printf_core_LengthSpec2.lm = 3;
					printf_core_LengthSpec2.bit_width = 0L;
				}
				else
				{
					(*(long*)local_pos)++;
					printf_core_LengthSpec2.lm = 2;
					printf_core_LengthSpec2.bit_width = 0L;
				}
				break;
			case 119:
				...
				lm = -1431655766;
				if (((sbyte*)((printf_core_Parser*)@this)->str)[*(long*)local_pos + 1L] == 102)
				{
					*(long*)local_pos += 2L;
					lm = 9;
				}
				...
				if (internal_isdigit_int_149.Invoke(((sbyte*)((printf_core_Parser*)@this)->str)[*(long*)local_pos]))
				{
					...
					*(int*)(&strToNumResult_yrtfty) = -1431655766;
					...
					Struct_fiz2nb struct_fiz2nb = StrToNumResult_int_internal_strtointeger_int_char_const_int_unsigned_long.Invoke((byte*)((printf_core_Parser*)@this)->str + *(long*)local_pos, 10, cpp_internal_integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
				...
				break;
			case 104:
				if (((sbyte*)((printf_core_Parser*)@this)->str)[*(long*)local_pos + 1L] == 104)
				{
					*(long*)local_pos += 2L;
					printf_core_LengthSpec2.lm = 0;
					printf_core_LengthSpec2.bit_width = 0L;
				}
				else
				{
					(*(long*)local_pos)++;
					printf_core_LengthSpec2.lm = 1;
					printf_core_LengthSpec2.bit_width = 0L;
				}
				break;
			case 76:
				(*(long*)local_pos)++;
				printf_core_LengthSpec2.lm = 7;
				printf_core_LengthSpec2.bit_width = 0L;
				break;
			case 106:
				(*(long*)local_pos)++;
				printf_core_LengthSpec2.lm = 4;
				printf_core_LengthSpec2.bit_width = 0L;
				break;
			case 122:
				(*(long*)local_pos)++;
				printf_core_LengthSpec2.lm = 5;
				printf_core_LengthSpec2.bit_width = 0L;
				break;
			case 116:
				(*(long*)local_pos)++;
				printf_core_LengthSpec2.lm = 6;
				printf_core_LengthSpec2.bit_width = 0L;
				break;
			default:
				printf_core_LengthSpec2.lm = 10;
				printf_core_LengthSpec2.bit_width = 0L;
				break;
			}
