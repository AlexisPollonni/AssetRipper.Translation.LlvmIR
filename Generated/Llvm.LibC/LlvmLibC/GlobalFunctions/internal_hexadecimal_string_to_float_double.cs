...
internal static partial class internal_hexadecimal_string_to_float_double
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] StrToNumResult_wpp2wp* agg_result, [NativeType("char const*")] void* src, [NativeType("char")] sbyte DECIMAL_POINT, [NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy round)
	{
		int num = 0;
		sbyte b = 0;
		sbyte b2 = 0;
		...
		unchecked
		{
			...
			*ptr2 = -86;
			...
			StrToNumResult_internal_ExpandedFloat_double_Constructor.Invoke(agg_result, *(long*)(&internal_ExpandedFloat_k68bhv2), ((int*)(&internal_ExpandedFloat_k68bhv2))[2]);
			...
			if ((b3 & 1) == 1)
			{
				...
				else
				{
					...
					*ptr5 = -86;
					...
					ptr5[2] = -86;
					ptr5[3] = -86;
					internal_ExpandedFloat_k68bhv3.mantissa = num2;
					internal_ExpandedFloat_k68bhv3.exponent = num3;
					internal_binary_exp_to_float_double.Invoke(round: (b2 & 1) == 1, agg_result: &internal_FloatConvertReturn_g92bm9, init_num: *(long*)(&internal_ExpandedFloat_k68bhv3), truncated: ((int*)(&internal_ExpandedFloat_k68bhv3))[2], mantissa: (int)round);
