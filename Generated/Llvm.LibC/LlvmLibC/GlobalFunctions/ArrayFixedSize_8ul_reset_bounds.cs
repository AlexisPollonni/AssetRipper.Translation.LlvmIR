...
internal static partial class ArrayFixedSize_8ul_reset_bounds
{
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("i")][NativeType("unsigned long")] long I, [MangledName("s")][NativeType("unsigned long")] long S)
	{
		unchecked
		{
			((Llvm_libc_20_1_2_cpp_string_view*)This)->Span_data = ArrayFixedSize_8ul_get_internal.Invoke(This, I);
