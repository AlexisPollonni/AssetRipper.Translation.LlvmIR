...
internal static partial class Fputil_ldexp_long_double_int
{
	...
	public unsafe static double Invoke([MangledName("x")][NativeType("long double")] double X, [MangledName("exp")][NativeType("int")] int Exp)
	{
		...
		unchecked
		{
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) = -6148914691236517206L;
			...
			if (Details_expects_bool_condition_bool.Invoke((Exp == 0) ? true : ((!FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)) ? FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_inf_or_nan.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi) : true), Expected: false))
			{
				result = X;
				goto IL_0664;
			}
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				if (!Llvm_libc_20_1_2_Equals_fy8fvt.Invoke(anon_izyfb9.Val, anon_izyfb10.Val) || num3 != 2048)
				{
					...
					if (!Llvm_libc_20_1_2_Equals_fy8fvt.Invoke(anon_izyfb11.Val, anon_izyfb12.Val) || num3 != 1024)
					{
						...
						result = FPBits_long_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5);
		...
		result = DyadicFloat_128ul_as_long_double_true_void.Invoke(&llvm_libc_20_1_2_fputil_DyadicFloat_kt2kd);
