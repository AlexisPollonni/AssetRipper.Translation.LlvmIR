...
internal static partial class BigInt_64ul_false_unsigned_long_RightShift
{
	...
	public unsafe static long Invoke([MangledName("this")] BigInt_555ggs* This, [MangledName("s")][NativeType("unsigned long")] long S)
	{
		...
		unchecked
		{
			long data = Multiword_shift_multiword_Direction_1_false_unsigned_long_1ul.Invoke(*(long*)(&cpp_array_rpgxvv2.Data), S);
			*(long*)(&cpp_array_rpgxvv.Data) = data;
			BigInt_64ul_false_unsigned_long_Constructor.Invoke(&bigInt_555ggs, &cpp_array_rpgxvv);
