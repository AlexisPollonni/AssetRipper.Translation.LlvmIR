...
internal static partial class cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_1_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long
{
			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un2) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 1uL; num5++)
				{
					...
					num6 = cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_1_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long_lambda0_unsigned_long_operator_unsigned_long_const.Invoke(&anon_6je4un2, num5 + num3);
					llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_1_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long_lambda0_unsigned_long_operator_unsigned_long_const.Invoke(&anon_6je4un2, num5 + num3 + 1L);
					llvm_lifetime_start_p0.Invoke(8L, &ptr);
					ptr = (void*)12297829382473034410uL;
					ptr = cpp_array_unsigned_int_1ul_operator_unsigned_long.Invoke(&cpp_array_aj48id2, cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_1_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long_lambda_unsigned_long_operator_unsigned_long_const.Invoke(&anon_izyfb8, num5));
					if (num4 == 0L)
					{
						*(int*)ptr = num6;
					}
