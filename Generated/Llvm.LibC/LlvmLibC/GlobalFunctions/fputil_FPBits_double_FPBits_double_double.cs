...
internal static partial class fputil_FPBits_double_FPBits_double_double
{
	public unsafe static void Invoke(void* @this, double x)
	{
		...
		unchecked((fputil_internal_FPStorage_v3nexn*)@this)->val = cpp_enable_if_sizeof_unsigned_long_sizeof_double_cpp_is_trivially_constructible_unsigned_long_value_cpp_is_trivially_copyable_unsigned_long_value_cpp_is_trivially_copyable_double_value_unsigned_long_type_cpp_bit_cast_unsigned_long_double_double_const.Invoke(&num);
	}
}
