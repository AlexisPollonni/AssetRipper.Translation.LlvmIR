			...
			*(short*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva) = -21846;
			...
			else
			{
				...
				*(Half*)ptr = default(Half);
				ptr[2] = -86;
				ptr[3] = -86;
				int storage = ExceptValues_Float16_9ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_LOG2F16_EXCEPTS.Pointer);
				*(int*)(&llvm_libc_20_1_2_cpp_optional_aq7wey.Storage) = storage;
				...
				case 0:
					...
					num6 = Fputil_multiply_add_float.Invoke(x, *(float*)Array_float_32ul_Index.Invoke(Index: num5, This: Llvm_libc_20_1_2_ONE_OVER_F_F_9.Pointer), -1f);
					Llvm_lifetime_start_p0.Invoke(4L, &num7);
					num7 = num6 * Fputil_polyeval_float_float_float.Invoke(num6, 1.442695f, -0.7216118f, 0.4811537f);
					Llvm_lifetime_start_p0.Invoke(4L, &num8);
					num8 = *(float*)Array_float_32ul_Index.Invoke(Index: num5, This: Llvm_libc_20_1_2_LOG2F_F.Pointer) + num7;
