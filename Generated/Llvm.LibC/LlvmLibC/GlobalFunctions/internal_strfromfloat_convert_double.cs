				...
				*(long*)(&fputil_FPBits_wjhbrm2) = -6148914691236517206L;
				...
				else
				{
					...
					case 102:
						...
						result = printf_core_convert_float_decimal_typed_double_0.Invoke(writer, section, fputil_FPBits_wjhbrm3.FPRepImpl.FPRepSem.FPStorage.val);
						break;
					case 69:
					case 101:
						llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_wjhbrm4, &fputil_FPBits_wjhbrm2, 8L, isVolatile: false);
						result = printf_core_convert_float_dec_exp_typed_double_0.Invoke(writer, section, fputil_FPBits_wjhbrm4.FPRepImpl.FPRepSem.FPStorage.val);
						break;
					case 65:
					case 97:
					...
					case 103:
						...
						result = printf_core_convert_float_dec_auto_typed_double_0.Invoke(writer, section, fputil_FPBits_wjhbrm5.FPRepImpl.FPRepSem.FPStorage.val);
						break;
					default:
