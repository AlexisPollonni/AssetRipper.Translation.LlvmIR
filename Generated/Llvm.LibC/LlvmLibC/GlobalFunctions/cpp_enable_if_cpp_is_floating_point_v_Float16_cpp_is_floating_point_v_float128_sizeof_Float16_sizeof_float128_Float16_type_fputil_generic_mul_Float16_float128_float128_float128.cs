...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_float128_sizeof_Float16_sizeof_float128_Float16_type_fputil_generic_mul_Float16_float128_float128_float128
{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			...
			else
			{
				...
				result = Float16_fputil_DyadicFloat_256ul_as_Float16_true_void_const.Invoke(&fputil_DyadicFloat_jhcpjj4);
