...
internal static partial class generic_MemcmpSequence_unsigned_short_unsigned_char_block_cpp_byte_const_cpp_byte_const
{
	public unsafe static int Invoke(void* p1, void* p2)
	{
		...
		unchecked
		{
			*(int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2) = -1431655766;
			...
			{
				fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2.field_0 = generic_MemcmpSequence_unsigned_char_block_cpp_byte_const_cpp_byte_const.Invoke((byte*)p1 + 2, (byte*)p2 + 2);
			}
