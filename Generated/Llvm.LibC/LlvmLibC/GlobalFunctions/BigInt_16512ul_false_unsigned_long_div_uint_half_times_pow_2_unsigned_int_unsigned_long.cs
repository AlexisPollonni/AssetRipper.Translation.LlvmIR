...
{
	public unsafe static void Invoke([MangledName("agg.result")] cpp_optional_he65ea* agg_result, BigInt_q8g275* @this, int x, long e)
	{
		...
		BigInt_16512ul_false_unsigned_long_BigInt.Invoke(&bigInt_q8g);
		unchecked
		{
			if (x == 0)
			{
			...
			else if ((ulong)e >= 16512uL)
			{
				...
				BigInt_16512ul_false_unsigned_long_BigInt.Invoke(&bigInt_q8g2);
				llvm_memcpy_p0_p0_i64.Invoke(@this, &bigInt_q8g2, 2064L, isVolatile: false);
				llvm_lifetime_end_p0.Invoke(2064L, &bigInt_q8g2);
				cpp_optional_BigInt_16512ul_false_unsigned_long_optional_BigInt_16512ul_false_unsigned_long.Invoke(agg_result, &bigInt_q8g);
			}
			else
			{
				llvm_lifetime_start_p0.Invoke(2064L, &bigInt_q8g3);
				llvm_memset_p0_i64.Invoke(&bigInt_q8g3, -86, 2064L, isVolatile: false);
				BigInt_16512ul_false_unsigned_long_BigInt.Invoke(&bigInt_q8g3);
				...
				for (num9 = 258L - num6; (ulong)num9 > 0uL; num9 += -1L)
				{
					...
					*(long*)cpp_array_unsigned_long_258ul_operator_unsigned_long.Invoke(&bigInt_q8g3.val, num9 - 1L) = num17;
					num7 = (long)((ulong)num7 % (ulong)num);
				...
				if ((ulong)num11 > 0uL)
				{
					BigInt_16512ul_false_unsigned_long_operator_unsigned_long_en4bet.Invoke(&bigInt_q8g3, num11);
					...
					long num19 = num12;
					*(long*)cpp_array_unsigned_long_258ul_operator_unsigned_long.Invoke(&bigInt_q8g3.val, 0L) += num19;
					if ((ulong)(num5 - e) <= 32uL)
					{
						if ((ulong)num8 < 257uL)
						{
							long num20 = num7 >>> 32;
							*(long*)BigInt_16512ul_false_unsigned_long_operator_unsigned_long_jsva56.Invoke(&bigInt_q8g, num8 + 1L) = num20;
						}
						long num21 = (num7 << 32) + (*(long*)cpp_array_unsigned_long_258ul_operator_unsigned_long.Invoke(&@this->val, num8) & 0xFFFFFFFFL);
						*(long*)BigInt_16512ul_false_unsigned_long_operator_unsigned_long_jsva56.Invoke(&bigInt_q8g, num8) = num21;
					}
					else
					{
						long num22 = num7;
						*(long*)BigInt_16512ul_false_unsigned_long_operator_unsigned_long_jsva56.Invoke(&bigInt_q8g, num8) = num22;
					}
				...
				{
					long num23 = num7;
					*(long*)BigInt_16512ul_false_unsigned_long_operator_unsigned_long_jsva56.Invoke(&bigInt_q8g, num8) = num23;
				}
				for (; (ulong)num8 > 0uL; num8 += -1L)
				{
					long num24 = *(long*)cpp_array_unsigned_long_258ul_operator_unsigned_long.Invoke(&@this->val, num8 - 1L);
					*(long*)BigInt_16512ul_false_unsigned_long_operator_unsigned_long_jsva56.Invoke(&bigInt_q8g, num8 - 1L) = num24;
				}
