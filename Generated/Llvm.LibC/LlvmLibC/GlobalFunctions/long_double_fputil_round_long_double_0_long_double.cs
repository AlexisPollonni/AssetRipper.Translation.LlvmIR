...
internal static partial class long_double_fputil_round_long_double_0_long_double
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			else
			{
				...
				else if (num == -1)
				{
					...
					Struct_fiz2nb struct_fiz2nb = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_one_Sign.Invoke(anon_izyfb8.val);
				...
				else
				{
					...
					*(long*)num5 = struct_fiz2nb9.field_1;
					...
					Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval_const.Invoke(&fputil_FPBits_ubgsi3);
					Int128* num6 = &int2;
					...
					*(long*)num7 = struct_fiz2nb12.field_1;
					...
					else
					{
						...
						result = (((b & 1) == 1) ? ((!fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg_const.Invoke(&fputil_FPBits_ubgsi3)) ? (num3 + 1.0) : (num3 - 1.0)) : num3);
