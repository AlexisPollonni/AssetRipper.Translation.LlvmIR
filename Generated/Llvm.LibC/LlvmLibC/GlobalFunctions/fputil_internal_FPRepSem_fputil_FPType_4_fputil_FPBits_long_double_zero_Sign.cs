...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero_Sign
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")] sbyte sign)
	{
		...
		Struct_fiz2nb struct_fiz2nb = fputil_internal_FPStorage_fputil_FPType_4_Significand_zero.Invoke();
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb4 = fputil_internal_FPStorage_fputil_FPType_4_encode_Sign_fputil_internal_FPStorage_fputil_FPType_4_BiasedExponent_fputil_internal_FPStorage_fputil_FPType_4_Significand.Invoke(anon_izyfb9.val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1]);
			Int128* num = &@int;
