...
internal static partial class Internal_rounded_float_to_signed_integer_double_long_long_0
{
	...
	public unsafe static long Invoke([MangledName("x")][NativeType("double")] double X)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb) = -86;
			...
			{
				Lambda_Invoke_kcfwxx.Invoke(&anon_izyfb);
				result = InstructionHelper.Select(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)), long.MinValue, long.MaxValue);
			}
			else
			{
				...
				else if (num3 == 63 && (FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)) || FPRepImpl_fputil_FPType_2_fputil_FPBits_double_get_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)) != 0L))
				{
					Lambda_Invoke_kcfwxx.Invoke(&anon_izyfb);
					result = InstructionHelper.Select(FPRepImpl_fputil_FPType_2_fputil_FPBits_double_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm)), long.MinValue, long.MaxValue);
				}
