...
internal static partial class Fputil_totalordermag_float128
{
	...
	public unsafe static bool Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y)
	{
		...
		Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&fputil_FPBits_ubgsi2);
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			...
			Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_abs.Invoke(&fputil_FPBits_ubgsi4);
