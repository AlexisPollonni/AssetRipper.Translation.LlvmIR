	...
	public unsafe static float Invoke([MangledName("x")] float X, [MangledName("y")] float Y)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs, num41);
			Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs2);
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs2, num42);
			...
			int num43 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs3));
			...
			int field_2 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_abs.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2));
			fputil_FPBits_5nkvcs4.FPRepImpl.FPRepSem.field_0.field_0 = field_2;
			int num44 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs4));
			...
			else if (num4 == 2139095040)
			{
				...
				else
				{
					...
					result = InstructionHelper.Select(condition, FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs6), 0f);
			...
			else
			{
				...
				else
				{
					...
					FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs7, num47);
					result = ((FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs7)) == int.MinValue) ? 0f : num47);
		...
		FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs13, num41);
		unchecked
		{
			num = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs13));
			...
			double x3 = num17;
			long num49 = num16;
			num19 = Fputil_multiply_add_double.Invoke(x3, ((double*)RD.Pointer)[num49], -1.0);
			...
			*(double*)(&inlineArray6_Double) = 1.4426950408889634;
			...
			double y = num20;
			long num50 = num16;
			num21 = Fputil_multiply_add_double.Invoke(x4, y, ((double*)LOG2_R.Pointer)[num50] + num14);
			...
			double num51 = num14;
			long num52 = num16;
			num24 = Fputil_multiply_add_double.Invoke(x5, num51 + ((Fputil_TripleDouble*)Anonymous_namespace_LOG2_R_TD.Pointer)[num52].Hi, 0.0 - num23);
			Llvm_lifetime_start_p0.Invoke(8L, &num25);
			double x6 = num22;
			double x7 = num19;
			double y2 = num20;
			long num53 = num16;
			num25 = Fputil_multiply_add_double.Invoke(x6, Fputil_multiply_add_double.Invoke(x7, y2, ((Fputil_TripleDouble*)Anonymous_namespace_LOG2_R_TD.Pointer)[num53].Mid), num24);
			...
			*(double*)(&inlineArray6_Double2) = 1.0;
			...
			if (Details_expects_bool_condition_bool.Invoke(num35 == num37, Expected: true))
			{
				...
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs14, num35);
				bool num57 = Details_expects_bool_condition_bool.Invoke(FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs14)) == 0, Expected: false);
				...
				if (num57)
				{
					...
					bool num58 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_inf.Invoke(&fputil_FPBits_5nkvcs15);
				...
				if (num62 != 1073741824)
				{
					if (num62 != 1092616192)
					{
						...
						if (num41 == 0f)
						{
							...
							{
								FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs8, num3);
								num64 = (Anonymous_namespace_is_odd_integer.Invoke(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs8)) ? 1 : 0);
							}
							...
							if ((uint)num3 > 2147483648u)
							{
								...
								Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb3, ((b2 & 1) != 1) ? Sign_POS.Pointer : Sign_NEG.Pointer, 1L, isVolatile: false);
								int field_5 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb3.Val);
								fputil_FPBits_5nkvcs9.FPRepImpl.FPRepSem.field_0.field_0 = field_5;
						...
						else if (num2 == 2139095040)
						{
							...
							{
								FPBits_float_FPBits_unsigned_int.Invoke(&fputil_FPBits_5nkvcs10, num3);
								num66 = (Anonymous_namespace_is_odd_integer.Invoke(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs10)) ? 1 : 0);
							}
							...
							else
							{
								...
								Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb4, ((b3 & 1) != 1) ? Sign_POS.Pointer : Sign_NEG.Pointer, 1L, isVolatile: false);
								int field_6 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb4.Val);
								fputil_FPBits_5nkvcs11.FPRepImpl.FPRepSem.field_0.field_0 = field_6;
						...
						else
						{
							...
							if ((b & 1) == 1)
							{
								if (!Anonymous_namespace_is_integer.Invoke(num42))
								{
									...
									fputil_FPBits_5nkvcs12.FPRepImpl.FPRepSem.field_0.field_0 = field_7;
