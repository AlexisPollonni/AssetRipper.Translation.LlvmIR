	...
	public unsafe static long Invoke([MangledName("str")] void* Str, [MangledName("str_end")] void* Str_end, [MangledName("base")] int Base)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			Internal_strtointeger_unsigned_long_long.Invoke(&strToNumResult_gbeb3a, Str, Base, Integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
			...
			long result = StrToNumResult_unsigned_long_long_ToUInt64.Invoke(&strToNumResult_gbeb3a);
