...
internal static partial class generic_fma_Float16_float128
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil7generic3fmaIDF16_gEENS_3cpp9enable_ifIXaaaasr3cppE19is_floating_point_vIT_Esr3cppE19is_floating_point_vIT0_ElestS5_stS6_ES5_E4typeES6_S6_S6_")]
	[DemangledName("__llvm_libc_20_1_2_::cpp::enable_if<cpp::is_floating_point_v<_Float16> && cpp::is_floating_point_v<__float128> && sizeof (_Float16) <= sizeof (__float128), _Float16>::type __llvm_libc_20_1_2_::fputil::generic::fma<_Float16, __float128>(__float128, __float128, __float128)")]
	...
	public unsafe static Half Invoke([NativeType("__float128")] double x, [NativeType("__float128")] double y, [NativeType("__float128")] double z)
	{
		int num = 0;
		long num2 = 0L;
		long num3 = 0L;
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi3, num11);
			llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi4);
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi4, num12);
			llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi5);
			*(Int128*)(&fputil_FPBits_ubgsi5) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi5, num13);
			Half result;
			if (details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)) ? true : ((!FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4))) ? FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi5)) : true), expected: false) && (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4))))
			{
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi5)))
				{
				...
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
				{
					...
					*(long*)num15 = struct_fiz2nb3.field_1;
					...
					short field_ = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(v: (short)@int, sign: anon_izyfb8.val);
				...
				else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)))
				{
					...
					*(long*)num17 = struct_fiz2nb6.field_1;
					...
					short field_2 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(v: (short)int3, sign: anon_izyfb9.val);
				...
				else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi5)))
				{
					llvm_lifetime_start_p0.Invoke(16L, &int5);
					Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_mantissa.Invoke(&fputil_FPBits_ubgsi5);
					Int128* num18 = &int6;
					...
					*(long*)num19 = struct_fiz2nb9.field_1;
					int5 = int6;
					int5 = NumericHelper.ShiftRightLogical(int5, 102L);
					llvm_lifetime_start_p0.Invoke(2L, &fputil_FPBits_2fahva4);
					anon_izyfb10.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi5);
					short field_3 = FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_quiet_nan.Invoke(v: (short)int5, sign: anon_izyfb10.val);
			...
			{
				result = fputil_cast_Float16_float128.Invoke(llvm_fmuladd_f128.Invoke(num11, num12, num13));
			}
			else
			{
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi6, num11);
				bool num20 = details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi6)), expected: false);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi7, num12);
				bool num21 = details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi7)), expected: false);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi8, num13);
				bool num22 = details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi8)), expected: false);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi9, num11);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi10, num12);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi11, num13);
				...
				*(sbyte*)(&anon_izyfb12) = -86;
				anon_izyfb12.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi5);
				llvm_lifetime_start_p0.Invoke(1L, &anon_izyfb13);
				*(sbyte*)(&anon_izyfb13) = -86;
				anon_izyfb14.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi3);
				anon_izyfb15.val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi4);
				...
				int num23 = (ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi3);
				num4 = checked(num4 + num23);
				int num24 = (ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi4);
				num5 = checked(num5 + num24);
				int num25 = (ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi5);
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb10 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
					Int128* num26 = &int9;
					...
					*(long*)num27 = struct_fiz2nb12.field_1;
					...
					Struct_fiz2nb struct_fiz2nb13 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4));
					Int128* num28 = &int11;
					...
					*(long*)ptr = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb16 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi5));
					Int128* num30 = &int12;
					...
					*(long*)ptr2 = -6148914691236517206L;
					...
					checked
					{
						...
						num9 = 114;
						BigInt_256ul_false_unsigned_long_Operator_d84zyi.Invoke(&bigInt_x9dsed, 114L);
						...
						result = DyadicFloat_256ul_as_Float16_true_void.Invoke(&fputil_DyadicFloat_jhcpjj2);
