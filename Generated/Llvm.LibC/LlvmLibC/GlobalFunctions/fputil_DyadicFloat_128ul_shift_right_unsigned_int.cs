...
internal static partial class fputil_DyadicFloat_128ul_shift_right_unsigned_int
{
	public unsafe static void* Invoke(void* @this, int shift_length)
	{
		...
		unchecked
		{
			if ((ulong)(uint)shift_length < 128uL)
			{
				checked
				{
					unchecked((fputil_DyadicFloat_kt2kd4*)@this)->exponent += shift_length;
				}
				BigInt_128ul_false_unsigned_long_operator_unsigned_long_94ezwu.Invoke(&((fputil_DyadicFloat_kt2kd4*)@this)->mantissa, (uint)shift_length);
			}
			else
			{
