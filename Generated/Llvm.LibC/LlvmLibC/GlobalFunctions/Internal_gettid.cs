...
internal static partial class Internal_gettid
{
	...
	public unsafe static int Invoke()
	{
		...
		int result = unchecked((!Details_expects_bool_condition_bool.Invoke((ptr != null) ? (*(int*)ptr <= 0) : true, Expected: false)) ? (*(int*)ptr) : Llvm_libc_20_1_2_syscall_impl_int.Invoke(186L));
