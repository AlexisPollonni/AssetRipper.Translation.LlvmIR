...
internal static partial class Cpp_bit_cast_unsigned_long_unsigned_long
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (unsigned long) == sizeof (unsigned long) && cpp::is_trivially_constructible<unsigned long>::value && cpp::is_trivially_copyable<unsigned long>::value && cpp::is_trivially_copyable<unsigned long>::value, unsigned long>::type")]
