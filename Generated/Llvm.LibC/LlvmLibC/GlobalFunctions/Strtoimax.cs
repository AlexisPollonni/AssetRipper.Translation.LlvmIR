...
internal static partial class Strtoimax
{
	[MangledName("strtoimax")]
	[DemangledName("strtoimax")]
	public unsafe static long Invoke([MangledName("str")] void* Str, [MangledName("str_end")] void* Str_end, [MangledName("base")] int Base)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			...
			Internal_strtointeger_long.Invoke(&llvm_libc_20_1_2_StrToNumResult_gbeb3a, Str, Base, Integer_impl_unsigned_long_0ul_18446744073709551615ul_max.Invoke());
			...
			long result = StrToNumResult_long_Long.Invoke(&llvm_libc_20_1_2_StrToNumResult_gbeb3a);
