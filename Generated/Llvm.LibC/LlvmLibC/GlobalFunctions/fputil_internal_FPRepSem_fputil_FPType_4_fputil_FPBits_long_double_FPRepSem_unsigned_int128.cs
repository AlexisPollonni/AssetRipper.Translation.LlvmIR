...
internal static partial class fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_FPRepSem_unsigned_int128
{
	public unsafe static void Invoke(void* @this, [MangledName(".coerce0")] long coerce0, [MangledName(".coerce1")] long coerce1)
	{
		...
		unchecked
		{
			*(long*)(&@int) = coerce0;
			((long*)(&@int))[1] = coerce1;
			Int128 int2 = @int;
			fputil_internal_FPStorage_fputil_FPType_4_FPStorage_unsigned_int128.Invoke(@this, *(long*)(&int2), ((long*)(&int2))[1]);
		}
	}
}
