...
internal static partial class Eval_sinh_or_cosh_true
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("_Float16")] Half X)
	{
		...
		unchecked
		{
			...
			x = *(int*)Array_unsigned_int_32ul_Index.Invoke(Index: (uint)num7, This: EXP2_MID_5_BITS_5.Pointer) + (num5 << 23);
			Llvm_lifetime_start_p0.Invoke(4L, &x2);
			x2 = *(int*)Array_unsigned_int_32ul_Index.Invoke(Index: (uint)num8, This: EXP2_MID_5_BITS_5.Pointer) + (num6 << 23);
