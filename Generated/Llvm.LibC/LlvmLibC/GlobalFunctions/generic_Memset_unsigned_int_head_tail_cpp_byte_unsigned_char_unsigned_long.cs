...
internal static partial class generic_Memset_unsigned_int_head_tail_cpp_byte_unsigned_char_unsigned_long
{
	public unsafe static void Invoke(void* dst, sbyte value, long count)
	{
		sbyte value2 = value;
		generic_Memset_unsigned_int_block_cpp_byte_unsigned_char.Invoke(dst, value2);
		generic_Memset_unsigned_int_tail_cpp_byte_unsigned_char_unsigned_long.Invoke(dst, value2, count);
	}
}
