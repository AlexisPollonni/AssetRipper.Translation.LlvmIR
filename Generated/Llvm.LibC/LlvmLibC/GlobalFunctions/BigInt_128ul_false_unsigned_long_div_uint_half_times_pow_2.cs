...
internal static partial class BigInt_128ul_false_unsigned_long_div_uint_half_times_pow_2
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Cpp_optional_neprgb* Agg_result, [MangledName("this")] Anon_izyfb7* This, [MangledName("x")] int X, [MangledName("e")] long E)
	{
		...
		unchecked
		{
			...
			*(long*)ptr = -6148914691236517206L;
			...
			else if ((ulong)E >= 128uL)
			{
				...
				Optional_BigInt_128ul_false_unsigned_long_Constructor.Invoke(Agg_result, (Anon_izyfb7*)(&bigInt_qdkjbh));
			}
			else
			{
				...
				*(long*)ptr2 = -6148914691236517206L;
				...
				BigInt_128ul_false_unsigned_long_Constructor.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh3));
				...
				for (num9 = 2L - num6; (ulong)num9 > 0uL; num9 += -1L)
				{
					...
					num7 <<= 32;
					long num16 = *(long*)Array_unsigned_long_2ul_Index_6dk93t.Invoke(&((BigInt_qdkjbh*)This)->Val, num8) & 0xFFFFFFFFL;
					num7 += num16;
					long num17 = (num10 << 32) + (long)((ulong)num7 / (ulong)num);
					*(long*)Array_unsigned_long_2ul_Index_6dk93t.Invoke(&bigInt_qdkjbh3.Val, num9 - 1L) = num17;
					num7 = (long)((ulong)num7 % (ulong)num);
				...
				if ((ulong)num11 > 0uL)
				{
					BigInt_128ul_false_unsigned_long_Operator_89tuvz.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh3), num11);
					...
					long num19 = num12;
					*(long*)Array_unsigned_long_2ul_Index_6dk93t.Invoke(&bigInt_qdkjbh3.Val, 0L) += num19;
					if ((ulong)(num5 - E) <= 32uL)
					{
						if ((ulong)num8 < 1uL)
						{
							long num20 = num7 >>> 32;
							*(long*)BigInt_128ul_false_unsigned_long_Index_4bextd.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh), num8 + 1L) = num20;
						}
						long num21 = (num7 << 32) + (*(long*)Array_unsigned_long_2ul_Index_6dk93t.Invoke(&((BigInt_qdkjbh*)This)->Val, num8) & 0xFFFFFFFFL);
						*(long*)BigInt_128ul_false_unsigned_long_Index_4bextd.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh), num8) = num21;
					}
					else
					{
						long num22 = num7;
						*(long*)BigInt_128ul_false_unsigned_long_Index_4bextd.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh), num8) = num22;
					}
				...
				{
					long num23 = num7;
					*(long*)BigInt_128ul_false_unsigned_long_Index_4bextd.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh), num8) = num23;
				}
				for (; (ulong)num8 > 0uL; num8 += -1L)
				{
					long num24 = *(long*)Array_unsigned_long_2ul_Index_6dk93t.Invoke(&((BigInt_qdkjbh*)This)->Val, num8 - 1L);
					*(long*)BigInt_128ul_false_unsigned_long_Index_4bextd.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh), num8 - 1L) = num24;
				}
