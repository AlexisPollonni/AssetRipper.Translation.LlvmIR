...
internal static partial class Cpp_bit_cast_unsigned_int_unsigned_long_Fract
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (unsigned int) == sizeof (unsigned long _Fract) && cpp::is_trivially_constructible<unsigned int>::value && cpp::is_trivially_copyable<unsigned int>::value && cpp::is_trivially_copyable<unsigned long _Fract>::value, unsigned int>::type")]
