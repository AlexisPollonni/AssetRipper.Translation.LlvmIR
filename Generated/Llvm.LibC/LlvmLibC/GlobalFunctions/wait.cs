	...
	public unsafe static int Invoke(void* wait_status)
	{
		...
		unchecked
		{
			...
			*ptr = -86;
			ptr[1] = -86;
			ptr[2] = -86;
			*(InlineArray5_Byte*)(&cpp_optional_int_OptionalStorage2) = NumericHelper.TruncOrZextToBytes<long, InlineArray5_Byte>(internal_wait4impl_int_int_int_rusage.Invoke(-1, wait_status, 0, null));
			int result;
