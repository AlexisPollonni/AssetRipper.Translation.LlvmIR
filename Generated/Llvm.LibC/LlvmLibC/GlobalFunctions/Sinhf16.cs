			...
			if (Details_expects_bool_condition_bool.Invoke((ushort)num2 == 0 || ((uint)(ushort)num >= 33792u && (uint)(ushort)num <= 41984u) || (uint)(ushort)num2 >= 18917u, Expected: false))
			{
				...
				else if ((uint)(ushort)num2 >= 18917u)
				{
					...
					else
					{
						...
						if (num3 == 0 || (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) && num3 == 2048) || (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_neg.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)) && num3 == 1024))
						{
						...
						else
						{
							...
							anon_izyfb5.Val = FPStorage_fputil_FPType_0_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_2fahva);
				...
				else if (Fputil_fenv_is_round_down.Invoke())
				{
					...
					FPBits_Float16_FPBits_unsigned_short.Invoke(&llvm_libc_20_1_2_fputil_FPBits_2fahva7, (short)checked(unchecked((ushort)num) + 1));
				...
				else
				{
					...
					FPBits_Float16_FPBits_unsigned_short.Invoke(&llvm_libc_20_1_2_fputil_FPBits_2fahva8, num);
			...
			else
			{
				if (FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_pos.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9*)(&llvm_libc_20_1_2_fputil_FPBits_2fahva)))
				{
					...
					*(Half*)ptr = default(Half);
					ptr[2] = -86;
					ptr[3] = -86;
					int storage = ExceptValues_Float16_16ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_SINHF16_EXCEPTS_POS.Pointer);
				...
				else
				{
					...
					*(Half*)ptr2 = default(Half);
					ptr2[2] = -86;
					ptr2[3] = -86;
					int storage2 = ExceptValues_Float16_12ul_lookup.Invoke(X_bits: num, This: Llvm_libc_20_1_2_SINHF16_EXCEPTS_NEG.Pointer);
				...
				result = Llvm_libc_20_1_2_eval_sinh_or_cosh_true.Invoke(X);
			}
			goto IL_05d9;
		}
		IL_05d9:
