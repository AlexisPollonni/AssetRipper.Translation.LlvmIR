...
internal static partial class fputil_round_using_specific_rounding_mode_long_double
{
	...
	public unsafe static double Invoke([NativeType("long double")] double x, [NativeType("int")] int rnd)
	{
					...
					*(long*)num7 = struct_fiz2nb6.field_1;
					...
					else
					{
						...
						*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
						int4 = int3;
						FPBits_long_double_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi4, *(long*)(&int4), ((long*)(&int4))[1]);
						llvm_lifetime_start_p0.Invoke(16L, &num3);
						num3 = FPBits_long_double_get_val.Invoke(&fputil_FPBits_ubgsi4);
						...
						*(long*)num9 = struct_fiz2nb9.field_1;
						...
						Struct_fiz2nb struct_fiz2nb10 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_mantissa.Invoke(&fputil_FPBits_ubgsi4);
						Int128* num10 = &x6;
