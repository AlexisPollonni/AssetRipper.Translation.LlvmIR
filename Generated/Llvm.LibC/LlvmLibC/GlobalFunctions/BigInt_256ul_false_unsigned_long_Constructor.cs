...
internal static partial class BigInt_256ul_false_unsigned_long_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] BigInt_x9dsed* This, [MangledName("words")][NativeType("__llvm_libc_20_1_2_::cpp::array<unsigned long, 4ul> const&")] Cpp_array_jgy3xh* Words)
	{
	...
	public unsafe static void Invoke([MangledName("this")] BigInt_x9dsed* This)
	{
		Llvm_memset_p0_i64.Invoke(&This->Val.Data, 0, 32L, isVolatile: false);
	}
}
