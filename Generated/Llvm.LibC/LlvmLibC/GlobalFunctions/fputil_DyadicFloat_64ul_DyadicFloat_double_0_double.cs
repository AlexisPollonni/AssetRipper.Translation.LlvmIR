...
{
	public unsafe static void Invoke(fputil_DyadicFloat_374hpp* @this, double x)
	{
		...
		*unchecked((long*)(&fputil_FPBits_wjhbrm2)) = -6148914691236517206L;
		...
		BigInt_64ul_false_unsigned_long_BigInt_unsigned_long_void_unsigned_long.Invoke(&bigInt_nx6qdt, fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_get_explicit_mantissa_const.Invoke(unchecked((fputil_internal_FPRepSem_fq8nhg*)(&fputil_FPBits_wjhbrm2))));
