			...
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			else
			{
				...
				else
				{
					...
					mantVal = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs)) >>> num2 << num2;
					FPRepImpl_fputil_FPType_1_fputil_FPBits_float_set_mantissa.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs), mantVal);
