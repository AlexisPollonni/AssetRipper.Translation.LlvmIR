...
internal static partial class double_fputil_DyadicFloat_128ul_fast_as_double_false_void_const
{
			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					double num18 = fputil_FPBits_double_get_val_const.Invoke(&fputil_FPBits_wjhbrm4);
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					int num20 = (BigInt_128ul_false_unsigned_long_is_zero_const.Invoke((anon_izyfb7*)(&bigInt_qdkjbh6)) ? 1 : 0) ^ -1;
					...
					int num21 = (BigInt_128ul_false_unsigned_long_is_zero_const.Invoke((anon_izyfb7*)(&bigInt_qdkjbh7)) ? 1 : 0) ^ -1;
				...
				if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(num8 <= 0, expected: false))
				{
					...
					double num22 = fputil_FPBits_double_get_val_const.Invoke(&fputil_FPBits_wjhbrm5);
					...
					x = fputil_FPBits_double_get_val_const.Invoke(&fputil_FPBits_wjhbrm7);
				...
				else
				{
					...
					unchecked
					{
						if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((b & 1) == 1, expected: false))
						{
							...
							fputil_FPBits_double_FPBits_double_double.Invoke(&fputil_FPBits_wjhbrm9, num14);
							long num24 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval_const.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm9)) - num15;
							...
							fputil_FPBits_double_FPBits_unsigned_long_unsigned_long.Invoke(&fputil_FPBits_wjhbrm10, num16);
