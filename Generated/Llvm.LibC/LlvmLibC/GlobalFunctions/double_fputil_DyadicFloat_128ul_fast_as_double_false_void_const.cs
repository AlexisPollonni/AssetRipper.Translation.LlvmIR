			...
			else
			{
				...
				else
				{
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					int num20 = (BigInt_128ul_false_unsigned_long_is_zero_const.Invoke(&bigInt_qdkjbh6) ? 1 : 0) ^ -1;
					...
					int num21 = (BigInt_128ul_false_unsigned_long_is_zero_const.Invoke(&bigInt_qdkjbh7) ? 1 : 0) ^ -1;
					...
					else
					{
						...
						if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((b & 1) == 1, expected: false))
						{
							...
							long num24 = fputil_internal_FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval_const.Invoke(&fputil_FPBits_wjhbrm9) - num15;
