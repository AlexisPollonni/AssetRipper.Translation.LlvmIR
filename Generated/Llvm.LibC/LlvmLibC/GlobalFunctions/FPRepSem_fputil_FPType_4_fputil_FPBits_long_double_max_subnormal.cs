...
internal static partial class FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_max_subnormal
{
	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign)
	{
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb7 = internal_BitwiseXor.Invoke(*(long*)(&fputil_internal_FPRepSem_f94eua3), ((long*)(&fputil_internal_FPRepSem_f94eua3))[1], *(long*)(&fputil_internal_FPRepSem_f94eua4), ((long*)(&fputil_internal_FPRepSem_f94eua4))[1]);
			...
			Struct_fiz2nb struct_fiz2nb10 = FPStorage_fputil_FPType_4_encode.Invoke(anon_izyfb9.val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1]);
			Int128* num = &@int;
