...
internal static partial class Shm_open
{
	...
	public unsafe static int Invoke([MangledName("name")] void* Name, [MangledName("oflags")] int Oflags, [MangledName("mode")] int Mode)
	{
		...
		unchecked
		{
			...
			{
				result = ((delegate*<void*, int, int>)Open.__pointer)(Array_char_265ul_data.Invoke(Optional_cpp_array_char_265ul_PointerDereference.Invoke(&cpp_optional_hnriuf)), Oflags | 0xA0800);
				num = 1;
			}
			else
			{
