...
{
	[MangledName("shm_open")]
	[DemangledName("shm_open")]
	public unsafe static int Invoke([MangledName("name")] void* Name, [MangledName("oflags")] int Oflags, [MangledName("mode")] int Mode)
	{
		int result = 0;
		...
		unchecked
		{
			...
			{
				result = ((delegate*<void*, int, int>)Open.__pointer)(Array_char_265ul_data.Invoke(Optional_cpp_array_char_265ul_PointerDereference.Invoke(&llvm_libc_20_1_2_cpp_optional_hnriuf)), Oflags | 0xA0800);
				num = 1;
			}
			else
			{
