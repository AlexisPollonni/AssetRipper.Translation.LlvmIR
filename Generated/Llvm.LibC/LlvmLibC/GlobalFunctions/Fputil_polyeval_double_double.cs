...
internal static partial class Fputil_polyeval_double_double
{
	...
	public static double Invoke([MangledName("x")][NativeType("double")] double X, [MangledName("a0")][NativeType("double")] double A0, [MangledName("a")][NativeType("double")] double A)
	{
