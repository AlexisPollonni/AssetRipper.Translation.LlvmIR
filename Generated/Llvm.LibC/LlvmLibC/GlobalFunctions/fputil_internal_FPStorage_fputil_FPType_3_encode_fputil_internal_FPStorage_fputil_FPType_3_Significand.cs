...
internal static partial class fputil_internal_FPStorage_fputil_FPType_3_encode_fputil_internal_FPStorage_fputil_FPType_3_Significand
{
	public unsafe static Struct_fiz2nb Invoke([MangledName("value.coerce0")] long value, [MangledName("value.coerce1")] long value_coerce1)
	{
		...
		unchecked
		{
			*(long*)(&fputil_internal_FPRepSem_f94eua2) = value;
			...
			Struct_fiz2nb struct_fiz2nb = fputil_internal_FPStorage_fputil_FPType_3_TypedInt_unsigned_int128_to_storage_type_const.Invoke(&fputil_internal_FPRepSem_f94eua2);
			Int128* num = &x;
