	...
	public unsafe static int Invoke([MangledName("new_str.coerce0")] void* new_str, [MangledName("new_str.coerce1")][NativeType("__llvm_libc_20_1_2_::cpp::string_view")] long target, [MangledName("target")][NativeType("void*")] printf_core_WriteBuffer* wb)
	{
		...
		unchecked
		{
			*(void**)(&cpp_string_view2) = new_str;
			...
			num = string_view_size.Invoke(&cpp_string_view2) + ((printf_core_WriteBuffer*)ptr)->buff_cur;
			...
			else
			{
				...
				inline_memcpy.Invoke((byte*)((printf_core_WriteBuffer*)ptr)->buff + ((printf_core_WriteBuffer*)ptr)->buff_cur, string_view_data.Invoke(&cpp_string_view2), string_view_size.Invoke(&cpp_string_view2));
