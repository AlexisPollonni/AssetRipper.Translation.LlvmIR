...
internal static partial class project_float128_complex
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] Struct_unhbb7* agg_result, [NativeType("__float128 complex")] void* c)
	{
		...
		unchecked
		{
			*(double*)(&complex_22i76p) = double.NaN;
			...
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi3, complex_22i76p.real);
			bool num = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
			...
			{
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi4, complex_22i76p.imag);
				num2 = (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)) ? 1 : 0);
			}
			...
			if (num2 != 0)
			{
				...
				complex_22i76p2.real = FPBits_float128_get_val.Invoke(&fputil_FPBits_ubgsi5);
				complex_22i76p2.imag = InstructionHelper.Select(complex_22i76p.imag > 0.0, 0.0, -0.0);
				cpp_bit_cast_float128_complex_Complex_float128.Invoke(&struct_unhbb, &complex_22i76p2);
