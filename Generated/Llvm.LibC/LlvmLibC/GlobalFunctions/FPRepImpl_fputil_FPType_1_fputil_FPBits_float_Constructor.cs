...
internal static partial class FPRepImpl_fputil_FPType_1_fputil_FPBits_float_Constructor
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_internal_FPRepImpl_vhj4tm* This, [MangledName("x")][NativeType("unsigned int")] int X)
	{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_internal_FPRepImpl_vhj4tm* This)
	{
