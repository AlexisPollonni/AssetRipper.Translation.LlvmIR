	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("number.coerce0")] long Number, [MangledName("number.coerce1")][NativeType("unsigned __int128")] long Ep, [MangledName("ep")][NativeType("int")] int Result)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_jrxud) = -6148914691236517206L;
			Int128 int8 = 0L;
			FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_jrxud, *(long*)(&int8), ((long*)(&int8))[1]);
		...
		unchecked
		{
			...
			{
				int2 = int7;
				FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_significand.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_jrxud, *(long*)(&int2), ((long*)(&int2))[1]);
				int3 = checked(num2 + 1);
				FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_biased_exponent.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_jrxud, *(long*)(&int3), ((long*)(&int3))[1]);
			}
			else
			{
				int4 = NumericHelper.ShiftRightLogical(int7, (Int128)(UInt128)(uint)checked(-num2));
				FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_set_significand.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_jrxud, *(long*)(&int4), ((long*)(&int4))[1]);
			}
			Struct_fiz2nb struct_fiz2nb = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_uintval.Invoke(&llvm_libc_20_1_2_fputil_internal_FPRepImpl_jrxud);
			Int128* num3 = &int5;
			...
			*(long*)num4 = struct_fiz2nb3.field_1;
			int6 = int5;
			FPBits_long_double_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, *(long*)(&int6), ((long*)(&int6))[1]);
