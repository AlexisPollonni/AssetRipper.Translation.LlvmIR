...
internal static partial class Scanf_core_convert
{
	...
	public unsafe static int Invoke([MangledName("reader")][NativeType("__llvm_libc_20_1_2_::scanf_core::Reader*")] Llvm_libc_20_1_2_scanf_core_Reader* Reader, [MangledName("to_conv")][NativeType("__llvm_libc_20_1_2_::scanf_core::FormatSection const&")] Llvm_libc_20_1_2_scanf_core_FormatSection* To_conv)
	{
		...
		unchecked
		{
			...
			{
			case 37:
				String_view_Constructor.Invoke(&llvm_libc_20_1_2_cpp_string_view, Str_144.Pointer);
				result = Scanf_core_raw_match.Invoke(Reader, *(void**)(&llvm_libc_20_1_2_cpp_string_view), ((long*)(&llvm_libc_20_1_2_cpp_string_view))[1]);
				break;
			case 115:
				String_view_Constructor.Invoke(&llvm_libc_20_1_2_cpp_string_view2, Str_1_147.Pointer);
				num = Scanf_core_raw_match.Invoke(Reader, *(void**)(&llvm_libc_20_1_2_cpp_string_view2), ((long*)(&llvm_libc_20_1_2_cpp_string_view2))[1]);
			...
			case 117:
			case 120:
				String_view_Constructor.Invoke(&llvm_libc_20_1_2_cpp_string_view3, Str_1_147.Pointer);
				num = Scanf_core_raw_match.Invoke(Reader, *(void**)(&llvm_libc_20_1_2_cpp_string_view3), ((long*)(&llvm_libc_20_1_2_cpp_string_view3))[1]);
			...
			case 102:
			case 103:
				String_view_Constructor.Invoke(&llvm_libc_20_1_2_cpp_string_view4, Str_1_147.Pointer);
				num = Scanf_core_raw_match.Invoke(Reader, *(void**)(&llvm_libc_20_1_2_cpp_string_view4), ((long*)(&llvm_libc_20_1_2_cpp_string_view4))[1]);
			...
			case 110:
				...
				break;
			case 112:
				String_view_Constructor.Invoke(&llvm_libc_20_1_2_cpp_string_view5, Str_1_147.Pointer);
				num = Scanf_core_raw_match.Invoke(Reader, *(void**)(&llvm_libc_20_1_2_cpp_string_view5), ((long*)(&llvm_libc_20_1_2_cpp_string_view5))[1]);
				result = ((num == 0) ? Scanf_core_convert_pointer.Invoke(Reader, To_conv) : num);
				break;
			default:
				Llvm_memcpy_p0_p0_i64.Invoke(&llvm_libc_20_1_2_cpp_string_view6, &To_conv->Raw_string, 16L, isVolatile: false);
				result = Scanf_core_raw_match.Invoke(Reader, *(void**)(&llvm_libc_20_1_2_cpp_string_view6), ((long*)(&llvm_libc_20_1_2_cpp_string_view6))[1]);
				break;
			}
