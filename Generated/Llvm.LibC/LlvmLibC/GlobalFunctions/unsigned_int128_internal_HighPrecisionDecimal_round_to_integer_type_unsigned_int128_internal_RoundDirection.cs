...
{
	public unsafe static Struct_fiz2nb Invoke(internal_HighPrecisionDecimal* @this, RoundDirection_b3pcwy round)
	{
		...
		unchecked
		{
			...
			Int128 @int = NumericHelper.Add(x, (Int128)(UInt128)(internal_HighPrecisionDecimal_should_round_up_int_internal_RoundDirection.Invoke(@this, @this->decimal_point, round) ? 1u : 0u));
