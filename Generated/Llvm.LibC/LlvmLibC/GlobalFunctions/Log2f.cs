...
internal static partial class Log2f
{
	...
	public unsafe static float Invoke([MangledName("x")] float X)
	{
		...
		unchecked
		{
			*(int*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) = -1431655766;
			...
			else
			{
				...
				bool num8 = (uint)num7 < (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs2));
				...
				else
				{
					...
					value = (((uint)num9 > (uint)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs3))) ? 1 : 0);
				}
				...
				else
				{
					if (!FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)))
					{
						...
						FPBits_float_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs6, FPBits_float_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs) * 8388608f);
		...
		return result;
		IL_0384:
		int num11 = unchecked((ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)));
		num2 += num11;
		Llvm_lifetime_start_p0.Invoke(4L, &num3);
		unchecked
		{
			num3 = FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_mantissa.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_vhj4tm*)(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs)) >>> 16;
			...
			num4 = FPBits_float_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_5nkvcs);
			Llvm_lifetime_start_p0.Invoke(8L, &num5);
			num5 = double.NaN;
			double x2 = num4;
			long num12 = num3;
			num5 = Fputil_multiply_add_double.Invoke(x2, ((double*)Llvm_libc_20_1_2_RD.Pointer)[num12], -1.0);
			Llvm_lifetime_start_p0.Invoke(8L, &z);
			double num13 = num2;
			long num14 = num3;
			z = num13 + ((double*)Llvm_libc_20_1_2_LOG2_R.Pointer)[num14];
