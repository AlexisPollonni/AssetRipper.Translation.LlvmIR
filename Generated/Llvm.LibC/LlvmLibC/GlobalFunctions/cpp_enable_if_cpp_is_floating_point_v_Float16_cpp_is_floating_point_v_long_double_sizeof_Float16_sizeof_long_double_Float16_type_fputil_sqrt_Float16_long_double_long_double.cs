...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_long_double_sizeof_Float16_sizeof_long_double_Float16_type_fputil_sqrt_Float16_long_double_long_double
{
			...
			else
			{
				...
				*(long*)num4 = struct_fiz2nb6.field_1;
				...
				checked
				{
					...
					{
						num++;
						void_fputil_internal_normalize_long_double_int_fputil_FPBits_long_double_StorageType.Invoke(&num, &x2);
					}
					else
					{
