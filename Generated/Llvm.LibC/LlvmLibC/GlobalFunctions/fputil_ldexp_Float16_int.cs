...
internal static partial class fputil_ldexp_Float16_int
{
	...
	public unsafe static Half Invoke([NativeType("_Float16")] Half x, [NativeType("int")] int exp)
	{
		...
		unchecked
		{
			*(short*)(&fputil_FPBits_2fahva2) = -21846;
			...
			if (details_expects_bool_condition_bool.Invoke((exp == 0) ? true : ((!FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((fputil_internal_FPRepSem_i7nz4h*)(&fputil_FPBits_2fahva2))) ? FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_is_inf_or_nan.Invoke((fputil_internal_FPRepImpl_7z3gh9*)(&fputil_FPBits_2fahva2)) : true), expected: false))
			{
				result = x;
				goto IL_05ac;
			}
