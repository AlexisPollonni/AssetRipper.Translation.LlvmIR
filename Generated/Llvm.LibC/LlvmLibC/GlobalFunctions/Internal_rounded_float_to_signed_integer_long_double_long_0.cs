	...
	public unsafe static long Invoke([MangledName("x")][NativeType("long double")] double X)
	{
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb) = -86;
			...
			{
				Lambda_Invoke_b7spk7.Invoke(&anon_izyfb);
				result = InstructionHelper.Select(FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg.Invoke(&fputil_FPBits_ubgsi), long.MinValue, long.MaxValue);
				goto IL_0209;
			}
			Llvm_lifetime_start_p0.Invoke(4L, &num3);
			num3 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_get_exponent.Invoke(&fputil_FPBits_ubgsi);
			...
			else
			{
				...
				if (!FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_pos.Invoke(&fputil_FPBits_ubgsi))
				{
