	...
	public unsafe static void Invoke([MangledName("agg.result")] Fputil_DyadicFloat_kt2kd4* Agg_result, [MangledName("x")][NativeType("double")] double X, [MangledName("kd")][NativeType("double")] double Kd, [MangledName("idx1")][NativeType("int")] int Idx1, [MangledName("idx2")][NativeType("int")] int Idx2)
	{
		...
		unchecked
		{
			...
			*(long*)num3 = struct_fiz2nb3.field_1;
			...
			DyadicFloat_128ul_Constructor.Invoke(&fputil_DyadicFloat_kt2kd17, anon_izyfb.Val, e, *(long*)(&bigInt_qdkjbh), ((long*)(&bigInt_qdkjbh))[1]);
			Llvm_lifetime_start_p0.Invoke(24L, &fputil_DyadicFloat_kt2kd18);
			*(sbyte*)(&fputil_DyadicFloat_kt2kd18) = -86;
			sbyte* ptr11 = (sbyte*)(&fputil_DyadicFloat_kt2kd18) + 1;
			*ptr11 = -86;
			ptr11[1] = -86;
			ptr11[2] = -86;
			((int*)(&fputil_DyadicFloat_kt2kd18))[1] = -1431655766;
			sbyte* ptr12 = (sbyte*)(&fputil_DyadicFloat_kt2kd18) + 8;
			*(long*)ptr12 = -6148914691236517206L;
			((long*)ptr12)[1] = -6148914691236517206L;
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd19, &fputil_DyadicFloat_kt2kd16, 24L, isVolatile: false);
			Llvm_memcpy_p0_p0_i64.Invoke(&fputil_DyadicFloat_kt2kd20, &fputil_DyadicFloat_kt2kd17, 24L, isVolatile: false);
			...
			*(sbyte*)(&fputil_DyadicFloat_kt2kd21) = -86;
			sbyte* ptr13 = (sbyte*)(&fputil_DyadicFloat_kt2kd21) + 1;
			*ptr13 = -86;
			ptr13[1] = -86;
			ptr13[2] = -86;
			((int*)(&fputil_DyadicFloat_kt2kd21))[1] = -1431655766;
			sbyte* ptr14 = (sbyte*)(&fputil_DyadicFloat_kt2kd21) + 8;
			*(long*)ptr14 = -6148914691236517206L;
			((long*)ptr14)[1] = -6148914691236517206L;
			Anonymous_namespace_poly_approx_f128_8qzdhw.Invoke(&fputil_DyadicFloat_kt2kd21, &fputil_DyadicFloat_kt2kd);
			*(sbyte*)Agg_result = -86;
			...
			*(long*)ptr16 = -6148914691236517206L;
			...
			Fputil_quick_mul_128ul.Invoke(&fputil_DyadicFloat_kt2kd22, &fputil_DyadicFloat_kt2kd16, &fputil_DyadicFloat_kt2kd);
			Fputil_multiply_add_128ul.Invoke(Agg_result, &fputil_DyadicFloat_kt2kd22, &fputil_DyadicFloat_kt2kd21, &fputil_DyadicFloat_kt2kd18);
