			...
			else
			{
				...
				*(IntPtr*)((byte*)(&anon_6je4un2) + 8) = unchecked((nint)(-6148914691236517206L));
				...
				for (num5 = 0L; (ulong)num5 < 1uL; num5++)
				{
					...
					ptr = cpp_array_unsigned_int_1ul_operator_unsigned_long.Invoke(&cpp_array_2v7m9i2, cpp_array_unsigned_int_1ul_multiword_shift_multiword_Direction_0_false_unsigned_int_1ul_cpp_array_unsigned_int_1ul_unsigned_long_lambda_unsigned_long_operator_unsigned_long_const.Invoke(&anon_izyfb8, num5));
					if (num4 == 0L)
					{
						*(int*)ptr = num6;
					}
