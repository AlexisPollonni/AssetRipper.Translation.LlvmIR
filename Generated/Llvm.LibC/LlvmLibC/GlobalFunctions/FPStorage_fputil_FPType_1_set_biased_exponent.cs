...
internal static partial class FPStorage_fputil_FPType_1_set_biased_exponent
{
	...
	public unsafe static void Invoke([MangledName("this")] void* This, [MangledName("biased.coerce")][NativeType("__llvm_libc_20_1_2_::fputil::internal::FPStorage<(__llvm_libc_20_1_2_::fputil::FPType)1>::BiasedExponent")] int Biased)
	{
		...
		unchecked
		{
			...
			((Fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt*)This)->field_0 = FPStorage_fputil_FPType_1_merge.Invoke(field_, FPStorage_fputil_FPType_1_encode_tuzdh3.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0), 2139095040);
		}
	}
}
