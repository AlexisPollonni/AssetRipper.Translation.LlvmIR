	...
	public unsafe static float Invoke(float x)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs2, x2);
			llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb8, Sign_POS.Pointer, 1L, isVolatile: false);
			FPStorage_fputil_FPType_1_set_sign.Invoke(&fputil_FPBits_5nkvcs2, anon_izyfb8.val);
			x2 = FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs2);
			...
			if (details_expects_bool_condition_bool.Invoke(((uint)num < 1119092736u) ? ((uint)num <= 847249408u) : true, expected: false))
			{
				...
				else if (FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)))
				{
					float num3 = x2;
					llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs3);
					llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb9, Sign_POS.Pointer, 1L, isVolatile: false);
					int field_ = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb9.val);
					fputil_FPBits_5nkvcs3.FPRepImpl.FPRepSem.field_0.field_0 = field_;
					result = num3 + FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs3);
				...
				else
				{
					...
					if (details_expects_bool_condition_bool.Invoke((num2 != 1024) ? (num2 == 3072) : true, expected: false))
					{
						...
						int field_2 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_max_normal.Invoke(anon_izyfb10.val);
					...
					else
					{
						...
						int field_3 = FPRepSem_fputil_FPType_1_fputil_FPBits_float_inf.Invoke(anon_izyfb11.val);
						fputil_FPBits_5nkvcs5.FPRepImpl.FPRepSem.field_0.field_0 = field_3;
						result = num4 + FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5);
			...
			{
				result = (float)exp_pm_eval_false.Invoke(x2);
			}
