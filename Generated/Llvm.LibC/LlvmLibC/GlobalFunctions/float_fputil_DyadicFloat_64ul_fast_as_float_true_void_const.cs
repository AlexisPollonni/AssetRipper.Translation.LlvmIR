...
internal static partial class float_fputil_DyadicFloat_64ul_fast_as_float_true_void_const
{
	public unsafe static float Invoke(void* @this)
	{
		...
		unchecked
		{
			...
			else
			{
				...
				checked
				{
					num3 = unchecked((fputil_DyadicFloat_374hpp*)@this)->exponent + 190;
				}
				...
				else
				{
					...
					*(long*)(&bigInt_nx6qdt) = -6148914691236517206L;
					...
					int field_3 = fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_create_value_Sign_unsigned_int_unsigned_int.Invoke(biased_exp: num3, mantissa: (BigInt_64ul_false_unsigned_long_operator_unsigned_int_unsigned_int_const.Invoke(&bigInt_nx6qdt) & 0x7FFFFF) | 0, sign: anon_izyfb10.val);
