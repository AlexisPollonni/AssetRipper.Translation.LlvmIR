...
internal static partial class Get_error_string
{
	...
	public unsafe static Struct_kqhe8i Invoke([NativeType("int")] int err_num)
	{
		cpp_string_view cpp_string_view2 = default(cpp_string_view);
		cpp_string_view cpp_string_view3 = default(cpp_string_view);
		span_char_Constructor.Invoke(&cpp_string_view3, llvm_threadlocal_address_p0.Invoke(internal_error_buffer.Pointer), 26L);
		unchecked
		{
			Struct_kqhe8i struct_kqhe8i = Invoke(err_num, *(void**)(&cpp_string_view3), ((long*)(&cpp_string_view3))[1]);
	...
	public unsafe static Struct_kqhe8i Invoke(int err_num, [MangledName("buffer.coerce0")][NativeType("int")] void* buffer, [MangledName("buffer.coerce1")][NativeType("__llvm_libc_20_1_2_::cpp::span<char>")] long opt_str)
	{
		cpp_string_view cpp_string_view2 = default(cpp_string_view);
		cpp_string_view cpp_string_view3 = default(cpp_string_view);
		...
		unchecked
		{
			...
			*ptr3 = -86;
			...
			ptr3[5] = -86;
			ptr3[6] = -86;
			MessageMapper_134ul_3113ul_get_str.Invoke(&cpp_optional_bnt67x2, (MessageMapper_8a2hs7*)internal_ERROR_MAPPER.Pointer, err_num);
			...
			else
			{
				...
				Struct_kqhe8i struct_kqhe8i = internal_build_error_string.Invoke(err_num, *(void**)(&cpp_string_view4), ((long*)(&cpp_string_view4))[1]);
				cpp_string_view* num = &cpp_string_view2;
				Struct_kqhe8i struct_kqhe8i2 = struct_kqhe8i;
				*(void**)num = struct_kqhe8i2.field_0;
				byte* num2 = (byte*)(&cpp_string_view2) + 8u;
