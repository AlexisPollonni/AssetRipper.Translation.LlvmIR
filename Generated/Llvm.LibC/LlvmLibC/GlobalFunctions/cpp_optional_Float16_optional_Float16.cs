...
internal static partial class cpp_optional_Float16_optional_Float16
{
	public unsafe static void Invoke(void* @this, void* t)
	{
		unchecked
		{
			cpp_optional_Float16_OptionalStorage_Float16_false_OptionalStorage_Float16_cpp_in_place_t_Float16.Invoke(&((cpp_optional_aq7wey*)@this)->storage, cpp_remove_reference_Float16_type_cpp_move_Float16_Float16.Invoke(t));
			((cpp_optional_aq7wey*)@this)->storage.in_use = 1;
		}
	}
}
