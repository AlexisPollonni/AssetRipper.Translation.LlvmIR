...
internal static partial class Llvm_libc_20_1_2_first_leading_one_unsigned_char
{
	...
	{
		return Llvm_libc_20_1_2_first_leading_zero_unsigned_char.Invoke(unchecked((sbyte)((byte)Value ^ -1)));
	}
}
