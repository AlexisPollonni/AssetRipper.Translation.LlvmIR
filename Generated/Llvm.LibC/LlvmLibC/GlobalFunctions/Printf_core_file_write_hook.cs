...
{
	public unsafe static readonly void* __pointer = (delegate*<void*, long, void*, int>)(&Invoke);
	...
	public unsafe static int Invoke([MangledName("new_str.coerce0")] void* New_str, [MangledName("new_str.coerce1")][NativeType("__llvm_libc_20_1_2_::cpp::string_view")] long Fp, [MangledName("fp")][NativeType("void*")] void* Target_file)
	{
		...
		unchecked
		{
			*(void**)(&cpp_string_view) = New_str;
			((long*)(&cpp_string_view))[1] = Fp;
			Llvm_lifetime_start_p0.Invoke(8L, &f);
			f = Target_file;
			Llvm_lifetime_start_p0.Invoke(8L, &num);
			num = Internal_fwrite_unlocked.Invoke(String_view_data.Invoke(&cpp_string_view), 1L, String_view_size.Invoke(&cpp_string_view), f);
			int result = ((num != String_view_size.Invoke(&cpp_string_view) || Internal_ferror_unlocked.Invoke(f) != 0) ? (-1) : 0);
