...
internal static partial class Parser_internal_ArgList_set_type_desc
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_printf_core_Parser* This, [MangledName("index")][NativeType("unsigned long")] long Index, [MangledName("value.coerce")][NativeType("__llvm_libc_20_1_2_::printf_core::TypeDesc")] short Value)
	{
		...
		unchecked
		{
			*(short*)(&llvm_libc_20_1_2_printf_core_TypeDesc) = Value;
			if (Index != 0L && (ulong)Index <= 128uL)
			{
				Llvm_memcpy_p0_p0_i64.Invoke((byte*)(&This->Desc_arr) + (nint)(Index - 1L) * sizeof(Llvm_libc_20_1_2_printf_core_TypeDesc), &llvm_libc_20_1_2_printf_core_TypeDesc, 2L, isVolatile: false);
			}
		}
	}
}
