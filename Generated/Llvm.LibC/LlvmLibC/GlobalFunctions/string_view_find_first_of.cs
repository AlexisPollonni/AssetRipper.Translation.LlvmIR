...
internal static partial class string_view_find_first_of
{
	...
	public unsafe static long Invoke(void* @this, [NativeType("char")] sbyte c, [NativeType("unsigned long")] long From)
	{
		long result = 0L;
		long num = 0L;
		sbyte b = c;
