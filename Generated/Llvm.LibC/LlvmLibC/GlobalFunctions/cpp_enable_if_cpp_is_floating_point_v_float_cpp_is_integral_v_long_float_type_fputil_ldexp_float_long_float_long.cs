...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_float_cpp_is_integral_v_long_float_type_fputil_ldexp_float_long_float_long
{
	public unsafe static float Invoke(float x, long exp)
	{
		...
		unchecked
		{
			*(int*)(&fputil_FPBits_5nkvcs2) = -1431655766;
			...
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke((exp == 0L) ? true : ((!fputil_internal_FPRepSem_fputil_FPType_1_fputil_FPBits_float_is_zero_const.Invoke(&fputil_FPBits_5nkvcs2)) ? fputil_internal_FPRepImpl_fputil_FPType_1_fputil_FPBits_float_is_inf_or_nan_const.Invoke((fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs2)) : true), expected: false))
			{
				result = x;
				goto IL_05ae;
			}
			...
			num = 279;
			if (bool_details_expects_bool_condition_bool_bool_bool.Invoke(exp > 279L, expected: false))
			{
		...
		fputil_DyadicFloat_c8qpxg2.exponent += unchecked((int)exp);
		result = float_fputil_DyadicFloat_32ul_as_float_true_void_const.Invoke(&fputil_DyadicFloat_c8qpxg2);
