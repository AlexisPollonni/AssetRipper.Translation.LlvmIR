...
[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE2ENS0_6FPBitsIdEEE13signaling_nanENS_4SignEm")]
[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)2, __llvm_libc_20_1_2_::fputil::FPBits<double>>::signaling_nan(__llvm_libc_20_1_2_::Sign, unsigned long)")]
internal static partial class fputil_internal_FPRepSem_fputil_FPType_2_fputil_FPBits_double_signaling_nan_Sign_unsigned_long
{
	public unsafe static long Invoke([MangledName("sign.coerce")] sbyte sign, long v)
	{
		...
		if (v != 0L)
		{
			fputil_internal_FPStorage_fputil_FPType_2_Significand_Significand_unsigned_long.Invoke(&fputil_internal_FPRepSem_fq8nhg2, v);
		}
		else
		{
			...
			long val2 = fputil_internal_operator_fputil_internal_FPStorage_fputil_FPType_2_Significand_int.Invoke(fputil_internal_FPRepSem_fq8nhg3.FPStorage.val, 1);
