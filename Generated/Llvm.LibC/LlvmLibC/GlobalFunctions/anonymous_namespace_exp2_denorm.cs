	...
	public unsafe static double Invoke([NativeType("double")] double x)
	{
		...
		unchecked
		{
			...
			*(double*)num12 = struct_4ydhja3.field_1;
			...
			num5 = fputil_multiply_add_double.Invoke(x2, -0.000244140625, x);
			llvm_lifetime_start_p0.Invoke(8L, &y);
			y = num5 * numberPair3.hi;
			llvm_lifetime_start_p0.Invoke(8L, &x3);
			x3 = anonymous_namespace_poly_approx_d_jq287d.Invoke(num5);
			llvm_lifetime_start_p0.Invoke(8L, &lo);
			lo = fputil_multiply_add_double.Invoke(x3, y, numberPair3.lo);
				...
				*ptr5 = -86;
				...
				case 0:
				{
					...
					*(long*)ptr8 = -6148914691236517206L;
					...
					anonymous_namespace_exp2_f128.Invoke(&fputil_DyadicFloat_kt2kd5, num5, hi, num3, num4);
