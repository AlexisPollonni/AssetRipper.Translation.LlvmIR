...
internal static partial class FPRepSem_fputil_FPType_3_fputil_FPBits_float128_max_normal
{
	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign)
	{
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb4 = FPStorage_fputil_FPType_3_encode.Invoke(anon_izyfb9.val, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent2.field_0.field_0, *(long*)(&fputil_internal_FPRepSem_f94eua2), ((long*)(&fputil_internal_FPRepSem_f94eua2))[1]);
			Int128* num = &@int;
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			Int128 int2 = @int;
			FPBits_float128_FPBits_unsigned_int128.Invoke(&fputil_FPBits_ubgsi3, *(long*)(&int2), ((long*)(&int2))[1]);
