...
internal static partial class FPRepSem_fputil_FPType_3_fputil_FPBits_float128_max_normal
{
	...
	public unsafe static Struct_fiz2nb Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte Sign)
	{
		...
		unchecked
		{
			...
			Struct_fiz2nb struct_fiz2nb4 = FPStorage_fputil_FPType_3_encode.Invoke(anon_izyfb2.Val, llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0, *(long*)(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua), ((long*)(&llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua))[1]);
			Int128* num = &@int;
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			Int128 int2 = @int;
			FPBits_float128_FPBits_unsigned_int128.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, *(long*)(&int2), ((long*)(&int2))[1]);
