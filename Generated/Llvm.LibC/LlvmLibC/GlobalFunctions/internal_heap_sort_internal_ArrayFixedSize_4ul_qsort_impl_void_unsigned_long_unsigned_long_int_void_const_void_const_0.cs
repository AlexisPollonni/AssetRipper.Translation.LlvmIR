...
internal static partial class internal_heap_sort_internal_ArrayFixedSize_4ul_qsort_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_0
{
	...
	public unsafe static void Invoke([NativeType("__llvm_libc_20_1_2_::internal::ArrayFixedSize<4ul> const&")] void* array, [NativeType("__llvm_libc_20_1_2_::__qsort_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*))::$_0 const&")] void* is_less)
	{
		long num = 0L;
		long num2 = 0L;
		...
		unchecked
		{
			...
			*(sbyte*)(&anon_izyfb8) = -86;
			while ((ulong)num > 1uL)
			{
				...
				i = num2;
				while ((ulong)lambda_Invoke_age6vb.Invoke(&anon_izyfb8, i) < (ulong)num)
				{
					llvm_lifetime_start_p0.Invoke(8L, &num3);
					num3 = lambda_Invoke_age6vb.Invoke(&anon_izyfb8, i);
