...
internal static partial class FPRepSem_fputil_FPType_1_fputil_FPBits_float_min_subnormal
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE1ENS0_6FPBitsIfEEE13min_subnormalENS_4SignE")]
	[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)1, __llvm_libc_20_1_2_::fputil::FPBits<float>>::min_subnormal(__llvm_libc_20_1_2_::Sign)")]
	public unsafe static int Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte sign)
	{
		...
		int field_2 = Significand_lsb_9tjuku.Invoke();
