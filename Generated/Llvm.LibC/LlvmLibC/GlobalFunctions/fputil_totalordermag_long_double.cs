...
internal static partial class fputil_totalordermag_long_double
{
	...
	public unsafe static bool Invoke([NativeType("long double")] double x, [NativeType("long double")] double y)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb6.field_1;
			...
			FPBits_long_double_Constructor.Invoke(&fputil_FPBits_ubgsi6, y);
			Struct_fiz2nb struct_fiz2nb7 = FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_abs.Invoke(&fputil_FPBits_ubgsi6);
