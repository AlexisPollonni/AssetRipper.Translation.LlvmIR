...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_long_double_sizeof_Float16_sizeof_long_double_Float16_type_fputil_generic_add_or_sub_false_Float16_long_double_long_double_long_double
{
			...
			*(Int128*)(&fputil_FPBits_ubgsi4) = -6148914691236517206L;
			...
			else if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				...
				else
				{
					...
					x2 = y;
					result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_long_double_Float16_type_fputil_cast_Float16_long_double_long_double.Invoke(x2);
			...
			else
			{
				...
				x3 = y;
				result = cpp_enable_if_cpp_is_floating_point_v_Float16_cpp_is_floating_point_v_long_double_Float16_type_fputil_cast_Float16_long_double_long_double.Invoke(x3);
