...
internal static partial class FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_mantissa
{
	...
	public unsafe static void Invoke([MangledName("this")] Llvm_libc_20_1_2_fputil_internal_FPRepImpl_7z3gh9* This, [MangledName("mantVal")][NativeType("unsigned short")] short MantVal)
	{
		short b = MantVal;
		unchecked
		{
