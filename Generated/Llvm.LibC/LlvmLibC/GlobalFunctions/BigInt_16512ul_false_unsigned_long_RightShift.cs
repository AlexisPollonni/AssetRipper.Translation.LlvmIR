...
internal static partial class BigInt_16512ul_false_unsigned_long_RightShift
{
	...
	public unsafe static void Invoke([MangledName("agg.result")] BigInt_q8g275* agg_result, BigInt_q8g275* @this, long s)
	{
		...
		multiword_shift_multiword_Direction_1_false_unsigned_long_258ul.Invoke(&cpp_array_anzbtp2, &cpp_array_anzbtp3, s);
		BigInt_16512ul_false_unsigned_long_Constructor.Invoke(agg_result, &cpp_array_anzbtp2);
