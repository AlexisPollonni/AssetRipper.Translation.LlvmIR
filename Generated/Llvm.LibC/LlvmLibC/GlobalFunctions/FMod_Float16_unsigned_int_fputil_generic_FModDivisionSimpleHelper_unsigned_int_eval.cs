		...
		unchecked
		{
			...
			case 0:
			{
				...
				*(sbyte*)(&anon_izyfb8) = -86;
				...
				FPStorage_fputil_FPType_0_set_sign.Invoke(&fputil_FPBits_2fahva2, anon_izyfb9.val);
				llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb10, Sign_POS.Pointer, 1L, isVolatile: false);
				FPStorage_fputil_FPType_0_set_sign.Invoke(&fputil_FPBits_2fahva3, anon_izyfb10.val);
				...
				*(short*)(&fputil_FPBits_2fahva4) = -21846;
				...
				short field_ = FMod_Float16_unsigned_int_fputil_generic_FModDivisionSimpleHelper_unsigned_int_eval_internal.Invoke(fputil_FPBits_2fahva5.FPRepImpl.FPRepSem.FPStorage.field_0, fputil_FPBits_2fahva6.FPRepImpl.FPRepSem.FPStorage.field_0);
				...
				FPStorage_fputil_FPType_0_set_sign.Invoke(&fputil_FPBits_2fahva4, anon_izyfb11.val);
