...
internal static partial class Internal_clinger_fast_path_float
{
	...
	public unsafe static Struct_8myw6y Invoke([MangledName("init_num.coerce")][NativeType("__llvm_libc_20_1_2_::internal::ExpandedFloat<float>")] long Init_num, [MangledName("round")][NativeType("__llvm_libc_20_1_2_::internal::RoundDirection")] RoundDirection_b3pcwy Round)
	{
		...
		unchecked
		{
			...
			*(int*)(&fputil_FPBits_5nkvcs) = -1431655766;
			...
			if (num2 == 0)
			{
				...
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs2, num3);
			...
			if (num2 > 0)
			{
				...
				else
				{
					...
					if (!(num3 > 16777215f))
					{
						...
						float num6 = num3;
						long num7 = num2;
						FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs3, num6 * ((float*)Internal_ClingerConsts_float_POWERS_OF_TEN_ARRAY.Pointer)[num7]);
		...
		if (num2 < 0)
		{
			...
			float num8 = num3;
			long num9 = -num2;
			FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs4, num8 / unchecked((float*)Internal_ClingerConsts_float_POWERS_OF_TEN_ARRAY.Pointer)[num9]);
		...
		unchecked
		{
			if (Round != RoundDirection_b3pcwy.Nearest)
			{
				...
				*(int*)(&fputil_FPBits_5nkvcs5) = -1431655766;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs5);
				Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs6);
				float num10 = 0f - num3;
				long num11 = num2;
				FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs6, num10 * ((float*)Internal_ClingerConsts_float_POWERS_OF_TEN_ARRAY.Pointer)[num11]);
				Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs5, &fputil_FPBits_5nkvcs6, 4L, isVolatile: false);
				Llvm_lifetime_end_p0.Invoke(4L, &fputil_FPBits_5nkvcs6);
				if (NumericHelper.IsUnorderedOrNotEquals(FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs), 0f - FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5)))
				{
					Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs7);
					*(int*)(&fputil_FPBits_5nkvcs7) = -1431655766;
					FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs7);
					Llvm_lifetime_start_p0.Invoke(4L, &fputil_FPBits_5nkvcs8);
					*(int*)(&fputil_FPBits_5nkvcs8) = -1431655766;
					FPBits_float_Constructor.Invoke(&fputil_FPBits_5nkvcs8);
					if (FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs) < 0f - FPBits_float_get_val.Invoke(&fputil_FPBits_5nkvcs5))
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs7, &fputil_FPBits_5nkvcs, 4L, isVolatile: false);
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs8, &fputil_FPBits_5nkvcs5, 4L, isVolatile: false);
					}
					else
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs7, &fputil_FPBits_5nkvcs5, 4L, isVolatile: false);
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs8, &fputil_FPBits_5nkvcs, 4L, isVolatile: false);
					}
					if (Round == RoundDirection_b3pcwy.Up)
					{
						Llvm_memcpy_p0_p0_i64.Invoke(&fputil_FPBits_5nkvcs, &fputil_FPBits_5nkvcs8, 4L, isVolatile: false);
					}
					else
					{
			...
			*(int*)(&internal_ExpandedFloat_i7t5up2) = -1431655766;
			...
			internal_ExpandedFloat_i7t5up2.Mantissa = FPRepSem_fputil_FPType_1_fputil_FPBits_float_get_explicit_mantissa.Invoke(&fputil_FPBits_5nkvcs);
			internal_ExpandedFloat_i7t5up2.Exponent = (ushort)FPRepImpl_fputil_FPType_1_fputil_FPBits_float_get_biased_exponent.Invoke((Fputil_internal_FPRepImpl_vhj4tm*)(&fputil_FPBits_5nkvcs));
