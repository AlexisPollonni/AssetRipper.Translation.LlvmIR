			...
			if (((byte)to_conv->flags & 1) == 0)
			{
				...
				case 2:
				{
					...
					*ptr3 = -86;
					...
					double num6 = StrToNumResult_double_operator_double.Invoke(&strToNumResult_k826n);
					*(double*)ptr = num6;
				...
				case 7:
				{
					...
					*ptr2 = -86;
					...
					double num5 = StrToNumResult_long_double_operator_long_double.Invoke(&strToNumResult_uytq);
					*(double*)ptr = num5;
				...
				default:
				{
					...
					*(long*)num3 = struct_fiz2nb3.field_1;
					float num4 = StrToNumResult_float_operator_float.Invoke(&strToNumResult_cqc3yy);
					*(float*)ptr = num4;
