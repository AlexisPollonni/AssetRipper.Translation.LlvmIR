...
internal static partial class Align_p1_to_next_boundary_32ul_cpp_byte_cpp_byte_const
{
	...
	public unsafe static void Invoke([MangledName("p1")][NativeType("__llvm_libc_20_1_2_::cpp::byte* restrict&")] void* P1, [MangledName("p2")][NativeType("__llvm_libc_20_1_2_::cpp::byte const* restrict&")] void* P2, [MangledName("count")][NativeType("unsigned long&")] void* Count)
	{
		unchecked
		{
			Adjust_cpp_byte_cpp_byte_const.Invoke(Distance_to_next_aligned_32ul.Invoke(*(void**)P1), P1, P2, Count);
			*(void**)P1 = Assume_aligned_32ul_cpp_byte.Invoke(*(void**)P1);
		}
	}
}
