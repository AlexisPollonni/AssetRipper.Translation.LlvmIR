			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					long val3 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value.Invoke(biased_exp: num3, mantissa: (BigInt_128ul_false_unsigned_long_unsigned_long_unsigned_long.Invoke((anon_izyfb7*)(&bigInt_qdkjbh)) & 0xFFFFFFFFFFFFFL) | 0L, sign: anon_izyfb10.val);
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					int num20 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((anon_izyfb7*)(&bigInt_qdkjbh6)) ? 1 : 0) ^ -1;
					...
					int num21 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((anon_izyfb7*)(&bigInt_qdkjbh7)) ? 1 : 0) ^ -1;
				...
				if (details_expects_bool_condition_bool.Invoke(num8 <= 0, expected: false))
				{
					...
					double num22 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm5);
				...
				else
				{
					...
					unchecked
					{
						if (details_expects_bool_condition_bool.Invoke((b & 1) == 1, expected: false))
						{
							...
							long num24 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm9)) - num15;
