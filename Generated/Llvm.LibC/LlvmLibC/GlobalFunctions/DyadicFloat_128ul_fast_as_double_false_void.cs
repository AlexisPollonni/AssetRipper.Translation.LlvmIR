			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					double num18 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm3);
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					bool num20 = InstructionHelper.BooleanXor(BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh6)), right: true);
					...
					bool num21 = InstructionHelper.BooleanXor(BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&bigInt_qdkjbh7)), right: true);
				...
				if (Details_expects_bool_condition_bool.Invoke(num8 <= 0, Expected: false))
				{
					...
					double num22 = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm4);
					...
					x = FPBits_double_get_val.Invoke(&fputil_FPBits_wjhbrm6);
				...
				else
				{
					...
					unchecked
					{
						if (Details_expects_bool_condition_bool.Invoke((b & 1) == 1, Expected: false))
						{
							...
							FPBits_double_Constructor.Invoke(&fputil_FPBits_wjhbrm8, num14);
							long num24 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Fputil_internal_FPRepImpl_ucubaq*)(&fputil_FPBits_wjhbrm8)) - num15;
							...
							FPBits_double_FPBits_unsigned_long.Invoke(&fputil_FPBits_wjhbrm9, num16);
