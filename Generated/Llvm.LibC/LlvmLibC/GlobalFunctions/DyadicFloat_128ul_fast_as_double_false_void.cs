			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					int num20 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh6)) ? 1 : 0) ^ -1;
					...
					int num21 = (BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh7)) ? 1 : 0) ^ -1;
