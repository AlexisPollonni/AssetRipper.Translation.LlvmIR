...
internal static partial class DyadicFloat_128ul_fast_as_double_false_void
{
	[MangledName("_ZNK19__llvm_libc_20_1_2_6fputil11DyadicFloatILm128EE7fast_asIdLb0EvEET_v")]
	[DemangledName("double __llvm_libc_20_1_2_::fputil::DyadicFloat<128ul>::fast_as<double, false, void>() const")]
			...
			else
			{
				...
				unchecked
				{
					...
					*(long*)ptr = -6148914691236517206L;
					...
					long val3 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_create_value.Invoke(Biased_exp: num3, Mantissa: (BigInt_128ul_false_unsigned_long_Unsigned_long_unsigned_long.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh)) & 0xFFFFFFFFFFFFFL) | 0L, Sign: anon_izyfb3.Val);
					llvm_libc_20_1_2_fputil_FPBits_wjhbrm3.FPRepImpl.FPRepSem.FPStorage.Val = val3;
					double num18 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm3);
					...
					*(long*)ptr3 = -6148914691236517206L;
					...
					bool num19 = (ulong)(uint)num7 > 128uL;
					...
					*(long*)ptr5 = -6148914691236517206L;
					...
					bool num20 = InstructionHelper.BooleanXor(BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh6)), right: true);
					Llvm_lifetime_end_p0.Invoke(16L, &llvm_libc_20_1_2_BigInt_qdkjbh6);
					b2 = (num20 ? ((sbyte)1) : ((sbyte)0));
					...
					bool num21 = InstructionHelper.BooleanXor(BigInt_128ul_false_unsigned_long_is_zero.Invoke((Anon_izyfb7*)(&llvm_libc_20_1_2_BigInt_qdkjbh7)), right: true);
					Llvm_lifetime_end_p0.Invoke(16L, &llvm_libc_20_1_2_BigInt_qdkjbh7);
					b3 = (num21 ? ((sbyte)1) : ((sbyte)0));
				...
				if (Details_expects_bool_condition_bool.Invoke(num8 <= 0, Expected: false))
				{
					...
					double num22 = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm4);
					...
					x = FPBits_double_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm6);
				...
				else
				{
					...
					unchecked
					{
						if (Details_expects_bool_condition_bool.Invoke((b & 1) == 1, Expected: false))
						{
							...
							FPBits_double_Constructor.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm8, num14);
							long num24 = FPRepImpl_fputil_FPType_2_fputil_FPBits_double_uintval.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepImpl_ucubaq*)(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm8)) - num15;
							...
							FPBits_double_FPBits_unsigned_long.Invoke(&llvm_libc_20_1_2_fputil_FPBits_wjhbrm9, num16);
