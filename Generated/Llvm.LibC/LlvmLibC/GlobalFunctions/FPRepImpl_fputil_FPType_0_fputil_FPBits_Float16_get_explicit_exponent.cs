	...
	public unsafe static int Invoke([MangledName("this")] Fputil_internal_FPRepImpl_7z3gh9* This)
	{
		...
		unchecked
		{
			*(int*)(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent) = -1431655766;
			...
			if (FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_is_zero.Invoke((Fputil_internal_FPRepSem_i7nz4h*)This))
			{
			...
			bool num = Internal_Equals_mniybm.Invoke(fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2.field_0);
