...
internal static partial class FPRepSem_fputil_FPType_2_fputil_FPBits_double_max_normal
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE2ENS0_6FPBitsIdEEE10max_normalENS_4SignE")]
	[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)2, __llvm_libc_20_1_2_::fputil::FPBits<double>>::max_normal(__llvm_libc_20_1_2_::Sign)")]
	public unsafe static long Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte Sign)
	{
		...
		int field_ = Exponent_max_d682vg.Invoke();
		...
		long val = Significand_bits_all_ones_cz6sas.Invoke();
		llvm_libc_20_1_2_fputil_internal_FPRepSem_fq8nhg.FPStorage.Val = val;
