...
internal static partial class fputil_modf_long_double_0
{
	...
	public unsafe static double Invoke([NativeType("long double")] double x, [NativeType("long double&")] void* iptr)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			...
			double result;
			if (FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero.Invoke(&fputil_FPBits_ubgsi3) || FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_nan.Invoke(&fputil_FPBits_ubgsi3))
			{
				*(double*)iptr = x;
				result = x;
			}
			...
			else
			{
				*(double*)iptr = fputil_trunc_long_double_0.Invoke(x);
				if (x == *(double*)iptr)
				{
					...
					Struct_fiz2nb struct_fiz2nb4 = FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_zero.Invoke(anon_izyfb9.val);
