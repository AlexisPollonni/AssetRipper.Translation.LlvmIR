...
internal static partial class internal_partition_hoare_branchy_internal_ArrayGenericSize_void_internal_quick_sort_impl_internal_ArrayGenericSize_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0_internal_ArrayGenericSize_void_const_unsigned_long_qsort_r_impl_void_unsigned_long_unsigned_long_int_void_const_void_const_void_void_0_const_lambda_void_const_void_const
{
	...
	public unsafe static long Invoke([NativeType("__llvm_libc_20_1_2_::internal::ArrayGenericSize const&")] void* array, [NativeType("void const*")] void* pivot, [NativeType("__llvm_libc_20_1_2_::__qsort_r_impl__(void*, unsigned long, unsigned long, int (*)(void const*, void const*, void*), void*)::$_0 const&")] void* is_less)
	{
		...
		unchecked
		{
			while (true)
			{
				if ((ulong)num2 < (ulong)num3 && lambda_Invoke_hxaia2.Invoke(is_less, ArrayGenericSize_get.Invoke(array, num2), pivot))
				{
					num2++;
					continue;
				}
				...
				while ((ulong)num2 < (ulong)num3 && !lambda_Invoke_hxaia2.Invoke(is_less, ArrayGenericSize_get.Invoke(array, num3), pivot));
