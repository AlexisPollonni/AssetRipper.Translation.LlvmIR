...
internal static partial class cpp_bit_cast_long_Fract_unsigned_int
{
	...
	[return: NativeType("__llvm_libc_20_1_2_::cpp::enable_if<sizeof (long _Fract) == sizeof (unsigned int) && cpp::is_trivially_constructible<long _Fract>::value && cpp::is_trivially_copyable<long _Fract>::value && cpp::is_trivially_copyable<unsigned int>::value, long _Fract>::type")]
