...
internal static partial class FPRepImpl_fputil_FPType_0_fputil_FPBits_Float16_set_biased_exponent
{
	...
	public unsafe static void Invoke([MangledName("this")] Fputil_internal_FPRepImpl_7z3gh9* This, [MangledName("biased")][NativeType("unsigned short")] short Biased)
	{
		...
		BiasedExponent_Constructor_wry333.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent, unchecked((ushort)Biased));
		FPStorage_fputil_FPType_0_set_biased_exponent.Invoke(This, fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent.field_0.field_0);
	}
}
