...
internal static partial class cpp_enable_if_cpp_is_floating_point_v_long_double_bool_type_fputil_setpayload_false_long_double_long_double_long_double
{
	public unsafe static bool Invoke(void* res, double pl)
	{
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			fputil_FPBits_long_double_FPBits_long_double_long_double.Invoke(&fputil_FPBits_ubgsi3, pl);
			if (fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_is_zero_const.Invoke(&fputil_FPBits_ubgsi3))
			{
				...
				*(double*)res = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi4);
			...
			if (!fputil_internal_FPRepImpl_fputil_FPType_4_fputil_FPBits_long_double_is_neg_const.Invoke(&fputil_FPBits_ubgsi3) && num >= 0 && num < 62)
			{
				...
				*(long*)num3 = struct_fiz2nb6.field_1;
				if (!NumericHelper.IntCmpNe(NumericHelper.BitwiseAnd(NumericHelper.ShiftLeft(x, (Int128)(UInt128)(uint)num), long.MaxValue), 0L))
				{
					...
					Struct_fiz2nb struct_fiz2nb7 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_get_explicit_mantissa_const.Invoke(&fputil_FPBits_ubgsi3);
					Int128* num4 = &x2;
					...
					*(long*)num5 = struct_fiz2nb9.field_1;
					...
					int3 = int4;
					Struct_fiz2nb struct_fiz2nb10 = fputil_internal_FPRepSem_fputil_FPType_4_fputil_FPBits_long_double_quiet_nan_Sign_unsigned_int128.Invoke(val2, *(long*)(&int3), ((long*)(&int3))[1]);
					...
					*(double*)res = fputil_FPBits_long_double_get_val_const.Invoke(&fputil_FPBits_ubgsi5);
