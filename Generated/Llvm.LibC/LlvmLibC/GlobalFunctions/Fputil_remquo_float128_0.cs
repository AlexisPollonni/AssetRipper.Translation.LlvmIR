	...
	public unsafe static double Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y, [MangledName("q")][NativeType("int&")] void* Q)
	{
		...
		unchecked
		{
			...
			*(Int128*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2) = -6148914691236517206L;
			...
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
			{
				result = Y;
			}
			else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_inf.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_zero.Invoke((Llvm_libc_20_1_2_fputil_internal_FPRepSem_f94eua*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2)))
			{
			...
			else
			{
				...
				*(sbyte*)(&anon_izyfb2) = -86;
				...
				FPStorage_fputil_FPType_3_set_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi, anon_izyfb5.Val);
				Llvm_memcpy_p0_p0_i64.Invoke(&anon_izyfb6, Llvm_libc_20_1_2_Sign_POS.Pointer, 1L, isVolatile: false);
				FPStorage_fputil_FPType_3_set_sign.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2, anon_izyfb6.Val);
				...
				NormalFloat_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie, *(long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4), ((long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi4))[1]);
				...
				NormalFloat_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie2, *(long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5), ((long*)(&llvm_libc_20_1_2_fputil_FPBits_ubgsi5))[1]);
				...
				*(int*)Q = 0;
				while (true)
				{
					...
					int3 = int4;
					NormalFloat_float128_Constructor.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie3, val2, e, *(long*)(&int3), ((long*)(&int3))[1]);
					Llvm_lifetime_start_p0.Invoke(16L, &num3);
					num3 = NormalFloat_float128_Float128.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie3);
					Llvm_lifetime_start_p0.Invoke(16L, &num4);
					num4 = FPBits_float128_get_val.Invoke(&llvm_libc_20_1_2_fputil_FPBits_ubgsi2);
					Llvm_lifetime_start_p0.Invoke(4L, &num5);
					Llvm_lifetime_start_p0.Invoke(48L, &llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie4);
					NormalFloat_float128_mul2.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie4, &llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie3, 1);
					int num8 = NormalFloat_float128_cmp.Invoke(&llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie4, &llvm_libc_20_1_2_fputil_NormalFloat_wqb3ie2);
