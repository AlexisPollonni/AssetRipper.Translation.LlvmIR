	...
	public unsafe static int Invoke([MangledName("this")] void* This)
	{
		...
		unchecked
		{
			...
			*(long*)num2 = struct_fiz2nb3.field_1;
			BiasedExponent_Constructor_ugybtz.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_BiasedExponent, (int)NumericHelper.ShiftRightLogical(x, 112L));
