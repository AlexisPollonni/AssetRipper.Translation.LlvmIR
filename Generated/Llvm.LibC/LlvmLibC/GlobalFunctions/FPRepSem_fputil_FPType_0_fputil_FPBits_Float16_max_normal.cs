...
internal static partial class FPRepSem_fputil_FPType_0_fputil_FPBits_Float16_max_normal
{
	[MangledName("_ZN19__llvm_libc_20_1_2_6fputil8internal8FPRepSemILNS0_6FPTypeE0ENS0_6FPBitsIDF16_EEE10max_normalENS_4SignE")]
	[DemangledName("__llvm_libc_20_1_2_::fputil::internal::FPRepSem<(__llvm_libc_20_1_2_::fputil::FPType)0, __llvm_libc_20_1_2_::fputil::FPBits<_Float16>>::max_normal(__llvm_libc_20_1_2_::Sign)")]
	public unsafe static short Invoke([MangledName("sign.coerce")][NativeType("__llvm_libc_20_1_2_::Sign")] sbyte Sign)
	{
		...
		int field_ = Exponent_max_itc9p2.Invoke();
		...
		short field_2 = Significand_bits_all_ones_pwguf3.Invoke();
