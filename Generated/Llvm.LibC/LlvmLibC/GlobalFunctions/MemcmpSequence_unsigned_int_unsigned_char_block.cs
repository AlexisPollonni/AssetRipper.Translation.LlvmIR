...
internal static partial class MemcmpSequence_unsigned_int_unsigned_char_block
{
	...
	public unsafe static int Invoke([MangledName("p1")][NativeType("__llvm_libc_20_1_2_::cpp::byte const*")] void* P1, [MangledName("p2")][NativeType("__llvm_libc_20_1_2_::cpp::byte const*")] void* P2)
	{
		...
		unchecked
		{
			*(int*)(&llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt) = -1431655766;
			...
			{
				llvm_libc_20_1_2_fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt.field_0 = MemcmpSequence_unsigned_char_block.Invoke((byte*)P1 + 4, (byte*)P2 + 4);
			}
