...
internal static partial class Generic_fma_Float16_float128
{
	...
	public unsafe static Half Invoke([MangledName("x")][NativeType("__float128")] double X, [MangledName("y")][NativeType("__float128")] double Y, [MangledName("z")][NativeType("__float128")] double Z)
	{
		int num = 0;
		long num2 = 0L;
		long num3 = 0L;
		...
		unchecked
		{
			*(Int128*)(&fputil_FPBits_ubgsi) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi, num11);
			Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi2);
			*(Int128*)(&fputil_FPBits_ubgsi2) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi2, num12);
			Llvm_lifetime_start_p0.Invoke(16L, &fputil_FPBits_ubgsi3);
			*(Int128*)(&fputil_FPBits_ubgsi3) = -6148914691236517206L;
			FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi3, num13);
			Half result;
			if (Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi2)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)), Expected: false) && (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi2))))
			{
				if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi2)) || FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_signaling_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
				{
				...
				else if (FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_quiet_nan.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3)))
				{
					...
					*(long*)num19 = struct_fiz2nb9.field_1;
					...
					anon_izyfb3.Val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi3);
			...
			else
			{
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi4, num11);
				bool num20 = Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi4)), Expected: false);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi5, num12);
				bool num21 = Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi5)), Expected: false);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi6, num13);
				bool num22 = Details_expects_bool_condition_bool.Invoke(FPRepSem_fputil_FPType_3_fputil_FPBits_float128_is_subnormal.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi6)), Expected: false);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi7, num11);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi8, num12);
				...
				FPBits_float128_Constructor.Invoke(&fputil_FPBits_ubgsi9, num13);
				...
				*(sbyte*)(&anon_izyfb5) = -86;
				anon_izyfb5.Val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi3);
				...
				*(sbyte*)(&anon_izyfb6) = -86;
				...
				anon_izyfb8.Val = FPStorage_fputil_FPType_3_sign.Invoke(&fputil_FPBits_ubgsi2);
				...
				int num23 = (ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi);
				num4 = checked(num4 + num23);
				int num24 = (ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi2);
				num5 = checked(num5 + num24);
				int num25 = (ushort)FPRepImpl_fputil_FPType_3_fputil_FPBits_float128_get_biased_exponent.Invoke(&fputil_FPBits_ubgsi3);
				...
				else
				{
					...
					Struct_fiz2nb struct_fiz2nb10 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi));
					Int128* num26 = &int9;
					...
					*(long*)num27 = struct_fiz2nb12.field_1;
					...
					Struct_fiz2nb struct_fiz2nb13 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi2));
					Int128* num28 = &int11;
					...
					*(long*)ptr = -6148914691236517206L;
					...
					Struct_fiz2nb struct_fiz2nb16 = FPRepSem_fputil_FPType_3_fputil_FPBits_float128_get_explicit_mantissa.Invoke((Fputil_internal_FPRepSem_f94eua*)(&fputil_FPBits_ubgsi3));
					Int128* num30 = &int12;
