...
internal static partial class StrictIntegralType_int_generic_cmp_unsigned_short_cpp_byte_const_cpp_byte_const_unsigned_long
{
	public unsafe static int Invoke(void* p1, void* p2, long offset)
	{
		...
		StrictIntegralType_int_StrictIntegralType_int_false_int.Invoke(&fputil_internal_FPStorage_fputil_FPType_IEEE754_Binary128_TypedInt2, unchecked((ushort)unsigned_short_generic_load_be_unsigned_short_cpp_byte_const_unsigned_long.Invoke(p1, offset)) - unchecked((ushort)unsigned_short_generic_load_be_unsigned_short_cpp_byte_const_unsigned_long.Invoke(p2, offset)));
