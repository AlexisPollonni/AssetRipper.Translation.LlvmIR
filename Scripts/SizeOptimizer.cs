...
unsafe static void Run(string name, ReadOnlySpan<byte> content, string outputPath)
{
...
unsafe static void OptimizeModule(LLVMModuleRef module, LLVMContextRef context)
{
...
unsafe static void DisableTailCalls(LLVMValueRef function, LLVMContextRef context)
{
...
unsafe static uint GetEnumAttributeKindForName(ReadOnlySpan<byte> utf8String)
{
...
{
    public unsafe static IEnumerable<LLVMValueRef> GetFunctions(this LLVMModuleRef module)
    {
    ...
    public unsafe static IEnumerable<LLVMValueRef> GetGlobals(this LLVMModuleRef module)
    {
    ...
    public unsafe static IEnumerable<LLVMValueRef> GetInstructions(this LLVMBasicBlockRef basicBlock)
    {
    ...
    public unsafe static IEnumerable<LLVMValueRef> GetInstructions(this LLVMValueRef value)
    {
