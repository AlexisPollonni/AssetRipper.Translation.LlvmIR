	...
	public static Instruction FromOpCode(CilOpCode opCode)
	{
		...
		if (opCode.OperandType is not CilOperandType.InlineNone)
		{
			throw new NotSupportedException(
				$"Unsupported CIL opcode with operand type: {opCode.OperandType} ({opCode})"
			);
		}
	...
	private sealed record class CilOpCodeInstruction(CilOpCode OpCode) : Instruction
	{
		...
		public override int PopCount =>
			OpCode.StackBehaviourPop switch
			{
				...
				CilStackBehaviour.Pop1_Pop1
				or CilStackBehaviour.PopI_Pop1
				or CilStackBehaviour.PopI_PopI
				or CilStackBehaviour.PopI_PopI8
				or CilStackBehaviour.PopI_PopR4
				or CilStackBehaviour.PopI_PopR8
				or CilStackBehaviour.PopRef_Pop1
				or CilStackBehaviour.PopRef_PopI => 2,
				CilStackBehaviour.PopI_PopI_PopI
				or CilStackBehaviour.PopRef_PopI_PopI
				or CilStackBehaviour.PopRef_PopI_PopI8
				or CilStackBehaviour.PopRef_PopI_PopR4
				or CilStackBehaviour.PopRef_PopI_PopR8
				or CilStackBehaviour.PopRef_PopI_PopRef
				or CilStackBehaviour.PopRef_PopI_Pop1 => 3,
				_ => throw new ArgumentOutOfRangeException(),
			};

		public override int PushCount =>
			OpCode.StackBehaviourPush switch
			{
				CilStackBehaviour.Push0 => 0,
				CilStackBehaviour.Push1
				or CilStackBehaviour.PushI
				or CilStackBehaviour.PushI8
				or CilStackBehaviour.PushR4
				or CilStackBehaviour.PushR8
				or CilStackBehaviour.PushRef => 1,
