...
internal sealed record class ClearStackFrameInstruction(FunctionContext Function) : Instruction
{
	...
	public override void AddInstructions(CilInstructionCollection instructions)
	{
		...
		instructions.Add(CilOpCodes.Ldsflda, Function.Module.ImportRuntimeField(stackFrameListType.GetFieldByName(nameof(StackFrameList.Current))));
		instructions.Add(CilOpCodes.Ldloc, Function.StackFrameVariable);
		instructions.Add(CilOpCodes.Call, Function.Module.ImportRuntimeMethod(stackFrameListType.Methods.Single(m => m.Name == nameof(StackFrameList.Clear) && m.IsPublic)));
	}
}
