...
{
	public static BasicBlockInstructionsEnumerable GetInstructions(
		this LLVMBasicBlockRef basicBlock
	) => new BasicBlockInstructionsEnumerable(basicBlock);
	...
	public static bool TryGetSingleInstruction(
		this LLVMBasicBlockRef basicBlock,
		out LLVMValueRef instruction
	)
	{
	...
	{
		LLVMValueRef firstInstruction = basicBlock.FirstInstruction;
		return firstInstruction.Handle != 0
			&& firstInstruction.InstructionOpcode == LLVMOpcode.LLVMPHI;
	}
}
